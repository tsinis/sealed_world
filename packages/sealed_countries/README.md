...
| translations  | **Yes** (for built-in data) | The translations of the country name.                            | List of **135+** `TranslatedName`s in different languages                                                                                                                          |
...
- **High code coverage**: The code in this package has 100% code coverage, with more than 1021 (+2118 in underlying packages) tests, providing confidence in its reliability and stability.
