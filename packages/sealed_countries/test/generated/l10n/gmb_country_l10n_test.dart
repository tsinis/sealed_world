...
void main() => group(
      "$CountryGmb() L10N",
      () {
        const value = CountryGmb();

        test("has translation for 'en' locale", () {
          const expectedName = "Gambia";
          const expectedFullName = "Republic of the Gambia";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Гамбија";
          const expectedFullName = "Република Гамбија";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "غامبيا";
          const expectedFullName = "جمهورية غامبيا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Gambia";
          const expectedFullName = "Republik islamek ar Gambia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Gambie";
          const expectedFullName = "Gambijská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Gambia";
          const expectedFullName = "Republik Gambia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Gambia";
          const expectedFullName = "Gambia Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Gambia";
          const expectedFullName = "Gambian tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Gambie";
          const expectedFullName = "République de Gambie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Gambija";
          const expectedFullName = "Republika Gambija";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Gambia";
          const expectedFullName = "Gambiai Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Gambia";
          const expectedFullName = "Repubblica del Gambia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ガンビア";
          const expectedFullName = "ガンビア共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "감비아";
          const expectedFullName = "감비아 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Gambia";
          const expectedFullName = "Republiek Gambia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "گامبیا";
          const expectedFullName = "جمهوری گامبیا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Gambia";
          const expectedFullName = "Republika Gambii";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Gâmbia";
          const expectedFullName = "República da Gâmbia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Гамбия";
          const expectedFullName = "Республика Гамбия";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Gambia";
          const expectedFullName = "República de Gambia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Gambia";
          const expectedFullName = "Republiken Gambia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Gambiya";
          const expectedFullName = "Gambiya Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "گیمبیا";
          const expectedFullName = "جمہوریہ گیمبیا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "冈比亚";
          const expectedFullName = "冈比亚共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Gambia nutome";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Ghaimbia";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ສາທາລະນະລັດແກມເບຍ";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Gambia";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Ang Gambiya";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Gambia";
