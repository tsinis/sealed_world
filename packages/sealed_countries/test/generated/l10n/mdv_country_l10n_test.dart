...
void main() => group(
      "$CountryMdv() L10N",
      () {
        const value = CountryMdv();

        test("has translation for 'en' locale", () {
          const expectedName = "Maldives";
          const expectedFullName = "Republic of the Maldives";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Малдиви";
          const expectedFullName = "Малдивска Република";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "المالديف";
          const expectedFullName = "جمهورية المالديف";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Maldivez";
          const expectedFullName = "Republik Maldivez";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Maledivy";
          const expectedFullName = "Maledivská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Malediven";
          const expectedFullName = "Republik Malediven";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Maldiivid";
          const expectedFullName = "Maldiivi Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Malediivit";
          const expectedFullName = "Malediivien tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Maldives";
          const expectedFullName = "République des Maldives";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Maldivi";
          const expectedFullName = "Republika Maldivi";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Maldív-szigetek";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Maldive";
          const expectedFullName = "Repubblica delle Maldive";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "モルディブ";
          const expectedFullName = "モルディブ共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "몰디브";
          const expectedFullName = "몰디브 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Maldiven";
          const expectedFullName = "Republiek van de Malediven";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "مالدیو";
          const expectedFullName = "جمهوری مالدیو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Malediwy";
          const expectedFullName = "Republika Malediwów";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Maldivas";
          const expectedFullName = "República das Maldivas";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Мальдивы";
          const expectedFullName = "Республика Мальдивы";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Maldivy";
          const expectedFullName = "Maldivská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Maldivas";
          const expectedFullName = "República de las Maldivas";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Maldiverna";
          const expectedFullName = "Republiken Maldiverna";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Maldivler";
          const expectedFullName = "Maldivler Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "مالدیپ";
          const expectedFullName = "جمہوریہ مالدیپ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "马尔代夫";
          const expectedFullName = "马尔代夫共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Maldiv adaları";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "maldivesdukɔ";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Maldivoyggjar";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Oileáin Mhaildíve";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Na h-Eileanan Mhaladaibh";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "האיים המלדיביים";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Maldíveyjar";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Мальдив аралдары";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Bizinga by’eMalidive";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "မော်လ်ဒိုက်";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Malediivvat";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Мальдив утраулары";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Maldiv orollari";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Maladifi";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "ދިވެހިރާއްޖެ";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Ny Maldeevaghyn";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Insulae Maldivae";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Majwjdaifuh";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Малдив адалары";
        ...
        test("has translation for 'kk_Cyrl' locale", () {
          const expectedName = "Мальдив Республикасы";
        ...
        test("has translation for 'ky_Cyrl' locale", () {
          const expectedName = "Малдив аралдары";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Мальдив ороллари";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Maladifi";
