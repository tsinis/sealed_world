...
void main() => group(
      "$CountryBel() L10N",
      () {
        const value = CountryBel();

        test("has translation for 'en' locale", () {
          const expectedName = "Belgium";
          const expectedFullName = "Kingdom of Belgium";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Белгија";
          const expectedFullName = "Краљевина Белгија";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "بلجيكا";
          const expectedFullName = "مملكة بلجيكا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Belgia";
          const expectedFullName = "Rouantelezh Belgia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Belgie";
          const expectedFullName = "Belgické království";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Gwlad Belg";
          const expectedFullName = "Teyrnas Gwlad Belg";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Belgien";
          const expectedFullName = "Königreich Belgien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Belgia";
          const expectedFullName = "Belgia Kuningriik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Belgia";
          const expectedFullName = "Belgian kuningaskunta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Belgique";
          const expectedFullName = "Royaume de Belgique";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Belgija";
          const expectedFullName = "Kraljevina Belgija";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Belgium";
          const expectedFullName = "Belga Királyság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Belgio";
          const expectedFullName = "Regno del Belgio";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ベルギー";
          const expectedFullName = "ベルギー王国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "벨기에";
          const expectedFullName = "벨기에 왕국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "België";
          const expectedFullName = "Koninkrijk België";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "بلژیک";
          const expectedFullName = "پادشاهی بلژیک";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Belgia";
          const expectedFullName = "Królestwo Belgii";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Bélgica";
          const expectedFullName = "Reino da Bélgica";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Бельгия";
          const expectedFullName = "Королевство Бельгия";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Belgicko";
          const expectedFullName = "Belgické kráľovstvo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Bélgica";
          const expectedFullName = "Reino de Bélgica";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Belgien";
          const expectedFullName = "Konungariket Belgien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Belçika";
          const expectedFullName = "Belçika Krallığı";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "بلجئیم";
          const expectedFullName = "مملکتِ بلجئیم";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "比利时";
          const expectedFullName = "比利时王国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Belgium nutome";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဘယ်လ်ဂျီယမ်";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Bégíọ́mù";
        ...
        test("has translation for 'ss' locale", () {
          const expectedName = "iBhelijiyamu";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Bégíɔ́mù";
