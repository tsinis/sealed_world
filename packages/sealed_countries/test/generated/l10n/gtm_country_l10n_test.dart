...
void main() => group(
      "$CountryGtm() L10N",
      () {
        const value = CountryGtm();

        test("has translation for 'en' locale", () {
          const expectedName = "Guatemala";
          const expectedFullName = "Republic of Guatemala";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Гватемала";
          const expectedFullName = "Република Гватемала";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "غواتيمالا";
          const expectedFullName = "جمهورية غواتيمالا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Guatemala";
          const expectedFullName = "Republik Guatemala";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Guatemala";
          const expectedFullName = "Republika Guatemala";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Guatemala";
          const expectedFullName = "Guatemala Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Guatemala";
          const expectedFullName = "Guatemalan tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Guatemala";
          const expectedFullName = "République du Guatemala";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Gvatemala";
          const expectedFullName = "Republika Gvatemala";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Guatemala";
          const expectedFullName = "Guatemalai Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Guatemala";
          const expectedFullName = "Repubblica del Guatemala";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "グアテマラ";
          const expectedFullName = "グアテマラ共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "과테말라";
          const expectedFullName = "과테말라 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Guatemala";
          const expectedFullName = "Republiek Guatemala";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "گواتِمالا";
          const expectedFullName = "جمهوری گواتِمالا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Gwatemala";
          const expectedFullName = "Republika Gwatemali";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Guatemala";
          const expectedFullName = "República da Guatemala";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Гватемала";
          const expectedFullName = "Республика Гватемала";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Guatemala";
          const expectedFullName = "Guatemalská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Guatemala";
          const expectedFullName = "República de Guatemala";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Guatemala";
          const expectedFullName = "Republiken Guatemala";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Guatemala";
          const expectedFullName = "Guatemala Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "گواتیمالا";
          const expectedFullName = "جمہوریہ گواتیمالا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "危地马拉";
          const expectedFullName = "危地马拉共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "গুয়াতেমালা";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Guatemala nutome";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Gwaatemalaa";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ក្វាតេម៉ាឡា";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ഗ്വാട്ടിമാല";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Gwatemala";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Guwaatamaala";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "גוואַטעמאַלע";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Guatemala";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Guatemala";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "གུ་ཝེ་ཐི་མ་ལ།";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Ghuatemaley";
        ...
        test("has translation for 'ss' locale", () {
          const expectedName = "IGwathamala";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Veizdimajlah";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Guatemala";
