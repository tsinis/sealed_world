...
void main() => group(
      "$CountryMmr() L10N",
      () {
        const value = CountryMmr();

        test("has translation for 'en' locale", () {
          const expectedName = "Myanmar";
          const expectedFullName = "Republic of the Union of Myanmar";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Мјанмар";
          const expectedFullName = "Република Савез Мјанмара";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "ميانمار";
          const expectedFullName = "جمهورية اتحاد ميانمار";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Myanmar";
          const expectedFullName = "Republik Unaniezh Myanmar";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Myanmar";
          const expectedFullName = "Republika Myanmarský svaz";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Myanmar";
          const expectedFullName = "Republik der Union Myanmar";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Myanmar";
          const expectedFullName = "Myanmari Liidu Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Myanmar";
          const expectedFullName = "Myanmarin liiton tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Birmanie";
          const expectedFullName = "République de l'Union du Myanmar";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Mijanmar";
          const expectedFullName = "Republika Unije Mijanmar";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Mianmar";
          const expectedFullName = "Mianmari Államszövetség Köztársasága";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Birmania";
          const expectedFullName = "Repubblica dell'Unione di Myanmar";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ミャンマー";
          const expectedFullName = "ミャンマー連邦共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "미얀마";
          const expectedFullName = "미얀마 연방 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Myanmar";
          const expectedFullName = "Republiek van de Unie van Myanmar";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "میانمار";
          const expectedFullName = "اتحادیه جمهوری میانمار";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Mjanma";
          const expectedFullName = "Republika Związku Mjanmy";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Myanmar";
          const expectedFullName = "República da União de Myanmar";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Мьянма";
          const expectedFullName = "Республика Союза Мьянма";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Mjanmarsko";
          const expectedFullName = "Mjanmarská zväzová republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Myanmar";
          const expectedFullName = "República de la Unión de Myanmar";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Myanmar";
          const expectedFullName = "Republiken Unionen Myanmar";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Myanmar";
          const expectedFullName = "Myanmar Birliği Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "میانمار";
          const expectedFullName = "متحدہ جمہوریہ میانمار";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "缅甸";
          const expectedFullName = "缅甸联邦共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Mianmar (Birma)";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "ম্যানমাৰ (বাৰ্মা)";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "М’янма (Бірма)";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Мианмар (Бирма)";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "মায়ানমার (বার্মা)";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "Myanmar (Birmània)";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Мьянма (Бирма)";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "མི་ཡཱན་མར་ (བྷར་མ)";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Myanmar (Burma) nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Μιανμάρ (Βιρμανία)";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Myanmar (Birmania)";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Myanmar (Birma)";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Maenmar (Burma)";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "મ્યાંમાર (બર્મા)";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Burma, Miyamar";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "מיאנמר (בורמה)";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "म्यांमार (बर्मा)";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Մյանմա (Բիրմա)";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Mjanmar (Búrma)";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "მიანმარი (ბირმა)";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "មីយ៉ាន់ម៉ា (ភូមា)";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಮಯನ್ಮಾರ್ (ಬರ್ಮಾ)";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "مَیَنما بٔرما";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Myanmar (Birmanya)";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ມຽນມາ (ເບີມາ)";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Mianmaras (Birma)";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Mjanma (Birma)";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Мјанмар (Бурма)";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "മ്യാൻമാർ (ബർമ്മ)";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "म्यानमार (बर्मा)";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Myanmar/Burma";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "म्यान्मार (बर्मा)";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਮਿਆਂਮਾਰ (ਬਰਮਾ)";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "ميانمار (برما)";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "මියන්මාරය (බුරුමය)";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "Mjanmar (Burma)";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Mianmar (Burmë)";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "மியான்மார் (பர்மா)";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "เมียนมาร์ (พม่า)";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Mýanma (Burma)";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Mianimā (Pema)";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Мʼянма (Бірма)";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Myanma (Birma)";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Myanmar (Miến Điện)";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Manamari";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Myanmar (Burma)";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "Myanmar (Burma)";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "EMyanmar (Burma)";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Мианма (Бирма)";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Manamari";
        ...
        test("has translation for 'ro_MD' locale", () {
          const expectedName = "Myanmar";

          final translated = value.maybeTranslation(
            const BasicTypedLocale(LangRon(), country: CountryMda()),
            useLanguageFallback: false,
          );
        ...
        test("has translation for 'mn_Cyrl' locale", () {
          const expectedName = "Мьянмар (Бурма)";
