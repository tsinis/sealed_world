...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'pt_PT' locale", () {
          ...
          final translated = value.maybeTranslation(
            const BasicTypedLocale(LangPor(), country: CountryPrt()),
            useLanguageFallback: false,
          );
        ...
        test("has translation for 'sr_Latn' locale", () {
          ...
          final translated = value.maybeTranslation(
            const BasicTypedLocale(LangSrp(), script: ScriptLatn()),
            useLanguageFallback: false,
          );
        ...
        test("has translation for 'zh_HK' locale", () {
          ...
          final translated = value.maybeTranslation(
            const BasicTypedLocale(LangZho(), country: CountryHkg()),
            useLanguageFallback: false,
          );
        ...
        test("has translation for 'zh_Hant' locale", () {
          ...
          final translated = value.maybeTranslation(
            const BasicTypedLocale(LangZho(), script: ScriptHant()),
            useLanguageFallback: false,
          );
