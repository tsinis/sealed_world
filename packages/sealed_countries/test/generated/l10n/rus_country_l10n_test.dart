...
void main() => group(
      "$CountryRus() L10N",
      () {
        const value = CountryRus();

        test("has translation for 'en' locale", () {
          const expectedName = "Russia";
          const expectedFullName = "Russian Federation";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Русија";
          const expectedFullName = "Руска Федерација";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "روسيا";
          const expectedFullName = "روسيا الاتحادية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Rusia";
          const expectedFullName = "Kevread Rusia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Rusko";
          const expectedFullName = "Ruská federace";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Russland";
          const expectedFullName = "Russische Föderation";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Venemaa";
          const expectedFullName = "Venemaa Föderatsioon";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Venäjä";
          const expectedFullName = "Venäjän federaatio";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Russie";
          const expectedFullName = "Fédération de Russie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Rusija";
          const expectedFullName = "Ruska Federacija";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Oroszország";
          const expectedFullName = "Oroszországi Föderáció";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Russia";
          const expectedFullName = "Federazione russa";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "러시아";
          const expectedFullName = "러시아 연방";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Rusland";
          const expectedFullName = "Russische Federatie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "روسیه";
          const expectedFullName = "فدراسیون روسیه";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Rosja";
          const expectedFullName = "Federacja Rosyjska";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Rússia";
          const expectedFullName = "Federação Russa";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Россия";
          const expectedFullName = "Российская Федерация";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Rusko";
          const expectedFullName = "Ruská federácia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Rusia";
          const expectedFullName = "Federación de Rusia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Ryssland";
          const expectedFullName = "Ryska federationen";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Rusya";
          const expectedFullName = "Rusya Federasyonu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "روس";
          const expectedFullName = "روسی وفاق";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "俄罗斯";
          const expectedFullName = "俄罗斯联邦";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Russia nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Rọṣia";
        ...
        test("has translation for 'av' locale", () {
          const expectedName = "Россиялъул Федерация";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Раççей Патшалăхĕ";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Biʼééʼ Łichííʼí Bikéyah";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Pederasyong Ruso";
        ...
        test("has translation for 'wa' locale", () {
          const expectedName = "Federåcion d' Rûsseye";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Ezlozswh Lienzbangh";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Rɔshia";
