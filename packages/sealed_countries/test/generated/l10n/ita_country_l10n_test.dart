...
void main() => group(
      "$CountryIta() L10N",
      () {
        const value = CountryIta();

        test("has translation for 'en' locale", () {
          const expectedName = "Italy";
          const expectedFullName = "Italian Republic";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Италија";
          const expectedFullName = "Италијанска Република";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "إيطاليا";
          const expectedFullName = "الجمهورية الإيطالية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          ...
          const expectedFullName = "Republik Italia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Itálie";
          const expectedFullName = "Italská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          ...
          const expectedFullName = "Italienische Republik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          ...
          const expectedFullName = "Itaalia Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Italia";
          const expectedFullName = "Italian tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Italie";
          const expectedFullName = "République italienne";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Italija";
          const expectedFullName = "talijanska Republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Olaszország";
          const expectedFullName = "Olasz Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Italia";
          const expectedFullName = "Repubblica italiana";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "イタリア";
          const expectedFullName = "イタリア共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "이탈리아";
          const expectedFullName = "이탈리아 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Italië";
          const expectedFullName = "Italiaanse Republiek";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "ایتالیا";
          const expectedFullName = "جمهوری ایتالیا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Włochy";
          const expectedFullName = "Republika Włoska";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Itália";
          const expectedFullName = "República Italiana";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Италия";
          const expectedFullName = "итальянская Республика";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Taliansko";
          const expectedFullName = "Talianska republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Italien";
          const expectedFullName = "Republiken Italien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "İtalya";
          const expectedFullName = "İtalyan Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "اطالیہ";
          const expectedFullName = "جمہوریہ اطالیہ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "意大利";
          const expectedFullName = "意大利共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Italia nutome";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Ubutaliyani";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Itáli";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "އިޓަލީވިލާތް";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Itáli";
