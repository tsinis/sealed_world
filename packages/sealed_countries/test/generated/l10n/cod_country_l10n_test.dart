...
void main() => group(
      "$CountryCod() L10N",
      () {
        const value = CountryCod();

        test("has translation for 'en' locale", () {
          const expectedName = "DR Congo";
          const expectedFullName = "Democratic Republic of the Congo";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "ДР Конго";
          const expectedFullName = "Демократска Република Конго";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "الكونغو";
          const expectedFullName = "جمهورية الكونغو الديمقراطية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Kongo-Kinshasa";
          const expectedFullName = "Republik Demokratel Kongo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "DR Kongo";
          const expectedFullName = "Demokratická republika Kongo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Gweriniaeth Ddemocrataidd Congo";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Kongo (Dem. Rep.)";
          const expectedFullName = "Demokratische Republik Kongo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Kongo DV";
          const expectedFullName = "Kongo Demokraatlik Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Kongon demokraattinen tasavalta";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Congo (Rép. dém.)";
          const expectedFullName = "République démocratique du Congo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Kongo, Demokratska Republika";
          const expectedFullName = "Demokratska Republika Kongo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Kongói Demokratikus Köztársaság";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Congo (Rep. Dem.)";
          const expectedFullName = "Repubblica Democratica del Congo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Congo (DRC)";
          const expectedFullName = "Democratische Republiek Congo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "کنگو دموکراتیک";
          const expectedFullName = "جمهوری دموکراتیک کنگو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Demokratyczna Republika Konga";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "República Democrática do Congo";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Демократическая Республика Конго";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Kongo";
          const expectedFullName = "Konžská demokratická republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Congo (Rep. Dem.)";
          const expectedFullName = "República Democrática del Congo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Kongo-Kinshasa";
          const expectedFullName = "Demokratiska republiken Kongo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Kongo Demokratik Cumhuriyeti";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "کانگو";
          const expectedFullName = "جمہوری جمہوریہ کانگو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "民主刚果";
          const expectedFullName = "刚果民主共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Demokratiese Republiek van die Kongo";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "কঙ্গো - কিনচাছা";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Konqo - Kinşasa";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Конга (Кіншаса)";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Конго (Киншаса)";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Kongo ka republiki demɔkratiki";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "কঙ্গো-কিনশাসা";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Demokratska Republika Kongo";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Демократин Республика Конго";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "Congo-Kinshasa";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཀོང་གྷོ ཀིན་ཤ་ས";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Kongo Kinshasa nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Κονγκό - Κινσάσα";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Kongoko Errepublika Demokratikoa";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Ndenndaandi Demokaraasiire Konngo";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Kongo, Dem. Lýðveldið";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Poblacht Dhaonlathach an Chongó";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "કોંગો - કિંશાસા";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Jamhuriyar Dimokuraɗiyyar Kongo";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "קונגו - קינשאסה";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "कांगो - किंशासा";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Կոնգո - Կինշասա";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Kongó-Kinshasa";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "კონგო - კინშასა";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Jamhuri ya Kidemokrasia ya Kongo";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "កុងហ្គោ- គីនស្ហាសា";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಕಾಂಗೋ - ಕಿನ್ಶಾಸಾ";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "کونگو کِنشاسا";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Kongo - Kînşasa";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Kongo - Zayire";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Republíki ya Kongó Demokratíki";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ຄອງໂກ - ຄິນຊາຊາ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Kongas-Kinšasa";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Ditunga wa Kongu";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Kongo (Kinšasa)";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Repoblikan’i Kongo";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "കോംഗോ - കിൻഷാസ";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "काँगो - किंशासा";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "ir-Repubblika Demokratika tal-Kongo";
        ...
        test("has translation for 'nd' locale", () {
          const expectedName = "Democratic Republic of the Congo";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "कङ्गो - किन्शासा";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "କଙ୍ଗୋ (ଡିଆରସି)";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਕਾਂਗੋ - ਕਿੰਸ਼ਾਸਾ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "کانګو - کینشاسا";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "Republica Democratica dal Congo";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Repubulika Iharanira Demokarasi ya Kongo";
        ...
        test("has translation for 'sd' locale", () {
          const expectedName = "ڪانگو -ڪنشاسا";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Ködörösêse tî Ngunuhalëzo tî kongö";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "කොංගෝව (ඩීආර්සී)";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "Demokratična republika Kongo";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Jamhuuriyadda Dimuquraadiga Kongo";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "காங்கோ - கின்ஷாசா";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "కాంగో- కిన్షాసా";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "คองโก - กินชาซา";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Kongo - Kinşasa";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Kongo - Kinisasa";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "كونگو - كىنشاسا";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Конго – Кіншаса";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "קאנגא־קינשאַזע";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orilẹ́ède Kóngò";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Congo - Kinshasa";
        ...
        test("has translation for 'an' locale", () {
          const expectedName = "Republica Democratica d'o Congo";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ཀོང་གོ་མི་དམངས་དམངས་གཙོ།";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "República Democràtica del Congo";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Конго Демократиллĕ Республики";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "ކޮންގޯ (ދިމިޤްރާޠީ ޖުމްހޫރިއްޔާ)";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Demokratia Respubliko Kongo";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Poblachd Dheamocrach na Congo";
        ...
        test("has translation for 'gn' locale", () {
          const expectedName = "Tetã Jekopytyjoja Kongo";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Pobblaght Gheynlagh ny Congo";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Republica Democratic del Congo";
        ...
        test("has translation for 'ie' locale", () {
          const expectedName = "Democratic Republic de Congo";
        ...
        test("has translation for 'io' locale", () {
          const expectedName = "Demokratial Republiko Kongo";
        ...
        test("has translation for 'kg' locale", () {
          const expectedName = "Repubilika ya Kongo ya Dimokalasi";
        ...
        test("has translation for 'kw' locale", () {
          const expectedName = "Repoblek Werinel Kongo";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Respublica Democratica Congensis";
        ...
        test("has translation for 'li' locale", () {
          const expectedName = "Democratische Rippebliek vaan de Kongo";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Te Whenua o Kōngo";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Republik Demokratik Congo";
        ...
        test("has translation for 'na' locale", () {
          const expectedName = "Ripubrikit Engame Kongo";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Kéyah Káango Shádiʼááhjí Siʼánígíí";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Republica Democratica de Còngo";
        ...
        test("has translation for 'os' locale", () {
          const expectedName = "Конгойы Демократон Республикæ";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Republica Democrată Congo";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Repùbrica Democràtiga de su Congo";
        ...
        test("has translation for 'su' locale", () {
          const expectedName = "Républik Démokratik Kongo";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Demokratikong Republika ng Konggo";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Конго Демократик Җөмһүрияте";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Cộng hòa Dân chủ Congo";
        ...
        test("has translation for 'vo' locale", () {
          const expectedName = "Kongoän (Repüblikän Demokratik)";
        ...
        test("has translation for 'wa' locale", () {
          const expectedName = "Republike democratike do Congo";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Republik Demokaraatik bu Kongóo";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Ganggoj Minzcuj Gunghozgoz";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "ECongo -Kinshasa";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Демократска Република Конго";
        ...
        test("has translation for 'ks_Arab' locale", () {
          const expectedName = "کونٛگو کِنشاسا";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orilɛ́ède Kóngò";
