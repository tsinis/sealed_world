...
void main() => group(
      "$CountrySpm() L10N",
      () {
        const value = CountrySpm();

        test("has translation for 'en' locale", () {
          const expectedName = "Saint Pierre and Miquelon";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Сен Пјер и Микелон";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "سان بيير وميكلون";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Sant-Pêr-ha-Mikelon";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Saint-Pierre a Miquelon";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "St. Pierre und Miquelon";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Saint-Pierre ja Miquelon";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Saint-Pierre-et-Miquelon";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Sveti Petar i Mikelon";
          const expectedFullName = "Saint Pierre i Miquelon";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Saint-Pierre és Miquelon";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Saint-Pierre e Miquelon";
          const expectedFullName = "Saint Pierre e Miquelon";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "サンピエール島・ミクロン島";
          const expectedFullName = "サンピエール島·ミクロン島";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Saint Pierre en Miquelon";
          const expectedFullName = "Saint-Pierre en Miquelon";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "سن-پیِر و میکلُن";
          const expectedFullName = "سن-پیر-ا-میکلون";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Saint-Pierre i Miquelon";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Сен-Пьер и Микелон";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Saint Pierre a Miquelon";
          const expectedFullName = "Ostrovy Saint Pierre a Miquelon";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "San Pedro y Miquelón";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Saint-Pierre och Miquelon";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Saint Pierre ve Miquelon";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "سینٹ پیئر و میکیلون";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Sint Pierre en Miquelon";
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Saint Pierre ne Miquelon";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "ቅዱስ ፒዬር እና ሚኩኤሎን";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "ছেইণ্ট পিয়েৰে আৰু মিকিউৱেলন";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Müqəddəs Pyer və Mikelon";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Сен-П’ер і Мікелон";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Сен Пиер и Микелон";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Piyɛri-Senu-ni-Mikelɔŋ";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "সেন্ট পিয়ের ও মিকুয়েলন";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Сен-Пьер а, Микелон а";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "Saint Pierre og Miquelon";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "སིནཊ་པི་ཡེར་ ཨེནཌ་ མིཀོ་ལེན";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Saint Pierre kple Mikelɔn nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Σεν Πιερ και Μικελόν";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Sent-Piero kaj Mikelono";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Saint-Pierre eta Mikelune";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "See Piyeer e Mikeloo";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Saint Pierre & Miquelon";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "San Pierre agus Miquelon";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Saint Pierre agus Miquelon";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "સેંટ પીએરી અને મિક્યુલોન";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "San Piyar Da Mikelan";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "סנט פייר ומיקלון";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "सेंट पिएरे और मिक्वेलान";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Սեն Պիեռ և Միքելոն";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "St. Pierre e Miquelon";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Saint Pierre dan Miquelon";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Sankti Pierre og Miquelon";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Saint Pièr lan Mikuélon";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "სენ-პიერი და მიკელონი";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Santapieri na Mikeloni";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Сен-Пьер және Микелон";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "សង់ព្យែរ និង​មីគីឡុង";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಸೇಂಟ್ ಪಿಯರ್ ಮತ್ತು ಮಿಕ್ವೆಲನ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "سینٹ پیٖری تہٕ موکیلِیَن";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Saint-Pierre û Miquelon";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Сен-Пьер жана Микелон";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "St. Pierre a Miquelon";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Senti Piyere ne Mikeloni";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Sántu pététo mpé Mikelɔ";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ເຊນ ປີແອ ມິເກວລອນ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Sen Pjeras ir Mikelonas";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Santu pététo ne Mikelu";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Senpjēra un Mikelona";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Сент Пјер и Микелан";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "സെന്റ് പിയറി ആൻഡ് മിക്വലൻ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Сент-Пьер ба Микело";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "सेंट पियरे आणि मिक्वेलोन";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "Saint Pierre u Miquelon";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "စိန့်ပီအဲရ်နှင့် မီကွီလွန်";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "सेन्ट पिर्रे र मिक्केलोन";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ସେଣ୍ଟ ପିଏରେ ଏବଂ ମିକ୍ୱେଲନ୍‌";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਸੇਂਟ ਪੀਅਰੇ ਐਂਡ ਮਿਕੇਲਨ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "سینټ پییر او میکولون";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Sempiyeri na Mikeloni";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Saint-Pierre și Miquelon";
        ...
        test("has translation for 'sd' locale", () {
          const expectedName = "سینٽ پیئر و میڪوئیلون";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Sên-Pyêre na Mikelöon";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ශාන්ත පියරේ සහ මැකෝලන්";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "Saint Pierre in Miquelon";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Shën-Pier dhe Mikelon";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Santapierre na Miquelon";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "செயின்ட் பியர் & மிக்வேலான்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "సెయింట్ పియెర్ మరియు మికెలాన్";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Сент-Пер ва Микелон";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "แซงปีแยร์และมีเกอลง";
        ...
        test("has translation for 'ti' locale", () {
          const expectedName = "ቅዱስ ፒዬርን ሚኩኤሎን";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Sen-Pýer we Mikelon";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Sā Piea mo Mikeloni";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Сен-Пьер һәм Микелон";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ساينت پىيېر ۋە مىكېلون ئاراللىرى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Сен-Пʼєр і Мікелон";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Sen-Pyer va Mikelon";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Saint Pierre và Miquelon";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Saŋ Peer ak Mikeloŋ";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Pẹẹri ati mikuloni";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Saint Pierre kanye ne-Miquelon";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Сен-Пьер & Микелон";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Pierre na Miquelon Dị nsọ";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Hato Piere & Mikerona";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Santu Predu e Miquelon";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "St. Pierre & Miquelon";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "ESt. Pierre & Miquelon";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Сен-Пиери Микелони";
        ...
        test("has translation for 'an' locale", () {
          const expectedName = "Saint-Pierre y Miquelon";
        ...
        test("has translation for 'kl' locale", () {
          const expectedName = "Saint Pierre aamma Miquelon";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Insulae Sancti Petri et Miquelonensis";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Sant Pèire e Miquelon";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Мүгәддәс Пјер вә Микелон";
        ...
        test("has translation for 'ks_Arab' locale", () {
          const expectedName = "سینٛٹ پیٖری تہٕ موکیلِیَن";
        ...
        test("has translation for 'mn_Cyrl' locale", () {
          const expectedName = "Сэнт Пьер ба Микелон";
        ...
        test("has translation for 'ug_Arab' locale", () {
          const expectedName = "ساينىت-پىئېر ۋە مىكېلون ئاراللىرى";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Сент-Пьер ва Микелон";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Pɛɛri ati mikuloni";
