...
void main() => group(
      "$CountryTza() L10N",
      () {
        const value = CountryTza();

        test("has translation for 'en' locale", () {
          const expectedName = "Tanzania";
          const expectedFullName = "United Republic of Tanzania";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Танзанија";
          const expectedFullName = "Уједињена Република Танзанија";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "تنزانيا";
          const expectedFullName = "جمهورية تنزانيا الاتحادية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Tanzania";
          const expectedFullName = "Republik Unanet Tanzania";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Tanzanie";
          const expectedFullName = "Sjednocená tanzanská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Tansania";
          const expectedFullName = "Vereinigte Republik Tansania";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Tansaania";
          const expectedFullName = "Tansaania Ühendvabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Tansania";
          const expectedFullName = "Tansanian yhdistynyt tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Tanzanie";
          const expectedFullName = "République -Unie de Tanzanie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Tanzanija";
          const expectedFullName = "Ujedinjena Republika Tanzanija";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Tanzania";
          const expectedFullName = "Repubblica Unita di Tanzania";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "タンザニア";
          const expectedFullName = "タンザニア連合共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "탄자니아";
          const expectedFullName = "탄자니아 연합 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Tanzania";
          const expectedFullName = "Verenigde Republiek Tanzania";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "تانزانیا";
          const expectedFullName = "جمهوری متحد تانزانیا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Tanzania";
          const expectedFullName = "Zjednoczona Republika Tanzanii";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Tanzânia";
          const expectedFullName = "República Unida da Tanzânia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Танзания";
          const expectedFullName = "Объединенная Республика Танзания";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Tanzánia";
          const expectedFullName = "Tanzánijská zjednotená republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Tanzania";
          const expectedFullName = "República Unida de Tanzania";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Tanzania";
          const expectedFullName = "Förenade republiken Tanzania";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Tanzanya";
          const expectedFullName = "Tanzanya Birleşik Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "تنزانیہ";
          const expectedFullName = "متحدہ جمہوریہ تنزانیہ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "坦桑尼亚";
          const expectedFullName = "坦桑尼亚联合共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "তাঞ্জানিয়া";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཊཱན་ཛཱ་ནི་ཡ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Tanzania nutome";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "it-Tanzanija";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "တန်ဇန်းနီးယား";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ටැන්සානියාව";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Tàǹsáníà";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Tʼanzanííya";
        ...
        test("has translation for 'ss' locale", () {
          const expectedName = "IThanzaniya";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Dajsanghnizya";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Tàǹsáníà";
