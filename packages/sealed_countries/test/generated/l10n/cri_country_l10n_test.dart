...
void main() => group(
      "$CountryCri() L10N",
      () {
        const value = CountryCri();

        test("has translation for 'en' locale", () {
          const expectedName = "Costa Rica";
          const expectedFullName = "Republic of Costa Rica";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Костарика";
          const expectedFullName = "Република Костарика";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "كوستاريكا";
          const expectedFullName = "جمهورية كوستاريكا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Costa Rica";
          const expectedFullName = "Republik Costa Rica";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Kostarika";
          const expectedFullName = "Kostarická republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Costa Rica";
          const expectedFullName = "Gweriniaeth Costa Rica";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Costa Rica";
          const expectedFullName = "Costa Rica Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Costa Rica";
          const expectedFullName = "Costa Rican tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Costa Rica";
          const expectedFullName = "République du Costa Rica";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Kostarika";
          const expectedFullName = "Republika Kostarika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Costa Rica";
          const expectedFullName = "Costa Rica-i Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Costa Rica";
          const expectedFullName = "Repubblica di Costa Rica";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "コスタリカ";
          const expectedFullName = "コスタリカ共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "코스타리카";
          const expectedFullName = "코스타리카 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Costa Rica";
          const expectedFullName = "Republiek Costa Rica";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "کاستاریکا";
          const expectedFullName = "جمهوری کاستاریکا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Kostaryka";
          const expectedFullName = "Republika Kostaryki";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Costa Rica";
          const expectedFullName = "República da Costa Rica";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Коста-Рика";
          const expectedFullName = "Республика Коста-Рика";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Costa Rica";
          const expectedFullName = "República de Costa Rica";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Costa Rica";
          const expectedFullName = "Republiken Costa Rica";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Kosta Rika";
          const expectedFullName = "Kosta Rika Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "کوسٹاریکا";
          const expectedFullName = "جمہوریہ کوسٹاریکا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "哥斯达黎加";
          const expectedFullName = "哥斯达黎加共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "কোষ্টা ৰিকা";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Kosta Rika nutome";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Kosta Rikaa";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Costa Rìcea";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "કોસ્ટા રિકા";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Kwasta Rika";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಕೊಸ್ಟಾ ರಿಕಾ";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Kosita Rika";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "കോസ്റ്ററിക്ക";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "कोस्टा रिका";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Costa Rica";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ကို့စ်တာရီကာ";
        ...
        test("has translation for 'nd' locale", () {
          const expectedName = "Khosta Rikha";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "କୋଷ୍ଟା ରିକା";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Kosta Riika";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "కోస్టా రికా";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Kosita Lika";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "קאסטאַ ריקאַ";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Kuusita Ríkà";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Costa Rica";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ཁོ་ས་ཏ་རི་ཁ";
        ...
        test("has translation for 'gn' locale", () {
          const expectedName = "Kosta Rrika";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Coose Berçhagh";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Ora Opulenta";
        ...
        test("has translation for 'om' locale", () {
          const expectedName = "Kostaa Rikaa";
        ...
        test("has translation for 'pi' locale", () {
          const expectedName = "कोस्टा रीका";
        ...
        test("has translation for 'ss' locale", () {
          const expectedName = "IKhosta-Likha";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "ECosta Rica";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Gohswhdazlizgyah";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Kuusita Ríkà";
