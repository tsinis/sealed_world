...
void main() => group(
      "$CountryNld() L10N",
      () {
        const value = CountryNld();

        test("has translation for 'en' locale", () {
          const expectedName = "Netherlands";
          const expectedFullName = "Kingdom of the Netherlands";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Холандија";
          const expectedFullName = "Краљевина Холандија";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "هولندا";
          const expectedFullName = "مملكة هولندا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Izelvroioù";
          const expectedFullName = "Rouantelezh an Izelvroioù";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Nizozemsko";
          const expectedFullName = "Nizozemské království";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Niederlande";
        ...
        test("has translation for 'et' locale", () {
          ...
          const expectedFullName = "Madalmaade Kuningriik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Nizozemska";
          const expectedFullName = "Holandija";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Hollandia";
          const expectedFullName = "Holland Királyság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Paesi Bassi";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "네덜란드";
          const expectedFullName = "네덜란드 왕국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Holandia";
          const expectedFullName = "Królestwo Niderlandów";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Holansko";
          const expectedFullName = "Holandské kráľovstvo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Países Bajos";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Nederländerna";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "نیدرلینڈز";
          const expectedFullName = "مملکتِ نیدرلینڈز";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Нидерландия";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "নেদারল্যান্ডস";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "Països Baixos";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Нидерландаш";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ནེ་དར་ལནཌས྄";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Netherlands nutome";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Herbehereak";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Nederlannda";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Na Tìrean Ìsle";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Países Baixos";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "નેધરલેન્ડ્સ";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Նիդեռլանդներ";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Nederlandia";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ნიდერლანდები";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ನೆದರ್‌ಲ್ಯಾಂಡ್ಸ್";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Nyderlandai";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "നെതർലാൻഡ്‌സ്";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "in-Netherlands";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "नेदरल्याण्ड";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ନେଦରଲ୍ୟାଣ୍ଡ";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "Pajais Bass";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Țările de Jos";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Vuolleeatnamat";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Nederlaands";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "நெதர்லாந்து";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "నెదర్లాండ్స్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "เนเธอร์แลนด์";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Niderlandlar";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Niderlandiya";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Nedalandi";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Netherlands";
        ...
        test("has translation for 'ay' locale", () {
          const expectedName = "Aynacha Jach'a Markanaka";
        ...
        test("has translation for 'ba' locale", () {
          const expectedName = "Нидерландтар";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Нидерландсем";
        ...
        test("has translation for 'gn' locale", () {
          const expectedName = "Tetãnguéra Yvýi";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Çheer Injil";
        ...
        test("has translation for 'kv' locale", () {
          const expectedName = "Нидерландъяс";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Tsin Bikeeʼ Dineʼé Bikéyah";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Païses Basses";
        ...
        test("has translation for 'os' locale", () {
          const expectedName = "Нидерландтæ";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Logos Bascios";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "ENetherlands";
        ...
        test("has translation for 'ks_Arab' locale", () {
          const expectedName = "نیٖدَرلینٛڑ";
        ...
        test("has translation for 'ky_Cyrl' locale", () {
          const expectedName = "Нидерланддар";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Nedalandi";
