...
void main() => group(
      "$CountryGrc() L10N",
      () {
        const value = CountryGrc();

        test("has translation for 'en' locale", () {
          const expectedName = "Greece";
          const expectedFullName = "Hellenic Republic";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Грчка";
          const expectedFullName = "Хеленска Република";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "اليونان";
          const expectedFullName = "الجمهورية الهيلينية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Gres";
          const expectedFullName = "Republik Hellenek";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Řecko";
          const expectedFullName = "Řecká republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Griechenland";
          const expectedFullName = "Hellenische Republik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          ...
          const expectedFullName = "Kreeka Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          ...
          const expectedFullName = "Helleenien tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Grèce";
          const expectedFullName = "République hellénique";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Grčka";
          const expectedFullName = "Helenska Republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Görögország";
          const expectedFullName = "Görög Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Grecia";
          const expectedFullName = "Repubblica ellenica";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ギリシャ";
          const expectedFullName = "ギリシャ共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "그리스";
          const expectedFullName = "그리스 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Griekenland";
          const expectedFullName = "Helleense Republiek";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "یونان";
          const expectedFullName = "جمهوری یونان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Grecja";
          const expectedFullName = "Republika Grecka";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Grécia";
          const expectedFullName = "República Helénica";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Греция";
          const expectedFullName = "Греческая Республика";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Greécko";
          const expectedFullName = "Grécka republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Grekland";
          const expectedFullName = "Republiken Grekland";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Yunanistan";
          const expectedFullName = "Helen Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "یونان";
          const expectedFullName = "جمہوریہ ہیلینیہ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "希腊";
          const expectedFullName = "希腊共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Greece nutome";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Yewnanistan";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Griicheland";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Bugereeki/Buyonaani";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Geriisi";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Барзентәыла";
        ...
        test("has translation for 'kl' locale", () {
          const expectedName = "Grækerit Nunaat";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Gwíík Dineʼé Bikéyah";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Geriisi";
