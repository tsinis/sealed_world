...
void main() => group(
      "$CountryTwn() L10N",
      () {
        const value = CountryTwn();

        test("has translation for 'en' locale", () {
          const expectedName = "Taiwan";
          const expectedFullName = "Republic of China (Taiwan)";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Тајван";
          const expectedFullName = "Република Кина";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "تايوان";
          const expectedFullName = "جمهورية الصين (تايوان)";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Taiwan";
          const expectedFullName = "Republik Sina (Taiwan)";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Tchaj-wan";
          const expectedFullName = "Čínská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Taiwan";
          const expectedFullName = "Republik China (Taiwan)";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Taiwan";
          const expectedFullName = "Taiwani";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Taiwan";
          const expectedFullName = "Kiinan tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Taïwan";
          const expectedFullName = "République de Chine (Taïwan)";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Tajvan";
          const expectedFullName = "Republika Kina";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Tajvan";
          const expectedFullName = "Kínai Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Taiwan";
          const expectedFullName = "Repubblica cinese (Taiwan)";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "台湾";
          const expectedFullName = "中華民国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "대만";
          const expectedFullName = "중화민국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Taiwan";
          const expectedFullName = "Republiek China (Taiwan)";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "تایوان";
          const expectedFullName = "جمهوری چین";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Tajwan";
          const expectedFullName = "Republika Chińska (Tajwan)";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Ilha Formosa";
          const expectedFullName = "República da China";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Тайвань";
          const expectedFullName = "Китайская Республика";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Taiwan";
          const expectedFullName = "Čínska republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Taiwán";
          const expectedFullName = "República de China en Taiwán";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Taiwan";
          const expectedFullName = "Republiken Kina";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Tayvan";
          const expectedFullName = "Çin Cumhuriyeti (Tayvan)";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "تائیوان";
          const expectedFullName = "جمہوریہ چین (تائیوان)";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "台灣";
          const expectedFullName = "中華民國";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Taiwan nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Taiwani";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "ޖުމްހޫރީ ޗައިނާ";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Taiwani";
