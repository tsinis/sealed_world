...
void main() => group(
      "$CountryPan() L10N",
      () {
        const value = CountryPan();

        test("has translation for 'en' locale", () {
          const expectedName = "Panama";
          const expectedFullName = "Republic of Panama";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Панама";
          const expectedFullName = "Република Панама";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "بنما";
          const expectedFullName = "جمهورية بنما";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Panama";
          const expectedFullName = "Republik Panama";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Panama";
          const expectedFullName = "Panamská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Panama";
          const expectedFullName = "Panama Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Panama";
          const expectedFullName = "Panaman tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Panama";
          const expectedFullName = "République du Panama";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Panama";
          const expectedFullName = "Republika Panama";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Panama";
          const expectedFullName = "Panamai Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Panama";
          const expectedFullName = "Repubblica di Panama";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "パナマ";
          const expectedFullName = "パナマ共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "파나마";
          const expectedFullName = "파나마 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Panama";
          const expectedFullName = "Republiek Panama";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "پاناما";
          const expectedFullName = "جمهوری پاناما";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Panama";
          const expectedFullName = "Republika Panamy";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Panamá";
          const expectedFullName = "República do Panamá";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Панама";
          const expectedFullName = "Республика Панама";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Panamá";
          const expectedFullName = "República de Panamá";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Panama";
          const expectedFullName = "Republiken Panama";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Panama";
          const expectedFullName = "Panama Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "پاناما";
          const expectedFullName = "جمہوریہ پاناما";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "巴拿马";
          const expectedFullName = "巴拿马共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Panama nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Panama";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Phanamaa";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Panama";
