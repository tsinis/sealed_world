...
void main() => group(
      "$CountryNer() L10N",
      () {
        const value = CountryNer();

        test("has translation for 'en' locale", () {
          const expectedName = "Niger";
          const expectedFullName = "Republic of Niger";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Нигер";
          const expectedFullName = "Република Нигер";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "النيجر";
          const expectedFullName = "جمهورية النيجر";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Niger";
          const expectedFullName = "Republik Niger";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Niger";
          const expectedFullName = "Nigerská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Niger";
          const expectedFullName = "Nigeri Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Niger";
          const expectedFullName = "Nigerin tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Niger";
          const expectedFullName = "République du Niger";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Niger";
          const expectedFullName = "Republika Niger";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Niger";
          const expectedFullName = "Nigeri Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Niger";
          const expectedFullName = "Repubblica del Niger";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ニジェール";
          const expectedFullName = "ニジェール共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "니제르";
          const expectedFullName = "니제르 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Niger";
          const expectedFullName = "Republiek Niger";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "نیجر";
          const expectedFullName = "جمهوری نیجر";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Niger";
          const expectedFullName = "Republika Nigru";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Níger";
          const expectedFullName = "República do Níger";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Нигер";
          const expectedFullName = "Республика Нигер";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Niger";
          const expectedFullName = "Nigérská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Níger";
          const expectedFullName = "República de Níger";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Niger";
          const expectedFullName = "Republiken Niger";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Nijer";
          const expectedFullName = "Nijer Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "نائجر";
          const expectedFullName = "جمہوریہ نائجر";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "尼日尔";
          const expectedFullName = "尼日尔共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Niger nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Nàìjá";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Res publica Nigritana";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Nàìjá";
