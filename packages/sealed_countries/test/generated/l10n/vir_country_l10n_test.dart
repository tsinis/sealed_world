...
void main() => group(
      "$CountryVir() L10N",
      () {
        const value = CountryVir();

        test("has translation for 'en' locale", () {
          const expectedName = "United States Virgin Islands";
          const expectedFullName = "Virgin Islands of the United States";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Америчка Девичанска Острва";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "جزر العذراء الامريكية";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Inizi Gwerc'h ar Stadoù-Unanet";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Americké Panenské ostrovy";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Amerikanische Jungferninseln";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Neitsisaared, USA";
          const expectedFullName = "Ühendriikide Neitsisaared";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Neitsytsaaret";
          const expectedFullName = "Yhdysvaltain Neitsytsaaret";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Îles Vierges des États-Unis";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Američki Djevičanski Otoci";
          const expectedFullName = "Djevičanski Otoci SAD";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Amerikai Virgin-szigetek";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Isole Vergini americane";
          const expectedFullName = "Isole Vergini degli Stati Uniti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "アメリカ領ヴァージン諸島";
          const expectedFullName = "米国のバージン諸島";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Amerikaanse Maagdeneilanden";
          const expectedFullName = "Maagdeneilanden van de Verenigde Staten";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "جزایر ویرجین ایالات متحده آمریکا";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Wyspy Dziewicze Stanów Zjednoczonych";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Ilhas Virgens dos Estados Unidos";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Виргинские Острова";
          const expectedFullName = "Виргинские острова Соединенных Штатов";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Islas Vírgenes de los Estados Unidos";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Amerikanska Jungfruöarna";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "ABD Virjin Adaları";
          const expectedFullName = "Amerika Birleşik Devletleri Virjin Adaları";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "امریکی جزائر ورجن";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "VSA se Maagde-eilande";
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Amɛrika Virgin Islands";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የአሜሪካ ቨርጂን ደሴቶች";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "ইউ. এছ. ভাৰ্জিন দ্বীপপুঞ্জ";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "ABŞ Virgin adaları";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Амерыканскія Віргінскія астравы";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Американски Вирджински острови";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Ameriki ka Sungurunnin Gun";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "মার্কিন যুক্তরাষ্ট্রের ভার্জিন দ্বীপপুঞ্জ";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Američka Djevičanska ostrva";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "Illes Verges Nord-americanes";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Виргинийн гӀайренаш (АЦШ)";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "De Amerikanske Jomfruøer";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཝརཇིན་གླིང་ཚོམ་ ཡུ་ཨེས་ཨེ་མངའ་ཁོངས";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "U.S. Vɛrgin ƒudomekpowo nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Αμερικανικές Παρθένες Νήσοι";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Usonaj Virgulininsuloj";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Birjina uharte amerikarrak";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Duuɗe Kecce Amerik";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Sambandsríki Amerikas Jomfrúoyggjar";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Amerikaanske Maagdeneilannen";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Oileáin Mheiriceánacha na Maighdean";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Eileanan na Maighdinn aig na SA";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Illas Virxes Estadounidenses";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "યુએસ વર્જિન આઇલેન્ડ્સ";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Tsibiran Birjin Ta Amurka";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "איי הבתולה של ארצות הברית";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "यू॰एस॰ वर्जिन द्वीपसमूह";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "ԱՄՆ Վիրջինյան կղզիներ";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Kepulauan Virgin Amerika Serikat";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Agwaetiti Virgin nke US";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Bandarísku Jómfrúaeyjar";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Kapuloan Virgin Amérika";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "აშშ-ის ვირჯინის კუნძულები";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Visiwa vya Virgin vya Marekani";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "АҚШ-тың Виргин аралдары";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "កោះ​វឺជីន​អាមេរិក";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಯು.ಎಸ್. ವರ್ಜಿನ್ ದ್ವೀಪಗಳು";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "یوٗ ایس ؤرجِن جٔزیٖرٕ";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Виргин аралдары (АКШ)";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Amerikanesch Joffereninselen";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Bizinga bya Virigini eby’Amerika";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Bisanga bya Vierzi ya Ameriki";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ໝູ່ເກາະ ເວີຈິນ ຂອງສະຫະລັດ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Jungtinių Valstijų Mergelių Salos";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Lutanda lua Vierzi wa Ameriki";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "ASV Virdžīnas";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Nosy Virijiny Etazonia";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Американски Девствени Острови";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "യു.എസ്. വെർജിൻ ദ്വീപുകൾ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "АНУ-ын Виржиний арлууд";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "यू.एस. व्हर्जिन बेटे";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Kepulauan Virgin A.S.";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Gżejjer Verġni tal-Istati Uniti";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ယူအက်စ် ဗာဂျင်း ကျွန်းစု";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "De amerikanske jomfruøyene";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "संयुक्त राज्य भर्जिन टापुहरु";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "Dei amerikanske Jomfruøyane";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଯୁକ୍ତରାଷ୍ଟ୍ର ଭିର୍ଜିନ୍ ଦ୍ଵୀପପୁଞ୍ଜ";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਯੂ ਐੱਸ ਵਰਜਿਨ ਟਾਪੂ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "د متحده آيالاتو ورجن ټاپوګان";
        ...
        test("has translation for 'qu' locale", () {
          const expectedName = "EE.UU. Islas Vírgenes";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "Inslas Virginas Americanas";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Amazinga y’Isugi y’Abanyamerika";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Insulele Virgine Americane";
        ...
        test("has translation for 'sd' locale", () {
          const expectedName = "آمريڪي ورجن ٻيٽ";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "AOS Virgin-sullot";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Âzûâ Virîgo tî Amerîka";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ඇමරිකානු වර්ජින් දූපත්";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "Ameriški Deviški otoki";
        ...
        test("has translation for 'sn' locale", () {
          const expectedName = "Zvitsuwa zveAmerika";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "U.S Fargin Island";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Ishujt e Virgjër të SHBA-së";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "யூ.எஸ். கன்னித் தீவுகள்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "యు.ఎస్. వర్జిన్ దీవులు";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Ҷазираҳои Виргини ИМА";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "หมู่เกาะเวอร์จินของสหรัฐอเมริกา";
        ...
        test("has translation for 'ti' locale", () {
          const expectedName = "ቨርጂን ደሴታት ኣሜሪካ";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "ABŞ-nyň Wirgin adalary";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "ʻOtumotu Vilikini fakaʻamelika";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "АКШ Виргин утраулары";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ئا ق ش ۋىرگىن ئاراللىرى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Віргінські острови, США";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "AQSH Virgin orollari";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Quần đảo Virgin thuộc Mỹ";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Duni Wirsin yu Etaa-sini";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Etikun Fagini ti Amẹrika";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-U.S. Virgin Islands";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Виргини утравӗсем (АПШ)";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Insulas Virgine statounitese";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Giravên Vîrjînê yên Amerîkayê";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Ngā Moutere Puhi Amerika";
        ...
        test("has translation for 'nd' locale", () {
          const expectedName = "U.S. Virgin Islands";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Ìsulas Vèrgines de sos Istados Unidos";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "E-U.S. Virgin Islands";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Виргинтәи ад-хақәа (ЕАШ)";
        ...
        test("has translation for 'an' locale", () {
          const expectedName = "Islas Virchens Norte-americanas";
        ...
        test("has translation for 'ie' locale", () {
          const expectedName = "Insules Vírginas (USA)";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Virginis Insulae Americanae";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Illas Verges estatsunidencas";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "АБШ Вирҝин адалары";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Америчка Дјевичанска острва";
        ...
        test("has translation for 'ug_Arab' locale", () {
          const expectedName = "ئامېرىكا تەۋەلىكىدىكى ۋىرجىن تاقىم ئاراللىرى";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "АҚШ Виргин ороллари";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Etikun Fagini ti Amɛrika";
