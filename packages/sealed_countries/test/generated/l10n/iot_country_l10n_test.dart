...
void main() => group(
      "$CountryIot() L10N",
      () {
        const value = CountryIot();

        test("has translation for 'en' locale", () {
          const expectedName = "British Indian Ocean Territory";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Британска територија Индијског океана";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "إقليم المحيط الهندي البريطاني";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Tiriad breizhveurat Meurvor Indez";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Britské indickooceánské území";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Tiriogaeth Brydeinig Cefnfor India";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Britisches Territorium im Indischen Ozean";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Briti India ookeani ala";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Brittiläinen Intian valtameren alue";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Territoire britannique de l'océan Indien";
          const expectedFullName = "Territoire britannique de l' océan Indien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Britanski Indijskooceanski teritorij";
          const expectedFullName = "British Indian Ocean Territory";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Brit Indiai-óceáni Terület";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Territorio britannico dell'oceano indiano";
          const expectedFullName = "Territorio britannico dell'Oceano Indiano";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "イギリス領インド洋地域";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "인도";
          const expectedFullName = "인도 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Britse Gebieden in de Indische Oceaan";
          const expectedFullName = "Brits Indische Oceaan Territorium";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "قلمرو بریتانیا در اقیانوس هند";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Brytyjskie Terytorium Oceanu Indyjskiego";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Território Britânico do Oceano Índico";
          const expectedFullName = "British Indian Ocean Territory";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Британская территория в Индийском океане";
          const expectedFullName = "Британская территория Индийского океана";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Britské indickooceánske územie";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Territorio Británico del Océano Índico";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Brittiska territoriet i Indiska Oceanen";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Britanya Hint Okyanusu Toprakları";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "برطانوی بحرہند خطہ";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Brits-Indiese Oseaangebied";
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Britenfo Hɔn Man Wɔ India Po No Mu";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የብሪታኒያ ህንድ ውቂያኖስ ግዛት";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "ব্ৰিটিছ ইণ্ডিয়ান অ’চন টেৰিট’ৰি";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Britaniyanın Hind Okeanı Ərazisi";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Брытанская тэрыторыя ў Індыйскім акіяне";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Британска територия в Индийския океан";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Angilɛ ka ɛndu dugukolo";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "ব্রিটিশ ভারত মহাসাগরীয় অঞ্চল";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Britanska Teritorija u Indijskom Okeanu";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "Territori Britànic de l’Oceà Índic";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Британин латта Индин океанехь";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "བྲི་ཊིཤ་རྒྱ་གར་གྱི་རྒྱ་མཚོ་ས་ཁོངས";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Britaintɔwo ƒe india ƒudome nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Βρετανικά Εδάφη Ινδικού Ωκεανού";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Brita Hindoceana Teritorio";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Indiako Ozeanoko lurralde britainiarra";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Keeriindi britaani to maayo enndo";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Stóra Bretlands Indiahavoyggjar";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Britse Gebieden yn de Indyske Oseaan";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Críoch Aigéan Indiach na Breataine";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Ranntair Breatannach Cuan nan Innseachan";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Territorio Británico do Océano Índico";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "બ્રિટિશ ઇન્ડિયન ઓશન ટેરિટરી";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Yankin Birtaniya Na Tekun Indiya";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "הטריטוריה הבריטית באוקיינוס ההודי";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "ब्रिटिश हिंद महासागरीय क्षेत्र";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Բրիտանական Տարածք Հնդկական Օվկիանոսում";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Territorio oceanic britanno-indian";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Wilayah Inggris di Samudra Hindia";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Bresku Indlandshafseyjar";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Wilayah Inggris nang Segoro Hindia";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ბრიტანეთის ტერიტორია ინდოეთის ოკეანეში";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Eneo la Uingereza katika Bahari Hindi";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Үнді мұхитындағы Британ аймағы";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ដែនដី​អង់គ្លេស​នៅ​មហា​សមុទ្រ​ឥណ្ឌា";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಬ್ರಿಟೀಷ್ ಹಿಂದೂ ಮಹಾಸಾಗರದ ಪ್ರದೇಶ";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "برطانوی بحرِ ہِندۍ علاقہٕ";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "Det Britiske Territorium i Det Indiske Ocean";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Инди океанындагы Британ территориясы";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Britescht Territorium am Indeschen Ozean";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Bizinga by’eCago";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Mabelé ya Angɛlɛtɛ́lɛ na mbú ya Indiya";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ເຂດແດນອັງກິດໃນມະຫາສະມຸດອິນເດຍ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Indijos Vandenyno Britų Sritis";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Lutanda lwa Angeletele ku mbu wa Indiya";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Indijas okeāna Britu teritorija";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Faridranomasina indiana britanika";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Британска Индоокеанска Територија";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ബ്രിട്ടീഷ് ഇന്ത്യൻ മഹാസമുദ്ര പ്രദേശം";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "ब्रिटिश हिंदी महासागर क्षेत्र";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Wilayah Lautan Hindi British";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "Territorju Brittaniku tal-Oċean Indjan";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဗြိတိသျှပိုင် အိန္ဒိယသမုဒ္ဒရာကျွန်းများ";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "Det britiske territoriet i Indiahavet";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "बेलायती हिन्द महासागर क्षेत्र";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ବ୍ରିଟିଶ୍‌ ଭାରତ ମାହାସାଗର କ୍ଷେତ୍ର";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਬਰਤਾਨਵੀ ਹਿੰਦ ਮਹਾਂਸਾਗਰ ਖਿੱਤਾ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "د بريتانوي هند سمندري سيمه";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "Territori Britannic en l’Ocean Indic";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Intara y’Ubwongereza yo mu birwa by’Abahindi";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Teritoriul Britanic din Oceanul Indian";
        ...
        test("has translation for 'sd' locale", () {
          const expectedName = "برطانوي هندي سمنڊ خطو";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Sêse tî Anglëe na Ngûyämä tî Ênnde";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "බ්‍රිතාන්‍ය ඉන්දීය සාගර බල ප්‍රදේශය";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "Britansko ozemlje v Indijskem oceanu";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Dhul xadeedka Badweynta Hindiya ee Biritishka";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Territori Britanik i Oqeanit Indian";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "பிரிட்டிஷ் இந்தியப் பெருங்கடல் பிரதேசம்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "బ్రిటిష్ హిందూ మహాసముద్ర ప్రాంతం";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Қаламрави Британия дар уқёнуси Ҳинд";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "บริติชอินเดียนโอเชียนเทร์ริทอรี";
        ...
        test("has translation for 'ti' locale", () {
          const expectedName = "ናይ ብሪጣንያ ህንዳዊ ውቅያኖስ ግዝኣት";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Britaniýanyň Hindi okeanyndaky territoriýalary";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Potu fonua moana ʻInitia fakapilitānia";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Британиянең Һинд Океанындагы Территориясе";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ئەنگلىيەگە قاراشلىق ھىندى ئوكيان تېررىتورىيەسى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Британська територія в Індійському Океані";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Britaniyaning Hind okeanidagi hududi";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Lãnh thổ Ấn Độ Dương thuộc Anh";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Terituwaaru Brëtaañ ci Oseyaa Enjeŋ";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Etíkun Índíánì ti Ìlú Bírítísì";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-British Indian Ocean Territory";
        ...
        test("has translation for 'an' locale", () {
          const expectedName = "Territorio Britanico de l'Ozián Indico";
        ...
        test("has translation for 'io' locale", () {
          const expectedName = "Britaniana teritorio en Indiana Oceano";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Xakên Brîtanyayê yên Okyanûsa Hindî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Te Rohe o te Moana Īniana Piritihi";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Territòriu Britànnicu de s’Otzèanu Indianu";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Teritoryo sa Karagatan ng British Indian";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "EBritish Indian Ocean Territory";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Англисен Инди океанĕн территорийĕ";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Британиатәи аҵакырадгьыл Индиатәи аокеан аҟны";
        ...
        test("has translation for 'ie' locale", () {
          const expectedName = "Chagos (BTIO)";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Territòri Britanic de l’Ocean Indian";
        ...
        test("has translation for 'ug_Arab' locale", () {
          const expectedName = "ئەنگلىيەنىڭ ھىندى ئوكياندىكى تەۋەلىكى";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Британиянинг Ҳинд океанидаги ҳудуди";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Etíkun Índíánì ti Ìlú Bírítísì";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Британтјанын Һинд Океаны Әразиси";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Британска територија у Индијском океану";
        ...
        test("has translation for 'ks_Arab' locale", () {
          const expectedName = "برطانوی بحرِ ہِنٛدۍ علاقہٕ";
        ...
        test("has translation for 'ky_Cyrl' locale", () {
          const expectedName = "Британиянын Индия океанындагы аймагы";
        ...
        test("has translation for 'sw_KE' locale", () {
          const expectedName = "Himaya ya Uingereza katika Bahari Hindi";
