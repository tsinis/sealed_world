...
void main() => group(
      "$CountryWlf() L10N",
      () {
        const value = CountryWlf();

        test("has translation for 'en' locale", () {
          const expectedName = "Wallis and Futuna";
          const expectedFullName = "Territory of the Wallis and Futuna Islands";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Валис и Футуна";
          const expectedFullName = "Територија државе Валис и Футуна";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "واليس وفوتونا";
          const expectedFullName = "إقليم جزر واليس وفوتونا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Wallis ha Futuna";
          const expectedFullName = "Tiriad Inizi Wallis ha Futuna";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Wallis a Futuna";
          const expectedFullName = "Teritorium ostrovů Wallis a Futuna";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Wallis und Futuna";
          const expectedFullName = "Gebiet der Wallis und Futuna";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Wallis ja Futuna";
          const expectedFullName = "Wallise ja Futuna ala";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Wallis ja Futuna";
          const expectedFullName = "Wallisin ja Futunan yhteisö";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Wallis-et-Futuna";
          const expectedFullName = "Territoire des îles Wallis et Futuna";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Wallis i Fortuna";
          const expectedFullName = "Teritoriju Wallis i Futuna";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Wallis és Futuna";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Wallis e Futuna";
          const expectedFullName = "Territorio delle Isole Wallis e Futuna";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ウォリス・フツナ";
          const expectedFullName = "ウォリス·フツナ諸島の領土";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Wallis en Futuna";
          const expectedFullName = "Grondgebied van de Wallis en Futuna";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "والیس و فوتونا";
          const expectedFullName = "جزایر والیس و فوتونا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Wallis i Futuna";
          const expectedFullName = "Terytorium Wysp Wallis i Futuna";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Wallis e Futuna";
          const expectedFullName = "Território das Ilhas Wallis e Futuna";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Уоллис и Футуна";
          const expectedFullName = "Территория Уоллис и Футуна острова";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Wallis a Futuna";
          const expectedFullName = "Teritórium ostrovov Wallis a Futuna";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Wallis y Futuna";
          const expectedFullName = "Territorio de las Islas Wallis y Futuna";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Wallis- och Futunaöarna";
          const expectedFullName = "Territoriet Wallis- och Futunaöarna";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Wallis ve Futuna Adaları Bölgesi";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "والس و فتونہ";
          const expectedFullName = "سر زمینِ والس و فتونہ جزائر";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Wallis ne Futuna";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "ዋሊስ እና ፉቱና ደሴቶች";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "ৱালিছ আৰু ফুটুনা";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Uollis və Futuna";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Уоліс і Футуна";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Уолис и Футуна";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Walisi-ni-Futuna";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "ওয়ালিস ও ফুটুনা";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Ostrva Valis i Futuna";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Уоллис а, Футуна а";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "Wallis og Futuna";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཝལ་ལིས྄་ ཨེནཌ་ ཕུ་ཏུ་ན་";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Wallis kple Futuna nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Γουάλις και Φουτούνα";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Valiso kaj Futuno";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Wallis eta Futuna";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Walis e Futuna";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Wallis- og Futunaoyggjar";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Vailís agus Futúna";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Uallas agus Futuna";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "વૉલિસ અને ફ્યુચુના";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Walis Da Futuna";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "איי ווליס ופוטונה";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "वालिस और फ़्यूचूना";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Ուոլիս և Ֆուտունա";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Kepulauan Wallis dan Futuna";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Wallis- og Fútúnaeyjar";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Wallis lan Futuna";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "უოლისი და ფუტუნა";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Walis na Futuna";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Уоллис және Футуна";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "វ៉ាលីស និង​ហ្វូទូណា";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ವಾಲಿಸ್ ಮತ್ತು ಫುಟುನಾ";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "والِس تہٕ فیوٗچوٗنا";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Wallis û Futuna";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Уоллис жана Футуна";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Walisi ne Futuna";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Walisɛ mpé Futuna";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ວາລລິສ ແລະ ຟູຕູນາ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Volisas ir Futūna";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Walise ne Futuna";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Volisa un Futunas salas";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Wallis sy Futuna";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "വാലിസ് ആന്റ് ഫ്യൂച്യുന";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Уоллис ба Футуна";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "वालिस आणि फ्यूचूना";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Wallis dan Futuna";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "Wallis u Futuna";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဝေါလစ်နှင့် ဖူကျူးနား";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "वालिस र फुटुना";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ୱାଲିସ୍ ଏବଂ ଫୁତୁନା";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਵਾਲਿਸ ਅਤੇ ਫੂਟੂਨਾ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "والیس او فوتونا";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Walisi na Futuna";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Wallis și Futuna";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Walîsi na Futuna";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "වැලිස් සහ ෆුටුනා";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "Wallis in Futuna";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Walis & Futuna";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Uollis e Futuna";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Wallis na Futuna";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "வாலிஸ் மற்றும் ஃபுடுனா";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "వాల్లిస్ మరియు ఫుటునా";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Уоллис ва Футуна";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "วาลลิสและฟุตูนา";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Uollis we Futuna";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "ʻUvea mo Futuna";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Уоллис һәм Футуна";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ۋاللىس ۋە فۇتۇنا";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Уолліс і Футуна";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Uollis va Futuna";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Wallis và Futuna";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Walis ak Futuna";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Wali ati futuna";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Wallis ne-Futuna";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Уоллис тата Футуна";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Wallis & Futuna";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Warihi me Whutuna";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "EWallis & Futuna";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Уоллиси Футунеи";
        ...
        test("has translation for 'an' locale", () {
          const expectedName = "Wallis y Fortuna";
        ...
        test("has translation for 'kl' locale", () {
          const expectedName = "Wallis aamma Futuna";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Vallis et Futuna";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Уоллис вә Футуна";
        ...
        test("has translation for 'kk_Cyrl' locale", () {
          const expectedName = "Уоллис пен Футуна";
        ...
        test("has translation for 'ug_Arab' locale", () {
          const expectedName = "ۋالىس ۋە فۇتۇنا";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Wali ati futuna";
