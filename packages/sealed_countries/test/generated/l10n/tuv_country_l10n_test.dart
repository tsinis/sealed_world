...
void main() => group(
      "$CountryTuv() L10N",
      () {
        const value = CountryTuv();

        test("has translation for 'en' locale", () {
          const expectedName = "Tuvalu";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Tuvalu nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Tufalu";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Tufalu";
