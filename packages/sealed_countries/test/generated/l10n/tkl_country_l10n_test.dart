...
void main() => group(
      "$CountryTkl() L10N",
      () {
        const value = CountryTkl();

        test("has translation for 'en' locale", () {
          const expectedName = "Tokelau";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Tokelau";
          const expectedFullName = "Îles Tokelau";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Tokelau-szigetek";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Isole Tokelau";
          const expectedFullName = "Tokelau";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "トケラウ";
          const expectedFullName = "トケラウ諸島";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Tokelau";
          const expectedFullName = "Tokelauské ostrovy";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Islas Tokelau";
          const expectedFullName = "Tokelau";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Tokelauöarna";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཏོ་ཀེ་ལའུ་ མཚོ་གླིང";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Tokelau nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Tokelau";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Tokelau";
