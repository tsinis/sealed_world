...
void main() => group(
      "$CountryBgd() L10N",
      () {
        const value = CountryBgd();

        test("has translation for 'en' locale", () {
          const expectedName = "Bangladesh";
          const expectedFullName = "People's Republic of Bangladesh";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Бангладеш";
          const expectedFullName = "Народна Република Бангладеш";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "بنغلاديش";
          const expectedFullName = "جمهورية بنغلاديش الشعبية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Bangladesh";
          const expectedFullName = "Republik pobl Bangladesh";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Bangladéš";
          const expectedFullName = "Bangladéšská lidová republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Bangladesh";
          const expectedFullName = "Gweriniaeth Pobl Bangladesh";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Bangladesch";
          const expectedFullName = "Volksrepublik Bangladesch";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Bangladesh";
          const expectedFullName = "Bangladeshi Rahvavabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Bangladesh";
          const expectedFullName = "Bangladeshin kansantasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Bangladesh";
          const expectedFullName = "La République populaire du Bangladesh";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Bangladeš";
          const expectedFullName = "Narodna Republika Bangladeš";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Bangladesh";
          const expectedFullName = "Repubblica popolare del Bangladesh";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "バングラデシュ";
          const expectedFullName = "バングラデシュ人民共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "방글라데시";
          const expectedFullName = "방글라데시 인민 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Bangladesh";
          const expectedFullName = "Volksrepubliek Bangladesh";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "بنگلادش";
          const expectedFullName = "جمهوری خلق بنگلادش";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Bangladesz";
          const expectedFullName = "Ludowa Republika Bangladeszu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Bangladesh";
          const expectedFullName = "República Popular do Bangladesh";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Бангладеш";
          const expectedFullName = "Народная Республика Бангладеш";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Bangladéš";
          const expectedFullName = "Bangladéšska ľudová republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Bangladesh";
          const expectedFullName = "República Popular de Bangladesh";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Bangladesh";
          const expectedFullName = "Folkrepubliken Bangladesh";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Bangladeş";
          const expectedFullName = "Bangladeş Halk Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "بنگلہ دیش";
          const expectedFullName = "عوامی جمہوریہ بنگلہ دیش";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "孟加拉国";
          const expectedFullName = "孟加拉人民共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Bangladɛhye";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Bɛngiladɛsi";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Bangladesh nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Μπανγκλαντές";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Banglaadees";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Bhanglaidéis";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Banggaladésa";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Bangladeshi";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Bangaladesi";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Bengalidɛsi";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Bangladešas";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Benguladeshi";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Bangladesh";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဘင်္ဂလားဒေ့ရှ်";
        ...
        test("has translation for 'nd' locale", () {
          const expectedName = "Bhangiladeshi";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Bangaladeshi";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Bengladêshi";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Pengilātesi";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "באַנגלאַדעש";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Bángáládésì";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Bangladesh";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "Bangla Desh";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Bangladesha";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Bangaladhesh";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "EBangladesh";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Munggyahlahgoz";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Bángáládésì";
