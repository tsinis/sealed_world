...
void main() => group(
      "$CountryUzb() L10N",
      () {
        const value = CountryUzb();

        test("has translation for 'en' locale", () {
          const expectedName = "Uzbekistan";
          const expectedFullName = "Republic of Uzbekistan";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Узбекистан";
          const expectedFullName = "Република Узбекистан";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "أوزباكستان";
          const expectedFullName = "جمهورية أوزباكستان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Ouzbekistan";
          const expectedFullName = "Republik Ouzbekistan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Uzbekistán";
          const expectedFullName = "Republika Uzbekistán";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Usbekistan";
          const expectedFullName = "Republik Usbekistan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Usbekistan";
          const expectedFullName = "Usbekistani Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Uzbekistan";
          const expectedFullName = "Uzbekistanin tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Ouzbékistan";
          const expectedFullName = "République d'Ouzbékistan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Uzbekistan";
          const expectedFullName = "Republika Uzbekistan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Üzbegisztán";
          const expectedFullName = "Üzbég Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Uzbekistan";
          const expectedFullName = "Repubblica di Uzbekistan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ウズベキスタン";
          const expectedFullName = "ウズベキスタン共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "우즈베키스탄";
          const expectedFullName = "우즈베키스탄 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Oezbekistan";
          const expectedFullName = "Republiek Oezbekistan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "ازبکستان";
          const expectedFullName = "جمهوری ازبکستان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Uzbekistan";
          const expectedFullName = "Republika Uzbekistanu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Uzbequistão";
          const expectedFullName = "República do Usbequistão";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Узбекистан";
          const expectedFullName = "Республика Узбекистан";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Uzbekistan";
          const expectedFullName = "Uzbecká republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Uzbekistán";
          const expectedFullName = "República de Uzbekistán";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Uzbekistan";
          const expectedFullName = "Republiken Uzbekistan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Özbekistan";
          const expectedFullName = "Özbekistan Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "ازبکستان";
          const expectedFullName = "جمہوریہ ازبکستان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "乌兹别克斯坦";
          const expectedFullName = "乌兹别克斯坦共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Oesbekistan";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "উজবেকিস্তান";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Uzebekisitani";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཨུས་བེག་གི་སཏཱན";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Uzbekistan nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Ουζμπεκιστάν";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Usbekistaan";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Úisbéiceastáin";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "ઉઝ્બેકિસ્તાન";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Uzubekistan";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "उज़्बेकिस्तान";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Uzibekistani";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "អ៊ូសបេគីស្ថាន";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಉಜ್ಬೇಕಿಸ್ಥಾನ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "اُزبِکِستان";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Wuzibekisitaani";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Uzibɛkisitá";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ອຸສເບກິສະຖານ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Uzbekistanas";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Uzibekisita";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Uzbekistāna";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ഉസ്‌ബെക്കിസ്ഥാൻ";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "उझबेकिस्तान";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "l-Użbekistan";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဥဇဘက်ကစ္စတန်";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "उज्बेकिस्तान";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଉଜବେକିସ୍ତାନ";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਉਜ਼ਬੇਕਿਸਤਾਨ";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Uzubekisitani";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Uzbekistäan";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "උස්බෙකිස්ථානය";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Uusbakistaan";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "உஸ்பெகிஸ்தான்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "ఉజ్బెకిస్తాన్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "อุซเบกิสถาน";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "ʻUsipekitani";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ئۆزبېكىستان";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Oʻzbekiston";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Nṣibẹkisitani";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Uzbekistan";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ཨུ་ཟ་བྷེ་ཁི་སི་ཐན།";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "އުޒްބެކިސްތާން";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Oosbeckistaan";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Ózbeʼ Bikéyah";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Ozbequistan";
        ...
        test("has translation for 'sa' locale", () {
          const expectedName = "उजबेकिस्थान";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Uzbekistani";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "אוזבעקיסטאן";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Uhipeketāne";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "E-Uzbekistan";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Узбеқьисҭан";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Vuhsihbezgwzswhdanj";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Nshibɛkisitani";
