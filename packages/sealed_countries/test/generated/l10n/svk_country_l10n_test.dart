...
void main() => group(
      "$CountrySvk() L10N",
      () {
        const value = CountrySvk();

        test("has translation for 'en' locale", () {
          const expectedName = "Slovakia";
          const expectedFullName = "Slovak Republic";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Словачка";
          const expectedFullName = "Словачка Република";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "سلوفاكيا";
          const expectedFullName = "جمهورية سلوفاكيا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Slovakia";
          const expectedFullName = "Republik Slovak";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Slovensko";
          const expectedFullName = "Slovenská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Slowakei";
          const expectedFullName = "Slowakische Republik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Slovakkia";
          const expectedFullName = "Slovaki Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Slovakia";
          const expectedFullName = "Slovakian tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Slovaquie";
          const expectedFullName = "République slovaque";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Slovačka";
          const expectedFullName = "slovačka";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Szlovákia";
          const expectedFullName = "Szlovák Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Slovacchia";
          const expectedFullName = "Repubblica slovacca";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "スロバキア";
          const expectedFullName = "スロバキア共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "슬로바키아";
          const expectedFullName = "슬로바키아 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Slowakije";
          const expectedFullName = "Slowaakse Republiek";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "اِسلُواکی";
          const expectedFullName = "جمهوری اسلواکی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Słowacja";
          const expectedFullName = "Republika Słowacka";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Eslováquia";
          const expectedFullName = "República Eslovaca";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Словакия";
          const expectedFullName = "Словацкая Республика";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "República Eslovaca";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Slovakien";
          const expectedFullName = "Republiken Slovakien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Slovakya";
          const expectedFullName = "Slovak Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "سلوواکیہ";
          const expectedFullName = "جمہوریہ سلوواکیہ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "斯洛伐克";
          const expectedFullName = "斯洛伐克共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "শ্লোভাকিয়া";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "স্লোভাকিয়া";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "སུ་ལོ་བཱ་ཀི་ཡ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Slovakia nutome";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an tSlóvaic";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "An t-Slòbhac";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "स्लोव्हाकिया";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "is-Slovakkja";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဆလိုဗက်ကီးယား";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ස්ලෝවැකියාව";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Islofaakiya";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Silofakia";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Słóbaʼ Bikéyah";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Swhlozfazgwz";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Silofakia";
