...
void main() => group(
      "$CountryFra() L10N",
      () {
        const value = CountryFra();

        test("has translation for 'en' locale", () {
          const expectedName = "France";
          const expectedFullName = "French Republic";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Француска";
          const expectedFullName = "Француска Република";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "فرنسا";
          const expectedFullName = "الجمهورية الفرنسية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Frañs";
          const expectedFullName = "Republik Frañs";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Francie";
          const expectedFullName = "Francouzská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Frankreich";
          const expectedFullName = "Französische Republik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Prantsusmaa";
          const expectedFullName = "Prantsuse Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Ranska";
          const expectedFullName = "Ranskan tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "France";
          const expectedFullName = "République française";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Francuska";
          const expectedFullName = "Francuska Republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Franciaország";
          const expectedFullName = "Francia Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Francia";
          const expectedFullName = "Repubblica francese";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "フランス";
          const expectedFullName = "フランス共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "프랑스";
          const expectedFullName = "프랑스 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Frankrijk";
          const expectedFullName = "Franse Republiek";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "فرانسه";
          const expectedFullName = "جمهوری فرانسه";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Francja";
          const expectedFullName = "Republika Francuska";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "França";
          const expectedFullName = "República Francesa";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Франция";
          const expectedFullName = "Французская Республика";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Francúzsko";
          const expectedFullName = "Francúzska republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Francia";
          const expectedFullName = "República francés";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Frankrike";
          const expectedFullName = "Republiken Frankrike";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Fransa";
          const expectedFullName = "Fransa Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "فرانس";
          const expectedFullName = "جمہوریہ فرانس";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "法国";
          const expectedFullName = "法兰西共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "France nutome";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "פֿראַנקרייך";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Faranse";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "ފަރަންސޭސިވިލާތް";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Dáághahii Dineʼé Bikéyah";
        ...
        test("has translation for 'sa' locale", () {
          const expectedName = "फ्रान्सदेशः";
        ...
        test("has translation for 'st' locale", () {
          const expectedName = "Fora";

          final translated = value.maybeTranslation(
            const BasicTypedLocale(LangSot()),
            useLanguageFallback: false,
          );
          ...
          expect(commonMapTranslation, expectedName);
          final unexpectedScriptTranslation = value.maybeTranslation(
            const BasicTypedLocale(LangSot(), script: ScriptCyrs()),
          );
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Faranse";
