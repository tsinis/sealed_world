...
void main() => group(
      "$CountryTcd() L10N",
      () {
        const value = CountryTcd();

        test("has translation for 'en' locale", () {
          const expectedName = "Chad";
          const expectedFullName = "Republic of Chad";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Чад";
          const expectedFullName = "Република Чад";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "تشاد";
          const expectedFullName = "جمهورية تشاد";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Tchad";
          const expectedFullName = "Republik Tchad";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Čad";
          const expectedFullName = "Čadská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Tsiad";
          const expectedFullName = "Gweriniaeth Tsiad";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Tschad";
          const expectedFullName = "Republik Tschad";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Tšaad";
          const expectedFullName = "Tšaadi Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Tšad";
          const expectedFullName = "Tšadin tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Tchad";
          const expectedFullName = "République du Tchad";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Csád";
          const expectedFullName = "Csád Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Ciad";
          const expectedFullName = "Repubblica del Ciad";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "チャド";
          const expectedFullName = "チャド共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "차드";
          const expectedFullName = "차드 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Tsjaad";
          const expectedFullName = "Republiek Tsjaad";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "چاد";
          const expectedFullName = "جمهوری چاد";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Czad";
          const expectedFullName = "Republika Czadu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Chade";
          const expectedFullName = "República do Chade";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Чад";
          const expectedFullName = "Республика Чад";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Chad";
          const expectedFullName = "República de Chad";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Tchad";
          const expectedFullName = "Republiken Tchad";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Çad";
          const expectedFullName = "Çad Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "چاڈ";
          const expectedFullName = "جمہوریہ چاڈ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "乍得";
          const expectedFullName = "乍得共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Tsad nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède ṣààdì";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède shààdì";
