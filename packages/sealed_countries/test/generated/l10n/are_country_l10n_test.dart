...
void main() => group(
      "$CountryAre() L10N",
      () {
        const value = CountryAre();

        test("has translation for 'en' locale", () {
          const expectedName = "United Arab Emirates";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Уједињени Арапски Емирати";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "دولة الإمارات العربية المتحدة";
          const expectedFullName = "الإمارات العربية المتحدة";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Emirelezhioù Arab Unanet";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Arabské emiráty";
          const expectedFullName = "Spojené arabské emiráty";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Vereinigte Arabische Emirate";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Araabia Ühendemiraadid";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Arabiemiraatit";
          const expectedFullName = "Yhdistyneet arabiemiirikunnat";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Émirats arabes unis";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Arapski Emirati";
          const expectedFullName = "Ujedinjeni Arapski Emirati";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Egyesült Arab Emírségek";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Emirati Arabi Uniti";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "아랍에미리트";
          const expectedFullName = "아랍 토후국 연방";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Verenigde Arabische Emiraten";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "امارات";
          const expectedFullName = "امارات متحده عربی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Emiraty Arabskie";
          const expectedFullName = "Zjednoczone Emiraty Arabskie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Emirados Árabes Unidos";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Объединённые Арабские Эмираты";
          const expectedFullName = "Объединенные Арабские Эмираты";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Emiratos Árabes Unidos";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Förenade Arabemiraten";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Birleşik Arap Emirlikleri";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "متحدہ عرب امارات";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Verenigde Arabiese Emirate";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የተባበሩት ዓረብ ኤምሬትስ";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "সংযুক্ত আৰব আমিৰাত";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Birləşmiş Ərəb Əmirlikləri";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Аб’яднаныя Арабскія Эміраты";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Обединени арабски емирства";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Arabu mara kafoli";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "সংযুক্ত আরব আমিরাত";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Ujedinjeni Arapski Emirati";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "Emirats Àrabs Units";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Ӏарбийн Цхьанатоьхна Эмираташ";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "De Forenede Arabiske Emirater";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཡུ་ནཱའི་ཊེཌ་ ཨ་རབ་ ཨེ་མེ་རེཊས";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "United Arab Emirates nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Ηνωμένα Αραβικά Εμιράτα";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Unuiĝintaj Arabaj Emirlandoj";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Arabiar Emirerri Batuak";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Emiraat Araab Denntuɗe";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Sameindu Emirríkini";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Verenigde Arabyske Emiraten";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Aontas na nÉimíríochtaí Arabacha";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Na h-Iomaratan Arabach Aonaichte";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Os Emiratos Árabes Unidos";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "યુનાઇટેડ આરબ અમીરાત";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Haɗaɗɗiyar Daular Larabawa";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "איחוד האמירויות הערביות";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "संयुक्त अरब अमीरात";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Արաբական Միացյալ Էմիրություններ";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Emiratos Arabe Unite";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Uni Emirat Arab";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Sameinuðu arabísku furstadæmin";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Uni Émirat Arab";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "არაბთა გაერთიანებული საამიროები";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Falme za Kiarabu";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Біріккен Араб Әмірліктері";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "អេមីរ៉ាត​អារ៉ាប់​រួម";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಯುನೈಟೆಡ್ ಅರಬ್ ಎಮಿರೇಟ್ಸ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "مُتحدہ عرَب امارات";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Emîrtiyên Erebî yên Yekbûyî";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Бириккен Араб Эмираттары";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Vereenegt Arabesch Emirater";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Lɛmila alabo";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ສະຫະລັດອາຣັບເອມິເຣດ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Jungtiniai Arabų Emyratai";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Lemila alabu";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Apvienotie Arābu Emirāti";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Emirà Arabo mitambatra";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Обединети Арапски Емирати";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "യുണൈറ്റഡ് അറബ് എമിറൈറ്റ്‌സ്";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Арабын Нэгдсэн Эмирт Улс";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Emiriah Arab Bersatu";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "l-Emirati Għarab Magħquda";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "De forente arabiske emirater";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "संयुक्त अरब इमिराट्स";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "Dei sameinte arabiske emirata";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ସଂଯୁକ୍ତ ଆରବ ଏମିରେଟସ୍";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਸੰਯੁਕਤ ਅਰਬ ਅਮੀਰਾਤ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "متحده عرب امارات";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "Emirats Arabs Unids";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Leta Zunze Ubumwe z’Abarabu";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Emiratele Arabe Unite";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Ovttastuvvan Arábaemiráhtat";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Arâbo Emirâti Ôko";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "එක්සත් අරාබි එමිර් රාජ්‍යය";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "Združeni arabski emirati";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Imaaraadka Carabta ee Midoobay";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Emiratet e Bashkuara Arabe";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "ஐக்கிய அரபு எமிரேட்ஸ்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "యునైటెడ్ అరబ్ ఎమిరేట్స్";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Аморатҳои Муттаҳидаи Араб";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "สหรัฐอาหรับเอมิเรตส์";
        ...
        test("has translation for 'ti' locale", () {
          const expectedName = "ሕቡራት ኢማራት ዓረብ";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Birleşen Arap Emirlikleri";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "ʻAlepea Fakatahataha";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Берләшкән Гарәп Әмирлекләре";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ئەرەب بىرلەشمە خەلىپىلىكى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Обʼєднані Арабські Емірати";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Birlashgan Arab Amirliklari";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Các Tiểu Vương quốc Ả Rập Thống nhất";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Emira Arab Ini";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Ẹmirate ti Awọn Arabu";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-United Arab Emirates";
        ...
        test("has translation for 'an' locale", () {
          const expectedName = "Emiratos Arabes Unitos";
        ...
        test("has translation for 'av' locale", () {
          const expectedName = "ГIарабазул Цолъарал Имаратал";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ཡི་ནེ་ཁྲེ་ཀྲི་ཨ་རབ་ཨེ་མེ་རེ་ཁྲི།";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "އެކުވެރި ޢަރަބި އިމާރާތު";
        ...
        test("has translation for 'gn' locale", () {
          const expectedName = "Aravia Emiryvy Joaju";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Ny h-Emmiraidyn Arabagh Unnaneysit";
        ...
        test("has translation for 'ie' locale", () {
          const expectedName = "Unit Arabic Emiratus";
        ...
        test("has translation for 'io' locale", () {
          const expectedName = "Unionita Araba Emirati";
        ...
        test("has translation for 'kv' locale", () {
          const expectedName = "Ӧтувтчӧм Араб Эмиратъяс";
        ...
        test("has translation for 'kw' locale", () {
          const expectedName = "Pennternasedh Unys Arabek";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Phylarchiarum Arabicarum Confoederatio";
        ...
        test("has translation for 'li' locale", () {
          const expectedName = "Vereinegde Arabische Emiraote";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Te Kotahitanga o ngā Whenua Ārapi";
        ...
        test("has translation for 'na' locale", () {
          const expectedName = "Emireitit Arabiya";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Ásáí Bikéyah Yázhí Ałhidadiidzooígíí";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Emirats Arabis Units";
        ...
        test("has translation for 'os' locale", () {
          const expectedName = "Араббы Иугонд Эмираттæ";
        ...
        test("has translation for 'rw' locale", () {
          const expectedName = "Nyarabu Zunze Ubumwe";
        ...
        test("has translation for 'ss' locale", () {
          const expectedName = "Bunye bema-Arabhu";
        ...
        test("has translation for 'vo' locale", () {
          const expectedName = "Lemiräns Larabik Pebalöl";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "פאראייניגטע אראבישע עמיראטן";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Арапсен Пӗрлешӳллӗ Эмирачӗ";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Emirados Àrabos Unidos";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "E-United Arab Emirates";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Бирләшмиш Әрәб Әмирликләри";
        ...
        test("has translation for 'kk_Cyrl' locale", () {
          const expectedName = "Біріккен Араб Эмираттары";
        ...
        test("has translation for 'mn_Cyrl' locale", () {
          const expectedName = "Арабын Нэгдсэн Эмират";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Бирлашган Араб Амирликлари";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Ɛmirate ti Awɔn Arabu";
