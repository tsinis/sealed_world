...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "المملكة المتحدة";
          const expectedFullName =
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Rouantelezh-Unanet";
          const expectedFullName =
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Spojené království";
          const expectedFullName =
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Vereinigtes Königreich";
          const expectedFullName =
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Suurbritannia";
          const expectedFullName =
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Yhdistynyt kuningaskunta";
          const expectedFullName =
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Egyesült Királyság";
          const expectedFullName =
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Regno Unito";
          const expectedFullName =
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Zjednoczone Królestwo";
          const expectedFullName =
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Великобритания";
          const expectedFullName =
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Veľká Británia (Spojené kráľovstvo)";
          const expectedFullName =
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Birleşik Krallık";
          const expectedFullName =
