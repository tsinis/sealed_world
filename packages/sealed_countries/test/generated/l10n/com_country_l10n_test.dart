...
void main() => group(
      "$CountryCom() L10N",
      () {
        const value = CountryCom();

        test("has translation for 'en' locale", () {
          const expectedName = "Comoros";
          const expectedFullName = "Union of the Comoros";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Комори";
          const expectedFullName = "Савез Комора";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "جزر القمر";
          const expectedFullName = "الإتحاد القمري";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Komorez";
          const expectedFullName = "Unaniezh Komorez";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Komory";
          const expectedFullName = "Komorský svaz";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Y Comoros";
          const expectedFullName = "Undeb y Comoros";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Komoren";
          const expectedFullName = "Union der Komoren";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Komoorid";
          const expectedFullName = "Komoori Liit";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Komorit";
          const expectedFullName = "Komorien liitto";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Comores";
          const expectedFullName = "Union des Comores";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Komori";
          const expectedFullName = "Savez Komori";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Comore-szigetek";
          const expectedFullName = "Comore-szigeteki Unió";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Comore";
          const expectedFullName = "Unione delle Comore";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "コモロ";
          const expectedFullName = "コモロ連合";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "코모로";
          const expectedFullName = "코모로 연방";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Comoren";
          const expectedFullName = "Unie van de Comoren";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "اتحاد قُمُر";
          const expectedFullName = "مجمع‌الجزایر قمر";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Komory";
          const expectedFullName = "Związek Komorów";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Comores";
          const expectedFullName = "União das Comores";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Коморы";
          const expectedFullName = "Союз Коморских Островов";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Komory";
          const expectedFullName = "Komorská únia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Comoras";
          const expectedFullName = "Unión de las Comoras";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Komorerna";
          const expectedFullName = "Unionen Komorerna";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Komorlar";
          const expectedFullName = "Komorlar Birliği";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "القمری";
          const expectedFullName = "اتحاد القمری";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "科摩罗";
          const expectedFullName = "科摩罗联盟";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Komor adaları";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Каморскія астравы";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Коморски острови";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Komoros nutome";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Komoroyggjar";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Oileáin Chomóra";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Կոմորյան կղզիներ";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "კომორის კუნძულები";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Комор аралдары";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Bizinga by’eKomoro";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Komoru salas";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Коморын арлууд";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ကိုမိုရိုစ်";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Izinga rya Komore";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Komor adalary";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Комор утраулары";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Komor orollari";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Kòmòrósì";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Insulae Comorianae";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Комор утравӗсем";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Комор адалары";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Комор ороллари";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Kòmòrósì";
