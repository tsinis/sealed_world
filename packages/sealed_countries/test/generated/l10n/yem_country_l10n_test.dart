...
void main() => group(
      "$CountryYem() L10N",
      () {
        const value = CountryYem();

        test("has translation for 'en' locale", () {
          const expectedName = "Yemen";
          const expectedFullName = "Republic of Yemen";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Јемен";
          const expectedFullName = "Република Јемен";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "اليمن";
          const expectedFullName = "الجمهورية اليمنية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Yemen";
          const expectedFullName = "Republik Yemen";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Jemen";
          const expectedFullName = "Jemenská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Jemen";
          const expectedFullName = "Republik Jemen";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Jeemen";
          const expectedFullName = "Jeemeni Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Jemen";
          const expectedFullName = "Jemenin tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Yémen";
          const expectedFullName = "République du Yémen";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Jemen";
          const expectedFullName = "Republika Jemen";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Jemen";
          const expectedFullName = "Jemeni Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Yemen";
          const expectedFullName = "Repubblica dello Yemen";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "イエメン";
          const expectedFullName = "イエメン共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "예멘";
          const expectedFullName = "예멘 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Jemen";
          const expectedFullName = "Republiek Jemen";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "یمن";
          const expectedFullName = "جمهوری یمن";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Jemen";
          const expectedFullName = "Republika Jemeńska";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Iémen";
          const expectedFullName = "República do Iêmen";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Йемен";
          const expectedFullName = "Йеменская Республика";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Yemen";
          const expectedFullName = "República de Yemen";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Jemen";
          const expectedFullName = "Republiken Jemen";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Yemen";
          const expectedFullName = "Yemen Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "یمن";
          const expectedFullName = "جمہوریہ یمن";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "也门";
          const expectedFullName = "也门共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Yemen nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède yemeni";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Shádiʼááhjí Ásáí Bikéyah";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède yemeni";
