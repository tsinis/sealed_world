...
void main() => group(
      "$CountryVnm() L10N",
      () {
        const value = CountryVnm();

        test("has translation for 'en' locale", () {
          const expectedName = "Vietnam";
          const expectedFullName = "Socialist Republic of Vietnam";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Вијетнам";
          const expectedFullName = "Социјалистичка Република Вијетнам";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "فيتنام";
          const expectedFullName = "جمهورية فيتنام الاشتراكية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Viêt Nam";
          const expectedFullName = "Republik Sokialour Viêt Nam";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Vietnam";
          const expectedFullName = "Vietnamská socialistická republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Vietnam";
          const expectedFullName = "Sozialistische Republik Vietnam";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Vietnam";
          const expectedFullName = "Vietnami Sotsialistlik Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Vietnam";
          const expectedFullName = "Vietnamin sosialistinen tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Viêt Nam";
          const expectedFullName = "République socialiste du Viêt Nam";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Vijetnam";
          const expectedFullName = "Socijalistička Republika Vijetnam";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Vietnám";
          const expectedFullName = "Vietnámi Szocialista Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Vietnam";
          const expectedFullName = "Repubblica socialista del Vietnam";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ベトナム";
          const expectedFullName = "ベトナム社会主義共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "베트남";
          const expectedFullName = "베트남 사회주의 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Vietnam";
          const expectedFullName = "Socialistische Republiek Vietnam";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "ویتنام";
          const expectedFullName = "جمهوری سوسیالیستی ویتنام";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Wietnam";
          const expectedFullName = "Socjalistyczna Republika Wietnamu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Vietname";
          const expectedFullName = "República Socialista do Vietname";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Вьетнам";
          const expectedFullName = "Социалистическая Республика Вьетнам";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Vietnam";
          const expectedFullName = "República Socialista de Vietnam";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Vietnam";
          const expectedFullName = "Socialistiska republiken Vietnam";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Vietnam";
          const expectedFullName = "Vietnam Sosyalist Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "ویتنام";
          const expectedFullName = "اشتراکی جمہوریہ ویتنام";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "越南";
          const expectedFullName = "越南社会主义共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Vietnam nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Fẹtinami";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Fɛtinami";
