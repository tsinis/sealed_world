...
void main() => group(
      "$CountryAta() L10N",
      () {
        const value = CountryAta();

        test("has translation for 'en' locale", () {
          const expectedName = "Antarctica";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Yr Antarctig";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Antarktis";
          const expectedFullName = "Antarktika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Etelämanner";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Antarctique";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "南極";
          const expectedFullName = "南極大陸";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Antártida";
          const expectedFullName = "Antártica";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "এণ্টাৰ্কটিকা";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "অ্যান্টার্কটিকা";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "འཛམ་གླིང་ལྷོ་མཐའི་ཁྱགས་གླིང";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Antartica nutome";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Antartaice";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "An Antartaig";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "A Antártida";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "એન્ટાર્કટિકા";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "अंटार्कटिका";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Suðurskautslandið";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "അന്റാർട്ടിക്ക";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "अंटार्क्टिका";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "l-Antartika";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଆଣ୍ଟାର୍କାଟିକା";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ඇන්ටාක්ටිකාව";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Antaarktika";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "அண்டார்டிகா";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "అంటార్కిటికా";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "แอนตาร์กติกา";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ئانتاركتىكا";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "אַנטאַרקטיקע";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Antarctica";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Te Kōpakatanga ki te Tonga";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "E-Antarctica";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ལྷོ་རྩེའི་མཐའ་གླིང་།";
        ...
        test("has translation for 'kl' locale", () {
          const expectedName = "Qalasersuaq Kujalleq";
