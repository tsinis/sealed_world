...
void main() => group(
      "$CountryMac() L10N",
      () {
        const value = CountryMac();

        test("has translation for 'en' locale", () {
          const expectedName = "Macau";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Macau";
          const expectedFullName = "Macau erihalduspiirkond";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "マカオ";
          const expectedFullName = "中華人民共和国マカオ特別行政区";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "마카오";
          const expectedFullName = "중화인민공화국 마카오 특별행정구";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Macao";
          const expectedFullName = "Macao, Špeciàlna administratívna oblasŦ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "澳门";
          const expectedFullName = "中华人民共和国澳门特别行政区";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Macau SAS Sjina";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "ማካኡ ልዩ የአስተዳደር ክልል ቻይና";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "মাকাও এছ. এ. আৰ. চীন";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Makao XİR Çin";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Макаа, САР (Кітай)";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Макао, САР на Китай";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "ম্যাকাও এসএআর চীনা";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Makao (SAR Kina)";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "Macau (RAE Xina)";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Макао (ша-къаьстина кӀошт)";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "མཀ་ཨའུ་ཅཱའི་ན";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Macau SAR Tsaina nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Μακάο ΕΔΠ Κίνας";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Macau Txinako AEB";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Macao SAR van Sina";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "S.R.R. na Síne Macao";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Macàthu SAR na Sìne";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Macau RAE da China";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "મકાઉ SAR ચીન";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "מקאו (אזור מנהלי מיוחד של סין)";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "मकाऊ (विशेष प्रशासनिक क्षेत्र चीन)";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Չինաստանի Մակաո ՀՎՇ";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Makau DAK Tiongkok";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "sérstjórnarsvæðið Makaó";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Laladan Administratif Astamiwa Makau";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ម៉ាកាវ តំបន់រដ្ឋបាលពិសេសចិន";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಮಕಾವು SAR ಚೈನಾ";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "مَکاوو ایس اے آر چیٖن";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Макау Кытай ААА";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Spezialverwaltungszon Macau";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ມາກາວ ເຂດປົກຄອງພິເສດ ຈີນ";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "ĶTR īpašais administratīvais reģions Makao";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "മക്കാവു (SAR) ചൈന";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "БНХАУ-ын Тусгай захиргааны бүс Макао";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "मकाओ एसएआर चीन";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Macau SAR China";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "မကာအို (တရုတ်ပြည်)";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "Macao S.A.R. Kina";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "(मकाउ चिनियाँ विशेष प्रशासनिक क्षेत्र";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ମାକାଉ ଏସଏଆର୍‌ ଚାଇନା";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਮਕਾਉ ਐਸਏਆਰ ਚੀਨ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "مکاو سار چین";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "Regiun d’administraziun speziala Macao, China";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "R.A.S. Macao, China";
        ...
        test("has translation for 'sd' locale", () {
          const expectedName = "مڪائو SAR چين";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "මකාවු එස්ඒආර්";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "RPA i Makaos";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Makau SAR China";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "மகாவ் எஸ்ஏஆர் சீனா";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "మకావ్ ఎస్ఏఆర్ చైనా";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "เขตปกครองพิเศษมาเก๊าแห่งสาธารณรัฐประชาชนจีน";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Makau AAS Hytaý";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Makau SAR Siaina";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Макао Махсус Идарәле Төбәге";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ئاۋمېن ئالاھىدە مەمۇرىي رايونى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Макао, О.А.Р Китаю";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Makao (Xitoy MMH)";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Macao, Trung Quốc";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Macau SAR China";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤖𞤂𞤀 𞤕𞤢𞤴𞤲𞤢 𞤫 𞤃𞤢𞤳𞤢𞤱𞤮𞥅";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Babban Yankin Mulkin Macao na Ƙasar Sin";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Macao, R.A.S. de China";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Macao SAR China";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Makaoya Hît ya Çînê";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Makau Haina";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "RAS tzinesa de Macao";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "EMacao SAR China";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Agbègbè Ìṣàkóso Pàtàkì Macao";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Макао Хүсуси Инзибати Әрази Чин";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Макао С. А. Р.";
        ...
        test("has translation for 'kk_Cyrl' locale", () {
          const expectedName =
              "Қытай Халық Республикасының Макао арнайы әкімшілік ауданы";
        ...
        test("has translation for 'ug_Arab' locale", () {
          const expectedName = "ئاۋمېن ئالاھىدە مەمۇرىي رايونى (جۇڭگو)";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Макао (Хитой ММҲ)";
