...
void main() => group(
      "$CountryPhl() L10N",
      () {
        const value = CountryPhl();

        test("has translation for 'en' locale", () {
          const expectedName = "Philippines";
          const expectedFullName = "Republic of the Philippines";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Филипини";
          const expectedFullName = "Република Филипини";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "الفلبين";
          const expectedFullName = "جمهورية الفلبين";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Filipinez";
          const expectedFullName = "Republik Filipinez";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Filipíny";
          const expectedFullName = "Filipínská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Philippinen";
          const expectedFullName = "Republik der Philippinen";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Filipiinid";
          const expectedFullName = "Filipiini Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Filippiinit";
          const expectedFullName = "Filippiinien tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Philippines";
          const expectedFullName = "République des Philippines";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Filipini";
          const expectedFullName = "Republika Filipini";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Fülöp-szigetek";
          const expectedFullName = "Fülöp-szigeteki Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Filippine";
          const expectedFullName = "Repubblica delle Filippine";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "フィリピン";
          const expectedFullName = "フィリピン共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "필리핀";
          const expectedFullName = "필리핀 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Filipijnen";
          const expectedFullName = "Republiek der Filipijnen";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "فیلیپین";
          const expectedFullName = "جمهوری فیلیپین";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Filipiny";
          const expectedFullName = "Republika Filipin";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Filipinas";
          const expectedFullName = "República das Filipinas";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Филиппины";
          const expectedFullName = "Республика Филиппины";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Filipíny";
          const expectedFullName = "Filipínska republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Filipinas";
          const expectedFullName = "República de las Filipinas";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Filippinerna";
          const expectedFullName = "Republiken Filippinerna";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Filipinler";
          const expectedFullName = "Filipinler Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "فلپائن";
          const expectedFullName = "جمہوریہ فلپائن";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "菲律宾";
          const expectedFullName = "菲律宾共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "Filippinerne";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Filipini nutome";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Filipsoyggjar";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "na hOileáin Fhilipíneacha";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Na h-Eileanan Filipineach";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Philippinas";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Filippseyjar";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Филиппин аралдары";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Philippinnen";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Bizinga bya Firipino";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ഫിലിപ്പീൻസ്";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Filippini";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "Filippinene";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "Filippinane";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Amazinga ya Filipine";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Filippiinnat";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "பிலிப்பைன்ஸ்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "ఫిలిప్పైన్స్";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Filippinler";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "פֿיליפּינען";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède filipini";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Philippines";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Ny h-Ellanyn Philippeenagh";
        ...
        test("has translation for 'kv' locale", () {
          const expectedName = "Филиппинъяс";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Philippinae";
        ...
        test("has translation for 'na' locale", () {
          const expectedName = "Eben Piripin";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Kéyah Dańlíinii";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Feihlizbinh";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "EPhilippines";
        ...
        test("has translation for 'kk_Cyrl' locale", () {
          const expectedName = "Филиппиндер";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède filipini";
