...
void main() => group(
      "$CountryMli() L10N",
      () {
        const value = CountryMli();

        test("has translation for 'en' locale", () {
          const expectedName = "Mali";
          const expectedFullName = "Republic of Mali";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Мали";
          const expectedFullName = "Република Мали";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "مالي";
          const expectedFullName = "جمهورية مالي";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Mali";
          const expectedFullName = "Republik Mali";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Mali";
          const expectedFullName = "Republika Mali";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Mali";
          const expectedFullName = "Mali Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Mali";
          const expectedFullName = "Malin tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Mali";
          const expectedFullName = "République du Mali";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Mali";
          const expectedFullName = "Mali Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Mali";
          const expectedFullName = "Repubblica del Mali";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "マリ";
          const expectedFullName = "マリ共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "말리";
          const expectedFullName = "말리 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Mali";
          const expectedFullName = "Republiek Mali";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "مالی";
          const expectedFullName = "جمهوری مالی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Mali";
          const expectedFullName = "República do Mali";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Мали";
          const expectedFullName = "Республика Мали";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Mali";
          const expectedFullName = "Malijská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Mali";
          const expectedFullName = "República de Malí";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Mali";
          const expectedFullName = "Republiken Mali";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Mali";
          const expectedFullName = "Mali Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "مالی";
          const expectedFullName = "جمہوریہ مالی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "马里";
          const expectedFullName = "马里共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Mali nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Mali";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Mali";
