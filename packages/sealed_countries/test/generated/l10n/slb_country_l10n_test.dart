...
void main() => group(
      "$CountrySlb() L10N",
      () {
        const value = CountrySlb();

        test("has translation for 'en' locale", () {
          const expectedName = "Solomon Islands";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Соломонска Острва";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Inizi Salomon";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Šalamounovy ostrovy";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Saalomoni Saared";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Salomonsaaret";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Îles Salomon";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Solomonski Otoci";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Salamon-szigetek";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Isole Salomone";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Salomonseilanden";
          const expectedFullName = "Solomon eilanden";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "جزایر سلیمان";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Wyspy Salomona";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Ilhas Salomão";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Соломоновы Острова";
          const expectedFullName = "Соломоновы острова";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Salomonove ostrovy";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Islas Salomón";
          const expectedFullName = "islas Salomón";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Salomonöarna";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Solomon Adaları";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "جزائر سلیمان";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Salomonseilande";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "চোলোমোন দ্বীপপুঞ্জ";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Саламонавы астравы";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Соломонови острови";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "সলোমন দ্বীপপুঞ্জ";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Solomonska Ostrva";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "Illes Salomó";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Соломонан гӀайренаш";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "Salomonøerne";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "སོ་ལོ་མོན་ གླིང་ཚོམ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Solomon ƒudomekpowo nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Νήσοι Σολομώντος";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Salomon Uharteak";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Duuɗe Solomon";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Salomonoyggjar";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Salomonseilannen";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Oileáin Sholomón";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Eileanan Sholaimh";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Illas Salomón";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "સોલોમન આઇલેન્ડ્સ";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Tsibiran Salaman";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "सोलोमन द्वीपसमूह";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Սողոմոնյան կղզիներ";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Insulas Solomon";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Kepulauan Solomon";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Agwaetiti Solomon";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Salómonseyjar";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Kapuloan Suleman";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "სოლომონის კუნძულები";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Visiwa vya Solomon";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Соломон аралдары";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "កោះ​សូឡូម៉ុង";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಸಾಲೊಮನ್ ದ್ವೀಪಗಳು";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "سولامان جٔزیٖرٕ";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Giravên Salomon";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Bizanga by’eSolomooni";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Bisanga Solomɔ";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ຫມູ່ເກາະໂຊໂລມອນ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Saliamono Salos";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Lutanda lua Solomu";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Zālamana salas";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Nosy Salomona";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Соломонски Острови";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "സോളമൻ ദ്വീപുകൾ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Соломоны арлууд";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "सोलोमन बेटे";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Gżejjer Solomon";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဆော်လမွန်ကျွန်းစု";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "Salomonøyene";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "सोलोमन टापुहरू";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "Salomonøyane";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ସୋଲୋମନ୍‌ ଦ୍ୱୀପପୁଞ୍ଜ";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਸੋਲੋਮਨ ਟਾਪੂ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "سليمان ټاپوګان";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Amazinga ya Salumoni";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Insulele Solomon";
        ...
        test("has translation for 'sd' locale", () {
          const expectedName = "سولومون ٻيٽَ";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Salomon-sullot";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Zûâ Salomöon";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "සොලමන් දූපත්";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "Salomonovi otoki";
        ...
        test("has translation for 'sn' locale", () {
          const expectedName = "Zvitsuwa zvaSolomon";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Jasiiradda Solomon";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Ishujt Solomon";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "சாலமன் தீவுகள்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "సోలమన్ దీవులు";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Ҷазираҳои Соломон";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "หมู่เกาะโซโลมอน";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Solomon adalary";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "ʻOtumotu Solomone";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Сөләйман утраулары";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "سولومون ئاراللىرى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Соломонові Острови";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Solomon orollari";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Quần đảo Solomon";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Duni Salmoon";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "סאלאמאן אינזלען";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Etikun Solomoni";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Solomon Islands";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "སོ་ལོ་མོན་གླིང་ཕྲན་ཚོ་ཁག";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Соломон Утравĕсем";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "ސޮލޮމޮން ޖަޒީރާ";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Ny h-Ellanyn Holomon";
        ...
        test("has translation for 'io' locale", () {
          const expectedName = "Salomon Insuli";
        ...
        test("has translation for 'kw' locale", () {
          const expectedName = "Ynysow Salamon";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Insulae Salomonis";
        ...
        test("has translation for 'li' locale", () {
          const expectedName = "Salomonseilen";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Sólomon Tó Bináhaazyínígíí";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Illas Salamon";
        ...
        test("has translation for 'os' locale", () {
          const expectedName = "Соломоны сакъадæхтæ";
        ...
        test("has translation for 'rw' locale", () {
          const expectedName = "Ibirwa bya Solomoni";
        ...
        test("has translation for 'sa' locale", () {
          const expectedName = "सोलोमन-द्वीप";
        ...
        test("has translation for 'su' locale", () {
          const expectedName = "Kapuloan Solomon";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Kapuluang Solomon";
        ...
        test("has translation for 'vo' locale", () {
          const expectedName = "Solomonuäns";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Ngā Motu Horomona";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Ìsulas Salomone";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "ESolomon Islands";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Соломонтәи адгьылбжьахақәа";
        ...
        test("has translation for 'ie' locale", () {
          const expectedName = "Insules Solomon";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Соломон адалары";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Соломон ороллари";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Etikun Solomoni";
