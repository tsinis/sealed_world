...
void main() => group(
      "$CountryTkm() L10N",
      () {
        const value = CountryTkm();

        test("has translation for 'en' locale", () {
          const expectedName = "Turkmenistan";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Туркменистан";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Turkmenistan";
          const expectedFullName = "Republik Turkmenistan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Turkmenistán";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Türkmenistan";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Turkménistan";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Türkmenisztán";
          const expectedFullName = "Türkmén Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "ترکمنستان";
          const expectedFullName = "جمهوری خلق ترکمنستان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Turkmenistan";
          const expectedFullName = "Republika Turkmenistanu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Turquemenistão";
          const expectedFullName = "Turcomenistão";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Туркмения";
          const expectedFullName = "Туркменистан";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Tɛkmɛnistan";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "তুৰ্কমেনিস্তান";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Türkmənistan";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Туркменістан";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Turikimenisitani";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "তুর্কমেনিস্তান";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཊཱརཀ་མེནའི་སཏཱན";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Tɛkmenistan nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Τουρκμενιστάν";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Turkmenistaan";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Tuircméanastáin";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Turcmanastàn";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "તુર્કમેનિસ્તાન";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Turkumenistan";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "तुर्कमेनिस्तान";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Թուրքմենստան";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Turkimenistan";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Túrkmenistan";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Turukimenistani";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Түрікменстан";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "តួកម៉េនីស្ថាន";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ತುರ್ಕಮೆನಿಸ್ತಾನ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "تُرمِنِستان";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Tirkmenistan";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Түркмөнстан";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Takimenesitaani";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Tikɛménisitá";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ເທີກເມນິສະຖານ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Turkmėnistanas";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Tukemenisita";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Turkmenistāna";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Torkmenistan";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "തുർക്ക്മെനിസ്ഥാൻ";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "it-Turkmenistan";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "တာ့ခ်မင်နစ္စတန်";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ତୁର୍କମେନିସ୍ତାନ";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਤੁਰਕਮੇਨਿਸਤਾਨ";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Turukumenisitani";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Turkumenistäan";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ටර්ක්මෙනිස්ථානය";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "துர்க்மெனிஸ்தான்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "టర్క్‌మెనిస్తాన్";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Туркманистон";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "เติร์กเมนิสถาน";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Tūkimenisitani";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Төркмәнстан";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "تۈركمەنىستان";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Turkmaniston";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Tirkmenistaŋ";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "טורקמעניסטאַן";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Tọọkimenisita";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Turkmenistan";
        ...
        test("has translation for 'ba' locale", () {
          const expectedName = "Төрөкмәнстан";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ཏུརཀ་མེ་ནི་སུཏན།";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "ތުރުކުމެނިސްތާން";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Turkmenistaan";
        ...
        test("has translation for 'kw' locale", () {
          const expectedName = "Pow Turkmen";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Turcomannia";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Tʼóokmen Bikéyah";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Turcmenistan";
        ...
        test("has translation for 'rw' locale", () {
          const expectedName = "Turukimenisitani";
        ...
        test("has translation for 'sa' locale", () {
          const expectedName = "तुर्कमिनिस्थान";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Turkmenistani";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Tukumanatānga";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Turkmènistan";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "ETurkmenistan";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Ҭурқменисҭан";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Dujgumanswhdanj";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Түркмәнистан";
        ...
        test("has translation for 'sw_KE' locale", () {
          const expectedName = "Turukimenstani";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Tɔɔkimenisita";
