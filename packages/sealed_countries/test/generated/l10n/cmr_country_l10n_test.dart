...
void main() => group(
      "$CountryCmr() L10N",
      () {
        const value = CountryCmr();

        test("has translation for 'en' locale", () {
          const expectedName = "Cameroon";
          const expectedFullName = "Republic of Cameroon";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Камерун";
          const expectedFullName = "Република Камерун";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "الكاميرون";
          const expectedFullName = "جمهورية الكاميرون";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Kameroun";
          const expectedFullName = "Republik Kameroun";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Kamerun";
          const expectedFullName = "Kamerunská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Camerŵn";
          const expectedFullName = "Gweriniaeth Camerŵn";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Kamerun";
          const expectedFullName = "Republik Kamerun";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Kamerun";
          const expectedFullName = "Kameruni Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Kamerun";
          const expectedFullName = "Kamerunin tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Cameroun";
          const expectedFullName = "République du Cameroun";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Kamerun";
          const expectedFullName = "Republika Kamerun";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Kamerun";
          const expectedFullName = "Kameruni Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Camerun";
          const expectedFullName = "Repubblica del Camerun";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "カメルーン";
          const expectedFullName = "カメルーン共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "카메룬";
          const expectedFullName = "카메룬 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Kameroen";
          const expectedFullName = "Republiek Kameroen";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "کامِرون";
          const expectedFullName = "جمهوری کامِرون";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Kamerun";
          const expectedFullName = "Republika Kamerunu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Camarões";
          const expectedFullName = "República dos Camarões";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Камерун";
          const expectedFullName = "Республика Камерун";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Camerún";
          const expectedFullName = "República de Camerún";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Kamerun";
          const expectedFullName = "Republiken Kamerun";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Kamerun";
          const expectedFullName = "Kamerun Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "کیمرون";
          const expectedFullName = "جمہوریہ کیمرون";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "喀麦隆";
          const expectedFullName = "喀麦隆共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Kamerun nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Kamerúúnì";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Táłtłʼááh Chʼosh Daadánígíí Bitooh";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Gahmwzlungz";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Kamerúúnì";
