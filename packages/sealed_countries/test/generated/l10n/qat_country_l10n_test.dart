...
void main() => group(
      "$CountryQat() L10N",
      () {
        const value = CountryQat();

        test("has translation for 'en' locale", () {
          const expectedName = "Qatar";
          const expectedFullName = "State of Qatar";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Катар";
          const expectedFullName = "Држава Катар";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "قطر";
          const expectedFullName = "دولة قطر";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Katar";
          const expectedFullName = "Stad Katar";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Katar";
          const expectedFullName = "Stát Katar";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Katar";
          const expectedFullName = "Staat Katar";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Katar";
          const expectedFullName = "Katari Riik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Qatar";
          const expectedFullName = "Qatarin valtio";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Qatar";
          const expectedFullName = "État du Qatar";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Katar";
          const expectedFullName = "Država Katar";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Katar";
          const expectedFullName = "Katari Állam";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Qatar";
          const expectedFullName = "Stato del Qatar";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "カタール";
          const expectedFullName = "カタール国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "카타르";
          const expectedFullName = "카타르국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Qatar";
          const expectedFullName = "Staat Qatar";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "قطر";
          const expectedFullName = "دولت قطر";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Katar";
          const expectedFullName = "Państwo Katar";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Catar";
          const expectedFullName = "Estado do Qatar";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Катар";
          const expectedFullName = "Государство Катар";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Katar";
          const expectedFullName = "Katarský štát";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Catar";
          const expectedFullName = "Estado de Qatar";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Qatar";
          const expectedFullName = "Staten Qatar";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Katar";
          const expectedFullName = "Katar Devleti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "قطر";
          const expectedFullName = "ریاستِ قطر";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "卡塔尔";
          const expectedFullName = "卡塔尔国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Katar nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Kota";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Kota";
