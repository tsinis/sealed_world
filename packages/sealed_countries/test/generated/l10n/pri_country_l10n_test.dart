...
void main() => group(
      "$CountryPri() L10N",
      () {
        const value = CountryPri();

        test("has translation for 'en' locale", () {
          const expectedName = "Puerto Rico";
          const expectedFullName = "Commonwealth of Puerto Rico";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Порторико";
          const expectedFullName = "Комонвелт Порторико";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "بويرتوريكو";
          const expectedFullName = "كومنولث بويرتوريكو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Puerto Rico";
          const expectedFullName = "Kenglad Puerto Rico";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Puerto Rico";
          const expectedFullName = "Freistaat Puerto Rico";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Puerto Rico";
          const expectedFullName = "Puerto Rico Ühendus";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Portoriko";
          const expectedFullName = "Zajednica Puerto Rico";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Porto Rico";
          const expectedFullName = "Commonwealth di Porto Rico";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "プエルトリコ";
          const expectedFullName = "プエルトリコのコモンウェルス";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Puerto Rico";
          const expectedFullName = "Gemenebest van Puerto Rico";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "پورتوریکو";
          const expectedFullName = "قلمرو همسود پورتوریکو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Portoryko";
          const expectedFullName = "Wolne Stowarzyszone Państwo Portoryko";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Пуэрто-Рико";
          const expectedFullName = "Содружество Пуэрто-Рико";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Portoriko";
          const expectedFullName = "Portorické spoločenstvo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Puerto Rico";
          const expectedFullName = "Asociado de Puerto Rico";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Porto Riko";
          const expectedFullName = "Porto Riko Topluluğu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "پورٹو ریکو";
          const expectedFullName = " دولتِ مشترکہ پورٹو ریکو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "波多黎各";
          const expectedFullName = "波多黎各联邦";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "পুৱেৰ্টো ৰিকো";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Puerto Riko";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Пуэрта-Рыка";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Пуерто Рико";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "পুয়ের্তো রিকো";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "པུ་འེར་ཊོ་རི་ཁོ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Puerto Riko nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Πουέρτο Ρίκο";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Porto Rikoo";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Porto Rìceo";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "પ્યુઅર્ટો રિકો";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "פוארטו ריקו";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "पोर्टो रिको";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Պուերտո Ռիկո";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Púertó Ríkó";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Puèrto Riko";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "პუერტო-რიკო";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಪ್ಯೂರ್ಟೋ ರಿಕೊ";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ເພືອໂຕ ຣິໂກ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Puerto Rikas";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "പോർട്ടോ റിക്കോ";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "प्युएर्तो रिको";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ပေါ်တိုရီကို";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "पुएर्टो रिको";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ପୁଏର୍ତ୍ତୋ ରିକୋ";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਪਿਊਰਟੋ ਰਿਕੋ";
        ...
        test("has translation for 'sd' locale", () {
          const expectedName = "پيوئرٽو ريڪو";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "පුවර්ටෝ රිකෝ";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Bueerto Riiko";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "பியூர்டோ ரிகோ";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "ప్యూర్టో రికో";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "เปอร์โตริโก";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "پۇئېرتو رىكو";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Пуерто-Ріко";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "פּארטא־ריקא";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Pọto Riko";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Puerto Rico";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "EPuerto Rico";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Portus Dives";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Bohdohlizgoz";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Pɔto Riko";
