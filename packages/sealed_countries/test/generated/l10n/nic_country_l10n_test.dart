...
void main() => group(
      "$CountryNic() L10N",
      () {
        const value = CountryNic();

        test("has translation for 'en' locale", () {
          const expectedName = "Nicaragua";
          const expectedFullName = "Republic of Nicaragua";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Никарагва";
          const expectedFullName = "Република Никарагва";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "نيكاراغوا";
          const expectedFullName = "جمهورية نيكاراغوا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Nicaragua";
          const expectedFullName = "Republik Nicaragua";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Nikaragua";
          const expectedFullName = "Republika Nikaragua";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Nicaragua";
          const expectedFullName = "Nicaragua Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Nicaragua";
          const expectedFullName = "Nicaraguan tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Nicaragua";
          const expectedFullName = "République du Nicaragua";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Nikaragva";
          const expectedFullName = "Republika Nikaragva";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Nicaragua";
          const expectedFullName = "Nicaraguai Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Nicaragua";
          const expectedFullName = "Repubblica del Nicaragua";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ニカラグア";
          const expectedFullName = "ニカラグア共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "니카라과";
          const expectedFullName = "니카라과 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Nicaragua";
          const expectedFullName = "Republiek Nicaragua";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "نیکاراگوئه";
          const expectedFullName = "جمهوری نیکاراگوئه";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Nikaragua";
          const expectedFullName = "Republika Nikaragui";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Nicarágua";
          const expectedFullName = "República da Nicarágua";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Никарагуа";
          const expectedFullName = "Республика Никарагуа";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Nikaragua";
          const expectedFullName = "Nikaragujská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Nicaragua";
          const expectedFullName = "República de Nicaragua";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Nicaragua";
          const expectedFullName = "Republiken Nicaragua";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Nikaragua";
          const expectedFullName = "Nikaragua Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "نکاراگوا";
          const expectedFullName = "جمہوریہ نکاراگوا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "尼加拉瓜";
          const expectedFullName = "尼加拉瓜共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "নিকারাগুয়া";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Nicaraguadukɔ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Nikaraguwaa";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "នីការ៉ាហ្គា";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "in-Nikaragwa";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Nikaraaguwa";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "ניקאַראַגוע";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède NIkaragua";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Nicaragua";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ནི་ཀ་ར་གུ་ཝ།";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Nickeraag";
        ...
        test("has translation for 'vo' locale", () {
          const expectedName = "Nikaraguvän";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Nizgyahlahgvah";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède NIkaragua";
