...
void main() => group(
      "$CountrySvn() L10N",
      () {
        const value = CountrySvn();

        test("has translation for 'en' locale", () {
          const expectedName = "Slovenia";
          const expectedFullName = "Republic of Slovenia";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Словенија";
          const expectedFullName = "Република Словенија";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "سلوفينيا";
          const expectedFullName = "جمهورية سلوفينيا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Slovenia";
          const expectedFullName = "Republik Slovenia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Slovinsko";
          const expectedFullName = "Slovinská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Slowenien";
          const expectedFullName = "Republik Slowenien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Sloveenia";
          const expectedFullName = "Sloveenia Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Slovenia";
          const expectedFullName = "Slovenian tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Slovénie";
          const expectedFullName = "République de Slovénie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Slovenija";
          const expectedFullName = "Republika Slovenija";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Szlovénia";
          const expectedFullName = "Szlovén Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Slovenia";
          const expectedFullName = "Repubblica di Slovenia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "スロベニア";
          const expectedFullName = "スロベニア共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "슬로베니아";
          const expectedFullName = "슬로베니아 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Slovenië";
          const expectedFullName = "Republiek Slovenië";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "اسلوونی";
          const expectedFullName = "جمهوری اسلوونی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Słowenia";
          const expectedFullName = "Republika Słowenii";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Eslovénia";
          const expectedFullName = "República da Eslovénia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Словения";
          const expectedFullName = "Республика Словения";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Eslovenia";
          const expectedFullName = "República de Eslovenia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Slovenien";
          const expectedFullName = "Republiken Slovenien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Slovenya";
          const expectedFullName = "Slovenya Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "سلووینیا";
          const expectedFullName = "جمہوریہ سلووینیا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "斯洛文尼亚";
          const expectedFullName = "斯洛文尼亚共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "শ্লোভেনিয়া";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "স্লোভানিয়া";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "སུ་ལོ་བི་ནི་ཡ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Slovenia nutome";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an tSlóivéin";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "An t-Slòbhain";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "स्लोव्हेनिया";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "is-Slovenja";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဆလိုဗေးနီးယား";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ස්ලෝවේනියාව";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Islofeeniya";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Silofania";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "སི་ལོ་ཝེ་ནི་ཡ།";
        ...
        test("has translation for 'cu' locale", () {
          const expectedName = "Їллѷрїиска Словѣнїꙗ";
        ...
        test("has translation for 'na' locale", () {
          const expectedName = "Tsirobeniya";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Słobíín Bikéyah";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Swhlozvwnznizya";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Silofania";
