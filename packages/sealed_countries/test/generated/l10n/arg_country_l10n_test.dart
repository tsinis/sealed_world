...
void main() => group(
      "$CountryArg() L10N",
      () {
        const value = CountryArg();

        test("has translation for 'en' locale", () {
          const expectedName = "Argentina";
          const expectedFullName = "Argentine Republic";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Аргентина";
          const expectedFullName = "Аргентинска Република";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "الأرجنتين";
          const expectedFullName = "جمهورية الأرجنتين";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Arc'hantina";
          const expectedFullName = "Republik Arc'hantina";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Argentina";
          const expectedFullName = "Argentinská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Ariannin";
          const expectedFullName = "Gweriniaeth yr Ariannin";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Argentinien";
          const expectedFullName = "Argentinische Republik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Argentina";
          const expectedFullName = "Argentina Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Argentiina";
          const expectedFullName = "Argentiinan tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Argentine";
          const expectedFullName = "République argentine";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Argentina";
          const expectedFullName = "Argentinski Republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Argentína";
          const expectedFullName = "Argentin Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Argentina";
          const expectedFullName = "Repubblica Argentina";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "アルゼンチン";
          const expectedFullName = "アルゼンチン共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "아르헨티나";
          const expectedFullName = "아르헨티나 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Argentinië";
          const expectedFullName = "Argentijnse Republiek";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "آرژانتین";
          const expectedFullName = "جمهوری آرژانتین";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Argentyna";
          const expectedFullName = "Republika Argentyńska";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Argentina";
          const expectedFullName = "República Argentina";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Аргентина";
          const expectedFullName = "Аргентинская Республика";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Argentína";
          const expectedFullName = "Argentínska republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Argentina";
          const expectedFullName = "Republiken Argentina";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Arjantin";
          const expectedFullName = "Arjantin Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "ارجنٹائن";
          const expectedFullName = "جمہوریہ ارجنٹائن";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "阿根廷";
          const expectedFullName = "阿根廷共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "আৰ্জেণ্টিনা";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "আর্জেন্টিনা";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཨར་ཇེན་ཊི་ན";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Argentina nutome";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Airgintín";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "An Argantain";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "A Arxentina";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "આર્જેન્ટીના";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Arjantiniya";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "l-Arġentina";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "အာဂျင်တီးနား";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "अर्जेन्टिना";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଆର୍ଜେଣ୍ଟିନା";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ආර්ජෙන්ටිනාව";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "அர்ஜென்டினா";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "อาร์เจนตินา";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Agentínà";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Argentina";
        ...
        test("has translation for 'bh' locale", () {
          const expectedName = "अर्जेन्टीना";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "yn Argenteen";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Béésh Łigaii Bikéyah";
        ...
        test("has translation for 'om' locale", () {
          const expectedName = "Arjentiinaa";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Argentiinná";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "E-Argentina";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Ahgwnhdingz";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Agentínà";
