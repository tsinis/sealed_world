...
void main() => group(
      "$CountryAia() L10N",
      () {
        const value = CountryAia();

        test("has translation for 'en' locale", () {
          const expectedName = "Anguilla";
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Angvila";
          const expectedFullName = "Anguilla";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "アンギラ";
          const expectedFullName = "アングィラ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Anguilla";
          const expectedFullName = "Anguila";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "এ্যাঙ্গুইলা";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Anguilla nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Ààngúlílà";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Anhgveihlah";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Ààngúlílà";
