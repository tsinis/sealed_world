...
void main() => group(
      "$CountryLka() L10N",
      () {
        const value = CountryLka();

        test("has translation for 'en' locale", () {
          const expectedName = "Sri Lanka";
          const expectedFullName = "Democratic Socialist Republic of Sri Lanka";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Сри Ланка";
          const expectedFullName =
              "Демократска Социјалистичка Република Сри Ланка";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "سريلانكا";
          const expectedFullName = "جمهورية سريلانكا الديمقراطية الشعبية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Sri Lanka";
          const expectedFullName = "Republik Demokratel ha Sokialour Sri Lanka";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "スリランカ";
          const expectedFullName = "スリランカ民主社会主義共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "스리랑카";
          const expectedFullName = "스리랑카 민주 사회주의 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "سری‌لانکا";
          const expectedFullName = "جمهوری دموکراتیک سوسیالیستی سری‌لانکا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Sri Lanka";
          const expectedFullName = "Sri Lanka Demokratik Sosyalist Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "سری لنکا";
          const expectedFullName = "جمہوری و اشتراکی جمہوریہ سری لنکا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "斯里兰卡";
          const expectedFullName = "斯里兰卡民主社会主义共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Sri Lanka nutome";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "is-Sri Lanka";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ශ්‍රී ලංකාව";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "סרי־לאַנקאַ";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Siri Lanka";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Sri Lanka";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Sri Lanka - Sri Lankā";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Swii Lankʼa";
        ...
        test("has translation for 'om' locale", () {
          const expectedName = "Sirilaankaa";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Swhlijlanzgaj";
        ...
        test("has translation for 'ks_Arab' locale", () {
          const expectedName = "سِریٖلَنٛکا";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Siri Lanka";
