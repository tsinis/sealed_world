...
import "package:sealed_countries/src/data/other_world_countries.data.dart";
...
void main() => group(
      "$CountryUnk() L10N",
      () {
        const value = CountryUnk();

        test("has translation for 'en' locale", () {
          const expectedName = "Kosovo";
          const expectedFullName = "Republic of Kosovo";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Косово";
          const expectedFullName = "Република Косово";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "كوسوفو";
          const expectedFullName = "جمهورية كوسوفو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Kosovo";
          const expectedFullName = "Republik Kosovo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Kosovo";
          const expectedFullName = "Kosovská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Kosovo";
          const expectedFullName = "Kosovo Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Kosovo";
          const expectedFullName = "Kosovon tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Kosovo";
          const expectedFullName = "République du Kosovo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Kosovo";
          const expectedFullName = "Republika Kosovo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Kosovo";
          const expectedFullName = "Repubblica del Kosovo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "코소보";
          const expectedFullName = "코소보 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Kosovo";
          const expectedFullName = "Republiek Kosovo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "کوزوو";
          const expectedFullName = "جمهوری کوزوو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Kosowo";
          const expectedFullName = "Republika Kosowa";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Kosovo";
          const expectedFullName = "República do Kosovo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Республика Косово";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Kosovo";
          const expectedFullName = "República de Kosovo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Kosovo";
          const expectedFullName = "Republiken Kosovo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Kosova";
          const expectedFullName = "Kosova Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "کوسووہ";
          const expectedFullName = "جمہوریہ کوسووہ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "科索沃";
          const expectedFullName = "科索沃共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Κοσσυφοπέδιο";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "कोसोवो गणराज्य";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ປະເທດໂກໂຊໂວ";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਕੋਸੋਵੋ ਗਣਰਾਜ";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ประเทศคอซอวอ";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Косово Җөмһүрияте";
        ...
        test("has translation for 'ny' locale", () {
          const expectedName = "Kosovo";

          final translated = value.maybeTranslation(
            const BasicLocale(LangNya()),
            useLanguageFallback: false,
          );
          ...
          expect(commonMapTranslation, expectedName);
          final unexpectedScriptTranslation = value.maybeTranslation(
            const BasicLocale(LangNya(), script: ScriptCyrs()),
          );

          expect(unexpectedScriptTranslation?.name, expectedName);
          expect(
            value.translations,
            contains(const TranslatedName(LangNya(), name: expectedName)),
          );
        });
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Kasar Kosovo";
        ...
        test("has translation for 'en_DG' locale", () {
          const expectedName = "Kosovo";

          final translated = value.maybeTranslation(
            const BasicLocale(LangEng(), countryCode: "DG"),
            useLanguageFallback: false,
          );
