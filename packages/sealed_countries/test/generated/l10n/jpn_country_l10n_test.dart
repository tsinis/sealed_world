...
void main() => group(
      "$CountryJpn() L10N",
      () {
        const value = CountryJpn();

        test("has translation for 'en' locale", () {
          const expectedName = "Japan";
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "일본";
          const expectedFullName = "일본국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Dzapan nutome";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an tSeapáin";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "An t-Seapan";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Japani";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Binaʼadaałtzózí Dinéʼiʼ Bikéyah";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Japani";
