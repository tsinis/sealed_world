...
void main() => group(
      "$CountryTur() L10N",
      () {
        const value = CountryTur();

        test("has translation for 'en' locale", () {
          const expectedName = "Turkey";
          const expectedFullName = "Republic of Turkey";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Турска";
          const expectedFullName = "Турска Република";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "تركيا";
          const expectedFullName = "الجمهورية التركية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Turkia";
          const expectedFullName = "Republik Turkia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Turecko";
          const expectedFullName = "Turecká republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Türkei";
          const expectedFullName = "Republik Türkei";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Türgi";
          const expectedFullName = "Türgi Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Turkki";
          const expectedFullName = "Turkin tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Turquie";
          const expectedFullName = "République de Turquie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Turska";
          const expectedFullName = "Republika Turska";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Törökország";
          const expectedFullName = "Török Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Turchia";
          const expectedFullName = "Repubblica di Turchia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "トルコ";
          const expectedFullName = "トルコ共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "터키";
          const expectedFullName = "터키 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Turkije";
          const expectedFullName = "Republiek Turkije";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "ترکیه";
          const expectedFullName = "جمهوری ترکیه";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Turcja";
          const expectedFullName = "Republika Turcji";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Turquia";
          const expectedFullName = "República da Turquia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Турция";
          const expectedFullName = "Республика Турции";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Turquía";
          const expectedFullName = "República de Turquía";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Turkiet";
          const expectedFullName = "Republiken Turkiet";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Türkiye";
          const expectedFullName = "Türkiye Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "ترکی";
          const expectedFullName = "جمہوریہ ترکی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "土耳其";
          const expectedFullName = "土耳其共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Tɛki nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Tọọki";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "ތުރުކީވިލާތް";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Tʼóok Bikéyah";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Tɔɔki";
