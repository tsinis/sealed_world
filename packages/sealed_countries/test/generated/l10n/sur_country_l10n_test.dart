...
void main() => group(
      "$CountrySur() L10N",
      () {
        const value = CountrySur();

        test("has translation for 'en' locale", () {
          const expectedName = "Suriname";
          const expectedFullName = "Republic of Suriname";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Суринам";
          const expectedFullName = "Република Суринам";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "سورينام";
          const expectedFullName = "جمهورية سورينام";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Surinam";
          const expectedFullName = "Republik Surinam";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Surinam";
          const expectedFullName = "Republika Surinam";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Suriname";
          const expectedFullName = "Republik Suriname";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Suriname";
          const expectedFullName = "Suriname Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Suriname";
          const expectedFullName = "Surinamen tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Surinam";
          const expectedFullName = "République du Suriname";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Suriname";
          const expectedFullName = "Suriname Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Suriname";
          const expectedFullName = "Repubblica del Suriname";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "スリナム";
          const expectedFullName = "スリナム共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "수리남";
          const expectedFullName = "수리남 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Suriname";
          const expectedFullName = "Republiek Suriname";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "سورینام";
          const expectedFullName = "جمهوری سورینام";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Surinam";
          const expectedFullName = "Republika Surinamu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Suriname";
          const expectedFullName = "República do Suriname";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Суринам";
          const expectedFullName = "Республика Суринам";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Surinam";
          const expectedFullName = "Surinamská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Surinam";
          const expectedFullName = "República de Suriname";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Surinam";
          const expectedFullName = "Republiken Surinam";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Surinam";
          const expectedFullName = "Surinam Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "سرینام";
          const expectedFullName = "جمہوریہ سرینام";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "苏里南";
          const expectedFullName = "苏里南共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Suriname nutome";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "is-Suriname";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Surinami";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Toorinam";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Surinami";
