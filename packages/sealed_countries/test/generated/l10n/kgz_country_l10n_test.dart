...
void main() => group(
      "$CountryKgz() L10N",
      () {
        const value = CountryKgz();

        test("has translation for 'en' locale", () {
          const expectedName = "Kyrgyzstan";
          const expectedFullName = "Kyrgyz Republic";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Киргизија";
          const expectedFullName = "Киргиска Република";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "قيرغيزستان";
          const expectedFullName = "الجمهورية القيرغيزية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Kirgizstan";
          const expectedFullName = "Republik Kirgiz";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Kyrgyzstán";
          const expectedFullName = "Kyrgyzská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Kirgisistan";
          const expectedFullName = "Kirgisische Republik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Kõrgõzstan";
          const expectedFullName = "Kirgiisi Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Kirgisia";
          const expectedFullName = "Kirgisian tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Kirghizistan";
          const expectedFullName = "République kirghize";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Kirgistan";
          const expectedFullName = "Kirgistanu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Kirgizisztán";
          const expectedFullName = "Kirgiz Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "キルギス";
          const expectedFullName = "キルギス共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "키르기스스탄";
          const expectedFullName = "키르기스 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Kirgizië";
          const expectedFullName = "Kirgizische Republiek";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "قرقیزستان";
          const expectedFullName = "جمهوری قِرقیزستان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Kirgistan";
          const expectedFullName = "Republika Kirgiska";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Quirguistão";
          const expectedFullName = "República do Quirguistão";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Киргизия";
          const expectedFullName = "Кыргызская Республика";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Kirgizsko";
          const expectedFullName = "Kirgizská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Kirguizistán";
          const expectedFullName = "República Kirguisa";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Kirgizistan";
          const expectedFullName = "Republiken Kirgizistan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Kırgızistan";
          const expectedFullName = "Kırgızistan Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "کرغیزستان";
          const expectedFullName = "جمہوریہ کرغیزستان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "吉尔吉斯斯坦";
          const expectedFullName = "吉尔吉斯斯坦共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "কিৰ্গিজস্তান";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Qırğızıstan";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Kirigizisitaŋ";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "কিরগিজিস্তান";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "Kirguizistan";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཀིར་གིས་སཏཱན";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Kirgizstan nutome";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Kirgizistano";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Chirgeastáin";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "કિર્ગિઝ્સ્તાન";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "किर्गिज़स्तान";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Kirigizistani";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "កៀហ្ស៊ីស៊ីស្ថាន";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಕಿರ್ಗಿಸ್ಥಾನ್";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Qirgizistan";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Kirigizisitaani";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ຄຽກກິດສະຖານ";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Kirgizstāna";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "किरगिझस्तान";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Kirgiżistan";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "किर्गिस्तान";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "କିର୍ଗିଜିସ୍ତାନ";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਕਿਰਗਿਜ਼ਸਤਾਨ";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "Kirghisistan";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Kirigisitani";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Kirigizitùaan";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "කිර්ගිස්තානය";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "கிர்கிஸ்தான்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "కిర్గిజిస్తాన్";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Қирғизистон";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "คีร์กีซสถาน";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Gyrgyzystan";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "قىرغىزىستان";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Qirgʻiziston";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Kuriṣisitani";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Kyrgyzstan";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ཀེ་རེ་གེཛུ་སུཏེན།";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "ކިރިގިސްތާން";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Chyrgistaan";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Kíígiz Bikéyah";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Quirguizstan";
        ...
        test("has translation for 'rw' locale", () {
          const expectedName = "Kirigizisitani";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Kirghìzistan";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "EKyrgyzstan";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Gizwjgizswhswhdanj";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Гырғызыстан";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Kurishisitani";
