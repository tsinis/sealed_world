...
void main() => group(
      "$CountryHti() L10N",
      () {
        const value = CountryHti();

        test("has translation for 'en' locale", () {
          const expectedName = "Haiti";
          const expectedFullName = "Republic of Haiti";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Хаити";
          const expectedFullName = "Република Хаити";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "هايتي";
          const expectedFullName = "جمهورية هايتي";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Haiti";
          const expectedFullName = "Republik Haiti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Haiti";
          const expectedFullName = "Republika Haiti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Haiti";
          const expectedFullName = "Haiti Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Haiti";
          const expectedFullName = "Haitin tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Haïti";
          const expectedFullName = "République d'Haïti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Haiti";
          const expectedFullName = "Haiti Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Haiti";
          const expectedFullName = "Repubblica di Haiti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ハイチ";
          const expectedFullName = "ハイチ共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "아이티";
          const expectedFullName = "아이티 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Haïti";
          const expectedFullName = "Republiek Haïti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "هائیتی";
          const expectedFullName = "جمهوری هائیتی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Haiti";
          const expectedFullName = "República do Haiti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          ...
          const expectedFullName = "Республика Гаити";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Haiti";
          const expectedFullName = "Haitská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Haití";
          const expectedFullName = "República de Haití";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Haiti";
          const expectedFullName = "Republiken Haiti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Haiti";
          const expectedFullName = "Haiti Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "ہیٹی";
          const expectedFullName = "جمہوریہ ہیٹی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "海地";
          const expectedFullName = "海地共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Haiti nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Haati";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Haití (estat)";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Haati";
