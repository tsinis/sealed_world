...
void main() => group(
      "$CountrySyr() L10N",
      () {
        const value = CountrySyr();

        test("has translation for 'en' locale", () {
          const expectedName = "Syria";
          const expectedFullName = "Syrian Arab Republic";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Сирија";
          const expectedFullName = "Сиријска Арапска Република";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "سوريا";
          const expectedFullName = "الجمهورية العربية السورية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Siria";
          const expectedFullName = "Republik Arab Siriat";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Sýrie";
          const expectedFullName = "Syrská arabská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Syrien";
          const expectedFullName = "Arabische Republik Syrien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Süüria";
          const expectedFullName = "Süüria Araabia Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Syyria";
          const expectedFullName = "Syyrian arabitasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Syrie";
          const expectedFullName = "République arabe syrienne";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Sirija";
          const expectedFullName = "Sirijska Arapska Republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Szíria";
          const expectedFullName = "Szíriai Arab Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Siria";
          const expectedFullName = "Repubblica araba siriana";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "シリア・アラブ共和国";
          const expectedFullName = "シリアアラブ共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "시리아";
          const expectedFullName = "시리아 아랍 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Syrië";
          const expectedFullName = "Syrische Arabische Republiek";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "سوریه";
          const expectedFullName = "جمهوری عربی سوریه";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Syria";
          const expectedFullName = "Syryjska Republika Arabska";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Síria";
          const expectedFullName = "República Árabe Síria";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Сирия";
          const expectedFullName = "Сирийская Арабская Республика";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Sýria";
          const expectedFullName = "Sýrska arabská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Siria";
          const expectedFullName = "República Árabe Siria";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Syrien";
          const expectedFullName = "Syriska arabiska republiken";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Suriye";
          const expectedFullName = "Suriye Arap Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "سوریہ";
          const expectedFullName = "عرب جمہوریہ سوریہ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "叙利亚";
          const expectedFullName = "叙利亚阿拉伯共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Siria nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Siria";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Siria";
