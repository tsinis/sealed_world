...
void main() => group(
      "$CountryEst() L10N",
      () {
        const value = CountryEst();

        test("has translation for 'en' locale", () {
          const expectedName = "Estonia";
          const expectedFullName = "Republic of Estonia";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Естонија";
          const expectedFullName = "Естонска Република";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "إستونيا";
          const expectedFullName = "جمهورية إستونيا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Estonia";
          const expectedFullName = "Republik Estonia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Estonsko";
          const expectedFullName = "Estonská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Estonia";
          const expectedFullName = "Gweriniaeth Estonia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Estland";
          const expectedFullName = "Republik Estland";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Eesti";
          const expectedFullName = "Eesti Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Viro";
          const expectedFullName = "Viron tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Estonie";
          const expectedFullName = "République d'Estonie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Estonija";
          const expectedFullName = "Republika Estonija";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Észtország";
          const expectedFullName = "Észt Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Estonia";
          const expectedFullName = "Repubblica di Estonia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "エストニア";
          const expectedFullName = "エストニア共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "에스토니아";
          const expectedFullName = "에스토니아 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Estland";
          const expectedFullName = "Republiek Estland";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "اِستونی";
          const expectedFullName = "جمهوری استونی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Estonia";
          const expectedFullName = "Republika Estońska";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Estónia";
          const expectedFullName = "República da Estónia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Эстония";
          const expectedFullName = "Эстонская Республика";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Estónsko";
          const expectedFullName = "Estónska republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Estonia";
          const expectedFullName = "República de Estonia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Estland";
          const expectedFullName = "Republiken Estland";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Estonya";
          const expectedFullName = "Estonya Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "اسٹونیا";
          const expectedFullName = "جمہوریہ اسٹونیا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "爱沙尼亚";
          const expectedFullName = "爱沙尼亚共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཨེས་ཊོ་ནི་ཡ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Estonia nutome";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "အက်စတိုးနီးယား";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Esitonia";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ཨིསུ་ཊོ་ནིཡ།";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Ééstii Bikéyah";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Esitonia";
