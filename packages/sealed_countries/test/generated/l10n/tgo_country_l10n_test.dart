...
void main() => group(
      "$CountryTgo() L10N",
      () {
        const value = CountryTgo();

        test("has translation for 'en' locale", () {
          const expectedName = "Togo";
          const expectedFullName = "Togolese Republic";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Того";
          const expectedFullName = "Тоголешка Република";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "توغو";
          const expectedFullName = "جمهورية توغو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Togo";
          const expectedFullName = "Republik Togoat";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Togo";
          const expectedFullName = "Republika Togo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Togo";
          const expectedFullName = "Republik Togo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Togo";
          const expectedFullName = "Togo Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Togo";
          const expectedFullName = "Togon tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Togo";
          const expectedFullName = "République togolaise";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Togo";
          const expectedFullName = "Togolese Republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Togo";
          const expectedFullName = "Togói Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Togo";
          const expectedFullName = "Repubblica del Togo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "トーゴ";
          const expectedFullName = "トーゴ共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "토고";
          const expectedFullName = "토고 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Togo";
          const expectedFullName = "Republiek Togo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "توگو";
          const expectedFullName = "جمهوری توگو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Togo";
          const expectedFullName = "Republika Togijska";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Togo";
          const expectedFullName = "República do Togo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Того";
          const expectedFullName = "Того Республика";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Togo";
          const expectedFullName = "Togská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Togo";
          const expectedFullName = "República de Togo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Togo";
          const expectedFullName = "Republiken Togo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Togo";
          const expectedFullName = "Togo Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "ٹوگو";
          const expectedFullName = "جمہوریہ ٹوگو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "多哥";
          const expectedFullName = "多哥共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Togo nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Togo";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Togo";
