...
void main() => group(
      "$CountryUga() L10N",
      () {
        const value = CountryUga();

        test("has translation for 'en' locale", () {
          const expectedName = "Uganda";
          const expectedFullName = "Republic of Uganda";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Уганда";
          const expectedFullName = "Република Уганда";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "أوغندا";
          const expectedFullName = "جمهورية أوغندا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Ouganda";
          const expectedFullName = "Republik Ouganda";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Uganda";
          const expectedFullName = "Ugandská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Uganda";
          const expectedFullName = "Republik Uganda";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Uganda";
          const expectedFullName = "Uganda Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Uganda";
          const expectedFullName = "Ugandan tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Ouganda";
          const expectedFullName = "République de l'Ouganda";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Uganda";
          const expectedFullName = "Republika Uganda";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Uganda";
          const expectedFullName = "Ugandai Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Uganda";
          const expectedFullName = "Repubblica di Uganda";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ウガンダ";
          const expectedFullName = "ウガンダ共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "우간다";
          const expectedFullName = "우간다 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Oeganda";
          const expectedFullName = "Republiek Uganda";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "اوگاندا";
          const expectedFullName = "جمهوری اوگاندا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Uganda";
          const expectedFullName = "Republika Ugandy";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Uganda";
          const expectedFullName = "República do Uganda";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Уганда";
          const expectedFullName = "Республика Уганда";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Uganda";
          const expectedFullName = "República de Uganda";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Uganda";
          const expectedFullName = "Republiken Uganda";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Uganda";
          const expectedFullName = "Uganda Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "یوگنڈا";
          const expectedFullName = "جمہوریہ یوگنڈا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "乌干达";
          const expectedFullName = "乌干达共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Uganda nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Uganda";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Uganda";
