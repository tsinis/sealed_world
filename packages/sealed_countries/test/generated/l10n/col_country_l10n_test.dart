...
void main() => group(
      "$CountryCol() L10N",
      () {
        const value = CountryCol();

        test("has translation for 'en' locale", () {
          const expectedName = "Colombia";
          const expectedFullName = "Republic of Colombia";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Колумбија";
          const expectedFullName = "Република Колумбија";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "كولومبيا";
          const expectedFullName = "جمهورية كولومبيا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Kolombia";
          const expectedFullName = "Republik Kolombia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Kolumbie";
          const expectedFullName = "Kolumbijská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Colombia";
          const expectedFullName = "Gweriniaeth Colombia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Kolumbien";
          const expectedFullName = "Republik Kolumbien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Colombia";
          const expectedFullName = "Colombia Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Kolumbia";
          const expectedFullName = "Kolumbian tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Colombie";
          const expectedFullName = "République de Colombie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Kolumbija";
          const expectedFullName = "Republika Kolumbija";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Kolumbia";
          const expectedFullName = "Kolumbiai Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Colombia";
          const expectedFullName = "Repubblica di Colombia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "コロンビア";
          const expectedFullName = "コロンビア共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "콜롬비아";
          const expectedFullName = "콜롬비아 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Colombia";
          const expectedFullName = "Republiek Colombia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "کلمبیا";
          const expectedFullName = "جمهوری کلمبیا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Kolumbia";
          const expectedFullName = "Republika Kolumbii";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Colômbia";
          const expectedFullName = "República da Colômbia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Колумбия";
          const expectedFullName = "Республика Колумбия";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Colombia";
          const expectedFullName = "República de Colombia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Colombia";
          const expectedFullName = "Republiken Colombia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Kolombiya";
          const expectedFullName = "Kolombiya Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "کولمبیا";
          const expectedFullName = "جمہوریہ کولمبیا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "哥伦比亚";
          const expectedFullName = "哥伦比亚共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཀོ་ལོམ་བྷི་ཡ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Kolombia nutome";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Kolombja";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "කොළොම්බියාව";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Kòlómíbìa";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ཁོ་ལོམ་བི་ཡ།";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Cholombey";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "IsiColombia";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Gohlunzbijya";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Kòlómíbìa";
