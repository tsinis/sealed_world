...
void main() => group(
      "$CountrySdn() L10N",
      () {
        const value = CountrySdn();

        test("has translation for 'en' locale", () {
          const expectedName = "Sudan";
          const expectedFullName = "Republic of the Sudan";
        ...
        test("has translation for 'sr' locale", () {
          ...
          const expectedFullName = "Република Судан";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "السودان";
          const expectedFullName = "جمهورية السودان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Soudan";
          const expectedFullName = "Republik Soudan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Súdán";
          const expectedFullName = "Súdánská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Sudan";
          const expectedFullName = "Republik Sudan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Sudaan";
          const expectedFullName = "Sudaani Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Sudan";
          const expectedFullName = "Sudanin tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Soudan";
          const expectedFullName = "République du Soudan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Sudan";
          const expectedFullName = "Republika Sudan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Szudán";
          const expectedFullName = "Szudáni Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Sudan";
          const expectedFullName = "Repubblica del Sudan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "スーダン";
          const expectedFullName = "スーダン共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "수단";
          const expectedFullName = "수단 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Soedan";
          const expectedFullName = "Republiek Soedan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "سودان";
          const expectedFullName = "جمهوری سودان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Sudão";
          const expectedFullName = "República do Sudão";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Судан";
          const expectedFullName = "Республика Судан";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Sudán";
          const expectedFullName = "Sudánska republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Sudán";
          const expectedFullName = "República de Sudán";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Sudan";
          const expectedFullName = "Republiken Sudan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Sudan";
          const expectedFullName = "Sudan Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "سودان";
          const expectedFullName = "جمہوریہ سودان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "苏丹";
          const expectedFullName = "苏丹共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Sudan nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Sudani";
        ...
        test("has translation for 'kl' locale", () {
          const expectedName = "Avannarleqsudan";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Sudani";
