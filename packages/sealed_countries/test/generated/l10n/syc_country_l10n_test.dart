...
void main() => group(
      "$CountrySyc() L10N",
      () {
        const value = CountrySyc();

        test("has translation for 'en' locale", () {
          const expectedName = "Seychelles";
          const expectedFullName = "Republic of Seychelles";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Сејшели";
          const expectedFullName = "Република Сејшели";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "سيشل";
          const expectedFullName = "جمهورية سيشل";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Sechelez";
          const expectedFullName = "Republik Sechelez";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Seychely";
          const expectedFullName = "Seychelská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Seychellen";
          const expectedFullName = "Republik der Seychellen";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Seišellid";
          const expectedFullName = "Seišelli Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Seychellit";
          const expectedFullName = "Seychellien tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Seychelles";
          const expectedFullName = "République des Seychelles";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Sejšeli";
          const expectedFullName = "Republika Sejšeli";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Seychelle-szigetek";
          const expectedFullName = "Seychelle Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Seychelles";
          const expectedFullName = "Repubblica delle Seychelles";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "セーシェル";
          const expectedFullName = "セイシェル共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "세이셸";
          const expectedFullName = "세이셸 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Seychellen";
          const expectedFullName = "Republiek der Seychellen";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "سیشل";
          const expectedFullName = "جمهوری سیشل";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Seszele";
          const expectedFullName = "Republika Seszeli";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Seicheles";
          const expectedFullName = "República das Seychelles";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Сейшельские Острова";
          const expectedFullName = "Республика Сейшельские Острова";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Seychelles";
          const expectedFullName = "República de las Seychelles";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Seychellerna";
          const expectedFullName = "Republiken Seychellerna";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Seyşeller";
          const expectedFullName = "Seyşeller Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "سیچیلیس";
          const expectedFullName = "جمہوریہ سیچیلیس";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "塞舌尔";
          const expectedFullName = "塞舌尔共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Seyşel adaları";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Сейшэльскія астравы";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Сейшелан гӀайренаш";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "Seychellerne";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Seshɛls nutome";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Seychelleak";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Seyskelloyggjar";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Na h-Eileanan Sheiseall";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Seychelles-eyjar";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "სეიშელის კუნძულები";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Сейшель аралдары";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Сейшел аралдары";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Seišelu salas";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Сейшелийн арлууд";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "is-Seychelles";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "Seychellene";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "Seychellane";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Amazinga ya Seyisheli";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Seychellsullot";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Ushelisheli";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Seýşel adalary";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "ʻOtumotu Seiseli";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Сейшел утраулары";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Сейшельські Острови";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Seyshel orollari";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède seṣẹlẹsi";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Seychelles";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Сейшел утравĕсем";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Seixeles - Seychelles";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Ny h-Ellanyn Heshell";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Insulae Seisellenses";
        ...
        test("has translation for 'qu' locale", () {
          const expectedName = "Sichillakuna";
        ...
        test("has translation for 'ss' locale", () {
          const expectedName = "ISeyishelesi";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "ESeychelles";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Сеишелтәи адгьылбжьахақәа";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Сејшел адалары";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Сейшел ороллари";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède seshɛlɛsi";
