...
void main() => group(
      "$CountryAla() L10N",
      () {
        const value = CountryAla();

        test("has translation for 'en' locale", () {
          const expectedName = "Åland Islands";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Оландска Острва";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Åland";
          const expectedFullName = "Inizi Åland";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Ålandy";
          const expectedFullName = "Ålandské ostrovy";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Åland";
          const expectedFullName = "Åland-Inseln";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Ahvenamaa";
          const expectedFullName = "Ahvenamaa maakond";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Ahvenanmaa";
          const expectedFullName = "Ahvenanmaan maakunta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Ålandski otoci";
          const expectedFullName = "Aland Islands";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Åland-szigetek";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Isole Aland";
          const expectedFullName = "Isole Åland";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Ålandeilanden";
          const expectedFullName = "Åland eilanden";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Wyspy Alandzkie";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Alândia";
          const expectedFullName = "Ilhas Åland";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Аландские острова";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Alandy";
          const expectedFullName = "Alandské ostrovy";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Alandia";
          const expectedFullName = "Islas Åland";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Åland";
          const expectedFullName = "Åland Adaları";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "جزائر اولند";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Ålandeilande";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "আলণ্ড দ্বীপপুঞ্জ";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Aland adaları";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Аландскія астравы";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Оландски острови";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "আলান্ড দ্বীপপুঞ্জ";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Olandska ostrva";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "Illes Åland";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Аландан гӀайренаш";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཨ་ལནཌ་གླིང་ཚོམ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Åland ƒudomekpo nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Νήσοι Όλαντ";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Oileáin Åland";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Na h-Eileanan Åland";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Illas Åland";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "ઑલેન્ડ આઇલેન્ડ્સ";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "एलैंड द्वीपसमूह";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Ալանդյան կղզիներ";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Insulas Åland";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Kepulauan Aland";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Agwaetiti Aland";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Álandseyjar";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Kapuloan Alan";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ალანდის კუნძულები";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Аланд аралдары";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಆಲ್ಯಾಂಡ್ ದ್ವೀಪಗಳು";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "ایلینڑ جٔزیٖرٕ";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Ålandinselen";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ຫມູ່ເກາະໂອລັນ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Alandų Salos";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Olandes salas";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "അലൻഡ് ദ്വീപുകൾ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Аландын арлууд";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "अ‍ॅलँड बेटे";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Gżejjer Aland";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "အာလန်ကျွန်း";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "अलान्ड टापुहरु";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଅଲାଣ୍ଡ ଦ୍ଵୀପପୁଞ୍ଜ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "الاند ټاپوان";
        ...
        test("has translation for 'qu' locale", () {
          const expectedName = "Islas Åland";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "Inslas Aland";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Insulele Åland";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ඕලන්ඩ් දූපත්";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "Ålandski otoki";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Jasiiradda Aland";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Ishujt Alandë";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Visiwa vya Aland";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "ஆலந்து தீவுகள்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "ఆలాండ్ దీవులు";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Ҷазираҳои Аланд";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "หมู่เกาะโอลันด์";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Aland adalary";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "ʻOtumotu ʻAlani";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Аланд утраулары";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ئالاند ئاراللىرى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Аландські Острови";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Aland orollari";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Quần đảo Åland";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Duni Aalànd";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Åland Islands";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Аланди утравӗсем";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤕𞤵𞤪𞤭𞥅𞤶𞤫 𞤀𞤤𞤢𞤲𞤣";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Tsibirai na Åland";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Giravên Alandê";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Ìsulas Åland";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "E-Åland Islands";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Àwọn Erékùsù ti Åland";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Аландтәи ад-хақәа";
        ...
        test("has translation for 'ie' locale", () {
          const expectedName = "Insules Åland";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Bisanga Ɛland";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Аланд ороллари";
        ...
        test("has translation for 'ks_Arab' locale", () {
          const expectedName = "ایلینٛڑ جٔزیٖرٕ";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Аланд адалары";
