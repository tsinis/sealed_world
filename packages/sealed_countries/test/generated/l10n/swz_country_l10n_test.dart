...
void main() => group(
      "$CountrySwz() L10N",
      () {
        const value = CountrySwz();

        test("has translation for 'en' locale", () {
          const expectedName = "Eswatini";
          const expectedFullName = "Kingdom of Eswatini";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Есватини";
          const expectedFullName = "Краљевина Есватини";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "إسواتيني";
          const expectedFullName = "مملكة إسواتيني";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Eswatini";
          const expectedFullName = "Rouantelezh Eswatini";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Svazijsko";
          const expectedFullName = "Svazijské království";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Swasiland";
          const expectedFullName = "Königreich Eswatini";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Svaasimaa";
          const expectedFullName = "eSwatini Kuningriik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Swazimaa";
          const expectedFullName = "Swazimaan kuningaskunta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Swaziland";
          const expectedFullName = "Royaume d’Eswatini";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Svazi";
          const expectedFullName = "Kraljevina eSwatini";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Szváziföld";
          const expectedFullName = "Szváziföldi Királyság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Swaziland";
          const expectedFullName = "Regno di eSwatini";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "スワジランド";
          const expectedFullName = "スワジランド王国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "에스와티니";
          const expectedFullName = "에스와티니 왕국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Swaziland";
          const expectedFullName = "Koninkrijk eSwatini";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "اسواتینی";
          const expectedFullName = "پادشاهی سوازیلند";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Suazi";
          const expectedFullName = "Królestwo Suazi";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Suazilândia";
          const expectedFullName = "Reino de eSwatini";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Свазиленд";
          const expectedFullName = "Королевство Свазиленд";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Svazijsko";
          const expectedFullName = "Svazijské kráľovstvo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Suazilandia";
          const expectedFullName = "Reino de eSwatini";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Swaziland";
          const expectedFullName = "Konungariket Eswatini";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Esvatini";
          const expectedFullName = "Esvatini Krallığı";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "سوازی لینڈ";
          const expectedFullName = "مملکتِ سوازی لینڈ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "斯威士兰";
          const expectedFullName = "斯威士兰王国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "སུ་ཝ་ཛི་ལེནཌ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Swaziland nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Σουαζιλάνδη";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Swazilandia";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Swaasilannda";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "स्वाज़ीलैंड";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "​ເອ​ສະ​ວາ​ຕິ​ນີ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Svazilandas";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "സ്വാസിലാന്റ്";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "is-Swaziland";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "स्वाजिल्याण्ड";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Suwazilandi";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "எஸ்வாட்டீனி";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "סוואַזילאַנד";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Saṣiland";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Swaziland";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "སུ་ཝ་ཛི་ལནཌ།";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "ސުވާޒިލޭންޑު";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Suacilandia - Swaziland";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Çheer Swassee";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Swáazi Dineʼé Bikéyah";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Suwasilandya";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Swhveihswlanz";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Sashiland";
