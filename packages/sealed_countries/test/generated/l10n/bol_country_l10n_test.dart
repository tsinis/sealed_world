...
void main() => group(
      "$CountryBol() L10N",
      () {
        const value = CountryBol();

        test("has translation for 'en' locale", () {
          const expectedName = "Bolivia";
          const expectedFullName = "Plurinational State of Bolivia";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Боливија";
          const expectedFullName = "Вишенационална Држава Боливија";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "بوليفيا";
          const expectedFullName = "دولة بوليفيا المتعددة القوميات";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Bolivia";
          const expectedFullName = "Stad Liesvroadel Bolivia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Bolívie";
          const expectedFullName = "Mnohonárodnostní stát Bolívie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Bolifia";
          const expectedFullName = "Gweriniaeth Bolifia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Bolivien";
          const expectedFullName = "Plurinationaler Staat Bolivien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Boliivia";
          const expectedFullName = "Boliivia Paljurahvuseline Riik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Bolivia";
          const expectedFullName = "Bolivian monikansainen valtio";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Bolivie";
          const expectedFullName = "État plurinational de Bolivie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Bolívia";
          const expectedFullName = "Bolíviai Többnemzetiségű Állam";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Bolivia";
          const expectedFullName = "Stato Plurinazionale della Bolivia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ボリビア多民族国";
          const expectedFullName = "ボリビアの多民族国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "볼리비아";
          const expectedFullName = "볼리비아 다민족국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Bolivia";
          const expectedFullName = "Plurinationale Staat van Bolivia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "بولیوی";
          const expectedFullName = "جمهوری بولیوی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Boliwia";
          const expectedFullName = "Wielonarodowe Państwo Boliwia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Bolívia";
          const expectedFullName = "Estado Plurinacional da Bolívia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Боливия";
          const expectedFullName = "Многонациональное Государство Боливия";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Bolívia";
          const expectedFullName = "Bolívijská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Bolivia";
          const expectedFullName = "Estado Plurinacional de Bolivia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Bolivia";
          const expectedFullName = "Mångnationella staten Bolivia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Bolivya";
          const expectedFullName = "Bolivya Çokuluslu Devleti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "بولیویا";
          const expectedFullName = "جمہوریہ بولیویا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "玻利维亚";
          const expectedFullName = "多民族玻利维亚国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "བྷེ་ལི་བི་ཡ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Bolivia nutome";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဘိုလီးဗီးယား";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Bọ̀lífíyà";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "བྷོ་ལི་ཝི་ཡ།";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Bohliveizya";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Bɔ̀lífíyà";
