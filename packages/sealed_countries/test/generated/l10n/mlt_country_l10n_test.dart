...
void main() => group(
      "$CountryMlt() L10N",
      () {
        const value = CountryMlt();

        test("has translation for 'en' locale", () {
          const expectedName = "Malta";
          const expectedFullName = "Republic of Malta";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Малта";
          const expectedFullName = "Република Малта";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "مالطا";
          const expectedFullName = "جمهورية مالطا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Malta";
          const expectedFullName = "Republik Malta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Malta";
          const expectedFullName = "Maltská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Malta";
          const expectedFullName = "Malta Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Malta";
          const expectedFullName = "Maltan tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Malte";
          const expectedFullName = "République de Malte";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Malta";
          const expectedFullName = "Republika Malta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Málta";
          const expectedFullName = "Máltai Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Malta";
          const expectedFullName = "Repubblica di Malta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "マルタ";
          const expectedFullName = "マルタ共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "몰타";
          const expectedFullName = "몰타 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Malta";
          const expectedFullName = "Republiek Malta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "مالت";
          const expectedFullName = "جمهوری مالت";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Malta";
          const expectedFullName = "Republika Malty";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Malta";
          const expectedFullName = "República de Malta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          ...
          const expectedFullName = "Республика Мальта";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Malta";
          const expectedFullName = "Republiken Malta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Malta";
          const expectedFullName = "Malta Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "مالٹا";
          const expectedFullName = "جمہوریہ مالٹا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "马耳他";
          const expectedFullName = "马耳他共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Malta nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Malata";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Malata";
