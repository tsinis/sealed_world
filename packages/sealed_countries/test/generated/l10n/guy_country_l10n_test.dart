...
void main() => group(
      "$CountryGuy() L10N",
      () {
        const value = CountryGuy();

        test("has translation for 'en' locale", () {
          const expectedName = "Guyana";
          const expectedFullName = "Co-operative Republic of Guyana";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Гвајана";
          const expectedFullName = "Кооперативна Република Гвајана";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "غيانا";
          const expectedFullName = "جمهورية غيانا التعاونية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Guyana";
          const expectedFullName = "Republik Kevelourel Gwiana";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Guyana";
          const expectedFullName = "Kooperativní republika Guyana";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Guyana";
          const expectedFullName = "Kooperative Republik Guyana";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Guyana";
          const expectedFullName = "Guyana Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Guayana";
          const expectedFullName = "Guayanan osuustoiminnallinen tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Guyana";
          const expectedFullName = "République coopérative de Guyana";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Gvajana";
          const expectedFullName = "Zadruga Republika Gvajana";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Guyana";
          const expectedFullName = "Guyanai Szövetkezeti Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ガイアナ";
          const expectedFullName = "ガイアナの協同共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "가이아나";
          const expectedFullName = "가이아나 협동 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Guyana";
          const expectedFullName = "Coöperatieve Republiek Guyana";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "گویان";
          const expectedFullName = "جمهوری تعاونی گویان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Gujana";
          const expectedFullName = "Kooperacyjna Republika Gujany";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Guiana";
          const expectedFullName = "Co -operative República da Guiana";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Гайана";
          const expectedFullName = "Кооперативная Республика Гайана";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Guyana";
          const expectedFullName = "Guyanská kooperatívna republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Guyana";
          const expectedFullName = "República Cooperativa de Guyana";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Guyana";
          const expectedFullName = "Kooperativa republiken Guyana";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Guyana";
          const expectedFullName = "Guyana Kooperatif Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "گیانا";
          const expectedFullName = "تعاونی جمہوریہ گیانا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "圭亚那";
          const expectedFullName = "圭亚那共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Guyana";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Guyana";
