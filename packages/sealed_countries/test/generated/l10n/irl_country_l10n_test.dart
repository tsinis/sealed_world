...
void main() => group(
      "$CountryIrl() L10N",
      () {
        const value = CountryIrl();

        test("has translation for 'en' locale", () {
          const expectedName = "Ireland";
          const expectedFullName = "Republic of Ireland";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Ирска";
          const expectedFullName = "Република Ирска";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "أيرلندا";
          const expectedFullName = "جمهورية أيرلندا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Iwerzhon";
          const expectedFullName = "Republik Iwerzhon";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Irland";
          const expectedFullName = "Republik Irland";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Irlanti";
          const expectedFullName = "Irlannin tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Irlande";
          const expectedFullName = "République d'Irlande";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Irska";
          const expectedFullName = "Republika Irska";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Írország";
          const expectedFullName = "Ír Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Irlanda";
          const expectedFullName = "Repubblica d'Irlanda";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "アイルランド";
          const expectedFullName = "アイルランド共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "아일랜드";
          const expectedFullName = "아일랜드 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Irlandia";
          const expectedFullName = "Republika Irlandii";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Irlanda";
          const expectedFullName = "República da Irlanda";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Írsko";
          const expectedFullName = "Írska republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Irlanda";
          const expectedFullName = "República de Irlanda";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "İrlanda";
          const expectedFullName = "İrlanda Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "جزیرہ آئرلینڈ";
          const expectedFullName = "جمہوریہ جزیرہ آئرلینڈ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "爱尔兰";
          const expectedFullName = "爱尔兰共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "আয়ারল্যান্ড";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Ireland nutome";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Républik Irlan";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ئىرېلاندىيە";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Ailandi";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Ирланди Республики";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "އަޔަލޭންޑުގެ ޖުމްހޫރިއްޔާ";
        ...
        test("has translation for 'kw' locale", () {
          const expectedName = "Repoblek Wordhen";
        ...
        test("has translation for 'na' locale", () {
          const expectedName = "Ripubrikit Airerand";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Bitsiighaʼ Łichííʼí Bikéyah";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Republica d'Irlanda";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Aiwjlanz Gunghozgoz";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Ailandi";
