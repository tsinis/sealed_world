...
void main() => group(
      "$CountryBhr() L10N",
      () {
        const value = CountryBhr();

        test("has translation for 'en' locale", () {
          const expectedName = "Bahrain";
          const expectedFullName = "Kingdom of Bahrain";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Бахреин";
          const expectedFullName = "Краљевина Бахреин";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "‏البحرين";
          const expectedFullName = "مملكة البحرين";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Bahrein";
          const expectedFullName = "Rouantelezh Bahrein";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Bahrajn";
          const expectedFullName = "Království Bahrajn";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Bahrain";
          const expectedFullName = "Teyrnas Bahrein";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Bahrain";
          const expectedFullName = "Königreich Bahrain";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Bahrein";
          const expectedFullName = "Bahreini Kuningriik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Bahrain";
          const expectedFullName = "Bahrainin kuningaskunta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Bahreïn";
          const expectedFullName = "Royaume de Bahreïn";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Bahrein";
          const expectedFullName = "Kraljevina Bahrein";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Bahrein";
          const expectedFullName = "Bahreini Királyság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Bahrein";
          const expectedFullName = "Regno del Bahrain";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "バーレーン";
          const expectedFullName = "バーレーン王国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "바레인";
          const expectedFullName = "바레인 왕국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Bahrein";
          const expectedFullName = "Koninkrijk Bahrein";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "بحرین";
          const expectedFullName = "پادشاهی بحرین";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Bahrajn";
          const expectedFullName = "Królestwo Bahrajnu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Bahrein";
          const expectedFullName = "Reino do Bahrein";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Бахрейн";
          const expectedFullName = "Королевство Бахрейн";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Bahrajn";
          const expectedFullName = "Bahrajnské kráľovstvo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Bahrein";
          const expectedFullName = "Reino de Bahrein";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Bahrain";
          const expectedFullName = "Konungariket Bahrain";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Bahreyn";
          const expectedFullName = "Bahreyn Krallığı";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "بحرین";
          const expectedFullName = "مملکتِ بحرین";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "巴林";
          const expectedFullName = "巴林王国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Bahrain nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Báránì";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Báránì";
