...
void main() => group(
      "$CountryCuw() L10N",
      () {
        const value = CountryCuw();

        test("has translation for 'en' locale", () {
          const expectedName = "Curaçao";
          const expectedFullName = "WorldCountry of Curaçao";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "كوراساو";
          const expectedFullName = "دولة كوراساو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Curaçao";
          const expectedFullName = "Bro Curaçao";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Curaçao";
          const expectedFullName = "Autonomní země Curaçao";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Curaçao";
          const expectedFullName = "Land Curaçao";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Curaçao";
          const expectedFullName = "Pays de Curaçao";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Curaçao";
          const expectedFullName = "Paese di Curaçao";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "ilha da Curação";
          const expectedFullName = "País de Curaçao";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Кюрасао";
          const expectedFullName = "Страна Кюрасао";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Curazao";
          const expectedFullName = "País de Curazao";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "کیوراساؤ";
          const expectedFullName = "مملکتِ کیوراساؤ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Kasar Curaçao";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ကျူရေးကိုးစ်";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Kurakao nutome";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Insula Curacensis";
