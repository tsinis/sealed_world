...
void main() => group(
      "$CountryFin() L10N",
      () {
        const value = CountryFin();

        test("has translation for 'en' locale", () {
          const expectedName = "Finland";
          const expectedFullName = "Republic of Finland";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Финска";
          const expectedFullName = "Република Финска";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "فنلندا";
          const expectedFullName = "جمهورية فنلندا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Finland";
          const expectedFullName = "Republik Finland";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Finsko";
          const expectedFullName = "Finská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Finnland";
          const expectedFullName = "Republik Finnland";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Soome";
          const expectedFullName = "Soome Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Suomi";
          const expectedFullName = "Suomen tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Finlande";
          const expectedFullName = "République de Finlande";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Finska";
          const expectedFullName = "Republika Finska";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Finnország";
          const expectedFullName = "Finn Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Finlandia";
          const expectedFullName = "Repubblica di Finlandia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "フィンランド";
          const expectedFullName = "フィンランド共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "핀란드";
          const expectedFullName = "핀란드 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Finland";
          const expectedFullName = "Republiek Finland";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "فنلاند";
          const expectedFullName = "جمهوری فنلاند";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Finlandia";
          const expectedFullName = "Republika Finlandii";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Finlândia";
          const expectedFullName = "República da Finlândia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Финляндия";
          const expectedFullName = "Финляндская Республика";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Fínsko";
          const expectedFullName = "Fínska republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Finlandia";
          const expectedFullName = "República de Finlandia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Finland";
          const expectedFullName = "Republiken Finland";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Finlandiya";
          const expectedFullName = "Finlandiya Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "فن لینڈ";
          const expectedFullName = "جمہوریہ فن لینڈ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "芬兰";
          const expectedFullName = "芬兰共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Finland nutome";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Fhionlainn";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "An Fhionnlann";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಫಿನ್‌ಲ್ಯಾಂಡ್";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Finlandja";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Finlýandiýa";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Filandi";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Nahoditsʼǫʼłání";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Filandi";
