...
void main() => group(
      "$CountryEcu() L10N",
      () {
        const value = CountryEcu();

        test("has translation for 'en' locale", () {
          const expectedName = "Ecuador";
          const expectedFullName = "Republic of Ecuador";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Република Еквадор";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "الإكوادور";
          const expectedFullName = "جمهورية الإكوادور";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Ecuador";
          const expectedFullName = "Republik Ecuador";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Ekvádor";
          const expectedFullName = "Ekvádorská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Ecwador";
          const expectedFullName = "Gweriniaeth Ecwador";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Ecuador";
          const expectedFullName = "Ecuadori Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Ecuador";
          const expectedFullName = "Ecuadorin tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Équateur";
          const expectedFullName = "République de l'Équateur";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Ekvador";
          const expectedFullName = "Republika Ekvador";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Ecuador";
          const expectedFullName = "Ecuadori Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Ecuador";
          const expectedFullName = "Repubblica dell'Ecuador";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "エクアドル";
          const expectedFullName = "エクアドル共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "에콰도르";
          const expectedFullName = "에콰도르 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Ecuador";
          const expectedFullName = "Republiek Ecuador";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "اکوادور";
          const expectedFullName = "جمهوری اکوادور";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Equador";
          const expectedFullName = "República do Equador";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Эквадор";
          const expectedFullName = "Республика Эквадор";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Ecuador";
          const expectedFullName = "República del Ecuador";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Ecuador";
          const expectedFullName = "Republiken Ecuador";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Ekvador";
          const expectedFullName = "Ekvador Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "ایکواڈور";
          const expectedFullName = "جمہوریہ ایکوڈور";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "厄瓜多尔";
          const expectedFullName = "厄瓜多尔共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Ekuadɔ nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Ekuádò";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ཨེ་ཁོའོ་ཌོར།";
        ...
        test("has translation for 'kw' locale", () {
          const expectedName = "Pow Ekwadorel";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Kéyah Nahasdzáán Ałníiʼgi Siʼánígíí";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Ngwzgyahdohwj";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Ekuádò";
