...
void main() => group(
      "$CountryBih() L10N",
      () {
        const value = CountryBih();

        test("has translation for 'en' locale", () {
          const expectedName = "Bosnia and Herzegovina";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Босна и Херцеговина";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "البوسنة والهرسك";
          const expectedFullName = "جمهورية البوسنة والهرسك";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Bosnia-ha-Herzegovina";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Bosna a Hercegovina";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Bosnia a Hercegovina";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Bosnien und Herzegowina";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Bosnia ja Hertsegoviina";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Bosnia ja Hertsegovina";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Bosnie-Herzégovine";
          const expectedFullName = "Bosnie-et-Herzégovine";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Bosna i Hercegovina";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Bosznia-Hercegovina";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Bosnia ed Erzegovina";
          const expectedFullName = "Bosnia-Erzegovina";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ボスニア・ヘルツェゴビナ";
          const expectedFullName = "ボスニア·ヘルツェゴビナ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "보스니아 헤르체고비나";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Bosnië en Herzegovina";
          const expectedFullName = "Bosnië-Herzegovina";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "بوسنی و هرزگوین";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Bośnia i Hercegowina";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Bósnia e Herzegovina";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Босния и Герцеговина";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Bosna a Hercegovina";
          const expectedFullName = "Republika Bosny a Hercegoviny";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Bosnia y Herzegovina";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Bosnien och Hercegovina";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Bosna-Hersek";
          const expectedFullName = "Bosna ve Hersek";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "بوسنیا و ہرزیگووینا";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Bosnië en Herzegowina";
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Bosnia ne Hɛzegovina";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "ቦስኒያ እና ሄርዞጎቪኒያ";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "ব’ছনিয়া আৰু হাৰ্জেগ’ভিনা";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Bosniya və Herseqovina";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Боснія і Герцагавіна";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Bozni-Ɛrizigovini";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "বসনিয়া ও হার্জেগোভিনা";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "Bòsnia i Hercegovina";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Босни а, Герцеговина а";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "Bosnien-Hercegovina";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "བྷོས་ནི་ཡ་ ཨེནཌ་ ཧར་ཛི་གྷོ་བི་ན";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Bosnia kple Herzergovina nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Βοσνία - Ερζεγοβίνη";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Bosnio-Hercegovino";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Bosnia-Herzegovina";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Bosnii Hersegowiin";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Bosnia-Hersegovina";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Bhoisnia agus an Heirseagaivéin";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Bosna is Hearsagobhana";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Bosnia e Hercegovina";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "બોસ્નિયા અને હર્ઝેગોવિના";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Bosniya Harzagobina";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "בוסניה והרצגובינה";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "बोस्निया और हर्ज़ेगोविना";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Բոսնիա և Հերցեգովինա";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Bosnia e Herzegovina";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Bosnia dan Herzegovina";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Bosnía og Hersegóvína";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Bosnia lan Hèrségovina";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ბოსნია და ჰერცეგოვინა";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Bosnia na Hezegovina";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Босния және Герцеговина";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "បូស្នី និងហឺហ្សីហ្គូវីណា";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಬೋಸ್ನಿಯಾ ಮತ್ತು ಹರ್ಜೆಗೋವಿನಾ";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "بوسنِیا تہٕ ہَرزِگووِنا";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Bosniya û Herzegovîna";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Босния жана Герцеговина";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Bosnien an Herzegowina";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Boziniya Hezegovina";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Bosini mpé Hezegovine";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ບອດສະເນຍ ແລະ ແຮສໂກວີນາ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Bosnija ir Hercegovina";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Mbosini ne Hezegovine";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Bosnija un Hercegovina";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Bosnia sy Herzegovina";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ബോസ്നിയയും ഹെർസഗോവിനയും";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Босни-Герцеговин";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "बोस्निया अणि हर्जेगोविना";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Bożnija-Ħerzegovina";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဘော့စနီးယားနှင့် ဟာဇီဂိုဗီနား";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "Bosnia-Hercegovina";
        ...
        test("has translation for 'nd' locale", () {
          const expectedName = "Bhosnia le Herzegovina";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "बोस्निया एण्ड हर्जगोभिनिया";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ବୋସନିଆ ଏବଂ ହର୍ଜଗୋଭିନା";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਬੋਸਨੀਆ ਅਤੇ ਹਰਜ਼ੇਗੋਵੀਨਾ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "بوسنيا او هېرزګوينا";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Bosiniya na Herigozevine";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Bosnia și Herțegovina";
        ...
        test("has translation for 'sd' locale", () {
          const expectedName = "بوسنیا اور هرزیگوینا";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Bosnïi na Herzegovînni";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "බොස්නියාව සහ හර්සගොවීනාව";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "Bosna in Hercegovina";
        ...
        test("has translation for 'sn' locale", () {
          const expectedName = "Boznia ne Herzegovina";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Boosniya & Harsegofina";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Bosnjë-Hercegovinë";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "போஸ்னியா & ஹெர்ஸகோவினா";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "బోస్నియా మరియు హెర్జిగోవినా";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Босния ва Ҳерсеговина";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "บอสเนียและเฮอร์เซโกวีนา";
        ...
        test("has translation for 'ti' locale", () {
          const expectedName = "ቦዝንያን ሄርዘጎቪናን";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Bosniýa we Gersegowina";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Posinia mo Hesikōvina";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Босния һәм Герцеговина";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "بوسىنىيە ۋە گېرتسېگوۋىنا";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Боснія і Герцеґовина";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Bosniya va Gertsegovina";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Bosnia và Herzegovina";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Bosni Ersegowin";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "באסניע הערצעגאווינע";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Bọ̀síníà àti Ẹtisẹgófínà";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Bosnia ne-Herzegovina";
        ...
        test("has translation for 'av' locale", () {
          const expectedName = "Бо́сния ва Герцегови́на";
        ...
        test("has translation for 'bh' locale", () {
          const expectedName = "बोस्निया आ हर्जेगोविना";
        ...
        test("has translation for 'bi' locale", () {
          const expectedName = "Bosnia mo Herzegovina";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "བྷོསུ་ནིཡ་དང་ཧར་ཛེ་གྷོ་ཝི་ན།";
        ...
        test("has translation for 'co' locale", () {
          const expectedName = "Bosnia è Erzegovina";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Босни тата Герцеговина";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "ބޮސްނިޔާ އެންޑް ހެރްޒިގޮވީނާ";
        ...
        test("has translation for 'gn' locale", () {
          const expectedName = "Vonia ha Hesegovina";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Bosnia as Herzegovina";
        ...
        test("has translation for 'ht' locale", () {
          const expectedName = "Bosni ak Erzegovin";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Bosnia na Herzegovina";
        ...
        test("has translation for 'kv' locale", () {
          const expectedName = "Босния да Герцеговина";
        ...
        test("has translation for 'kw' locale", () {
          const expectedName = "Bosni–Hercegovina";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Bosnia et Herzegovina";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Pōngia-Herekōmina";
        ...
        test("has translation for 'na' locale", () {
          const expectedName = "Boteniya me Erdegobina";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Bosna dóó Hetsog Bikéyah";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Bòsnia e Ercegovina";
        ...
        test("has translation for 'om' locale", () {
          const expectedName = "Boosniyaa fi Herzegoviinaa";
        ...
        test("has translation for 'os' locale", () {
          const expectedName = "Босни æмæ Герцеговинæ";
        ...
        test("has translation for 'pi' locale", () {
          const expectedName = "बास्निया";

          final translated = value.maybeTranslation(
            const BasicTypedLocale(LangPli()),
            useLanguageFallback: false,
          );
          ...
          expect(commonMapTranslation, expectedName);
          final unexpectedScriptTranslation = value.maybeTranslation(
            const BasicTypedLocale(LangPli(), script: ScriptCyrs()),
          );

          expect(unexpectedScriptTranslation?.name, expectedName);
          expect(
            value.translations,
            contains(const TranslatedName(LangPli(), name: expectedName)),
          );
        });
        test("has translation for 'rw' locale", () {
          const expectedName = "Bosiniya na Herizegovina";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Bòsnia e Erzegòvina";
        ...
        test("has translation for 'sm' locale", () {
          const expectedName = "Bosnia ma Herzegovina";
        ...
        test("has translation for 'ss' locale", () {
          const expectedName = "iBhosinya ne Hezegovi";
        ...
        test("has translation for 'su' locale", () {
          const expectedName = "Bosnia jeung Hérzégovina";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Bosnia at Herzegovina";
        ...
        test("has translation for 'ty' locale", () {
          const expectedName = "Pōtinia-Heretōvina";
        ...
        test("has translation for 'vo' locale", () {
          const expectedName = "Bosnän e Härzegovän";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "EBosnia & Herzegovina";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Босниеи Герцеговинеи";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Bohswhnizya caeuq Hwzsaigohveizna";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Боснија вә Һерсеговина";
        ...
        test("has translation for 'mn_Cyrl' locale", () {
          const expectedName = "Босни Херцеговин";
        ...
        test("has translation for 'se_FI' locale", () {
          const expectedName = "Bosnia ja Hercegovina";

          final translated = value.maybeTranslation(
            const BasicTypedLocale(LangSme(), country: CountryFin()),
            useLanguageFallback: false,
          );
        ...
        test("has translation for 'ug_Arab' locale", () {
          const expectedName = "بوسنىيە-گېرتسېگوۋىنا";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Босния ва Герцеговина";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Bɔ̀síníà àti Ɛtisɛgófínà";
