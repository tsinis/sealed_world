...
void main() => group(
      "$CountryMrt() L10N",
      () {
        const value = CountryMrt();

        test("has translation for 'en' locale", () {
          const expectedName = "Mauritania";
          const expectedFullName = "Islamic Republic of Mauritania";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Мауританија";
          const expectedFullName = "Исламска Република Мауританија";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "موريتانيا";
          const expectedFullName = "الجمهورية الإسلامية الموريتانية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Maouritania";
          const expectedFullName = "Republik islamek Maouritania";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Mauritánie";
          const expectedFullName = "Mauritánská islámská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Mauretanien";
          const expectedFullName = "Islamische Republik Mauretanien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Mauritaania";
          const expectedFullName = "Mauritaania Islamivabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Mauritania";
          const expectedFullName = "Mauritanian islamilainen tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Mauritanie";
          const expectedFullName = "République islamique de Mauritanie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Mauritanija";
          const expectedFullName = "Islamska Republika Mauritanija";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Mauritánia";
          const expectedFullName = "Mauritániai Iszlám Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Mauritania";
          const expectedFullName = "Repubblica islamica di Mauritania";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "モーリタニア";
          const expectedFullName = "モーリタニア·イスラム共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "모리타니";
          const expectedFullName = "모리타니 이슬람 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Mauritanië";
          const expectedFullName = "Islamitische Republiek Mauritanië";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "موریتانی";
          const expectedFullName = "جمهوری اسلامی موریتانی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Mauretania";
          const expectedFullName = "Islamska Republika Mauretańska";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Mauritânia";
          const expectedFullName = "República Islâmica da Mauritânia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Мавритания";
          const expectedFullName = "Исламская Республика Мавритания";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Mauritánia";
          const expectedFullName = "Mauritánska islamská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Mauritania";
          const expectedFullName = "República Islámica de Mauritania";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Mauretanien";
          const expectedFullName = "Islamiska republiken Mauretanien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Moritanya";
          const expectedFullName = "Moritanya İslam Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "موریتانیہ";
          const expectedFullName = "اسلامی جمہوریہ موریتانیہ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "毛里塔尼亚";
          const expectedFullName = "毛里塔尼亚伊斯兰共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "মাউৰিটানিয়া";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Mavritaniya";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "མོ་རི་ཊེ་ནི་ཡ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Mauritania nutome";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Maŭritanujo";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Mháratáin";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Mawulitenya";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Mauritānija";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Мавританија";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "മൗറിറ്റാനിയ";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Mauritania";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "မော်ရီတေးနီးယား";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "माउरिटानिया";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "මොරිටේනියාව";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "Mavretanija";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Muritaaniya";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Mawritaniýa";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ماۋرىتانىيە";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "מאַריטאַניע";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Maritania";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Mauritania";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "མའུ་རི་ཏ་ནི་ཡ།";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Varitaan";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Moowitéínya";
        ...
        test("has translation for 'ss' locale", () {
          const expectedName = "IMolithaniya";
        ...
        test("has translation for 'wa' locale", () {
          const expectedName = "Moritanreye";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "EMauritania";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Mauzlijdaznizya";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Maritania";
