...
void main() => group(
      "$CountryAfg() L10N",
      () {
        const value = CountryAfg();

        test("has translation for 'en' locale", () {
          const expectedName = "Afghanistan";
          const expectedFullName = "Islamic Republic of Afghanistan";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Авганистан";
          const expectedFullName = "Исламска Република Авганистан";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "أفغانستان";
          const expectedFullName = "جمهورية أففانستان الإسلامية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Afghanistan";
          const expectedFullName = "Republik Islamek Afghanistan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Afghánistán";
          const expectedFullName = "Afghánská islámská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Affganistan";
          const expectedFullName = "Gweriniaeth Islamaidd Affganistan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Afghanistan";
          const expectedFullName = "Islamische Republik Afghanistan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Afganistan";
          const expectedFullName = "Afganistani Islamivabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Afganistan";
          const expectedFullName = "Afganistanin islamilainen tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Afghanistan";
          const expectedFullName = "République islamique d'Afghanistan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Afganistan";
          const expectedFullName = "Islamska Republika Afganistan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Afganisztán";
          const expectedFullName = "Afganisztáni Iszlám Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Afghanistan";
          const expectedFullName = "Repubblica islamica dell'Afghanistan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "アフガニスタン";
          const expectedFullName = "アフガニスタン·イスラム共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "아프가니스탄";
          const expectedFullName = "아프가니스탄 이슬람 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Afghanistan";
          const expectedFullName = "Islamitische Republiek Afghanistan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "افغانستان";
          const expectedFullName = "جمهوری اسلامی افغانستان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Afganistan";
          const expectedFullName = "Islamska Republika Afganistanu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Afeganistão";
          const expectedFullName = "República Islâmica do Afeganistão";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Афганистан";
          const expectedFullName = "Исламская Республика Афганистан";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Afganistan";
          const expectedFullName = "Afgánsky islamský štát";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Afganistán";
          const expectedFullName = "República Islámica de Afganistán";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Afghanistan";
          const expectedFullName = "Islamiska republiken Afghanistan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Afganistan";
          const expectedFullName = "Afganistan İslam Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "افغانستان";
          const expectedFullName = "اسلامی جمہوریہ افغانستان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "阿富汗";
          const expectedFullName = "阿富汗伊斯兰共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "আফগানিস্তান";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Afiganistaŋ";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "ОвхӀан мохк";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཨཕ་གྷ་ནི་སཏཱན";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Afghanistan nutome";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Afganistaan";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Afganastáin";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Afghanastàn";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "અફઘાનિસ્તાન";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Afaganistan";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "अफ़गानिस्तान";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Afuganistani";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "អាហ្វហ្គានីស្ថាន";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಅಫಘಾನಿಸ್ಥಾನ";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "اَفغانَستان";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Afaganisitani";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Afiganisitá";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ອາຟການິດສະຖານ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Afganistanas";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Afuganisita";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Afganistāna";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "അഫ്‌ഗാനിസ്ഥാൻ";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "अफगाणिस्तान";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "l-Afganistan";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "အာဖဂန်နစ္စတန်";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "अफगानिस्तान";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଆଫଗାନିସ୍ତାନ୍";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਅਫ਼ਗਾਨਿਸਤਾਨ";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Afuganisitani";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Afganïstäan";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ඇෆ්ගනිස්ථානය";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Afgaanistaan";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "ஆஃப்கானிஸ்தான்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "ఆఫ్ఘనిస్తాన్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "อัฟกานิสถาน";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "ʻAfikānisitani";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ئافغانىستان";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Afgʻoniston";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "אַפֿגהאַניסטאַן";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Àfùgànístánì";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Afghanistan";
        ...
        test("has translation for 'bh' locale", () {
          const expectedName = "अफ़ग़ानिस्तान";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ཨ་ཧྥུའུ་རྒན་སི་ཐན།";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "އަފްޣާނިސްތާން";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Afghanistaan";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Afganistana";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Āwhekenetāna";
        ...
        test("has translation for 'os' locale", () {
          const expectedName = "Афгъанистан";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Afganistána";
        ...
        test("has translation for 'sm' locale", () {
          const expectedName = "Afakanisitana";
        ...
        test("has translation for 'vo' locale", () {
          const expectedName = "Lafganistän";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "E-Afghanistan";
        ...
        test("has translation for 'kl' locale", () {
          const expectedName = "Afghanistani";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Àfùgànístánì";
