...
void main() => group(
      "$CountryPer() L10N",
      () {
        const value = CountryPer();

        test("has translation for 'en' locale", () {
          const expectedName = "Peru";
          const expectedFullName = "Republic of Peru";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Перу";
          const expectedFullName = "Република Перу";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "بيرو";
          const expectedFullName = "جمهورية بيرو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Perou";
          const expectedFullName = "Republik Perou";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Peru";
          const expectedFullName = "Peruánská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Peru";
          const expectedFullName = "Republik Peru";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Peruu";
          const expectedFullName = "Peruu Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Peru";
          const expectedFullName = "Perun tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Pérou";
          const expectedFullName = "République du Pérou";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Peru";
          const expectedFullName = "Republika Peru";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Peru";
          const expectedFullName = "Perui Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Perù";
          const expectedFullName = "Repubblica del Perù";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ペルー";
          const expectedFullName = "ペルー共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "페루";
          const expectedFullName = "페루 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Peru";
          const expectedFullName = "Republiek Peru";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "پرو";
          const expectedFullName = "جمهوری پرو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Perú";
          const expectedFullName = "República do Peru";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Перу";
          const expectedFullName = "Республика Перу";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Peru";
          const expectedFullName = "Peruánska republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Perú";
          const expectedFullName = "República de Perú";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Peru";
          const expectedFullName = "Republiken Peru";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Peru";
          const expectedFullName = "Peru Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "پیرو";
          const expectedFullName = "جمہوریہ پیرو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "秘鲁";
          const expectedFullName = "秘鲁共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Peru nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Peru";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Peru";
