...
void main() => group(
      "$CountryMwi() L10N",
      () {
        const value = CountryMwi();

        test("has translation for 'en' locale", () {
          const expectedName = "Malawi";
          const expectedFullName = "Republic of Malawi";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Малави";
          const expectedFullName = "Република Малави";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "مالاوي";
          const expectedFullName = "جمهورية مالاوي";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Malawi";
          const expectedFullName = "Republik Malawi";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Malawi";
          const expectedFullName = "Malawiská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Malawi";
          const expectedFullName = "Malawi Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Malawi";
          const expectedFullName = "Malawin tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Malawi";
          const expectedFullName = "République du Malawi";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Malavi";
          const expectedFullName = "Republika Malavi";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Malawi";
          const expectedFullName = "Malawi Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Malawi";
          const expectedFullName = "Repubblica del Malawi";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "マラウイ";
          const expectedFullName = "マラウイ共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "말라위";
          const expectedFullName = "말라위 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Malawi";
          const expectedFullName = "Republiek Malawi";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "مالاوی";
          const expectedFullName = "جمهوری مالاوی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Malawi";
          const expectedFullName = "Republika Malawi";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Malawi";
          const expectedFullName = "República do Malawi";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Малави";
          const expectedFullName = "Республика Малави";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Malawi";
          const expectedFullName = "Malawijská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Malawi";
          const expectedFullName = "República de Malawi";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Malawi";
          const expectedFullName = "Republiken Malawi";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Malavi";
          const expectedFullName = "Malavi Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "ملاوی";
          const expectedFullName = "جمہوریہ ملاوی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "马拉维";
          const expectedFullName = "马拉维共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Malawi nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Malawi";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Malaui - Malawi";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Malawi";
