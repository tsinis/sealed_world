...
void main() => group(
      "$CountryNcl() L10N",
      () {
        const value = CountryNcl();

        test("has translation for 'en' locale", () {
          const expectedName = "New Caledonia";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Нова Каледонија";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "كاليدونيا الجديدة";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Kaledonia-Nevez";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Nová Kaledonie";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Neukaledonien";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Uus-Kaledoonia";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Uusi-Kaledonia";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Nouvelle-Calédonie";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Nova Kaledonija";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Új-Kaledónia";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Nuova Caledonia";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Nieuw-Caledonië";
          const expectedFullName = "nieuw -Caledonië";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "کالدونیای جدید";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Nowa Kaledonia";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Nova Caledónia";
          const expectedFullName = "New Caledonia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Новая Каледония";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Nová Kaledónia";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Nueva Caledonia";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Nya Kaledonien";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Yeni Kaledonya";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "نیو کیلیڈونیا";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Nieu-Kaledonië";
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Kaledonia Foforo";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "নিউ কেলিডোনিয়া";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Yeni Kaledoniya";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Новая Каледонія";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Нова Каледония";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Kaledoni Koura";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "নিউ ক্যালেডোনিয়া";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "Nova Caledònia";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Керла Каледони";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "Ny Kaledonien";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ནིའུ་ཀ་ལི་དོ་ནི་ཡ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "New Kaledonia nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Νέα Καληδονία";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Nov-Kaledonio";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Kaledonia Berria";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Nuwel Kaledonii";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Nýkaledónia";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Nij-Caledonië";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Nua-Chaladóin";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Cailleann Nuadh";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Nova Caledonia";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "ન્યુ સેલેડોનિયા";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Kaledoniya Sabuwa";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "קלדוניה החדשה";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "न्यू कैलेडोनिया";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Նոր Կալեդոնիա";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Nove Caledonia";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Kaledonia Baru";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Nýja-Kaledónía";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Kalédonia Anyar";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ახალი კალედონია";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Nyukaledonia";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Жаңа Каледония";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "នូវែល​កាឡេដូនី";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ನ್ಯೂ ಕ್ಯಾಲಿಡೋನಿಯಾ";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "نِو کیلِڑونِیا";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Kaledonyaya Nû";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Жаңы Каледония";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Neikaledonien";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Kaledonya mupya";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Kaledoni ya sika";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ນິວ ຄາເລໂດເນຍ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Naujoji Kaledonija";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Kaledoni wa mumu";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Jaunkaledonija";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ന്യൂ കാലിഡോണിയ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Шинэ Каледони";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "न्यू कॅलेडोनिया";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "နယူး ကယ်လီဒိုနီးယား";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "Ny-Caledonia";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "न्यु क्यालेडोनिया";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ନୂତନ କାଲେଡୋନିଆ";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਨਿਊ ਕੈਲੇਡੋਨੀਆ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "نوی کالیډونیا";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Niyukaledoniya";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Noua Caledonie";
        ...
        test("has translation for 'sd' locale", () {
          const expectedName = "نیو ڪالیڊونیا";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Ođđa-Kaledonia";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Finî Kaledonïi";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "නව කැලිඩෝනියාව";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Jasiiradda Niyuu Kaledooniya";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Kaledoni e Re";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "நியூ கேலிடோனியா";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "క్రొత్త కాలెడోనియా";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Каледонияи Нав";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "นิวแคลิโดเนีย";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Täze Kaledoniýa";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Niu Kaletōnia";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Яңа Каледония";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "يېڭى كالېدونىيە";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Нова Каледонія";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Yangi Kaledoniya";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Nuwel Kaledoni";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "נײַ קאַלעדאניע";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Kaledonia Titun";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-New Caledonia";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Ҫӗнӗ Каледони";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Whenua Kanaki";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Caledònia Noa";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "ENew Caledonia";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Каледониа ҿыц";
        ...
        test("has translation for 'ie' locale", () {
          const expectedName = "Nov-Caledonia";
        ...
        test("has translation for 'kl' locale", () {
          const expectedName = "Nutaaq Caledonia";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Nòva Caledonia";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Јени Каледонија";
        ...
        test("has translation for 'ky_Cyrl' locale", () {
          const expectedName = "Жаӊы Каледония";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Янги Каледония";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Kaledonia Titun";
