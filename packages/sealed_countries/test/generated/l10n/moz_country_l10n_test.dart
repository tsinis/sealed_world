...
void main() => group(
      "$CountryMoz() L10N",
      () {
        const value = CountryMoz();

        test("has translation for 'en' locale", () {
          const expectedName = "Mozambique";
          const expectedFullName = "Republic of Mozambique";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Мозамбик";
          const expectedFullName = "Република Мозамбик";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "موزمبيق";
          const expectedFullName = "جمهورية موزمبيق";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Mozambik";
          const expectedFullName = "Republik Mozambik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Mosambik";
          const expectedFullName = "Mosambická republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Mosambik";
          const expectedFullName = "Republik Mosambik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Mosambiik";
          const expectedFullName = "Mosambiigi Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Mosambik";
          const expectedFullName = "Mosambikin tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Mozambique";
          const expectedFullName = "République du Mozambique";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Mozambik";
          const expectedFullName = "Republika Mozambiku";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Mozambik";
          const expectedFullName = "Mozambiki Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Mozambico";
          const expectedFullName = "Repubblica del Mozambico";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "モザンビーク";
          const expectedFullName = "モザンビーク共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "모잠비크";
          const expectedFullName = "모잠비크 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Mozambique";
          const expectedFullName = "Republiek Mozambique";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "موزامبیک";
          const expectedFullName = "جمهوری موزامبیک";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Moçambique";
          const expectedFullName = "República de Moçambique";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Мозамбик";
          const expectedFullName = "Республика Мозамбик";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Mozambik";
          const expectedFullName = "Mozambická republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Mozambique";
          const expectedFullName = "República de Mozambique";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Moçambique";
          const expectedFullName = "Republiken Moçambique";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Mozambik";
          const expectedFullName = "Mozambik Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "موزمبیق";
          const expectedFullName = "جمہوریہ موزمبیق";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "莫桑比克";
          const expectedFullName = "莫桑比克共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Mozambiki nutome";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "മൊസാംബിക്ക്";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Mozambique";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Moṣamibiku";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Mozambique";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Vosambeeck";
        ...
        test("has translation for 'ss' locale", () {
          const expectedName = "IMozambikhi";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "EMozambique";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Moshamibiku";
