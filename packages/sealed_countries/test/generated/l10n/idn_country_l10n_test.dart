...
void main() => group(
      "$CountryIdn() L10N",
      () {
        const value = CountryIdn();

        test("has translation for 'en' locale", () {
          const expectedName = "Indonesia";
          const expectedFullName = "Republic of Indonesia";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Индонезија";
          const expectedFullName = "Република Индонезија";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "إندونيسيا";
          const expectedFullName = "جمهورية إندونيسيا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Indonezia";
          const expectedFullName = "Republik Indonezia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Indonésie";
          const expectedFullName = "Indonéská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Indonesien";
          const expectedFullName = "Republik Indonesien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Indoneesia";
          const expectedFullName = "Indoneesia Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Indonesia";
          const expectedFullName = "Indonesian tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Indonésie";
          const expectedFullName = "République d'Indonésie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Indonezija";
          const expectedFullName = "Republika Indonezija";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Indonézia";
          const expectedFullName = "Indonéz Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Indonesia";
          const expectedFullName = "Repubblica di Indonesia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "インドネシア";
          const expectedFullName = "インドネシア共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "인도네시아";
          const expectedFullName = "인도네시아 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Indonesië";
          const expectedFullName = "Republiek Indonesië";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "اندونزی";
          const expectedFullName = "جمهوری اندونزی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Indonezja";
          const expectedFullName = "Republika Indonezji";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Indonésia";
          const expectedFullName = "República da Indonésia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Индонезия";
          const expectedFullName = "Республика Индонезия";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Indonézia";
          const expectedFullName = "Indonézska republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Indonesia";
          const expectedFullName = "República de Indonesia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Indonesien";
          const expectedFullName = "Republiken Indonesien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Endonezya";
          const expectedFullName = "Endonezya Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "انڈونیشیا";
          const expectedFullName = "جمہوریہ انڈونیشیا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "印度尼西亚";
          const expectedFullName = "印度尼西亚共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "ইণ্ডোনেচিয়া";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "ইন্দোনেশিয়া";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཨིན་ཌོ་ནེ་ཤི་ཡ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Indonesia nutome";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Indinéis";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Na h-Innd-innse";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "ઇન્ડોનેશિયા";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "اِنڑونیشِیا";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "l-Indoneżja";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "အင်ဒိုနီးရှား";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "इन्डोनेशिया";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ඉන්දුනීසියාව";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Indoneesiya";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "இந்தோனேசியா";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "อินโดนีเซีย";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "ʻInitonēsia";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ھىندونېزىيە";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Indonesia";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Indonesia";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ཨིན་རྡུ་ནི་ཤིས་ཡ།";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "އިންޑޮނޭޝިޔާ";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Indoneesh";
        ...
        test("has translation for 'na' locale", () {
          const expectedName = "Indonitsiya";
        ...
        test("has translation for 'om' locale", () {
          const expectedName = "Indoneeshiyaa";
        ...
        test("has translation for 'sa' locale", () {
          const expectedName = "इण्डोनेशिया";
        ...
        test("has translation for 'vo' locale", () {
          const expectedName = "Lindäna-Seänuäns";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Yindunizsihya";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "E-Indonesia";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Indonesia";
