...
void main() => group(
      "$CountryBwa() L10N",
      () {
        const value = CountryBwa();

        test("has translation for 'en' locale", () {
          const expectedName = "Botswana";
          const expectedFullName = "Republic of Botswana";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Боцвана";
          const expectedFullName = "Република Боцвана";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "بوتسوانا";
          const expectedFullName = "جمهورية بوتسوانا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Botswana";
          const expectedFullName = "Republik Botswana";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Botswana";
          const expectedFullName = "Botswanská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Botswana";
          const expectedFullName = "Republik Botsuana";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Botswana";
          const expectedFullName = "Botswana Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Botswana";
          const expectedFullName = "Botswanan tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Botswana";
          const expectedFullName = "République du Botswana";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Bocvana";
          const expectedFullName = "Republika Bocvana";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Botswana";
          const expectedFullName = "Botswanai Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Botswana";
          const expectedFullName = "Repubblica del Botswana";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ボツワナ";
          const expectedFullName = "ボツワナ共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "보츠와나";
          const expectedFullName = "보츠와나 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Botswana";
          const expectedFullName = "Republiek Botswana";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "بوتسوانا";
          const expectedFullName = "جمهوری بوتسوانا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Botswana";
          const expectedFullName = "Republika Botswany";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Botswana";
          const expectedFullName = "República do Botswana";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Ботсвана";
          const expectedFullName = "Республика Ботсвана";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Botswana";
          const expectedFullName = "República de Botswana";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Botswana";
          const expectedFullName = "Republiken Botswana";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Botsvana";
          const expectedFullName = "Botsvana Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "بوٹسوانا";
          const expectedFullName = "جمہوریہ بوٹسوانا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "博茨瓦纳";
          const expectedFullName = "博茨瓦纳共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Botswana nutome";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Bhotsuáin";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಬೋಟ್ಸ್‌ವಾನಾ";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Botswana";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Bọ̀tìsúwánà";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "yn Votswaan";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Tswana Dineʼé Bikéyah";
        ...
        test("has translation for 'om' locale", () {
          const expectedName = "Bootiswaanaa";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Bozswvajnaz";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Bɔ̀tìsúwánà";
