...
void main() => group(
      "$CountryDom() L10N",
      () {
        const value = CountryDom();

        test("has translation for 'en' locale", () {
          const expectedName = "Dominican Republic";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Доминикана";
          const expectedFullName = "Доминиканска Република";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "جمهورية الدومينيكان";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Republik Dominikan";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Dominikánská republika";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Gweriniaeth Dominica";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Dominikanische Republik";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Dominikaani Vabariik";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Dominikaaninen tasavalta";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "République dominicaine";
          const expectedFullName = "République Dominicaine";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Dominikanska Republika";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Dominikai Köztársaság";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Repubblica Dominicana";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Dominicaanse Republiek";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "جمهوری دومینیکن";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Dominikana";
          const expectedFullName = "Republika Dominikańska";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "República Dominicana";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Доминиканская Республика";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Dominikánska republika";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Dominikanska republiken";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Dominik Cumhuriyeti";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "ڈومینیکن";
          const expectedFullName = "جمہوریہ ڈومینیکن";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "多明尼加";
          const expectedFullName = "多明尼加共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Dominikaanse Republiek";
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Dɔmeneka Kurokɛse";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "ዶመኒካን ሪፑብሊክ";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "ড’মিনিকান ৰিপাব্লিক";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Dominikan Respublikası";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Дамініканская Рэспубліка";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Доминиканска република";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Dɔmimiki republiki";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "ডোমেনিকান প্রজাতন্ত্র";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Доминикан Республика";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "Den Dominikanske Republik";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཌོ་མི་ནི་ཀཱན་ རི་པབ་ལིཀ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Dominika repɔblik nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Δομινικανή Δημοκρατία";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Dominikar Errepublika";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Ndenndanndi Dominika";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Dominikalýðveldið";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Dominikaanske Republyk";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Phoblacht Dhoiminiceach";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "A’ Phoblachd Dhoiminiceach";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "ડોમિનિકન રિપબ્લિક";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Jamhuriyar Dominika";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "הרפובליקה הדומיניקנית";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "डोमिनिकन गणराज्य";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Դոմինիկյան Հանրապետություն";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Republica Dominican";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Republik Dominika";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Dominican Republik";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Dóminíska lýðveldið";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Républik Dominika";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "დომინიკელთა რესპუბლიკა";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Jamhuri ya Dominika";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Доминикан Республикасы";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "សាធារណរដ្ឋ​ដូមីនីក";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಡೊಮೆನಿಕನ್ ರಿಪಬ್ಲಿಕ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "ڈومِنِکَن جموٗرِیَت";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Komara Domînîk";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Доминика Республикасы";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Dominikanesch Republik";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Lipubulika ya Dominika";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Repibiki ya Domínikɛ";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ສາທາລະນະລັດ ໂດມິນິກັນ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Dominikos Respublika";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Ditunga wa Duminiku";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Repoblika Dominikanina";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ഡൊമിനിക്കൻ റിപ്പബ്ലിക്ക്";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Бүгд Найрамдах Доминикан Улс";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "डोमिनिकन प्रजासत्ताक";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Republik Dominica";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "ir-Repubblika Dominicana";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "Den dominikanske republikk";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "डोमिनिकन गणतन्त्र";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "Den dominikanske republikken";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଡୋମିନିକାନ୍‌ ସାଧାରଣତନ୍ତ୍ର";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਡੋਮੀਨਿਕਾਈ ਗਣਰਾਜ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "جمهوريه ډومينيکن";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "Republica Dominicana";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Repubulika ya Dominika";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Republica Dominicană";
        ...
        test("has translation for 'sd' locale", () {
          const expectedName = "ڊومينيڪن جمهوريه";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Dominikána dásseváldi";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Ködörösêse tî Dominîka";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ඩොමිනිකා ජනරජය";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Jamhuuriyaddda Dominika";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Republika Dominikane";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "டொமினிகன் குடியரசு";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "డొమినికన్ రిపబ్లిక్";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Ҷумҳурии Доминикан";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "สาธารณรัฐโดมินิกัน";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Dominikan Respublikasy";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Lepupelika Tominika";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Доминикана Республикасы";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "دومىنىكا جۇمھۇرىيىتى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Домініканська Республіка";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Dominikan Respublikasi";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Cộng hòa Dominica";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Repiblik Dominiken";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "דאמיניקאַנישע רעפּובליק";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orilẹ́ède Dòmíníkánì";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Dominican Republic";
        ...
        test("has translation for 'ay' locale", () {
          const expectedName = "Republika Duminikana";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ཌོ་མི་ནི་ཀན་སྤྱི་མཐུན་རྒྱལ་ཁབ།";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "ޑޮމިނިކަން ޖުމްހޫރިއްޔާ";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Phobblaght Ghominicagh";
        ...
        test("has translation for 'io' locale", () {
          const expectedName = "Dominikana Republiko";
        ...
        test("has translation for 'kw' locale", () {
          const expectedName = "Repoblek Dhominikanek";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Respublica Dominicana";
        ...
        test("has translation for 'li' locale", () {
          const expectedName = "Dominicaanse Rippubliek";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Te Whenua Tominika";
        ...
        test("has translation for 'na' locale", () {
          const expectedName = "Ripubrikin Dominika";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Domingo Bikéyah";
        ...
        test("has translation for 'os' locale", () {
          const expectedName = "Доминиканæйы Республикæ";
        ...
        test("has translation for 'rw' locale", () {
          const expectedName = "Repubulika ya Dominikani";
        ...
        test("has translation for 'sa' locale", () {
          const expectedName = "डोमोनिकन रिपब्लिक";
        ...
        test("has translation for 'ss' locale", () {
          const expectedName = "Tibuse weDomonokha";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Republikang Dominikano";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Доминикан Республики";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Repùblica Dominicana";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "EDominican Republic";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Доминиканатәи Ареспублика";
        ...
        test("has translation for 'co' locale", () {
          const expectedName = "Republica Duminicana";
        ...
        test("has translation for 'ie' locale", () {
          const expectedName = "Dominican Republica";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Dohmijnizgyah Gunghozgoz";
        ...
        test("has translation for 'mn_Cyrl' locale", () {
          const expectedName = "Бүгд Найрамдах Доминикан";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Доминикан Республикаси";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orilɛ́ède Dòmíníkánì";
