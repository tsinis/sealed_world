...
void main() => group(
      "$CountryPng() L10N",
      () {
        const value = CountryPng();

        test("has translation for 'en' locale", () {
          const expectedName = "Papua New Guinea";
          const expectedFullName = "Independent State of Papua New Guinea";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Папуа Нова Гвинеја";
          const expectedFullName = "Независна Држава Папуа Нова Гвинеја";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "بابوا غينيا الجديدة";
          const expectedFullName = "دولة بابوا غينيا الجديدة";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Papoua-Ginea Nevez";
          const expectedFullName = "Stad dizalc'h Papoua-Ginea Nevez";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Papua-Nová Guinea";
          const expectedFullName = "Nezávislý stát Papua Nová Guinea";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Papua-Neuguinea";
          const expectedFullName = "Unabhängiger Staat Papua-Neuguinea";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Paapua Uus-Guinea";
          const expectedFullName = "Paapua Uus-Guinea Iseseisvusriik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Papua-Uusi-Guinea";
          const expectedFullName = "Papua-Uuden-Guinean Itsenäinen valtio";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Papouasie-Nouvelle-Guinée";
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Papua Nova Gvineja";
          const expectedFullName = "Nezavisna Država Papui Novoj Gvineji";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Pápua Új-Guinea";
          const expectedFullName = "Pápua Új-Guinea Független Állam";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Papua Nuova Guinea";
          const expectedFullName = "Stato indipendente di Papua Nuova Guinea";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "パプアニューギニア";
          const expectedFullName = "パプアニューギニア独立国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "파푸아뉴기니";
          const expectedFullName = "파푸아뉴기니 독립국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Papoea-Nieuw-Guinea";
          const expectedFullName = "Onafhankelijke Staat Papoea -Nieuw-Guinea";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          ...
          const expectedFullName = "مملکت مستقل پاپوآ گینهٔ نو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Papua-Nowa Gwinea";
          const expectedFullName = "Niezależne Państwo Papui-Nowej Gwinei";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Papua Nova Guiné";
          const expectedFullName = "Estado Independente da Papua Nova Guiné";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Папуа — Новая Гвинея";
          const expectedFullName = "Независимое Государство Папуа-Новой Гвинеи";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Papua-Nová Guinea";
          const expectedFullName = "Nezávislý štát Papua-Nová Guinea";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Papúa Nueva Guinea";
          const expectedFullName = "Estado Independiente de Papúa Nueva Guinea";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Papua Nya Guinea";
          const expectedFullName = "Den oberoende staten Papua Nya Guinea";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Papua Yeni Gine";
          const expectedFullName = "Papua Yeni Gine Bağımsız Devleti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "پاپوا نیو گنی";
          const expectedFullName = "آزاد ریاستِ پاپوا نیو گنی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Papoea-Nieu-Guinee";
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Papua Guinea Foforo";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "পাপুৱা নিউ গিনি";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Papua-Yeni Qvineya";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Папуа-Новая Гвінея";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Папуа-Нова Гвинея";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Papuwasi-Gine-Koura";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "পাপুয়া নিউ গিনি";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "Papua Nova Guinea";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Папуа — Керла Гвиней";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "Papua Ny Guinea";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "པ་པུ་ ནིའུ་གི་ནི";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Papua New Gini nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Παπούα Νέα Γουινέα";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Papuo-Nov-Gvineo";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Papua Ginea Berria";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Papuwaa Nuwel Gine";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Papua Nýguinea";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Papoea-Nij-Guinea";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Nua-Ghuine Phapua";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Gini Nuadh Phaputhach";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Papúa-Nova Guinea";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "પાપુઆ ન્યૂ ગિની";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Papuwa Nugini";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "פפואה גינאה החדשה";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "पापुआ न्यू गिनी";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Պապուա Նոր Գվինեա";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Papua Nove Guinea";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Papua Nugini";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Papúa Nýja-Gínea";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "პაპუა-ახალი გვინეა";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Папуа — Жаңа Гвинея";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ប៉ាពូអាស៊ី​នូវែលហ្គីណេ";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಪಪುವಾ ನ್ಯೂಗಿನಿಯಾ";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "پاپُوا نیوٗ گیٖنی";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Papua Gîneya Nû";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Папуа-Жаңы Гвинея";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Papua-Neiguinea";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Papwa Nyugini";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Papwazi Ginɛ ya sika";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ປາປົວນິວກີນີ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Papua Naujoji Gvinėja";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Papwazi wa Nginɛ wa mumu";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Papua-Jaungvineja";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "പാപ്പുവ ന്യൂ ഗിനിയ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Папуа Шинэ Гвиней";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ပါပူအာ နယူးဂီနီ";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "पपुआ न्यू गाइनिया";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ପପୁଆ ନ୍ୟୁ ଗୁଏନିଆ";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਪਾਪੂਆ ਨਿਊ ਗਿਨੀ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "پاپوا نيو ګيني";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Papuwa Niyugineya";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Papua-Noua Guinee";
        ...
        test("has translation for 'sd' locale", () {
          const expectedName = "پاپوا نیو گني";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Papua-Ođđa-Guinea";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Papû Finî Ginëe, Papuazïi";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "පැපුවා නිව් ගිනියාව";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Babua Niyuu Gini";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Guineja e Re-Papua";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "பப்புவா நியூ கினியா";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "పాపువా న్యూ గినియా";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Папуа Гвинеяи Нав";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ปาปัวนิวกินี";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Papua - Täze Gwineýa";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Papuaniukini";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Папуа - Яңа Гвинея";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "پاپۇئا يېڭى گىۋىنىيەسى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Папуа-Нова Ґвінея";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Papua – Yangi Gvineya";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Papuwasi Gine Gu Bees";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "פּאַפּואַ נײַ גינע";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Paapu ti Giini";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Papua New Guinea";
        ...
        test("has translation for 'an' locale", () {
          const expectedName = "Papua y Nueva Guinea";
        ...
        test("has translation for 'ba' locale", () {
          const expectedName = "Папуа — Яңы Гвинея";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "པ་པུ་འ་ནིའུ་གི་ནེ།";
        ...
        test("has translation for 'cu' locale", () {
          const expectedName = "Папоуа · Нова Гвинєꙗ";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "ޕަޕުއާ ނިއު ގިނީ";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Papooey Guinea Noa";
        ...
        test("has translation for 'ht' locale", () {
          const expectedName = "Papwazi-Nouvèl-Gine";
        ...
        test("has translation for 'li' locale", () {
          const expectedName = "Papoea-Nui-Guinea";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Papua Nūkini";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "Papwa Gwinea l-Ġdida";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Páápowa Bigíní Ániidí";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Papoa-Nòva Guinèa";
        ...
        test("has translation for 'os' locale", () {
          const expectedName = "Папуæ — Ног Гвиней";
        ...
        test("has translation for 'rw' locale", () {
          const expectedName = "Papuwa Nuveli Gineya";
        ...
        test("has translation for 'sa' locale", () {
          const expectedName = "पपुवा न्यू गिनी";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Papua Bagong Ginea";
        ...
        test("has translation for 'vo' locale", () {
          const expectedName = "Papuveän Nula-Gineyän";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Папуа — Ҫӗнӗ Гвиней";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Pàpua Guinea Noa";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "EPapua New Guinea";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Папуа — Гвинеиа ҿыц";
        ...
        test("has translation for 'ie' locale", () {
          const expectedName = "Papua Nov-Guinea";
        ...
        test("has translation for 'kl' locale", () {
          const expectedName = "Papua Nutaaq Guinea";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Bahbuyasinhgijneiya";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Папуа-Јени Гвинеја";
        ...
        test("has translation for 'sw_KE' locale", () {
          const expectedName = "Papua Guinea Mpya";
        ...
        test("has translation for 'ug_Arab' locale", () {
          const expectedName = "پاپۇئا يېڭى گىۋىنېيەسى";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Папуа - Янги Гвинея";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Paapu ti Giini";
