...
void main() => group(
      "$CountryKir() L10N",
      () {
        const value = CountryKir();

        test("has translation for 'en' locale", () {
          const expectedName = "Kiribati";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Кирибати";
          const expectedFullName = "Независна и Суверена Република Кирибати";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "كيريباتي";
          const expectedFullName = "جمهورية كيريباتي";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Kiribati";
          const expectedFullName = "Republik Kiribati";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Kiribati";
          const expectedFullName = "Republika Kiribati";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Kiribati";
          const expectedFullName = "Kiribati Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Kiribati";
          const expectedFullName = "Kiribatin tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Kiribati";
          const expectedFullName = "République de Kiribati";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Kiribati";
          const expectedFullName = "Samostalne i suverene Republike Kiribati";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Kiribati";
          const expectedFullName = "Kiribati Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "キリバス";
          const expectedFullName = "キリバスの独立と主権共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "키리바시";
          const expectedFullName = "키리바시 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "کیریباتی";
          const expectedFullName = "جمهوری کیریباتی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Kiribati";
          const expectedFullName = "Kiribatská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Kiribati";
          const expectedFullName = "Republiken Kiribati";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Kiribati";
          const expectedFullName = "Kiribati Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "کیریباتی";
          const expectedFullName = "سلطنت آزاد جمہوریہ کیریباتی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "基里巴斯";
          const expectedFullName = "基里巴斯共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཀི་རི་བ་ཏི་མཚོ་གླིང";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Kiribati nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Kiribati";
        ...
        test("has translation for 'li' locale", () {
          const expectedName = "Kiribati-eilen";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ཀི་རི་བཱ་ཏི།";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Kiribati";
