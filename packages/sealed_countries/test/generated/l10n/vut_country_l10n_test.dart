...
void main() => group(
      "$CountryVut() L10N",
      () {
        const value = CountryVut();

        test("has translation for 'en' locale", () {
          const expectedName = "Vanuatu";
          const expectedFullName = "Republic of Vanuatu";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Вануату";
          const expectedFullName = "Република Вануату";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "فانواتو";
          const expectedFullName = "جمهورية فانواتو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Vanuatu";
          const expectedFullName = "Republik Vanuatu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Vanuatu";
          const expectedFullName = "Republika Vanuatu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Vanuatu";
          const expectedFullName = "Vanuatu Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Vanuatu";
          const expectedFullName = "Vanuatun tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Vanuatu";
          const expectedFullName = "République de Vanuatu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Vanuatu";
          const expectedFullName = "Vanuatui Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Vanuatu";
          const expectedFullName = "Repubblica di Vanuatu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "バヌアツ";
          const expectedFullName = "バヌアツ共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "바누아투";
          const expectedFullName = "바누아투 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Vanuatu";
          const expectedFullName = "Republiek Vanuatu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "وانواتو";
          const expectedFullName = "جمهوری وانواتو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Vanuatu";
          const expectedFullName = "República de Vanuatu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Вануату";
          const expectedFullName = "Республика Вануату";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Vanuatu";
          const expectedFullName = "Vanuatská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Vanuatu";
          const expectedFullName = "Republiken Vanuatu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Vanuatu";
          const expectedFullName = "Vanuatu Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "وانواتو";
          const expectedFullName = "جمہوریہ وانواتو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "瓦努阿图";
          const expectedFullName = "瓦努阿图共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Vanuatu nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Faniatu";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Banoʼáátʼoo";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Vajnujahduz";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Faniatu";
