...
void main() => group(
      "$CountryMdg() L10N",
      () {
        const value = CountryMdg();

        test("has translation for 'en' locale", () {
          const expectedName = "Madagascar";
          const expectedFullName = "Republic of Madagascar";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Мадагаскар";
          const expectedFullName = "Република Мадагаскар";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "مدغشقر";
          const expectedFullName = "جمهورية مدغشقر";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Madagaskar";
          const expectedFullName = "Republik Madagaskar";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Madagaskar";
          const expectedFullName = "Madagaskarská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Madagaskar";
          const expectedFullName = "Madagaskari Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Madagaskar";
          const expectedFullName = "Madagaskarin tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Madagascar";
          const expectedFullName = "République de Madagascar";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Madagaskar";
          const expectedFullName = "Republika Madagaskar";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Madagaszkár";
          const expectedFullName = "Madagaszkári Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Madagascar";
          const expectedFullName = "Repubblica del Madagascar";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "マダガスカル";
          const expectedFullName = "マダガスカル共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "마다가스카르";
          const expectedFullName = "마다가스카르 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Madagaskar";
          const expectedFullName = "Republiek Madagaskar";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "ماداگاسکار";
          const expectedFullName = "جمهوری ماداگاسکار";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Madagaskar";
          const expectedFullName = "Republika Madagaskaru";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Madagáscar";
          const expectedFullName = "República de Madagáscar";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Мадагаскар";
          const expectedFullName = "Республика Мадагаскар";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Madagascar";
          const expectedFullName = "República de Madagascar";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Madagaskar";
          const expectedFullName = "Republiken Madagaskar";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Madagaskar";
          const expectedFullName = "Madagaskar Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "مڈغاسکر";
          const expectedFullName = "جمہوریہ مڈغاسکر";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "马达加斯加";
          const expectedFullName = "马达加斯加共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "মাদাগাস্কাৰ";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Madagasikari";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "মাদাগাস্কার";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "མ་དཱ་གེས་ཀར";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Madagaska nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Μαδαγασκάρη";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Madagaskaro";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Madagaskaar";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "მადაგასკარი";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ម៉ាដាហ្គាស្កា";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Madagaskaras";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Madagaskara";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Madagasikara";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ମାଡାଗାସ୍କର୍";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Madagaskära";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "มาดากัสการ์";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "מאַדאַגאַסקאַר";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Madasika";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Madagascar";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "མ་ད་གཱ་སི་ཀར།";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "މަޑަގަސްކަރަ";
        ...
        test("has translation for 'fj' locale", () {
          const expectedName = "Madagasikar";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Madagascaria";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Madaʼgéésgáá";
        ...
        test("has translation for 'ss' locale", () {
          const expectedName = "IMadagasikha";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "EMadagascar";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Majdazgyahswhgyah";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Madasika";
