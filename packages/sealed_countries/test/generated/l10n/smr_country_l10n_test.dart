...
void main() => group(
      "$CountrySmr() L10N",
      () {
        const value = CountrySmr();

        test("has translation for 'en' locale", () {
          const expectedName = "San Marino";
          const expectedFullName = "Republic of San Marino";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Сан Марино";
          const expectedFullName = "Најузвишенија Република Сан Марино";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "سان مارينو";
          const expectedFullName = "جمهورية سان مارينو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "San Marino";
          const expectedFullName = "Republik San Marino";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "San Marino";
          const expectedFullName = "Republika San Marino";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "San Marino";
          const expectedFullName = "San Marino Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "San Marino";
          const expectedFullName = "San Marinon seesteinen tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Saint-Marin";
          const expectedFullName = "République de Saint-Marin";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "San Marino";
          const expectedFullName = "Većina Serene Republika San Marino";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "San Marino";
          const expectedFullName = "San Marino Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "San Marino";
          const expectedFullName = "Serenissima Repubblica di San Marino";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "サンマリノ";
          const expectedFullName = "サンマリノのほとんどセリーヌ共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "산마리노";
          const expectedFullName = "산마리노 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "San Marino";
          const expectedFullName = "Meest Serene Republiek San Marino";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "سان مارینو";
          const expectedFullName = "جمهوری سان مارینو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "San Marino";
          const expectedFullName = "Sereníssima República de San Marino";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Сан-Марино";
          const expectedFullName = "Большинство Serene Республика Сан-Марино";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "San Maríno";
          const expectedFullName = "Sanmarínska republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "San Marino";
          const expectedFullName = "Serenísima República de San Marino";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "San Marino";
          const expectedFullName = "Republiken San Marino";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "San Marino";
          const expectedFullName = "San Marino Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "سان مارینو";
          const expectedFullName = "جمہوریہ سان مارینو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "圣马力诺";
          const expectedFullName = "圣马力诺共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Marini-Senu";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "སཱན་མ་རི་ནོ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "San Marino nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Άγιος Μαρίνος";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "San Mairíne";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "សាន​ម៉ារីណូ";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಸ್ಯಾನ್ ಮೆರಿನೋ";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Sántu Marinɛ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "San Marinas";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Santu Marine";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "सान् मारिनो";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ସାନ୍ ମାରିନୋ";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "සැන් මැරිනෝ";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "శాన్ మారినో";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "סאַן מאַרינא";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Sani Marino";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-San Marino";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Sancti Marini";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Hato Marino";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Santu Marinu";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "ESan Marino";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "སན་མེ་རི་ནོ།";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Swngmajlinoz";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Sani Marino";
