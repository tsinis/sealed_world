...
void main() => group(
      "$CountryOmn() L10N",
      () {
        const value = CountryOmn();

        test("has translation for 'en' locale", () {
          const expectedName = "Oman";
          const expectedFullName = "Sultanate of Oman";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Оман";
          const expectedFullName = "Султанат Оман";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "عمان";
          const expectedFullName = "سلطنة عمان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Oman";
          const expectedFullName = "Sultanelezh Oman";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Omán";
          const expectedFullName = "Sultanát Omán";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Oman";
          const expectedFullName = "Sultanat Oman";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Omaan";
          const expectedFullName = "Omaani Sultaniriik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Oman";
          const expectedFullName = "Omanin sulttaanikunta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Oman";
          const expectedFullName = "Sultanat d'Oman";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Omán";
          const expectedFullName = "Ománi Szultanátus";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "oman";
          const expectedFullName = "Sultanato dell'Oman";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "オマーン";
          const expectedFullName = "オマーン·スルタン国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "오만";
          const expectedFullName = "오만 술탄국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Oman";
          const expectedFullName = "Sultanaat van Oman";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "عمان";
          const expectedFullName = "سلطان‌نشین عُمان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Oman";
          const expectedFullName = "Sułtanat Omanu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Omã";
          const expectedFullName = "Sultanato de Omã";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Omán";
          const expectedFullName = "Ománsky sultanát";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Omán";
          const expectedFullName = "Sultanato de Omán";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Oman";
          const expectedFullName = "Sultanatet Oman";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Umman";
          const expectedFullName = "Umman Sultanlığı";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "عمان";
          const expectedFullName = "سلطنت عمان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "阿曼";
          const expectedFullName = "阿曼苏丹国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Oman nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Ọọma";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Ɔɔma";
