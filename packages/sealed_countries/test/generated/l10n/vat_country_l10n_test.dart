...
void main() => group(
      "$CountryVat() L10N",
      () {
        const value = CountryVat();

        test("has translation for 'en' locale", () {
          const expectedName = "Vatican City";
          const expectedFullName = "Vatican City State";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Ватикан";
          const expectedFullName = "Град Ватикан";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "مدينة الفاتيكان";
          const expectedFullName = "دولة مدينة الفاتيكان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Vatikan";
          const expectedFullName = "Riez Keoded ar Vatikan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Vatikán";
          const expectedFullName = "Městský stát Vatikán";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Vatikanstadt";
          const expectedFullName = "Staat Vatikanstadt";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Vatikan";
          const expectedFullName = "Vatikani Linnriik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Vatikaani";
          const expectedFullName = "Vatikaanin kaupunkivaltio";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Cité du Vatican";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Vatikán";
          const expectedFullName = "Vatikán Állam";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Città del Vaticano";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "バチカン市国";
          const expectedFullName = "バチカン市国の状態";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "바티칸";
          const expectedFullName = "바티칸 시국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Vaticaanstad";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "واتیکان";
          const expectedFullName = "دولت‌شهر واتیکان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Watykan";
          const expectedFullName = "Państwo Watykańskie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Cidade do Vaticano";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Ватикан";
          const expectedFullName = "Город-государство Ватикан";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Vatikán";
          const expectedFullName = "Svätá stolica (Vatikánsky mestský štát";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Ciudad del Vaticano";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Vatikanstaten";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Vatikan";
          const expectedFullName = "Vatikan Şehir Devleti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "梵蒂冈";
          const expectedFullName = "梵蒂冈城国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Vatikaanstad";
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Vatican Man";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "ভেটিকান চিটি";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "ভ্যাটিকান সিটি";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "Ciutat del Vaticà";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "བ་ཊི་ཀཱན་ སི་ཊི";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Vatikandu nutome";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Vatikano Hiria";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Dowla Waticaan";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Vatikanbýur";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Vaticaanstêd";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Cathair na Vatacáine";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Cathair na Bhatacain";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "વેટિકન સિટી";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "वेटिकन सिटी";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Citate del Vaticano";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Kutha Vatikan";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ქალაქი ვატიკანი";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "បុរី​វ៉ាទីកង់";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ವ್ಯಾಟಿಕನ್ ಸಿಟಿ";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "ویٹِکَن سِٹی";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Vatikanstad";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ນະຄອນ ວາຕິກັນ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Vatikano Miesto Valstybė";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Firenen’i Vatikana";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Ватикан хот улс";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "व्हॅटिकन सिटी";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Kota Vatican";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "l-Istat tal-Belt tal-Vatikan";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဗာတီကန်စီးတီး";
        ...
        test("has translation for 'nd' locale", () {
          const expectedName = "Vatican State";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "भेटिकन सिटी";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଭାଟିକାନ୍ ସିଟି";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਵੈਟੀਕਨ ਸਿਟੀ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "واتیکان ښار";
        ...
        test("has translation for 'qu' locale", () {
          const expectedName = "Santa Sede (Ciudad del Vaticano)";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "Citad dal Vatican";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Umurwa wa Vatikani";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Statul Cetății Vaticanului";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Letëe tî Vatikäan";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "වතිකානු නගරය";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Mji wa Vatican";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "வாடிகன் நகரம்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "వాటికన్ నగరం";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Шаҳри Вотикон";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Kolo Vatikani";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Thành Vatican";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Site bu Watikaa";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "וואַטיקאַן שטאָט";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Ìlú Vatican";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Vatican City";
        ...
        test("has translation for 'an' locale", () {
          const expectedName = "Ciudat d'o Vaticano";
        ...
        test("has translation for 'bi' locale", () {
          const expectedName = "Vatican Siti";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ཝ་ཏི་ཀན་གྲོང་ཁྱོར།";
        ...
        test("has translation for 'co' locale", () {
          const expectedName = "Cità di u Vaticanu";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "ވެޓިކަން ސިޓީ";
        ...
        test("has translation for 'gn' locale", () {
          const expectedName = "Táva Vatikano";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Ard-valley yn Phaab";
        ...
        test("has translation for 'kw' locale", () {
          const expectedName = "Cita Vatikan";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Status Civitatis Vaticanæ";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Poho o Pita";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Bádikin Sídii";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Tzitade de su Vaticanu";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Lungsod ng Vaticano";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "EVatican City";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Fanzdigangh";
        ...
        test("has translation for 'sw_KE' locale", () {
          const expectedName = "Mji wa Vatikani";
        ...
        test("has translation for 'ug_Arab' locale", () {
          const expectedName = "ۋاتىكان شەھىرى";
