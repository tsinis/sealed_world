...
void main() => group(
      "$CountryLie() L10N",
      () {
        const value = CountryLie();

        test("has translation for 'en' locale", () {
          const expectedName = "Liechtenstein";
          const expectedFullName = "Principality of Liechtenstein";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Лихтенштајн";
          const expectedFullName = "Кнежевина Лихтенштајн";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "ليختنشتاين";
          const expectedFullName = "إمارة ليختنشتاين";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Liechtenstein";
          const expectedFullName = "Priñselezh Liechtenstein";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Lichtenštejnsko";
          const expectedFullName = "Knížectví Lichtenštejnské";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Liechtenstein";
          const expectedFullName = "Fürstentum Liechtenstein";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Liechtenstein";
          const expectedFullName = "Liechtensteini Vürstiriik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Liechenstein";
          const expectedFullName = "Liechensteinin ruhtinaskunta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Liechtenstein";
          const expectedFullName = "Principauté du Liechtenstein";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Lihtenštajn";
          const expectedFullName = "Kneževina Lihtenštajn";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Liechtenstein";
          const expectedFullName = "Liechtensteini Hercegség";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Liechtenstein";
          const expectedFullName = "Principato del Liechtenstein";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "リヒテンシュタイン";
          const expectedFullName = "リヒテンシュタイン公国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "리히텐슈타인";
          const expectedFullName = "리히텐슈타인 공국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Liechtenstein";
          const expectedFullName = "Vorstendom Liechtenstein";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "لیختن‌اشتاین";
          const expectedFullName = "شاهزاده‌نشین لیختن‌اشتاین";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Liechtenstein";
          const expectedFullName = "Księstwo Liechtensteinu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Liechtenstein";
          const expectedFullName = "Principado de Liechtenstein";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Лихтенштейн";
          const expectedFullName = "Княжество Лихтенштейн";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Lichtenštajnsko";
          const expectedFullName = "Lichtenštajnské kniežatstvo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Liechtenstein";
          const expectedFullName = "Furstendömet Liechtenstein";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Lihtenştayn";
          const expectedFullName = "Lihtenştayn Prensliği";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "لیختینستائن";
          const expectedFullName = "امارات لیختینستائن";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "列支敦士登";
          const expectedFullName = "列支敦士登公国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Lektenstaen";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "লিচটেনষ্টেইন";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Lixtenşteyn";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Ліхтэнштэйн";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Lisɛnsitayini";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "লিচেনস্টেইন";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ལིཀ་ཏནས་ཏ་ཡིན";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Litsenstein nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Λιχτενστάιν";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Liĥtenŝtejno";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Lincenstayn";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Liktinstein";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Lichtinstéin";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Lichtenstein";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "લૈચટેંસ્ટેઇન";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Լիխտենշտեյն";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ლიხტენშტაინი";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "លិចតិនស្ដាញ";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಲಿಚೆನ್‌ಸ್ಟೈನ್";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Licitensitayini";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ລິດເທນສະຕາຍ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Lichtenšteinas";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Lihtenšteina";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Listenstein";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ലിച്ചൺസ്റ്റൈൻ";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "लिक्टेनस्टाइन";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Liechtenstein";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "လစ်တန်စတိန်း";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "लिकटेन्सटाइन";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଲିଚେଟନଷ୍ଟେଇନ୍";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Lishyitenshitayini";
        ...
        test("has translation for 'sd' locale", () {
          const expectedName = "لچي ٽينسٽين";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ලික්ටන්ස්ටයින්";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Liyjtensteyn";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Lihtenshtajn";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "லிச்செண்ஸ்டெய்ன்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "లిక్టెన్‌స్టెయిన్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ลิกเตนสไตน์";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Lihtenşteýn";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Likitenisiteini";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "لىكتېنستېين";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Ліхтенштейн";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Lixtenshteyn";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Liktensteyin";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Lẹṣitẹnisiteni";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Liechtenstein";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Lychtenstein";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Lînxiniştayn";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Lichtenstenum";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Rīkeneteina";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "ELiechtenstein";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Лихтенштеин";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ལེག་ཏེན་ཚིན།";
        ...
        test("has translation for 'kl' locale", () {
          const expectedName = "Liechtensteini";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Lezcihdunhswdwngh";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Лихтенштејн";
        ...
        test("has translation for 'ks_Arab' locale", () {
          const expectedName = "لِکٹیٛسٹیٖن";
        ...
        test("has translation for 'ug_Arab' locale", () {
          const expectedName = "لىچتېنشتېين بەگلىكى";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Lɛshitɛnisiteni";
