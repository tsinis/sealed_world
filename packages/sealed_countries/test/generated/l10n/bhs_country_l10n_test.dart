...
void main() => group(
      "$CountryBhs() L10N",
      () {
        const value = CountryBhs();

        test("has translation for 'en' locale", () {
          const expectedName = "Bahamas";
          const expectedFullName = "Commonwealth of the Bahamas";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Бахами";
          const expectedFullName = "Комонвелт Бахама";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "باهاماس";
          const expectedFullName = "كومنولث جزر البهاما";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Bahamas";
          const expectedFullName = "Kenglad ar Bahamas";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Bahamy";
          const expectedFullName = "Bahamské společenství";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Bahamas";
          const expectedFullName = "Cymanwlad y Bahamas";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Bahamas";
          const expectedFullName = "Commonwealth der Bahamas";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Bahama";
          const expectedFullName = "Bahama Ühendus";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Bahamasaaret";
          const expectedFullName = "Bahaman liittovaltio";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Bahamas";
          const expectedFullName = "Commonwealth des Bahamas";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Bahami";
          const expectedFullName = "Zajednica Bahama";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Bahama-szigetek";
          const expectedFullName = "Bahamai Közösség";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Bahamas";
          const expectedFullName = "Commonwealth delle Bahamas";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "바하마";
          const expectedFullName = "바하마 연방";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Bahama’s";
          const expectedFullName = "Gemenebest van de Bahama's";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "باهاما";
          const expectedFullName = "قلمرو همسود باهاما";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Bahamas";
          const expectedFullName = "Comunidade das Bahamas";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Багамские Острова";
          const expectedFullName = "Содружество Багамских Островов";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Bahamy";
          const expectedFullName = "Bahamské spoločenstvo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Bahamas";
          const expectedFullName = "Commonwealth de las Bahamas";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Bahamas";
          const expectedFullName = "Samväldet Bahamas";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Bahamalar";
          const expectedFullName = "Bahama Milletler Topluluğu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "بہاماس";
          const expectedFullName = "دولتِ مشترکہ بہاماس";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "巴哈马";
          const expectedFullName = "巴哈马联邦";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Baham adaları";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Багамскія астравы";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Бахамски острови";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "বাহামা দ্বীপপুঞ্জ";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Багаман гӀайренаш";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Bahamas nutome";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Bahamaoyggjar";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Na h-Eileanan Bhathama";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Բահամյան կղզիներ";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Bahamaeyjar";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ბაჰამის კუნძულები";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Багам аралдары";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Багама аралдары";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Bahamu salas";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Багамын арлууд";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Bagama adalary";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Багам утраулары";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Багамські Острови";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Bagama orollari";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Bàhámásì";
        ...
        test("has translation for 'ba' locale", () {
          const expectedName = "Багама утрауҙары";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "ny Bahamaghyn";
        ...
        test("has translation for 'kw' locale", () {
          const expectedName = "Ynysow Bahama";
        ...
        test("has translation for 'li' locale", () {
          const expectedName = "De Bahama's";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Las Bahamas";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Bahamasullot";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Баһам адалары";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Багама ороллари";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Bàhámásì";
