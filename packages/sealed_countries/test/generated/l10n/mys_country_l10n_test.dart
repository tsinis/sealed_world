...
void main() => group(
      "$CountryMys() L10N",
      () {
        const value = CountryMys();

        test("has translation for 'en' locale", () {
          const expectedName = "Malaysia";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Malaisie";
          const expectedFullName = "Fédération de Malaisie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Malesia";
          const expectedFullName = "Malaysia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "مالزی";
          const expectedFullName = "فدراسیون مالزی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "মালয়েচিয়া";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "মালয়েশিয়া";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Malaysia nutome";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Mhalaeisia";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Malasia";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Valaysia";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Majlaizsihya";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Malasia";
