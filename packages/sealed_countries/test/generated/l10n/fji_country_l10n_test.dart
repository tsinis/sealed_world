...
void main() => group(
      "$CountryFji() L10N",
      () {
        const value = CountryFji();

        test("has translation for 'en' locale", () {
          const expectedName = "Fiji";
          const expectedFullName = "Republic of Fiji";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Фиџи";
          const expectedFullName = "Република Фиџи";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "فيجي";
          const expectedFullName = "جمهورية جزر فيجي";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Fidji";
          const expectedFullName = "Republik Fidji";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Fidži";
          const expectedFullName = "Republika Fidžijských ostrovů";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Fidschi";
          const expectedFullName = "Republik Fidschi";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Fidži";
          const expectedFullName = "Fidži Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Fidži";
          const expectedFullName = "Fidžin tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Fidji";
          const expectedFullName = "République des Fidji";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Fiđi";
          const expectedFullName = "Republika Fidži";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Fidzsi-szigetek";
          const expectedFullName = "Fidzsi-szigeteki Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Figi";
          const expectedFullName = "Repubblica di Figi";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "フィジー";
          const expectedFullName = "フィジー共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "피지";
          const expectedFullName = "피지 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Fiji";
          const expectedFullName = "Republiek Fiji";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "فیجی";
          const expectedFullName = "جمهوری جزایر فیجی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Fidżi";
          const expectedFullName = "Republika Fidżi";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Fiji";
          const expectedFullName = "República de Fiji";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Фиджи";
          const expectedFullName = "Республика Фиджи";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Fiǆi";
          const expectedFullName = "Fiǆijská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Fiji";
          const expectedFullName = "Republiken Fiji";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Fiji";
          const expectedFullName = "Fiji Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "فجی";
          const expectedFullName = "جمہوریہ فجی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "斐济";
          const expectedFullName = "斐济共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Fidzi nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Fiji";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Fiji";
