...
void main() => group(
      "$CountrySau() L10N",
      () {
        const value = CountrySau();

        test("has translation for 'en' locale", () {
          const expectedName = "Saudi Arabia";
          const expectedFullName = "Kingdom of Saudi Arabia";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Саудијска Арабија";
          const expectedFullName = "Краљевина Саудијска Арабија";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "السعودية";
          const expectedFullName = "المملكة العربية السعودية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Arabia Saoudat";
          const expectedFullName = "Rouantelezh Arabia Saoudat";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Saúdská Arábie";
          const expectedFullName = "Saúdskoarabské království";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Saudi-Arabien";
          const expectedFullName = "Königreich Saudi-Arabien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Saudi Araabia";
          const expectedFullName = "Saudi Araabia Kuningriik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Saudi-Arabia";
          const expectedFullName = "Saudi-Arabian kuningaskunta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Arabie Saoudite";
          const expectedFullName = "Royaume d'Arabie Saoudite";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Saudijska Arabija";
          const expectedFullName = "Kraljevina Saudijska Arabija";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Szaúd-Arábia";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Arabia Saudita";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "サウジアラビア";
          const expectedFullName = "サウジアラビア王国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "사우디아라비아";
          const expectedFullName = "사우디아라비아 왕국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Saoedi-Arabië";
          const expectedFullName = "Koninkrijk van Saoedi-Arabië";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "عربستان سعودی";
          const expectedFullName = "پادشاهی عربی سَعودی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Arabia Saudyjska";
          const expectedFullName = "Królestwo Arabii Saudyjskiej";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Arábia Saudita";
          const expectedFullName = "Reino da Arábia Saudita";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Саудовская Аравия";
          const expectedFullName = "Королевство Саудовская Аравия";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Saudská Arábia";
          const expectedFullName = "Saudskoarabské kráľovstvo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Arabia Saudí";
          const expectedFullName = "Reino de Arabia Saudita";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Saudiarabien";
          const expectedFullName = "Kungadömet Saudiarabien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Suudi Arabistan";
          const expectedFullName = "Suudi Arabistan Krallığı";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "سعودی عرب";
          const expectedFullName = "مملکتِ سعودی عرب";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "沙特阿拉伯";
          const expectedFullName = "沙特阿拉伯王国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "চৌডি আৰবিয়া";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Səudiyyə Ərəbistanı";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Саудаўская Аравія";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Саудитска Арабия";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Arabiya Sawudiya";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "Aràbia Saudita";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "СаӀудийн Ӏаьрбийчоь";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "སཱཝ་དི་ ཨ་རེ་བྷི་ཡ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Saudi Arabia nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Σαουδική Αραβία";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Saŭda Arabujo";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Arabii Sawdit";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Saudiarabia";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Araib Shádach";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Aràibia nan Sabhd";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "સાઉદી અરેબિયા";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "ערב הסעודית";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Սաուդյան Արաբիա";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Sádi-Arabía";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "საუდის არაბეთი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Сауд Арабиясы";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "អារ៉ាប៊ីសាអូឌីត";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಸೌದಿ ಅರೇಬಿಯಾ";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "سوٗدی عربِیہ";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Erebistana Siyûdî";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Sawudarebya - Buwarabu";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Alabi Sawuditɛ";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ຊາອຸດິ ອາຣາເບຍ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Saudo Arabija";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Alabu Nsawudi";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Saūda Arābija";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Arabia saodita";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Саудиска Арабија";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "സൗദി അറേബ്യ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Саудын Араб";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "l-Arabia Sawdija";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဆော်ဒီအာရေးဘီးယား";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ସାଉଦି ଆରବିଆ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "سعودي عربستان";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Arabiya Sawudite";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Arabia Saudită";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Saudi-Arábia";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Saûdi Arabïi";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "සෞදි අරාබිය";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "Saudova Arabija";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Sacuudi Carabiya";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Arabi Saudite";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "சவூதி அரேபியா";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "సౌదీ అరేబియా";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Арабистони Саудӣ";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ซาอุดีอาระเบีย";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Saud Arabystany";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Saute ʻAlepea";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Согуд Гарәбстаны";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "سەئۇدىي ئەرەبىستان";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Саудівська Аравія";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Saudiya Arabistoni";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Ả Rập Xê-út";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Arabi Sawudi";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Saudi Arabia";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Saudi Arabia";
        ...
        test("has translation for 'av' locale", () {
          const expectedName = "СагIудиязул ГIарабия";
        ...
        test("has translation for 'ba' locale", () {
          const expectedName = "Сәғүд Ғәрәбстаны";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "སའུ་དི་ཨ་ར་པི་ཡ།";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Сауд Аравийĕ";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "ސައޫދީ އަރަބިއްޔާ";
        ...
        test("has translation for 'gn' locale", () {
          const expectedName = "Aravia Saudíta";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Araab Saudi";
        ...
        test("has translation for 'ht' locale", () {
          const expectedName = "Arabi Sawoudit";
        ...
        test("has translation for 'io' locale", () {
          const expectedName = "Saudia Arabia";
        ...
        test("has translation for 'kv' locale", () {
          const expectedName = "Саудса Аравия";
        ...
        test("has translation for 'kw' locale", () {
          const expectedName = "Arabi Saoudek";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Arabia Saudiana";
        ...
        test("has translation for 'na' locale", () {
          const expectedName = "Taudiarabiya";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Ásáí Bikéyah Saʼoodí";
        ...
        test("has translation for 'os' locale", () {
          const expectedName = "Сауды Арави";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Arabyang Saudi";
        ...
        test("has translation for 'vo' locale", () {
          const expectedName = "Sauda-Larabän";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "סאודי אראביע";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Hauri Arāpia";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "ESaudi Arabia";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Саудтәи Арабсҭан";
        ...
        test("has translation for 'ie' locale", () {
          const expectedName = "Sauditic Arabia";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Sahdwz Ahlahbwz";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Сәудијјә Әрәбистаны";
        ...
        test("has translation for 'ha_Latn' locale", () {
          const expectedName = "Ƙasar Makka";
        ...
        test("has translation for 'ug_Arab' locale", () {
          const expectedName = "سەئۇدى ئەرەبىستان";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Саудия Арабистони";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Saudi Arabia";
