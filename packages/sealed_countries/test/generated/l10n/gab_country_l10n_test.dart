...
void main() => group(
      "$CountryGab() L10N",
      () {
        const value = CountryGab();

        test("has translation for 'en' locale", () {
          const expectedName = "Gabon";
          const expectedFullName = "Gabonese Republic";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Габон";
          const expectedFullName = "Габонска Република";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "الغابون";
          const expectedFullName = "جمهورية الغابون";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Gabon";
          const expectedFullName = "Republik Gabonat";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Gabon";
          const expectedFullName = "Gabonská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Gabun";
          const expectedFullName = "Gabunische Republik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Gabon";
          const expectedFullName = "Gaboni Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Gabon";
          const expectedFullName = "Gabonin tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Gabon";
          const expectedFullName = "République gabonaise";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Gabon";
          const expectedFullName = "Gabon Republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Gabon";
          const expectedFullName = "Gaboni Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Gabon";
          const expectedFullName = "Repubblica gabonese";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ガボン";
          const expectedFullName = "ガボン共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "가봉";
          const expectedFullName = "가봉 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Gabon";
          const expectedFullName = "Republiek Gabon";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "گابن";
          const expectedFullName = "جمهوری گابُن";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Gabon";
          const expectedFullName = "Republika Gabońska";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Gabão";
          const expectedFullName = "República do Gabão";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Габон";
          const expectedFullName = "Габона Республика";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Gabón";
          const expectedFullName = "República de Gabón";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Gabon";
          const expectedFullName = "Republiken Gabon";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Gabon";
          const expectedFullName = "Gabon Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "گیبون";
          const expectedFullName = "جمہوریہ گیبون";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "加蓬";
          const expectedFullName = "加蓬共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Gabɔn nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Gabon";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Gabon";
