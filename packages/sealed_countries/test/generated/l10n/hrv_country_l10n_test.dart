...
void main() => group(
      "$CountryHrv() L10N",
      () {
        const value = CountryHrv();

        test("has translation for 'en' locale", () {
          const expectedName = "Croatia";
          const expectedFullName = "Republic of Croatia";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Хрватска";
          const expectedFullName = "Република Хрватска";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "كرواتيا";
          const expectedFullName = "جمهورية كرواتيا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Kroatia";
          const expectedFullName = "Republik Kroatia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Chorvatsko";
          const expectedFullName = "Chorvatská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Croatia";
          const expectedFullName = "Gweriniaeth Croatia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Kroatien";
          const expectedFullName = "Republik Kroatien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Horvaatia";
          const expectedFullName = "Horvaatia Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Kroatia";
          const expectedFullName = "Kroatian tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Croatie";
          const expectedFullName = "République de Croatie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Hrvatska";
          const expectedFullName = "Republika Hrvatska";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Horvátország";
          const expectedFullName = "Horvát Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Croazia";
          const expectedFullName = "Repubblica di Croazia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "クロアチア";
          const expectedFullName = "クロアチア共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "크로아티아";
          const expectedFullName = "크로아티아 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Kroatië";
          const expectedFullName = "Republiek Kroatië";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "کرُواسی";
          const expectedFullName = "جمهوری کرواسی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Chorwacja";
          const expectedFullName = "Republika Chorwacji";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Croácia";
          const expectedFullName = "República da Croácia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Хорватия";
          const expectedFullName = "Республика Хорватия";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Chorvátsko";
          const expectedFullName = "Chorvátska republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Croacia";
          const expectedFullName = "República de Croacia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Kroatien";
          const expectedFullName = "Republiken Kroatien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Hırvatistan";
          const expectedFullName = "Hırvatistan Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "کرویئشا";
          const expectedFullName = "جمہوریہ کرویئشا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "克罗地亚";
          const expectedFullName = "克罗地亚共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "ক্ৰোৱেছিয়া";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "ক্রোয়েশিয়া";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Kroatsia nutome";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "A’ Chròthais";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Kurowaishiya";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ခရိုအေးရှား";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ක්‍රොඒෂියාව";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Korweeshiya";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Kòróátíà";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Kwóóʼad Bikéyah";
        ...
        test("has translation for 'ss' locale", () {
          const expectedName = "IKhuroshiya";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Kòróátíà";
