...
void main() => group(
      "$CountryCpv() L10N",
      () {
        const value = CountryCpv();

        test("has translation for 'en' locale", () {
          const expectedName = "Cape Verde";
          const expectedFullName = "Republic of Cabo Verde";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Зеленортска Острва";
          const expectedFullName = "Зеленортска Република";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "كابو فيردي";
          const expectedFullName = "جمهورية كابو فيردي";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Kab Glas";
          const expectedFullName = "Republik Kab Glas";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Kapverdy";
          const expectedFullName = "Kapverdská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Penrhyn Verde";
          const expectedFullName = "Gweriniaeth Cabo Verde";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Kap Verde";
          const expectedFullName = "Republik Cabo Verde";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Roheneemesaared";
          const expectedFullName = "Cabo Verde Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Kap Verde";
          const expectedFullName = "Kap Verden tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Îles du Cap-Vert";
          const expectedFullName = "République du Cap-Vert";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Zelenortska Republika";
          const expectedFullName = "Republika Cabo Verde";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Zöld-foki Köztársaság";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Capo Verde";
          const expectedFullName = "Repubblica di Capo Verde";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "カーボベルデ";
          const expectedFullName = "カーボベルデ共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "카보베르데";
          const expectedFullName = "카보베르데 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Kaapverdië";
          const expectedFullName = "Republiek van Cabo Verde";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "دماغهٔ سبز";
          const expectedFullName = "جمهوری کبو ورد";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Republika Zielonego Przylądka";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Cabo Verde";
          const expectedFullName = "República de Cabo Verde";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Кабо-Верде";
          const expectedFullName = "Республика Кабо -Верде";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Kap Verde";
          const expectedFullName = "Republiken Kap Verde";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Yeşil Burun";
          const expectedFullName = "Yeşil Burun Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "کیپ ورڈی";
          const expectedFullName = "جمہوریہ کیپ ورڈی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "佛得角";
          const expectedFullName = "佛得角共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Kepvɛdfo Islands";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Kape Verde nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Πράσινο Ακρωτήριο";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Duuɗe Kap Weer";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Grønhøvdaoyggjar";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "An Ceap Uaine";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Tsibiran Kap Barde";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Tanjung Verde";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Grænhöfðaeyjar";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Pongol Verdé";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Bizinga by’e Kepu Veredi";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Bisanga bya Kapevɛrɛ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Žaliasis Kyšulys";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Lutanda lua Kapevele";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Nosy Cap-Vert";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "കേപ്പ് വേർഡ്";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "केप व्हर्डे";
        ...
        test("has translation for 'nd' locale", () {
          const expectedName = "Cape Verde Islands";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Ibirwa bya Kapuveri";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Capul Verde";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Azûâ tî Kâpo-Vêre";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "Zelenortski otoki";
        ...
        test("has translation for 'sn' locale", () {
          const expectedName = "Zvitsuwa zveCape Verde";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Jasiiradda Kayb Faarde";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Kepi i Gjelbër";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "கேப் வெர்டே";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "కేప్ వెర్డె";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "يېشىل تۇمشۇق";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "קאַפּווערדישע אינזלען";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Etíokun Kápé féndè";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Cape Verde";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Promontorium Viride";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Te Kūrae Matomato";
        ...
        test("has translation for 'vo' locale", () {
          const expectedName = "Kabovärduäns";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "ECape Verde";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Etíokun Kápé féndè";
