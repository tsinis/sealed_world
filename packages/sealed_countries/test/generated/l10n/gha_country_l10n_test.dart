...
void main() => group(
      "$CountryGha() L10N",
      () {
        const value = CountryGha();

        test("has translation for 'en' locale", () {
          const expectedName = "Ghana";
          const expectedFullName = "Republic of Ghana";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Гана";
          const expectedFullName = "Република Гана";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "غانا";
          const expectedFullName = "جمهورية غانا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Ghana";
          const expectedFullName = "Republik Ghana";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Ghana";
          const expectedFullName = "Ghanská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Ghana";
          const expectedFullName = "Ghana Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Ghana";
          const expectedFullName = "Ghanan tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Ghana";
          const expectedFullName = "République du Ghana";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Gana";
          const expectedFullName = "Republika Gana";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Ghána";
          const expectedFullName = "Ghánai Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Ghana";
          const expectedFullName = "Repubblica del Ghana";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ガーナ";
          const expectedFullName = "ガーナ共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "가나";
          const expectedFullName = "가나 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Ghana";
          const expectedFullName = "Republiek Ghana";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "غنا";
          const expectedFullName = "جمهوری غنا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Ghana";
          const expectedFullName = "Republika Ghany";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Gana";
          const expectedFullName = "República do Gana";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Гана";
          const expectedFullName = "Республика Гана";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Ghana";
          const expectedFullName = "República de Ghana";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Ghana";
          const expectedFullName = "Republiken Ghana";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Gana";
          const expectedFullName = "Gana Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "گھانا";
          const expectedFullName = "جمہوریہ گھانا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "加纳";
          const expectedFullName = "加纳共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Ghana nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Gana";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Gana";
