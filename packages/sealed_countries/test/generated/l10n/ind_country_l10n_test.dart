...
void main() => group(
      "$CountryInd() L10N",
      () {
        const value = CountryInd();

        test("has translation for 'en' locale", () {
          const expectedName = "India";
          const expectedFullName = "Republic of India";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Индија";
          const expectedFullName = "Република Индија";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "الهند";
          const expectedFullName = "جمهورية الهند";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "India";
          const expectedFullName = "Republik India";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Indie";
          const expectedFullName = "Indická republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Indien";
          const expectedFullName = "Republik Indien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "India";
          const expectedFullName = "India Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Intia";
          const expectedFullName = "Intian tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Inde";
          const expectedFullName = "République de l'Inde";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Indija";
          const expectedFullName = "Republika Indija";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "India";
          const expectedFullName = "Indiai Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "India";
          const expectedFullName = "Repubblica dell'India";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "インド";
          const expectedFullName = "インド共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "India";
          const expectedFullName = "Republiek India";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "هند";
          const expectedFullName = "جمهوری هندوستان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Indie";
          const expectedFullName = "Republika Indii";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Índia";
          const expectedFullName = "República da Índia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Индия";
          const expectedFullName = "Республика Индия";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "India";
          const expectedFullName = "República de la India";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Indien";
          const expectedFullName = "Republiken Indien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Hindistan";
          const expectedFullName = "Hindistan Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "بھارت";
          const expectedFullName = "جمہوریہ بھارت";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "印度";
          const expectedFullName = "印度共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "India nutome";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Na h-Innseachan";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède India";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède India";
