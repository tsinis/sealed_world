...
void main() => group(
      "$CountryBrn() L10N",
      () {
        const value = CountryBrn();

        test("has translation for 'en' locale", () {
          const expectedName = "Brunei";
          const expectedFullName = "Nation of Brunei, Abode of Peace";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Брунеј";
          const expectedFullName = "Брунеј Дарусалам";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "بروناي";
          const expectedFullName = "بروناي دار السلام";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Brunei";
          const expectedFullName = "Stad Brunei Darussalam";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Brunej";
          const expectedFullName = "Sultanát Brunej";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Brunei";
          const expectedFullName = "Teyrnas Brwnei";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Brunei";
          const expectedFullName = "Sultanat Brunei Darussalam";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Brunei";
          const expectedFullName = "Brunei Darussalami Riik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Brunei";
          const expectedFullName = "Brunei Darussalamin valtio";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Brunei";
          const expectedFullName = "État de Brunei Darussalam";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Brunej";
          const expectedFullName = "Nacija od Bruneja, Kuću Mira";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Brunei";
          const expectedFullName = "Brunei Szultanátus";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Brunei";
          const expectedFullName = "Nazione di Brunei, Dimora della Pace";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ブルネイ・ダルサラーム";
          const expectedFullName = "ブルネイ、平和の精舎の国家";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "브루나이";
          const expectedFullName = "브루나이 다루살람국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "برونئی";
          const expectedFullName = "برونئی سرای صلح";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Brunei";
          const expectedFullName = "Państwo Brunei Darussalam";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Brunei";
          const expectedFullName = "Nação do Brunei, Morada da Paz";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Бруней";
          const expectedFullName = "Нация Бруней, обитель мира";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Brunej";
          const expectedFullName = "Brunejský sultanât";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Brunei";
          const expectedFullName = "Nación de Brunei, Morada de la Paz";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Brunei";
          const expectedFullName = "Brunei Darussalam";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Brunei";
          const expectedFullName = "Brunei Barış Ülkesi Devleti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "برونائی";
          const expectedFullName = "ریاستِ برونائی دارالسلام";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "文莱";
          const expectedFullName = "文莱和平之国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Бруней Даруссалам";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Brunei nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Búrúnẹ́lì";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Брунеи-Даруссалам";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Búrúnɛ́lì";
