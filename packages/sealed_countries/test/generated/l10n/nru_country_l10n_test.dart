...
void main() => group(
      "$CountryNru() L10N",
      () {
        const value = CountryNru();

        test("has translation for 'en' locale", () {
          const expectedName = "Nauru";
          const expectedFullName = "Republic of Nauru";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Науру";
          const expectedFullName = "Република Науру";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "ناورو";
          const expectedFullName = "جمهورية ناورو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Nauru";
          const expectedFullName = "Republik Nauru";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Nauru";
          const expectedFullName = "Republika Nauru";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Nauru";
          const expectedFullName = "Nauru Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Nauru";
          const expectedFullName = "Naurun tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Nauru";
          const expectedFullName = "République de Nauru";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Nauru";
          const expectedFullName = "Naurui Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Nauru";
          const expectedFullName = "Repubblica di Nauru";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ナウル";
          const expectedFullName = "ナウル共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "나우루";
          const expectedFullName = "나우루 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Nauru";
          const expectedFullName = "Republiek Nauru";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "نائورو";
          const expectedFullName = "جمهوری نائورو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Nauru";
          const expectedFullName = "República de Nauru";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Науру";
          const expectedFullName = "Республика Науру";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Nauru";
          const expectedFullName = "Naurská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Nauru";
          const expectedFullName = "Republiken Nauru";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Nauru";
          const expectedFullName = "Nauru Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "ناورو";
          const expectedFullName = "جمہوریہ ناورو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "瑙鲁";
          const expectedFullName = "瑙鲁共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Nauru nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Nauru";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Nauru";
