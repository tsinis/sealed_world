...
void main() => group(
      "$CountryChe() L10N",
      () {
        const value = CountryChe();

        test("has translation for 'en' locale", () {
          const expectedName = "Switzerland";
          const expectedFullName = "Swiss Confederation";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Швајцарска";
          const expectedFullName = "Швајцарска Конфедерација";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "سويسرا";
          const expectedFullName = "الاتحاد السويسري";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Suis";
          const expectedFullName = "Kengevredad Suis";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Švýcarsko";
          const expectedFullName = "Švýcarská konfederace";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Schweiz";
          const expectedFullName = "Schweizerische Eidgenossenschaft";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Šveits";
          const expectedFullName = "Šveitsi Konföderatsioon";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Sveitsi";
          const expectedFullName = "Sveitsin valaliitto";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Suisse";
          const expectedFullName = "Confédération suisse";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Švicarska";
          const expectedFullName = "švicarska Konfederacija";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Svizzera";
          const expectedFullName = "Confederazione svizzera";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "スイス";
          const expectedFullName = "スイス連邦";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "스위스";
          const expectedFullName = "스위스 연방";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Zwitserland";
          const expectedFullName = "Zwitserse Confederatie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "سوئیس";
          const expectedFullName = "کنفدراسیون سوئیس";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Szwajcaria";
          const expectedFullName = "Konfederacja Szwajcarska";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Suíça";
          const expectedFullName = "Confederação Suíça";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Швейцария";
          const expectedFullName = "Швейцарская Конфедерация";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Švajčiarsko";
          const expectedFullName = "Švajčiarska konfederácia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Suiza";
          const expectedFullName = "Confederación Suiza";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Schweiz";
          const expectedFullName = "Schweiziska edsförbundet";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "İsviçre";
          const expectedFullName = "İsviçre Konfederasyonu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "سویٹذرلینڈ";
          const expectedFullName = "سوئیس  متحدہ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "瑞士";
          const expectedFullName = "瑞士联邦";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Switserland";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "চুইজাৰলেণ্ড";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "সুইজারল্যান্ড";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "སུ་ཝིཊ་ཛར་ལེནཌ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Switzerland nutome";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "An Eilbheis";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "સ્વિટ્ઝર્લૅન્ડ";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "स्विट्ज़रलैंड";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಸ್ವಿಟ್ಜರ್ಲ್ಯಾಂಡ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "سُوِزَرلینڑ";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Switizirandi";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ສະວິດເຊີແລນ";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "സ്വിറ്റ്സർലാൻഡ്";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "स्वित्झर्लंड";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "l-Iżvizzera";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "स्विजरल्याण्ड";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ସ୍ୱିଜରଲ୍ୟାଣ୍ଡ";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਸਵਿਟਜ਼ਰਲੈਂਡ";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ස්විස්ටර්ලන්තය";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Swiiserlaand";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "ஸ்விட்சர்லாந்து";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "స్విట్జర్లాండ్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "สวิตเซอร์แลนด์";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "شىۋېتسارىيە";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Shveytsariya";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède switiṣilandi";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Switzerland";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "ސުވިޒަލޭންޑު";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Elveeish";
        ...
        test("has translation for 'li' locale", () {
          const expectedName = "Zweitserland";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Swis Bikéyah";
        ...
        test("has translation for 'sa' locale", () {
          const expectedName = "स्विटजरलैंड";
        ...
        test("has translation for 'ss' locale", () {
          const expectedName = "ISwizalandi";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "ESwitzerland";
        ...
        test("has translation for 'ks_Arab' locale", () {
          const expectedName = "سُوِزَرلینٛڑ";
        ...
        test("has translation for 'ug_Arab' locale", () {
          const expectedName = "شىۋىتسارىيە";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède switishilandi";
