...
void main() => group(
      "$CountryDji() L10N",
      () {
        const value = CountryDji();

        test("has translation for 'en' locale", () {
          const expectedName = "Djibouti";
          const expectedFullName = "Republic of Djibouti";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Џибути";
          const expectedFullName = "Република Џибути";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "جيبوتي";
          const expectedFullName = "جمهورية جيبوتي";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Djibouti";
          const expectedFullName = "Republik Djibouti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Džibutsko";
          const expectedFullName = "Džibutská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Jibwti";
          const expectedFullName = "Gweriniaeth Jibwti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Dschibuti";
          const expectedFullName = "Republik Dschibuti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Djibouti";
          const expectedFullName = "Djibouti Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Dijibouti";
          const expectedFullName = "Dijiboutin tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Djibouti";
          const expectedFullName = "République de Djibouti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Džibuti";
          const expectedFullName = "Republika Džibuti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Dzsibuti";
          const expectedFullName = "Dzsibuti Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Gibuti";
          const expectedFullName = "Repubblica di Gibuti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ジブチ";
          const expectedFullName = "ジブチ共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "지부티";
          const expectedFullName = "지부티 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Djibouti";
          const expectedFullName = "Republiek Djibouti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "جیبوتی";
          const expectedFullName = "جمهوری جیبوتی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Dżibuti";
          const expectedFullName = "Republika Dżibuti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Djibouti";
          const expectedFullName = "República do Djibouti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Джибути";
          const expectedFullName = "Республика Джибути";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "ǅibutsko";
          const expectedFullName = "ǅibutská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Djibouti";
          const expectedFullName = "República de Djibouti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Djibouti";
          const expectedFullName = "Republiken Djibouti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Cibuti";
          const expectedFullName = "Cibuti Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "جبوتی";
          const expectedFullName = "جمہوریہ جبوتی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "吉布提";
          const expectedFullName = "吉布提共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Dzibuti nutome";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Djibouti";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Díbọ́ótì";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Díbɔ́ótì";
