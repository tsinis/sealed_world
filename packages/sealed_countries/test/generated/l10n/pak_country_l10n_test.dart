...
void main() => group(
      "$CountryPak() L10N",
      () {
        const value = CountryPak();

        test("has translation for 'en' locale", () {
          const expectedName = "Pakistan";
          const expectedFullName = "Islamic Republic of Pakistan";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Пакистан";
          const expectedFullName = "Исламска Република Пакистан";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "باكستان";
          const expectedFullName = "جمهورية باكستان الإسلامية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Pakistan";
          const expectedFullName = "Republik islamek Pakistan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Pákistán";
          const expectedFullName = "Pákistánská islámská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Pakistan";
          const expectedFullName = "Islamische Republik Pakistan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Pakistan";
          const expectedFullName = "Pakistani Islamivabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Pakistan";
          const expectedFullName = "Pakistanin islamilainen tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Pakistan";
          const expectedFullName = "République islamique du Pakistan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Pakistan";
          const expectedFullName = "Islamska Republika Pakistan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Pakistan";
          const expectedFullName = "Repubblica islamica del Pakistan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "파키스탄";
          const expectedFullName = "파키스탄 이슬람 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Pakistan";
          const expectedFullName = "Islamitische Republiek Pakistan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "پاکستان";
          const expectedFullName = "جمهوری اسلامی پاکستان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Pakistan";
          const expectedFullName = "Islamska Republika Pakistanu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Paquistão";
          const expectedFullName = "República Islâmica do Paquistão";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Пакистан";
          const expectedFullName = "Исламская Республика Пакистан";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Pakistan";
          const expectedFullName = "Pakistanská islamská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Pakistán";
          const expectedFullName = "República Islámica de Pakistán";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Pakistan";
          const expectedFullName = "Islamiska republiken Pakistan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Pakistan";
          const expectedFullName = "Pakistan İslam Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "پاکستان";
          const expectedFullName = "اسلامی جمہوریہ پاکستان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "巴基斯坦";
          const expectedFullName = "巴基斯坦伊斯兰共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Pakistan nutome";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Phacastáin";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Pakisitaani";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "പാക്കിസ്ഥാൻ";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Pakistan";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "פּאַקיסטאַן";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Pakisitan";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Phakistaan";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Eʼeʼaahjí Naakaii Dootłʼizhí Bikéyah";
        ...
        test("has translation for 'sa' locale", () {
          const expectedName = "पाकिस्तानम्";
        ...
        test("has translation for 'ss' locale", () {
          const expectedName = "IPhakhistani";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Bahgihswhdanj";
        ...
        test("has translation for 'pa_Arab' locale", () {
          const expectedName = "پاکستان";

          final translated = value.maybeTranslation(
            const BasicTypedLocale(LangPan(), script: ScriptArab()),
            useLanguageFallback: false,
          );
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Pakisitan";
