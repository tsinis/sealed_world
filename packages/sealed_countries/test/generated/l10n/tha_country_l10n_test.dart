...
void main() => group(
      "$CountryTha() L10N",
      () {
        const value = CountryTha();

        test("has translation for 'en' locale", () {
          const expectedName = "Thailand";
          const expectedFullName = "Kingdom of Thailand";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Тајланд";
          const expectedFullName = "Краљевина Тајланд";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "تايلند";
          const expectedFullName = "مملكة تايلند";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Thailand";
          const expectedFullName = "Rouantelezh Thailand";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Thajsko";
          const expectedFullName = "Thajské království";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Thailand";
          const expectedFullName = "Königreich Thailand";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Tai";
          const expectedFullName = "Tai Kuningriik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Thaimaa";
          const expectedFullName = "Thaimaan kuningaskunta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Thaïlande";
          const expectedFullName = "Royaume de Thaïlande";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Tajland";
          const expectedFullName = "Kraljevina Tajland";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Thaiföld";
          const expectedFullName = "Thaiföldi Királyság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Tailandia";
          const expectedFullName = "Regno di Thailandia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "タイ";
          const expectedFullName = "タイ王国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "태국";
          const expectedFullName = "타이 왕국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Thailand";
          const expectedFullName = "Koninkrijk Thailand";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "تایلند";
          const expectedFullName = "پادشاهی تایلند";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Tajlandia";
          const expectedFullName = "Królestwo Tajlandii";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Tailândia";
          const expectedFullName = "Reino da Tailândia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Таиланд";
          const expectedFullName = "Королевство Таиланд";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Thajsko";
          const expectedFullName = "Thajské kráľovstvo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Tailandia";
          const expectedFullName = "Reino de Tailandia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Thailand";
          const expectedFullName = "Konungariket Thailand";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Tayland";
          const expectedFullName = "Tayland Krallığı";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "تھائی لینڈ";
          const expectedFullName = "مملکتِ تھائی لینڈ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "泰国";
          const expectedFullName = "泰王国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Thailand nutome";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Téalainn";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Dùthaich nan Tàidh";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "it-Tajlandja";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Tailandi";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Çheer Thai";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Tʼáí Bikéyah";
        ...
        test("has translation for 'ss' locale", () {
          const expectedName = "IThayilandi";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Tailandi";
