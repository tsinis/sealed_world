...
void main() => group(
      "$CountryMex() L10N",
      () {
        const value = CountryMex();

        test("has translation for 'en' locale", () {
          const expectedName = "Mexico";
          const expectedFullName = "United Mexican States";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Мексико";
          const expectedFullName = "Сједињене Мексичке Државе";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "المسكيك";
          const expectedFullName = "الولايات المتحدة المكسيكية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Mec'hiko";
          const expectedFullName = "Stadoù-Unanet Mec'hiko";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Mexiko";
          const expectedFullName = "Spojené státy mexické";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Mexiko";
          const expectedFullName = "Vereinigte Mexikanische Staaten";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Mehhiko";
          const expectedFullName = "Mehhiko Ühendriigid";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Meksiko";
          const expectedFullName = "Meksikon yhdysvallat";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Mexique";
          const expectedFullName = "États-Unis du Mexique";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Meksiko";
          const expectedFullName = "Sjedinjene Meksičke Države";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Mexikó";
          const expectedFullName = "Mexikói Egyesült Államok";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Messico";
          const expectedFullName = "Stati Uniti del Messico";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "メキシコ";
          const expectedFullName = "メキシコ合衆国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "멕시코";
          const expectedFullName = "멕시코 합중국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Mexico";
          const expectedFullName = "Verenigde Mexicaanse Staten";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "مکزیک";
          const expectedFullName = "ایالات متحد مکزیک";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Meksyk";
          const expectedFullName = "Meksykańskie Stany Zjednoczone";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "México";
          const expectedFullName = "Estados Unidos Mexicanos";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Мексика";
          const expectedFullName = "Мексиканские Соединённые Штаты";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Mexiko";
          const expectedFullName = "Spojené štášy mexické";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Mexiko";
          const expectedFullName = "Mexikos förenta stater";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Meksika";
          const expectedFullName = "Birleşik Meksika Devletleri";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "میکسیکو";
          const expectedFullName = "ریاستہائے متحدہ میکسیکو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "墨西哥";
          const expectedFullName = "墨西哥合众国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Mexico nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Mesiko";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Mesiko";
