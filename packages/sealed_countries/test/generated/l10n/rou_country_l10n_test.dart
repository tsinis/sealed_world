...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Rumunjska";
          const expectedFullName = "Rumunija";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Roménia";
          const expectedFullName = "Romênia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Romania nutome";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "ir-Rumanija";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ရိုမေးနီးယား";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Romaniya";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Lozmajnizya";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Romaniya";
