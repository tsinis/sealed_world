...
void main() => group(
      "$CountryGrd() L10N",
      () {
        const value = CountryGrd();

        test("has translation for 'en' locale", () {
          const expectedName = "Grenada";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Granada";
          const expectedFullName = "Grenada";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Grenada";
          const expectedFullName = "Granada";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Grenada nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Genada";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Gwzlinznazdaz";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Genada";
