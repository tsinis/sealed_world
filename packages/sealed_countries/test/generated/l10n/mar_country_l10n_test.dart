...
void main() => group(
      "$CountryMar() L10N",
      () {
        const value = CountryMar();

        test("has translation for 'en' locale", () {
          const expectedName = "Morocco";
          const expectedFullName = "Kingdom of Morocco";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Мароко";
          const expectedFullName = "Краљевина Мароко";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "المغرب";
          const expectedFullName = "المملكة المغربية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Maroko";
          const expectedFullName = "Rouantelezh Maroko";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Maroko";
          const expectedFullName = "Marocké království";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Marokko";
          const expectedFullName = "Königreich Marokko";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Maroko";
          const expectedFullName = "Maroko Kuningriik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Marokko";
          const expectedFullName = "Marokon kuningaskunta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Maroc";
          const expectedFullName = "Royaume du Maroc";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Maroko";
          const expectedFullName = "Kraljevina Maroko";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Marokkó";
          const expectedFullName = "Marokkói Királyság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Marocco";
          const expectedFullName = "Regno del Marocco";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "モロッコ";
          const expectedFullName = "モロッコ王国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "모로코";
          const expectedFullName = "모로코 왕국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Marokko";
          const expectedFullName = "Koninkrijk Marokko";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "مراکش";
          const expectedFullName = "پادشاهی مراکش";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Maroko";
          const expectedFullName = "Królestwo Marokańskie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Marrocos";
          const expectedFullName = "Reino de Marrocos";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Марокко";
          const expectedFullName = "Королевство Марокко";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Maroko";
          const expectedFullName = "Marocké kniežatstvo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Marruecos";
          const expectedFullName = "Reino de Marruecos";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Marocko";
          const expectedFullName = "Konungariket Marocko";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Fas";
          const expectedFullName = "Fas Krallığı";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "مراکش";
          const expectedFullName = "مملکتِ مراکش";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "摩洛哥";
          const expectedFullName = "摩洛哥王国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Moroko nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Moroko";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Moroko";
