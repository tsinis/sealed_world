...
void main() => group(
      "$CountryLao() L10N",
      () {
        const value = CountryLao();

        test("has translation for 'en' locale", () {
          const expectedName = "Laos";
          const expectedFullName = "Lao People's Democratic Republic";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Лаос";
          const expectedFullName = "Лаошка Народна Демократска Република";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "لاوس";
          const expectedFullName = "جمهورية لاوس الديمقراطية الشعبية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Laos";
          const expectedFullName = "Republik Demokratel ar Bobl Lao";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Laos";
          const expectedFullName = "Laoská lidově demokratická republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Laos";
          const expectedFullName = "Demokratische Volksrepublik Laos";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Laos";
          const expectedFullName = "Laose Demokraatlik Rahvavabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Laos";
          const expectedFullName = "Laosin demokraattinen kansantasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Laos";
          const expectedFullName = "République démocratique populaire lao";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Laos";
          const expectedFullName = "Narodna Demokratska Republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Laosz";
          const expectedFullName = "Laoszi Népi Demokratikus Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Laos";
          const expectedFullName = "Repubblica democratica popolare del Laos";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "라오스";
          const expectedFullName = "라오 인민 민주 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Laos";
          const expectedFullName = "Lao Democratische Volksrepubliek";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "لائوس";
          const expectedFullName = "جمهوری دموکراتیک خلق لائوس";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Laos";
          const expectedFullName = "Laotańska Republika Ludowo-Demokratyczna";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Laos";
          const expectedFullName = "Laos, República Democrática";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Laos";
          const expectedFullName = "Laoská ľudovodemokratická republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Laos";
          const expectedFullName = "República Democrática Popular Lao";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Laos";
          const expectedFullName = "Demokratiska folkrepubliken Laos";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Laos";
          const expectedFullName = "Laos Demokratik Halk Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "لاؤس";
          const expectedFullName = "عوامی جمہوری جمہوریہ لاؤ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "老挝";
          const expectedFullName = "老挝人民民主共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Laos nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Laosi";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Laosi";
