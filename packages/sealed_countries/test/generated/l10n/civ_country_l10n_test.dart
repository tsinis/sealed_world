...
void main() => group(
      "$CountryCiv() L10N",
      () {
        const value = CountryCiv();

        test("has translation for 'en' locale", () {
          const expectedName = "Ivory Coast";
          const expectedFullName = "Republic of Côte d'Ivoire";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Обала Слоноваче";
          const expectedFullName = "Република Обала Слоноваче";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "ساحل العاج";
          const expectedFullName = "جمهورية ساحل العاج";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Aod an Olifant";
          const expectedFullName = "Republik Aod an Olifant";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Pobřeží slonoviny";
          const expectedFullName = "Republika Pobřeží slonoviny";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Elfenbeinküste";
          const expectedFullName = "Republik Côte d'Ivoire";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Elevandiluurannik";
          const expectedFullName = "Côte d’Ivoire’i Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Norsunluurannikko";
          const expectedFullName = "Norsunluurannikon tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Côte d'Ivoire";
          const expectedFullName = "République de Côte d' Ivoire";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Obala Bjelokosti";
          const expectedFullName = "Republika Côte d'Ivoire";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Elefántcsontpart";
          const expectedFullName = "Elefántcsontparti Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Costa d'Avorio";
          const expectedFullName = "Repubblica della Costa d'Avorio";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "コートジボワール";
          const expectedFullName = "コートジボワール共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "코트디부아르";
          const expectedFullName = "코트디부아르 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Ivoorkust";
          const expectedFullName = "Republiek Ivoorkust";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "ساحل عاج";
          const expectedFullName = "جمهوری ساحل عاج";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "WybrzeŻe Kości Słoniowej";
          const expectedFullName = "Republika WybrzeŻa Kości Słoniowej";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Costa do Marfim";
          const expectedFullName = "República da Côte d'Ivoire";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Кот-д’Ивуар";
          const expectedFullName = "Республика Кот-д'Ивуаре";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Pobržie Slonoviny";
          const expectedFullName = "Republika Pobrežie Slonoviny";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Costa de Marfil";
          const expectedFullName = "República de Côte d'Ivoire";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Elfenbenskusten";
          const expectedFullName = "Republiken Elfenbenskusten";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Fildişi Sahili";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "آئیوری کوسٹ";
          const expectedFullName = "جمہوریہ کوت دیواغ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "科特迪瓦";
          const expectedFullName = "科特迪瓦共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "La Côte d’Ivoire";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "কোটে ডি আইভৰ";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Кот-д’Івуар";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Кот д’Ивоар";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "কোত দিভোয়ার";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Obala Slonovače";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "Elfenbenskysten";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཀོ་ཊེ་ ཌི་ཨི་ཝོ་རེ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Kote d’Ivoire nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Ακτή Ελεφαντοστού";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Fílabeinsstrondin";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Cósta Eabhair";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "કોટ ડીઆઇવરી";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Aibari Kwas";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "कोट डी आइवर";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Կոտ դ՚Իվուար";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Fílabeinsströndin";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Pasisir Gadhing";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "კოტ-დივუარი";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಕೋತ್‌ ದಿವಾರ್‍";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "اَیوٕری کوسٹ";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Peravê Diranfîl";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Kotídivualɛ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Dramblio Kaulo Krantas";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Kotedivuale";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Брегот на Слоновата Коска";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "കോട്ട് ഡി വാർ";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "आयव्हरी कोस्ट";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Cote d’Ivoire";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Kosta tal-Avorju";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ကို့တ် ဒီဗွာ";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "Elfenbeinskysten";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "କୋତ୍ ଡି ଭ୍ଵାର୍";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "Costa d’Ivur";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Kotedivuware";
        ...
        test("has translation for 'sd' locale", () {
          const expectedName = "آئيوري ڪنارو";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Elfenbenariddu";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "කෝට් දි අයිවරි";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "Slonokoščena obala";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Ayfori Koost";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "கோட் தி’வாயர்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "కోట్ డి ఐవోర్";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Kot-d’Iwuar";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Matafonua ʻAivolī";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "كوتې دې ئىۋوئىر";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Кот-дʼІвуар";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Kot-d’Ivuar";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "העלפֿאַ נדביין בארטן";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Kóútè forà";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Côte d’Ivoire";
        ...
        test("has translation for 'an' locale", () {
          const expectedName = "Costa de Vori";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ཀོ་ཊི་ཌི་ཨའི་བོ་རི།";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "Costa d'Ivori";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "އައިވަރީ ކޯސްޓު";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Costa Ìbhri";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Costa do Marfil";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Clyst Iuaagagh";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Costa de Ebore";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Pantai Gading";
        ...
        test("has translation for 'ie' locale", () {
          const expectedName = "Costa de Ivor";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Litus Eburneum";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Elfebeeküst";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Chį́į́h Yee Adilohii Bideeʼ Tónteel Bibąąh";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Còsta d'Evòri";
        ...
        test("has translation for 'qu' locale", () {
          const expectedName = "Marphil Chala";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Coasta de Fildeș";
        ...
        test("has translation for 'rw' locale", () {
          const expectedName = "Kote Divuwari";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Costa de Avòriu";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Bregu i Fildishtë";
        ...
        test("has translation for 'ss' locale", () {
          const expectedName = "Lugu Lwempondvondlovu";
        ...
        test("has translation for 'su' locale", () {
          const expectedName = "Basisir Gading";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Baybaying Garing";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Bờ Biển Ngà";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "ECôte d’Ivoire";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Обала Слоноваче (Кот д’Ивоар)";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Kóútè forà";
