...
void main() => group(
      "$CountryHnd() L10N",
      () {
        const value = CountryHnd();

        test("has translation for 'en' locale", () {
          const expectedName = "Honduras";
          const expectedFullName = "Republic of Honduras";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Хондурас";
          const expectedFullName = "Република Хондурас";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "هندوراس";
          const expectedFullName = "جمهورية هندوراس";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Honduras";
          const expectedFullName = "Republik Honduras";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Honduras";
          const expectedFullName = "Honduraská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Honduras";
          const expectedFullName = "Hondurase Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Honduras";
          const expectedFullName = "Hondurasin tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Honduras";
          const expectedFullName = "République du Honduras";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Honduras";
          const expectedFullName = "Republika Honduras";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Honduras";
          const expectedFullName = "Hondurasi Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Honduras";
          const expectedFullName = "Repubblica di Honduras";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ホンジュラス";
          const expectedFullName = "ホンジュラス共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "온두라스";
          const expectedFullName = "온두라스 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Honduras";
          const expectedFullName = "Republiek Honduras";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "هُندوراس";
          const expectedFullName = "جمهوری هندوراس";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Honduras";
          const expectedFullName = "Republika Hondurasu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Honduras";
          const expectedFullName = "República de Honduras";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Гондурас";
          const expectedFullName = "Республика Гондурас";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Honduras";
          const expectedFullName = "Republiken Honduras";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Honduras";
          const expectedFullName = "Honduras Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "ہونڈوراس";
          const expectedFullName = "جمہوریہ ہونڈوراس";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "洪都拉斯";
          const expectedFullName = "洪都拉斯共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཧཱན་ཌུ་རཱས྄";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Honduras";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဟွန်ဒူးရပ်စ်";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Hondurasi";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ཧོང་དུ་ར་སི།";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "ހޮންޑިއުރަސް";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Ny Hondooraghyn";
        ...
        test("has translation for 'wa' locale", () {
          const expectedName = "Hondourasse";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Yankin Honduras";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Hungzduhlahswh";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Hondurasi";
