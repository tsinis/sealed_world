...
void main() => group(
      "$CountryAtf() L10N",
      () {
        const value = CountryAtf();

        test("has translation for 'en' locale", () {
          const expectedName = "French Southern and Antarctic Lands";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Француске јужне и антарктичке земље";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "أراض فرنسية جنوبية وأنتارتيكية";
          const expectedFullName = "مقاطعات وأقاليم ما وراء البحار الفرنسية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Douaroù Aostral hag Antarktikel Frañs";
          const expectedFullName =
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Francouzská jižní a antarktická území";
          const expectedFullName =
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Französische Süd- und Antarktisgebiete";
          const expectedFullName =
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Prantsuse Lõunaalad";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Ranskan eteläiset ja antarktiset alueet";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Terres australes et antarctiques françaises";
          const expectedFullName =
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Francuski južni i antarktički teritoriji";
          const expectedFullName =
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Francia déli és antarktiszi területek";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Territori Francesi del Sud";
          const expectedFullName =
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "フランス領南方・南極地域";
          const expectedFullName = "フランス領南方·南極地域の領土";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "프랑스령 남부와 남극 지역";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "سرزمین‌های جنوبی و جنوبگانی فرانسه";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Francuskie Terytoria Południowe i Antarktyczne";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Terras Austrais e Antárticas Francesas";
          const expectedFullName = "Território do Sul e Antártica Francesa";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Французские Южные и Антарктические территории";
          const expectedFullName =
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Francúzske juŽné a antarktické územia";
          const expectedFullName = "Francúzske južné a antarktické územia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Tierras Australes y Antárticas Francesas";
          const expectedFullName =
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Franska södra territorierna";
          const expectedFullName = "Franska syd- och Antarktisterritorierna";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Fransız Güney ve Antarktika Toprakları";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "سرزمین جنوبی فرانسیسیہ و انٹارکٹیکا";
          const expectedFullName = "سرزمینِ جنوبی فرانسیسیہ و انٹارکٹیکہ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Franse Suidelike Gebiede";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የፈረንሳይ ደቡባዊ ግዛቶች";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "দক্ষিণ ফ্ৰান্সৰ অঞ্চল";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Fransanın Cənub Əraziləri";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Французскія паўднёвыя тэрыторыі";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Френски южни територии";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "ফরাসী দক্ষিণাঞ্চল";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Francuske Južne Teritorije";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "Territoris Australs Francesos";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Французийн къилба латтанаш";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཕྲནཅ་གི་ལྷོ་ཕྱོགས་མངའ་ཁོངས";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Anyiehe Franseme nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Γαλλικά Νότια Εδάφη";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Hegoaldeko lurralde frantsesak";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Fronsku sunnaru landaøki";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Críocha Francacha Dheisceart an Domhain";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Ranntairean a Deas na Frainge";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Territorios Austrais Franceses";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "ફ્રેંચ સધર્ન ટેરિટરીઝ";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Yankin Faransi ta Kudu";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "הטריטוריות הדרומיות של צרפת";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "फ़्रांसीसी दक्षिणी क्षेत्र";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Ֆրանսիական Հարավային Տարածքներ";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Territorios meridional francese";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Wilayah Selatan Perancis";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ụmụ ngalaba Frenchi Southern";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Frönsku suðlægu landsvæðin";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Wilayah Prancis nang Kutub Kidul";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ფრანგული სამხრეთის ტერიტორიები";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Францияның оңтүстік аймақтары";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ដែនដី​បារាំង​នៅ​ភាគខាងត្បូង";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಫ್ರೆಂಚ್ ದಕ್ಷಿಣ ಪ್ರದೇಶಗಳು";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "فرانسِسی جَنوٗبی عَلاقہٕ";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Франциянын Түштүктөгү аймактары";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Franséisch Süd- an Antarktisgebidder";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ເຂດແດນທາງໃຕ້ຂອຝຮັ່ງ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Prancūzijos Pietų sritys";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Francijas Dienvidjūru teritorija";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Француски Јужни Територии";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ഫ്രഞ്ച് ദക്ഷിണ ഭൂപ്രദേശം";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Францын өмнөд газар нутаг";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "फ्रेंच दाक्षिणात्य प्रदेश";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "It-Territorji Franċiżi tan-Nofsinhar";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ပြင်သစ် တောင်ပိုင်း ပိုင်နက်များ";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "De franske sørterritorier";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "फ्रेन्च दक्षिणी राज्यहरू";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "Dei franske sørterritoria";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଫରାସୀ ଦକ୍ଷିଣ କ୍ଷେତ୍ର";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਫਰੈਂਚ ਦੱਖਣੀ ਪ੍ਰਦੇਸ਼";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "د فرانسې جنوبي سیمې";
        ...
        test("has translation for 'qu' locale", () {
          const expectedName = "Territorios Australes Franceses";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "Territoris Franzos Meridiunals";
        ...
        test("has translation for 'sd' locale", () {
          const expectedName = "فرانسيسي ڏاکڻي علائقا";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "දකුණු ප්‍රංශ දූපත් සමූහය";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "Francosko južno ozemlje";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Dhul xadeedka Koonfureed ee Faransiiska";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Territoret Jugore Franceze";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Himaya za Kusini za Kifaranza";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "பிரெஞ்சு தெற்கு பிரதேசங்கள்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "ఫ్రెంచ్ దక్షిణ ప్రాంతాలు";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Минтақаҳои Ҷанубии Фаронса";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "เฟรนช์เซาเทิร์นเทร์ริทอรีส์";
        ...
        test("has translation for 'ti' locale", () {
          const expectedName = "ናይ ፈረንሳይ ደቡባዊ ግዝኣታት";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Fransuz günorta territoriýalary";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Potu fonua tonga fakafalanisē";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Франциянең Көньяк Территорияләре";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "فىرانسىيەنىڭ جەنۇبىي زېمىنى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Французькі Південні Території";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Fransuz Janubiy hududlari";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Lãnh thổ phía Nam Thuộc Pháp";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Teer Ostraal gu Fraas";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Agbègbè Gúúsù Faranṣé";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-French Southern Territories";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Франци Кӑнтӑр территорийӗсем";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤚𞤵𞤥𞤦𞤫 𞤂𞤫𞤧𞤤𞤫𞤴𞤶𞤫 𞤊𞤪𞤢𞤲𞤧𞤭";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Herêmên Başûr ên Fransayê";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Ngā Rohe o Wīwī ki te Tonga";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Terras australes frantzesas";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "French Southern Territories";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "EFrench Southern Territories";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Францызтәи Аладатәи аҵакырадгьылқәа";
        ...
        test("has translation for 'an' locale", () {
          const expectedName = "Territorios australs franceses";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Francaj Sudaj Teritorioj";
        ...
        test("has translation for 'ie' locale", () {
          const expectedName = "Territorias meridional de Francia";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Territòris del Sud franceses";
        ...
        test("has translation for 'ps_PK' locale", () {
          const expectedName = "د فرانسے جنوبي سیمے";

          final translated = value.maybeTranslation(
            const BasicTypedLocale(LangPus(), country: CountryPak()),
            useLanguageFallback: false,
          );
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Франсанын Ҹәнуб Әразиләри";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Француске Јужне Територије";
        ...
        test("has translation for 'kk_Cyrl' locale", () {
          const expectedName = "Францияның солтүстік аймағы";
        ...
        test("has translation for 'ks_Arab' locale", () {
          const expectedName = "فرٛانسِسی جَنوٗبی عَلاقہٕ";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Teritoriile Australe și Antarctice Franceze";
        ...
        test("has translation for 'ug_Arab' locale", () {
          const expectedName = "فىرانسىيەگە قاراشلىق جەنۇبتىكى زېمىنلىرى";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Француз жанубий ҳудудлари";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Agbègbè Gúúsù Faranshé";
