...
void main() => group(
      "$CountryZaf() L10N",
      () {
        const value = CountryZaf();

        test("has translation for 'en' locale", () {
          const expectedName = "South Africa";
          const expectedFullName = "Republic of South Africa";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Јужноафричка Република";
          const expectedFullName = "Република Јужна Африка";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "جنوب أفريقيا";
          const expectedFullName = "جمهورية جنوب أفريقيا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Suafrika";
          const expectedFullName = "Republik Suafrika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Jihoafrická republika";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Südafrika";
          const expectedFullName = "Republik Südafrika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Lõuna-Aafrika Vabariik";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Etelä-Afrikka";
          const expectedFullName = "Etelä-Afrikan tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Afrique du Sud";
          const expectedFullName = "République d'Afrique du Sud";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Južna Afrika";
          const expectedFullName = "Južnoafrička Republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Dél-afrikai Köztársaság";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Sud Africa";
          const expectedFullName = "Repubblica del Sud Africa";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "南アフリカ";
          const expectedFullName = "南アフリカ共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "남아프리카";
          const expectedFullName = "남아프리카 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Zuid-Afrika";
          const expectedFullName = "Republiek Zuid-Afrika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "آفریقای جنوبی";
          const expectedFullName = "جمهوری آفریقای جنوبی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Południowa Afryka";
          const expectedFullName = "Republika Południowej Afryki";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "África do Sul";
          const expectedFullName = "República da África do Sul";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Южная Африка";
          const expectedFullName = "Южно-Африканская Республика";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Južná Afrika";
          const expectedFullName = "Juhoafrická republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Sudáfrica";
          const expectedFullName = "República de Sudáfrica";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Sydafrika";
          const expectedFullName = "Republiken Sydafrika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Güney Afrika";
          const expectedFullName = "Güney Afrika Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "جنوبی افریقا";
          const expectedFullName = "جمہوریہ جنوبی افریقا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "南非";
          const expectedFullName = "南非共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Suid-Afrika";
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Afrika Anaafo";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "দক্ষিণ আফ্রিকা";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Cənub Afrika";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Паўднёва-Афрыканская Рэспубліка";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Южна Африка";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Worodugu Afriki";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Južnoafrička Republika";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "República de Sud-àfrica";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Къилба-Африкин Республика";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "སཱའུཐ་ ཨཕ་རི་ཀ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Anyiehe Africa nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Νότια Αφρική";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Afrik bŋ Worgo";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Suðurafrika";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Afraic Theas";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Afraga a Deas";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "દક્ષિણ આફ્રિકા";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Afirka Ta Kudu";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "דרום אפריקה";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "दक्षिण अफ़्रीका";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Հարավաֆրիկյան Հանրապետություն";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Afrika Selatan";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Suður-Afríka";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Afrika Kidul";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "სამხრეთ აფრიკის რესპუბლიკა";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Afrika Kusini";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Оңтүстік Африка Республикасы";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "អាហ្វ្រិកខាងត្បូង";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ದಕ್ಷಿಣ ಆಫ್ರಿಕಾ";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "جَنوٗبی اَفریٖکا";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Afrîkaya Başûr";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Түштүк-Африка Республикасы";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Sawusafirika";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Afríka ya Súdi";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Pietų Afrika";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Afrika ya Súdi";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Dienvidāfrikas Republika";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Afrika Atsimo";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Јужноафриканска Република";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ദക്ഷിണാഫ്രിക്ക";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Өмнөд Африк";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "दक्षिण आफ्रिका";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "l-Afrika t’Isfel";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "တောင်အာဖရိက";
        ...
        test("has translation for 'nd' locale", () {
          const expectedName = "Mzansi ye Afrika";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "दक्षिण अफ्रिका";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଦକ୍ଷିଣ ଆଫ୍ରିକା";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਦੱਖਣੀ ਅਫਰੀਕਾ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "سویلي افریقا";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "Africa dal Sid";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Afurika y’Epfo";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Africa de Sud";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Mátta-Afrihká";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Mbongo-Afrîka";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "දකුණු අප්‍රිකාව";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "Južnoafriška republika";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Koonfur Afrika";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Afrika e Jugut";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "தென் ஆப்பிரிக்கா";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "దక్షిణ ఆఫ్రికా";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Африкаи Ҷанубӣ";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Günorta Afrika";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "ʻAfilika tonga";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Көньяк Африка";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "جەنۇبىي ئافرىقا";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Південно-Африканська Республіка";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Janubiy Afrika Respublikasi";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Afrik di Sid";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "eMzantsi Afrika";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "דרום־אַפֿריקע";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Gúúṣù Áfíríkà";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "iNingizimu Afrika";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Кăнтăр Африка";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "ދެކުނު އެފްރިކާ";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Affrick Yiass";
        ...
        test("has translation for 'ht' locale", () {
          const expectedName = "Afrik disid";
        ...
        test("has translation for 'kg' locale", () {
          const expectedName = "Afelika ya Sudi";
        ...
        test("has translation for 'kv' locale", () {
          const expectedName = "Лунвыв Африкаса Республика";
        ...
        test("has translation for 'kw' locale", () {
          const expectedName = "Afrika Dhyhow";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Africa Australis";
        ...
        test("has translation for 'li' locale", () {
          const expectedName = "Zuud-Afrika";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Awherika ki te Tonga";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName =
              "Kéyah Naakai Łizhinii Bikéyah Shádiʼááhjí Siʼánígíí";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Sud d'Africa";
        ...
        test("has translation for 'os' locale", () {
          const expectedName = "Хуссар Африкæйы";
        ...
        test("has translation for 'st' locale", () {
          const expectedName = "Afrika Borwa";

          final translated = value.maybeTranslation(
            const BasicLocale(LangSot()),
            useLanguageFallback: false,
          );
          ...
          expect(commonMapTranslation, expectedName);
          final unexpectedScriptTranslation = value.maybeTranslation(
            const BasicLocale(LangSot(), script: ScriptCyrs()),
          );

          expect(unexpectedScriptTranslation?.name, expectedName);
          expect(
            value.translations,
            contains(const TranslatedName(LangSot(), name: expectedName)),
          );
        });
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Timog Aprika";
        ...
        test("has translation for 'tn' locale", () {
          const expectedName = "Aferika Borwa";
        ...
        test("has translation for 'ts' locale", () {
          const expectedName = "Afrika-Dzonga";
        ...
        test("has translation for 've' locale", () {
          const expectedName = "Afurika Tshipembe";

          final translated = value.maybeTranslation(
            const BasicLocale(LangVen()),
            useLanguageFallback: false,
          );
          ...
          expect(commonMapTranslation, expectedName);
          final unexpectedScriptTranslation = value.maybeTranslation(
            const BasicLocale(LangVen(), script: ScriptCyrs()),
          );

          expect(unexpectedScriptTranslation?.name, expectedName);
          expect(
            value.translations,
            contains(const TranslatedName(LangVen(), name: expectedName)),
          );
        });
        test("has translation for 'vo' locale", () {
          const expectedName = "Sulüdafrikän";
        ...
        test("has translation for 'wa' locale", () {
          const expectedName = "Nonne-Afrike";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Алада-Африкатәи ареспублика";
        ...
        test("has translation for 'kl' locale", () {
          const expectedName = "Kujalleqafrika";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Ҹәнуб Африка";
        ...
        test("has translation for 'mn_Cyrl' locale", () {
          const expectedName = "Өмнөд Африк тив";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Жанубий Африка Республикаси";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Gúúshù Áfíríkà";
