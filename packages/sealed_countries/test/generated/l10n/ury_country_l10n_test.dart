...
void main() => group(
      "$CountryUry() L10N",
      () {
        const value = CountryUry();

        test("has translation for 'en' locale", () {
          const expectedName = "Uruguay";
          const expectedFullName = "Oriental Republic of Uruguay";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Уругвај";
          const expectedFullName = "Источна Република Уругвај";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "الأوروغواي";
          const expectedFullName = "جمهورية الأوروغواي الشرقية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Uruguay";
          const expectedFullName = "Republik Reter Uruguay";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Uruguay";
          const expectedFullName = "Uruguayská východní republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Uruguay";
          const expectedFullName = "Republik Östlich des Uruguay";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Uruguay";
          const expectedFullName = "Uruguay Idavabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Uruguay";
          const expectedFullName = "Uruguayn itäinen tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Uruguay";
          const expectedFullName = "République orientale de l'Uruguay";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Urugvaj";
          const expectedFullName = "Orijentalna Republika Urugvaj";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Uruguay";
          const expectedFullName = "Uruguayi Keleti Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Uruguay";
          const expectedFullName = "Repubblica Orientale dell'Uruguay";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ウルグアイ";
          const expectedFullName = "ウルグアイ東方共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "우루과이";
          const expectedFullName = "우루과이 동방 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Uruguay";
          const expectedFullName = "Oosterse Republiek Uruguay";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "اروگوئه";
          const expectedFullName = "جمهوری اروگوئه";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Urugwaj";
          const expectedFullName = "Wschodnia Republika Urugwaju";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Uruguai";
          const expectedFullName = "República Oriental do Uruguai";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Уругвай";
          const expectedFullName = "Восточной Республики Уругвай";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Uruguaj";
          const expectedFullName = "Uruguajská východná republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Uruguay";
          const expectedFullName = "República Oriental del Uruguay";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Uruguay";
          const expectedFullName = "Republiken Uruguay";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Uruguay";
          const expectedFullName = "Uruguay Doğu Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "یوراگوئے";
          const expectedFullName = "جمہوریہ شرقیہ یوراگوئے";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "乌拉圭";
          const expectedFullName = "乌拉圭东岸共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཡུ་རུ་གུ་ཝའི";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "uruguaydukɔ";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "អ៊ុយរូហ្គាយ";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Nruguayi";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ཨུ་རུ་གུ་ཡེ།";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Ooraguay";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Táłtłʼááh Chʼosh Bitooh (Kéyah Dah Siʼánígíí)";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Vuhlahgveih";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Nruguayi";
