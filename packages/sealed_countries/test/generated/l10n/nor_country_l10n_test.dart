...
void main() => group(
      "$CountryNor() L10N",
      () {
        const value = CountryNor();

        test("has translation for 'en' locale", () {
          const expectedName = "Norway";
          const expectedFullName = "Kingdom of Norway";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Норвешка";
          const expectedFullName = "Краљевина Норвешка";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "النرويج";
          const expectedFullName = "مملكة النرويج";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Norvegia";
          const expectedFullName = "Rouantelezh Norvegia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Norsko";
          const expectedFullName = "Norské království";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Norwegen";
          const expectedFullName = "Königreich Norwegen";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Norra";
          const expectedFullName = "Norra Kuningriik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Norja";
          const expectedFullName = "Norjan kuningaskunta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Norvège";
          const expectedFullName = "Royaume de Norvège";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Norveška";
          const expectedFullName = "Kraljevina Norveška";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Norvégia";
          const expectedFullName = "Norvég Királyság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Norvegia";
          const expectedFullName = "Regno di Norvegia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ノルウェー";
          const expectedFullName = "ノルウェー王国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "노르웨이";
          const expectedFullName = "노르웨이 왕국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Noorwegen";
          const expectedFullName = "Koninkrijk Noorwegen";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "نروژ";
          const expectedFullName = "پادشاهی نروژ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Norwegia";
          const expectedFullName = "Królestwo Norwegii";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Noruega";
          const expectedFullName = "Reino da Noruega";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Норвегия";
          const expectedFullName = "Королевство Норвегия";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Nórsko";
          const expectedFullName = "Nórske kráľovstvo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Noruega";
          const expectedFullName = "Reino de Noruega";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Norge";
          const expectedFullName = "Konungariket Norge";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Norveç";
          const expectedFullName = "Norveç Krallığı";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "ناروے";
          const expectedFullName = "مملکتِ ناروے";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "挪威";
          const expectedFullName = "挪威王国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Norway nutome";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "in-Norveġja";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Nọọwii";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Nɔɔwii";
