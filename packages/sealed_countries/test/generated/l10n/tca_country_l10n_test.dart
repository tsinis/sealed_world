...
void main() => group(
      "$CountryTca() L10N",
      () {
        const value = CountryTca();

        test("has translation for 'en' locale", () {
          const expectedName = "Turks and Caicos Islands";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Теркс и Кејкос";
          const expectedFullName = "Острва Теркс и Кејкос";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "جزر توركس وكايكوس";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Inizi Turks ha Caicos";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Turks a Caicos";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Turks-und Caicosinseln";
          const expectedFullName = "Turks und Caicos Inseln";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Turks ja Caicos";
          const expectedFullName = "Turksi ja Caicose saared";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Turks-ja Caicossaaret";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Îles Turques-et-Caïques";
          const expectedFullName = "Îles Turques et Caïques";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Otoci Turks i Caicos";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Turks- és Caicos-szigetek";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Isole Turks e Caicos";
          const expectedFullName = "Turks e Caicos";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "タークス・カイコス諸島";
          const expectedFullName = "タークス·カイコス諸島";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "터크스 케이커스 제도";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Turks-en Caicoseilanden";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "جزایر تورکس و کایکوس";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Turks i Caicos";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Ilhas Turks e Caicos";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Теркс и Кайкос";
          const expectedFullName = "Теркс и Кайкос острова";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Turks a Caicos";
          const expectedFullName = "Ostrovy Turks a Caicos";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Islas Turks y Caicos";
          const expectedFullName = "Islas Turcas y Caicos";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Turks- och Caicosöarna";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Turks ve Caicos Adaları";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "جزائر کیکس و ترکیہ";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Turks- en Caicoseilande";
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Turks ne Caicos Islands";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የቱርኮችና የካኢኮስ ደሴቶች";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "টাৰ্কছ অৰু কেইক’ছ দ্বীপপুঞ্জ";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Törks və Kaykos adaları";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Астравы Цёркс і Кайкас";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "острови Търкс и Кайкос";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Turiki Gun ni Kayiki";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "তুর্কস ও কাইকোস দ্বীপপুঞ্জ";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Ostrva Turks i Kaikos";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "Illes Turks i Caicos";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Тёркс а, Кайкос а гӀайренаш";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "Turks- og Caicosøerne";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཏུརྐས྄་ ཨེནཌ་ ཀ་ཀོས་གླིང་ཚོམ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Tɛks kple Kaikos ƒudomekpowo nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Νήσοι Τερκς και Κάικος";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Turk eta Caico uharteak";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Duuɗe Turke e Keikoos";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Turks- og Caicosoyggjar";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Turks- en Caicoseilannen";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Oileáin na dTurcach agus Caicos";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Na h-Eileanan Turcach is Caiceo";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Illas Turks e Caicos";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "તુર્ક્સ અને કેકોઝ આઇલેન્ડ્સ";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Turkis Da Tsibiran Kaikwas";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "איי טרקס וקייקוס";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "तुर्क और कैकोज़ द्वीपसमूह";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Թըրքս և Կայկոս կղզիներ";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Insulas Turcos e Caicos";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Kepulauan Turks dan Caicos";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Agwaetiti Turks na Caicos";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Turks- og Caicoseyjar";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Turks lan Kapuloan Kaikos";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "თერქს-ქაიქოსის კუნძულები";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Visiwa vya Turki na Kaiko";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Теркс және Кайкос аралдары";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "កោះ​ទួគ និង កៃកូស";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಟರ್ಕ್ಸ್ ಮತ್ತು ಕೈಕೋಸ್ ದ್ವೀಪಗಳು";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "تُرُک تہٕ کیکوس جٔزیٖرٕ";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Giravên Turk û Kaîkos";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Түркс жана Кайкос аралдары";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Turks- a Caicosinselen";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Bizinga by’eTaaka ne Kayikosi";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Bisanga bya Turki mpé Kaiko";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ໝູ່ເກາະ ເທີກ ແລະ ໄຄໂຄສ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Terkso ir Kaikoso Salos";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Lutanda lua Tuluki ne Kaiko";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Tērksas un Kaikosas salas";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Nosy Turks sy Caïques";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Острови Туркс и Каикос";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ടർക്ക്‌സും കെയ്‌ക്കോ ദ്വീപുകളും";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Турк ба Кайкосын Арлууд";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "टर्क्स आणि कैकोस बेटे";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Gżejjer Turks u Caicos";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "တခ်စ်နှင့်ကာအီကိုစ်ကျွန်းစု";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "Turks- og Caicosøyene";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "तुर्क र काइकोस टापु";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "Turks- og Caicosøyane";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ତୁର୍କସ୍‌ ଏବଂ କାଇକୋସ୍‌ ଦ୍ୱୀପପୁଞ୍ଜ";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਟੁਰਕਸ ਅਤੇ ਕੈਕੋਸ ਟਾਪੂ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "د ترکیې او کیکاسو ټاپو";
        ...
        test("has translation for 'qu' locale", () {
          const expectedName = "Islas Turcas y Caicos";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "Inslas Turks e Caicos";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Amazinga ya Turkisi na Cayikosi";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Insulele Turks și Caicos";
        ...
        test("has translation for 'sd' locale", () {
          const expectedName = "ترڪ ۽ ڪيڪوس ٻيٽ";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Turks ja Caicos-sullot";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Âzûâ Turku na Kaîki";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ටර්ක්ස් සහ කයිකොස් දූපත්";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "Otoki Turks in Caicos";
        ...
        test("has translation for 'sn' locale", () {
          const expectedName = "Zvitsuwa zveTurk neCaico";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Turks & Kaikos Island";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Ishujt Turks dhe Kaikos";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Visiwa vya Turks na Caicos";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "டர்க்ஸ் & கைகோஸ் தீவுகள்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "టర్క్స్ మరియు కైకోస్ దీవులు";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Ҷазираҳои Теркс ва Кайкос";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "หมู่เกาะเติกส์และหมู่เกาะเคคอส";
        ...
        test("has translation for 'ti' locale", () {
          const expectedName = "ደሴታት ቱርክን ካይኮስን";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Terks we Kaýkos adalary";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "ʻOtumotu Tuki mo Kaikosi";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Теркс һәм Кайкос утраулары";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "تۇركس ۋە كايكوس ئاراللىرى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Острови Теркс і Кайкос";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Turks va Kaykos orollari";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Quần đảo Turks và Caicos";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Duni Tirk ak Kaykos";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Tọọki ati Etikun Kakọsi";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Turks ne-Caicos Islands";
        ...
        test("has translation for 'an' locale", () {
          const expectedName = "Islas Turcas e Caicos";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Тĕркс тата Кайкос";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "ޓާކަސް އަދި ކައިކޯ ޖަޒީރާ";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Turkoj kaj Kajkoj";
        ...
        test("has translation for 'io' locale", () {
          const expectedName = "Turks e Kaikos-Insuli";
        ...
        test("has translation for 'kw' locale", () {
          const expectedName = "Turks ha Kaykos";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Ìsulas Turks e Caicos";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Turks & Caicos Islands";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "ETurks & Caicos Islands";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "ад-хақәа Тиоркси Каикоси";
        ...
        test("has translation for 'ie' locale", () {
          const expectedName = "Turks e Caicos";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Insulae Turcenses et Caicenses";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Illas Turcas e Caïcas";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Төркс вә Кајкос адалары";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Туркс и Кајкос Острва";
        ...
        test("has translation for 'kk_Cyrl' locale", () {
          const expectedName = "Туркс пен Кайкос";
        ...
        test("has translation for 'ps_PK' locale", () {
          const expectedName = "د ترکیے او کیکاسو ټاپو";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Туркс ва Кайкос ороллари";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Tɔɔki ati Etikun Kakɔsi";
