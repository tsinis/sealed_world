...
void main() => group(
      "$CountryVen() L10N",
      () {
        const value = CountryVen();

        test("has translation for 'en' locale", () {
          const expectedName = "Venezuela";
          const expectedFullName = "Bolivarian Republic of Venezuela";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Венецуела";
          const expectedFullName = "Боливарска Република Венецуела";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "فنزويلا";
          const expectedFullName = "جمهورية فنزويلا البوليفارية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Venezuela";
          const expectedFullName = "Republik Volivarian Venezuela";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Venezuela";
          const expectedFullName = "Bolívarská republika Venezuela";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Venezuela";
          const expectedFullName = "Bolivarische Republik Venezuela";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Venezuela";
          const expectedFullName = "Venezuela Bolívari Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Venezuela";
          const expectedFullName = "Venezuelan bolivariaainen tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Venezuela";
          const expectedFullName = "République bolivarienne du Venezuela";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Venezuela";
          const expectedFullName = "BOLIVARIJANSKA Republika Venezuela";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Venezuela";
          const expectedFullName = "Venezuelai Bolivári Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Venezuela";
          const expectedFullName = "Repubblica Bolivariana del Venezuela";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ベネズエラ・ボリバル共和国";
          const expectedFullName = "ベネズエラ·ボリバル共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "베네수엘라";
          const expectedFullName = "베네수엘라 볼리바르 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Venezuela";
          const expectedFullName = "Bolivariaanse Republiek Venezuela";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "ونزوئلا";
          const expectedFullName = "جمهوری بولیواری ونزوئلا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Wenezuela";
          const expectedFullName = "Boliwariańska Republika Wenezueli";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Venezuela";
          const expectedFullName = "República Bolivariana da Venezuela";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Венесуэла";
          const expectedFullName = "Боливарианская Республика Венесуэла";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Venezuela";
          const expectedFullName = "Venezuelská bolívarovská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Venezuela";
          const expectedFullName = "República Bolivariana de Venezuela";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Venezuela";
          const expectedFullName = "Bolivarianska republiken Venezuela";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Venezuela";
          const expectedFullName = "Bolivarcı Venezuela Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "وینیزویلا";
          const expectedFullName = "جمہوریہ وینیزویلا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "委内瑞拉";
          const expectedFullName = "委内瑞拉玻利瓦尔共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "ভেনেজুয়েলা";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "བེ་ནི་ཛུ་ཝེ་ལ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Venezuela nutome";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Wenesuwelaa";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "A’ Bheiniseala";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "វ៉េណេស៊ុយអេឡា";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "व्हेनेझुएला";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Venezwela";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဗင်နီဇွဲလား";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "වෙනිසියුලාව";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Fenisuweela";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Fẹnẹṣuẹla";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Venezuela";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ཝེ་ནེ་ཟུའེ་ལ།";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Veneswaaley";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Táłkááʼ Bighan Dineʼé Bikéyah";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Veijneisuilah";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Fɛnɛshuɛla";
