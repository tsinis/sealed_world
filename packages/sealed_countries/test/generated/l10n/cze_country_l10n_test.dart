...
void main() => group(
      "$CountryCze() L10N",
      () {
        const value = CountryCze();

        test("has translation for 'en' locale", () {
          const expectedName = "Czechia";
          const expectedFullName = "Czech Republic";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Чешка";
          const expectedFullName = "Чешка Република";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "التشيك";
          const expectedFullName = "جمهورية التشيك";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Tchekia";
          const expectedFullName = "Republik Tchek";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Česko";
          const expectedFullName = "Česká republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Y Weriniaeth Tsiec";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Tschechien";
          const expectedFullName = "Tschechische Republik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Tšehhi";
          const expectedFullName = "Tšehhi Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Tšekki";
          const expectedFullName = "Tšekin tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Tchéquie";
          const expectedFullName = "République tchèque";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Csehország";
          const expectedFullName = "Cseh Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Cechia";
          const expectedFullName = "Repubblica Ceca";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "チェコ";
          const expectedFullName = "チェコ共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Tsjechië";
          const expectedFullName = "Tsjechische Republiek";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Czechy";
          const expectedFullName = "Republika Czeska";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Chéquia";
          const expectedFullName = "República Checa";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Чехия";
          const expectedFullName = "Чешская Республика";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Tjeckien";
          const expectedFullName = "Republiken Tjeckien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Çekya";
          const expectedFullName = "Çek Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "چيک";
          const expectedFullName = "چيک جمہوريہ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "捷克";
          const expectedFullName = "捷克共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Kyɛk Kurokɛse";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Ceki republiki";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཅེཀ་ རི་པབ་ལིཀ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Tsɛk repɔblik nutome";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Ndenndaandi Cek";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Jamhuriyar Cak";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Jamhuri ya Cheki";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "چیک جَموٗرِیَت";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Lipubulika ya Ceeka";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Ditunga dya Tsheka";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Repoblikan’i Tseky";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "ir-Repubblika Ċeka";
        ...
        test("has translation for 'nd' locale", () {
          const expectedName = "Czech Republic";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "Republica Tscheca";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Repubulika ya Ceke";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Ködörösêse tî Tyêki";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Ҷумҳурии Чех";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Чехия Республикасы";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "چېخ جۇمھۇرىيىتى";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède ṣẹ́ẹ́kì";
        ...
        test("has translation for 'an' locale", () {
          const expectedName = "Republica Checa";
        ...
        test("has translation for 'ay' locale", () {
          const expectedName = "Chexya Ripublika";
        ...
        test("has translation for 'bh' locale", () {
          const expectedName = "चेक रिपब्लिक";
        ...
        test("has translation for 'ch' locale", () {
          const expectedName = "Chekia";
          ...
          expect(
            value.translations,
            contains(const TranslatedName(LangCha(), name: expectedName)),
          );
        });
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Чех Республики";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "ޗެކް ޖުމްހޫރިއްޔާ";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Phobblaght Çheck";
        ...
        test("has translation for 'ht' locale", () {
          const expectedName = "Repiblik tchèk";
        ...
        test("has translation for 'kg' locale", () {
          const expectedName = "République tchèque";
        ...
        test("has translation for 'na' locale", () {
          const expectedName = "Ripubrikin Tsiek";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Chek Bikéyah";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Republica Chèca";
        ...
        test("has translation for 'sa' locale", () {
          const expectedName = "ज़ेक् रिपब्लिक";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Repùblica Ceca";
        ...
        test("has translation for 'sm' locale", () {
          const expectedName = "Czechs Republic";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Republikang Tseko";
        ...
        test("has translation for 'kk_Cyrl' locale", () {
          const expectedName = "Чех Республикасы";
        ...
        test("has translation for 'mn_Cyrl' locale", () {
          const expectedName = "Бүгд Найрамдах Чех Улс";
        ...
        test("has translation for 'ms_Latn' locale", () {
          const expectedName = "Republik Czech";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède shɛ́ɛ́kì";
