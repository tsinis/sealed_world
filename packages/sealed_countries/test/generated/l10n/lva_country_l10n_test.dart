...
void main() => group(
      "$CountryLva() L10N",
      () {
        const value = CountryLva();

        test("has translation for 'en' locale", () {
          const expectedName = "Latvia";
          const expectedFullName = "Republic of Latvia";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Летонија";
          const expectedFullName = "Летонска Република";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "لاتفيا";
          const expectedFullName = "جمهورية لاتفيا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Latvia";
          const expectedFullName = "Republik Latvia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Lotyšsko";
          const expectedFullName = "Lotyšská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Lettland";
          const expectedFullName = "Republik Lettland";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Läti";
          const expectedFullName = "Läti Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Latvia";
          const expectedFullName = "Latvian tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Lettonie";
          const expectedFullName = "République de Lettonie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Latvija";
          const expectedFullName = "Republika Latvija";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Lettország";
          const expectedFullName = "Lett Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Lettonia";
          const expectedFullName = "Repubblica di Lettonia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ラトビア";
          const expectedFullName = "ラトビア共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "라트비아";
          const expectedFullName = "라트비아 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Letland";
          const expectedFullName = "Republiek Letland";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "لتونی";
          const expectedFullName = "جمهوری لتونی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Łotwa";
          const expectedFullName = "Republika Łotewska";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Letónia";
          const expectedFullName = "República da Letónia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Латвия";
          const expectedFullName = "Латвийская Республика";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Letonia";
          const expectedFullName = "República de Letonia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Lettland";
          const expectedFullName = "Republiken Lettland";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Letonya";
          const expectedFullName = "Letonya Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "لٹویا";
          const expectedFullName = "جمہوریہ لٹویا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "拉脱维亚";
          const expectedFullName = "拉脱维亚共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Latvia nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Latifia";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Lahdozveizya";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Latifia";
