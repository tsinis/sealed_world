...
void main() => group(
      "$CountryBes() L10N",
      () {
        const value = CountryBes();

        test("has translation for 'en' locale", () {
          const expectedName = "Caribbean Netherlands";
          const expectedFullName = "Bonaire, Sint Eust,atius and Saba";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Карипска Холандија";
          const expectedFullName = "Бонер, Свети Еустахије и Саба";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "الجزر الكاريبية الهولندية";
          const expectedFullName = "بونير وسينت أوستاتيوس وسابا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Bonaire, Sint Eustatius ha Saba";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Karibské Nizozemsko";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Caribbean Netherlands";
          const expectedFullName = "Bonaire, Sint Eustatius and Saba";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Karibische Niederlande";
          const expectedFullName = "Bonaire, Sint Eustatius und Saba";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Bonaire, Sint Eustatius ja Saba";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Pays-Bas caribéens";
          const expectedFullName = "Bonaire, Saint-Eustache et Saba";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Bonaire, Sint Eustatius i Saba";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Paesi Bassi caraibici";
          const expectedFullName = "Bonaire, Sint Eustatius e Saba";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ボネール、シント・ユースタティウスおよびサバ";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "카리브 네덜란드";
          const expectedFullName = "보네르, 신트외스타티위스, 사바";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Caribisch Nederland";
          const expectedFullName = "Bonaire, Sint Eustatius en Saba";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "جزایر کارائیب هلند";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Antyle Holenderskie";
          const expectedFullName = "Bonaire, Sint Eustatius i Saba";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Países Baixos Caribenhos";
          const expectedFullName = "Bonaire, Saba e Santo Eustáquio";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Карибские Нидерланды";
          const expectedFullName = "Бонэйр, Синт-Эстатиус и Саба";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Bonaire, Sint Eustatius a Saba";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Caribe Neerlandés";
          const expectedFullName = "Bonaire, San Eustaquio y Saba";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Karibiska Nederländerna";
          const expectedFullName = "Bonaire, Sint Eustatius and Saba";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Karayip Hollandası";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "کیریبین نیدرلینڈز";
          const expectedFullName = "بونایر، سینٹ ایوسٹائیس اور سابا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Karibiese Nederland";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የካሪቢያን ኔዘርላንድስ";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "কেৰিবিয়ান নেদাৰলেণ্ডছ";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Karib Niderlandı";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Карыбскія Нідэрланды";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Карибска Нидерландия";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "ক্যারিবিয়ান নেদারল্যান্ডস";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Karipska Holandija";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "Carib Neerlandès";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Бонэйр, Синт-Эстатиус а, Саба а";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "De tidligere Nederlandske Antiller";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཀེ་རི་བི་ཡེན་ནེ་དར་ལནཌས྄";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Ολλανδία Καραϊβικής";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Karibeko Herbehereak";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Niðurlonds Karibia";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Karibysk Nederlân";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Ísiltír Chairibeach";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Na Tìrean Ìsle Caraibeach";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "કેરેબિયન નેધરલેન્ડ્ઝ";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "האיים הקריביים ההולנדיים";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "कैरिबियन नीदरलैंड";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Կարիբյան Նիդեռլանդներ";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Belanda Karibia";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Karíbahafshluti Hollands";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Karibia Walanda";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "კარიბის ნიდერლანდები";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Бонэйр, Синт-Эстатиус және Саба";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ហូឡង់ ការ៉ាប៊ីន";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಕೆರೀಬಿಯನ್ ನೆದರ್‌ಲ್ಯಾಂಡ್ಸ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "برطانوی قُطبہِ جَنوٗبی علاقہٕ";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Кариб Нидерланддары";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Karibescht Holland";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ຄາຣິບບຽນ ເນເທີແລນ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Karibų Nyderlandai";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Nīderlandes Karību salas";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "കരീബിയൻ നെതർലാൻഡ്സ്";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Карибын Нидерланд";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "कॅरिबियन नेदरलँड्स";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Belanda Caribbean";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "in-Netherlands tal-Karibew";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ကာရစ်ဘီယံ နယ်သာလန်";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "Karibisk Nederland";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "क्यारिवियन नेदरल्याण्ड्स";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "କାରବିୟନ୍‌ ନେଦରଲ୍ୟାଣ୍ଡ";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਕੈਰੇਬੀਆਈ ਨੀਦਰਲੈਂਡ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "کیریبین هالینډ";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Insulele Caraibe Olandeze";
        ...
        test("has translation for 'sd' locale", () {
          const expectedName = "ڪيريبين نيدرلينڊ";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "කැරිබියානු නෙදර්ලන්තය";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "Nizozemski Karibi";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Karibiyaan Nadarlands";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Karaibet holandeze";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Uholanzi ya Karibiani";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "கரீபியன் நெதர்லாந்து";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "కరీబియన్ నెదర్లాండ్స్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "เนเธอร์แลนด์แคริบเบียน";
        ...
        test("has translation for 'ti' locale", () {
          const expectedName = "ካሪቢያን ኔዘርላንድስ";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Karib Niderlandlary";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Kalipiane fakahōlani";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "كارىب دېڭىزى گوللاندىيە";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Нідерландські Карибські острови";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Boneyr, Sint-Estatius va Saba";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Ca-ri-bê Hà Lan";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Caribbean Netherlands";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Бонэйр, Синт-Эстатиус тата Саба";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤑𞤢𞤪𞤦𞤭𞤴𞤢𞥄 𞤖𞤮𞤤𞤢𞤲𞤣𞤭𞤴𞤢𞥄";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Paises Basse caribe";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Holendaya Karayîbê";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Karapīana Hōrana";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "Antillas Ollandaisas";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Caràibes olandesas";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "ECaribbean Netherlands";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Kàríbíánì ti Nẹ́dálándì";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Бонеир, Синт-Естатиуси Сабеи";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Karibbeatɔwo ƒe Nedalanɖs nutome";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Karibia Nederlando";
        ...
        test("has translation for 'ie' locale", () {
          const expectedName = "Caribean Nederland";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Païses Basses caribèus";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Vuolleeatnamat Karibe";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Netherland Antilles sa Caribbean";
        ...
        test("has translation for 'kk_Cyrl' locale", () {
          const expectedName = "Кариб Нидерландысы";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Бонейр, Синт-Эстатиус ва Саба";
