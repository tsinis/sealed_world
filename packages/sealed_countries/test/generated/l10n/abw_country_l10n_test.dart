...
void main() => group(
      "$CountryAbw() L10N",
      () {
        const value = CountryAbw();

        test("has translation for 'en' locale", () {
          const expectedName = "Aruba";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Aruba nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Árúbà";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Árúbà";
