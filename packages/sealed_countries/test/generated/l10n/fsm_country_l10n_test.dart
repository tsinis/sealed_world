...
void main() => group(
      "$CountryFsm() L10N",
      () {
        const value = CountryFsm();

        test("has translation for 'en' locale", () {
          const expectedName = "Micronesia";
          const expectedFullName = "Federated States of Micronesia";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Микронезија";
          const expectedFullName = "Савез Држава Микронезије";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "ميكرونيسيا";
          const expectedFullName = "ولايات ميكرونيسيا المتحدة";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Mikronezia";
          const expectedFullName = "Stadoù Kevreet Mikronezia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Mikronésie";
          const expectedFullName = "Federativní státy Mikronésie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Mikronesien";
          const expectedFullName = "Föderierte Staaten von Mikronesien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Mikroneesia";
          const expectedFullName = "Mikroneesia Liiduriigid";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Mikronesia";
          const expectedFullName = "Mikronesian liittovaltio";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Micronésie";
          const expectedFullName = "États fédérés de Micronésie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Mikronezija";
          const expectedFullName = "Savezne Države Mikronezije";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Mikronéziai Szövetségi Államok";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Micronesia";
          const expectedFullName = "Stati federati di Micronesia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "미크로네시아";
          const expectedFullName = "미크로네시아 연방";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Micronesië";
          const expectedFullName = "Federale Staten van Micronesia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "میکرونزی";
          const expectedFullName = "ایالات فدرال میکرونزی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Mikronezja";
          const expectedFullName = "Sfederowane Stany Mikronezji";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Micronésia";
          const expectedFullName = "Estados Federados da Micronésia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Федеративные Штаты Микронезии";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Mikronézia";
          const expectedFullName = "Mikronézske federatívne štáty";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Micronesia";
          const expectedFullName = "Estados Federados de Micronesia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Mikronesiska federationen";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Mikronezya";
          const expectedFullName = "Mikronezya Federal Devletleri";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "مائکرونیشیا";
          const expectedFullName = "ریاستہائے وفاقیہ مائکرونیشیا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "密克罗尼西亚";
          const expectedFullName = "密克罗尼西亚联邦";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Maekronehyia";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "মাইক্ৰোনেচিয়া";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Mikroneziya";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "মাইক্রোনেশিয়া";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Микронезин Федеративни штаташ";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "མའི་ཀྲོ་ནི་ཤི་ཡ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Mikronesia nutome";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Mikoronesii";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Mikronesiasamveldið";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Mhicrinéis";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Na Meanbh-eileanan";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "માઇક્રોનેશિયા";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Mikuronesiya";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "माइक्रोनेशिया";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Féderasi Mikronésia";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "មីក្រូណេស៊ី";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಮೈಕ್ರೋನೇಶಿಯಾ";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Mikuronezya";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Mikronēzija";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "മൈക്രോനേഷ്യ";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "मायक्रोनेशिया";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "မိုင်ခရိုနီရှား";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "Mikronesiaføderasjonen";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "माइक्रोनेसिया";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ମାଇକ୍ରୋନେସିଆ";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਮਾਇਕ੍ਰੋਨੇਸ਼ੀਆ";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Mikoroniziya";
        ...
        test("has translation for 'sd' locale", () {
          const expectedName = "مائڪرونيشيا";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "මයික්‍රොනීසියාව";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Mikroneesiya";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "மைக்ரோனேஷியா";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "మైక్రోనేషియా";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Штатҳои Федеративии Микронезия";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ไมโครนีเซีย";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Mikroneziýa";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Mikolonīsia";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "مىكرونېزىيە";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Makoronesia";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Micronesia";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Estats Federats de Micronesia";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Liên bang Micronesia";
        ...
        test("has translation for 'vo' locale", () {
          const expectedName = "Smala-Seanuäns";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "EMicronesia";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Еилоу Микронезиатәи Аштатқәа";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "مائیکرونیشیا";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Makoronesia";
