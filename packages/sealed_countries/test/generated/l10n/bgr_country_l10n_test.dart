...
void main() => group(
      "$CountryBgr() L10N",
      () {
        const value = CountryBgr();

        test("has translation for 'en' locale", () {
          const expectedName = "Bulgaria";
          const expectedFullName = "Republic of Bulgaria";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Бугарска";
          const expectedFullName = "Република Бугарска";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "بلغاريا";
          const expectedFullName = "جمهورية بلغاريا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Bulgaria";
          const expectedFullName = "Republik Bulgaria";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Bulharsko";
          const expectedFullName = "Bulharská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Bwlgaria";
          const expectedFullName = "Gweriniaeth Bwlgaria";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Bulgarien";
          const expectedFullName = "Republik Bulgarien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Bulgaaria";
          const expectedFullName = "Bulgaaria Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Bulgaria";
          const expectedFullName = "Bulgarian tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Bulgarie";
          const expectedFullName = "République de Bulgarie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Bugarska";
          const expectedFullName = "Republika Bugarska";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Bulgária";
          const expectedFullName = "Bolgár Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Bulgaria";
          const expectedFullName = "Repubblica di Bulgaria";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ブルガリア";
          const expectedFullName = "ブルガリア共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "불가리아";
          const expectedFullName = "불가리아 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Bulgarije";
          const expectedFullName = "Republiek Bulgarije";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "بلغارستان";
          const expectedFullName = "جمهوری بلغارستان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Bułgaria";
          const expectedFullName = "Republika Bułgarii";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Bulgária";
          const expectedFullName = "República da Bulgária";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Болгария";
          const expectedFullName = "Республика Болгария";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Bulgaria";
          const expectedFullName = "República de Bulgaria";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Bulgarien";
          const expectedFullName = "Republiken Bulgarien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Bulgaristan";
          const expectedFullName = "Bulgaristan Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "بلغاریہ";
          const expectedFullName = "جمہوریہ بلغاریہ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "保加利亚";
          const expectedFullName = "保加利亚共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Bolqarıstan";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Bulgaria nutome";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Bhulgáir";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Bulgarija";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဘူလ်ဂေးရီးယား";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Bùùgáríà";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "པུ་ར་ག་རི་ཡ།";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Bálgaa Bikéyah";
        ...
        test("has translation for 'om' locale", () {
          const expectedName = "Bulgeeriyaa";
        ...
        test("has translation for 'ss' locale", () {
          const expectedName = "iBhulgariya";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Baujgyahliya";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Болгарыстан";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Bùùgáríà";
