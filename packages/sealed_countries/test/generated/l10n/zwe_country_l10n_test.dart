...
void main() => group(
      "$CountryZwe() L10N",
      () {
        const value = CountryZwe();

        test("has translation for 'en' locale", () {
          const expectedName = "Zimbabwe";
          const expectedFullName = "Republic of Zimbabwe";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Зимбабве";
          const expectedFullName = "Република Зимбабве";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "زيمبابوي";
          const expectedFullName = "جمهورية زيمبابوي";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Zimbabwe";
          const expectedFullName = "Republik Zimbabwe";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Zimbabwe";
          const expectedFullName = "Zimbabwská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Simbabwe";
          const expectedFullName = "Republik Simbabwe";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Zimbabwe";
          const expectedFullName = "Zimbabwe Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Zimbabwe";
          const expectedFullName = "Zimbabwen tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Zimbabwe";
          const expectedFullName = "République du Zimbabwe";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Zimbabve";
          const expectedFullName = "Republika Zimbabve";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Zimbabwe";
          const expectedFullName = "Zimbabwei Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Zimbabwe";
          const expectedFullName = "Repubblica dello Zimbabwe";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ジンバブエ";
          const expectedFullName = "ジンバブエ共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "짐바브웨";
          const expectedFullName = "짐바브웨 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Zimbabwe";
          const expectedFullName = "Republiek Zimbabwe";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "زیمبابوه";
          const expectedFullName = "جمهوری زیمبابوه";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Zimbabwe";
          const expectedFullName = "Republika Zimbabwe";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Zimbabwe";
          const expectedFullName = "República do Zimbabwe";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Зимбабве";
          const expectedFullName = "Республика Зимбабве";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Zimbabwe";
          const expectedFullName = "Zimbabwianska republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Zimbabue";
          const expectedFullName = "República de Zimbabue";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Zimbabwe";
          const expectedFullName = "Republiken Zimbabwe";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Zimbabve";
          const expectedFullName = "Zimbabve Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "زمبابوے";
          const expectedFullName = "جمہوریہ زمبابوے";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "津巴布韦";
          const expectedFullName = "津巴布韦共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "জিম্বাবোয়ে";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Zimbabwe nutome";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an tSiombáib";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "An t-Sìombab";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "ज़िम्बाब्वे";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "iż-Żimbabwe";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède ṣimibabe";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Çhimbabwe";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Hooghan Tsé Bee Ádaalyaaí Bikéyah";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Cinhbahbuveiz";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède shimibabe";
