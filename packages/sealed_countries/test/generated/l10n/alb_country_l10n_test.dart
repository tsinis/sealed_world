...
void main() => group(
      "$CountryAlb() L10N",
      () {
        const value = CountryAlb();

        test("has translation for 'en' locale", () {
          const expectedName = "Albania";
          const expectedFullName = "Republic of Albania";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Албанија";
          const expectedFullName = "Република Албанија";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "ألبانيا";
          const expectedFullName = "جمهورية ألبانيا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Albania";
          const expectedFullName = "Republik Albania";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Albánie";
          const expectedFullName = "Albánská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Albania";
          const expectedFullName = "Gweriniaeth Albania";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Albanien";
          const expectedFullName = "Republik Albanien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Albaania";
          const expectedFullName = "Albaania Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Albania";
          const expectedFullName = "Albanian tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Albanie";
          const expectedFullName = "République d'Albanie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Albanija";
          const expectedFullName = "Republika Albanija";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Albánia";
          const expectedFullName = "Albán Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Albania";
          const expectedFullName = "Repubblica d'Albania";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "アルバニア";
          const expectedFullName = "アルバニア共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "알바니아";
          const expectedFullName = "알바니아 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Albanië";
          const expectedFullName = "Republiek Albanië";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "آلبانی";
          const expectedFullName = "جمهوری آلبانی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Albania";
          const expectedFullName = "Republika Albanii";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Albânia";
          const expectedFullName = "República da Albânia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Албания";
          const expectedFullName = "Республика Албания";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Albánsko";
          const expectedFullName = "Albánska republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Albania";
          const expectedFullName = "República de Albania";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Albanien";
          const expectedFullName = "Republiken Albanien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Arnavutluk";
          const expectedFullName = "Arnavutluk Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "البانیا";
          const expectedFullName = "جمہوریہ البانیا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "阿尔巴尼亚";
          const expectedFullName = "阿尔巴尼亚共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཨཱལ་བེ་ནི་ཡ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Albania nutome";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "အယ်လ်ဘေးနီးယား";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Àlùbàníánì";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Арнауыҭтәыла";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Dziłigaii Bikéyah";
        ...
        test("has translation for 'ss' locale", () {
          const expectedName = "I-Alibheniya";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Ahwjbahnizya";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Àlùbàníánì";
