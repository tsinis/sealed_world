...
void main() => group(
      "$CountryGgy() L10N",
      () {
        const value = CountryGgy();

        test("has translation for 'en' locale", () {
          const expectedName = "Guernsey";
          const expectedFullName = "Bailiwick of Guernsey";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Гернзи";
          const expectedFullName = "Бејливик Гернзи";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Guernsey";
          const expectedFullName = "Rychtářství Guernsey";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Guernsey";
          const expectedFullName = "Vogtei Guernsey";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Guernsey";
          const expectedFullName = "Guernsey foogtkond";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Guernesey";
          const expectedFullName = "Bailliage de Guernesey";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Guernsey";
          const expectedFullName = "Struka Guernsey";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Guernsey";
          const expectedFullName = "Baliato di Guernsey";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ガーンジー";
          const expectedFullName = "ガーンジーの得意分野";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Guernsey";
          const expectedFullName = "Baljuwschap Guernsey";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Guernsey";
          const expectedFullName = "Baliwat Guernsey";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Guernsey";
          const expectedFullName = "Bailiado de Guernsey";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Гернси";
          const expectedFullName = "Коронное владение Гернси";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Guernsey";
          const expectedFullName = "Bailía de Guernsey";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Guernsey";
          const expectedFullName = "Guernsey Muhafızlığı";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "گرنزی";
          const expectedFullName = "گرنزی رودبار";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Guernse nutome";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Yankin Guernsey";
