...
void main() => group(
      "$CountryAgo() L10N",
      () {
        const value = CountryAgo();

        test("has translation for 'en' locale", () {
          const expectedName = "Angola";
          const expectedFullName = "Republic of Angola";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Ангола";
          const expectedFullName = "Република Ангола";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "جمهورية أنغولا";
          const expectedFullName = "أنغولا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Angola";
          const expectedFullName = "Republik Angola";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Angola";
          const expectedFullName = "Angolská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Angola";
          const expectedFullName = "Gweriniaeth Angola";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Angola";
          const expectedFullName = "Angola Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Angola";
          const expectedFullName = "Angolan tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Angola";
          const expectedFullName = "République d'Angola";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Angola";
          const expectedFullName = "Republika Angola";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Angola";
          const expectedFullName = "Repubblica dell'Angola";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "アンゴラ";
          const expectedFullName = "アンゴラ共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "앙골라";
          const expectedFullName = "앙골라 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Angola";
          const expectedFullName = "Republiek Angola";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "آنگولا";
          const expectedFullName = "جمهوری آنگولا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Angola";
          const expectedFullName = "Republika Angoli";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Angola";
          const expectedFullName = "República de Angola";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Ангола";
          const expectedFullName = "Республика Ангола";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Angola";
          const expectedFullName = "Republiken Angola";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Angola";
          const expectedFullName = "Angola Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "انگولہ";
          const expectedFullName = "جمہوریہ انگولہ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "安哥拉";
          const expectedFullName = "安哥拉共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Angola nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Ààngólà";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Ààngólà";
