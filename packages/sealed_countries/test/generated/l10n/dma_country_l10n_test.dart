...
void main() => group(
      "$CountryDma() L10N",
      () {
        const value = CountryDma();

        test("has translation for 'en' locale", () {
          const expectedName = "Dominica";
          const expectedFullName = "Commonwealth of Dominica";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Доминика";
          const expectedFullName = "Комонвелт Доминика";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "دومينيكا";
          const expectedFullName = "كومونولث دومينيكا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Dominika";
          const expectedFullName = "Kenglad Dominika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Dominika";
          const expectedFullName = "Dominikánské společenství";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Dominica";
          const expectedFullName = "Cymanwlad Dominica";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Dominica";
          const expectedFullName = "Commonwealth von Dominica";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Dominica";
          const expectedFullName = "Dominica Ühendus";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Dominica";
          const expectedFullName = "Dominican liittovaltio";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Dominique";
          const expectedFullName = "Commonwealth de la Dominique";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Dominika";
          const expectedFullName = "Zajednica Dominika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Dominikai Közösség";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Dominica";
          const expectedFullName = "Commonwealth di Dominica";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Dominica";
          const expectedFullName = "Gemenebest Dominica";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "دومینیکا";
          const expectedFullName = "قلمرو همسود دومینیکا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Dominika";
          const expectedFullName = "Wspólnota Dominiki";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Dominica";
          const expectedFullName = "Comunidade da Dominica";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Доминика";
          const expectedFullName = "Содружество Доминики";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Dominika";
          const expectedFullName = "Dominické spoločenstvo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Dominica";
          const expectedFullName = "Mancomunidad de Dominica";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Dominica";
          const expectedFullName = "Samväldet Dominica";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Dominika";
          const expectedFullName = "Dominika Topluluğu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "ڈومینیکا";
          const expectedFullName = "دولتِ مشترکہ ڈومینیکا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "多米尼加";
          const expectedFullName = "多米尼加共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Dominika nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Dòmíníkà";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ཌོ་མིན་ནི་ཀ།";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Dohmijnizgwz";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Dòmíníkà";
