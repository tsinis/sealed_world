...
void main() => group(
      "$CountryMda() L10N",
      () {
        const value = CountryMda();

        test("has translation for 'en' locale", () {
          const expectedName = "Moldova";
          const expectedFullName = "Republic of Moldova";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Молдавија";
          const expectedFullName = "Република Молдавија";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "مولدوڤا";
          const expectedFullName = "جمهورية مولدوڤا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Moldova";
          const expectedFullName = "Republik Moldova";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Moldavsko";
          const expectedFullName = "Moldavská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Moldawien";
          const expectedFullName = "Republik Moldau";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Moldova";
          const expectedFullName = "Moldova Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Moldova";
          const expectedFullName = "Moldovan tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Moldavie";
          const expectedFullName = "République de Moldavie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Moldova";
          const expectedFullName = "Moldavija";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Moldova";
          const expectedFullName = "Moldovai Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Moldavia";
          const expectedFullName = "Repubblica di Moldova";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "몰도바";
          const expectedFullName = "몰도바 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Moldavië";
          const expectedFullName = "Republiek Moldavië";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "مولداوی";
          const expectedFullName = "جمهوری مولداوی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Mołdawia";
          const expectedFullName = "Republika Mołdawii";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Moldávia";
          const expectedFullName = "República da Moldávia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Молдавия";
          const expectedFullName = "Молдова";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Moldavia";
          const expectedFullName = "República de Moldova";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Moldavien";
          const expectedFullName = "Republiken Moldavien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Moldova";
          const expectedFullName = "Moldova Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "مالدووا";
          const expectedFullName = "جمہوریہ مالدووا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "摩尔多瓦";
          const expectedFullName = "摩尔多瓦共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Moldova nutome";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Mholdóiv";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "A’ Mholdobha";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Republica Moldova";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Modofia";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Te Whenua o Morotawa";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Mohwjdohvaj";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Modofia";
