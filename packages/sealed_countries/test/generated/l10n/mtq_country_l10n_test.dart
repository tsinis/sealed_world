...
void main() => group(
      "$CountryMtq() L10N",
      () {
        const value = CountryMtq();

        test("has translation for 'en' locale", () {
          const expectedName = "Martinique";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Martinique";
          const expectedFullName = "Martinique’i departemang";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Martinica";
          const expectedFullName = "Martinique";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "マルティニーク";
          const expectedFullName = "マルティニーク島";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Martiniki nutome";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Maritiniiki";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "മാർട്ടിനിക്ക്";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ମାର୍ଟିନିକ୍ୟୁ";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Matinikuwi";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Martinique";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "EMartinique";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Matinikuwi";
