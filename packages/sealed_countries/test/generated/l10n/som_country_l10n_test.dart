...
void main() => group(
      "$CountrySom() L10N",
      () {
        const value = CountrySom();

        test("has translation for 'en' locale", () {
          const expectedName = "Somalia";
          const expectedFullName = "Federal Republic of Somalia";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Сомалија";
          const expectedFullName = "Савезна Република Сомалија";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "الصومال";
          const expectedFullName = "جمهورية الصومال الفيدرالية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Somalia";
          const expectedFullName = "Republik Kevreadel Somalia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Somálsko";
          const expectedFullName = "Somálská demokratická republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Somalia";
          const expectedFullName = "Bundesrepublik Somalia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Somaalia";
          const expectedFullName = "Somaalia Liitvabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Somalia";
          const expectedFullName = "Somalian liittotasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Somalie";
          const expectedFullName = "République fédérale de Somalie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Somalija";
          const expectedFullName = "Savezna Republika Somaliji";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Szomália";
          const expectedFullName = "Szomáli Szövetségi Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Somalia";
          const expectedFullName = "Repubblica federale di Somalia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ソマリア";
          const expectedFullName = "ソマリア連邦共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "소말리아";
          const expectedFullName = " 소말리아 연방 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Somalië";
          const expectedFullName = "Federale Republiek Somalië";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "سومالی";
          const expectedFullName = "جمهوری فدرال سومالی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Somalia";
          const expectedFullName = "Federalna Republika Somalii";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Somália";
          const expectedFullName = "República Federal da Somália";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Сомали";
          const expectedFullName = "Федеративная Республика Сомали";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Somálsko";
          const expectedFullName = "Somálska federatívna republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Somalia";
          const expectedFullName = "República Federal de Somalia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Somalia";
          const expectedFullName = "Förbundsrepubliken Somalia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Somali";
          const expectedFullName = "Somali Federal Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "صومالیہ";
          const expectedFullName = "وفاقی جمہوریہ صومالیہ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "索马里";
          const expectedFullName = "索马里共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Somalia nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Somalia";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Soomáálii Bikéyah";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Somalia";
