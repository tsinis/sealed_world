...
void main() => group(
      "$CountryIrn() L10N",
      () {
        const value = CountryIrn();

        test("has translation for 'en' locale", () {
          const expectedName = "Iran";
          const expectedFullName = "Islamic Republic of Iran";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Иран";
          const expectedFullName = "Исламска Република Иран";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "إيران";
          const expectedFullName = "جمهورية إيران الإسلامية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Iran";
          const expectedFullName = "Republik Islamek Iran";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Írán";
          const expectedFullName = "Islámská republika Írán";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Iran";
          const expectedFullName = "Islamische Republik Iran";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Iraan";
          const expectedFullName = "Iraani Islamivabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Iran";
          const expectedFullName = "Iranin islamilainen tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "ایران";
          const expectedFullName = "جمهوری اسلامی ایران";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Iran";
          const expectedFullName = "République islamique d'Iran";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Iran";
          const expectedFullName = "Islamska Republika Iran";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Irán";
          const expectedFullName = "Iráni Iszlám Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Iran";
          const expectedFullName = "Repubblica islamica dell'Iran";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "イラン・イスラム共和国";
          const expectedFullName = "イラン·イスラム共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "이란";
          const expectedFullName = "이란 이슬람 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Iran";
          const expectedFullName = "Islamitische Republiek Iran";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Iran";
          const expectedFullName = "Islamska Republika Iranu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Irão";
          const expectedFullName = "República Islâmica do Irã";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Иран";
          const expectedFullName = "Исламская Республика Иран";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Irán";
          const expectedFullName = "Iránska islamská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Iran";
          const expectedFullName = "República Islámica de Irán";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Iran";
          const expectedFullName = "Islamiska republiken Iran";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "İran";
          const expectedFullName = "İran İslam Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "ایران";
          const expectedFullName = "جمہوریہ ایران";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "伊朗";
          const expectedFullName = "伊朗伊斯兰共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "ГӀажарийчоь";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Iran nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Irani";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Irani";
