...
void main() => group(
      "$CountryMhl() L10N",
      () {
        const value = CountryMhl();

        test("has translation for 'en' locale", () {
          const expectedName = "Marshall Islands";
          const expectedFullName = "Republic of the Marshall Islands";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Маршалска Острва";
          const expectedFullName = "Република Маршалска Острва";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "جزر مارشال";
          const expectedFullName = "جمهورية جزر مارشال";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Inizi Marshall";
          const expectedFullName = "Republik Inizi Marshall";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Marshallovy ostrovy";
          const expectedFullName = "Republika Marshallovy ostrovy";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Marshallinseln";
          const expectedFullName = "Republik Marshallinseln";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Marshalli Saared";
          const expectedFullName = "Marshalli Saarte Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Marshallinsaaret";
          const expectedFullName = "Marshallinsaarten tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Îles Marshall";
          const expectedFullName = "République des Îles Marshall";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Maršalovi Otoci";
          const expectedFullName = "Republika Maršalovi Otoci";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Marshall-szigetek";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Isole Marshall";
          const expectedFullName = "Repubblica delle Isole Marshall";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "マーシャル諸島";
          const expectedFullName = "マーシャル諸島共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "마셜 제도";
          const expectedFullName = "마셜 제도 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Marshalleilanden";
          const expectedFullName = "Republiek van de Marshall-eilanden";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "جزایر مارشال";
          const expectedFullName = "جمهوری جزایر مارشال";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Wyspy Marshalla";
          const expectedFullName = "Republika Wysp Marshalla";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Ilhas Marshall";
          const expectedFullName = "República das Ilhas Marshall";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Маршалловы Острова";
          const expectedFullName = "Республика Маршалловы острова";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Marshallove ostrovy";
          const expectedFullName = "Republika Marshallových ostrovov";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Islas Marshall";
          const expectedFullName = "República de las Islas Marshall";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Marshallöarna";
          const expectedFullName = "Republiken Marshallöarna";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Marshall Adaları";
          const expectedFullName = "Marshall Adaları Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "جزائر مارشل";
          const expectedFullName = "جمہوریہ جزائر مارشل";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "马绍尔群岛";
          const expectedFullName = "马绍尔群岛共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Marshalleilande";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "মাৰ্শ্বাল দ্বীপপুঞ্জ";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Marşal adaları";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Маршалавы астравы";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Маршалови острови";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Marisali Gun";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "মার্শাল দ্বীপপুঞ্জ";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Maršalova ostrva";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "Illes Marshall";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Маршаллан гӀайренаш";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "Marshalløerne";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "མར་ཤེལ་གླིང་ཚོམ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Marshal ƒudomekpowo nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Νήσοι Μάρσαλ";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Marshall Uharteak";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Duuɗe Marsaal";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Marshalloyggjar";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Marshalleilannen";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Oileáin Marshall";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Eileanan Mharshall";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Illas Marshall";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "માર્શલ આઇલેન્ડ્સ";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Tsibiran Marshal";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "मार्शल द्वीपसमूह";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Մարշալյան կղզիներ";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Insulas Marshall";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Kepulauan Marshall";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Agwaetiti Marshall";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Marshalleyjar";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Kapuloan Marshall";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "მარშალის კუნძულები";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Visiwa vya Marshal";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Маршалл аралдары";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "កោះ​ម៉ាស់សល";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಮಾರ್ಷಲ್ ದ್ವೀಪಗಳು";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "مارشَل جٔزیٖرٕ";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Giravên Marşal";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Marshallinselen";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Bizinga bya Mariso";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Bisanga bya Marishalɛ";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ຫມູ່ເກາະມາແຊວ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Maršalo Salos";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Lutanda lua Marishale";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Māršala salas";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Nosy Marshall";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Маршалски Острови";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "മാർഷൽ ദ്വീപുകൾ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Маршаллын арлууд";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "मार्शल बेटे";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "Gżejjer Marshall";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "မာရှယ် ကျွန်းစု";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "Marshalløyene";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "मार्शल टापुहरु";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "Marshalløyane";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ମାର୍ଶାଲ୍ ଦ୍ୱୀପପୁଞ୍ଜ";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਮਾਰਸ਼ਲ ਟਾਪੂ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "مارشل ټاپوګان";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "Inslas da Marshall";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Izinga rya Marishari";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Insulele Marshall";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Marshallsullot";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Âzûâ Märshâl";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "මාෂල් දූපත්";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "Marshallovi otoki";
        ...
        test("has translation for 'sn' locale", () {
          const expectedName = "Zvitsuwa zveMarshall";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Jasiiradda Maarshal";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Ishujt Marshall";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Visiwa vya Marshall";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "மார்ஷல் தீவுகள்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "మార్షల్ దీవులు";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Ҷазираҳои Маршалл";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "หมู่เกาะมาร์แชลล์";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Marşall adalary";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "ʻOtumotu Māsolo";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Маршалл утраулары";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "مارشال ئاراللىرى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Маршаллові Острови";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Marshall orollari";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Quần đảo Marshall";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Duni Marsaal";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "מאַרשאַל אינזלען";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Etikun Máṣali";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Marshall Islands";
        ...
        test("has translation for 'io' locale", () {
          const expectedName = "Insuli Marshall";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Insulae Marsalienses";
        ...
        test("has translation for 'li' locale", () {
          const expectedName = "Marshall-eilen";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Маршаллов утравӗсем";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Ngā Motu Māhara";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Ìsulas Marshall";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "EMarshall Islands";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Маршаллтәи Адгьылбжьахақәа";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "མཱར་ཤལ་གླིང་ཕྲེན།";
        ...
        test("has translation for 'ie' locale", () {
          const expectedName = "Insules Marshall";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Kapuluang Marshall";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Маршал адалары";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Маршал ороллари";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Etikun Máshali";
