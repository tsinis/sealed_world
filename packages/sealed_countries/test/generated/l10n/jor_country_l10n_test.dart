...
void main() => group(
      "$CountryJor() L10N",
      () {
        const value = CountryJor();

        test("has translation for 'en' locale", () {
          const expectedName = "Jordan";
          const expectedFullName = "Hashemite Kingdom of Jordan";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Јордан";
          const expectedFullName = "Хашемитска Краљевина Јордан";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "الأردن";
          const expectedFullName = "المملكة الأردنية الهاشمية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Jordania";
          const expectedFullName = "Rouantelezh hachemit Jordania";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Jordánsko";
          const expectedFullName = "Jordánské hášimovské království";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Jordanien";
          const expectedFullName = "Haschemitisches Königreich Jordanien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Jordaania";
          const expectedFullName = "Jordaania Hašimiidi Kuningriik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Jordania";
          const expectedFullName = "Jordanian hašemiittinen kunigaskunta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Jordanie";
          const expectedFullName = "Royaume hachémite de Jordanie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Jordan";
          const expectedFullName = "Hašemitske Kraljevine Jordan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Giordania";
          const expectedFullName = "Regno hascemita di Giordania";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ヨルダン";
          const expectedFullName = "ヨルダン·ハシミテ王国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "요르단";
          const expectedFullName = "요르단 하심 왕국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Jordanië";
          const expectedFullName = "Hasjemitisch Koninkrijk Jordanië";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "اردن";
          const expectedFullName = "پادشاهی اُردُن هاشمی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Jordania";
          const expectedFullName = "Jordańskie Królestwo Haszymidzkie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Jordânia";
          const expectedFullName = "Reino Hachemita da Jordânia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Иордания";
          const expectedFullName = "Иорданского Хашимитского Королевства";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Jordánsko";
          const expectedFullName = "Jordánske hášimovské kráľovstvo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Jordania";
          const expectedFullName = "Reino Hachemita de Jordania";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Jordanien";
          const expectedFullName = "Hashimitiska kungadömet Jordanien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Ürdün";
          const expectedFullName = "Ürdün Hâşimi Krallığı";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "اردن";
          const expectedFullName = "ھاشمی مملکتِ اردن";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "约旦";
          const expectedFullName = "约旦哈希姆王国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Yordan nutome";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ئىيوردانىيە";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Jọdani";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Jɔdani";
