...
void main() => group(
      "$CountryCym() L10N",
      () {
        const value = CountryCym();

        test("has translation for 'en' locale", () {
          const expectedName = "Cayman Islands";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Кајманска Острва";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Inizi Cayman";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Kajmanské ostrovy";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Ynysoedd Cayman";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Kaimaninseln";
          const expectedFullName = "Cayman-Inseln";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Kaimanisaared";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Caymansaaret";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Îles Caïmans";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Kajmanski otoci";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Kajmán-szigetek";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Isole Cayman";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Caymaneilanden";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Ilhas Caimão";
          const expectedFullName = "Ilhas Cayman";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Каймановы острова";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Kajmanie ostrovy";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Islas Caimán";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Caymanöarna";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Cayman Adaları";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "جزائر کیمین";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Kaaimanseilande";
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Kemanfo Islands";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "কেইমেন দ্বীপপুঞ্জ";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Kayman adaları";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Кайманавы астравы";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Кайманови острови";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "কেম্যান দ্বীপপুঞ্জ";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Kajmanska ostrva";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "Illes Caiman";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Кайман гӀайренаш";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "Caymanøerne";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཁེ་མེན་གླིང་ཚོམ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Kayman ƒudomekpowo nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Νήσοι Κέιμαν";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Kaiman uharteak";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Duuɗe Kaymaa";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Caymanoyggjar";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Caymaneilannen";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Oileáin Cayman";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Na h-Eileanan Caimean";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Illas Caimán";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "કેમેન આઇલેન્ડ્સ";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Tsibiran Kaiman";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "कैमेन द्वीपसमूह";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Կայմանյան կղզիներ";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Insulas de Caiman";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Kepulauan Cayman";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Agwaetiti Cayman";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Caymaneyjar";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Kapuloan Kéman";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "კაიმანის კუნძულები";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Visiwa vya Kayman";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Кайман аралдары";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಕೇಮನ್ ದ್ವೀಪಗಳು";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "کیمَن جٔزیٖرٕ";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Giravên Kaymanê";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Kaimaninselen";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Bizinga ebya Kayimaani";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Bisanga bya Kayíma";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ໝູ່ເກາະ ເຄແມນ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Kaimanų Salos";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Lutanda lua Kayima";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Kaimanu salas";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Nosy Kayman";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Кајмански Острови";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "കേയ്മാൻ ദ്വീപുകൾ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Кайманы арлууд";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Gżejjer Cayman";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ကေမန် ကျွန်းစု";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "Caymanøyene";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "केयमान टापु";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "Caymanøyane";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "କେମ୍ୟାନ୍‌ ଦ୍ୱୀପପୁଞ୍ଜ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "کیمان ټاپوګان";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "Inslas Cayman";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Ibirwa bya Keyimani";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Insulele Cayman";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Cayman-sullot";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Âzûâ Ngundë";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "කේමන් දූපත්";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "Kajmanski otoki";
        ...
        test("has translation for 'sn' locale", () {
          const expectedName = "Zvitsuwa zveCayman";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Ishujt Kajman";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Visiwa vya Cayman";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "கெய்மென் தீவுகள்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "కేమాన్ దీవులు";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Ҷазираҳои Кайман";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "หมู่เกาะเคย์แมน";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Kaýman adalary";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "ʻOtumotu Keimeni";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Кайман утраулары";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "كايمان ئاراللىرى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Кайманові Острови";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Kayman orollari";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Quần đảo Cayman";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Duni Kaymaŋ";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "קיימאַן אינזלען";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Etíokun Kámánì";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Cayman Islands";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ཁེ་མེན་གླིང་ཕྲན།";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Ellanyn Cayman";
        ...
        test("has translation for 'io' locale", () {
          const expectedName = "Insuli Kaiman";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Кайман утравӗсем";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Ngā Motu Keimana";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Ìsulas Cayman";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "ECayman Islands";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Адгьылбжьахақәа Каиман";
        ...
        test("has translation for 'ie' locale", () {
          const expectedName = "Insules Cayman";
        ...
        test("has translation for 'kl' locale", () {
          const expectedName = "Cayman qeqertaq";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Insulae Caimanenses";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Islas Caiman";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Кајман адалары";
        ...
        test("has translation for 'sw_KE' locale", () {
          const expectedName = "Visiwa vya Kaimani";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Кайман ороллари";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Etíokun Kámánì";
