...
void main() => group(
      "$CountryMyt() L10N",
      () {
        const value = CountryMyt();

        test("has translation for 'en' locale", () {
          const expectedName = "Mayotte";
          const expectedFullName = "Department of Mayotte";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Mayotte";
          const expectedFullName = "Departamant Mayotte";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Mayotte";
          const expectedFullName = "Übersee-Département Mayotte";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Mayotte";
          const expectedFullName = "Département de Mayotte";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Mayotte";
          const expectedFullName = "Odjel Mayotte";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Mayotte";
          const expectedFullName = "Dipartimento di Mayotte";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "マヨット";
          const expectedFullName = "マヨット科";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Mayotte";
          const expectedFullName = "Afdeling Mayotte";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "مایوت";
          const expectedFullName = "مجموعه شهرستانی مایوت";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Mayotte";
          const expectedFullName = "Departamento de Mayotte";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Майотта";
          const expectedFullName = "Департамент Майотта";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Mayotte";
          const expectedFullName = "Department Mayotte";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Mayotte";
          const expectedFullName = "Departementsområdet Mayotte";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Mayotte nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Mayote";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Mayote";
