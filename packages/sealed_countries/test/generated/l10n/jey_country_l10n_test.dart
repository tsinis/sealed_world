...
void main() => group(
      "$CountryJey() L10N",
      () {
        const value = CountryJey();

        test("has translation for 'en' locale", () {
          const expectedName = "Jersey";
          const expectedFullName = "Bailiwick of Jersey";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Jersey";
          const expectedFullName = "Rychtářství Jersey";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Jersey";
          const expectedFullName = "Vogtei Jersey";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Jersey";
          const expectedFullName = "Jersey foogtkond";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Jersey";
          const expectedFullName = "Bailliage de Jersey";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Jersey";
          const expectedFullName = "Struka od Jersey";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Isola di Jersey";
          const expectedFullName = "Baliato di Jersey";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ジャージー";
          const expectedFullName = "ジャージの得意分野";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Jersey";
          const expectedFullName = "Baljuwschap Jersey";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Jersey";
          const expectedFullName = "Bailiado de Jersey";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Джерси";
          const expectedFullName = "Коронное владение Джерси";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Jersey";
          const expectedFullName = "Bailiwick Jersey";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Jersey";
          const expectedFullName = "Bailía de Jersey";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Dzɛse nutome";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Illa de Jersey";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Caesarea Insula";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Insula Jersey";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Kasar Jersey";
