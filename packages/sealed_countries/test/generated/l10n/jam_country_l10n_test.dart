...
void main() => group(
      "$CountryJam() L10N",
      () {
        const value = CountryJam();

        test("has translation for 'en' locale", () {
          const expectedName = "Jamaica";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Dzamaika nutome";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ហ្សាម៉ាអ៊ីក";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Jamaika";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Yazmaijgyah";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Jamaika";
