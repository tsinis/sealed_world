...
void main() => group(
      "$CountryPcn() L10N",
      () {
        const value = CountryPcn();

        test("has translation for 'en' locale", () {
          const expectedName = "Pitcairn Islands";
          const expectedFullName = "Pitcairn Group of Islands";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Острва Питкерн";
          const expectedFullName = "Острва Питкерн, Хендерсон, Дуци и Оин";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "جزر بيتكيرن";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Inizi Pitcairn";
          const expectedFullName = "Inizi Pitcairn, Henderson, Ducie hag Oeno";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Pitcairnovy ostrovy";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Pitcairninseln";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Pitcairn";
          const expectedFullName = "Pitcairni, Hendersoni, Ducie ja Oeno saar";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Îles Pitcairn";
          const expectedFullName = "Groupe d'îles Pitcairn";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Pitcairnovo otočje";
          const expectedFullName = "Pitcairn skupine otoka";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Pitcairn-szigetek";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Isole Pitcairn";
          const expectedFullName = "Pitcairn gruppo di isole";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ピトケアン";
          const expectedFullName = "島のピトケアングループ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Pitcairneilanden";
          const expectedFullName = "Pitcairn groep eilanden";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "جزایر پیت‌کرن";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Pitcairn";
          const expectedFullName = "Wyspy Pitcairn, Henderson, Ducie i Oeno";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Ilhas Pitcairn";
          const expectedFullName = "Pitcairn grupo de ilhas";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Острова Питкэрн";
          const expectedFullName = "Питкэрн группа островов";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Pitcairnove ostrovy";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Islas Pitcairn";
          const expectedFullName = "Grupo de Islas Pitcairn";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Pitcairnöarna";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Pitcairn Adaları";
          const expectedFullName = "Pitcairn, Henderson, Ducie ve Oeno Adaları";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "جزائر پٹکیرن";
          const expectedFullName = "پٹکیرن جزائر";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Pitcairneilande";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "ፒትካኢርን አይስላንድ";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "পিটকেইৰ্ণ দ্বীপপুঞ্জ";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Pitkern adaları";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Астравы Піткэрн";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Острови Питкерн";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "পিটকেয়ার্ন দ্বীপপুঞ্জ";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Pitkernska Ostrva";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "Illes Pitcairn";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Питкэрн гӀайренаш";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "པིཊ་ཀེ་ཡེརན་གླིང་ཚོམ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Pitkairn ƒudomekpo nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Νήσοι Πίτκερν";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Pitkarna Insulo";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Pitcairn uharteak";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Pitcairnoyggjar";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Pitcairneilannen";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Oileáin Pitcairn";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Eileanan Pheit a’ Chàirn";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Illas Pitcairn";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "પીટકૈર્ન આઇલેન્ડ્સ";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "पिटकैर्न द्वीपसमूह";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Պիտկեռն կղզիներ";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Kepulauan Pitcairn";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Agwaetiti Pitcairn";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Pitcairn-eyjar";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Kapuloan Pitcairn";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "პიტკერნის კუნძულები";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Питкэрн аралдары";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಪಿಟ್‌ಕೈರ್ನ್ ದ್ವೀಪಗಳು";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "پِٹکیرٕنۍ جٔزیٖرٕ";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Giravên Pitcairn";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Pitcairninselen";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ໝູ່ເກາະພິດແຄນ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Pitkerno salos";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Pitkērnas salas";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Питкернски Острови";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "പിറ്റ്‌കെയ്‌ൻ ദ്വീപുകൾ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Питкэрн арлууд";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "पिटकैर्न बेटे";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "Gżejjer Pitcairn";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ပစ်တ်ကိန်းကျွန်းစု";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "Pitcairnøyene";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "पिटकाइर्न टापुहरु";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ପିଟକାଇରିନ୍‌ ଦ୍ୱୀପପୁଞ୍ଜ";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਪਿਟਕੇਰਨ ਟਾਪੂ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "پيټکيرن ټاپوګان";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Pitikeyirini";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Insulele Pitcairn";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "පිට්කෙය්න් දූපත්";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Ishujt Pitkern";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Visiwa vya Pitcairn";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "பிட்கெய்ர்ன் தீவுகள்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "పిట్‌కెయిర్న్ దీవులు";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Ҷазираҳои Питкейрн";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "หมู่เกาะพิตแคร์น";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Pitkern adalary";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "ʻOtumotu Pitikeni";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Питкэрн утраулары";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "پىتكايرن ئاراللىرى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Острови Піткерн";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Pitkern orollari";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Quần đảo Pitcairn";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Duni Pitkayirn";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "פּיטקערן אינזלען";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Pikarini";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Pitcairn Islands";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Pitcairn Insulae";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Питкэрн утравӗсем";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Insulas Pitcairn";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Ìsulas Pìtcairn";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "EPitcairn Islands";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Питкерн ад-хақәа";
        ...
        test("has translation for 'ie' locale", () {
          const expectedName = "Insules Pitcairn";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Iscla Pitcairn";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Питкерн адалары";
        ...
        test("has translation for 'ug_Arab' locale", () {
          const expectedName = "پىتكاير ئاراللىرى";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Питкэрн ороллари";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Pikarini";
