...
void main() => group(
      "$CountryWsm() L10N",
      () {
        const value = CountryWsm();

        test("has translation for 'en' locale", () {
          const expectedName = "Samoa";
          const expectedFullName = "Independent State of Samoa";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Самоа";
          const expectedFullName = "Независна Држава Самоа";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "ساموا";
          const expectedFullName = "دولة ساموا المستقلة";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Samoa";
          const expectedFullName = "Stad Dizalc'h Samoa";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Samoa";
          const expectedFullName = "Nezávislý stát Samoa";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Samoa";
          const expectedFullName = "Unabhängige Staat Samoa";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Samoa";
          const expectedFullName = "Samoa Iseseisvusriik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Samoa";
          const expectedFullName = "Samoan itsenäinen valtio";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Samoa";
          const expectedFullName = "Nezavisna Država Samoa";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          ...
          const expectedFullName = "Szamoai Független Állam";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Samoa";
          const expectedFullName = "Stato indipendente di Samoa";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "サモア";
          const expectedFullName = "サモア独立国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "사모아";
          const expectedFullName = "사모아 독립국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Samoa";
          const expectedFullName = "Onafhankelijke Staat Samoa";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "ساموآ";
          const expectedFullName = "ایالت مستقل ساموآ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Samoa";
          const expectedFullName = "Niezależne Państwo Samoa";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Samoa";
          const expectedFullName = "Estado Independente de Samoa";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Самоа";
          const expectedFullName = "Независимое Государство Самоа";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Samoa";
          const expectedFullName = "Nezávislý štátSamoa";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Samoa";
          const expectedFullName = "Estado Independiente de Samoa";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Samoa";
          const expectedFullName = "Självständiga staten Samoa";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Bağımsız Samoa Devleti";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "سامووا";
          const expectedFullName = "آزاد سلطنتِ ساموا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "萨摩亚";
          const expectedFullName = "萨摩亚独立国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Samoa nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Samọ";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ནུ་བ་ས་མོ་འ།";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Samɔ";
