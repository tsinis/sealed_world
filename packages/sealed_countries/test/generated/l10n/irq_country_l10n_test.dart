...
void main() => group(
      "$CountryIrq() L10N",
      () {
        const value = CountryIrq();

        test("has translation for 'en' locale", () {
          const expectedName = "Iraq";
          const expectedFullName = "Republic of Iraq";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Ирак";
          const expectedFullName = "Република Ирак";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "العراق";
          const expectedFullName = "جمهورية العراق";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Irak";
          const expectedFullName = "Republik Irak";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Irák";
          const expectedFullName = "Irácká republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Iraak";
          const expectedFullName = "Iraagi Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Irak";
          const expectedFullName = "Irakin tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Irak";
          const expectedFullName = "République d'Irak";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Irak";
          const expectedFullName = "Republika Irak";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Irak";
          const expectedFullName = "Iraki Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Iraq";
          const expectedFullName = "Repubblica dell'Iraq";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "イラク";
          const expectedFullName = "イラク共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "이라크";
          const expectedFullName = "이라크 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Irak";
          const expectedFullName = "Republiek Irak";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "عراق";
          const expectedFullName = "جمهوری عراق";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Irak";
          const expectedFullName = "Republika Iraku";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Iraque";
          const expectedFullName = "República do Iraque";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Ирак";
          const expectedFullName = "Республика Ирак";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Irak";
          const expectedFullName = "Iracká republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Irak";
          const expectedFullName = "República de Irak";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Irak";
          const expectedFullName = "Republiken Irak";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Irak";
          const expectedFullName = "Irak Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "عراق";
          const expectedFullName = "جمہوریہ عراق";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "伊拉克";
          const expectedFullName = "伊拉克共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Iraki";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Iraq - العراق";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Iraki";
