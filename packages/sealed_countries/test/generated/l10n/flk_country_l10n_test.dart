...
void main() => group(
      "$CountryFlk() L10N",
      () {
        const value = CountryFlk();

        test("has translation for 'en' locale", () {
          const expectedName = "Falkland Islands";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Фолкланди";
          const expectedFullName = "Фолкландска Острва";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "جزر فوكلاند";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Inizi Maloù";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Falklandy";
          const expectedFullName = "Falklandské ostrovy";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Falklandinseln";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Falklandi saared";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Falkandinsaaret";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Îles Malouines";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Falklandski Otoci";
          const expectedFullName = "Falklandski otoci";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Falkland-szigetek";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Isole Falkland o Isole Malvine";
          const expectedFullName = "Isole Falkland";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "フォークランド（マルビナス）諸島";
          const expectedFullName = "フォークランド";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Falklandeilanden";
          const expectedFullName = "Falkland eilanden";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "جزایر فالکلند";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Ilhas Malvinas";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Фолклендские острова";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Islas Malvinas";
          const expectedFullName = "islas Malvinas";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Falklandsöarna";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Falkland (Malvina) Adaları";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "جزائر فاکلینڈ";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Falklandeilande";
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Fɔlkman Aeland";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የፎክላንድ ደሴቶች";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "ফকলেণ্ড দ্বীপপুঞ্জ";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Folklend adaları";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Фалклендскія астравы";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Фолкландски острови";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Maluwini Gun";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "ফকল্যান্ড দ্বীপপুঞ্জ";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Folklandska ostrva";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "Illes Malvines";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Фолклендан гӀайренаш";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "Falklandsøerne";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཕལྐ་ལནྜ་གླིང་ཚོམ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Falkland ƒudomekpowo nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Νήσοι Φόκλαντ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Duuɗe Falkland";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Falklandsoyggjar";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Falklâneilannen";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Oileáin Fháclainne";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Na h-Eileanan Fàclannach";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Illas Malvinas";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "ફૉકલેન્ડ આઇલેન્ડ્સ";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Tsibiran Falkilan";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "फ़ॉकलैंड द्वीपसमूह";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Ֆոլքլենդյան կղզիներ";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Kepulauan Falkland";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Agwaetiti Falkland";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Falklandseyjar";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Kapuloan Falkland";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ფოლკლენდის კუნძულები";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Visiwa vya Falkland";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Фолкленд аралдары";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "កោះ​ហ្វក់ឡែន";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಫಾಕ್‌ಲ್ಯಾಂಡ್ ದ್ವೀಪಗಳು";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "فٕلاکلینڑ جٔزیٖرٕ";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Giravên Malvîn";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Falklandinselen";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Bizinga by’eFalikalandi";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Bisanga bya Maluni";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ຫມູ່ເກາະຟອກແລນ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Folklando Salos";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Lutanda lua Maluni";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Folklenda salas";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Nosy Falkand";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ഫാക്ക്‌ലാന്റ് ദ്വീപുകൾ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Фолклендийн арлууд";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "फॉकलंड बेटे";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Gżejjer Falkland";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဖော့ကလန် ကျွန်းစု";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "Falklandsøyene";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "फकल्याण्ड टापुहरु";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "Falklandsøyane";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଫକ୍‌ଲ୍ୟାଣ୍ଡ ଦ୍ଵୀପପୁଞ୍ଜ";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਫ਼ਾਕਲੈਂਡ ਟਾਪੂ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "فاکلينډ ټاپوګان";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "Inslas dal Falkland";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Izinga rya Filikilandi";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Insulele Falkland";
        ...
        test("has translation for 'sd' locale", () {
          const expectedName = "فاڪ لينڊ ٻيٽ";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Falklandsullot";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Âzûâ tî Mälüîni";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ෆෝක්ලන්ත දූපත්";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "Falklandski otoki";
        ...
        test("has translation for 'sn' locale", () {
          const expectedName = "Zvitsuwa zveFalklands";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Jaziiradaha Fooklaan";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Ishujt Falkland";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "ஃபாக்லாந்து தீவுகள்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "ఫాక్‌ల్యాండ్ దీవులు";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Ҷазираҳои Фолкленд";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "หมู่เกาะฟอล์กแลนด์";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Folklend adalary";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "ʻOtumotu Fokulani";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Фолкленд утраулары";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "فالكلاند ئاراللىرى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Фолклендські Острови";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Folklend orollari";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Quần đảo Falkland";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Duni Falkland";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "פֿאַלקלאַנד אינזלען";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Etikun Fakalandi";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Falkland Islands";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ཕལྐ་ལནྜ་གླིང་ཕྲན།";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Ny Malveenaghyn";
        ...
        test("has translation for 'kl' locale", () {
          const expectedName = "Falklandi qeqertaq";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Insulae Malvinae";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Kapuluang Falkland (Kapuluang Malvinas)";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Фолкленд утравӗсем";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Insulas Falkland";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Motu Whākarangi";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Ìsulas Falkland";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "EFalkland Islands";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Фолклендтәи ад-хақәа";
        ...
        test("has translation for 'ie' locale", () {
          const expectedName = "Insules Falkland";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Isclas Falkland";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Фолкленд адалары";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Фокландска Острва";
        ...
        test("has translation for 'ks_Arab' locale", () {
          const expectedName = "فٕلاکلینٛڑ جٔزیٖرٕ";
        ...
        test("has translation for 'ky_Cyrl' locale", () {
          const expectedName = "Фолклэнд аралдары";
        ...
        test("has translation for 'mn_Cyrl' locale", () {
          const expectedName = "Фолькландын Арлууд";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Фолкленд ороллари";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Etikun Fakalandi";
