...
void main() => group(
      "$CountryTjk() L10N",
      () {
        const value = CountryTjk();

        test("has translation for 'en' locale", () {
          const expectedName = "Tajikistan";
          const expectedFullName = "Republic of Tajikistan";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Таџикистан";
          const expectedFullName = "Република Таџикистан";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "طاجيكستان";
          const expectedFullName = "جمهورية طاجيكستان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Tadjikistan";
          const expectedFullName = "Republik Tadjikistan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Tádžikistán";
          const expectedFullName = "Republika Tádžikistán";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Tadschikistan";
          const expectedFullName = "Republik Tadschikistan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Tadžikistan";
          const expectedFullName = "Tadžikistani Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Tadžikistan";
          const expectedFullName = "Tadžikistanin tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Tadjikistan";
          const expectedFullName = "République du Tadjikistan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Tađikistan";
          const expectedFullName = "Republika Tadžikistan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Tagikistan";
          const expectedFullName = "Repubblica del Tajikistan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "タジキスタン";
          const expectedFullName = "タジキスタン共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "타지키스탄";
          const expectedFullName = "타지키스탄 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Tadzjikistan";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "تاجیکِستان";
          const expectedFullName = "جمهوری تاجیکستان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Tadżykistan";
          const expectedFullName = "Republika Tadżykistanu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Tajiquistão";
          const expectedFullName = "República do Tajiquistão";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Таджикистан";
          const expectedFullName = "Республика Таджикистан";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Taǆikistan";
          const expectedFullName = "Taǆická republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Tayikistán";
          const expectedFullName = "República de Tayikistán";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Tadzjikistan";
          const expectedFullName = "Republiken Tadzjikistan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Tacikistan";
          const expectedFullName = "Tacikistan Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "تاجکستان";
          const expectedFullName = "جمہوریہ تاجکستان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "塔吉克斯坦";
          const expectedFullName = "塔吉克斯坦共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "তাজিকিস্তান";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Таджыкістан";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Tajikisitani";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "Tadsjikistan";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཏ་ཇིག་གི་སཏཱན";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Tajikistan nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Τατζικιστάν";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Tajikistaan";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Táidsíceastáin";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Taidigeastàn";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Taxiquistán";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "તાજીકિસ્તાન";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "ताज़िकिस्तान";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Tadzhikistan";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Tajikistani";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "តាហ្ស៊ីគីស្ថាន";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ತಜಿಕಿಸ್ತಾನ್";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Tajikisitaani";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ທາຈິກິດສະຖານ";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Tadžikistāna";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "താജിക്കിസ്ഥാൻ";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "ताजिकिस्तान";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "it-Taġikistan";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "တာဂျီကစ္စတန်";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ତାଜିକିସ୍ଥାନ୍";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Taazikiistäan";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ටජිකිස්තානය";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Taxhikistan";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "தஜிகிஸ்தான்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "తజికిస్తాన్";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Takisitani";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Tajikistan";
        ...
        test("has translation for 'an' locale", () {
          const expectedName = "Tachiquistán";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ཐ་ཇི་ཁེ་སི་ཏན།";
        ...
        test("has translation for 'cu' locale", () {
          const expectedName = "Таджикистанъ";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "ތަޖިކިސްތާން";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Tajikistaan";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Tadzikistania";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Tʼajiʼ Bikéyah";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Tatgiquistan";
        ...
        test("has translation for 'sa' locale", () {
          const expectedName = "ताजिकिस्थान";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "טאדזשיקיסטאן";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Takiritānga";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "ETajikistan";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Dazgizgwzswhdanj";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Takisitani";
