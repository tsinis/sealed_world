...
void main() => group(
      "$CountryChl() L10N",
      () {
        const value = CountryChl();

        test("has translation for 'en' locale", () {
          const expectedName = "Chile";
          const expectedFullName = "Republic of Chile";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Чиле";
          const expectedFullName = "Република Чиле";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "تشيلي";
          const expectedFullName = "جمهورية تشيلي";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Chile";
          const expectedFullName = "Republik Chile";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Chile";
          const expectedFullName = "Chilská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Chile";
          const expectedFullName = "Gweriniaeth Chile";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Tšiili";
          const expectedFullName = "Tšiili Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Chile";
          const expectedFullName = "Chilen tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Chili";
          const expectedFullName = "République du Chili";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Čile";
          const expectedFullName = "Republika Čile";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Chile";
          const expectedFullName = "Chilei Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Cile";
          const expectedFullName = "Repubblica del Cile";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "チリ";
          const expectedFullName = "チリ共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "칠레";
          const expectedFullName = "칠레 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Chili";
          const expectedFullName = "Republiek Chili";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "شیلی";
          const expectedFullName = "جمهوری شیلی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Chile";
          const expectedFullName = "Republika Chile";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Chile";
          const expectedFullName = "República do Chile";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Чили";
          const expectedFullName = "Республика Чили";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Čile";
          const expectedFullName = "Čílska republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Chile";
          const expectedFullName = "República de Chile";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Chile";
          const expectedFullName = "Republiken Chile";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Şili";
          const expectedFullName = "Şili Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "چلی";
          const expectedFullName = "جمہوریہ چلی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "智利";
          const expectedFullName = "智利共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Tsile nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède ṣílè";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède shílè";
