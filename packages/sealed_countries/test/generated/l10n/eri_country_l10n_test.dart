...
void main() => group(
      "$CountryEri() L10N",
      () {
        const value = CountryEri();

        test("has translation for 'en' locale", () {
          const expectedName = "Eritrea";
          const expectedFullName = "State of Eritrea";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Еритреја";
          const expectedFullName = "Држава Еритреја";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "إريتريا";
          const expectedFullName = "دولة إريتريا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Eritrea";
          const expectedFullName = "Stad Eritrea";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Eritrea";
          const expectedFullName = "Stát Eritrea";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Eritrea";
          const expectedFullName = "Gwladwriaeth Eritrea";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Eritrea";
          const expectedFullName = "Staat Eritrea";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Eritrea";
          const expectedFullName = "Eritrea Riik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Eritrea";
          const expectedFullName = "Eritrean valtio";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Érythrée";
          const expectedFullName = "État d'Érythrée";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Eritreja";
          const expectedFullName = "Država Eritreji";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Eritrea";
          const expectedFullName = "Stato di Eritrea";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "エリトリア";
          const expectedFullName = "エリトリア国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "에리트레아";
          const expectedFullName = "에리트레아국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "اریتره";
          const expectedFullName = "جمهوری اریتره";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Erytrea";
          const expectedFullName = "Państwo Erytrea";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Eritreia";
          const expectedFullName = "Estado da Eritreia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Эритрея";
          const expectedFullName = "Государство Эритрея";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Eritrea";
          const expectedFullName = "Eritrejský štát";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Eritrea";
          const expectedFullName = "Estado de Eritrea";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Eritrea";
          const expectedFullName = "Staten Eritrea";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Eritre";
          const expectedFullName = "Eritre Devleti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "ارتریا";
          const expectedFullName = "ریاستِ ارتریا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཨེ་རི་ཊྲེ་ཡ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Eritrea nutome";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "အီရီထရီးယား";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "එරිත්‍රියාව";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Eritira";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Eritira";
