...
void main() => group(
      "$CountryHkg() L10N",
      () {
        const value = CountryHkg();

        test("has translation for 'en' locale", () {
          const expectedName = "Hong Kong";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Hongkong";
          const expectedFullName = "Hongkongi erihalduspiirkond";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Hongkong";
          const expectedFullName = "Hong Kongin erityishallintoalue";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "香港";
          const expectedFullName = "中華人民共和国香港特別行政区";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "홍콩";
          const expectedFullName = "중화인민공화국 홍콩 특별행정구";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "香港";
          const expectedFullName = "中华人民共和国香港特别行政区";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Hongkong SAS Sjina";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "ሆንግ ኮንግ ልዩ የአስተዳደር ክልል ቻይና";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "হং কং এছ. এ. আৰ. চীন";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Honq Konq Xüsusi İnzibati Rayonu Çin";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Ганконг, САР (Кітай)";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Хонконг, САР на Китай";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "হংকং এসএআর চীনা";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Hong Kong (SAR Kina)";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "Hong Kong (RAE Xina)";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Гонконг (ша-къаьстина кӀошт)";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "SAR Hongkong";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཧོང་ཀོང་ཅཱའི་ན";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Hɔng Kɔng SAR Tsaina nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Χονγκ Κονγκ ΕΔΠ Κίνας";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Hong Kong Txinako AEB";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Hongkong SAR van Sina";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "S.R.R. na Síne Hong Cong";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Hong Kong SAR na Sìne";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Hong Kong RAE da China";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "હોંગકોંગ SAR ચીન";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "הונג קונג (אזור מנהלי מיוחד של סין)";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "हाँग काँग (चीन विशेष प्रशासनिक क्षेत्र)";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Հոնկոնգի ՀՎՇ";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Hong Kong DAK Tiongkok";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "sérstjórnarsvæðið Hong Kong";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Laladan Administratif Astamiwa Hong Kong";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಹಾಂಗ್ ಕಾಂಗ್ SAR ಚೈನಾ";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "ہانگ کانگ ایس اے آر چیٖن";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Гонконг Кытай ААА";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Spezialverwaltungszon Hong Kong";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ຮົງກົງ ເຂດປົກຄອງພິເສດ ຈີນ";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Ķīnas īpašās pārvaldes apgabals Honkonga";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Хонг Конг С.А.Р Кина";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ഹോങ്കോങ് (SAR) ചൈന";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "БНХАУ-ын Тусгай захиргааны бүс Хонг Конг";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "हाँगकाँग एसएआर चीन";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဟောင်ကောင် (တရုတ်ပြည်)";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "Hongkong S.A.R. Kina";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "हङकङ चिनियाँ विशेष प्रशासनिक क्षेत्र";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ହଂ କଂ ଏସଏଆର୍‌ ଚାଇନା";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਹਾਂਗ ਕਾਂਗ ਐਸਏਆਰ ਚੀਨ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "هانګ کانګ SAR چین";
        ...
        test("has translation for 'qu' locale", () {
          const expectedName = "Hong Kong (RAE)";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "R.A.S. Hong Kong a Chinei";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "හොංකොං චීන විශේෂ පරිපාලන කලාපය";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "RPA i Hong-Kongut";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "ஹாங்காங் எஸ்ஏஆர் சீனா";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "హాంకాంగ్ ఎస్ఏఆర్ చైనా";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Ҳонконг (МММ)";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "เขตปกครองพิเศษฮ่องกงแห่งสาธารณรัฐประชาชนจีน";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Gonkong AAS Hytaý";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Hongi Kongi SAR Siaina";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Гонконг Махсус Идарәле Төбәге";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "شياڭگاڭ ئالاھىدە مەمۇرىي رايونى (جۇڭگو)";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Гонконг, О.А.Р. Китаю";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Gonkong (Xitoy MMH)";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Hồng Kông, Trung Quốc";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Hong Kong SAR China";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Гонконг (САР)";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤖𞤂𞤀 𞤕𞤢𞤴𞤲𞤢 𞤫 𞤖𞤮𞤲𞤺 𞤑𞤮𞤲𞤺";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Babban Yankin Mulkin Hong Kong na Ƙasar Sin";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Hongkong, R.A.S. de China";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Hong Kong SAR China";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Hong Konga HîT ya Çînê";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Hongipua Haina";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "RAS tzinesa de Hong Kong";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "EHong Kong SAR China";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Agbègbè Ìṣàkóso Ìṣúná Hong Kong Tí Ṣánà Ń Darí";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Һонк Конг Хүсуси Инзибати Әрази Чин";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Хонг Конг С. А. Р.";
        ...
        test("has translation for 'kk_Cyrl' locale", () {
          const expectedName =
              "Қытай Халық Республикасының Гонг-Конг арнайы әкімшілік ауданы";
        ...
        test("has translation for 'ks_Arab' locale", () {
          const expectedName = "ہانٛگ کانٛگ ایس اے آر چیٖن";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Гонконг (Хитой ММҲ)";
