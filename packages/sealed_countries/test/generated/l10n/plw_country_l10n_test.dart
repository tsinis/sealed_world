...
void main() => group(
      "$CountryPlw() L10N",
      () {
        const value = CountryPlw();

        test("has translation for 'en' locale", () {
          const expectedName = "Palau";
          const expectedFullName = "Republic of Palau";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Палау";
          const expectedFullName = "Република Палау";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "بالاو";
          const expectedFullName = "جمهورية بالاو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Palau";
          const expectedFullName = "Republik Palau";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Palau";
          const expectedFullName = "Republika Palau";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Belau";
          const expectedFullName = "Belau Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Palau";
          const expectedFullName = "Palaun tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Palaos (Palau)";
          const expectedFullName = "République des Palaos (Palau)";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Palau";
          const expectedFullName = "Palaui Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Palau";
          const expectedFullName = "Repubblica di Palau";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "パラオ";
          const expectedFullName = "パラオ共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "팔라우";
          const expectedFullName = "팔라우 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Palau";
          const expectedFullName = "Republiek van Palau";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "پالائو";
          const expectedFullName = "جمهوری پالائو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Palau";
          const expectedFullName = "República de Palau";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Палау";
          const expectedFullName = "Республика Палау";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Palau";
          const expectedFullName = "Palauská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Palau";
          const expectedFullName = "Republiken Palau";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Palau";
          const expectedFullName = "Palau Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "پلاؤ";
          const expectedFullName = "جمہوریہ پلاؤ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "帕劳";
          const expectedFullName = "帕劳共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Palau nutome";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Oileáin Palau";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Paalu";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Paalu";
