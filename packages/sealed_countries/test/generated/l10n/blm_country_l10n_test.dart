...
void main() => group(
      "$CountryBlm() L10N",
      () {
        const value = CountryBlm();

        test("has translation for 'en' locale", () {
          const expectedName = "Saint Barthélemy";
          const expectedFullName = "Collectivity of Saint Barthélemy";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Сен Бартелеми";
          const expectedFullName = "Територијални Kолектив Сен Бартелеми";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "سان بارتليمي";
          const expectedFullName = "التجمع الإقليمي لسانت بارتيليمي";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Svatý Bartoloměj";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Saint-Barthélemy";
          const expectedFullName = "Gebietskörperschaft Saint-Barthélemy";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Saint-Barthélemy";
          const expectedFullName = "Saint-Barthélemy territoriaalühendus";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Saint-Barthélemy";
          const expectedFullName = "Saint-Barthélemyn yhteisö";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Saint-Barthélemy";
          const expectedFullName = "Collectivité de Saint-Barthélemy";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Saint Barthélemy";
          const expectedFullName = "Kolektivnost sv Barthélemy";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Antille Francesi";
          const expectedFullName = "Collettività di Saint Barthélemy";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "サン・バルテルミー";
          const expectedFullName = "サン·バルテルミー島の集合体";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Saint Barthélemy";
          const expectedFullName = "Gemeenschap Saint Barthélemy";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "São Bartolomeu";
          const expectedFullName = "Coletividade de Saint Barthélemy";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Сен-Бартелеми";
          const expectedFullName = "Коллективность Санкт -Бартельми";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Svätý Bartolomej";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "San Bartolomé";
          const expectedFullName = "Colectividad de San Barthélemy";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "سینٹ بارتھیملے";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "圣巴泰勒米";
          const expectedFullName = "圣巴泰勒米集体";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Sint Barthélemy";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "ছেইণ্ট বাৰ্থলেমে";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Sent-Bartelemi";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Сен-Бартэльмі";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "সেন্ট বারথেলিমি";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Sveti Bartolomej";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Сен-Бартельми";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "སེནཊ་ བར་ཐོ་ལོམ་མིའུ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Saint Barthélemy nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Άγιος Βαρθολομαίος";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "સેંટ બાર્થેલેમી";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "סנט ברתולומיאו";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "सेंट बार्थेलेमी";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Սուրբ Բարդուղիմեոս";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Sankti Bartólómeusareyjar";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Saint Barthélémi";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "სენ-ბართელმი";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "សាំង​បាថេឡេមី";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಸೇಂಟ್ ಬಾರ್ಥೆಲೆಮಿ";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "سینٹ بارتَھیلمی";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Сент Бартелеми";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ເຊນ ບາເທເລມີ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Sen Bartelemi";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Senbartelmī";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Свети Вартоломеј";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "സെന്റ് ബാർത്തലമി";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Сент-Бартельми";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "St. Barthelemy";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "စိန့်ဘာသယ်လ်မီ";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "सेन्ट बार्थेलेमी";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ସେଣ୍ଟ ବାର୍ଥେଲେମି";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਸੇਂਟ ਬਾਰਥੇਲੇਮੀ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "سينټ بارتيلمي";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "Son Barthélemy";
        ...
        test("has translation for 'sd' locale", () {
          const expectedName = "سینٽ برٿلیمی";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ශාන්ත බර්තලෙමි";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "St. Baathelemiy";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "செயின்ட் பார்தேலெமி";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "సెయింట్ బర్థెలిమి";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Сент-Бартелми";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "เซนต์บาร์เธเลมี";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Sā Patēlemi";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ساينت بارتېلېمى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Сен-Бартельмі";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Saŋ Bartalemi";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Saint Barthélemy";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤅𞤼. 𞤄𞤢𞤪𞤼𞤫𞤤𞤭𞤥𞤭";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "St. Barthélemy";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "San Barthélemy";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Sancte Bartholomeo";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Barthélemy Dị nsọ";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Hato Pāteremi";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Santu Bartolomeu";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "ESt. Barthélemy";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Ìlú Bátílẹ́mì";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Sankta Bartolomeo";
        ...
        test("has translation for 'ie' locale", () {
          const expectedName = "Sant-Bartolomeo";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Insula Sancti Bartholomaei";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Sántu Barthélemy";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Sant Bertomiu";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Свети Бартоломеј";
        ...
        test("has translation for 'ks_Arab' locale", () {
          const expectedName = "سینٛٹ بارتَھیلمی";
        ...
        test("has translation for 'ug_Arab' locale", () {
          const expectedName = "ساينىت-بارتھېلەمي ئاراللىرى";
