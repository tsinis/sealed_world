...
void main() => group(
      "$CountryRwa() L10N",
      () {
        const value = CountryRwa();

        test("has translation for 'en' locale", () {
          const expectedName = "Rwanda";
          const expectedFullName = "Republic of Rwanda";
        ...
        test("has translation for 'sr' locale", () {
          ...
          const expectedFullName = "Република Руанда";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "رواندا";
          const expectedFullName = "جمهورية رواندا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Rwanda";
          const expectedFullName = "Republik Rwanda";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Rwanda";
          const expectedFullName = "Rwandská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          ...
          const expectedFullName = "Republik Ruanda";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Rwanda";
          const expectedFullName = "Rwanda Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Ruanda";
          const expectedFullName = "Ruandan tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Rwanda";
          const expectedFullName = "République rwandaise";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Ruanda";
          const expectedFullName = "Republika Ruandi";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Ruanda";
          const expectedFullName = "Ruandai Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Ruanda";
          const expectedFullName = "Repubblica del Ruanda";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ルワンダ";
          const expectedFullName = "ルワンダ共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "르완다";
          const expectedFullName = "르완다 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Rwanda";
          const expectedFullName = "Republiek Rwanda";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "رواندا";
          const expectedFullName = "جمهوری رواندا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Rwanda";
          const expectedFullName = "Republika Rwandy";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Ruanda";
          const expectedFullName = "República do Ruanda";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Руанда";
          const expectedFullName = "Республика Руанда";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Ruanda";
          const expectedFullName = "República de Rwanda";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Rwanda";
          const expectedFullName = "Republiken Rwanda";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Ruanda";
          const expectedFullName = "Ruanda Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "روانڈا";
          const expectedFullName = "جمہوریہ روانڈا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "卢旺达";
          const expectedFullName = "卢旺达共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Rwanda nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Ruwanda";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Wánda Dineʼé Bikéyah";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Ruwanda";
