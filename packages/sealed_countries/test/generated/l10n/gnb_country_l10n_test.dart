...
void main() => group(
      "$CountryGnb() L10N",
      () {
        const value = CountryGnb();

        test("has translation for 'en' locale", () {
          const expectedName = "Guinea-Bissau";
          const expectedFullName = "Republic of Guinea-Bissau";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Гвинеја Бисао";
          const expectedFullName = "Република Гвинеја Бисао";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "غينيا بيساو";
          const expectedFullName = "جمهورية غينيا بيساو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Ginea-Bissau";
          const expectedFullName = "Republik Ginea-Bissau";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Guinea-Bissau";
          const expectedFullName = "Republika Guinea-Bissau";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Guinea-Bissau";
          const expectedFullName = "Republik Guinea-Bissau";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Guinea-Bissau";
          const expectedFullName = "Guinea-Bissau Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Guinea-Bissau";
          const expectedFullName = "Guinea-Bissaun tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Guinée-Bissau";
          const expectedFullName = "République de Guinée-Bissau";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Gvineja Bisau";
          const expectedFullName = "Republika Gvineja Bisau";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Bissau-Guinea";
          const expectedFullName = "Bissau-Guineai Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Guinea-Bissau";
          const expectedFullName = "Repubblica di Guinea-Bissau";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ギニアビサウ";
          const expectedFullName = "ギニアビサウ共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "기니비사우";
          const expectedFullName = "기니비사우 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Guinee-Bissau";
          const expectedFullName = "Republiek Guinee-Bissau";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "گینه بیسائو";
          const expectedFullName = "جمهوری گینه بیسائو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Gwinea Bissau";
          const expectedFullName = "Republika Gwinei Bissau";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Guiné-Bissau";
          const expectedFullName = "República da Guiné-Bissau";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Гвинея-Бисау";
          const expectedFullName = "Республика Гвинея -Бисау";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Guinea-Bissau";
          const expectedFullName = "Guinejsko-bissauská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Guinea-Bisáu";
          const expectedFullName = "República de Guinea-Bissau";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Guinea-Bissau";
          const expectedFullName = "Republiken Guinea-Bissau";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Gine-Bissau";
          const expectedFullName = "Gine-Bissau Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "گنی بساؤ";
          const expectedFullName = "جمہوریہ گنی بساؤ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "几内亚比绍";
          const expectedFullName = "几内亚比绍共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Qvineya-Bisau";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Гвінея-Бісау";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Gine Bisawo";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Gvineja-Bisao";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Гвиней-Бисау";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "གྷི་ནི་ བྷི་སཱའུ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Gini-Bisao nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Γουινέα Μπισάου";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Gvineo-Bisaŭo";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Gine-Bisaawo";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Guine Bissau";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "A Guinea Bissau";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "גינאה-ביסאו";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Գվինեա-Բիսաու";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Gínea-Bissá";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "გვინეა-ბისაუ";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ហ្គីណេប៊ីស្សូ";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಗಿನಿ-ಬಿಸ್ಸಾವ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "گیٖنی بِساو";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Gîne-Bissau";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Gini-Bisawu";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ກິນີ-ບິສເຊົາ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Bisau Gvinėja";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Gvineja-Bisava";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Гвинеја-Бисау";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Guinea-Bissau";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଗୁଇନିଆ-ବିସାଉ";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Gineya Bisawu";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Guineea-Bissau";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Gninëe-Bisau";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "Gvineja Bissau";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Gini-Bisaaw";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Guine-Bisau";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "கினியா-பிஸ்ஸாவ்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "గినియా-బిస్సావ్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "กินี-บิสเซา";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Gwineýa-Bisau";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "گىۋىنىيە بىسسائۇ";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Gvineya-Bisau";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Gine-Bisaawóo";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "גינע־ביסאַו";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Gene-Busau";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Guinea-Bissau";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "གི་ནེ་-བི་སའོ།";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "ގީނީ-ބިސާއޫ";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Ghuinea-Bissau";
        ...
        test("has translation for 'io' locale", () {
          const expectedName = "Guinea Bisau";
        ...
        test("has translation for 'kg' locale", () {
          const expectedName = "Ginea-Bisau";
        ...
        test("has translation for 'kw' locale", () {
          const expectedName = "Gyni-Bissaw";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Guinea Bissaviensis";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Guinèa Bissau";
        ...
        test("has translation for 'rw' locale", () {
          const expectedName = "Gineya-Biso";
        ...
        test("has translation for 'ss' locale", () {
          const expectedName = "IGiniya-Bhasawu";
        ...
        test("has translation for 'su' locale", () {
          const expectedName = "Guinéa-Bissau";
        ...
        test("has translation for 'vo' locale", () {
          const expectedName = "Gineyän-Bisauän";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "EGuinea-Bissau";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Гвинеиа-Бисау";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Gijneiyabijsau";
        ...
        test("has translation for 'ug_Arab' locale", () {
          const expectedName = "گىۋىنېيە-بىسسائۇ";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Gene-Busau";
