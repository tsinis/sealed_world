...
void main() => group(
      "$CountryTun() L10N",
      () {
        const value = CountryTun();

        test("has translation for 'en' locale", () {
          const expectedName = "Tunisia";
          const expectedFullName = "Tunisian Republic";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Тунис";
          const expectedFullName = "Тунишанска Република";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "تونس";
          const expectedFullName = "الجمهورية التونسية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Tunizia";
          const expectedFullName = "Republik Tunizian";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Tunisko";
          const expectedFullName = "Tuniská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Tunesien";
          const expectedFullName = "Tunesische Republik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Tuneesia";
          const expectedFullName = "Tuneesia Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Tunisia";
          const expectedFullName = "Tunisian tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Tunisie";
          const expectedFullName = "République tunisienne";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Tunis";
          const expectedFullName = "Tuniski Republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Tunézia";
          const expectedFullName = "Tunéziai Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Tunisia";
          const expectedFullName = "Repubblica tunisina";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "チュニジア";
          const expectedFullName = "チュニジア共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "튀니지";
          const expectedFullName = "튀니지 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Tunesië";
          const expectedFullName = "Republiek Tunesië";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "تونس";
          const expectedFullName = "جمهوری تونس";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Tunezja";
          const expectedFullName = "Republika Tunezyjska";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Tunísia";
          const expectedFullName = "República da Tunísia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Тунис";
          const expectedFullName = "Тунисской Республики";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Túnez";
          const expectedFullName = "República de Túnez";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Tunisien";
          const expectedFullName = "Republiken Tunisien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Tunus";
          const expectedFullName = "Tunus Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "تونس";
          const expectedFullName = "جمہوریہ تونس";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "突尼斯";
          const expectedFullName = "突尼斯共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Tunisia nutome";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "it-Tuneżija";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ටියුනීසියාව";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Tuniṣia";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Tooneesh";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Tunishia";
