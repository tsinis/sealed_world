...
void main() => group(
      "$CountryCog() L10N",
      () {
        const value = CountryCog();

        test("has translation for 'en' locale", () {
          const expectedName = "Republic of the Congo";
        ...
        test("has translation for 'sr' locale", () {
          ...
          const expectedFullName = "Република Конго";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "جمهورية الكونفو";
          const expectedFullName = "جمهورية الكونغو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Kongo-Brazzaville";
          const expectedFullName = "Republik Kongo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          ...
          const expectedFullName = "Konžská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Gweriniaeth y Congo";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Kongo Vabariik";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Kongo-Brazzaville";
          const expectedFullName = "Kongon tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Congo";
          const expectedFullName = "République du Congo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Kongo";
          const expectedFullName = "Republika Kongo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Kongói Köztársaság";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Congo";
          const expectedFullName = "Repubblica del Congo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Congo";
          const expectedFullName = "Republiek Congo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "جمهوری کُنگو";
          const expectedFullName = "جمهوری برازاویل کُنگو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Kongo";
          const expectedFullName = "Republika Konga";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Congo";
          const expectedFullName = "República do Congo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Республика Конго";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Congo";
          const expectedFullName = "República del Congo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Kongo-Brazzaville";
          const expectedFullName = "Republiken Kongo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Kongo Cumhuriyeti";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "جمہوریہ کانگو";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "刚果";
          const expectedFullName = "刚果共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "কঙ্গো - ব্রাজাভিল";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Konqo - Brazzavil";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Конга - Бразавіль";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Конго (Бразавил)";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Конго - Браззавиль";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "Congo-Brazzaville";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཀོང་གྷོ བྷྲ་ཛ་བིལ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Kongo Brazzaville nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Κονγκό - Μπραζαβίλ";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "A’ Chongo - Brazzaville";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "República do Congo";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "કોંગો - બ્રાઝાવિલે";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "קונגו - ברזאויל";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "कांगो – ब्राज़ाविल";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Կոնգո - Բրազավիլ";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Kongó-Brazzaville";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Kongo - Brassaville";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "კონგო - ბრაზავილი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Конго-Браззавиль Республикасы";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "កុងហ្គោ - ប្រាហ្សាវីល";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಕಾಂಗೋ - ಬ್ರಾಜಾವಿಲ್ಲೇ";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "کونگو بٔرزاوِلی";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Конго-Браззавил";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ຄອງໂກ - ບຣາຊາວິວ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Kongas-Brazavilis";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Kongo (Brazavila)";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "കോംഗോ - ബ്രാസവില്ലി";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "काँगो - ब्राझाविले";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Kongo - Brazzaville";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ကွန်ဂို-ဘရာဇာဗီးလ်";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "कङ्गो ब्राजाभिल";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "କଙ୍ଗୋ-ବ୍ରାଜିଭିଲ୍ଲେ";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਕਾਂਗੋ - ਬ੍ਰਾਜ਼ਾਵਿਲੇ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "کانګو - بروزوییل";
        ...
        test("has translation for 'sd' locale", () {
          const expectedName = "ڪانگو - برازاویل";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "කොංගො - බ්‍රසාවිල්";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Kongo-Brazavilë";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "காங்கோ - ப்ராஸாவில்லே";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "కాంగో- బ్రాజావిల్లి";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "คองโก - บราซซาวิล";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Kongo - Brazzawil";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Kongo - Palasavila";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "كونگو - بىراززاۋىل";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Конго – Браззавіль";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Kongo – Brazzavil";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Kóngò";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Congo - Brazzaville";
        ...
        test("has translation for 'an' locale", () {
          const expectedName = "Republica d'o Congo";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ཀོང་གོ་སྤྱི་མཐུན་རྒྱལ་ཁབ།";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "República del Congo";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Конго Республики";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "ކޮންގޯ (ޖުމްހޫރިއްޔާ)";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Pobblaght ny Congo";
        ...
        test("has translation for 'ht' locale", () {
          const expectedName = "Kongo (Brazavil)";
        ...
        test("has translation for 'ie' locale", () {
          const expectedName = "Republic de Congo";
        ...
        test("has translation for 'io' locale", () {
          const expectedName = "Republiko Kongo";
        ...
        test("has translation for 'kg' locale", () {
          const expectedName = "Repubilika ya Kôngo";
        ...
        test("has translation for 'kw' locale", () {
          const expectedName = "Repoblek Kongo";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Respublica Congensis";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Republik Congo";
        ...
        test("has translation for 'na' locale", () {
          const expectedName = "Ripubrikin Kongo";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Kéyah Káango Náhookǫsjí Siʼánígíí";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Republica de Còngo";
        ...
        test("has translation for 'os' locale", () {
          const expectedName = "Конгойы Республикæ";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Republica Congo";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Repùbrica de su Congo";
        ...
        test("has translation for 'ss' locale", () {
          const expectedName = "Tibuse weKhongo";
        ...
        test("has translation for 'su' locale", () {
          const expectedName = "Républik Kongo";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Ҷумҳӯрии Конго";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Republika ng Konggo";
        ...
        test("has translation for 'ts' locale", () {
          const expectedName = "Riphabliki ya Congo";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Конго Җөмһүрияте";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Cộng hòa Congo";
        ...
        test("has translation for 'vo' locale", () {
          const expectedName = "Kongoän (Repüblikän)";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Kongóo-Brasaawiil";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "רעפובליק פון קאנגא";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Kōngo - Pārawhe";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "ECongo - Brazzaville";
        ...
        test("has translation for 'ks_Arab' locale", () {
          const expectedName = "کونٛگو بٔرٛزاوِلی";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Kóngò";
