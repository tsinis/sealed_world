...
void main() => group(
      "$CountryMaf() L10N",
      () {
        const value = CountryMaf();

        test("has translation for 'en' locale", () {
          const expectedName = "Saint Martin";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Свети Мартин";
          const expectedFullName = "Заједница Свети Мартин";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Svatý Martin (Francie)";
          const expectedFullName = "Svatý Martin";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Saint-Martin";
          const expectedFullName = "Saint-Martini ühendus";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Sveti Martin";
          const expectedFullName = "Saint Martin";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Saint-Martin";
          const expectedFullName = "Saint-Martin Közösség";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "サン・マルタン（フランス領）";
          const expectedFullName = "サンマルタン島";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Saint-Martin";
          const expectedFullName = "Wspólnota Saint-Martin";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "São Martinho";
          const expectedFullName = "saint Martin";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Saint-Martin";
          const expectedFullName = "Förvaltningsområdet Saint-Martin";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Sint Martin";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "ছেইণ্ট মাৰ্টিন";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Sent Martin";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "সেন্ট মার্টিন";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "སེནཊ་ མཱར་ཊིན";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Saint Martin nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Άγιος Μαρτίνος (Γαλλικό τμήμα)";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Naomh Màrtainn";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "સેંટ માર્ટિન";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "सेंट मार्टिन";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Santa Martin";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "სენ-მარტენი";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "សាំង​ម៉ាទីន";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಸೇಂಟ್ ಮಾರ್ಟಿನ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "سینٹ مارٹِن";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Сент-Мартин";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Sen Martenas";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "സെന്റ് മാർട്ടിൻ";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "सेन्ट मार्टिन";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ସେଣ୍ଟ ମାର୍ଟିନ୍";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਸੇਂਟ ਮਾਰਟਿਨ";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Sfântul Martin";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Frankriikka Saint Martin";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ශාන්ත මාර්ටින්";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "செயின்ட் மார்ட்டீன்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "సెయింట్ మార్టిన్";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Ҷазираи Сент-Мартин";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "เซนต์มาร์ติน";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Sā Mātini (fakafalanisē)";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ساينت مارتىن";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Saint Martin";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Sancte Martino francese";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Martin Dị nsọ";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Hato Mātene";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Santu Martine";
        ...
        test("has translation for 'an' locale", () {
          const expectedName = "Sant Martín";
        ...
        test("has translation for 'co' locale", () {
          const expectedName = "San Martinu";
        ...
        test("has translation for 'kl' locale", () {
          const expectedName = "Frankrigi Saint Martin";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Sántu Martin";
        ...
        test("has translation for 'ks_Arab' locale", () {
          const expectedName = "سینٛٹ مارٹِن";
        ...
        test("has translation for 'ug_Arab' locale", () {
          const expectedName = "ساينىت-مارتېن";
