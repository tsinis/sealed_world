...
void main() => group(
      "$CountryVct() L10N",
      () {
        const value = CountryVct();

        test("has translation for 'en' locale", () {
          const expectedName = "Saint Vincent and the Grenadines";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Свети Винсент и Гренадини";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "سانت فينسنت والغرينادين";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Sant-Visant hag ar Grenadinez";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Svatý Vincenc a Grenadiny";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "St. Vincent und die Grenadinen";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Saint Vincent";
          const expectedFullName = "Saint Vincent ja Grenadiinid";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Saint Vincent ja Grenadiinit";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Saint-Vincent-et-les-Grenadines";
          const expectedFullName = "Saint-Vincent-et-les Grenadines";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Sveti Vincent i Grenadini";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Saint Vincent és a Grenadine-szigetek";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Saint Vincent e Grenadine";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "セントビンセントおよびグレナディーン諸島";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "세인트빈센트 그레나딘";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Saint Vincent en de Grenadines";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "سنت وینسنت و گرنادین‌ها";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Saint Vincent i Grenadyny";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "São Vincente e Granadinas";
          const expectedFullName = "São Vicente e Granadinas";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Сент-Винсент и Гренадины";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Svätý Vincent a Grenadíny";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "San Vicente y Granadinas";
          const expectedFullName = "San Vicente y las Granadinas";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Saint Vincent och Grenadinerna";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Saint Vincent ve Grenadinler";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "سینٹ وینسینٹ و گریناڈائنز";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Sint Vincent en die Grenadine";
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Saint Vincent ne Grenadines";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "ቅዱስ ቪንሴንት እና ግሬናዲንስ";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "ছেইণ্ট ভিনচেণ্ট আৰু গ্ৰীণাডাইনছ";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Sent-Vinsent və Qrenadinlər";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Сент-Вінсент і Грэнадзіны";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Сейнт Винсънт и Гренадини";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Vinisɛn-Senu-ni-Grenadini";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "সেন্ট ভিনসেন্ট ও গ্রেনাডিনস";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Sveti Vinsent i Grenadin";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "Saint Vincent i les Grenadines";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Сент-Винсент а, Гренадинаш а";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "Saint Vincent og Grenadinerne";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "སེནཊ་ཝིན་སེནཌ྄ ཨེནཌ་ གི་རེ་ན་དིནས྄";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Saint Vincent kple Grenadine nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Άγιος Βικέντιος και Γρεναδίνες";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Sent-Vincento kaj la Grenadinoj";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Saint Vincent eta Grenadinak";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "See Weesaa e Garnadiin";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "St. Vinsent & Grenadinoyggjar";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "San Uinseann agus na Greanáidíní";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Naomh Bhionsant agus Eileanan Greanadach";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "San Vicente e As Granadinas";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "સેંટ વિન્સેંટ અને ગ્રેનેડાઇંસ";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "San Binsan Da Girnadin";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "סנט וינסנט והגרנדינים";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "सेंट विंसेंट और ग्रेनाडाइंस";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Սենթ Վինսենթ և Գրենադիններ";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Sancte Vincente e le Grenadinas";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Saint Vincent dan Grenadine";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Sankti Vinsent og Grenadíneyjar";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Saint Vinsen lan Grénadin";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "სენტ-ვინსენტი და გრენადინები";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Santavisenti na Grenadini";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Сент-Винсент және Гренадин аралдары";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "សាំង​វ៉ាំងសង់ និង ហ្គ្រេណាឌីន";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಸೇಂಟ್. ವಿನ್ಸೆಂಟ್ ಮತ್ತು ಗ್ರೆನೆಡೈನ್ಸ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "سینٹ وینسؠٹ تہٕ گریناڑاینٕز";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Saint Vincent û Giravên Grenadîn";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Сент-Винсент жана Гренадиндер";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "St. Vincent an d’Grenadinnen";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Senti Vinsenti ne Gurendadiini";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Sántu vesá mpé Gelenadinɛ";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ເຊນ ວິນເຊນ ແລະ ເກຣເນດິນ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Šventasis Vincentas ir Grenadinai";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Santu vesa ne Ngelenadine";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Sentvinsenta un Grenadīnas";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Сент Винсент и Гренадини";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "സെന്റ് വിൻസെന്റും ഗ്രനെഡൈൻസും";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Сент-Винсент ба Гренадин";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "सेंट व्हिन्सेंट आणि ग्रेनडाइन्स";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Saint Vincent dan Grenadines";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "Saint Vincent u l-Grenadini";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "စိန့်ဗင်းဆင့်နှင့် ဂရိနေဒိုင်";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "St. Vincent og Grenadinene";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "सेन्ट भिन्सेन्ट र ग्रेनाडिन्स";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "St. Vincent og Grenadinane";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ସେଣ୍ଟ ଭିନସେଣ୍ଟ ଏବଂ ଦି ଗ୍ରେନାଡିସ୍";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਸੇਂਟ ਵਿਨਸੈਂਟ ਐਂਡ ਗ੍ਰੇਨਾਡੀਨਸ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "سینټ ویسنټینټ او ګرینډینز";
        ...
        test("has translation for 'qu' locale", () {
          const expectedName = "San Vicente y las Granadinas";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "Saint Vincent e las Grenadinas";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Sevensa na Gerenadine";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Saint Vincent și Grenadinele";
        ...
        test("has translation for 'sd' locale", () {
          const expectedName = "سینٽ ونسنت ۽ گریناڊینز";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Saint Vincent ja Grenadine";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Sên-Vensäan na âGrenadîni";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ශාන්ත වින්සන්ට් සහ ග්‍රෙනඩින්ස්";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "Saint Vincent in Grenadine";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "St. Finsent & Girenadiins";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Shën-Vincent dhe Grenadine";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "St. Vincent na Grenadines";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "செயின்ட் வின்சென்ட் & கிரெனடைன்ஸ்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "సెయింట్ విన్సెంట్ మరియు గ్రెనడీన్స్";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Сент-Винсент ва Гренадина";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "เซนต์วินเซนต์และเกรนาดีนส์";
        ...
        test("has translation for 'ti' locale", () {
          const expectedName = "ቅዱስ ቪንሴንትን ግሬናዲንስን";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Sent-Winsent we Grenadinler";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Sā Viniseni mo Kulenatini";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Сент-Винсент һәм Гренадин";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ساينت ۋىنسېنت ۋە گىرېنادىنېس";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Сент-Вінсент і Ґренадіни";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Sent-Vinsent va Grenadin";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "St. Vincent và Grenadines";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Saŋ Weesaa ak Garanadin";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Fisẹnnti ati Genadina";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Saint Vincent ne-Grenadines";
        ...
        test("has translation for 'vo' locale", () {
          const expectedName = "Saluda-Vinsenteän e Grenadineäns";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Сент-Винсент тата Гренадины";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Vincent na Grenadines Dị nsọ";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Hato Wēneti me Keretīni";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Santu Vissente e sas Grenadinas";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "St. Vincent & Grenadines";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "ESt. Vincent & Grenadines";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Сент-Винсенти Гренадини";
        ...
        test("has translation for 'an' locale", () {
          const expectedName = "Sant Vicent y las Granadinas";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "སེནྚ། ཝིན་སན། དང༌། གྷིརིན་ཌིན།";
        ...
        test("has translation for 'ie' locale", () {
          const expectedName = "St. Vincent e Grenadines";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Sanctus Vincentius et Granatinae";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "St Vincent e Granadinas";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Сент-Винсент вә Гренадинләр";
        ...
        test("has translation for 'kk_Cyrl' locale", () {
          const expectedName = "Сент-Винсент және Гренадиндер";
        ...
        test("has translation for 'ks_Arab' locale", () {
          const expectedName = "سینٛٹ وینسٮ۪ٹ تہٕ گرٛیناڑاینٕز";
        ...
        test("has translation for 'ky_Cyrl' locale", () {
          const expectedName = "Сент-Винсент жана Гренадиналар";
        ...
        test("has translation for 'mn_Cyrl' locale", () {
          const expectedName = "Сэнт Винсэнт ба Гренадин";
        ...
        test("has translation for 'ug_Arab' locale", () {
          const expectedName = "ساينىت-ۋىنسېنت ۋە گىرېنادىنېس";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Сент-Винсент ва Гренадин";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Fisɛnnti ati Genadina";
