...
void main() => group(
      "$CountryLbr() L10N",
      () {
        const value = CountryLbr();

        test("has translation for 'en' locale", () {
          const expectedName = "Liberia";
          const expectedFullName = "Republic of Liberia";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Либерија";
          const expectedFullName = "Република Либерија";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "ليبيريا";
          const expectedFullName = "جمهورية ليبيريا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Liberia";
          const expectedFullName = "Republik Liberia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Libérie";
          const expectedFullName = "Liberijská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Libeeria";
          const expectedFullName = "Libeeria Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Liberia";
          const expectedFullName = "Liberian tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Liberia";
          const expectedFullName = "République du Libéria";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Liberija";
          const expectedFullName = "Republika Liberija";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Libéria";
          const expectedFullName = "Libériai Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Liberia";
          const expectedFullName = "Repubblica di Liberia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "リベリア";
          const expectedFullName = "リベリア共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "라이베리아";
          const expectedFullName = "라이베리아 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Liberia";
          const expectedFullName = "Republiek Liberia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "لیبـِریا";
          const expectedFullName = "جمهوری لیبریا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Liberia";
          const expectedFullName = "Republika Liberii";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Libéria";
          const expectedFullName = "República da Libéria";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Либерия";
          const expectedFullName = "Республика Либерия";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Libéria";
          const expectedFullName = "Libérijská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Liberia";
          const expectedFullName = "República de Liberia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Liberia";
          const expectedFullName = "Republiken Liberia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Liberya";
          const expectedFullName = "Liberya Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "لائبیریا";
          const expectedFullName = "جمہوریہ لائبیریا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "利比里亚";
          const expectedFullName = "利比里亚共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ལཱའི་བེ་རི་ཡ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Liberia nutome";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "လိုက်ဘေးရီးယား";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Laberia";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Laberia";
