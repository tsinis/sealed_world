...
void main() => group(
      "$CountryZmb() L10N",
      () {
        const value = CountryZmb();

        test("has translation for 'en' locale", () {
          const expectedName = "Zambia";
          const expectedFullName = "Republic of Zambia";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Замбија";
          const expectedFullName = "Република Замбија";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "زامبيا";
          const expectedFullName = "جمهورية زامبيا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Zambia";
          const expectedFullName = "Republik Zambia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Zambie";
          const expectedFullName = "Zambijská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Sambia";
          const expectedFullName = "Republik Sambia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Sambia";
          const expectedFullName = "Sambia Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Sambia";
          const expectedFullName = "Sambian tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Zambie";
          const expectedFullName = "République de Zambie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Zambija";
          const expectedFullName = "Republika Zambija";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Zambia";
          const expectedFullName = "Zambiai Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Zambia";
          const expectedFullName = "Repubblica di Zambia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ザンビア";
          const expectedFullName = "ザンビア共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "잠비아";
          const expectedFullName = "잠비아 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Zambia";
          const expectedFullName = "Republiek Zambia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "زامبیا";
          const expectedFullName = "جمهوری زامبیا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Zambia";
          const expectedFullName = "Republika Zambii";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Zâmbia";
          const expectedFullName = "República da Zâmbia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Замбия";
          const expectedFullName = "Республика Замбия";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Zambia";
          const expectedFullName = "República de Zambia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Zambia";
          const expectedFullName = "Republiken Zambia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Zambiya";
          const expectedFullName = "Zambiya Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "زیمبیا";
          const expectedFullName = "جمہوریہ زیمبیا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "赞比亚";
          const expectedFullName = "赞比亚共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Zambia nutome";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an tSaimbia";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède ṣamibia";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède shamibia";
