...
void main() => group(
      "$CountryAnd() L10N",
      () {
        const value = CountryAnd();

        test("has translation for 'en' locale", () {
          const expectedName = "Andorra";
          const expectedFullName = "Principality of Andorra";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Андора";
          const expectedFullName = "Кнежевина Андора";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "أندورا";
          const expectedFullName = "إمارة أندورا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Andorra";
          const expectedFullName = "Priñselezh Andorra";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Andorra";
          const expectedFullName = "Andorrské knížectví";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Andorra";
          const expectedFullName = "Tywysogaeth Andorra";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Andorra";
          const expectedFullName = "Fürstentum Andorra";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Andorra";
          const expectedFullName = "Andorra Vürstiriik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Andorra";
          const expectedFullName = "Andorran ruhtinaskunta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Andorre";
          const expectedFullName = "Principauté d'Andorre";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Andora";
          const expectedFullName = "Kneževina Andora";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Andorra";
          const expectedFullName = "Principato di Andorra";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "アンドラ";
          const expectedFullName = "アンドラ公国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "안도라";
          const expectedFullName = "안도라 공국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Andorra";
          const expectedFullName = "Prinsdom Andorra";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "آندورا";
          const expectedFullName = "شاهزاده‌نشین آندورا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Andora";
          const expectedFullName = "Księstwo Andory";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Andorra";
          const expectedFullName = "Principado de Andorra";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Андорра";
          const expectedFullName = "Княжество Андорра";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Andorra";
          const expectedFullName = "Andorrské kniežatstvo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Andorra";
          const expectedFullName = "Furstendömet Andorra";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Andorra";
          const expectedFullName = "Andorra Prensliği";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "انڈورا";
          const expectedFullName = "اماراتِ انڈورا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "安道尔";
          const expectedFullName = "安道尔公国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Andorra nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Ààndórà";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Ààndórà";
