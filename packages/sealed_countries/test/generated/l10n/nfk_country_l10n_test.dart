...
void main() => group(
      "$CountryNfk() L10N",
      () {
        const value = CountryNfk();

        test("has translation for 'en' locale", () {
          const expectedName = "Norfolk Island";
          const expectedFullName = "Territory of Norfolk Island";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Норфок";
          const expectedFullName = "Територија Острва Норфок";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "جزيرة نورفولك";
          const expectedFullName = "إقليم جزيرة نورفولك";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Enez Norfolk";
          const expectedFullName = "Tiriad Enez Norfolk";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Norfolk";
          const expectedFullName = "Teritorium ostrova Norfolk";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Norfolkinsel";
          const expectedFullName = "Gebiet der Norfolkinsel";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Norfolk";
          const expectedFullName = "Norfolki saare ala";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Norfolkinsaari";
          const expectedFullName = "Norfolkinsaaren territorio";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Île Norfolk";
          const expectedFullName = "Territoire de l'île Norfolk";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Otok Norfolk";
          const expectedFullName = "Teritorij Norfolk Island";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Norfolk-sziget";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Isola Norfolk";
          const expectedFullName = "Territorio di Norfolk Island";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ノーフォーク島";
          const expectedFullName = "ノーフォーク島の領土";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Norfolkeiland";
          const expectedFullName = "Grondgebied van Norfolk Island";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "جزیره نورفک";
          const expectedFullName = "قلمرو جزایر نورفک";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Wyspa Norfolk";
          const expectedFullName = "Terytorium Wyspy Norfolk";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Ilha Norfolk";
          const expectedFullName = "Território da Ilha Norfolk";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Норфолк";
          const expectedFullName = "Территория острова Норфолк";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Norfolk";
          const expectedFullName = "Teritórium ostrova Norfolk";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Isla de Norfolk";
          const expectedFullName = "Territorio de la Isla Norfolk";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Norfolk Adası";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "جزیرہ نورفک";
          const expectedFullName = "جزیرہ نورفک خطہ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Nɔfolk Aeland";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "ন’ৰফ’ক দ্বীপ";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Востраў Норфалк";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "остров Норфолк";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Nɔrofoliki Gun";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "নরফোক দ্বীপ";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Ostrvo Norfolk";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Норфолк гӀайре";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ནོར་ཕོལཀ་མཚོ་གླིང༌";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Norfolk ƒudomekpo nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Νήσος Νόρφολκ";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Norfolkinsulo";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Norfolk uhartea";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Duuɗe Norfolk";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Norfolksoyggj";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Norfolkeilân";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Oileán Norfolk";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Eilean Norfolk";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Illa Norfolk";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "નોરફોક આઇલેન્ડ્સ";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Tsibirin Narfalk";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "नॉरफ़ॉक द्वीप";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Նորֆոլկ կղզի";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Insula Norfolk";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Kepulauan Norfolk";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Agwaetiti Norfolk";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Norfolkeyja";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Pulo Norfolk";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ნორფოლკის კუნძული";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Kisiwa cha Norfok";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Норфолк аралы";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "កោះ​ណ័រហ្វក់";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ನಾರ್ಫೋಕ್ ದ್ವೀಪ";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "نارفاک جٔزیٖرٕ";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Girava Norfolk";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Kizinga ky’eNorofoko";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Esanga Norfokɛ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Norfolko sala";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Lutanda lua Norfok";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Norfolkas sala";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Nosy Norfolk";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Норфолшки Остров";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "നോർഫോക് ദ്വീപ്";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Норфолк арал";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Pulau Norfolk";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "Gżira Norfolk";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "နောဖုတ်ကျွန်း";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "नोरफोल्क टापु";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ନର୍ଫକ୍ ଦ୍ଵୀପ";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਨੋਰਫੌਕ ਟਾਪੂ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "نارفولک ټاپوګان";
        ...
        test("has translation for 'qu' locale", () {
          const expectedName = "Isla Norfolk";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "Insla Norfolk";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "izinga rya Norufoluke";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Norfolksullot";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Zûâ Nôrfôlko";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "නෝෆෝක් දූපත";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "Norfolški otok";
        ...
        test("has translation for 'sn' locale", () {
          const expectedName = "Chitsuwa cheNorfolk";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Jasiiradda Noorfolk";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Ishulli Norfolk";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Kisiwa cha Norfolk";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "நார்ஃபோக் தீவு";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "నార్ఫోక్ దీవి";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Ҷазираи Норфолк";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "เกาะนอร์ฟอล์ก";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Norfolk adasy";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Motu Nōfoliki";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Норфолк утравы";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "نورفولك ئارىلى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Острів Норфолк";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Norfolk oroli";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Đảo Norfolk";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Dunu Norfolk";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "נארפֿאלק אינזל";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Etikun Nọ́úfókì";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Norfolk Island";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Норфолк утравӗ";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Te Moutere Nōpoke";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Ìsula Norfolk";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "ENorfolk Island";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Ад-ха Норфолк";
        ...
        test("has translation for 'ie' locale", () {
          const expectedName = "Insul Norfolk";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Insula Norfolcia";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Illas Norfòlk";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Норфолк адасы";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Острво Норфолк";
        ...
        test("has translation for 'mn_Cyrl' locale", () {
          const expectedName = "Норфолк Арлууд";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Норфолк ороллари";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Etikun Nɔ́úfókì";
