...
void main() => group(
      "$CountryIsl() L10N",
      () {
        const value = CountryIsl();

        test("has translation for 'en' locale", () {
          const expectedName = "Iceland";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Island";
          const expectedFullName = "Islandi Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Islande";
          const expectedFullName = "République d'Islande";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "아이슬란드";
          const expectedFullName = "아이슬란드 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "ایسلند";
          const expectedFullName = "جمهوری ایسلند";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Islandia";
          const expectedFullName = "Republika Islandii";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Island";
          const expectedFullName = "Islandská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Aiseland nutome";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Íoslainn";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಐಸ್‌ಲ್ಯಾಂಡ್";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "आइस्ल्याण्ड";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Aṣilandi";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ཨཡིསུ་ལེན་ཌ།";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "އައިސްލަންޑަން";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Tin Bikéyah";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Ashilandi";
