...
void main() => group(
      "$CountryDza() L10N",
      () {
        const value = CountryDza();

        test("has translation for 'en' locale", () {
          const expectedName = "Algeria";
          const expectedFullName = "People's Democratic Republic of Algeria";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Алжир";
          const expectedFullName = "Народна Демократска Република Алжир";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "الجزائر";
          const expectedFullName = "الجمهورية الديمقراطية الشعبية الجزائرية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Aljeria";
          const expectedFullName = "Republik Aljerian Demokratel ha Poblel";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Alžírsko";
          const expectedFullName = "Alžírská demokratická a lidová republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Algeria";
          const expectedFullName = "Gweriniaeth Ddemocrataidd Pobl Algeria";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Algerien";
          const expectedFullName = "Demokratische Volksrepublik Algerien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Alžeeria";
          const expectedFullName = "Alžeeria Demokraatlik Rahvavabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Algeria";
          const expectedFullName = "Algerian demokraattinen kansantasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Alžir";
          const expectedFullName = "Narodna Demokratska Republika Alžir";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Algéria";
          const expectedFullName = "Algériai Népi Demokratikus Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Algeria";
          const expectedFullName = "Repubblica popolare democratica di Algeria";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "アルジェリア";
          const expectedFullName = "アルジェリア人民民主共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "알제리";
          const expectedFullName = "알제리 인민 민주 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Algerije";
          const expectedFullName = "Democratische Volksrepubliek Algerije";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "الجزایر";
          const expectedFullName = "جمهوری دموکراتیک خلق الجزایر";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Algieria";
          const expectedFullName = "Algierska Republika Ludowo-Demokratyczna";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Argélia";
          const expectedFullName = "República Argelina Democrática e Popular";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Алжир";
          const expectedFullName = "Народно-Демократическая Республика Алжир";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Alžírsko";
          const expectedFullName = "Alžírska demokratická ľudová republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Argelia";
          const expectedFullName = "República Argelina Democrática y Popular";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Algeriet";
          const expectedFullName = "Demokratiska folkrepubliken Algeriet";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Cezayir";
          const expectedFullName = "Cezayir Demokratik Halk Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "الجزائر";
          const expectedFullName = "عوامی جمہوری جمہوریہ الجزائر";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "阿尔及利亚";
          const expectedFullName = "阿尔及利亚人民民主共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཨཱལ་ཇི་རི་ཡ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Algeria nutome";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "အယ်လ်ဂျီးရီးယား";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Àlùgèríánì";
        ...
        test("has translation for 'ss' locale", () {
          const expectedName = "i-Alijeriya";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Ahwjgizliya";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Àlùgèríánì";
