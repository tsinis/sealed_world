...
void main() => group(
      "$CountryAus() L10N",
      () {
        const value = CountryAus();

        test("has translation for 'en' locale", () {
          const expectedName = "Australia";
          const expectedFullName = "Commonwealth of Australia";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Аустралија";
          const expectedFullName = "Комонвелт Аустралија";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "أستراليا";
          const expectedFullName = "كومونولث أستراليا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Aostralia";
          const expectedFullName = "Kenglad Aostralia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Austrálie";
          const expectedFullName = "Australské společenství";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Awstralia";
          const expectedFullName = "Cymanwlad Awstralia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Australien";
          const expectedFullName = "Commonwealth Australien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Austraalia";
          const expectedFullName = "Austraalia Ühendus";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Australia";
          const expectedFullName = "Australian liittovaltio";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Ausztrália";
          const expectedFullName = "Ausztrál Államszövetség";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Australia";
          const expectedFullName = "Commonwealth dell'Australia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "オーストラリア";
          const expectedFullName = "オーストラリア連邦";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "호주";
          const expectedFullName = "오스트레일리아 연방";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Australië";
          const expectedFullName = "Gemenebest van Australië";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "استرالیا";
          const expectedFullName = "قلمرو همسود استرالیا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Australia";
          const expectedFullName = "Związek Australijski";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Austrália";
          const expectedFullName = "Comunidade da Austrália";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Австралия";
          const expectedFullName = "Содружество Австралии";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Austrália";
          const expectedFullName = "Austrálsky zväz";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Australia";
          const expectedFullName = "Mancomunidad de Australia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Australien";
          const expectedFullName = "Australiska statsförbundet";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Avustralya";
          const expectedFullName = "Avustralya Federal Devleti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "آسٹریلیا";
          const expectedFullName = "دولتِ مشترکہ آسٹریلیا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "澳大利亚";
          const expectedFullName = "澳大利亚联邦";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "অষ্ট্ৰেলিয়া";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "অস্ট্রেলিয়া";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཨཱོས་ཊྲེལ་ལི་ཡ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Australia nutome";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "ઑસ્ટ્રેલિયા";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "ऑस्ट्रेलिया";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಆಸ್ಟ್ರೇಲಿಯಾ";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Awusitureliya";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ഓസ്‌ട്രേലിയ";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "l-Awstralja";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "अष्ट्रेलिया";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Ositaraliya";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ඕස්ට්‍රේලියාව";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Awstaraaliya";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "ஆஸ்திரேலியா";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "ఆస్ట్రేలియా";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "ʻAositelēlia";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ئاۋسترالىيە";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "אויסטראַליע";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Ástràlìá";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Australia";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ཨོ་སེ་ཐེ་ལི་ཡ།";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "އޮސްޓަރުލިޔާ";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Ahitereiria";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Nahatʼeʼiitsoh Bikéyah";
        ...
        test("has translation for 'om' locale", () {
          const expectedName = "Awustireliyaa";
        ...
        test("has translation for 'pi' locale", () {
          const expectedName = "आस्ट्रेलिया";
        ...
        test("has translation for 'ty' locale", () {
          const expectedName = "Autereraria";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Audaihleihya";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "E-Australia";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Ástràlìá";
