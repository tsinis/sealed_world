...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          ...
          const expectedFullName = "Federal Republic of Germany";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Немачка";
          const expectedFullName = "Савезна Република Немачка";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "ألمانيا";
          const expectedFullName = "جمهورية ألمانيا الاتحادية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Alamagn";
          const expectedFullName = "Republik Kevreadel Alamagn";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Německo";
          const expectedFullName = "Spolková republika Německo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Deutschland";
          const expectedFullName = "Bundesrepublik Deutschland";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Saksamaa";
          const expectedFullName = "Saksamaa Liitvabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Saksa";
          const expectedFullName = "Saksan liittotasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Allemagne";
          const expectedFullName = "République fédérale d'Allemagne";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Njemačka";
          const expectedFullName = "Njemačka Federativna Republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Németország";
          const expectedFullName = "Német Szövetségi Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Germania";
          const expectedFullName = "Repubblica federale di Germania";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ドイツ";
          const expectedFullName = "ドイツ連邦共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "독일";
          const expectedFullName = "독일 연방 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Duitsland";
          const expectedFullName = "Bondsrepubliek Duitsland";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "آلمان";
          const expectedFullName = "جمهوری فدرال آلمان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Niemcy";
          const expectedFullName = "Republika Federalna Niemiec";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Alemanha";
          const expectedFullName = "República Federal da Alemanha";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Германия";
          const expectedFullName = "Федеративная Республика Германия";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Nemecko";
          const expectedFullName = "Nemecká spolková republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Alemania";
          const expectedFullName = "República Federal de Alemania";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Tyskland";
          const expectedFullName = "Förbundsrepubliken Tyskland";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Almanya";
          const expectedFullName = "Almanya Federal Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "جرمنی";
          const expectedFullName = "وفاقی جمہوریہ جرمنی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "德国";
          const expectedFullName = "德意志联邦共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Germania nutome";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Ghearmáin";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "A’ Ghearmailt";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Mba Germany";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Däitschland";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Ġermanja";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹèdè Jámánì";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "ޖަރުމަނުވިލާތް";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Ghermaan";
        ...
        test("has translation for 'kl' locale", () {
          const expectedName = "Tyskit Nunaat";
        ...
        test("has translation for 'li' locale", () {
          const expectedName = "Duutsjlandj";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Béésh Bichʼahii Bikéyah";
        ...
        test("has translation for 'tw' locale", () {
          ...
          final translated = value.maybeTranslation(
            const BasicTypedLocale(LangTwi()),
            useLanguageFallback: false,
          );
          ...
          expect(commonMapTranslation, expectedName);
          final unexpectedScriptTranslation = value.maybeTranslation(
            const BasicTypedLocale(LangTwi(), script: ScriptCyrs()),
          );
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛèdè Jámánì";
