...
void main() => group(
      "$CountryAze() L10N",
      () {
        const value = CountryAze();

        test("has translation for 'en' locale", () {
          const expectedName = "Azerbaijan";
          const expectedFullName = "Republic of Azerbaijan";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Азербејџан";
          const expectedFullName = "Азербејџанска Република";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "أذربيجان";
          const expectedFullName = "جمهورية أذربيجان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Azerbaidjan";
          const expectedFullName = "Republik Azerbaidjan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Ázerbájdžán";
          const expectedFullName = "Ázerbájdžánská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Aserbaijan";
          const expectedFullName = "Gweriniaeth Aserbaijan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Aserbaidschan";
          const expectedFullName = "Republik Aserbaidschan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Aserbaidžaan";
          const expectedFullName = "Aserbaidžaani Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Azerbaidzan";
          const expectedFullName = "Azerbaidzanin tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Azerbaïdjan";
          const expectedFullName = "République d'Azerbaïdjan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Azerbajdžan";
          const expectedFullName = "Republika Azerbajdžan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Azerbajdzsán";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Azerbaijan";
          const expectedFullName = "Repubblica dell'Azerbaigian";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "アゼルバイジャン";
          const expectedFullName = "アゼルバイジャン共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "아제르바이잔";
          const expectedFullName = "아제르바이잔 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Azerbeidzjan";
          const expectedFullName = "Republiek Azerbeidzjan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "جمهوری آذربایجان";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Azerbejdżan";
          const expectedFullName = "Republika Azerbejdżanu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Azerbeijão";
          const expectedFullName = "República do Azerbaijão";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Азербайджан";
          const expectedFullName = "Азербайджанская Республика";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "AzerbajǇan";
          const expectedFullName = "Azerbajǆanská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Azerbaiyán";
          const expectedFullName = "República de Azerbaiyán";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Azerbajdzjan";
          const expectedFullName = "Republiken Azerbajdzjan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Azerbaycan";
          const expectedFullName = "Azerbaycan Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "آذربائیجان";
          const expectedFullName = "جمہوریہ آذربائیجان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "阿塞拜疆";
          const expectedFullName = "阿塞拜疆共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Azerbeidjan";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Azerbejdžan";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "Aserbajdsjan";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཨ་ཛར་བྷའི་ཇཱན";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Azerbaijan nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Αζερμπαϊτζάν";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Azerbajĝano";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Ajerbayjaan";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Asarbaiseáin";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Asarbaideàn";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Azerbaidzhan";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Aserbaídsjan";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "აზერბაიჯანი";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "អាស៊ែបៃហ្សង់";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Azerebayijaani";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Azerbaidžanas";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Ajelbayidja";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Azerbaidžāna";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "l-Ażerbajġan";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "အဇာဘိုင်ဂျန်";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଆଜେରବାଇଜାନ୍";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Azerubayijani";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Zerebaidyäan";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "අසර්බයිජානය";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Azerbajxhan";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Azerbaijani";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "อาเซอร์ไบจาน";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "ʻAsapaisani";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ئەزەربەيجان";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Asẹ́bájánì";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Azerbaijan";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Азербаиџьан";
        ...
        test("has translation for 'an' locale", () {
          const expectedName = "Azerbaichán";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ཨ་ཛར་བཡི་ཇན།";
        ...
        test("has translation for 'co' locale", () {
          const expectedName = "Azerbaighjan";
        ...
        test("has translation for 'cu' locale", () {
          const expectedName = "Аꙁѣрбаича́нъ";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "އަޒަރުބައިޖާން";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "yn Asserbajaan";
        ...
        test("has translation for 'ht' locale", () {
          const expectedName = "Azerbaydjan";
        ...
        test("has translation for 'kv' locale", () {
          const expectedName = "Азербайджа́н";
        ...
        test("has translation for 'li' locale", () {
          const expectedName = "Azerbaidzjan";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Atepaihānia";
        ...
        test("has translation for 'na' locale", () {
          const expectedName = "Aderbaidjan";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Azééwii Bikéyah";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Azerbaitjan";
        ...
        test("has translation for 'rw' locale", () {
          const expectedName = "Azeribayijani";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Azerbaigián";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "אַזערבײַדזשאַן";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Ahsehbaiqgyangh";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "E-Azerbaijan";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Asɛ́bájánì";
