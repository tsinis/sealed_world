...
void main() => group(
      "$CountryMsr() L10N",
      () {
        const value = CountryMsr();

        test("has translation for 'en' locale", () {
          const expectedName = "Montserrat";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Montserrat nutome";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Montserrati";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಮಾಂಟ್‌ಸೆರಟ್";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Monteseraati";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Montseratas";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Montserrata";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "മൊണ്ടെസരത്ത്";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "मॉन्ट्सेराट";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "မောင့်စဲရက်";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "मोन्टसेर्राट";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ମଣ୍ଟେସେରାଟ୍";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Monteserati";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "மாண்ட்செராட்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "మాంట్సెరాట్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "มอนต์เซอร์รัต";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Moʻungaselati";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Motserati";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Montserrat";
        ...
        test("has translation for 'an' locale", () {
          const expectedName = "Isla de Montserrat";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "Illa de Montserrat";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Illa Montserrat";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "EMontserrat";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Motserati";
