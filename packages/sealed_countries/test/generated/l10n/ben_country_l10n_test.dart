...
void main() => group(
      "$CountryBen() L10N",
      () {
        const value = CountryBen();

        test("has translation for 'en' locale", () {
          const expectedName = "Benin";
          const expectedFullName = "Republic of Benin";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Бенин";
          const expectedFullName = "Република Бенин";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "بنين";
          const expectedFullName = "جمهورية بنين";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Benin";
          const expectedFullName = "Republik Benin";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Benin";
          const expectedFullName = "Beninská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Benin";
          const expectedFullName = "Gweriniaeth Benin";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Benin";
          const expectedFullName = "Benini Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Benin";
          const expectedFullName = "Beninin tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Bénin";
          const expectedFullName = "République du Bénin";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Benin";
          const expectedFullName = "Republika Benin";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Benin";
          const expectedFullName = "Benini Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Benin";
          const expectedFullName = "Repubblica del Benin";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ベナン";
          const expectedFullName = "ベナン共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "베냉";
          const expectedFullName = "베냉 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Benin";
          const expectedFullName = "Republiek Benin";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "بنین";
          const expectedFullName = "جمهوری بنین";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Benin";
          const expectedFullName = "República do Benin";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Бенин";
          const expectedFullName = "Республика Бенин";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Benín";
          const expectedFullName = "República de Benin";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Benin";
          const expectedFullName = "Republiken Benin";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Benin";
          const expectedFullName = "Benin Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "بینن";
          const expectedFullName = "جمہوریہ بینن";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "贝宁";
          const expectedFullName = "贝宁共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Benin nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Bẹ̀nẹ̀";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Bɛ̀nɛ̀";
