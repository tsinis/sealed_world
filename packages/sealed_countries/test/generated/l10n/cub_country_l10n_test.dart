...
void main() => group(
      "$CountryCub() L10N",
      () {
        const value = CountryCub();

        test("has translation for 'en' locale", () {
          const expectedName = "Cuba";
          const expectedFullName = "Republic of Cuba";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Куба";
          const expectedFullName = "Република Куба";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "كوبا";
          const expectedFullName = "جمهورية كوبا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Kuba";
          const expectedFullName = "Republik Kuba";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Kuba";
          const expectedFullName = "Kubánská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Ciwba";
          const expectedFullName = "Gweriniaeth Ciwba";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Kuuba";
          const expectedFullName = "Kuuba Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Kuuba";
          const expectedFullName = "Kuuban tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Cuba";
          const expectedFullName = "République de Cuba";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Kuba";
          const expectedFullName = "Republika Kuba";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Kuba";
          const expectedFullName = "Kubai Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Cuba";
          const expectedFullName = "Repubblica di Cuba";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "キューバ";
          const expectedFullName = "キューバ共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "쿠바";
          const expectedFullName = "쿠바 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Cuba";
          const expectedFullName = "Republiek Cuba";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "کوبا";
          const expectedFullName = "جمهوری کوبا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Kuba";
          const expectedFullName = "Republika Kuby";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Cuba";
          const expectedFullName = "República de Cuba";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Куба";
          const expectedFullName = "Республика Куба";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Kuba";
          const expectedFullName = "Kubánska republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Kuba";
          const expectedFullName = "Republiken Kuba";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Küba";
          const expectedFullName = "Küba Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "کیوبا";
          const expectedFullName = "جمہوریہ کیوبا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "古巴";
          const expectedFullName = "古巴共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Kuba nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Kúbà";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Kúbà";
