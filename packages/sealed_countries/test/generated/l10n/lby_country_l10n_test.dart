...
void main() => group(
      "$CountryLby() L10N",
      () {
        const value = CountryLby();

        test("has translation for 'en' locale", () {
          const expectedName = "Libya";
          const expectedFullName = "State of Libya";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Либија";
          const expectedFullName = "Држава Либија";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "‏ليبيا";
          const expectedFullName = "دولة ليبيا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Libia";
          const expectedFullName = "Stad Libia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Libye";
          const expectedFullName = "Stát Libye";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Libyen";
          const expectedFullName = "Staat Libyen";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Libya";
          const expectedFullName = "Libyan valtio";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Libija";
          const expectedFullName = "Država Libiji";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Líbia";
          const expectedFullName = "Líbia Állam";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Libia";
          const expectedFullName = "Stato della Libia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "リビア";
          const expectedFullName = "リビアの国家";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Libië";
          const expectedFullName = "Staat van Libië";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "لیبی";
          const expectedFullName = "دولت لیبی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Libia";
          const expectedFullName = "Państwo Libia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Líbia";
          const expectedFullName = "Estado da Líbia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Ливия";
          const expectedFullName = "Государство Ливии";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Libia";
          const expectedFullName = "Estado de Libia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Libyen";
          const expectedFullName = "Staten Libyen";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Libya";
          const expectedFullName = "Libya Devleti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "لیبیا";
          const expectedFullName = "ریاستِ لیبیا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "利比亚";
          const expectedFullName = "利比亚国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Libya nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Libiya";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Libiya";
