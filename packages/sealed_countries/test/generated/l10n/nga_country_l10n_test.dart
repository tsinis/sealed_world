...
void main() => group(
      "$CountryNga() L10N",
      () {
        const value = CountryNga();

        test("has translation for 'en' locale", () {
          const expectedName = "Nigeria";
          const expectedFullName = "Federal Republic of Nigeria";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Нигерија";
          const expectedFullName = "Савезна Република Нигерија";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "نيجيريا";
          const expectedFullName = "جمهورية نيجيريا الاتحادية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Nigeria";
          const expectedFullName = "Republik Kevreadel Nigeria";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Nigérie";
          const expectedFullName = "Nigerijská federativní republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Nigeria";
          const expectedFullName = "Bundesrepublik Nigeria";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Nigeeria";
          const expectedFullName = "Nigeeria Liitvabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Nigeria";
          const expectedFullName = "Nigerian liittotasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Nigéria";
          const expectedFullName = "République fédérale du Nigeria";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Nigerija";
          const expectedFullName = "Savezna Republika Nigerija";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Nigeria";
          const expectedFullName = "Repubblica federale di Nigeria";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ナイジェリア";
          const expectedFullName = "ナイジェリア連邦共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "나이지리아";
          const expectedFullName = "나이지리아 연방 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Nigeria";
          const expectedFullName = "Federale Republiek Nigeria";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "نیجریه";
          const expectedFullName = "جمهوری فدرال نیجریه";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Nigeria";
          const expectedFullName = "Federalna Republika Nigerii";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Nigéria";
          const expectedFullName = "República Federal da Nigéria";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Нигерия";
          const expectedFullName = "Федеративная Республика Нигерия";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Nigéria";
          const expectedFullName = "Nigérijská federatívna republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Nigeria";
          const expectedFullName = "República Federal de Nigeria";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Nigeria";
          const expectedFullName = "Förbundsrepubliken Nigeria";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Nijerya";
          const expectedFullName = "Nijerya Federal Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "نائجیریا";
          const expectedFullName = "وفاقی جمہوریہ نائجیریا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "尼日利亚";
          const expectedFullName = "尼日利亚联邦共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ནཱའི་ཇི་རི་ཡ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Nigeria nutome";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "នីហ្សេរីយ៉ា";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "နိုင်ဂျီးရီးယား";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orilẹ̀-èdè Nàìjíríà";
        ...
        test("has translation for 'ss' locale", () {
          const expectedName = "INayijeriya";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orilɛ̀-èdè Nàìjíríà";
