...
void main() => group(
      "$CountryBlr() L10N",
      () {
        const value = CountryBlr();

        test("has translation for 'en' locale", () {
          const expectedName = "Belarus";
          const expectedFullName = "Republic of Belarus";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Белорусија";
          const expectedFullName = "Република Белорусија";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "بيلاروسيا";
          const expectedFullName = "جمهورية بيلاروسيا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Belarus";
          const expectedFullName = "Republik Belarus";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Bělorusko";
          const expectedFullName = "Běloruská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Belarws";
          const expectedFullName = "Gweriniaeth Belarws";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Weißrussland";
          const expectedFullName = "Republik Belarus";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Valgevene";
          const expectedFullName = "Valgevene Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Valko-Venäjä";
          const expectedFullName = "Valko-Venäjän tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Biélorussie";
          const expectedFullName = "République de Biélorussie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Bjelorusija";
          const expectedFullName = "Republika Bjelorusija";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Fehéroroszország";
          const expectedFullName = "Fehérorosz Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Bielorussia";
          const expectedFullName = "Repubblica di Belarus";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ベラルーシ";
          const expectedFullName = "ベラルーシ共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "벨라루스";
          const expectedFullName = "벨라루스 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Wit-Rusland";
          const expectedFullName = "Republiek Belarus";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "بلاروس";
          const expectedFullName = "جمهوری بلاروس";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Białoruś";
          const expectedFullName = "Republika Białorusi";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Bielorússia";
          const expectedFullName = "República da Bielorrússia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Беларусь";
          const expectedFullName = "Республика Беларусь";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Bielorusko";
          const expectedFullName = "Bieloruská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Bielorrusia";
          const expectedFullName = "República de Belarús";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Belarus";
          const expectedFullName = "Republiken Vitryssland";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Belarus";
          const expectedFullName = "Belarus Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "بیلاروس";
          const expectedFullName = "جمہوریہ بیلاروس";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "白俄罗斯";
          const expectedFullName = "白俄罗斯共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "Hviderusland";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "བེལ་ཨ་རུ་སུ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Belarus nutome";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Hvítarussland";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Bhealarúis";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "A’ Bhealaruis";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Hvíta-Rússland";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Wäissrussland";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Baltarusija";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Baltkrievija";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Belarussja";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "Hviterussland";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "Kviterussland";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Vilges-Ruošša";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Bélárúsì";
        ...
        test("has translation for 'gn' locale", () {
          const expectedName = "Vielorrusia";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Velaroosh";
        ...
        test("has translation for 'kl' locale", () {
          const expectedName = "Hvideruslandi";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Ruthenia Alba";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Belorussiýa";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Biyelorusya";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Bielorùssia";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Bwzngozlozswh";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Бјелорусија";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Bélárúsì";
