...
void main() => group(
      "$CountryPry() L10N",
      () {
        const value = CountryPry();

        test("has translation for 'en' locale", () {
          const expectedName = "Paraguay";
          const expectedFullName = "Republic of Paraguay";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Парагвај";
          const expectedFullName = "Република Парагвај";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "باراغواي";
          const expectedFullName = "جمهورية باراغواي";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Paraguay";
          const expectedFullName = "Republik Paraguay";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Paraguay";
          const expectedFullName = "Paraguayská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Paraguay";
          const expectedFullName = "Paraguay Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Paraguay";
          const expectedFullName = "Paraguayn tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Paraguay";
          const expectedFullName = "République du Paraguay";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Paragvaj";
          const expectedFullName = "Republika Paragvaj";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Paraguay";
          const expectedFullName = "Paraguayi Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Paraguay";
          const expectedFullName = "Repubblica del Paraguay";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "パラグアイ";
          const expectedFullName = "パラグアイ共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "파라과이";
          const expectedFullName = "파라과이 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Paraguay";
          const expectedFullName = "Republiek Paraguay";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "پاراگوئه";
          const expectedFullName = "جمهوری پاراگوئه";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Paragwaj";
          const expectedFullName = "Republika Paragwaju";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Paraguai";
          const expectedFullName = "República do Paraguai";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Парагвай";
          const expectedFullName = "Республика Парагвай";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Paraguaj";
          const expectedFullName = "Paraguajská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Paraguay";
          const expectedFullName = "República de Paraguay";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Paraguay";
          const expectedFullName = "Republiken Paraguay";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Paraguay";
          const expectedFullName = "Paraguay Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "پیراگوئے";
          const expectedFullName = "جمہوریہ پیراگوئے";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "巴拉圭";
          const expectedFullName = "巴拉圭共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "প্যারাগুয়ে";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Paragua nutome";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ប៉ារ៉ាហ្គាយ";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Paragwaj";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "פּאַראַגווײַ";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Paraguye";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Pharaguay";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Bahlahgveih";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Paraguye";
