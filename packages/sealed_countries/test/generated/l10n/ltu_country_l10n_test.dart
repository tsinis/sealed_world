...
void main() => group(
      "$CountryLtu() L10N",
      () {
        const value = CountryLtu();

        test("has translation for 'en' locale", () {
          const expectedName = "Lithuania";
          const expectedFullName = "Republic of Lithuania";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Литванија";
          const expectedFullName = "Литванска Република";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "ليتوانيا";
          const expectedFullName = "جمهورية ليتوانيا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Lituania";
          const expectedFullName = "Republik Lituania";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Litva";
          const expectedFullName = "Litevská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Litauen";
          const expectedFullName = "Republik Litauen";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Leedu";
          const expectedFullName = "Leedu Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Liettua";
          const expectedFullName = "Liettuan tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Lituanie";
          const expectedFullName = "République de Lituanie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Litva";
          const expectedFullName = "Republika Litva";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Litvánia";
          const expectedFullName = "Litván Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Lituania";
          const expectedFullName = "Repubblica di Lituania";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "リトアニア";
          const expectedFullName = "リトアニア共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "리투아니아";
          const expectedFullName = "리투아니아 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Litouwen";
          const expectedFullName = "Republiek Litouwen";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "لیتوانیایی‌ها";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Litwa";
          const expectedFullName = "Republika Litewska";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Lituânia";
          const expectedFullName = "República da Lituânia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Литва";
          const expectedFullName = "Литовская Республика";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Litva";
          const expectedFullName = "Litovská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Lituania";
          const expectedFullName = "República de Lituania";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Litauen";
          const expectedFullName = "Republiken Litauen";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Litvanya";
          const expectedFullName = "Litvanya Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "لتھووینیا";
          const expectedFullName = "جمہوریہ لتھووینیا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "立陶宛";
          const expectedFullName = "立陶宛共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "লিথুৱানিয়া";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "লিথুয়ানিয়া";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ལི་ཐུ་ཝེ་ནི་ཡ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Lituania nutome";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Liotuáin";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "An Liotuain";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "لِتھُوانِیا";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Litwanja";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "လစ်သူယေးနီးယား";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ලිතුවේනියාව";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Lituweeniya";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Lituania";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Lithuania";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ལི་ཐུ་ཨེ་ནི་ཡ།";
        ...
        test("has translation for 'fj' locale", () {
          ...
          final translated = value.maybeTranslation(
            const BasicTypedLocale(LangFij()),
            useLanguageFallback: false,
          );
          ...
          expect(commonMapTranslation, expectedName);
          final unexpectedScriptTranslation = value.maybeTranslation(
            const BasicTypedLocale(LangFij(), script: ScriptCyrs()),
          );
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Łitʼoowę́ęya";
        ...
        test("has translation for 've' locale", () {
          ...
          final translated = value.maybeTranslation(
            const BasicTypedLocale(LangVen()),
            useLanguageFallback: false,
          );
          ...
          expect(commonMapTranslation, expectedName);
          final unexpectedScriptTranslation = value.maybeTranslation(
            const BasicTypedLocale(LangVen(), script: ScriptCyrs()),
          );
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Lizdauzvanj";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Lituania";
