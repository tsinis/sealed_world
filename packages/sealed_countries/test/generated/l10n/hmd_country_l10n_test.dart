...
void main() => group(
      "$CountryHmd() L10N",
      () {
        const value = CountryHmd();

        test("has translation for 'en' locale", () {
          const expectedName = "Heard Island and McDonald Islands";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Острва Херд и Макдоналд";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "جزيرة هيرد وجزر ماكدونالد";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Inizi Heard ha McDonald";
          const expectedFullName = "Enez Heard hag Inizi McDonald";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Heardův ostrov a McDonaldovy ostrovy";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Heard und die McDonaldinseln";
          const expectedFullName = "Heard und McDonaldinseln";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Heard ja McDonald";
          const expectedFullName = "Heardi ja McDonaldi saarte ala";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Heard ja McDonaldinsaaret";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Îles Heard-et-MacDonald";
          const expectedFullName = "Des îles Heard et McDonald";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Otok Heard i otočje McDonald";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Heard-sziget és McDonald-szigetek";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Isole Heard e McDonald";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ハード島とマクドナルド諸島";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Heard-en McDonaldeilanden";
          const expectedFullName = "Heard en McDonaldeilanden";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "جزیره هرد و جزایر مک‌دونالد";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Wyspy Heard i McDonalda";
          const expectedFullName = "Terytorium Wysp Heard i McDonalda";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Ilha Heard e Ilhas McDonald";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Остров Херд и острова Макдональд";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Heardov ostrov";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Islas Heard y McDonald";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Heard- och McDonaldöarna";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Heard Adası ve McDonald Adaları";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "جزیرہ ہرڈ و جزائر مکڈونلڈ";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Heardeiland en McDonaldeilande";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "ኽርድ ደሴቶችና ማክዶናልድ ደሴቶች";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "হাৰ্ড দ্বীপ আৰু মেকডোনাল্ড দ্বীপপুঞ্জ";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Herd və Makdonald adaları";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Астравы Херд і Макдональд";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "острови Хърд и Макдоналд";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "হার্ড এবং ম্যাকডোনাল্ড দ্বীপপুঞ্জ";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Herd i arhipelag MekDonald";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "Illa Heard i Illes McDonald";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Херд гӀайре а, Макдональд гӀайренаш а";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "Heard Island og McDonald Islands";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཧཱརཌ་མཚོ་གླིང་ དང་ མེཀ་ཌོ་ནལཌ྄་གླིང་ཚོམ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Heard kple Mcdonald ƒudomekpowo nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Νήσοι Χερντ και Μακντόναλντ";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Herda kaj Makdonaldaj Insuloj";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Heard eta McDonald uharteak";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Heard og McDonaldoyggjar";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Heard- en McDonaldeilannen";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Oileán Heard agus Oileáin McDonald";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Eilean Heard is MhicDhòmhnaill";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Illa Heard e Illas McDonald";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "હર્ડ અને મેકડોનાલ્ડ આઇલેન્ડ્સ";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "איי הרד ומקדונלד";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "हर्ड द्वीप और मैकडोनॉल्ड द्वीपसमूह";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Հերդ կղզի և ՄակԴոնալդի կղզիներ";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Pulau Heard dan Kepulauan McDonald";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Agwaetiti Heard na Agwaetiti McDonald";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Heard og McDonaldseyjar";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Kapuloan Heard lan McDonald";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ჰერდი და მაკდონალდის კუნძულები";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Херд аралы және Макдональд аралдары";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "កោះ​ហឺដ និង​ម៉ាក់ដូណាល់";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಹರ್ಡ್ ಮತ್ತು ಮ್ಯಾಕ್‌ಡೋನಾಲ್ಡ್ ದ್ವೀಪಗಳು";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "ہَرٕڑ جٔزیٖرٕ تہٕ مؠکڈونالڑٕ جٔزیٖرٕ";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Херд жана Макдональд аралдары";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Heard- a McDonald-Inselen";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Ile Heard et Iles McDonald";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ໝູ່ເກາະເຮີດ & ແມັກໂດນອລ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Herdo ir Makdonaldo Salos";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Hērda sala un Makdonalda salas";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Остров Херд и Острови Мекдоналд";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ഹിയേർഡും മക്‌ഡൊണാൾഡ് ദ്വീപുകളും";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Херд ба Макдональдийн арлууд";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "हर्ड आणि मॅक्डोनाल्ड बेटे";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Kepulauan Heard & McDonald";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Gżejjer Heard u l-Gżejjer McDonald";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဟတ်ကျွန်းနှင့်မက်ဒေါနယ်ကျွန်းစု";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "Heard- og McDonaldøyene";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "हर्ड टापु र म्याकडोनाल्ड टापुहरु";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "Heardøya og McDonaldøyane";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ହାର୍ଡ୍‌ ଏବଂ ମ୍ୟାକଡୋନାଲ୍ଡ ଦ୍ୱୀପପୁଞ୍ଜ";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਹਰਡ ਤੇ ਮੈਕਡੋਨਾਲਡ ਟਾਪੂ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "هارډ او ميکډانلډ ټاپوګان";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "Inslas da Heard e da McDonald";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Insula Heard și Insulele McDonald";
        ...
        test("has translation for 'sd' locale", () {
          const expectedName = "هرڊ ۽ مڪڊونلڊ ٻيٽ";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Heard- ja McDonald-sullot";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "හර්ඩ් දූපත සහ මැක්ඩොනල්ඩ් දූපත්";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "Heardov otok in McDonaldovi otoki";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Jasiiradda Haad & MakDonald";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Ishujt Hërd e Mekdonald";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Kisiwa cha Heard na Visiwa vya McDonald";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "ஹேர்ட் மற்றும் மெக்டொனால்டு தீவுகள்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "హెర్డ్ దీవి మరియు మెక్‌డొనాల్డ్ దీవులు";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Ҷазираи Ҳерд ва Ҷазираҳои Макдоналд";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "เกาะเฮิร์ดและหมู่เกาะแมกดอนัลด์";
        ...
        test("has translation for 'ti' locale", () {
          const expectedName = "ደሴታት ሀርድን ማክዶናልድን";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Herd we Makdonald adalary";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "ʻOtumotu Heati mo Makitonali";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Херд утравы һәм Макдональд утраулары";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ھېرد ئارىلى ۋە ماكدونالد ئاراللىرى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Острови Герд і Макдоналд";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Xerd va Makdonald orollari";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Quần đảo Heard và McDonald";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Duni Hërd ak Duni MakDonald";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "I-Heard & McDonald Island";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Херд тата Макдональд утравӗ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤕𞤵𞤪𞤭𞥅𞤶𞤫 𞤖𞤭𞤪𞤣𞤭 & 𞤃𞤢𞤳𞤣𞤮𞤲𞤢𞤤";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Tsibirin Heard da McDonald";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Insulas Heard e McDonald";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Giravên Heard û MacDonaldê";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Ngā Moutere Heriti me Makitānara";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Ìsulas Heard e McDonald";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Heard & McDonald Islands";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "EHeard & McDonald Islands";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Erékùsù Heard àti Erékùsù McDonald";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "ад-хақәа Херди Макдональди";
        ...
        test("has translation for 'ie' locale", () {
          const expectedName = "Insules Heard e McDonald Islands";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Illas Heard e McDonald";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Херд ва Макдоналд ороллари";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Һерд вә Макдоналд адалары";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Херд и Мекдоналд Острва";
