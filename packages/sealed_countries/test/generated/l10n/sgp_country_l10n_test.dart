...
void main() => group(
      "$CountrySgp() L10N",
      () {
        const value = CountrySgp();

        test("has translation for 'en' locale", () {
          const expectedName = "Singapore";
          const expectedFullName = "Republic of Singapore";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Сингапур";
          const expectedFullName = "Република Сингапур";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "سنغافورة";
          const expectedFullName = "جمهورية سنغافورة";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Singapour";
          const expectedFullName = "Republik Singapour";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Singapur";
          const expectedFullName = "Singapurská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Singapur";
          const expectedFullName = "Republik Singapur";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Singapur";
          const expectedFullName = "Singapuri Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Singapore";
          const expectedFullName = "Singaporen tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Singapour";
          const expectedFullName = "République de Singapour";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Singapur";
          const expectedFullName = "Republika Singapur";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Szingapúr";
          const expectedFullName = "Szingapúri Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Singapore";
          const expectedFullName = "Repubblica di Singapore";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "シンガポール";
          const expectedFullName = "シンガポール共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "싱가포르";
          const expectedFullName = "싱가포르 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Singapore";
          const expectedFullName = "Republiek Singapore";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "سنگاپور";
          const expectedFullName = "جمهوری سنگاپور";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Singapur";
          const expectedFullName = "Republika Singapuru";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Singapura";
          const expectedFullName = "República de Singapura";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Сингапур";
          const expectedFullName = "Республика Сингапур";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Singapur";
          const expectedFullName = "República de Singapur";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Singapore";
          const expectedFullName = "Republiken Singapore";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Singapur";
          const expectedFullName = "Singapur Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "سنگاپور";
          const expectedFullName = "جمہوریہ سنگاپور";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "新加坡";
          const expectedFullName = "新加坡共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Singapɔr nutome";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "සිංගප්පූරුව";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "சிங்கப்பூர்";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Singapo";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Singapore";
        ...
        test("has translation for 'sa' locale", () {
          const expectedName = "सिङ्गापुरम्";
        ...
        test("has translation for 'ss' locale", () {
          const expectedName = "ISingapholo";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Sinhgyahboh";
        ...
        test("has translation for 'ks_Arab' locale", () {
          const expectedName = "ٛسِنٛگاپوٗر";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Singapo";
