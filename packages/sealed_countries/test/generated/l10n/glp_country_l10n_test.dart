...
void main() => group(
      "$CountryGlp() L10N",
      () {
        const value = CountryGlp();

        test("has translation for 'en' locale", () {
          const expectedName = "Guadeloupe";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Guadeloupe";
          const expectedFullName = "Guadeloupe’i ja sõltkondade departemang";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Guadeloupe";
          const expectedFullName = "Guadeloupen departmentti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Guadeloupa";
          const expectedFullName = "Guadeloupe";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "グアドループ";
          const expectedFullName = "グアドループ島";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "གོ་ཌེ་ལུ་པེ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Guadelupe nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Γουαδελούπη";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Gvadelúpeyjar";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ഗ്വാഡലൂപ്പ്";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "ग्वाडेलोउपे";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Gadelope";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Guadeloupe";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "EGuadeloupe";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Gadelope";
