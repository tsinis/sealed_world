...
void main() => group(
      "$CountryMkd() L10N",
      () {
        const value = CountryMkd();

        test("has translation for 'en' locale", () {
          const expectedName = "North Macedonia";
          const expectedFullName = "Republic of North Macedonia";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Северна Македонија";
          const expectedFullName = "Република Северна Македонија";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "شمال مقدونيا";
          const expectedFullName = "جمهورية شمال مقدونيا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Makedonia an Norzh";
          const expectedFullName = "Republik Makedonia an Norzh";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Severní Makedonie";
          const expectedFullName = "Republika Severní Makedonie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Nordmazedonien";
          const expectedFullName = "Republik Nordmazedonien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Põhja-Makedoonia";
          const expectedFullName = "Põhja-Makedoonia Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Pohjois-Makedonia";
          const expectedFullName = "Pohjois-Makedonian tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Macédoine du Nord";
          const expectedFullName = "République de Macédoine du Nord";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Sjeverna Makedonija";
          const expectedFullName = "Republika Sjeverna Makedonija";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Észak-Macedónia";
          const expectedFullName = "Észak-macedón Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Macedonia del Nord";
          const expectedFullName = "Repubblica di Macedonia del Nord";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "北マケドニア ";
          const expectedFullName = "北マケドニア共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "북마케도니아";
          const expectedFullName = "북마케도니아 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Noord-Macedonië";
          const expectedFullName = "Republiek Noord-Macedonië";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "مقدونیه شمالی";
          const expectedFullName = "جمهوری مقدونیه شمالی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Macedonia Północna";
          const expectedFullName = "Republika Macedonii Północnej";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Macedónia do Norte";
          const expectedFullName = "República da Macedônia do Norte";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Северная Македония";
          const expectedFullName = "Республика Северная Македония";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Severné Macedónsko";
          const expectedFullName = "Severomacedónska republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Macedonia del Norte";
          const expectedFullName = "República de Macedonia del Norte";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Nordmakedonien";
          const expectedFullName = "Republiken Nordmakedonien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Kuzey Makedonya";
          const expectedFullName = "Kuzey Makedonya Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "شمالی مقدونیہ";
          const expectedFullName = "جمہوریہ مقدونیہ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "北馬其頓";
          const expectedFullName = "北馬其頓共和國";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "উত্তৰ মেচিডোনীয়া";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Şimali Makedoniya";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Паўночная Македонія";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Северна Македония";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "উত্তর ম্যাসেডোনিয়া";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "Macedònia del Nord";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Βόρεια Μακεδονία";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Ipar Mazedonia";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Mhacadóin Thuaidh";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "A’ Mhasadon a Tuath";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Macedonia do Norte";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "ઉત્તર મેસેડોનિયા";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Macedonia ta Arewa";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "מקדוניה הצפונית";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "उत्तरी मकदूनिया";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Հյուսիսային Մակեդոնիա";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Makedonia Utara";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Norður-Makedónía";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ჩრდილოეთ მაკედონია";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Солтүстік Македония";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ម៉ាសេដ្វានខាងជើង";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಉತ್ತರ ಮ್ಯಾಸಿಡೋನಿಯಾ";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Түндүк Македония";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ແມຊິໂດເນຍເໜືອ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Šiaurės Makedonija";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Ziemeļmaķedonija";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Makerōnia ki te Raki";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "നോർത്ത് മാസിഡോണിയ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Хойд Македон";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "उत्तर मॅसेडोनिया";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Macedonia Utara";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Maċedonja ta’ Fuq";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "မြောက် မက်ဆီဒိုးနီးယား";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "Nord-Makedonia";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "उत्तर म्यासेडोनिया";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଉତ୍ତର ମାସେଡୋନିଆ";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਉੱਤਰੀ ਮੈਕਡੋਨੀਆ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "شمالي مقدونيه";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Macedonia de Nord";
        ...
        test("has translation for 'rw' locale", () {
          const expectedName = "Masedoniya y’Amajyaruguru";
        ...
        test("has translation for 'sd' locale", () {
          const expectedName = "شمالي مقدونيا";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "උතුරු මැසිඩෝනියාව";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "Severna Makedonija";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Masedooniya Waqooyi";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Maqedonia e Veriut";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Masedonia ya Kaskazini";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "வடக்கு மாசிடோனியா";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "ఉత్తర మాసిడోనియా";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Македонияи Шимолӣ";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "มาซิโดเนียเหนือ";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Demirgazyk Makedoniýa";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Masetōnia fakatokelau";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Төньяк Македония";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "شىمالىي ماكېدونىيە";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Північна Македонія";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Shimoliy Makedoniya";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Bắc Macedonia";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Maseduwaan bëj Gànnaar";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "uMntla Macedonia";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Àríwá Macedonia";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-North Macedonia";
        ...
        test("has translation for 'an' locale", () {
          const expectedName = "Republica de Macedonia";
        ...
        test("has translation for 'ba' locale", () {
          const expectedName = "Македония Республикаһы";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "མ་སེ་ཌོ་ནིཡ། (རྒྱལ་ཁབ།)";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Македони Республики";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "མ་སེ་ཌོ་ནི་ཡ་ [ཡུ་གོ་སླཱ་བི་ཡ]";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Nord-Makedonio";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Noard-Masedoanje";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Massadoan Hwoaie";
        ...
        test("has translation for 'ht' locale", () {
          const expectedName = "Repiblik d Masedoni";
        ...
        test("has translation for 'io' locale", () {
          const expectedName = "Republiko Macedonia";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Républik Makedonia";
        ...
        test("has translation for 'kv' locale", () {
          const expectedName = "Македония Республика";
        ...
        test("has translation for 'kw' locale", () {
          const expectedName = "Repoblek Makedoni";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Macedonia Septentrionalis";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Republica de Macedònia";
        ...
        test("has translation for 'os' locale", () {
          const expectedName = "Республикæ Македони";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Davvi-Makedonia";
        ...
        test("has translation for 'ss' locale", () {
          const expectedName = "IMakhedoniya";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Republika ng Masedonya";
        ...
        test("has translation for 'vo' locale", () {
          const expectedName = "Nolüda-Makedoniyän";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "רעפובליק פון מאקעדאניע";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Аҩадатәи Македониа";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "شُمالی میسڈونیا";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Bwz Majgizdun";
        ...
        test("has translation for 'bm_Latn' locale", () {
          const expectedName = "Macedɔni";

          final translated = value.maybeTranslation(
            const BasicTypedLocale(LangBam(), script: ScriptLatn()),
            useLanguageFallback: false,
          );
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Сјеверна Македонија";
        ...
        test("has translation for 'ha_Latn' locale", () {
          const expectedName = "Masedoniya";
        ...
        test("has translation for 'ks_Arab' locale", () {
          const expectedName = "مٮ۪سوڑونِیا";
        ...
        test("has translation for 'ms_Latn' locale", () {
          const expectedName = "Macedonia";

          final translated = value.maybeTranslation(
            const BasicTypedLocale(LangMsa(), script: ScriptLatn()),
            useLanguageFallback: false,
          );
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Шимолий Македония";
