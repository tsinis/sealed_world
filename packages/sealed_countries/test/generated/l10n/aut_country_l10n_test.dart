...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Austria";
          const expectedFullName = "Republic of Austria";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Аустрија";
          const expectedFullName = "Република Аустрија";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "النمسا";
          const expectedFullName = "جمهورية النمسا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Aostria";
          const expectedFullName = "Republik Aostria";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Rakousko";
          const expectedFullName = "Rakouská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Awstria";
          const expectedFullName = "Gweriniaeth Awstria";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Österreich";
          const expectedFullName = "Republik Österreich";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Austria";
          const expectedFullName = "Austria Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Itävalta";
          const expectedFullName = "Itävallan tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Autriche";
          const expectedFullName = "République d'Autriche";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Austrija";
          const expectedFullName = "Republika Austrija";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Austria";
          const expectedFullName = "Repubblica d'Austria";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "オーストリア";
          const expectedFullName = "オーストリア共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "오스트리아";
          const expectedFullName = "오스트리아 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Oostenrijk";
          const expectedFullName = "Republiek Oostenrijk";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "اتریش";
          const expectedFullName = "جمهوری اتریش";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Austria";
          const expectedFullName = "Republika Austrii";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Áustria";
          const expectedFullName = "República da Áustria";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Австрия";
          const expectedFullName = "Австрийская Республика";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Rakúsko";
          const expectedFullName = "Rakúska republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Austria";
          const expectedFullName = "República de Austria";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Österrike";
          const expectedFullName = "Republiken Österrike";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Avusturya";
          const expectedFullName = "Avusturya Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "آسٹریا";
          const expectedFullName = "جمہوریہ آسٹریا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "奥地利";
          const expectedFullName = "奥地利共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Austria nutome";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Awusituriya";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Nuortariika";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ඔස්ට්‍රියාව";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ئاۋىستىرىيە";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Asítíríà";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ཨོ་སི་ཐྲི་ཡ།";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Asítíríà";
