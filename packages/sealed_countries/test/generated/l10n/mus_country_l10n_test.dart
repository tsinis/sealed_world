...
void main() => group(
      "$CountryMus() L10N",
      () {
        const value = CountryMus();

        test("has translation for 'en' locale", () {
          const expectedName = "Mauritius";
          const expectedFullName = "Republic of Mauritius";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Маурицијус";
          const expectedFullName = "Република Маурицијус";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "موريشيوس";
          const expectedFullName = "جمهورية موريشيوس";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Moris";
          const expectedFullName = "Republik Moris";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Mauricius";
          const expectedFullName = "Mauricijská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Mauritius";
          const expectedFullName = "Republik Mauritius";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Mauritius";
          const expectedFullName = "Mauritiuse Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Mauritius";
          const expectedFullName = "Mauritiuksen tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Île Maurice";
          const expectedFullName = "République de Maurice";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Mauricijus";
          const expectedFullName = "Republika Mauricijus";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Mauritius";
          const expectedFullName = "Mauritiusi Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Mauritius";
          const expectedFullName = "Repubblica di Mauritius";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "モーリシャス";
          const expectedFullName = "モーリシャス共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "모리셔스";
          const expectedFullName = "모리셔스 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Mauritius";
          const expectedFullName = "Republiek Mauritius";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "موریس";
          const expectedFullName = "جمهوری موریس";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Mauritius";
          const expectedFullName = "Republika Mauritiusu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Maurício";
          const expectedFullName = "República das Maurícias";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Маврикий";
          const expectedFullName = "Республика Маврикий";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Maurícius";
          const expectedFullName = "Maurícijská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Mauricio";
          const expectedFullName = "República de Mauricio";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Mauritius";
          const expectedFullName = "Republiken Mauritius";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Mauritius";
          const expectedFullName = "Mauritius Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "موریشس";
          const expectedFullName = "جمہوریہ موریشس";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "毛里求斯";
          const expectedFullName = "毛里求斯共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "mauritiusdukɔ";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Oileán Mhuirís";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Na h-Eileanan Mhoiriseas";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Mawulisyasi";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Izinga rya Morise";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Mawrishiyaas";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Maritiusi";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Mauritius";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "མའུ་རི་ཊིའུ་སུ།";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Ellan Wirrish";
        ...
        test("has translation for 'kw' locale", () {
          const expectedName = "Ynys Morrys";
        ...
        test("has translation for 'ss' locale", () {
          const expectedName = "IMorishiyasi";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Maritiusi";
