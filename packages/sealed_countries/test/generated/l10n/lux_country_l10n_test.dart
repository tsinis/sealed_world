...
void main() => group(
      "$CountryLux() L10N",
      () {
        const value = CountryLux();

        test("has translation for 'en' locale", () {
          const expectedName = "Luxembourg";
          const expectedFullName = "Grand Duchy of Luxembourg";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Луксембург";
          const expectedFullName = "Велико Војводство Луксембург";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "لوكسمبورغ";
          const expectedFullName = "دوقية لوكسمبورغ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Luksembourg";
          const expectedFullName = "Dugelezh Veur Luksembourg";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Lucembursko";
          const expectedFullName = "Lucemburské velkovévodství";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Luxemburg";
          const expectedFullName = "Großherzogtum Luxemburg,";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Luksemburg";
          const expectedFullName = "Luksemburgi Suurhertsogiriik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Luxemburg";
          const expectedFullName = "Luxemburgin suurherttuakunta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Luxembourg";
          const expectedFullName = "Grand-Duché de Luxembourg";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Luksemburg";
          const expectedFullName = "Veliko Vojvodstvo Luksemburg";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Luxemburg";
          const expectedFullName = "Luxemburgi Nagyhercegség";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Lussemburgo";
          const expectedFullName = "Granducato di Lussemburgo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ルクセンブルク";
          const expectedFullName = "ルクセンブルク大公国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "룩셈부르크";
          const expectedFullName = "룩셈부르크 대공국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Luxemburg";
          const expectedFullName = "Groothertogdom Luxemburg";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "لوکزامبورگ";
          const expectedFullName = "دوک‌نشین لوکزامبورگ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Luksemburg";
          const expectedFullName = "Wielkie Księstwo Luksemburga";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Luxemburgo";
          const expectedFullName = "Grão-Ducado do Luxemburgo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Люксембург";
          const expectedFullName = "Великое Герцогство Люксембург";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Luxembursko";
          const expectedFullName = "Luxemburské veľkovojvodstvo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Luxemburgo";
          const expectedFullName = "Gran Ducado de Luxemburgo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Luxemburg";
          const expectedFullName = "Storhertigdömet Luxemburg";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Lüksemburg";
          const expectedFullName = "Lüksemburg Büyük Dükalığı";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "لکسمبرگ";
          const expectedFullName = "دوقیہ کبیرلکسمبرگ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "卢森堡";
          const expectedFullName = "卢森堡大公国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "লাক্সেমবাৰ্গ";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Likisanburu";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "লাক্সেমবার্গ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Lazembɔg nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Λουξεμβούργο";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Luksemburgo";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Լյուքսեմբուրգ";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ლუქსემბურგი";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಲಕ್ಸೆಂಬರ್ಗ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "لَکسَمبٔرٕگ";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Lukisembaaga";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Likisambulu";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Liuksemburgas";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Luksemburga";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Lioksamboro";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Lussemburgu";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Lukusamburu";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ලක්ශම්බර්ග්";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Luksemboorg";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "லக்ஸ்சம்பர்க்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "లక్సెంబర్గ్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ลักเซมเบิร์ก";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Lýuksemburg";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Lakisimipeki";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "لىيۇكسېمبۇرگ";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Lyuksemburg";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Lusemogi";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Luxembourg";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ལུ་སེམ་བའུརག";
        ...
        test("has translation for 'co' locale", () {
          const expectedName = "Lussemburgu";
        ...
        test("has translation for 'cu' locale", () {
          const expectedName = "Люѯємбоургъ";
        ...
        test("has translation for 'ie' locale", () {
          const expectedName = "Luxemburgia";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Luxemburgum";
        ...
        test("has translation for 'na' locale", () {
          const expectedName = "Ruketemburg";
        ...
        test("has translation for 'rw' locale", () {
          const expectedName = "Lugizamburu";
        ...
        test("has translation for 'vo' locale", () {
          const expectedName = "Luxämburgän";
        ...
        test("has translation for 'wa' locale", () {
          const expectedName = "Grande-Dutcheye do Lussimbork";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "ELuxembourg";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Лиуксембург";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Luzswnhbauj";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Lusemogi";
