...
void main() => group(
      "$CountryBlz() L10N",
      () {
        const value = CountryBlz();

        test("has translation for 'en' locale", () {
          const expectedName = "Belize";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Belize nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Bèlísẹ̀";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Bèlísɛ̀";
