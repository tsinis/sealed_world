...
void main() => group(
      "$CountryMco() L10N",
      () {
        const value = CountryMco();

        test("has translation for 'en' locale", () {
          const expectedName = "Monaco";
          const expectedFullName = "Principality of Monaco";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Монако";
          const expectedFullName = "Кнежевина Монако";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "موناكو";
          const expectedFullName = "إمارة موناكو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Monako";
          const expectedFullName = "Priñselezh Monako";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Monako";
          const expectedFullName = "Monacké knížectví";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Monaco";
          const expectedFullName = "Fürstentum Monaco";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Monaco";
          const expectedFullName = "Monaco Vürstiriik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Monaco";
          const expectedFullName = "Monacon ruhtinaskunta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Monaco";
          const expectedFullName = "Principauté de Monaco";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Monako";
          const expectedFullName = "Kneževina Monako";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Monaco";
          const expectedFullName = "Monacói Hercegség";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Principato di Monaco";
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "モナコ";
          const expectedFullName = "モナコ公国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "모나코";
          const expectedFullName = "모나코 공국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Monaco";
          const expectedFullName = "Vorstendom Monaco";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "موناکو";
          const expectedFullName = "شاهزاده‌نشین موناکو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Monako";
          const expectedFullName = "Księstwo Monako";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Mónaco";
          const expectedFullName = "Principado do Mónaco";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Монако";
          const expectedFullName = "Княжество Монако";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Monako";
          const expectedFullName = "Monacké kniežatstvo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Mónaco";
          const expectedFullName = "Principado de Mónaco";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Monaco";
          const expectedFullName = "Furstendömet Monaco";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Monako";
          const expectedFullName = "Monako Prensliği";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "موناکو";
          const expectedFullName = "جمہوریہ مناکو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "摩纳哥";
          const expectedFullName = "摩纳哥公国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Monako nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Monako";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Monako";
