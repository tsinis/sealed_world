...
void main() => group(
      "$CountryBra() L10N",
      () {
        const value = CountryBra();

        test("has translation for 'en' locale", () {
          const expectedName = "Brazil";
          const expectedFullName = "Federative Republic of Brazil";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Бразил";
          const expectedFullName = "Савезна Република Бразил";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "البرازيل";
          const expectedFullName = "جمهورية البرازيل الاتحادية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Brazil";
          const expectedFullName = "Republik Kevreel Brazil";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Brazílie";
          const expectedFullName = "Brazilská federativní republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Brasil";
          const expectedFullName = "Gweriniaeth Ffederal Brasil";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Brasilien";
          const expectedFullName = "Föderative Republik Brasilien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Brasiilia";
          const expectedFullName = "Brasiilia Liitvabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Brasilia";
          const expectedFullName = "Brasilian liittotasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Brésil";
          const expectedFullName = "République fédérative du Brésil";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Brazil";
          const expectedFullName = "Savezne Republike Brazil";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Brazília";
          const expectedFullName = "Brazil Szövetségi Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Brasile";
          const expectedFullName = "Repubblica federativa del Brasile";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ブラジル";
          const expectedFullName = "ブラジル連邦共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "브라질";
          const expectedFullName = "브라질 연방 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Brazilië";
          const expectedFullName = "Federale Republiek Brazilië";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "برزیل";
          const expectedFullName = "جمهوری فدراتیو برزیل";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Brazylia";
          const expectedFullName = "Federacyjna Republika Brazylii";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Brasil";
          const expectedFullName = "República Federativa do Brasil";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Бразилия";
          const expectedFullName = "Федеративная Республика Бразилия";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Brazília";
          const expectedFullName = "Brazílska federatívna republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Brasil";
          const expectedFullName = "República Federativa del Brasil";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Brasilien";
          const expectedFullName = "Förbundsrepubliken Brasilien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Brezilya";
          const expectedFullName = "Brezilya Federal Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "برازیل";
          const expectedFullName = "وفاقی جمہوریہ برازیل";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "巴西";
          const expectedFullName = "巴西联邦共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Brazil nutome";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Bhrasaíl";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orilẹ̀-èdè Bàràsílì";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "yn Vrasseel";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orilɛ̀-èdè Bàràsílì";
