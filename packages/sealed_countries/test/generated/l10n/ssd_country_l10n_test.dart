...
void main() => group(
      "$CountrySsd() L10N",
      () {
        const value = CountrySsd();

        test("has translation for 'en' locale", () {
          const expectedName = "South Sudan";
          const expectedFullName = "Republic of South Sudan";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Јужни Судан";
          const expectedFullName = "Република Јужни Судан";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "جنوب السودان";
          const expectedFullName = "جمهورية جنوب السودان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Soudan ar Su";
          const expectedFullName = "Republik Soudan ar Su";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Jižní Súdán";
          const expectedFullName = "Jihosúdánská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Südsudan";
          const expectedFullName = "Republik Südsudan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Lõuna-Sudaan";
          const expectedFullName = "Lõuna-Sudaani Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Etelä-Sudan";
          const expectedFullName = "Etelä-Sudanin tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Soudan du Sud";
          const expectedFullName = "République du Soudan du Sud";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Južni Sudan";
          const expectedFullName = "Republika Južni Sudan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Dél-Szudán";
          const expectedFullName = "Dél-szudáni Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Sudan del sud";
          const expectedFullName = "Repubblica del Sudan del Sud";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "南スーダン";
          const expectedFullName = "南スーダン共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "남수단";
          const expectedFullName = "남수단 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Zuid-Soedan";
          const expectedFullName = "Republiek Zuid-Soedan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "سودان جنوبی";
          const expectedFullName = "جمهوری سودان جنوبی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          ...
          const expectedFullName = "Republika Sudanu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Sudão do Sul";
          const expectedFullName = "República do Sudão do Sul";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Южный Судан";
          const expectedFullName = "Республика Южный Судан";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Južný Sudán";
          const expectedFullName = "Juhosudánska republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Sudán del Sur";
          const expectedFullName = "República de Sudán del Sur";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Sydsudan";
          const expectedFullName = "Republiken Sydsudan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Güney Sudan";
          const expectedFullName = "Güney Sudan Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "جنوبی سوڈان";
          const expectedFullName = "جمہوریہ جنوبی سوڈان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "南苏丹";
          const expectedFullName = "南苏丹共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Suid-Soedan";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "দক্ষিণ চুডান";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Cənubi Sudan";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Паўднёвы Судан";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "দক্ষিণ সুদান";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Къилба Судан";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "སཱའུཐ་ སུ་ཌཱན";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Νότιο Σουδάν";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an tSúdáin Theas";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Sudàn a Deas";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "O Sudán do Sur";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "દક્ષિણ સુદાન";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Sudan ta kudu";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "दक्षिण सूडान";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Հարավային Սուդան";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Sudan Selatan";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Suður-Súdan";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Sudan Kidul";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "სამხრეთ სუდანი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Оңтүстік Судан";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ស៊ូដង់​ខាង​ត្បូង";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ದಕ್ಷಿಣ ಸುಡಾನ್";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Sûdana Başûr";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Түштүк Судан";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Pietų Sudanas";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Dienvidsudāna";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Јужен Судан";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ദക്ഷിണ സുഡാൻ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Өмнөд Судан";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "दक्षिण सुदान";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "is-Sudan t’Isfel";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "တောင် ဆူဒန်";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "दक्षिण सुडान";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଦକ୍ଷିଣ ସୁଦାନ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "سويلي سوډان";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Sudanul de Sud";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "දකුණු සුඩානය";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Koonfur Suudaan";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Sudani i Jugut";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Sudan Kusini";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "தெற்கு சூடான்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "దక్షిణ సూడాన్";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Судони Ҷанубӣ";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Günorta Sudan";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Sūtani fakatonga";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Көньяк Судан";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "جەنۇبىي سۇدان";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Південний Судан";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Janubiy Sudan";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Sudaŋ di Sid";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "דרום־סודאַן";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Gúúsù Sudan";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-South Sudan";
        ...
        test("has translation for 'an' locale", () {
          const expectedName = "Sudán d'o Sud";
        ...
        test("has translation for 'av' locale", () {
          const expectedName = "Югалъулаб Судан";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Кăнтăр Судан";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Suda Sudano";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Toodaan Yiass";
        ...
        test("has translation for 'kv' locale", () {
          const expectedName = "Лунвыв Судан";
        ...
        test("has translation for 'kw' locale", () {
          const expectedName = "Soudan Soth";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Sudania Australis";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Shádiʼááhjí Soodą́ą";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Sodan del Sud";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "Sudan dal Sid";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Sudan Meridionali";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Sudäan-Mbongo";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Timog Sudan";
        ...
        test("has translation for 'vo' locale", () {
          const expectedName = "Sulüda-Sudän";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤅𞤵𞤣𞤢𞥄𞤲 𞤂𞤫𞤧𞤤𞤫𞤴𞤪𞤭";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Hūtāne ki te Tonga";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "ESouth Sudan";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Аладатәи Судан";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Anyiehe Sudan nutome";
        ...
        test("has translation for 'kl' locale", () {
          const expectedName = "Kujalleqsudan";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Sudani ya Sidi";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Nanz Suhdanh";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Ҹәнуби Судан";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Жанубий Судан";
