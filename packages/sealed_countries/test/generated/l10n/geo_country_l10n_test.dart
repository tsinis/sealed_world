...
void main() => group(
      "$CountryGeo() L10N",
      () {
        const value = CountryGeo();

        test("has translation for 'en' locale", () {
          const expectedName = "Georgia";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Jorjia";
          const expectedFullName = "Republik Jorjia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Géorgie";
          const expectedFullName = "République de Géorgie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Georgië";
          const expectedFullName = "Georgia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Georgia nutome";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an tSeoirsia";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "A’ Chairtbheil";
        ...
        test("has translation for 'os' locale", () {
          const expectedName = "Гуырдзыстон";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Gọgia";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "འཇོར་ཇི་ཡ། (རྒྱལ་ཁབ།)";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "ޖޯޖިޔާ (ޤައުމު)";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Georgia (land)";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Çhorshey";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Jóojah (Kéyah)";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Georgia (Caucàs)";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Gwzlujgizya";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Gɔgia";
