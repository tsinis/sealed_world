...
void main() => group(
      "$CountryEsp() L10N",
      () {
        const value = CountryEsp();

        test("has translation for 'en' locale", () {
          const expectedName = "Spain";
          const expectedFullName = "Kingdom of Spain";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Шпанија";
          const expectedFullName = "Краљевина Шпанија";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "إسبانيا";
          const expectedFullName = "مملكة إسبانيا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Spagn";
          const expectedFullName = "Rouantelezh Spagn";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Španělsko";
          const expectedFullName = "Španělské království";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Spanien";
          const expectedFullName = "Königreich Spanien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          ...
          const expectedFullName = "Hispaania Kuningriik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          ...
          const expectedFullName = "Espanjan kuningaskunta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Espagne";
          const expectedFullName = "Royaume d'Espagne";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Španjolska";
          const expectedFullName = "Kraljevina Španjolska";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Spanyolország";
          const expectedFullName = "Spanyol Királyság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Spagna";
          const expectedFullName = "Regno di Spagna";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "スペイン";
          const expectedFullName = "スペイン王国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "스페인";
          const expectedFullName = "에스파냐 왕국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Spanje";
          const expectedFullName = "Koninkrijk Spanje";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "اسپانیا";
          const expectedFullName = "پادشاهی اسپانیا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Hiszpania";
          const expectedFullName = "Królestwo Hiszpanii ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Espanha";
          const expectedFullName = "Reino de Espanha";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Испания";
          const expectedFullName = "Королевство Испания";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Španielsko";
          const expectedFullName = "Španielske kráľovstvo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "España";
          const expectedFullName = "Reino de España";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Spanien";
          const expectedFullName = "Konungariket Spanien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "İspanya";
          const expectedFullName = "İspanya Krallığı";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "ہسپانیہ";
          const expectedFullName = "مملکتِ ہسپانیہ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "西班牙";
          const expectedFullName = "西班牙王国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Spain nutome";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tây Ban Nha";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Sipani";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Spaainey";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Dibé Diníí Bikéyah";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Sipani";
