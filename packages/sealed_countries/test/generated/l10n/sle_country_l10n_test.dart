...
void main() => group(
      "$CountrySle() L10N",
      () {
        const value = CountrySle();

        test("has translation for 'en' locale", () {
          const expectedName = "Sierra Leone";
          const expectedFullName = "Republic of Sierra Leone";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Сијера Леоне";
          const expectedFullName = "Република Сијера Леоне";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "سيراليون";
          const expectedFullName = "جمهورية سيراليون";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Sierra Leone";
          const expectedFullName = "Republik Sierra Leone";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Sierra Leone";
          const expectedFullName = "Republika Sierra Leone";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Sierra Leone";
          const expectedFullName = "Sierra Leone Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Sierra Leone";
          const expectedFullName = "Sierra Leonen tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Sierra Leone";
          const expectedFullName = "République de Sierra Leone";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Sijera Leone";
          const expectedFullName = "Republika Sijera Leone";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Sierra Leone";
          const expectedFullName = "Sierra Leone Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Sierra Leone";
          const expectedFullName = "Repubblica della Sierra Leone";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "シエラレオネ";
          const expectedFullName = "シエラレオネ共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "시에라리온";
          const expectedFullName = "시에라리온 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Sierra Leone";
          const expectedFullName = "Republiek Sierra Leone";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "سیرالئون";
          const expectedFullName = "جمهوری سیرالئون";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Serra Leoa";
          const expectedFullName = "República da Serra Leoa";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Сьерра-Леоне";
          const expectedFullName = "Республика Сьерра-Леоне";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Sierra Leone";
          const expectedFullName = "Sierraleonská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Sierra Leone";
          const expectedFullName = "República de Sierra Leona";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Sierra Leone";
          const expectedFullName = "Republiken Sierra Leone";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Sierra Leone";
          const expectedFullName = "Sierra Leone Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "سیرالیون";
          const expectedFullName = "جمہوریہ سیرالیون";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "塞拉利昂";
          const expectedFullName = "塞拉利昂共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "চিয়েৰা লিঅ’ন";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Syerra-Leone";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Сьера-Леонэ";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Сиера Леоне";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Siyera Lewɔni";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "সিয়েরা লিওন";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "སི་ར་ ལི་འོན";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Sierra Leone nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Σιέρα Λεόνε";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Siera-Leono";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Sierra Leona";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Seraa liyon";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Siarra Leon";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Siarra Leòmhann";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "סיירה לאונה";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "सिएरा लियोन";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Սիեռա Լեոնե";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Síerra Leóne";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Siéra Léoné";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "სიერა-ლეონე";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Siera Leoni";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಸಿಯೆರ್ರಾ ಲಿಯೋನ್";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Siyeralewone";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Siera Leonɛ";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ເຊຍຣາ ລີໂອນ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Siera Leonė";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Siera Leone";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Sjerraleone";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "സിയെറ ലിയോൺ";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဆီယာရာ လီယွန်း";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "सिएर्रा लिओन";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Sierä-Leône";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "සියරාලියෝන්";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Siraaliyoon";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "சியாரா லியோன்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "సియెర్రా లియాన్";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Сиерра-Леоне";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "เซียร์ราลีโอน";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Sýerra-Leone";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Siela Leone";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Сьєрра-Леоне";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Siyera Lewon";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "סיערע לעאנע";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Siria looni";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Sierra Leone";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "སི་ར་ལེ་ཨོན།";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Sierra Leöane";
        ...
        test("has translation for 'kw' locale", () {
          const expectedName = "Sierra Leon";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Mons Leoninus";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Náshdóítsoh Bitsiijįʼ Daditłʼooʼígíí Bidził";
        ...
        test("has translation for 'os' locale", () {
          const expectedName = "Сьеррæ-Леоне";
        ...
        test("has translation for 'rw' locale", () {
          const expectedName = "Siyera Lewone";
        ...
        test("has translation for 'sa' locale", () {
          const expectedName = "सियारा-लियोन";
        ...
        test("has translation for 'ss' locale", () {
          const expectedName = "ISiriya-Liyoni";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Bulubunduking Leona";
        ...
        test("has translation for 'ts' locale", () {
          const expectedName = "Siyera Liyona";
        ...
        test("has translation for 'vo' locale", () {
          const expectedName = "Sieraleonän";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "ESierra Leone";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Сјерра-Леоне";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Siria looni";
