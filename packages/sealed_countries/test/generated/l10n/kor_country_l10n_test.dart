...
void main() => group(
      "$CountryKor() L10N",
      () {
        const value = CountryKor();

        test("has translation for 'en' locale", () {
          const expectedName = "South Korea";
          const expectedFullName = "Republic of Korea";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Јужна Кореја";
          const expectedFullName = "Република Кореја";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "كوريا الجنوبية";
          const expectedFullName = "جمهورية كوريا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Korea ar Su";
          const expectedFullName = "Republik Korea";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Jižní Korea";
          const expectedFullName = "Korejská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Lõuna-Korea";
          const expectedFullName = "Korea Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Etelä-Korea";
          const expectedFullName = "Korean tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Corée du Sud";
          const expectedFullName = "République de Corée";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Južna Koreja";
          const expectedFullName = "Republika Koreja";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Dél-Korea";
          const expectedFullName = "Koreai Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Corea del Sud";
          const expectedFullName = "Repubblica di Corea";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "韓国";
          const expectedFullName = "大韓民国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "한국";
          const expectedFullName = "대한민국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Zuid-Korea";
          const expectedFullName = "Republiek Korea";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "کرهٔ جنوبی";
          const expectedFullName = "جمهوری کره";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Korea Południowa";
          const expectedFullName = "Republika Korei";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Coreia do Sul";
          const expectedFullName = "República da Coreia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Южная Корея";
          const expectedFullName = "Республика Корея";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Južná Kórea";
          const expectedFullName = "Kórejská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Corea del Sur";
          const expectedFullName = "República de Corea";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Sydkorea";
          const expectedFullName = "Republiken Korea";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Güney Kore";
          const expectedFullName = "Kore Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "جنوبی کوریا";
          const expectedFullName = "جمہوریہ کوریا ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "韩国";
          const expectedFullName = "大韩民国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Anaafo Koria";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "দক্ষিণ কোৰিয়া";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Cənubi Koreya";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Паўднёвая Карэя";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Worodugu Kore";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "দক্ষিণ কোরিয়া";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ལྷོ་ཀོ་རི་ཡ།";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Къилба Корей";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Anyiehe Korea nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Νότια Κορέα";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Koree Worgo";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Chóiré Theas";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Corea do Sur";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "દક્ષિણ કોરિયા";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Koriya Ta Kudu";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "קוריאה הדרומית";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "दक्षिण कोरिया";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Հարավային Կորեա";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Korea Selatan";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Suður-Kórea";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Koréa Kidul";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "სამხრეთ კორეა";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Korea Kusini";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "កូរ៉េ​ខាង​ត្បូង";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ದಕ್ಷಿಣ ಕೊರಿಯಾ";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "جنوٗبی کورِیا";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Korêya Başûr";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Түштүк Корея";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Koreya ey’omumaserengeta";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Korɛ ya súdi";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Pietų Korėja";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Kore wa mwinshi";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Dienvidkoreja";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Korea Atsimo";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ദക്ഷിണകൊറിയ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Өмнөд Солонгос";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Korea t’Isfel";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "တောင်ကိုရီးယား";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଦକ୍ଷିଣ କୋରିଆ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "سویلي کوریا";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "Corea dal Sid";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Koreya y’amajepfo";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Coreea de Sud";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Mátta-Korea";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Korëe tî Mbongo";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "දකුණු කොරියාව";
        ...
        test("has translation for 'sn' locale", () {
          const expectedName = "Korea, South";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Kuuriyada Koonfureed";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Kore e Jugut";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "தென் கொரியா";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "దక్షిణ కొరియా";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Günorta Koreýa";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Kōlea tonga";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Південна Корея";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Janubiy Koreya";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Ariwa Kọria";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-South Korea";
        ...
        test("has translation for 'an' locale", () {
          const expectedName = "Corea d'o Sur";
        ...
        test("has translation for 'ba' locale", () {
          const expectedName = "Көньяҡ Корея";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "ދެކުނު ކޮރެއާ";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Chorea Yiass";
        ...
        test("has translation for 'kl' locale", () {
          const expectedName = "Korea Kujalleq";
        ...
        test("has translation for 'kv' locale", () {
          const expectedName = "Корея Республика";
        ...
        test("has translation for 'kw' locale", () {
          const expectedName = "Korea Dhyhow";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Corea Meridionalis";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Kōrea-ki-te-tonga";
        ...
        test("has translation for 'na' locale", () {
          const expectedName = "Ripubrikin Korea";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Kolíya Bikéyah Shádiʼááhjí Siʼánígíí";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Corèa del Sud";
        ...
        test("has translation for 'os' locale", () {
          const expectedName = "Хуссар Корей";
        ...
        test("has translation for 'rw' locale", () {
          const expectedName = "Koreya y’Amajyepfo";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Corea de su Sud";
        ...
        test("has translation for 'sm' locale", () {
          const expectedName = "Kolea i Saute";
        ...
        test("has translation for 'ss' locale", () {
          const expectedName = "IKhoriya leseNingizimu";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Timog Korea";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Көньяк Корея";
        ...
        test("has translation for 'vo' locale", () {
          const expectedName = "Sulüda-Koreyän";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Kore gu Bëj-saalum";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Корей Республики";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "EMzantsi Korea";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Кореиа Ареспублика";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Ҹәнуби Кореја";
        ...
        test("has translation for 'ha_Latn' locale", () {
          const expectedName = "Koreya Ta Kudu";
        ...
        test("has translation for 'ug_Arab' locale", () {
          const expectedName = "جەنۇبىي كورىيە";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Жанубий Корея";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Ariwa Kɔria";
