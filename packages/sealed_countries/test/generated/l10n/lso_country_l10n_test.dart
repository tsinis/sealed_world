...
void main() => group(
      "$CountryLso() L10N",
      () {
        const value = CountryLso();

        test("has translation for 'en' locale", () {
          const expectedName = "Lesotho";
          const expectedFullName = "Kingdom of Lesotho";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Лесото";
          const expectedFullName = "Краљевина Лесото";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "ليسوتو";
          const expectedFullName = "مملكة ليسوتو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Lesotho";
          const expectedFullName = "Rouantelezh Lesotho";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Lesotho";
          const expectedFullName = "Lesothské království";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Lesotho";
          const expectedFullName = "Königreich Lesotho";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Lesotho";
          const expectedFullName = "Lesotho Kuningriik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Lesotho";
          const expectedFullName = "Lesothon kuningaskunta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Lesotho";
          const expectedFullName = "Royaume du Lesotho";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Lesoto";
          const expectedFullName = "Kraljevina Lesoto";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Lesotho";
          const expectedFullName = "Lesothói Királyság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Lesotho";
          const expectedFullName = "Regno del Lesotho";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "レソト";
          const expectedFullName = "レソト王国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "레소토";
          const expectedFullName = "레소토 왕국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Lesotho";
          const expectedFullName = "Koninkrijk Lesotho";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "لسوتو";
          const expectedFullName = "پادشاهی لسوتو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Lesotho";
          const expectedFullName = "Królestwo Lesotho";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Lesoto";
          const expectedFullName = "Reino do Lesoto";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Лесото";
          const expectedFullName = "Королевство Лесото";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Lesotho";
          const expectedFullName = "Lesothské kráľovstvo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Lesotho";
          const expectedFullName = "Reino de Lesotho";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Lesotho";
          const expectedFullName = "Konungariket Lesotho";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Lesotho";
          const expectedFullName = "Lesotho Krallığı";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "لیسوتھو";
          const expectedFullName = "مملکتِ لیسوتھو";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "莱索托";
          const expectedFullName = "莱索托王国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Lɛsoto nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Lesoto";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Sotho Dineʼé Bikéyah";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Lesoto";
