...
void main() => group(
      "$CountryShn() L10N",
      () {
        const value = CountryShn();

        test("has translation for 'en' locale", () {
          const expectedName = "Saint Helena, Ascension and Tristan da Cunha";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Света Јелена";
          const expectedFullName = "Света Јелена, Асенсион и Тристан да Куња";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "سانت هيلينا وأسينشين وتريستان دا كونا";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Saint Helena, Ascension ha Tristan da Cunha";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Svatá Helena, Ascension a Tristan da Cunha";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "St. Helena, Ascension und Tristan da Cunha";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Saint Helena, Ascension ja Tristan da Cunha";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Sainte-Hélène, Ascension et Tristan da Cunha";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Sveta Helena";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Szent Ilona-sziget";
          const expectedFullName = "Szent Ilona";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Sant'Elena, Ascensione e Tristan da Cunha";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "セントヘレナ・アセンションおよびトリスタンダクーニャ";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Sint-Helena, Ascension en Tristan da Cunha";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Santa Helena, Ascensão e Tristão da Cunha";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Svätá Helena (zámorské územie)";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Santa Elena, Ascensión y Tristán de Acuña";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Sankta Helena";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Saint Helena";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "سینٹ ہلینا، اسینشن و ترسٹان دا کونیا";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "圣赫勒拿、阿森松和特里斯坦-达库尼亚";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Sint Helena";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "ছেইণ্ট হেলেনা";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Müqəddəs Yelena";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Востраў Святой Алены";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Света Елена";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "সেন্ট হেলেনা";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Сийлахьчу Еленин гӀайре";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "སེནཊ་ ཧེ་ལི་ན";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Saint Helena nutome";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Sent-Heleno";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Santa Helena";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Eilean Naomh Eilidh";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "સેંટ હેલેના";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "सेंट हेलेना";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Սուրբ Հեղինեի կղզի";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Sankti Helena";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Saint Héléna";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "წმინდა ელენეს კუნძული";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Santahelena";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Әулие Елена аралы";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಸೇಂಟ್ ಹೆಲೆನಾ";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "سینٹ ہؠلِنا";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Senti Herena";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Sántu eleni";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Šv. Elenos Sala";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Santu eleni";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Sv.Helēnas sala";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Sainte-Hélène";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "സെന്റ് ഹെലീന";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Сент Хелена";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "စိန့်ဟယ်လယ်နာ";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "सेन्ट हेलेना";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ସେଣ୍ଟ ହେଲେନା";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਸੇਂਟ ਹੇਲੇਨਾ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "سینټ هیلینا";
        ...
        test("has translation for 'qu' locale", () {
          const expectedName = "Santa Elena";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "Sontg’Elena";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Sfânta Elena";
        ...
        test("has translation for 'sd' locale", () {
          const expectedName = "سينٽ ھيلينا";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Sênt-Helêna";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ශාන්ත හෙලේනා";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "செயின்ட் ஹெலெனா";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "సెయింట్ హెలెనా";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "เซนต์เฮเลนา";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Keramatly Ýelena adasy";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ساينىت ھېلېنا";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Острів Святої Єлени";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Muqaddas Yelena oroli";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Hẹlena";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-St. Helena";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Saint Helena, Ascension và Tristan da Cunha";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Сӑваплӑ Елена утравӗ";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Sancte Helena";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Hato Hērena";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Santa Elene";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Иԥшьоу Елена ладгьылбжьаха";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "སེནྚ། ཧེ་ལི་ན།";
        ...
        test("has translation for 'ie' locale", () {
          const expectedName = "Sant-Helena";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Sancta Helena, Ascensio et Tristan da Cunha";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Swnghwzlwznaz";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Мүгәддәс Јелена";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Света Хелена";
        ...
        test("has translation for 'ks_Arab' locale", () {
          const expectedName = "سینٛٹ ہٮ۪لِنا";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Муқаддас Елена ороли";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Hɛlena";
