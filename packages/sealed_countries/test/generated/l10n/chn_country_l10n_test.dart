...
void main() => group(
      "$CountryChn() L10N",
      () {
        const value = CountryChn();

        test("has translation for 'en' locale", () {
          const expectedName = "China";
          const expectedFullName = "People's Republic of China";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Кина";
          const expectedFullName = "Народна Република Кина";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "الصين";
          const expectedFullName = "جمهورية الصين الشعبية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Sina";
          const expectedFullName = "Republik Pobl Sina";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Čína";
          const expectedFullName = "Čínská lidová republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Tsieina";
          const expectedFullName = "Gweriniaeth Pobl Tsieina";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "China";
          const expectedFullName = "Volksrepublik China";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Hiina";
          const expectedFullName = "Hiina Rahvavabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Kiina";
          const expectedFullName = "Kiinan kansantasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Chine";
          const expectedFullName = "République populaire de Chine";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Kina";
          const expectedFullName = "Narodna Republika Kina";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Kína";
          const expectedFullName = "Kínai Népköztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Cina";
          const expectedFullName = "Repubblica popolare cinese";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "中国";
          const expectedFullName = "中華人民共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "중국";
          const expectedFullName = "중화인민공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "China";
          const expectedFullName = "Volksrepubliek China";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "چین";
          const expectedFullName = "جمهوری خلق چین";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Chiny";
          const expectedFullName = "Chińska Republika Ludowa";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "China";
          const expectedFullName = "República Popular da China";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Китай";
          const expectedFullName = "Народная Республика Китай";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Čína";
          const expectedFullName = "Čínska ľudová republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "China";
          const expectedFullName = "República Popular de China";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Kina";
          const expectedFullName = "Folkrepubliken Kina";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Çin";
          const expectedFullName = "Çin Halk Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "چین";
          const expectedFullName = "عوامی جمہوریہ چین";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "中国";
          const expectedFullName = "中华人民共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Siniwajamana";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Tsaina nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orilẹ̀-èdè Ṣáínà";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Tsiiʼyishbizhí Dineʼé Bikéyah";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orilɛ̀-èdè Sháínà";
