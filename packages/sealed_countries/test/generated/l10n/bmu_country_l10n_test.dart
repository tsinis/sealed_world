...
void main() => group(
      "$CountryBmu() L10N",
      () {
        const value = CountryBmu();

        test("has translation for 'en' locale", () {
          const expectedName = "Bermuda";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Bermudy";
          const expectedFullName = "Bermudské ostrovy";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Bermudi";
          const expectedFullName = "Bermuda";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "برمودا";
          const expectedFullName = "جزایر برمودا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Бермудские Острова";
          const expectedFullName = "Бермудские острова";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Bermud adaları";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Бермудскія астравы";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Бермудски острови";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Бермудан гӀайренаш";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Bermuda nutome";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Illas Bermudas";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Bermúdaeyjar";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Бермуд аралдары";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Bermudu salas";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Бермуд утраулары";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Бермудські Острови";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Bermuda orollari";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Bémúdà";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Бермуд утравӗсем";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Бермудтәи ад-хақәа";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Бермуд адалары";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Bémúdà";
