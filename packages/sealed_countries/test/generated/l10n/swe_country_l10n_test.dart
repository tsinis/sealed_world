...
void main() => group(
      "$CountrySwe() L10N",
      () {
        const value = CountrySwe();

        test("has translation for 'en' locale", () {
          const expectedName = "Sweden";
          const expectedFullName = "Kingdom of Sweden";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Шведска";
          const expectedFullName = "Краљевина Шведска";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "السويد";
          const expectedFullName = "مملكة السويد";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Sveden";
          const expectedFullName = "Rouantelezh Sveden";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Švédsko";
          const expectedFullName = "Švédské království";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Schweden";
          const expectedFullName = "Königreich Schweden";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Rootsi";
          const expectedFullName = "Rootsi Kuningriik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Ruotsi";
          const expectedFullName = "Ruotsin kuningaskunta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Suède";
          const expectedFullName = "Royaume de Suède";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Švedska";
          const expectedFullName = "Kraljevina Švedska";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Svédország";
          const expectedFullName = "Svéd Királyság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Svezia";
          const expectedFullName = "Regno di Svezia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "スウェーデン";
          const expectedFullName = "スウェーデン王国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "스웨덴";
          const expectedFullName = "스웨덴 왕국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Zweden";
          const expectedFullName = "Koninkrijk Zweden";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "سوئد";
          const expectedFullName = "پادشاهی سوئد";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Szwecja";
          const expectedFullName = "Królestwo Szwecji";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Suécia";
          const expectedFullName = "Reino da Suécia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Швеция";
          const expectedFullName = "Королевство Швеция";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Švédsko";
          const expectedFullName = "Švédske kráľovstvo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Suecia";
          const expectedFullName = "Reino de Suecia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Sverige";
          const expectedFullName = "Konungariket Sverige";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "İsveç";
          const expectedFullName = "İsveç Krallığı";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "سویڈن";
          const expectedFullName = "مملکتِ سویڈن";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "瑞典";
          const expectedFullName = "瑞典王国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Sweden nutome";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an tSualainn";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Swidini";
        ...
        test("has translation for 'kl' locale", () {
          const expectedName = "Svenskit Nunaat";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Swidini";
