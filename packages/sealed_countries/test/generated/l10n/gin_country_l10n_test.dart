...
void main() => group(
      "$CountryGin() L10N",
      () {
        const value = CountryGin();

        test("has translation for 'en' locale", () {
          const expectedName = "Guinea";
          const expectedFullName = "Republic of Guinea";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "غينيا";
          const expectedFullName = "جمهورية غينيا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Ginea";
          const expectedFullName = "Republik Ginea";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Guinea";
          const expectedFullName = "Guinejská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Guinea";
          const expectedFullName = "Republik Guinea";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Guinea";
          const expectedFullName = "Guinea Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Guinea";
          const expectedFullName = "Guinean tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Guinée";
          const expectedFullName = "République de Guinée";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Gvineja";
          const expectedFullName = "Republika Gvineja";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Guinea";
          const expectedFullName = "Guineai Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Guinea";
          const expectedFullName = "Repubblica di Guinea";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ギニア";
          const expectedFullName = "ギニア共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "기니";
          const expectedFullName = "기니 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Guinee";
          const expectedFullName = "Republiek Guinee";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Gwinea";
          const expectedFullName = "Republika Gwinei";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Guiné";
          const expectedFullName = "República da Guiné";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Гвинея";
          const expectedFullName = "Республика Гвинея";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Guinea";
          const expectedFullName = "República de Guinea";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Guinea";
          const expectedFullName = "Republiken Guinea";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Gine";
          const expectedFullName = "Gine Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "گنی";
          const expectedFullName = "جمہوریہ گنی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "几内亚";
          const expectedFullName = "几内亚共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Guini nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Gene";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "República de Guinea";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Gene";
