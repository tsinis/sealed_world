...
void main() => group(
      "$CountryArm() L10N",
      () {
        const value = CountryArm();

        test("has translation for 'en' locale", () {
          const expectedName = "Armenia";
          const expectedFullName = "Republic of Armenia";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Јерменија";
          const expectedFullName = "Република Јерменија";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "أرمينيا";
          const expectedFullName = "جمهورية أرمينيا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Armenia";
          const expectedFullName = "Republik Armenia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Arménie";
          const expectedFullName = "Arménská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Armenia";
          const expectedFullName = "Gweriniaeth Armenia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Armenien";
          const expectedFullName = "Republik Armenien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Armeenia";
          const expectedFullName = "Armeenia Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Armenia";
          const expectedFullName = "Armenian tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Arménie";
          const expectedFullName = "République d'Arménie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Armenija";
          const expectedFullName = "Republika Armenija";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Örményország";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Armenia";
          const expectedFullName = "Repubblica di Armenia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "アルメニア";
          const expectedFullName = "アルメニア共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "아르메니아";
          const expectedFullName = "아르메니아 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Armenië";
          const expectedFullName = "Republiek Armenië";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "ارمنستان";
          const expectedFullName = "جمهوری ارمنستان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Armenia";
          const expectedFullName = "Republika Armenii";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Arménia";
          const expectedFullName = "República da Arménia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Армения";
          const expectedFullName = "Республика Армения";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Arménsko";
          const expectedFullName = "Arménska republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Armenia";
          const expectedFullName = "República de Armenia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Armenien";
          const expectedFullName = "Republiken Armenien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Ermenistan";
          const expectedFullName = "Ermenistan Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "آرمینیا";
          const expectedFullName = "جمہوریہ آرمینیا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "亚美尼亚";
          const expectedFullName = "亚美尼亚共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Armenia nutome";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "အာမေးနီးယား";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Améníà";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Aooméénii Bikéyah";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Yameijnizya";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Améníà";
