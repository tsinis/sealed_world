...
void main() => group(
      "$CountryKwt() L10N",
      () {
        const value = CountryKwt();

        test("has translation for 'en' locale", () {
          const expectedName = "Kuwait";
          const expectedFullName = "State of Kuwait";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Кувајт";
          const expectedFullName = "Држава Кувајт";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "الكويت";
          const expectedFullName = "دولة الكويت";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Koweit";
          const expectedFullName = "Stad Koweit";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Kuvajt";
          const expectedFullName = "Stát Kuvajt";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Kuwait";
          const expectedFullName = "Staat Kuwait";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Kuveit";
          const expectedFullName = "Kuveidi Riik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Kuwait";
          const expectedFullName = "Kuwaitin valtio";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Koweït";
          const expectedFullName = "État du Koweït";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Kuvajt";
          const expectedFullName = "Država Kuvajt";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Kuvait";
          const expectedFullName = "Kuvaiti Állam";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Kuwait";
          const expectedFullName = "Stato del Kuwait";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "クウェート";
          const expectedFullName = "クウェート国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "쿠웨이트";
          const expectedFullName = "쿠웨이트국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Koeweit";
          const expectedFullName = "Staat Koeweit";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "کُویت";
          const expectedFullName = "دولت کویت";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Kuwejt";
          const expectedFullName = "Państwo Kuwejt";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Kuwait";
          const expectedFullName = "Estado do Kuwait";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Кувейт";
          const expectedFullName = "Государство Кувейт";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Kuvajt";
          const expectedFullName = "Kuvajtský štát";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Kuwait";
          const expectedFullName = "Estado de Kuwait";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Kuwait";
          const expectedFullName = "Staten Kuwait";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Kuveyt";
          const expectedFullName = "Kuveyt Devleti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "کویت";
          const expectedFullName = "دولتِ کویت";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "科威特";
          const expectedFullName = "科威特国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Kuwait nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Kuweti";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Choowait";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Kuweti";
