...
void main() => group(
      "$CountryBrb() L10N",
      () {
        const value = CountryBrb();

        test("has translation for 'en' locale", () {
          const expectedName = "Barbados";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Barbados nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Μπαρμπέιντος";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဘာဘေးဒိုးစ်";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Bábádósì";
        ...
        test("has translation for 'om' locale", () {
          const expectedName = "Baarbeedoos";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Bahbahdohswh";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Bábádósì";
