...
void main() => group(
      "$CountryPyf() L10N",
      () {
        const value = CountryPyf();

        test("has translation for 'en' locale", () {
          const expectedName = "French Polynesia";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Француска Полинезија";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "بولينزيا الفرنسية";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Polinezia C'hall";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Francouzská Polynésie";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Französisch-Polynesien";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Prantsuse Polüneesia";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Ranskan Polynesia";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Polynésie française";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Francuska Polinezija";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Francia Polinézia";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Polinesia Francese";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Frans-Polynesië";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "پُلی‌نِزی فرانسه";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Polinezja Francuska";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Polinésia Francesa";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Французская Полинезия";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Francúzska Polynézia";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Polinesia Francesa";
          const expectedFullName = "Polinesia francés";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Franska Polynesien";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Fransız Polinezyası";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "فرانسیسی پولینیشیا";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Frans-Polinesië";
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Frɛnkye Pɔlenehyia";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የፈረንሳይ ፖሊኔዢያ";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "ফ্ৰান্স পোলেনচিয়া";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Fransa Polineziyası";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Французская Палінезія";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Френска Полинезия";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Faransi ka polinezi";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "ফরাসী পলিনেশিয়া";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "Polinèsia Francesa";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Французийн Полинези";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "Fransk Polynesien";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཕྲཱནས྄་ཀྱི་པོ་ལི་ནི་ཤི་ཡ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Frentsi Pɔlinesia nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Γαλλική Πολυνησία";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Franca Polinezio";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Polinesia Frantsesa";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Polinesii Farayse";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Franska Polynesia";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Polainéis na Fraince";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Poilinèis na Frainge";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "A Polinesia Francesa";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "ફ્રેંચ પોલિનેશિયા";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Folinesiya Ta Faransa";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "פולינזיה הצרפתית";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "फ़्रेंच पोलिनेशिया";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Ֆրանսիական Պոլինեզիա";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Polynesia francese";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Polinesia Prancis";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Frenchi Polynesia";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Franska Pólýnesía";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "საფრანგეთის პოლინეზია";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Polinesia ya Ufaransa";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Француз Полинезиясы";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ប៉ូលី​ណេស៊ី​បារាំង";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಫ್ರೆಂಚ್ ಪಾಲಿನೇಷ್ಯಾ";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "فرانسی پولِنیشِیا";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Polînezyaya Fransî";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Полинезия (франциялык)";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Franséisch-Polynesien";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Polinesiya enfalansa";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Polinezi ya Falánsɛ";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ເຟຣນຊ໌ ໂພລິນີເຊຍ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Prancūzijos Polinezija";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Polinezi wa Nfalanse";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Francijas Polinēzija";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Polynezia frantsay";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ഫ്രഞ്ച് പോളിനേഷ്യ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Францын Полинез";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "फ्रेंच पॉलिनेशिया";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Polinesia Perancis";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "Polineżja Franċiża";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ပြင်သစ် ပေါ်လီနီးရှား";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "Fransk Polynesia";
        ...
        test("has translation for 'nd' locale", () {
          const expectedName = "Pholinesiya ye Fulansi";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "फ्रान्सेली पोलिनेसिया";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଫ୍ରେଞ୍ଚ ପଲିନେସିଆ";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਫਰੈਂਚ ਪੋਲੀਨੇਸ਼ੀਆ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "فرانسوي پولينيسيا";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "Polinesia Franzosa";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Polineziya y’Abafaransa";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Polinezia Franceză";
        ...
        test("has translation for 'sd' locale", () {
          const expectedName = "فرانسيسي پولينيشيا";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Frankriikka Polynesia";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Polinezïi tî farânzi";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ප්‍රංශ පොලිනීසියාව";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "Francoska Polinezija";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Booliyneesiya Faransiiska";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Polinezia Franceze";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Polynesia ya Ufaransa";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "பிரெஞ்சு பாலினேஷியா";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "ఫ్రెంచ్ పోలినీషియా";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Полинезияи Фаронса";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "เฟรนช์โปลินีเซีย";
        ...
        test("has translation for 'ti' locale", () {
          const expectedName = "ናይ ፈረንሳይ ፖሊነዝያ";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Fransuz Polineziýasy";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Polinisia fakafalanisē";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Француз Полинезиясе";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "فىرانسىيەگە قاراشلىق پولىنېزىيە";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Французька Полінезія";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Fransuz Polineziyasi";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Polynesia thuộc Pháp";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Polinesi Farañse";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "פֿראַנצויזישע פּאלינעזיע";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Firenṣi Polinesia";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-French Polynesia";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Франци Полинези";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Poronēhia Wīwī";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Polinèsia frantzesa";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "EFrench Polynesia";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Францызтәи Полинезиа";
        ...
        test("has translation for 'an' locale", () {
          const expectedName = "Polinesa Francesa";
        ...
        test("has translation for 'ie' locale", () {
          const expectedName = "Francesi Polinesia";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Polynesia Francica";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Франса Полинезијасы";
        ...
        test("has translation for 'ks_Arab' locale", () {
          const expectedName = "فرٛانسی پولِنیشِیا";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Француз Полинезияси";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Firenshi Polinesia";
