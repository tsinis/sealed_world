...
void main() => group(
      "$CountrySlv() L10N",
      () {
        const value = CountrySlv();

        test("has translation for 'en' locale", () {
          const expectedName = "El Salvador";
          const expectedFullName = "Republic of El Salvador";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Салвадор";
          const expectedFullName = "Република Ел Салвадор";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "السلفادور";
          const expectedFullName = "جمهورية السلفادور";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "El Salvador";
          const expectedFullName = "Republik El Salvador";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Salvador";
          const expectedFullName = "Salvadorská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "El Salfador";
          const expectedFullName = "Gweriniaeth El Salfador";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "El Salvador";
          const expectedFullName = "El Salvadori Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "El Salvador";
          const expectedFullName = "El Salvadorin tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Salvador";
          const expectedFullName = "République du Salvador";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Salvador";
          const expectedFullName = "Republika El Salvador";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Salvador";
          const expectedFullName = "Salvadori Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "El Salvador";
          const expectedFullName = "Repubblica di El Salvador";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "エルサルバドル";
          const expectedFullName = "エルサルバドル共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "엘살바도르";
          const expectedFullName = "엘살바도르 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "El Salvador";
          const expectedFullName = "Republiek El Salvador";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "السالوادور";
          const expectedFullName = "جمهوری السالوادور";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Salwador";
          const expectedFullName = "Republika Salwadoru";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "El Salvador";
          const expectedFullName = "República de El Salvador";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Сальвадор";
          const expectedFullName = "Республика Эль-Сальвадор";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Salvádor";
          const expectedFullName = "Salvádorská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "El Salvador";
          const expectedFullName = "Republiken El Salvador";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "El Salvador";
          const expectedFullName = "El Salvador Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "ایل سیلواڈور";
          const expectedFullName = "جمہوریہ ایل سیلواڈور";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "萨尔瓦多";
          const expectedFullName = "萨尔瓦多共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "এল ছেলভেড’ৰ";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཨེལ་སལ་བ་ཌོར";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "El Salvadɔ nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Ελ Σαλβαδόρ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "El Salwador";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an tSalvadóir";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "An Salbhador";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "એલ સેલ્વાડોર";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "El Salbador";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "अल सल्वाडोर";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Èl Salvador";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "អែលសាល់វ៉ាឌ័រ";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಎಲ್ ಸಾಲ್ವೇಡಾರ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "اؠل سَلواڑور";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Эль-Сальвадор";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "El salivado";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Ел Салвадор";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "अल साल्वाडोर";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "အယ်လ်ဆာဗေးဒိုး";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "एल् साल्भाडोर";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଏଲ୍ ସାଲଭାଡୋର୍";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Eli Saluvatori";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "එල් සැල්වදෝරය";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "El Salfadoor";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "எல் சால்வடார்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "ఎల్ సాల్వడోర్";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Эл-Салвадор";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "เอลซัลวาดอร์";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "ʻEle Salavatoa";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "El Salwadoor";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "על סאַלוואַדאר";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Ẹẹsáfádò";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-El Salvador";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ཨིལ་སལ་ཝ་ཌོར།";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "އެލްސެލްވަޑޯރު";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Salvador";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Te Whakaora";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Lo Salvador";
        ...
        test("has translation for 'sa' locale", () {
          const expectedName = "एल-साल्वाडोर";
        ...
        test("has translation for 'su' locale", () {
          const expectedName = "Él Salvador";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "E-El Salvador";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Sazwjvajdoh";
        ...
        test("has translation for 'ks_Arab' locale", () {
          const expectedName = "اٮ۪ل سَلواڑور";
        ...
        test("has translation for 'ug_Arab' locale", () {
          const expectedName = "ئەل سالۋادور";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Ɛɛsáfádò";
