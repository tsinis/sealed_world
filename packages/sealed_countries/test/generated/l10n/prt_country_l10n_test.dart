...
void main() => group(
      "$CountryPrt() L10N",
      () {
        const value = CountryPrt();

        test("has translation for 'en' locale", () {
          const expectedName = "Portugal";
          const expectedFullName = "Portuguese Republic";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Португал";
          const expectedFullName = "Португалска Република";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "البرتغال";
          const expectedFullName = "الجمهورية البرتغالية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Portugal";
          const expectedFullName = "Republik Portugalat";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Portugalsko";
          const expectedFullName = "Portugalská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Portugal";
          const expectedFullName = "Portugiesische Republik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Portugal";
          const expectedFullName = "Portugali Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Portugali";
          const expectedFullName = "Portugalin tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Portugal";
          const expectedFullName = "République portugaise";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Portugal";
          const expectedFullName = "Portugalska Republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Portugália";
          const expectedFullName = "Portugál Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Portogallo";
          const expectedFullName = "Repubblica portoghese";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ポルトガル";
          const expectedFullName = "ポルトガル共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "포르투갈";
          const expectedFullName = "포르투갈 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Portugal";
          const expectedFullName = "Portugese Republiek";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "پرتغال";
          const expectedFullName = "جمهوری پرتغال";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Portugalia";
          const expectedFullName = "Republika Portugalska";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Portugal";
          const expectedFullName = "República português";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Португалия";
          const expectedFullName = "Португальская Республика";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Portugal";
          const expectedFullName = "República Portuguesa";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Portugal";
          const expectedFullName = "Republiken Portugal";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Portekiz";
          const expectedFullName = "Portekiz Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "پرتگال";
          const expectedFullName = "جمہوریہ پرتگال";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "葡萄牙";
          const expectedFullName = "葡萄牙共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Portuqaliya";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Portugal nutome";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Portugalujo";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Phortaingéil";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "A’ Phortagail";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Պորտուգալիա";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ព័រទុយហ្គាល់";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Portugalija";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Mputulugeshi";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Португалија";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Portugall";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ପର୍ତ୍ତୁଗାଲ୍";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Pörtugäle, Ködörö Pûra";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "Portugalska";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "போர்ச்சுக்கல்";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Portugaliýa";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "پورتۇگالىيە";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Portugaliya";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Pọ́túgà";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Phortiugal";
        ...
        test("has translation for 'kg' locale", () {
          const expectedName = "Mputulukesi";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Portugallia";
        ...
        test("has translation for 'ss' locale", () {
          const expectedName = "IPhuthukezi";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Pɔ́túgà";
