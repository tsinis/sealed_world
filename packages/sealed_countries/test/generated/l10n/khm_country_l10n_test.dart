...
void main() => group(
      "$CountryKhm() L10N",
      () {
        const value = CountryKhm();

        test("has translation for 'en' locale", () {
          const expectedName = "Cambodia";
          const expectedFullName = "Kingdom of Cambodia";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Камбоџа";
          const expectedFullName = "Краљевина Камбоџа";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "كمبوديا";
          const expectedFullName = "مملكة كمبوديا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Kambodja";
          const expectedFullName = "Rouantelezh Kambodja";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Kambodža";
          const expectedFullName = "Kambodžské království";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Cambodia";
          const expectedFullName = "Teyrnas Cambodia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Kambodscha";
          const expectedFullName = "Königreich Kambodscha";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Kambodža";
          const expectedFullName = "Kambodža Kuningriik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Kambodža";
          const expectedFullName = "Kambodžan kuningaskunta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Cambodge";
          const expectedFullName = "Royaume du Cambodge";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Kambodža";
          const expectedFullName = "Kraljevina Kambodža";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Kambodzsa";
          const expectedFullName = "Kambodzsai Királyság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Cambogia";
          const expectedFullName = "Regno di Cambogia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "カンボジア";
          const expectedFullName = "カンボジア王国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "캄보디아";
          const expectedFullName = "캄보디아 왕국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Cambodja";
          const expectedFullName = "Koninkrijk Cambodja";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "کامبوج";
          const expectedFullName = "پادشاهی کامبوج";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Kambodża";
          const expectedFullName = "Królestwo Kambodży";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Camboja";
          const expectedFullName = "Reino do Camboja";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Камбоджа";
          const expectedFullName = "Королевство Камбоджа";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Kamboǆa";
          const expectedFullName = "Kamboǆské kráľovstvo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Camboya";
          const expectedFullName = "Reino de Camboya";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Kambodja";
          const expectedFullName = "Konungariket Kambodja";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Kamboçya";
          const expectedFullName = "Kamboçya Krallığı";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "کمبوڈیا";
          const expectedFullName = "مملکتِ کمبوڈیا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "柬埔寨";
          const expectedFullName = "柬埔寨王国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཀམ་བྷོ་ཌི་ཡ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Kambodia nutome";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Chambóid";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Kambodja";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ကမ္ဘောဒီးယား";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Kàmùbódíà";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Chamboyd";
        ...
        test("has translation for 'ss' locale", () {
          const expectedName = "IKhambodiya";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Kàmùbódíà";
