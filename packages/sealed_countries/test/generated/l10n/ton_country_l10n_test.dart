...
void main() => group(
      "$CountryTon() L10N",
      () {
        const value = CountryTon();

        test("has translation for 'en' locale", () {
          const expectedName = "Tonga";
          const expectedFullName = "Kingdom of Tonga";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Тонга";
          const expectedFullName = "Краљевина Тонга";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "تونغا";
          const expectedFullName = "مملكة تونغا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Tonga";
          const expectedFullName = "Rouantelezh Tonga";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Tonga";
          const expectedFullName = "Království Tonga";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Tonga";
          const expectedFullName = "Königreich Tonga";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Tonga";
          const expectedFullName = "Tonga Kuningriik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Tonga";
          const expectedFullName = "Tongan kuningaskunta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Tonga";
          const expectedFullName = "Royaume des Tonga";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Tonga";
          const expectedFullName = "Kraljevina Tonga";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Tonga";
          const expectedFullName = "Tongai Királyság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Tonga";
          const expectedFullName = "Regno di Tonga";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "トンガ";
          const expectedFullName = "トンガ王国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "통가";
          const expectedFullName = "통가 왕국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Tonga";
          const expectedFullName = "Koninkrijk Tonga";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "تونگا";
          const expectedFullName = "پادشاهی تونگا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Tonga";
          const expectedFullName = "Królestwo Tonga";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Tonga";
          const expectedFullName = "Reino de Tonga";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Тонга";
          const expectedFullName = "Королевство Тонга";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Tonga";
          const expectedFullName = "Tongské kráľovstvo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Tonga";
          const expectedFullName = "Konungariket Tonga";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Tonga";
          const expectedFullName = "Tonga Krallığı";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "ٹونگا";
          const expectedFullName = "مملکتِ ٹونگا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "汤加";
          const expectedFullName = "汤加王国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Tonga nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Tonga";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Tonga";
