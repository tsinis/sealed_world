...
void main() => group(
      "$CountryReu() L10N",
      () {
        const value = CountryReu();

        test("has translation for 'en' locale", () {
          const expectedName = "Réunion";
          const expectedFullName = "Réunion Island";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "لا ريونيون";
          const expectedFullName = "جزيرة لا ريونيون";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Reünion";
          const expectedFullName = "Enez ar Reünion";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Réunion";
          const expectedFullName = "Réunioni departemang";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Réunion";
          const expectedFullName = "Ile de la Réunion";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Riunione";
          const expectedFullName = "Réunion";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "レユニオン";
          const expectedFullName = "レユニオン島";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Reunião";
          const expectedFullName = "Ilha da Reunião";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Réunion";
          const expectedFullName = "Réunionský zámorský departmán";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Reunión";
          const expectedFullName = "Isla de la Reunión";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "رے یونیوں";
          const expectedFullName = "رے یونیوں جزیرہ";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "Illa de la Reunió";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "རེ་ཡུ་ནི་ཡོན";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Réunion nutome";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Amazinga ya Reyiniyo";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Riuniyan";
        ...
        test("has translation for 'an' locale", () {
          const expectedName = "Isla d’a Reunión";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Riuniyan";
