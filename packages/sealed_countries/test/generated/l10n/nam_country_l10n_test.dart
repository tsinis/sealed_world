...
void main() => group(
      "$CountryNam() L10N",
      () {
        const value = CountryNam();

        test("has translation for 'en' locale", () {
          const expectedName = "Namibia";
          const expectedFullName = "Republic of Namibia";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Намибија";
          const expectedFullName = "Република Намибија";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "ناميبيا";
          const expectedFullName = "جمهورية ناميبيا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Namibia";
          const expectedFullName = "Republik Namibia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Namibie";
          const expectedFullName = "Namibijská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Namiibia";
          const expectedFullName = "Namiibia Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Namibia";
          const expectedFullName = "Namibian tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Namibie";
          const expectedFullName = "République de Namibie";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Namibija";
          const expectedFullName = "Republika Namibija";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Namíbia";
          const expectedFullName = "Namíbiai Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Namibia";
          const expectedFullName = "Repubblica di Namibia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ナミビア";
          const expectedFullName = "ナミビア共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "나미비아";
          const expectedFullName = "나미비아 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Namibië";
          const expectedFullName = "Republiek Namibië";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "نامیبیا";
          const expectedFullName = "جمهوری نامیبیا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Namibia";
          const expectedFullName = "Republika Namibii";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Namíbia";
          const expectedFullName = "República da Namíbia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Намибия";
          const expectedFullName = "Республика Намибия";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Namíbia";
          const expectedFullName = "Namíbijská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Namibia";
          const expectedFullName = "República de Namibia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Namibia";
          const expectedFullName = "Republiken Namibia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Namibya";
          const expectedFullName = "Namibya Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "نمیبیا";
          const expectedFullName = "جمہوریہ نمیبیا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "纳米比亚";
          const expectedFullName = "纳米比亚共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Namibia nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Namibia";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Nazmijbijya";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Namibia";
