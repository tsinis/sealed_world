...
void main() => group(
      "$CountryLbn() L10N",
      () {
        const value = CountryLbn();

        test("has translation for 'en' locale", () {
          const expectedName = "Lebanon";
          const expectedFullName = "Lebanese Republic";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Либан";
          const expectedFullName = "Либанска Република";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "لبنان";
          const expectedFullName = "الجمهورية اللبنانية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Liban";
          const expectedFullName = "Republik Liban";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Libanon";
          const expectedFullName = "Libanonská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Libanon";
          const expectedFullName = "Libanesische Republik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Liibanon";
          const expectedFullName = "Liibanoni Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Libanon";
          const expectedFullName = "Libanonin tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Liban";
          const expectedFullName = "République libanaise";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Libanon";
          const expectedFullName = "Libanonska Republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Libanon";
          const expectedFullName = "Libanoni Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Libano";
          const expectedFullName = "Repubblica libanese";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "レバノン";
          const expectedFullName = "レバノン共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "레바논";
          const expectedFullName = "레바논 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Libanon";
          const expectedFullName = "Libanese Republiek";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "لبنان";
          const expectedFullName = "جمهوری لبنان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Liban";
          const expectedFullName = "Republika Libańska";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Líbano";
          const expectedFullName = "República Libanesa";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Ливан";
          const expectedFullName = "Ливанская Республика";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Libanon";
          const expectedFullName = "Republiken Libanon";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Lübnan";
          const expectedFullName = "Lübnan Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "لبنان";
          const expectedFullName = "جمہوریہ لبنان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "黎巴嫩";
          const expectedFullName = "黎巴嫩共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Lebanɔn nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Lebanoni";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Lebanoni";
