...
void main() => group(
      "$CountryBtn() L10N",
      () {
        const value = CountryBtn();

        test("has translation for 'en' locale", () {
          const expectedName = "Bhutan";
          const expectedFullName = "Kingdom of Bhutan";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Бутан";
          const expectedFullName = "Краљевина Бутан";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "بوتان";
          const expectedFullName = "مملكة بوتان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Bhoutan";
          const expectedFullName = "Rouantelezh Bhoutan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Bhútán";
          const expectedFullName = "Bhútánské království";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Bhwtan";
          const expectedFullName = "Teyrnas Bhwtan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Bhutan";
          const expectedFullName = "Königreich Bhutan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Bhutan";
          const expectedFullName = "Bhutani Kuningriik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Bhutan";
          const expectedFullName = "Bhutanin kuningaskunta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Bhoutan";
          const expectedFullName = "Royaume du Bhoutan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Butan";
          const expectedFullName = "Kraljevina Butan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Bhután";
          const expectedFullName = "Bhutáni Királyság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Bhutan";
          const expectedFullName = "Regno del Bhutan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ブータン";
          const expectedFullName = "ブータン王国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "부탄";
          const expectedFullName = "부탄 왕국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Bhutan";
          const expectedFullName = "Koninkrijk Bhutan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "بوتان";
          const expectedFullName = "پادشاهی بوتان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Butão";
          const expectedFullName = "Reino do Butão";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Бутан";
          const expectedFullName = "Королевство Бутан";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Bhután";
          const expectedFullName = "Bhutánske krâľovstvo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Bután";
          const expectedFullName = "Reino de Bután";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Bhutan";
          const expectedFullName = "Konungariket Bhutan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Butan";
          const expectedFullName = "Butan Krallığı";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "بھوٹان";
          const expectedFullName = "سلطنت بھوٹان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "不丹";
          const expectedFullName = "不丹王国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Bhutan nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Bútánì";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Bútánì";
