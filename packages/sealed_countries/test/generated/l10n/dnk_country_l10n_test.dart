...
void main() => group(
      "$CountryDnk() L10N",
      () {
        const value = CountryDnk();

        test("has translation for 'en' locale", () {
          const expectedName = "Denmark";
          const expectedFullName = "Kingdom of Denmark";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Данска";
          const expectedFullName = "Краљевина Данска";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "الدنمارك";
          const expectedFullName = "مملكة الدنمارك";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Danmark";
          const expectedFullName = "Rouantelezh Danmark";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Dánsko";
          const expectedFullName = "Dánské království";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Denmarc";
          const expectedFullName = "Teyrnas Denmarc";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Dänemark";
          const expectedFullName = "Königreich Dänemark";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          ...
          const expectedFullName = "Taani Kuningriik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          ...
          const expectedFullName = "Tanskan kuningaskunta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Danemark";
          const expectedFullName = "Royaume du Danemark";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          ...
          const expectedFullName = "Kraljevina Danska";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Dánia";
          const expectedFullName = "Dán Királyság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Danimarca";
          const expectedFullName = "Regno di Danimarca";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "デンマーク";
          const expectedFullName = "デンマーク王国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "덴마크";
          const expectedFullName = "덴마크 왕국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Denemarken";
          const expectedFullName = "Koninkrijk Denemarken";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "دانمارک";
          const expectedFullName = "پادشاهی دانمارک";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Dania";
          const expectedFullName = "Królestwo Danii";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Dinamarca";
          const expectedFullName = "Reino da Dinamarca";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          ...
          const expectedFullName = "Королевство Дания";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Dánsko";
          const expectedFullName = "Dánske kráľovstvo";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Dinamarca";
          const expectedFullName = "Reino de Dinamarca";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Danmark";
          const expectedFullName = "Konungariket Danmark";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          ...
          const expectedFullName = "Danimarka Krallığı";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "ڈنمارک";
          const expectedFullName = "مملکتِ ڈنمارک";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "丹麦";
          const expectedFullName = "丹麦王国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Denmark nutome";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Danmhairg";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Dhènemarken";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "id-Danimarka";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Dẹ́mákì";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Déinish Dineʼé Bikéyah";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Dɛ́mákì";
