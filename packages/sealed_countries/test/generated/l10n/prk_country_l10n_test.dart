...
void main() => group(
      "$CountryPrk() L10N",
      () {
        const value = CountryPrk();

        test("has translation for 'en' locale", () {
          const expectedName = "North Korea";
          const expectedFullName = "Democratic People's Republic of Korea";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Северна Кореја";
          const expectedFullName = "Демократска Народна Република Кореја";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "كوريا الشمالية";
          const expectedFullName = "جمهورية كوريا الديمقراطية الشعبية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Korea an Norzh";
          const expectedFullName = "Republik Poblel ha Demokratel Korea";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Severní Korea";
          const expectedFullName = "Korejská lidově demokratická republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Nordkorea";
          const expectedFullName = "Demokratische Volksrepublik Korea";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Põhja-Korea";
          const expectedFullName = "Korea Rahvademokraatlik Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Pohjois-Korea";
          const expectedFullName = "Korean demokraattinen kansantasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Corée du Nord";
          const expectedFullName = "République populaire démocratique de Corée";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Sjeverna Koreja";
          const expectedFullName = "Demokratska Narodna Republika Koreja";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Észak-Korea";
          const expectedFullName = "Koreai Népi Demokratikus Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Corea del Nord";
          const expectedFullName = "Repubblica democratica popolare di Corea";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "朝鮮民主主義人民共和国";
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "조선";
          const expectedFullName = "조선민주주의인민공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Noord-Korea";
          const expectedFullName = "Democratische Volksrepubliek Korea";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "کُره شمالی";
          const expectedFullName = "جمهوری دموکراتیک خلق کره";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Korea Północna";
          const expectedFullName = "Koreańska Republika Ludowo-Demokratyczna";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Coreia do Norte";
          const expectedFullName = "República Popular Democrática da Coreia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Северная Корея";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Severná Kórea";
          const expectedFullName = "Kórejská ľudovodemokratická republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Corea del Norte";
          const expectedFullName = "República Popular Democrática de Corea";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Nordkorea";
          const expectedFullName = "Demokratiska Folkrepubliken Korea";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Kuzey Kore";
          const expectedFullName = "Kore Demokratik Halk Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "شمالی کوریا";
          const expectedFullName = "جمہوری عوامی جمہوریہ کوریا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "朝鲜";
          const expectedFullName = "朝鲜人民民主共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Etifi Koria";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "উত্তৰ কোৰিয়া";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Şimali Koreya";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Паўночная Карэя";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Северна Корея";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Kɛɲɛka Kore";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "উত্তর কোরিয়া";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Къилбаседа Корей";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "བྱང་ ཀོ་རི་ཡ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Dziehe Korea nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Βόρεια Κορέα";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Norðurkorea";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Noard-Korea";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Chóiré Thuaidh";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Coirèa a Tuath";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Corea do Norte";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "ઉત્તર કોરિયા";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Koriya Ta Arewa";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "קוריאה הצפונית";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "उत्तर कोरिया";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Հյուսիսային Կորեա";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Korea Utara";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Norður-Kórea";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ჩრდილოეთ კორეა";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Korea Kaskazini";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Солтүстік Корея";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "កូរ៉េ​ខាង​ជើង";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಉತ್ತರ ಕೊರಿಯಾ";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "شُمٲلی کورِیا";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Korêya Bakur";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Түндүк Корея";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Koreya ey’omumambuka";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Korɛ ya nɔ́rdi";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ເກົາຫລີເໜືອ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Šiaurės Korėja";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Kore wa muulu";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Ziemeļkoreja";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Korea Avaratra";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Хойд Солонгос";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Korea ta’ Fuq";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "မြောက်ကိုရီးယား";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଉତ୍ତର କୋରିଆ";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "Corea dal Nord";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Koreya y’amajaruguru";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Coreea de Nord";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Davvi-Korea";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Korëe tî Banga";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "උතුරු කොරියාව";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "Severna Koreja";
        ...
        test("has translation for 'sn' locale", () {
          const expectedName = "Korea, North";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Kuuriyada Waqooyi";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Kore e Veriut";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "ఉత్తర కొరియా";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Кореяи Шимолӣ";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "เกาหลีเหนือ";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Demirgazyk Koreýa";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Kōlea tokelau";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Төньяк Корея";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Північна Корея";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Shimoliy Koreya";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Guusu Kọria";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-North Korea";
        ...
        test("has translation for 'an' locale", () {
          const expectedName = "Coreya d'o Norte";
        ...
        test("has translation for 'ba' locale", () {
          const expectedName = "Корея Халыҡ-Демократик Республикаһы";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "އުތުރު ކޮރެއާ";
        ...
        test("has translation for 'gn' locale", () {
          const expectedName = "Yvate Koréa";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Chorea Twoaie";
        ...
        test("has translation for 'ik' locale", () {
          const expectedName = "Nigiq Korea";

          final translated = value.maybeTranslation(
            const BasicTypedLocale(LangIpk()),
            useLanguageFallback: false,
          );
          ...
          expect(commonMapTranslation, expectedName);
          final unexpectedScriptTranslation = value.maybeTranslation(
            const BasicTypedLocale(LangIpk(), script: ScriptCyrs()),
          );
        ...
        test("has translation for 'kg' locale", () {
          const expectedName = "Hangu ya Node";
        ...
        test("has translation for 'kl' locale", () {
          const expectedName = "Korea Avannarleq";
        ...
        test("has translation for 'kv' locale", () {
          const expectedName = "Корея Войтыр Демократия Республика";
        ...
        test("has translation for 'kw' locale", () {
          const expectedName = "Korea Gledh";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Res publica popularis democratica Coreana";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Kōrea-ki-te-raki";
        ...
        test("has translation for 'na' locale", () {
          const expectedName = "Ripubrikit Engame Korea";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Kolíya Bikéyah Náhookǫsjí Siʼánígíí";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Corèa del Nòrd";
        ...
        test("has translation for 'om' locale", () {
          const expectedName = "Kooriyaa Kaabaa";
        ...
        test("has translation for 'os' locale", () {
          const expectedName = "Корейы Адæмон Демократон Республикæ";
        ...
        test("has translation for 'rw' locale", () {
          const expectedName = "Koreya y’Amajyaruguru";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Corea de su Norte";
        ...
        test("has translation for 'ss' locale", () {
          const expectedName = "IKhoriya leseNyakatfo";
        ...
        test("has translation for 'su' locale", () {
          const expectedName = "Koréa Kalér";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Hilagang Korea";
        ...
        test("has translation for 'vo' locale", () {
          const expectedName = "Nolüda-Koreyän";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "Coreia do Twoaie";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Cauzsenh Minzcujcujyi Yinzminz Gunghozgoz";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Шимали Кореја";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Сјеверна Кореја";
        ...
        test("has translation for 'ha_Latn' locale", () {
          const expectedName = "Koreya Ta Arewa";
        ...
        test("has translation for 'kk_Cyrl' locale", () {
          const expectedName = "Оңтүстік Корея";
        ...
        test("has translation for 'ug_Arab' locale", () {
          const expectedName = "شىمالىي كورىيە";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Шимолий Корея";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Guusu Kɔria";
