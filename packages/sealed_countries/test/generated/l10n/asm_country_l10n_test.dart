...
void main() => group(
      "$CountryAsm() L10N",
      () {
        const value = CountryAsm();

        test("has translation for 'en' locale", () {
          const expectedName = "American Samoa";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Америчка Самоа";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "ساموا الأمريكية";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Samoa Amerikan";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Americká Samoa";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Amerikanisch-Samoa";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Ameerika Samoa";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Amerikan Samoa";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Samoa américaines";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Američka Samoa";
          const expectedFullName = "američka Samoa";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Samoa Americane";
          const expectedFullName = "Samoa americane";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "アメリカ領サモア";
          const expectedFullName = "米サモア";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Amerikaans Samoa";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "ساموآی آمریکا";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Samoa Amerykańskie";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Samoa Americana";
          const expectedFullName = "Samoa americana";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Американское Самоа";
          const expectedFullName = "американское Самоа";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Amerikanska Samoa";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Amerikan Samoası";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "امریکی سمووا";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Amerikaanse Samoa";
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Amɛrika Samoa";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "আমেৰিকান চামোৱা";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Amerika Samoası";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Амерыканскае Самоа";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Американска Самоа";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Samowa amerikani";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "আমেরিকান সামোয়া";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "Samoa Nord-americana";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Американ Самоа";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "Amerikansk Samoa";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ས་མོ་ཨ་ཡུ་ཨེས་ཨེ་མངའ་ཁོངས";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Amerika Samoa nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Αμερικανική Σαμόα";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Samoa Estatubatuarra";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Samowa Amerik";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Amerikaansk Samoa";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Samó Mheiriceá";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Samotha na h-Aimeireaga";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "અમેરિકન સમોઆ";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Samowa Ta Amurka";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "סמואה האמריקנית";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "अमेरिकी समोआ";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Ամերիկյան Սամոա";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Samoa american";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Samoa Amerika";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Bandaríska Samóa";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ამერიკის სამოა";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Samoa ya Marekani";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Америкалық Самоа";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "សាម័រ អាមេរិកាំង";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಅಮೇರಿಕನ್ ಸಮೋವಾ";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "اَمریٖکَن سَموا";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Samoaya Amerîkanî";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Америкалык Самоа";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Amerikanesch-Samoa";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Samowa omumerika";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Samoa ya Ameriki";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ອາເມຣິກາ ຊາມົວ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Amerikos Samoa";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Samoa wa Ameriki";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Samoa amerikanina";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "അമേരിക്കൻ സമോവ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Америкийн Самоа";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "अमेरिकन सामोआ";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "is-Samoa Amerikana";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "အမေရိကန် ဆမိုးအား";
        ...
        test("has translation for 'nd' locale", () {
          const expectedName = "Samoa ye Amelika";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଆମେରିକାନ୍ ସାମୋଆ";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਅਮੈਰੀਕਨ ਸਮੋਆ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "امریکایی سمو";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Samowa nyamerika";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Samoa Americană";
        ...
        test("has translation for 'sd' locale", () {
          const expectedName = "آمريڪي ساموا";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Amerihká Samoa";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Samöa tî Amerîka";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ඇමරිකානු සැමෝවා";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "Ameriška Samoa";
        ...
        test("has translation for 'sn' locale", () {
          const expectedName = "Samoa ye Amerika";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Samowa Ameerika";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Samoa Amerikane";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "அமெரிக்க சமோவா";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "అమెరికన్ సమోవా";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Самоаи Америка";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "อเมริกันซามัว";
        ...
        test("has translation for 'ti' locale", () {
          const expectedName = "ናይ ኣሜሪካ ሳሞኣ";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Amerikan Samoasy";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Haʻamoa ʻAmelika";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Америка Самоасы";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ئامېرىكا ساموئا";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Американське Самоа";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Amerika Samoasi";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Samoa thuộc Mỹ";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Samowa bu Amerig";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Sámóánì ti Orílẹ́ède Àméríkà";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-American Samoa";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Америка Самоа";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Hāmoa-Amerika";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Samoa americanas";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "E-American Samoa";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Америкатәи Самоа";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Usona Samoo";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Amerikanong Samoa";
        ...
        test("has translation for 'kk_Cyrl' locale", () {
          const expectedName = "Американ Самоасы";
        ...
        test("has translation for 'ug_Arab' locale", () {
          const expectedName = "ئامېرىكا تەۋەلىكىدىكى ساموئا";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Америка Самоаси";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Sámóánì ti Orílɛ́ède Àméríkà";
