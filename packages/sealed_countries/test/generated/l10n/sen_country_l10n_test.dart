...
void main() => group(
      "$CountrySen() L10N",
      () {
        const value = CountrySen();

        test("has translation for 'en' locale", () {
          const expectedName = "Senegal";
          const expectedFullName = "Republic of Senegal";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Сенегал";
          const expectedFullName = "Република Сенегал";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "السنغال";
          const expectedFullName = "جمهورية السنغال";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Senegal";
          const expectedFullName = "Republik Senegal";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Senegal";
          const expectedFullName = "Senegalská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Senegal";
          const expectedFullName = "Senegali Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Senegal";
          const expectedFullName = "Senegalin tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Sénégal";
          const expectedFullName = "République du Sénégal";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Senegal";
          const expectedFullName = "Republika Senegal";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Szenegál";
          const expectedFullName = "Szenegáli Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Senegal";
          const expectedFullName = "Repubblica del Senegal";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "セネガル";
          const expectedFullName = "セネガル共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "세네갈";
          const expectedFullName = "세네갈 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Senegal";
          const expectedFullName = "Republiek Senegal";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "سنگال";
          const expectedFullName = "جمهوری سنگال";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Senegal";
          const expectedFullName = "República do Senegal";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Сенегал";
          const expectedFullName = "Республика Сенегал";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Senegal";
          const expectedFullName = "República de Senegal";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Senegal";
          const expectedFullName = "Republiken Senegal";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Senegal";
          const expectedFullName = "Senegal Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "سینیگال";
          const expectedFullName = "جمہوریہ سینیگال";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "塞内加尔";
          const expectedFullName = "塞内加尔共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Senegal nutome";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an tSeineagáil";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Sẹnẹga";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Tenegaal";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Saineigyahwj";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Sɛnɛga";
