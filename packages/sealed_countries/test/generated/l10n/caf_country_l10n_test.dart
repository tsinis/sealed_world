...
void main() => group(
      "$CountryCaf() L10N",
      () {
        const value = CountryCaf();

        test("has translation for 'en' locale", () {
          const expectedName = "Central African Republic";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Централноафричка Република";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "جمهورية أفريقيا الوسطى";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Republik Kreizafrikan";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Středoafrická republika";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Gweriniaeth Canolbarth Affrica";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Zentralafrikanische Republik";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Kesk-Aafrika Vabariik";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Keski-Afrikan tasavalta";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "République centrafricaine";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Srednjoafrička Republika";
          const expectedFullName = "Centralna Afrička Republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Közép-afrikai Köztársaság";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Repubblica Centrafricana";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Centraal-Afrikaanse Republiek";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "جمهوری آفریقای مرکزی";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Republika Środkowoafrykańska";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "República Centro-Africana";
          const expectedFullName = "República Centro-Africano";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Центральноафриканская Республика";
          const expectedFullName = "Центрально-Африканская Республика";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Stredoafrická republika";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "República Centroafricana";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Centralafrikanska republiken";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Orta Afrika Cumhuriyeti";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "وسطی افریقی جمہوریہ";
          const expectedFullName = expectedName;
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Sentraal-Afrikaanse Republiek";
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Afrika Finimfin Man";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "ማዕከላዊ አፍሪካ ሪፑብሊክ";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "মধ্য আফ্রিকান প্রজাতন্ত্র";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Mərkəzi Afrika Respublikası";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Цэнтральна-Афрыканская Рэспубліка";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Централноафриканска република";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Santarafiriki";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "মধ্য আফ্রিকার প্রজাতন্ত্র";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Centralnoafrička Republika";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "República Centreafricana";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Юккъерчу Африкин Республика";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "Den Centralafrikanske Republik";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "སེན་ཊལ་ ཨཕ་རི་ཀཱན་ རི་པབ་ལིཀ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Titina Afrika repɔblik nutome";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Κεντροαφρικανική Δημοκρατία";
        ...
        test("has translation for 'eo' locale", () {
          const expectedName = "Centr-Afrika Respubliko";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Afrika Erdiko Errepublika";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Ndenndaandi Santarafrik";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Miðafrikalýðveldið";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Sintraal-Afrikaanske Republyk";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Poblacht na hAfraice Láir";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Poblachd Meadhan Afraga";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "સેન્ટ્રલ આફ્રિકન રિપબ્લિક";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Jamhuriyar Afirka Ta Tsakiya";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "הרפובליקה המרכז-אפריקאית";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "मध्य अफ़्रीकी गणराज्य";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Կենտրոնական Աֆրիկյան Հանրապետություն";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Republica African Central";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Republik Afrika Tengah";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Central African Republik";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Mið-Afríkulýðveldið";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Républik Afrika Tengah";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ცენტრალური აფრიკის რესპუბლიკა";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Jamhuri ya Afrika ya Kati";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Орталық Африка Республикасы";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "សាធារណរដ្ឋអាហ្វ្រិកកណ្ដាល";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಮಧ್ಯ ಆಫ್ರಿಕಾ ಗಣರಾಜ್ಯ";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "مرکٔزی اَفریٖکی جموٗریَت";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Komara Afrîkaya Navend";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Борбордук Африка Республикасы";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Zentralafrikanesch Republik";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Lipubulika eya Senturafiriki";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Repibiki ya Afríka ya Káti";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Centrinės Afrikos Respublika";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Ditunga dya Afrika wa munkatshi";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Centrālāfrikas Republika";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Repoblika Ivon’Afrika";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "സെൻട്രൽ ആഫ്രിക്കൻ റിപ്പബ്ലിക്ക്";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Төв Африкийн Бүгд Найрамдах Улс";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "केंद्रीय अफ्रिकी प्रजासत्ताक";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "ir-Repubblika Ċentru-Afrikana";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဗဟို အာဖရိက ပြည်ထောင်စု";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "Den sentralafrikanske republikk";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "मध्य अफ्रिकी गणतन्त्र";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "Den sentralafrikanske republikken";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ମଧ୍ୟ ଆଫ୍ରିକୀୟ ସାଧାରଣତନ୍ତ୍ର";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਕੇਂਦਰੀ ਅਫ਼ਰੀਕੀ ਗਣਰਾਜ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "وسطي افريقا جمهور";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "Republica Centralafricana";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Repubulika ya Santarafurika";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Republica Centrafricană";
        ...
        test("has translation for 'sd' locale", () {
          const expectedName = "وچ آفريقي جمهوريه";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Gaska-Afrihká dásseváldi";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Ködörösêse tî Bêafrîka";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "මධ්‍යම අප්‍රිකානු ජනරජය";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "Centralnoafriška republika";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Jamhuuriyadda Afrikada Dhexe";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Republika e Afrikës Qendrore";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "மத்திய ஆப்ரிக்கக் குடியரசு";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "సెంట్రల్ ఆఫ్రికన్ రిపబ్లిక్";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Ҷумҳурии Африқои Марказӣ";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "สาธารณรัฐแอฟริกากลาง";
        ...
        test("has translation for 'ti' locale", () {
          const expectedName = "ማእከላይ ኣፍሪቃ ሪፓብሊክ";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Merkezi Afrika Respublikasy";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Lepupelika ʻAfilika Lotoloto";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "Үзәк Африка Республикасы";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ئوتتۇرا ئافرىقا جۇمھۇرىيىتى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Центральноафриканська Республіка";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Markaziy Afrika Respublikasi";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Cộng hòa Trung Phi";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Repiblik Sàntar Afrik";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "צענטראַל־אַפֿריקאַנישע רעפּובליק";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Àrin gùngun Áfíríkà";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Central African Republic";
        ...
        test("has translation for 'an' locale", () {
          const expectedName = "Republica Centroafricana";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "དབུས་ཨ་ཧྥེ་རི་ཁན་རི་པཔ་ལིཀ།";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "މެދުތެރޭ އެފްރިކާގެ ޖުމްހޫރިއްޔާ";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Pobblaght yn Affrick Veanagh";
        ...
        test("has translation for 'ht' locale", () {
          const expectedName = "Repiblik santafrik";
        ...
        test("has translation for 'io' locale", () {
          const expectedName = "Centrafrika";
        ...
        test("has translation for 'kg' locale", () {
          const expectedName = "Repubilika ya Afelika ya Kati";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Respublica Africae Mediae";
        ...
        test("has translation for 'li' locale", () {
          const expectedName = "Centraal Afrika";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Te Puku o Āwherika";
        ...
        test("has translation for 'na' locale", () {
          const expectedName = "Ripubrikin Aprika Yugaga";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Naakaii Łizhinii Bikéyah Beʼałnííʼ";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Centreafrica";
        ...
        test("has translation for 'os' locale", () {
          const expectedName = "Централон Африкæйы Республикæ";
        ...
        test("has translation for 'rw' locale", () {
          const expectedName = "Repubulika ya Santara Afurika";
        ...
        test("has translation for 'sa' locale", () {
          const expectedName = "केन्द्रीय अफ्रीका गणराज्यम्";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "Tzentràfrica";
        ...
        test("has translation for 'ss' locale", () {
          const expectedName = "Umkhatsi we-Afrikha";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Republika ng Gitnang Aprika";
        ...
        test("has translation for 'ts' locale", () {
          const expectedName = "Afrika Wale Xikarhi";

          final translated = value.maybeTranslation(
            const BasicLocale(LangTso()),
            useLanguageFallback: false,
          );
          ...
          expect(commonMapTranslation, expectedName);
          final unexpectedScriptTranslation = value.maybeTranslation(
            const BasicLocale(LangTso(), script: ScriptCyrs()),
          );
        ...
        test("has translation for 'vo' locale", () {
          const expectedName = "Zänoda-Frikop";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Тӗп Африка Республики";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "ECentral African Republic";
        ...
        test("has translation for 'ab' locale", () {
          const expectedName = "Агәҭантәи-Африкатәи Ареспублика";
        ...
        test("has translation for 'ie' locale", () {
          const expectedName = "Central African Republica";
        ...
        test("has translation for 'az_Cyrl' locale", () {
          const expectedName = "Мәркәзи Африка Республикасы";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Марказий Африка Республикаси";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Àrin gùngun Áfíríkà";
