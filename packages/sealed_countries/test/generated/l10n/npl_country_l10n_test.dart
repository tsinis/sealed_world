...
void main() => group(
      "$CountryNpl() L10N",
      () {
        const value = CountryNpl();

        test("has translation for 'en' locale", () {
          const expectedName = "Nepal";
          const expectedFullName = "Federal Democratic Republic of Nepal";
        ...
        test("has translation for 'sr' locale", () {
          ...
          const expectedFullName = "Савезна Демократска Република Непал";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "نيبال";
          const expectedFullName = "جمهورية نيبال الديمقراطية الاتحادية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Nepal";
          const expectedFullName = "Republik Demokratel Kevreadel Nepal";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Nepál";
          const expectedFullName = "Federativní demokratická republika Nepál";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Nepal";
          const expectedFullName = "Demokratische Bundesrepublik Nepal";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Nepal";
          const expectedFullName = "Nepali Demokraatlik Liitvabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Nepal";
          const expectedFullName = "Nepalin demokraattinen liittotasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Népal";
          const expectedFullName = "République du Népal";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Nepal";
          const expectedFullName = "Savezna Demokratska Republika Nepal";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Nepál";
          const expectedFullName = "Nepáli Szövetségi Demokratikus Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Nepal";
          const expectedFullName = "Repubblica federale democratica del Nepal";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ネパール";
          const expectedFullName = "ネパール連邦民主共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "네팔";
          const expectedFullName = "네팔 연방 민주 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Nepal";
          const expectedFullName = "Federale Democratische Republiek Nepal";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "نپال";
          const expectedFullName = "جمهوری فدرال دموکراتیک نپال";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Nepal";
          const expectedFullName = "Federalna Demokratyczna Republika Nepalu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Nepal";
          const expectedFullName = "República Democrática Federal do Nepal";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Nepal";
          const expectedFullName = "República Democrática Federal de Nepal";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Nepal";
          const expectedFullName = "Demokratiska förbundsrepubliken Nepal";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Nepal";
          const expectedFullName = "Nepal Federal Demokratik Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "نیپال";
          const expectedFullName = "وفاقی جمہوری جمہوریہ نیپال";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "尼泊尔";
          const expectedFullName = "尼泊尔联邦民主共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Nepal nutome";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Nepa";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Nepa";
