...
void main() => group(
      "$CountryEth() L10N",
      () {
        const value = CountryEth();

        test("has translation for 'en' locale", () {
          const expectedName = "Ethiopia";
          const expectedFullName = "Federal Democratic Republic of Ethiopia";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Етиопија";
          const expectedFullName = "Савезна Демократска Република Етиопија";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "إثيوبيا";
          const expectedFullName = "جمهورية إثيوبيا الفدرالية الديموقراطية";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Etiopia";
          const expectedFullName = "Republik Demokratel Kevredadel Etiopia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Äthiopien";
          const expectedFullName = "Demokratische Bundesrepublik Äthiopien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Etioopia";
          const expectedFullName = "Etioopia Demokraatlik Liitvabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Etiopia";
          const expectedFullName = "Etiopian demokraattinen liittotasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Etiopija";
          const expectedFullName = "Savezna Demokratska Republika Etiopija";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Etiópia";
          const expectedFullName = "Etióp Szövetségi Demokratikus Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Etiopia";
          const expectedFullName = "Repubblica federale democratica di Etiopia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "エチオピア";
          const expectedFullName = "エチオピア連邦民主共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "에티오피아";
          const expectedFullName = "에티오피아 연방 민주 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Ethiopië";
          const expectedFullName = "Federale Democratische Republiek Ethiopië";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "اِتیوپی";
          const expectedFullName = "جمهوری فدرال دموکراتیک اتیوپی";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Etiopia";
          const expectedFullName = "Federalna Demokratyczna Republika Etiopii";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Etiópia";
          const expectedFullName = "República Federal Democrática da Etiópia";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Etiopía";
          const expectedFullName = "República Democrática Federal de Etiopía";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Etiopien";
          const expectedFullName = "Demokratiska förbundsrepubliken Etiopien";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Etiyopya";
          const expectedFullName = "Etiyopya Federal Demokratik Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "ایتھوپیا";
          const expectedFullName = "وفاقی جمہوری جمہوریہ ایتھوپیا";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "埃塞俄比亚";
          const expectedFullName = "埃塞俄比亚联邦民主共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཨི་ཐི་ཡོ་པི་ཡ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Etiopia nutome";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "အီသီယိုးပီးယား";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "எத்தியோப்பியா";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Etopia";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ཨི་ཐི་ཨོ་པི་ཡ།";
        ...
        test("has translation for 'aa' locale", () {
          const expectedName = "Otobbia";

          final translated = value.maybeTranslation(
            const BasicLocale(LangAar()),
            useLanguageFallback: false,
          );
          ...
          expect(commonMapTranslation, expectedName);
          final unexpectedScriptTranslation = value.maybeTranslation(
            const BasicLocale(LangAar(), script: ScriptCyrs()),
          );

          expect(unexpectedScriptTranslation?.name, expectedName);
          expect(
            value.translations,
            contains(const TranslatedName(LangAar(), name: expectedName)),
          );
        });
        test("has translation for 'ab' locale", () {
          const expectedName = "Ефиопиа";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Aihsaiwzbizya";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Etopia";
