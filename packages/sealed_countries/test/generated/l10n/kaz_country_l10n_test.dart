...
void main() => group(
      "$CountryKaz() L10N",
      () {
        const value = CountryKaz();

        test("has translation for 'en' locale", () {
          const expectedName = "Kazakhstan";
          const expectedFullName = "Republic of Kazakhstan";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Казахстан";
          const expectedFullName = "Република Казахстан";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "كازاخستان";
          const expectedFullName = "جمهورية كازاخستان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "Kazakstan";
          const expectedFullName = "Republik Kazakstan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Kazachstán";
          const expectedFullName = "Republika Kazachstán";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Kasachstan";
          const expectedFullName = "Republik Kasachstan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Kasahstan";
          const expectedFullName = "Kasahstani Vabariik";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Kazakstan";
          const expectedFullName = "Kazakstanin tasavalta";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "Kazakhstan";
          const expectedFullName = "République du Kazakhstan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "Kazahstan";
          const expectedFullName = "Republika Kazahstan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Kazahsztán";
          const expectedFullName = "Kazah Köztársaság";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "Kazakistan";
          const expectedFullName = "Repubblica del Kazakhstan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "カザフスタン";
          const expectedFullName = "カザフスタン共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "카자흐스탄";
          const expectedFullName = "카자흐스탄 공화국";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Kazachstan";
          const expectedFullName = "Republiek Kazachstan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "قزاقستان";
          const expectedFullName = "جمهوری قزاقستان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Kazachstan";
          const expectedFullName = "Republika Kazachstanu";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Cazaquistão";
          const expectedFullName = "República do Cazaquistão";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Казахстан";
          const expectedFullName = "Республика Казахстан";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Kazachstan";
          const expectedFullName = "Kazašská republika";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "Kazajistán";
          const expectedFullName = "República de Kazajstán";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Kazakstan";
          const expectedFullName = "Republiken Kazakstan";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Kazakistan";
          const expectedFullName = "Kazakistan Cumhuriyeti";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "قازقستان";
          const expectedFullName = "جمہوریہ قازقستان";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "哈萨克斯坦";
          const expectedFullName = "哈萨克斯坦共和国";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "কাজাখাস্তান";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Кхазакхстан";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Kazakstan nutome";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "an Chasacstáin";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Kazakistani";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "កាហ្សាក់ស្ថាន";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಕಝಾಕಿಸ್ಥಾನ್";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Kazakisitaani";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Kazachstanas";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "il-Każakistan";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "କାଜାକାସ୍ତାନ";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Kazakisitani";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "Kazakisitäan";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Kasaakhistaan";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Qozogʻiston";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Orílẹ́ède Kaṣaṣatani";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Kazakhstan";
        ...
        test("has translation for 'an' locale", () {
          const expectedName = "Cazaquistán";
        ...
        test("has translation for 'av' locale", () {
          const expectedName = "Хъазахъистан";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ཀཛ་ཀིསུ་གཏན།";
        ...
        test("has translation for 'dv' locale", () {
          const expectedName = "ކަޒަކިސްތާން";
        ...
        test("has translation for 'gv' locale", () {
          const expectedName = "Yn Chassaghstaan";
        ...
        test("has translation for 'kl' locale", () {
          const expectedName = "Kasakhstani";
        ...
        test("has translation for 'la' locale", () {
          const expectedName = "Kazachstania";
        ...
        test("has translation for 'nv' locale", () {
          const expectedName = "Kʼazah Bikéyah";
        ...
        test("has translation for 'za' locale", () {
          const expectedName = "Hahsazgwswhdanj";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "EKazakhstan";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Orílɛ́ède Kashashatani";
