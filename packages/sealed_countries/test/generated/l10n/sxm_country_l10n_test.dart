...
void main() => group(
      "$CountrySxm() L10N",
      () {
        const value = CountrySxm();

        test("has translation for 'en' locale", () {
          const expectedName = "Sint Maarten";
        ...
        test("has translation for 'sr' locale", () {
          ...
          const expectedFullName = "Свети Мартин (Холандија)";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "Svatý Martin (Nizozemsko)";
        ...
        test("has translation for 'fr' locale", () {
          ...
          const expectedFullName = "Sint Maarten";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "シント・マールテン";
          const expectedFullName = "シントマールテン島";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Синт-Мартен";
          const expectedFullName = "Синт-Маартен";
          final translated = value.maybeTranslation(
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "চিণ্ট মাৰ্টেন";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Sint-Marten";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Сінт-Мартэн";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "সিন্ট মার্টেন";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "སིནཊ་ མཱར་ཊེན";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Άγιος Μαρτίνος (Ολλανδικό τμήμα)";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "સિંટ માર્ટેન";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "सिंट मार्टिन";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Սինտ Մարտեն";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Sankti Martin";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Sint Martén";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "სინტ-მარტენი";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಸಿಂಟ್ ಮಾರ್ಟೆನ್";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Sint Martenas";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Sintmārtena";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "സിന്റ് മാർട്ടെൻ";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "सिंट मार्टेन";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "सिन्ट मार्टेन";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ସିଣ୍ଟ ମାର୍ଟୀନ୍‌";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਸਿੰਟ ਮਾਰਟੀਨ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "سینټ مارټین";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "Vuolleeatnamat Saint Martin";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ශාන්ත මාර්ටෙන්";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Siint Maarteen";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "சின்ட் மார்டென்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "సింట్ మార్టెన్";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "Синт-Маартен";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ซินต์มาร์เทน";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Sā Mātini (fakahōlani)";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "سىنت مارتېن";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "Сінт-Мартен";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Sint Maarten";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤅𞤫𞤲𞤼𞤵 𞤃𞤢𞥄𞤪𞤼𞤫𞤲";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "San Maarten";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "Sancte Martino nederlandese";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "Sint Marteen";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Hiti Mātene";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "ESint Maarten";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Síntì Mátẹ́ẹ̀nì";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Sint Maarten nutome";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "سِنٹ مارٹِن";
        ...
        test("has translation for 'oc' locale", () {
          const expectedName = "Sant Martin";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Свети Мартин (Холандија)";
