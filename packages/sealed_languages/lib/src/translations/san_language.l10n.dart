...
/// Provides 110 translations for a Sanskrit (Saṁskṛta) language:
/// - (Eastern) Punjabi
/// - Afrikaans
/// - Albanian
/// - Amharic
...
const sanLanguageTranslations = [
  ...
  TranslatedName(LangFul(), name: "𞤅𞤢𞤲𞤧𞤳𞤪𞤭𞤼𞤪𞤫", script: ScriptAdlm()),
  ...
  TranslatedName(LangAfr(), name: "Sanskrit"),
  TranslatedName(LangMsa(), name: "Sanskrit"),
  TranslatedName(LangTgl(), name: "Sanskrit"),
];
