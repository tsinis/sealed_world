...
/// Provides 114 translations for a (Scottish) Gaelic language:
/// - (Eastern) Punjabi
/// - (Scottish) Gaelic
/// - Afrikaans
/// - Albanian
...
const glaLanguageTranslations = [
  ...
  TranslatedName(LangAsm(), name: "স্কটিচ গেইলিক"),
  TranslatedName(LangChe(), name: "гэлийн"),
  TranslatedName(
    LangFul(),
    name: "𞤅𞤭𞤳𞤮𞤼𞤭𞤧𞤪𞤫 𞤘𞤢𞤫𞤭𞤳",
    script: ScriptAdlm(),
  ),
  TranslatedName(LangHau(), name: "Kʼabilan Scots Gaelic"),
  TranslatedName(LangHye(), name: "շոտլանդական գաելերեն"),
  TranslatedName(LangIna(), name: "gaelico scotese"),
  TranslatedName(LangIbo(), name: "Sụkọtịs Gelị"),
  TranslatedName(LangJav(), name: "Gaulia"),
  TranslatedName(LangKaz(), name: "шотландиялық гэль тілі"),
  TranslatedName(LangKur(), name: "gaelîka skotî"),
  TranslatedName(LangKir(), name: "шотладиялык гелча"),
  TranslatedName(LangMri(), name: "Keiriki Kotimana"),
  TranslatedName(LangMya(), name: "စကော့တစ်ရှ် ဂေးလစ်ခ်"),
  TranslatedName(LangNep(), name: "स्कटिस गाएलिक"),
  TranslatedName(LangPan(), name: "ਸਕਾਟਿਸ਼ ਗੇਲਿਕ"),
  TranslatedName(LangPus(), name: "سکاټلېنډي ګېلک"),
  TranslatedName(LangSrd(), name: "gaèlicu iscotzesu"),
  TranslatedName(LangSnd(), name: "اسڪاٽش گيلڪ"),
  TranslatedName(LangSin(), name: "ස්කොට්ටිශ් ගෙලික්"),
  TranslatedName(LangSom(), name: "Iskot Giilik"),
  TranslatedName(LangSqi(), name: "galishte skoceze"),
  TranslatedName(LangTgk(), name: "шотландии гэлӣ"),
  TranslatedName(LangTuk(), name: "şotland kelt dili"),
  TranslatedName(LangTat(), name: "шотланд гэль"),
  TranslatedName(LangUzb(), name: "shotland-gel"),
  TranslatedName(LangWol(), name: "Galuwaa bu Ekos"),
];
