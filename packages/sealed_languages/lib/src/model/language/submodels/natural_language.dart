...
class NaturalLanguage extends Language
  ...
  String toString({bool short = true}) => short
      ? super.toString()
      : """NaturalLanguage(name: "$name", code: "$code", codeShort: "$codeShort", namesNative: ${jsonEncode(namesNative)}, bibliographicCode: "$bibliographicCode", family: ${family.runtimeType}(), isRightToLeft: $isRightToLeft)""";
