...
abstract class BasicLocaleParser<T extends BasicLocale> {
  const BasicLocaleParser({this.languages, this.scripts});
  ...
  T toLocale(NaturalLanguage language, Script? script, String? countryCode);

  T? parse(Object? locale) {
