...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "North Ndebele";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Noord-Ndebele";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "النديبيل الشمالي";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "şimali ndebele";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "северен ндебеле";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "উত্তর এন্দেবিলি";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "ndebele an Norzh";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "sjeverni ndebele";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "северни ндебеле";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "ndebele septentrional";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "ndebele (Zimbabwe)";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Ndebele Gogleddol";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "nordndebele";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Nord-Ndebele-Sprache";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "dziehe ndebelegbe";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Ντεμπέλε Βορρά";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "põhjandebele";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "iparraldeko ndebeleera";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "انده‌بله‌ای شمالی";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "pohjois-ndebele";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "ndébélé du Nord";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Noard-Ndbele";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Ndeibéilis an Tuaiscirt";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Ndebele Thuathach";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "ndebele do norte";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "उत्तरी देबेल";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "északi ndebele";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "հյուսիսային նդեբելե";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Ndebele Utara";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "norður-ndebele";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "ndebele del nord";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ჩრდილოეთ ნდებელე";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "солтүстік ндебел";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಉತ್ತರ ದೆಬೆಲೆ";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "شُمال ڈَبیل";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "түндүк ндыбелче";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Nord-Ndebele-Sprooch";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ເອັນເດເບເລເໜືອ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "šiaurės ndebelų";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "ziemeļndebelu";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "നോർത്ത് ഡെബിൾ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "хойд ндебеле";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "उत्तर देबेली";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "တောင်ဒီဘီလီ";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "nord-ndebele";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "उत्तर नेडेबेले";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଉତ୍ତର ନେଡବେଲେ";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਉੱਤਰੀ ਨਡੇਬੇਲੇ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "ndebele północny";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "ndebele dal nord";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "ndebele de nord";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "северный ндебели";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "උතුරු එන්ඩිබෙලෙ";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "severné ndebele";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "severna ndebelščina";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "ndebelishte veriore";
        ...
        test("has translation for 'sr_Latn' locale", () {
          const expectedName = "severni ndebele";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Kindebele cha Kaskazini";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "வடக்கு தெபெலே";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "ఉత్తర దెబెలె";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "เอ็นเดเบเลเหนือ";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakanetepele-tokelau";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Kuzey Ndebele";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "شىمالى ندەبەلەچە";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "ндебелє північна";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "shimoliy ndebelcha";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tiếng Ndebele Miền Bắc";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "isi-North Ndebele";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "উত্তৰ নিবেবেলে";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "паўночная ндэбеле";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "къилбаседа ндебели";
        ...
        test("has translation for 'ff_Adlm' locale", () {
          const expectedName = "𞤐𞤣𞤫𞤦𞤫𞤤𞤫𞥅𞤪𞤫 𞤐𞤢𞤲𞥆𞤢𞥄𞤺𞤫";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Nọrtụ Ndabede";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Ndebele Lor";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "នេបេលេខាងជើង";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "ndebeliya bakurî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Enetepēra ki te Raki";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "شمالي نديبل";
        ...
        test("has translation for 'qu' locale", () {
          const expectedName = "Ndebele septentrional Simi";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "ndebele de su nord";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Indhebeele Waqooyi";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "demirgazyk ndebele dili";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Hilagang Ndebele";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Àríwá Ndebele";
