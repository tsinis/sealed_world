...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Norwegian Bokmål";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Noorse Bokmål";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "البوكمالية النرويجية";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "bokmal norveç";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "нарвэская букмал";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "норвежки букмол";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "নরওয়েজিয়ান বোকমাল";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "norvegeg bokmål";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "norveški bokmal";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "норвешки бокмал";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "noruec bokmål";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "norština (bokmål)";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Norwyeg Bokmål";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "norsk bokmål";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Norwegisch Bokmål";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ནོར་ཝེ་ཇི་ཡཱན་བོཀ་མཱལ་ཁ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "nɔweigbe bokmål";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Νορβηγικά Μποκμάλ";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "bokmal noruego";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "norra bokmål";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "bokmala (Norvegia)";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "بوکسمال نروژی";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "norjan bokmål";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "norskt bokmál";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "norvégien bokmål";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Noors - Bokmål";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Ioruais Bokmål";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Bokmål na Nirribhidh";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "noruegués bokmal";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "નોર્વેજીયન બોકમાલ";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "‏נורבגית ספרותית";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "नॉर्वेजियाई बोकमाल";
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "književni norveški";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "norvég bokmal";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "նորվեգերեն բուկմոլ";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Bokmål Norwegia";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "norskt bókmál";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "norvegese bokmål";
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ノルウェー語(ブークモール)";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ნორვეგიული ბუკმოლი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "норвегиялық букмол";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ន័រវែស បុកម៉ាល់";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ನಾರ್ವೆಜಿಯನ್ ಬೊಕ್ಮಲ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "ناروییَن بوکمال";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "норвежче (Букмал)";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Norwegesch Bokmål";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ນໍເວຈຽນ ບັອກມອລ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Norvegijos rašytinė – būkmolų";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "norvēģu bukmols";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "норвешки букмол";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "നോർവീജിയൻ ബുക്‌മൽ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "норвегийн букмол";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "नॉर्वेजियन बोकमाल";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Bokmål Norway";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "Bokmahal Norveġiż";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "नर्वेली बोकमाल";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ନରୱେଜିଆନ୍ ବୋକମଲ୍";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਨਾਰਵੇਜਿਆਈ ਬੋਕਮਲ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "norweski (bokmål)";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "bokmål norueguês";
        ...
        test("has translation for 'pt_PT' locale", () {
          const expectedName = "norueguês bokmål";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "norvegais bokmål";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "norvegiană bokmål";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "норвежский букмол";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "girjedárogiella";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "නෝවේජියානු බොක්මාල්";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "nórsky bokmål";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "knjižna norveščina";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "bokmalishte norvegjeze";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "norskt bokmål";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Kibokmal cha Norwe";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "நார்வேஜியன் பொக்மால்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "నార్వీజియన్ బొక్మాల్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "นอร์เวย์บุคมอล";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Norwegian Bokmal";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakanouaē-pokimali";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Norveççe Bokmål";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "نورۋىگىيە بوكمالچە";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "букмол (Норвегія)";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "نارویجین بوکمل";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "norvegcha bokmal";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Норвегча Бокмал";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tiếng Na Uy (Bokmål)";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "isi-Norwegian Bokmål";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "নৰৱেজিয়ান বোকমাল";
        ...
        test("has translation for 'ff_Adlm' locale", () {
          const expectedName = "𞤐𞤮𞤪𞤱𞤫𞤶𞤭𞤴𞤢𞤲𞤪𞤫 𞤄𞤮𞤳𞤥𞤢𞤤";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "norvegiano bokmål";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Nọrweyịan Bọkmal";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "norwecî (bokmål)";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Pakamō Nōwei";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "ناروېئي (بوکمال)";
        ...
        test("has translation for 'qu' locale", () {
          const expectedName = "Noruego Bokmål Simi";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "norvegesu bokmål";
        ...
        test("has translation for 'sd' locale", () {
          const expectedName = "نارويائي بوڪمال";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Nawrijii Bokmål";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "norwegiýa bukmol dili";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Nọ́ọ́wè Bokímàl";
