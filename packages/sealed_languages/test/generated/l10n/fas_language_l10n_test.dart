...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Pɛɛhyia kasa";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "perisanikan";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "པར་ཤི་ཡཱན་ཁ";
        ...
        test("has translation for 'nd' locale", () {
          const expectedName = "isi-Pheshiyani";
        ...
        test("has translation for 'om' locale", () {
          const expectedName = "Afaan Persia";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "persijagiella";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "perzijščina";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakapēsia";
        ...
        test("has translation for 'uz_Arab' locale", () {
          const expectedName = "دری";

          final translated = value.maybeTranslation(
            const BasicLocale(LangUzb(), script: ScriptArab()),
            useLanguageFallback: false,
          );
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tiếng Ba Tư";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "isi-Persian";
