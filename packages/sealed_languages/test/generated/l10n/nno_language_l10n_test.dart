...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Noorweegse Nynorsk";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የኖርዌይ ናይኖርስክ";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "النينورسك النرويجي";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "নৰৱেজিয়ান নায়নোৰ্স্ক";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "nünorsk norveç";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "нарвежская (нюнорск)";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "норвежки нюношк";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "নরওয়েজীয়ান নিনর্স্ক";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "norvegeg nynorsk";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "norveški njorsk";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "норвешки њорск";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "noruec nynorsk";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "норвегийн нюнорск";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "norština (nynorsk)";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Norwyeg Nynorsk";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Norwegisch Nynorsk";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ནོར་ཝེ་ཇི་ཡཱན་ནོརསཀ་ཁ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "nɔweigbe ninɔsk";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Νορβηγικά Νινόρσκ";
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Norwegian Nynorsk";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "nynorsk noruego";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "norra nynorsk";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "nynorsk norvegiera";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "نرس جدید نروژی";
        ...
        test("has translation for 'ff_Adlm' locale", () {
          const expectedName = "𞤐𞤮𞤪𞤱𞤫𞤶𞤭𞤴𞤢𞤲𞤪𞤫 𞤙𞤮𞤪𞤧𞤳";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "norjan nynorsk";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "norvégien nynorsk";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Noors - Nynorsk";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Nua-Ioruais";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Nynorsk na Nirribhidh";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "noruegués nynorsk";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "નૉર્વેજીયન નાયનૉર્સ્ક";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "נורבגית חדשה";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "नॉर्वेजियाई नॉयनॉर्स्क";
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "novonorveški";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "norvég nynorsk";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "նորվեգերեն նյունորսկ";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "norvegiano nynorsk";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Nynorsk Norwegia";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Nọrweyịan Nynersk";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "norvegese nynorsk";
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ノルウェー語(ニーノシュク)";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ნორვეგიული ნიუნორსკი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "норвегиялық нинорск";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ន័រវែស នីនូស";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ನಾರ್ವೆಜಿಯನ್ ನೈನೊಸ್ಕ್";
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "노르웨이어(니노르스크)";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "ناروییَن نَے نورسک";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "norwecî (nynorsk)";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "норвежче (Нинорск)";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Norwegesch Nynorsk";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ນໍເວຈຽນ ນີນອກ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "naujoji norvegų";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "jaunnorvēģu";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Nīnōka Nōwei";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "норвешки нинорск";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "നോർവീജിയൻ നൈനോർക്‌സ്";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "норвегийн нинорск";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "नॉर्वेजियन न्योर्स्क";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Nynorsk Norway";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "Ninorsk Norveġiż";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "နော်ဝေး နီးနော်စ်ခ်";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "norsk nynorsk";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "नर्वेली नाइनोर्स्क";
        ...
        test("has translation for 'om' locale", () {
          const expectedName = "Afaan Norwegian";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ନରୱେଜିଆନ୍ ନିୟୋର୍ସ୍କ";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਨਾਰਵੇਜਿਆਈ ਨਿਓਨੌਰਸਕ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "norweski (nynorsk)";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "ناروېئي (نائنورسک)";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "nynorsk norueguês";
        ...
        test("has translation for 'pt_PT' locale", () {
          const expectedName = "norueguês nynorsk";
        ...
        test("has translation for 'qu' locale", () {
          const expectedName = "Noruego Nynorsk Simi";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "norvegiais nynorsk";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "norvegiană nynorsk";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "норвежский нюнорск";
        ...
        test("has translation for 'rw' locale", () {
          const expectedName = "Inyenoruveji (Nyonorusiki)";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "norvegesu nynorsk";
        ...
        test("has translation for 'sd' locale", () {
          const expectedName = "نارويائي نيوناسڪ";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "ođđadárogiella";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "නොවේර්ජියානු නයිනෝර්ස්ක්";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "nórsky nynorsk";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "novonorveščina";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Nawriijiga Nynorsk";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "ninorske norvegjeze";
        ...
        test("has translation for 'sr_Latn' locale", () {
          const expectedName = "norveški ninorsk";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Kinorwe Kipya";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "நார்வேஜியன் நியூநார்ஸ்க்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "నార్విజియాన్ న్యోర్స్క్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "นอร์เวย์นีนอสก์";
        ...
        test("has translation for 'ti' locale", () {
          const expectedName = "ኖርዌይኛ (ናይ ኝኖርስክ)";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "norwegiýa nýunorsk dili";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakanoauē-ninosiki";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Norveççe Nynorsk";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "يېڭى نورۋېگچە";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "нюношк (Норвегія)";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "نورویجینی نینورسک";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "norvegcha ninorsk";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Норвегча Нинорск";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tiếng Na Uy (Nynorsk)";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "נײַ־נארוועגיש";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Nọ́ọ́wè Nínọ̀sìkì";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Norwegian Nynorsk";
