...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Inyamuranci";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Igbo-Sprooch";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakaʻikipō";
