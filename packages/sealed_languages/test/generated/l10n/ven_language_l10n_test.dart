...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Venda-Sprache";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Venda-Sprooch";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakavenitā";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tiếng Venda";
