...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'qu' locale", () {
          const expectedName = "Tartaro Simi";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakatatale";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tiếng Tatar";
