...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "siswatština";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "svazijščina";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakasuasilani";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tiếng Swati";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Wikang Swati";
