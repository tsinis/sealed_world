...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Pungyabi kasa";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "pɛnijabikan";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "paňdžábština";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Puinseáibis";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Pandschabesch";
        ...
        test("has translation for 'nd' locale", () {
          const expectedName = "isi-Phunjabi";
        ...
        test("has translation for 'om' locale", () {
          const expectedName = "Afaan Punjabii";
        ...
        test("has translation for 'qu' locale", () {
          const expectedName = "Punyabi Simi";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "panjabigiella";
        ...
        test("has translation for 'se_FI' locale", () {
          const expectedName = "panjabagiella";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "pandžábčina";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "pandžabščina";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "penjab dili";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakapūnusapi";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tiếng Punjab";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Èdè Punjabi";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "isi-Punjabi";
