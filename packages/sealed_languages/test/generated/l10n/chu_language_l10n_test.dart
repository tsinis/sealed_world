...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Church Slavic";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "سلافية كنسية";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "kilsə slav dili";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "църковно славянски";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "চার্চ স্লাভিক";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "slavoneg iliz";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "staroslovenski";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "старословенски";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "eslau eclesiàstic";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "staroslověnština";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Hen Slafoneg";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "kirkeslavisk";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Kirchenslawisch";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Εκκλησιαστικά Σλαβικά";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "eslavo eclesiástico";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "kirikuslaavi";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "اسلاوی کلیسایی";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "kirkkoslaavi";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "slavon d’église";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Kerkslavysk";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Slavais na hEaglaise";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Slàbhais na h-Eaglaise";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "ચર્ચ સ્લાવિક";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "סלאבית כנסייתית עתיקה";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "चर्च साल्विक";
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "crkvenoslavenski";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "egyházi szláv";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Bahasa Gereja Slavonia";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "kirkjuslavneska";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "slavo della Chiesa";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "საეკლესიო სლავური";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಚರ್ಚ್ ಸ್ಲಾವಿಕ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "چٔرچ سلاوِک";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Kiercheslawesch";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "bažnytinė slavų";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "baznīcslāvu";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "црковнословенски";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ചർച്ച് സ്ലാവിക്";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "चर्च स्लाव्हिक";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Slavik Gereja";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "Slaviku tal-Knisja";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Kerkslavisch";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "kyrkjeslavisk";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଚର୍ଚ୍ଚ ସ୍ଲାଭିକ୍";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "staro-cerkiewno-słowiański";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "slav da baselgia";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "церковнославянский";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "cirkevná slovančina";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "stara cerkvena slovanščina";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "kyrkslaviska";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "சர்ச் ஸ்லாவிக்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "చర్చ స్లావిక్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "เชอร์ชสลาวิก";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakasilavia-fakasiasi";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Kilise Slavcası";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "قەدىمكى سلاۋيانچە";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "церковнослов’янська";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tiếng Slavơ Nhà thờ";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "קלויסטער־סלאַוויש";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Kerkslawies";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "চাৰ্চ শ্লেভিক";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "царкоўнаславянская";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "килсславянийн";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "elizako eslaviera";
        ...
        test("has translation for 'ff_Adlm' locale", () {
          const expectedName = "𞤅𞤭𞤤𞤾𞤭𞤳𞤪𞤫 𞤕𞤮𞥅𞤷𞤭";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "kirkju sláviskt";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "slavo ecclesiastic";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Slavia Gerejani";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "шіркеулік славян тілі";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "slaviya kenîseyî";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "чиркөө славянча";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "сүмийн славян";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ချပ်ချ် စလာဗစ်";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "चर्च स्लाभिक";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "د کليسا سلاوي";
        ...
        test("has translation for 'qu' locale", () {
          const expectedName = "Eslavo Eclesiástico Simi";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "islavu eclesiàsticu";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "චර්ච් ස්ලැවික්";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Kaniisadda Islaafik";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "sllavishte kishtare";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Kislovakia cha Kanisa";
        ...
        test("has translation for 'ti' locale", () {
          const expectedName = "ቤተ-ክርስትያን ስላቭኛ";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "buthana slaw dili";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "slavyan (cherkov)";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Èdè Síláfííkì Ilé Ìjọ́sìn";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "isi-Church Slavic";
