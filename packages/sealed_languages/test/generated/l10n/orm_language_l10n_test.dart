...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Afaan Oromo";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakaʻolomo";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tiếng Oromo";
