...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "гӀиргӀизойн";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "kyrgyzština";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "kirghistangbe";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "қырғыз тілі";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "គៀរហ្គីស្តង់";
        ...
        test("has translation for 'qu' locale", () {
          const expectedName = "Kirghiz Simi";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "kirgizština";
        ...
        test("has translation for 'sv_FI' locale", () {
          const expectedName = "kirgiziska";

          final translated = value.maybeTranslation(
            const BasicLocale(LangSwe(), countryCode: "FI"),
            useLanguageFallback: false,
          );
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "gyrgyz dili";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakakīsisi";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tiếng Kyrgyz";
