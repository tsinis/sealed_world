...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Wit-Russies";
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Belarus kasa";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "البيلاروسية";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "biyelorisikan";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "běloruština";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "hviderussisk";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Weißrussisch";
        ...
        test("has translation for 'de_CH' locale", () {
          const expectedName = "Weissrussisch";

          final translated = value.maybeTranslation(
            const BasicLocale(LangDeu(), countryCode: "CH"),
            useLanguageFallback: false,
          );
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "བེལ་ཨ་རུས་ཁ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "belarusiagbe";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Λευκορωσικά";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "bielorrusiera";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "valkovenäjä";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "hvitarussiskt";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Wyt-Russysk";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Bealarúisis";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Bealaruisis";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Belarusanci";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "բելառուսերեն";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "hvítrússneska";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "беларус тілі";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "بیلَروٗشیَن";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Wäissrussesch";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "libyelorisí";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Perarūhiana";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "hviterussisk";
        ...
        test("has translation for 'nd' locale", () {
          const expectedName = "isi-Bhelarashiyani";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Wit-Russisch";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "kviterussisk";
        ...
        test("has translation for 'om' locale", () {
          const expectedName = "Afaan Belarusia";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ବେଲାରୁଷିଆନ୍";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "bielorrusso";
        ...
        test("has translation for 'qu' locale", () {
          const expectedName = "Bielorruso Simi";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Ikibelarusiya";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "белорусский";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "vilges-ruoššagiella";
        ...
        test("has translation for 'se_FI' locale", () {
          const expectedName = "vilgesruoššagiella";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "බෙලරුසියානු";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "bieloruština";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "beloruščina";
        ...
        test("has translation for 'sn' locale", () {
          const expectedName = "chiBelarusi";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Beleruusiyaan";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "bjellorusisht";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "பெலாருஷியன்";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "belarus dili";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakapelalusi";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Beyaz Rusça";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tiếng Belarus";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Èdè Belarusi";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "isi-Belarusian";
