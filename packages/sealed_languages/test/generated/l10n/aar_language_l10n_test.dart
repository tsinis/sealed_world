...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ភាសាអាហ្វារ";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakaʻafāla";
