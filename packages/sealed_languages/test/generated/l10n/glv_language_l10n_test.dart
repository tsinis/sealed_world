...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "man-szigeti";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "manksgiella";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakamangikī";
