...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'om' locale", () {
          const expectedName = "Afaan Telugu";
        ...
        test("has translation for 'qu' locale", () {
          const expectedName = "Telugu Simi";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "telugijščina";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "telugu dili";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakaʻinitia-teluku";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "telugvancha";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tiếng Telugu";
