...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'om' locale", () {
          const expectedName = "Afaan Baskuu";
        ...
        test("has translation for 'qu' locale", () {
          const expectedName = "Euskera Simi";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "baskovščina";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakapāsiki";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tiếng Basque";
