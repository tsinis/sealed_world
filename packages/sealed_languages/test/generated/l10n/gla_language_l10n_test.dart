...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Scottish Gaelic";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Skotse Gallies";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "الغيلية الأسكتلندية";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "skot gaelik dili";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "шатландская гэльская";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "шотландски галски";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "স্কটস-গ্যেলিক";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "škotski galski";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "шкотски галски";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "gaèlic escocès";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "skotská gaelština";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Gaeleg yr Alban";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "skotsk gælisk";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Schottisches Gälisch";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Σκωτικά Κελτικά";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "gaélico escocés";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "eskoziako gaelikoa";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "گیلی اسکاتلندی";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "skotskt gæliskt";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "gaélique écossais";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Schotsk Gaelic";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Gaeilge na hAlban";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "સ્કોટ્સ ગેલિક";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "גאלית סקוטית";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "स्काट्स् गायेलिक्";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Gaelik Skotlandia";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "skosk gelíska";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "gaelico scozzese";
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "スコットランド・ゲール語";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "შოტლანდიური გელური";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ភាសាហ្កែលិគ (gd)";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಸ್ಕಾಟಿಶ್ ಗ್ಯಾಲಿಕ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "سکوٹِش گیےلِک";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Schottescht Gällesch";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ສະກັອດເກລິກ";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "шкотски гелски";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "സ്കോട്ടിഷ് ഗൈലിക്";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "шотланд келт";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "स्कॉट्स गेलिक";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Scots Gaelic";
        ...
        test("has translation for 'mt' locale", () {
          const expectedName = "Galliku Skoċċiż";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Schots-Gaelisch";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ସ୍କଟିସ୍ ଗାଏଲିକ୍";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "szkocki gaelicki";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "gaélico escocês";
        ...
        test("has translation for 'qu' locale", () {
          const expectedName = "Gaelico Escoces Simi";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "gaelic scot";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "gaelică scoțiană";
        ...
        test("has translation for 'rw' locale", () {
          const expectedName = "Ikigaluwa cy’Igisweduwa";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "škótska gaelčina";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "škotska gelščina";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "skotsk gäliska";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Kigaeli cha Uskoti";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "ஸ்காட்ஸ் கேலிக்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "స్కాటిష్ గేలిక్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "สกอตส์กาลิก";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakakaeliki";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "İskoç Gal Dili";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tiếng Xentơ (Xcốt len)";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "סקאטיש געליש";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Èdè Gaelik ti Ilu Scotland";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Scottish Gaelic";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "স্কটিচ গেইলিক";
        ...
        test("has translation for 'ff_Adlm' locale", () {
          const expectedName = "𞤅𞤭𞤳𞤮𞤼𞤭𞤧𞤪𞤫 𞤘𞤢𞤫𞤭𞤳";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Kʼabilan Scots Gaelic";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "շոտլանդական գաելերեն";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "gaelico scotese";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Sụkọtịs Gelị";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "шотландиялық гэль тілі";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "gaelîka skotî";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "шотладиялык гелча";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Keiriki Kotimana";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "စကော့တစ်ရှ် ဂေးလစ်ခ်";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "स्कटिस गाएलिक";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਸਕਾਟਿਸ਼ ਗੇਲਿਕ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "سکاټلېنډي ګېلک";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "gaèlicu iscotzesu";
        ...
        test("has translation for 'sd' locale", () {
          const expectedName = "اسڪاٽش گيلڪ";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ස්කොට්ටිශ් ගෙලික්";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Iskot Giilik";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "galishte skoceze";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "шотландии гэлӣ";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "şotland kelt dili";
        ...
        test("has translation for 'tt' locale", () {
          const expectedName = "шотланд гэль";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "shotland-gel";
        ...
        test("has translation for 'wo' locale", () {
          const expectedName = "Galuwaa bu Ekos";
