...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'om' locale", () {
          const expectedName = "Afaan Xhosa";
        ...
        test("has translation for 'qu' locale", () {
          const expectedName = "Isixhosa Simi";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakatōsa";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tiếng Xhosa";
