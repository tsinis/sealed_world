...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Ido-Sprache";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Ido-Sprooch";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakaʻito";
