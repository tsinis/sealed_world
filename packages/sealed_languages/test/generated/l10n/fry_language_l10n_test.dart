...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "ৱেষ্টাৰ্ণ ফ্ৰিছিয়ান";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "পশ্চিম ফ্রিসিয়";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "frizeg ar Cʼhornôg";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "frisó oriental";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "малхбузен-фризийн";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Ffriseg y Gorllewin";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Westfriesisch";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ནུབ་ཕྼི་སི་ཡན་ཁ";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Δυτικά Φριζιανά";
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Western Frisian";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "frisón occidental";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "läänefriisi";
        ...
        test("has translation for 'ff_Adlm' locale", () {
          const expectedName = "𞤊𞤭𞤪𞤭𞥅𞤧𞤭𞤴𞤢𞤲𞤳𞤮𞥅𞤪𞤫 𞤖𞤭𞤪𞤲𞤢";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "länsifriisi";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "vestfrisikt";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "frison occidental";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Freaslainnis Iartharach";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Frìoslannais Siarach";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "પશ્ચિમી ફ્રિશિયન";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Frisian ta Yamma";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "पश्चिमी फ़्रिसियाई";
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "zapadnofrizijski";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "արևմտյան ֆրիզերեն";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Frisia Barat";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Westan Frịsịan";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "vesturfrísneska";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "frisone occidentale";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Frisia Sisih Kulon";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "დასავლეთფრიზიული";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ហ្វ្រីស៊ានខាងលិច";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಪಶ್ಚಿಮ ಫ್ರಿಸಿಯನ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "مغربی فرِشیَن";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "батыш фризче";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Westfriesesch";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ເວສເທີນ ຟຣິຊຽນ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "vakarų fryzų";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "rietumfrīzu";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Whirīhiana ki te Uru";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "западнофризиски";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "പശ്ചിമ ഫ്രിഷിയൻ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "баруун фризын";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "पश्चिमी फ्रिशियन";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "အနောက်ပိုင်း ဖရီစီရန်";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "vestfrisisk";
        ...
        test("has translation for 'om' locale", () {
          const expectedName = "Afaan Firisiyaani";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ପଶ୍ଚିମ ଫ୍ରିସିୟନ୍";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਪੱਛਮੀ ਫ੍ਰਿਸੀਅਨ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "zachodniofryzyjski";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "لوېديځ فريشي";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "frísio ocidental";
        ...
        test("has translation for 'pt_PT' locale", () {
          const expectedName = "frísico ocidental";
        ...
        test("has translation for 'qu' locale", () {
          const expectedName = "Frison Simi";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "frizonă occidentală";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "западно-фризский";
        ...
        test("has translation for 'rw' locale", () {
          const expectedName = "Igifiriziyani";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "frisone otzidentale";
        ...
        test("has translation for 'sd' locale", () {
          const expectedName = "مغربي فريشن";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "oarjifriisagiella";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "බටහිර ෆ්‍රිසියානු";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "západná frízština";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "frizijščina";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Firiisiyan Galbeed";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "frizianisht";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "западни фризијски";
        ...
        test("has translation for 'sr_Latn' locale", () {
          const expectedName = "zapadni frizijski";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "västfrisiska";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Kifrisia cha Magharibi";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "மேற்கத்திய ஃப்ரிஷியன்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "పశ్చిమ ఫ్రిసియన్";
        ...
        test("has translation for 'tg' locale", () {
          const expectedName = "фризии ғарбӣ";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ฟริเซียนตะวันตก";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "günbatar friz dili";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Kanlurang Frisian";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakafilisia-hihifo";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Batı Frizcesi";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "غەربى فىرىزيەچە";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "західно-фризька";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "مغربی فریسیئن";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "gʻarbiy friziancha";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Ғарбий фризианча";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tiếng Frisia";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "מערב־פֿריזיש";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "isi-Western Frisian";
