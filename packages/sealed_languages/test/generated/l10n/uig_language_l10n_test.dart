...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "ույղուրերեն";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakaʻuikūli";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tiếng Uyghur";
