...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'om' locale", () {
          const expectedName = "Afaan Tamilii";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakatamili";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tiếng Tamil";
