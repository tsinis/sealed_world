...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Harshen Urdu";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakaʻūtū";
