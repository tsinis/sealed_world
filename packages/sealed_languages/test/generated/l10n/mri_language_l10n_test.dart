...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "maorigiella";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakamauli";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tiếng Maori";
