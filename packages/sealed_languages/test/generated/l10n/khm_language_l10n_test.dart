...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Kambodia kasa";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Kambodschanisch";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Καμποτζιανά";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "kambodjanskt";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Harshen Kimar";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Kambodschanesch";
        ...
        test("has translation for 'nd' locale", () {
          const expectedName = "isi-Khambodiya";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "cambodschan";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Igikambodiya";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "kambodiagiella";
        ...
        test("has translation for 'se_FI' locale", () {
          const expectedName = "kambožagiella";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Kamboodhian";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "kambodjanska";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakakamipōtia";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tiếng Khơ-me";
