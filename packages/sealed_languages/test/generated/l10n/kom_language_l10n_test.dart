...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Komi-Sprache";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Komi-Sprooch";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakakomi";
