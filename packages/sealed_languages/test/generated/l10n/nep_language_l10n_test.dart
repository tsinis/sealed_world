...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Nepalesisch";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Nepalesesch";
        ...
        test("has translation for 'om' locale", () {
          const expectedName = "Afaan Nepalii";
        ...
        test("has translation for 'qu' locale", () {
          const expectedName = "Nepali Simi";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "nepaligiella";
        ...
        test("has translation for 'se_FI' locale", () {
          const expectedName = "nepalagiella";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "nepalesiska";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakanepali";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tiếng Nepal";
