...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Bengali kasa";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "бенгальская";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "bengálština";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "бенгал тілі";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "бангладешче";
        ...
        test("has translation for 'nd' locale", () {
          const expectedName = "isi-Bhengali";
        ...
        test("has translation for 'om' locale", () {
          const expectedName = "Afaan Baangladeshi";
        ...
        test("has translation for 'qu' locale", () {
          const expectedName = "Bangla Simi";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "бенгальский";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "bengalgiella";
        ...
        test("has translation for 'se_FI' locale", () {
          const expectedName = "bengalagiella";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "bengalščina";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakapengikali";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "бенгальська";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tiếng Bengali";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Èdè Bengali";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "isi-Bengali";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "bengal dili";
