...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཨར་མི་ནི་ཡཱན་ཁ";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Armeniyanci";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "आर्मेनियाली";
        ...
        test("has translation for 'qu' locale", () {
          const expectedName = "Armenio Simi";
        ...
        test("has translation for 'rw' locale", () {
          const expectedName = "Ikinyarumeniya";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "armeenagiella";
        ...
        test("has translation for 'se_FI' locale", () {
          const expectedName = "armenagiella";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ආර්මේනියානු";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Armeeniyaan";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "ermeni dili";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakaʻāmenia";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tiếng Armenia";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Èdè Ile Armenia";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "isi-Armenia";
