...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Suid-Ndebele";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "النديبيل الجنوبي";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "দক্ষিণ দেবেল";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "cənub ndebele dili";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "паўднёвая ндэбеле";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "южен ндебеле";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "দক্ষিণ এনডেবেলে";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "ndebele ar Su";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "južni ndebele";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "јужни ндебеле";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "ndebele meridional";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "къилба ндебеле";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "ndebele (Jižní Afrika)";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Ndebele Deheuol";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Süd-Ndebele-Sprache";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Ντεμπέλε Νότου";
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "South Ndebele";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "lõunandebele";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "hegoaldeko ndebeleera";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "انده‌بله‌ای جنوبی";
        ...
        test("has translation for 'ff_Adlm' locale", () {
          const expectedName = "𞤐𞤣𞤫𞤦𞤫𞤤𞤫𞥅𞤪𞤫 𞤙𞤢𞥄𞤥𞤲𞤢𞥄𞤲𞤺𞤫";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "etelä-ndebele";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "suður ndebele";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "ndébélé du Sud";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Ndeibéilis an Deiscirt";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Ndebele Dheasach";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "દક્ષિણ દેબેલ";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Ndebele na Kudu";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "दक्षिण देबेल";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "déli ndebele";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "հարավային նդեբելե";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "ndebele del sud";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Ndebele Selatan";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Sọut Ndebele";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "suðurndebele";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Ndebele Kidul";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "სამხრეთ ნდებელური";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "оңтүстік ндебеле тілі";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "នេប៊េលខាងត្បូង";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ದಕ್ಷಿಣ ದೆಬೆಲೆ";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "جنوب ڈیٚبیل";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "ndebeliya başûrî";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "түштүк ндебелече";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Süd-Ndebele-Sprooch";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "pietų ndebele";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "dienvidndebelu";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Enetepēra ki te Tonga";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "јужен ндебеле";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ദക്ഷിണ നെഡിബിൾ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "өмнөд ндебеле";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "दक्षिणात्य देबेली";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "တောင် အွန်န်ဘီလီ";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "sør-ndebele";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "दक्षिण न्देबेले";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Zuid-Ndbele";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଦକ୍ଷିଣ ନେଡବେଲେ";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਸਾਊਥ ਨਡੇਬੇਲੇ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "ndebele południowy";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "سويلي نديبيل";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "ndebele do sul";
        ...
        test("has translation for 'qu' locale", () {
          const expectedName = "Ndebele del Sur Simi";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "ndebele dal sid";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "ndebele de sud";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "ндебели южный";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "ndebele de su sud";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "සෞත් ඩ්බේල්";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "južná ndebelčina";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "južna ndebelščina";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "ndebelishte jugore";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "தெற்கு தெபெலே";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "దక్షిణ దెబెలె";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "เอ็นเดเบเลใต้";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "günorta ndebele dili";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Timog Ndebele";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakanetepele-tonga";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Güney Ndebele";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "جەنۇبى ندەبەلەچە";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "ндебелє південна";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "جنوبی نڈیبیلی";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "janubiy ndebel";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tiếng Ndebele Miền Nam";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Èdè Gusu Ndebele";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "isi-South Ndebele";
