...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "kirundština";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Rundi-Sprache";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Rundi-Sprooch";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Wikang Kirundi";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakaluaniti";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tiếng Rundi";
