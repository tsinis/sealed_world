...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "الكازاخستانية";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "kazakhstangbe";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "កាហ្សាក់ស្តង់់";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "казакстански";
        ...
        test("has translation for 'qu' locale", () {
          const expectedName = "Kazajo Simi";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "kazakgiella";
        ...
        test("has translation for 'se_FI' locale", () {
          const expectedName = "kazakhgiella";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakakasaki";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tiếng Kazakh";
