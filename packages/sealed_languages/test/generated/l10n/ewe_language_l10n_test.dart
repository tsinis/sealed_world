...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Ewe-Sprooch";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakaʻeue";
