...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'rw' locale", () {
          const expectedName = "Ikilawotiyani";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakalau";
