...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Hawsaŋkoore";
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "haussagiella";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakahausa";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tiếng Hausa";
