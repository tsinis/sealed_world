...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'qu' locale", () {
          const expectedName = "Sindhi Simi";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "sindhi dili";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakasīniti";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tiếng Sindhi";
