...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakaʻavaliki";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tiếng Avaric";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "U dhashay Avar";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Èdè Afariki";
