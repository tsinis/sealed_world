...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'se' locale", () {
          const expectedName = "arábagiella";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "lea fakaʻalepea";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tiếng Ả Rập";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Èdè Arabiki";
