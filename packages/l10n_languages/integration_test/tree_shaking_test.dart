...
void main() {
  ...
  print(mapper.localize(const {"ENG"}, mainLocale: "en"));
}
''');
  });
  ...
  group("Tree-shaking verification", () {
    ...
    test(
      ...
      () async {
        ...
        expect(
          ...
          reason: "3 locales should be <10% of full build (3/157 ≈ 2%)",
        );
      },
      timeout: const Timeout(Duration(minutes: 5)),
    );
    ...
    test(
      ...
      () async {
        ...
        expect(
          jsContent.contains("anglais"), // French for "English".
          isFalse,
        ...
        expect(
          jsContent.contains("Englisch"), // German for "English".
          isTrue,
