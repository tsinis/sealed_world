...
- **Official and trusted dependencies only**: Built using only the Flutter SDK, official Google publisher packages (`meta` and `material_ui`), and the `sealed_world` monorepo for seamless, reliable integration.
