        ...
        context.hasMaterialL10n
            ? Material(
              ...
              child: TextField(
                ...
                textInputAction:
                    widget.copyFrom?.textInputAction ?? TextInputAction.search,
                textCapitalization:
                    widget.copyFrom?.textCapitalization ??
                ...
                inputFormatters:
                    widget.copyFrom?.inputFormatters ??
                ...
                selectionHeightStyle:
                    widget.copyFrom?.selectionHeightStyle ??
                    BoxHeightStyle.tight,
                selectionWidthStyle:
                    widget.copyFrom?.selectionWidthStyle ?? BoxWidthStyle.tight,
                keyboardAppearance: widget.copyFrom?.keyboardAppearance,
                scrollPadding:
                    widget.copyFrom?.scrollPadding ?? const EdgeInsets.all(20),
                dragStartBehavior:
                    widget.copyFrom?.dragStartBehavior ??
                ...
                magnifierConfiguration: widget.copyFrom?.magnifierConfiguration,
              ),
            )
            : DecoratedBox(
