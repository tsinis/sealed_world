...
void main() => group("NavigatorContextExtension", () {
  ...
  testWidgets("maybePop pops the current route if there is a previous route", (
    tester,
  ) async {
    final routeFirst = MaterialPageRoute<Object>(builder: (_) => Container());
    final routeSecond = MaterialPageRoute<Object>(
