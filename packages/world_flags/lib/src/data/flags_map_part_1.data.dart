...
const flagDmaProperties = FlagProperties(
  ...
  elementsProperties: [
    ...
    CustomElementsProperties(
      Color(0xff006000),
      otherColors: [Color(0xff00693f), Color(0xff7d76b6), Color(0xffffd420)],
...
const flagJeyProperties = FlagProperties(
  ...
  elementsProperties: [
    CustomElementsProperties(
      Color(0xffffd700),
      otherColors: [Color(0xffcf142b)],
      offset: Offset(0, -0.5815),
      heightFactor: 0.3781,
      widthFactor: 0.1441,
    ),
    ElementsProperties(
...
const flagPcnProperties = FlagProperties(
  ...
  elementsProperties: [
    CustomElementsProperties(
      Color(0xff006ec7),
      otherColors: [Color(0xff316d3a), Color(0xfff7e017)],
      offset: Offset(0.5, 0),
      heightFactor: 0.5,
      widthFactor: 0.176,
    ),
...
const flagSrbProperties = FlagProperties(
  ...
  elementsProperties: [
    CustomElementsProperties(
      Color(0xffc6363c),
      otherColors: [Color(0xffffffff), Color(0xffedb92e), Color(0xff0c4076)],
      offset: Offset(-0.2845, -0.06),
      heightFactor: 0.7399,
      widthFactor: 0.2517,
    ),
  ],
