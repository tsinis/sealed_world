...
void main() {
  ...
  print(mapper.localize(const {"USA"}, mainLocale: "en"));
}
''');
  });
  ...
  group("Tree-shaking verification", () {
    ...
    test(
      ...
      () async {
        ...
        expect(
          ...
          reason: "3 locales should be <10% of full build (3/193 ≈ 1.5%)",
        );
      },
      timeout: const Timeout(Duration(minutes: 5)),
    );
    ...
    test(
      ...
      () async {
        ...
        expect(
          jsContent.contains("États-Unis"), // French for "United States".
          isFalse,
        ...
        expect(
          jsContent.contains("Vereinigte Staaten"), // German for US.
          isTrue,
