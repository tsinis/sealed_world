...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Honduran Lempira";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Hondurese lempira";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የሃንዱራ ሌምፓአይራ";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "ليمبيرا هنداروس";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Honduras Lempirası";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "гандураская лемпіра";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Хондураска лемпира";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "হন্ডুরাস লেম্পিরা";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "lempira Honduras";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Honduraška lempira";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Хондурашка лемпира";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "lempira hondurenya";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Гондурасан лемпира";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "honduraská lempira";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "honduransk lempira";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Honduras-Lempira";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "honduraga lempira";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Λεμπίρα Ονδούρας";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "lempira hondureño";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Hondurase lempiira";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Hondurasko lempira";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "لمپیرای هندوراس";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Hondurasin lempira";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "lempira hondurien";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Lempira Hondúras";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Lempira Hondùrach";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "હોન્ડ્યુરન લેમ્પિરા";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "למפירה הונדורי";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "होंडुरन लेम्पिरा";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "hodurasi lempira";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Հոնդուրասական լեմպիրա";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "hondúrsk lempíra";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "lempira honduregna";
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ホンジュラス レンピラ";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ჰონდურასული ლემპირა";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Гондурас лемпирасы";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "លិមពីរ៉ា​ហុងឌូរ៉ាស";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಹೊಂಡುರಾನ್‌ ಲೆಂಪಿರಾ";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "حونڑورنُک لٮ۪مپیٖرا";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ຮອນດູແຣນ ເລມພິຣາ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Hondūro lempira";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Hondurasas lempīra";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Хондурска лемпира";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ഹോണ്ടുറൻ ലെംപിറ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "гондурасын лемпира";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "होन्डुरन लेंपिरा";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဟွန်ဒူးရပ်စ် လမ်းပီရာ";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "honduranske lempira";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "होन्डुरान लेम्पिरा";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਹਾਨਡੂਰਨ ਲੇਮਪਿਰਾ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "lempira honduraska";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Lempira hondurenha";
        ...
        test("has translation for 'pt_PT' locale", () {
          const expectedName = "Lempira das Honduras";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "lempira hondurian";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "lempira honduriană";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Гондурасская лемпира";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "හොන්ඩුරානු ලෙම්පිරා";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Lempira hondurase";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Lempira ya Hondurasi";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "ஹோன்டூரன் லெம்பீரா";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "హోండురన్ లెమిపిరా";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "เลมปิราฮอนดูรัส";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Lempira ng Honduras";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ھوندۇراس لېمپىراسى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "гондураська лемпіра";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "ہونڈوران لیمپیرا";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Gonduras lempirasi";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Гондурас лемпираси";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Honduran Lempira";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "হোন্দুৰান লেম্পিৰা";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Гондурас лемпирӗ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤂𞤫𞤥𞤨𞤭𞤪𞤢 𞤖𞤮𞤲𞤣𞤵𞤪𞤢𞤲𞤳𞤮";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Lempira na ƙasar Honduras";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "lempira hondurese";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Lempira obodo Honduras";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "lempîrayê hondurasî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Lempira Honotura";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ହୋଣ୍ଡୁରୀୟ ଲେମପିରା";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "هونډوران ليمپيرا";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "lempira hondurenu";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Lembirada Honduras";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Gonduras lempirasy";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Lẹmipírà Ọ́ńdúrà";
