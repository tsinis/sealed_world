...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Mozambican Metical";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Mosambiekse metical";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የሞዛምቢክ ሜቲካል";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "متكال موزمبيقي";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Mozambik Metikalı";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "мазамбікскі метыкал";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Мозамбикски метикал";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "মোজাম্বিক মেটিকেল";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "metical Mozambik";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Mozambijski metikal";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Мозамбијски метикал";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "metical moçambiquès";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Мозамбикан метикал";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "mozambický metical";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Metical Mozambique";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "mozambiquisk metical";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Mosambikanischer Metical";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Μετικάλ Μοζαμβίκης";
        ...
        test("has translation for 'es_MX' locale", () {
          const expectedName = "metical mozambiqueño";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Mosambiigi metikal";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Mozambikeko metikala";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "متیکال موزامبیک";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Mosambikin metical";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Mosambik metical";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "metical mozambicain";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Mozambikaanske metical";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Metical Mhósaimbíc";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Metical Mòsaimbiceach";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Metical de Mozambique";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "મોઝામ્બિકન મેટિકલ";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "מטיקל מוזמביני";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "मोज़ाम्बिकन मेटिकल";
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "mozambički metikal";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "mozambiki metikális";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Մոզամբիկյան մետիկալ";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "mósambískt metikal";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "metical mozambicano";
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "モザンビーク メティカル";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "მოზამბიკური მეტიკალი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Мозамбик метикалы";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "មីទីខល​ម៉ូសំប៊ិក";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಮೊಝಾಂಬಿಕನ್ ಮೆಟಿಕಲ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "موزیمبِکَن مٮ۪ٹِکَل";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Mosambikanesche Metical";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ໂມ​ແຊມ​ບິ​ກັນ ເມ​ທິ​ຄອນ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Mozambiko metikalis";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Mozambikas metikals";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Мозамбиски метикал";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "മൊസാംബിക്കൻ മെറ്റിക്കൽ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "мозамбик метикал";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "मोझांबिकन मेटिकल";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Metikal Mozambique";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "မိုဇမ်ဘစ် မက်တီခယ်လ်";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "mosambikiske metical";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "मोजाम्विकन मेटिकल";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Mozambikaanse metical";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "mosambikisk metical";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਮੋਜ਼ਾਮਬੀਕਨ ਮੈਟੀਕਲ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "metical mozambicki";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Metical moçambicano";
        ...
        test("has translation for 'pt_MZ' locale", () {
          const expectedName = "Metical de Moçambique";

          final translated = value.maybeTranslation(
            const BasicLocale(LangPor(), countryCode: "MZ"),
            useLanguageFallback: false,
          );
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "metical dal mozambican";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "metical mozambican";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Мозамбикский метикал";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "මොසැම්බිකන් මෙටිකල්";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "mozambiški metikal";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Metikali i Mozambikut";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Мозамбички метикал";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "moçambikisk metical";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Metikali ya Msumbiji";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "மொசாம்பிகன் மெடிகல்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "మొజాంబికన్ మెటికల్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "เมติคัลโมซัมบิก";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Mozambik Metikali";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "موزامبىك مېتىكالى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "мозамбіцький метикал";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "موزامبیقی میٹیکل";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Mozambican Metical";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "মোজাম্বিকান মেটিকল";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Мозамбик метикалӗ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤃𞤫𞤼𞤭𞤳𞤮𞤤 𞤃𞤮𞥁𞤢𞤥𞤦𞤭𞤲𞤳𞤮";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Metical na ƙasar Mozambique";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Metical obodo Mozambique";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Metical Mosambik";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "meticalê mozambîkî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Metical Mohapiki";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ମୋଜାମ୍ବିକୀୟ ମେଟିକାଲ୍";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "موزمبيقي ميټيکل";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "metical mozambicanu";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Metikalka Mosambik";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Mozambik metikaly";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "I-Metical yaseMozambique";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Mẹ́tíkààlì Mòsáḿbíìkì";
