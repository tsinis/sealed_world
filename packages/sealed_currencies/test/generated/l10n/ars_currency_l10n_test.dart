...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Argentine Peso";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Argentynse peso";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "بيزو أرجنتيني";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Argentina Pesosu";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "аргенцінскае песа";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Аржентинско песо";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "আর্জেন্টিনা পেসো";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "peso Arcʼhantina";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Argentinski pezos";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "аргентински пезо";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "peso argentí";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Аргентинан песо";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "argentinské peso";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Peso yr Ariannin";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "argentinsk peso";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Argentinischer Peso";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "argentinaga peso";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Πέσο Αργεντινής";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "peso argentino";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Argentina peeso";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Argentinako pesoa";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "پزوی آرژانتین";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Argentiinan peso";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Argentina peso";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "peso argentin";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Argentynske peso";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Peso na hAirgintíne";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Peso Argantaineach";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Peso arxentino";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "અર્જેન્ટીના પેસો";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "פסו ארגנטינאי";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "अर्जेंटीनी पेसो";
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "argentinski pezo";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "argentin peso";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Արգենտինական պեսո";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Peso Argentina";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "argentínskur pesi";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "არგენტინული პესო";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Аргентина песосы";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ប៉េសួអាហ្សង់ទីន";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಅರ್ಜೆಂಟಿನಾ ಪೆಸೊ";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "أرجَنٹیٖن پِسو";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "аргентина песосу";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Argentinesche Peso";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ອາ​ເຈນ​ທິ​ນາ ເປ​ໂຊ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Argentinos pesas";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Argentīnas peso";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Аргентински пезос";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "അർജൻറീൻ പെസോ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "аргентин песо";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "अर्जेंटाइन पेसो";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "အာဂျင်တီးနား ပီဆို";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "argentinske pesos";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "अर्जेन्टिनी पेसो";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Argentijnse peso";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਅਰਜਨਟੀਨੀ ਪੇਸੋ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "peso argentyńskie";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "peso argentinian";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Аргентинское песо";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ආර්ජන්ටිනා පෙසෝ";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "argentínske peso";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "argentinski peso";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Pesoja argjentinase";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Peso ya Ajentina";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "அர்ஜென்டைன் பெசோ";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "అర్జెంటీనా పెసో";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "เปโซอาร์เจนตินา";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Piso ng Argentina";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Arjantin Pesosu";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ئارگېنتىنا پېسوسى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "аргентинський песо";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "ارجنٹائن پیسہ";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Argentina pesosi";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Аргентина песоси";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Argentina Peso";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "আৰ্জেণ্টাইন পেছো";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Аргентина песийӗ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤆𞤫𞥅𞤧𞤮𞥅 𞤀𞤪𞤶𞤢𞤲𞤼𞤭𞤲𞤢𞤲𞤳𞤮";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Peso na ƙasar Argentina";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Peso obodo Argentina";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "pesoyê arjantînî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Peso Āketina";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଆର୍ଜେଣ୍ଟାଇନ୍‍ ପେସୋ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "ارجنټاين پسو";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "peso argentinu";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Beesada Arjentiin";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Argentin pesosy";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "IPeso yase-Argentina";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Pẹ́sò Agẹntínà";
