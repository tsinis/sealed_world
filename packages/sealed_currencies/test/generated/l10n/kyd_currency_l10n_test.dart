...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Cayman Islands Dollar";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Cayman-eilande dollar";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የካይማን ደሴቶች ዶላር";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "دولار جزر كيمن";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Kayman Adaları Dolları";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "долар Кайманавых астравоў";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Кайманов долар";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "কেম্যান দ্বীপপুঞ্জের ডলার";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "dollar Inizi Cayman";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Kajmanski dolar";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Кајманска острва долар";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "dòlar de les illes Caiman";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Кайманийн гӀайренийн доллар";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "kajmanský dolar";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Doler Ynysoedd Cayman";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "caymansk dollar";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Kaiman-Dollar";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "kayman ƒudomekpoga dollar";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Δολάριο Νήσων Κέιμαν";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "dólar de las Islas Caimán";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Kaimanisaarte dollar";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Kaiman uharteetako dolarra";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "دلار جزایر کِیمن";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Caymansaarten dollari";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Caymanoyggjar dollari";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "dollar des îles Caïmans";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Caymaneilânske dollar";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Dollar Oileáin Cayman";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Dolar Caimeanach";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Dólar das Illas Caimán";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "કેયમેન આઇલેંડ્સ ડોલર";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "דולר קיימאני";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "कैमेन द्वीपसमूह डॉलर";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "kajmán-szigeteki dollár";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Կայմանյան կղզիների դոլար";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Dolar Kepulauan Cayman";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "caymaneyskur dalur";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "dollaro delle Isole Cayman";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "კაიმანის კუნძულების დოლარი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Кайман аралдары доллары";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ដុល្លារ​កោះ​កៃម៉ែន";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಕೆಮ್ಯಾನ್‌ ಐಲ್ಯಾಂಡ್‌ನ ಡಾಲರ್‌";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "کیمین ججیٖرُک ڑالَر";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "кайман доллары";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ເຄ​ແມນ ໄອ​ແລນ ໂດ​ລ່າ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Kaimanų salų doleris";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Kaimanu salu dolārs";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Долар на кајмански острови";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "കേമാൻ ഐലൻഡ്‌സ് ഡോളർ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "кайман арлын доллар";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "केमेन आयलॅंड डॉलर";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ကေမန် ကျွန်းစု ဒေါ်လာ";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "caymanske dollar";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "केम्यान टापुहरूका डलर";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Kaaimaneilandse dollar";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਕੇਮੈਨ ਆਈਲੈਂਡਸ ਡਾਲਰ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "dolar kajmański";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Dólar das Ilhas Caiman";
        ...
        test("has translation for 'pt_PT' locale", () {
          const expectedName = "Dólar das Ilhas Caimão";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "dollar da las Inslas Cayman";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "dolar din Insulele Cayman";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Доллар Каймановых островов";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "කේමන් දූපත් ඩොලර්";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "kajmanský dolár";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Dollari i Ishujve Kajman";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Кајмански долар";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Cayman-dollar";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Dola ya Visiwa vya Cayman";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "கேமன் தீவுகள் டாலர்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "కేమాన్ దీవుల డాలర్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ดอลลาร์หมู่เกาะเคย์แมน";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Dolyar ng Cayman Islands";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Cayman Adaları Doları";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "كايمان ئاراللىرى دوللىرى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "долар Кайманових островів";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "کیمین آئلینڈز ڈالر";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Kayman orollari dollari";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Кайман ороли Доллари";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Đô la Quần đảo Cayman";
        ...
        test("has translation for 'zh_Hans_HK' locale", () {
          const expectedName = "开曼群岛元";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Cayman Islands Dollar";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "কেইমেন দ্বীপপুঞ্জৰ ডলাৰ";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Кайман утравӗсен долларӗ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤁𞤢𞤤𞤢 𞤅𞤵𞤪𞤭𞥅𞤶𞤫 𞤑𞤢𞤴𞤥𞤢𞥄𞤲";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Dalar ƙasar Tsibirai na Cayman";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "dollar del Insulas Caiman";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Dollar obodo Cayman Islands";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Dolar Kepuloan Caiman";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "dolarê giravên keymanî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Tāra Kāmana";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "କେମେନ୍ ଦ୍ଵୀପପୁଞ୍ଜ ଡଲାର୍";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "کيمن ټاپوګانو ډالر";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "dòllaru de sas Ìsulas Cayman";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Doolarka Kayman Aylaanis";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Kaýman adalarynyň dollary";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Dọ́là Erékùsù Cayman";
