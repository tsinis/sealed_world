...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Costa Rican Colón";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Costa Ricaanse colón";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "كولن كوستا ريكي";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Kosta Rika Kolonu";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "коста-рыканскі калон";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Костарикански колон";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "কোস্টা রিকা কোলোন";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "colón Costa Rica";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Kostarikanski kolon";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "colón costa-riqueny";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Костарикан колон";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "kostarický colón";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "costaricansk colón";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Costa-Rica-Colón";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "kosta rikaga kolón";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Κολόν Κόστα Ρίκα";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "colón costarricense";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Costa Rica koloon";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Costa Ricako colona";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "کولون کاستاریکا";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Costa Rican colon";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Kosta Rika colón";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "colón costaricain";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Costaricaanske colón";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Colón Chósta Ríce";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Colón Costa Rìceach";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Colón costarriqueño";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "કોસ્ટા રિકન કોલોન";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "קולון קוסטה־ריקני";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "कोस्टा रिका कोलोन";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Costa Rica-i colon";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Կոստա Ռիկայի կոլոն";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Colon Kosta Rika";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "kostarískt kólon";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "colón costaricano";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "კოსტა-რიკული კოლონი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Коста-Рика колоны";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "កូឡុង​កូស្តារីកា";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಕೋಸ್ಟ ರಿಕನ್ ಕೊಲನ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "کوسٹا رِکَن کولَن";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "коста-рика колону";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ໂຄສຕາ ຣິກັນ ໂຄລອນ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Kosta Rikos kolonas";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Kostarikas kolons";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "കോസ്റ്റാ റിക്കൻ കോളൻ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "коста рикагийн колон";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Colon Costa Rica";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ကို့စတာရီကာ ကိုလွန်";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "costaricanske colón";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "कोष्टारिकन कोलोन";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Costa Ricaanse colon";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "costaricansk colon";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਕੋਸਟਾ ਰੀਕਨ ਕੋਲਨ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "colon kostarykański";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Colón costarriquenho";
        ...
        test("has translation for 'pt_PT' locale", () {
          const expectedName = "Colon costa-riquenho";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "colon da la Costa Rica";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "colon costarican";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Костариканский колон";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "කොස්ට රිකා කොලෝන්";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "kostariški kolon";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Koloni kostarikan";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "costarikansk colón";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Colon ya Kostarika";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "கோஸ்டா ரிகன் கொலோன்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "కోస్టా రికన్ కోలోన్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "โกลองคอสตาริกา";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Colón ng Costa Rica";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "كوستارىكا كولونى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "костариканський колон";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "کوسٹا ریکا کا کولن";
        ...
        test("has translation for 'ur_IN' locale", () {
          const expectedName = "کوسٹا ریکا کولون";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Kosta-Rika koloni";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Коста-Рика колони";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Costa Rican Colón";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "কোষ্টা ৰিকান কোলন";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Коста-Рика колонӗ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤑𞤮𞤤𞤮𞥅𞤲 𞤑𞤮𞤧𞤼𞤢𞤪𞤭𞤴𞤢𞤲𞤳𞤮";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Colón na ƙasar Costa Rica";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Colón obodo Costa Rica";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "kolonê kosta rîkayî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Colon Koto Rika";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "କୋଷ୍ଟା ରିକୀୟ କୋଲୋନ୍";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "کوسټا ريکن کولون";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "colón costaricanu";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Kolonka Kosta Riika";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Kosta-Rika kolony";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Kólọ́ọ̀nì Kosita Ríkà";
