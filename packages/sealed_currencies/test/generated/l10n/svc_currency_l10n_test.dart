...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Salvadoran Colón";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "كولون سلفادوري";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "El Salvador kolonu";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Салвадорски колон";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "এল স্যালভোডোর কোলোন";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "colón Salvador";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Salvadorski kolon";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "colón salvadorenc";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "salvadorský colón";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Colón El Salvador";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "Salvadoransk colon";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "El Salvador Colon";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "salvadɔga colón";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Κολόν Ελ Σαλβαδόρ";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "colón salvadoreño";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "El Salvadori koloon";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "El Salvadorin colon";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "colón salvadorien";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Salvadoraanske colón";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Colón na Salvadóire";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Colón Salbhadorach";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "קולון סלבדורי";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Salvadori colón";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Colon El Savador";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "colón salvadoregno";
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "エルサルバドル コロン";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "سَلویدَرُک کولَن";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "El-Salvador-Colón";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ໂກລອງ ເອກາວາດໍ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Salvadoro kolonas";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Salvadoras kolons";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "എൽ സാൽവഡോർ കോളൻ";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "salvadoranske colon";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Salvadoraanse colón";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "colon salwadorski";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Colom salvadorenho";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "colon da l’El Salvador";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "colon El Salvador";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Сальвадорский колон";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Salvádorský colón";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "salvadoransk colón";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "โคลอนเอลซัลวาดอร์";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "سالۋادور كولونى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "сальвадорський колон";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "ኤል ሳልቫዶር ኮሎን";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Сальвадорскі колон";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "kolon salvadortarra";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "السالوادور کولون";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "અલ સાલ્વાડોર કોલન";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "एल साल्वाडोर कॉलन";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Սալվադոր Կոլոն";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "სალვადორის კოლონი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Сальвадордағы колон";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "អែលសាវ៉ាឌ័រអាឡូន";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಎಲ್ ಸಾಲ್ವಡಾರ್ ಕೊಲೊನ್";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Салвадордук колон";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Эл Салвадор Колон";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဆာဗေးဒိုလ် ကိုလီနိုင်";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "अल साल्भाडोर कलोन";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਐਲ ਸੈਲਵੇਡਾਰ ਕੋਲਨ";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "එල් සැල්වදෝර් කොලෝන්";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "எல் சால்வடார் காலன்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "ఎల్ సాల్వడార్ కోలన్";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "ایل سلواڈور کولون";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Salvador Koloni";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤑𞤮𞤤𞤮𞥅𞤲 𞤅𞤢𞤤𞤾𞤢𞤣𞤮𞤪𞤢𞤲𞤳𞤮";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "colón salvadorenu";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "ছালভাডৰিয়ান কলন";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ସାଲଭାଡୋରାନ କଲୋନ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "سلواډوري کولون";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Colon ng El Salvador";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Сальвадоран колон";
