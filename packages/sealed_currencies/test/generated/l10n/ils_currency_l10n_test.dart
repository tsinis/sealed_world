...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Israeli New Shekel";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Israeliese nuwe sikkel";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የእስራኤል አዲስ ሽቅል";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "شيكل إسرائيلي جديد";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "İsrail Yeni Şekeli";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "новы ізраільскі шэкель";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Израелски нов шекел";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "ইস্রাইলি নতুন শেকেল";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "shekel nevez Israel";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Izraelski novi šekel";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Израелски нови шекел";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "nou xéquel israelià";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Израилан керла шекель";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "izraelský nový šekel";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Shegel Newydd Israel";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "ny israelsk shekel";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Israelischer Neuer Schekel";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཨིས་རེལ་གྱི་དངུལ་གསརཔ་ ཤེ་ཀེལ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "israelga yeyetɔ sheqel";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Νέο Σέκελ Ισραήλ";
        ...
        test("has translation for 'en_AU' locale", () {
          const expectedName = "Israeli Shekel";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "nuevo séquel israelí";
        ...
        test("has translation for 'es_MX' locale", () {
          const expectedName = "nuevo shéquel israelí";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Iisraeli uus seekel";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Israelgo shekel berria";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "شقل جدید اسرائیل";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Israelin uusi sekeli";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Ísrael new sheqel";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "nouveau shekel israélien";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Israëlyske nieuwe shekel";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Seiceal Nua Iosrael";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Sheqel ùr Iosraeleach";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Novo shequel israelí";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "ઇઝરાયેલી ન્યુ શેકલ";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "इज़राइली न्यू शेकेल";
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "novi izraelski šekel";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "izraeli új sékel";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Իսրայելի նոր շեկել";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Shekel Baru Israel";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "nýr ísraelskur sikill";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "nuovo siclo israeliano";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ისრაელის ახალი შეკელი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Израиль жаңа шекелі";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ស៊ីគែលថ្មីអ៊ីស្រាអែល";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಇಸ್ರೇಲಿ ನ್ಯೂ ಶೇಖಲ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "اِزرٲیِلی نٔوۍ شٮ۪قٕل";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Израилдин жаңы шекели";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Israeleschen Neie Schekel";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ອິສ​ຣາ​ເອວ​ລິ ນິວ ເຊ​ເກວ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Izraelio naujasis šekelis";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Izraēlas šekelis";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ഇസ്രായേലി ന്യൂ ഷെക്കെൽ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "израилийн шинэ шекел";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "ईस्त्रायली न्यू शेकेल";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Sheqel Baru Israel";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "အစ္စရေးရှဲကလ်အသစ်";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "nye israelske shekler";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "इजरायली नयाँ शेकेल";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Israëlische nieuwe shekel";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "israelsk ny shekel";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਇਜ਼ਰਾਈਲੀ ਨਵੀਂ ਸ਼ੇਕੇਲ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "nowy szekel izraelski";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Sheqel novo israelita";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "șechel israelian nou";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Новый израильский шекель";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ඊශ්‍රායල නව ශෙකල්";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "izraelský šekel";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "izraelski šekel";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Shekeli izrealit";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "israelisk ny shekel";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Shekeli Mpya ya Israel";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "இஸ்ரேலி நியூ ஷிகேல்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "ఐరాయిలి న్యూ షెక్యెల్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "นิวเชเกลอิสราเอล";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Israeli New Sheqel";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Yeni İsrail Şekeli";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ئىسرائىل يېڭى شېكېلى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "ізраїльський новий шекель";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "اسرائیلی نیا شیکل";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Isroil yangi shekeli";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Sheqel Israel mới";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Israeli New Sheqel";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "ইজৰাইলী নিউ শ্বেকেল";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଇସ୍ରାଏଲ ସେକେଲ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "اسراييلي شېکېل";
