...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Thaise baht";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "باخت تايلاندي";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Tayland Batı";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Тайландски бат";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "baht Thailand";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Tajlandski baht";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "baht tailandès";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Таиландан бат";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "thajský baht";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Baht Gwlad Thai";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "thailandsk baht";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Thailändischer Baht";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཐཱའི་ལེནཌ་གི་དངུལ་ བཱཏ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Thailandga baht";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Μπατ Ταϊλάνδης";
        ...
        test("has translation for 'es_MX' locale", () {
          const expectedName = "baht tailandés";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Thailandiako bahta";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Thaimaan baht";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Tailand baht";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "baht thaïlandais";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Baht na Téalainne";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Baht Tàidheach";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "בהט תאילנדי";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Թայլանդական բատ";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "taílenskt bat";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "baht thailandese";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ტაილანდური ბატი";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Thailännesche Baht";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Tailando batas";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Taizemes bāts";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "тайландын бат";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "thailandske baht";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "baht tajski";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Baht tailandês";
        ...
        test("has translation for 'pt_PT' locale", () {
          const expectedName = "Baht da Tailândia";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "baht tailandais";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "baht thailandez";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Таиландский бат";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "tajski baht";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Bata tajlandeze";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Тајландски бат";
        ...
        test("has translation for 'sr_Latn' locale", () {
          const expectedName = "Tajlandski bat";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "thailändsk baht";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Baht ya Tailandi";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Tayland Bahtı";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "تايلاند باختى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "таїландський бат";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Tailand bati";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Bạt Thái Lan";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Thai Baht";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Таиланд барӗ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤄𞤢𞤸𞤼𞤵 𞤚𞤢𞤴𞤤𞤢𞤲𞤣𞤭𞤲𞤳𞤮";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Baht na ƙasar Thailand";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Baht obodo Thai";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "bahtê taylandî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Baht Tairanga";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "baht tailandesu";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Baatka Taylaan";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Taýland baty";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "I-Baht yaseThailand";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Bhat ng Thailand";
