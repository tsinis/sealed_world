...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "St. Helena Pound";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Sint Helena pond";
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "St Helena Pɔn";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የሴይንት ሔሌና ፓውንድ";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "جنيه سانت هيلين";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Müqəddəs Yelena Funtu";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "фунт Святой Алены";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Лира на Света Елена";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "Ɛlɛni-Senu Livri";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "সেন্ট হেলেনা পাউন্ড";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "lur Saint-Helena";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Svetohelenska funta";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Св. јеленска фунта";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "lliura de Santa Helena";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Сийлахьчу Еленин гӀайрен фунт";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "svatohelenská libra";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Punt Saint Helena";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "pund fra Saint Helena";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "St. Helena-Pfund";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "saint helenaga pound";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Λίρα Αγίας Ελένης";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "libra de Santa Elena";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Saint Helena nael";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Santa Helenako libera";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "پوند سنت هلن";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Liibar Sent Helen";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Saint Helenan punta";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "St. Helena pund";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "livre de Sainte-Hélène";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Sint-Heleenske pûn";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Punt San Héilin";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Punnd Eilean Naomh Eilidh";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Libra de Santa Helena";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "સેંટ હેલેના પાઉન્ડ";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Fam kin San Helena";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "פאונד סנט הלני";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "सेंट हेलेना पाउंड";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Szent Ilona-i font";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Սուրբ Հեղինեի ֆունտ";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Pound Saint Helena";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "helenskt pund";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "sterlina di Sant’Elena";
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "セントヘレナ島 ポンド";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "წმ. ელენეს კუნძულის ფუნტი";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Pauni ya Santahelena";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Әулие Елена аралы фунты";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ផោន​សាំងហេឡេណា";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಸೇಂಟ್ ಹೆಲೇನಾ ಪೌಂಡ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "سینٹ ہیلِنا پونٛڈ";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Ыйык Елена аралынын фунту";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "St. Helena-Pond";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Pawundi ey’eSenti Herena";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Paunɛ ya Sántu elena";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ເຊນ ເຮ​ເລ​ນາ ພາວດ໌";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Šv. Elenos salų svaras";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Pauni wa Santu Elena";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Sv.Helēnas salas mārciņa";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Фунта на Света Елена";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "സെന്റ് ഹെലീന പൗണ്ട്";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "сент хелена фунт";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Paun Saint Helena";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "စိန့်ဟယ်လယ်နာ ပေါင်";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "sankthelenske pund";
        ...
        test("has translation for 'nd' locale", () {
          const expectedName = "Phawundindi laseSt Helena";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "सेन्ट हेलेना पाउन्ड";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Sint-Heleens pond";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "sankthelensk pund";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਸੇਂਟ ਹੇਲੇਨਾ ਪੌਂਡ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "funt Wyspy Świętej Heleny";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "glivra da Sontg’Elena";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Ipawundi rya Sente Helena";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "liră Insula Sf. Elena";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Фунт острова Святой Елены";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "pôndo tî Zûâ Sênt-Helêna";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ශාන්ත හෙලේනා පවුම්";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "svätohelenská libra";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "funt Sv. Helene";
        ...
        test("has translation for 'sn' locale", () {
          const expectedName = "Paundi re Senti Helena";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Stërlina e Ishullit të Shën-Helenës";
        ...
        test("has translation for 'sr_Latn' locale", () {
          const expectedName = "Sv. jelenska funta";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "S:t Helena-pund";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "செயின்ட் ஹெலேனா பவுண்டு";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "సెయింట్ హెలెనా పౌండ్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ปอนด์เซนต์เฮเลนา";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Saint Helena Pound";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Saint Helena Lirası";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ساينىت-ھېلېنا فوندستېرلىڭى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "фунт острова Святої Єлени";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "سینٹ ہیلینا پاؤنڈ";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Muqaddas Yelena oroli funti";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Bảng St. Helena";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Pọọun ti Orílẹ́ède ̣Elena";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Pɔɔun ti Orílɛ́ède ̣Elena";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Saint Helena Pound";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "ছেইণ্ট হেলেনা পাউণ্ড";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Сӑваплӑ Елена утравӗн фунчӗ";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "libra de St. Helena";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Pound obodo St Helena";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Pound Santa Helena";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "lîreyê saînt helenayî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Pāuna Hato Herena";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ସେଣ୍ଟ୍. ହେଲେନା ପାଉଣ୍ଡ୍";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "سينټ هيلينا پونډ";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "isterlina de Sant’Elene";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Bowndka St Helen";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Keramatly Ýelena adasynyň funty";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "IPonti yaseSt. Helena";
