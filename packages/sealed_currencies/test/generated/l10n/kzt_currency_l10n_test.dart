...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Kazakhstani Tenge";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Kazakse tenge";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የካዛኪስታን ተንጌ";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "تينغ كازاخستاني";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Qazaxıstan Tengesi";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "казахстанскі тэнгэ";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Казахстанско тенге";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "কাজাখাস্তানি টেঙ্গে";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "tenge Kazakstan";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Kazahstanski tenge";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Казахстански тенџ";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "tenge kazakh";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Казахстанан тенге";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "kazašské tenge";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "kasakhisk tenge";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Kasachischer Tenge";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཀ་ཛགས་ཏཱན་གྱི་དངུལ་ ཏེང་གེ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "kazakhstanga tenge";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Τένγκε Καζακστάν";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "tenge kazako";
        ...
        test("has translation for 'es_MX' locale", () {
          const expectedName = "tenge kazajo";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Kasahstani tenge";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Kazakhstango tengea";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "تنگهٔ قزاقستان";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Kazakstanin tenge";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Kasakstan tenge";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Kazachstaanske tenge";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Tenge na Casacstáine";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Tenge Casachach";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Tenge casaco";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "કઝાકિસ્તાની ટેંગ";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "טנגה קזחסטני";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "कज़ाखिस्तानी टेंज़";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "kazahsztáni tenge";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Ղազախական տենգե";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "kasakst tengi";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ყაზახური ტენგე";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Қазақстан теңгесі";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "តង់ហ្គី​កាហ្សាក់ស្ថាន";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಕಜಾಕಿಸ್ತಾನಿ ತೆಂಗೆ";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "کزاکِستان ٹینٛج";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Казакстан теӊгеси";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Kasacheschen Tenge";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ຄາ​ຊັກ​ສະ​ຖາ​ນິ ເຕັງ​ເຈ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Kazachstano tengė";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Kazahstānas tenge";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Казахстанска тенга";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "കസാക്കിസ്ഥാനി ടെംഗെ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "казахын тэнгэ";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "कझाकिस्तानी तेंगे";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Tenge Kazakhstan";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ကာဇက်စတန် ထိန်ဂျီ";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "kasakhstanske tenge";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "काजाखस्तानी टेन्ज";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Kazachse tenge";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "kasakhstansk tenge";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਕਜ਼ਾਖਸਤਾਨੀ ਤੇਂਗੇ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "tenge kazachskie";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Tenge cazaque";
        ...
        test("has translation for 'pt_PT' locale", () {
          const expectedName = "Tenge do Cazaquistão";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "tenge casac";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "tenge kazahă";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Казахский тенге";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "කසකස්ථාන ටෙන්ග";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Tenga kazake";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Казахстански тенге";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "kazakisk tenge";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Tenge ya Kazakistani";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "கஸகஸ்தானி டென்கே";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "ఖజికిస్థాన్ టెంగే";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "เทงเจคาซัคสถาน";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Kazakistan Tengesi";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "قازاقىستان تەڭگىسى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "казахстанський тенге";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "قزاخستانی ٹینگ";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Qozog‘iston tengesi";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Kazakhstani Tenge";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "কাজাখস্তানী তেঞ্জ";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Казах тенгейӗ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤚𞤫𞤲𞤺𞤫 𞤑𞤢𞥁𞤢𞤳𞤭𞤧𞤼𞤢𞤲𞤭𞤲𞤳𞤮";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Tenge na ƙasar Kazkhstan";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Tenge obodo Kazakhstani";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Tenge Kasakhstan";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "tengeyê qazaxistanî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Tenge Katatānga";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "କାଜାକସ୍ତାନୀ ତେଙ୍ଗେ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "قازقستاني ټينج";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "tenge kazaku";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Tengeda Kasakhstan";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Gazak teňňesi";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "I-Tenge yaseKhazakhstan";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Tẹngé Kasakísítàànì";
