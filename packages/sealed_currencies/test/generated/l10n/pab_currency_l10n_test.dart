...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Panamanian Balboa";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Panamese balboa";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "ፓናማኒአን ባልቦአ";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "بالبوا بنمي";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Panama Balboası";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "панамскае бальбоа";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Панамска балбоа";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "পানামা বেলবোয়া";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "balboa Panamá";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Panamska balboa";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "balboa panameny";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Панаман бальбоа";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "panamská balboa";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Balboa Panama";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "panamansk balboa";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Panamaischer Balboa";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "པ་ན་མ་གི་དངུལ་ བཱལ་བོ་ཝ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "panamaga balboa";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Μπαλμπόα Παναμά";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "balboa panameño";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Panama balboa";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Panamako balboa";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "بالبوای پاناما";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Panaman balboa";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "balboa panaméen";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Balboa Phanama";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Balboa Panamach";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "પનામેનિયન બાલ્બોઆ";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "בלבואה פנמי";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "पनामेनियन बैल्बोआ";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "panamai balboa";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Պանամական բալբոա";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "balboa panamense";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "პანამური ბალბოა";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Панама бальбоасы";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "បាល់ប៉ៅ​ប៉ាណាម៉ា";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಪನಾಮಾನಿಯನ್ ಬಲ್ಬೋವಾ";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "پانامانِیَن بالبوز";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "панама балбоасы";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Panamaesche Balboa";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ພານາມານຽນ ບອນບົວ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Panamos balboja";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Panamas balboa";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "പനാമനിയൻ ബാൽബോവ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "панамын бальбоа";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "पनामा बाल्बोआ";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ပနားမား ဘလ်ဘိုးအာ";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "panamanske balboa";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "पानामानियाली बाल्बोआ";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਪਨਾਮੇਨੀਅਨ ਬਾਲਬੋਆ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "balboa panamski";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Balboa panamenha";
        ...
        test("has translation for 'pt_PT' locale", () {
          const expectedName = "Balboa do Panamá";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "balboa dal Panama";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "balboa panameză";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Панамское бальбоа";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "පැනමා බැල්බෝ";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Balboa panameze";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Balboa ya Panama";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "பனாமானியன் பால்போவா";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "పనామనియన్ బల్బోవ";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "บัลบัวปานามา";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Balboa ng Panama";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "پاناما بالبوئاسى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "панамська бальбоа";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "پنامہ کا بالبوآ";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Panama balboasi";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Панама бальбоаси";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Panamanian Balboa";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "পানামেনিয়ান বাল্বোৱা";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Панама бальбоа";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤄𞤢𞤤𞤦𞤮𞤱𞤢 𞤆𞤢𞤲𞤢𞤥𞤢𞤴𞤢𞤲𞤳𞤮";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Balboa na ƙasar Panama";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "balboa panamen";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Balboa obodo Panama";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "balboayê panamayî";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ପାନାମାନିୟ ବାଲବୋଆ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "پانامۍ بالبوا";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "balboa panamesu";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Balbow Banama";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Panama balboasy";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Bálíbóà Pànámà";
