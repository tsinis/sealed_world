...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Myanmar Kyat";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Mianmese kyat";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "كيات ميانمار";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Myanma Kiyatı";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "м’янманскі к’ят";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Мианмарски кият";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "মায়ানমার কিয়াত";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "kyat Myanmar";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Mijanmarski kjat";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Мјанмашки кјат";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "kyat de Myanmar";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Мьянман кьят";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "myanmarský kyat";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "myanmarsk kyat";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Myanmarischer Kyat";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "མི་ཡཱན་མར་གྱི་དངུལ་ ཅཱཏ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "myanmaga kyat";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Κιάτ Μιανμάρ";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Myanmari kjatt";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Myanmarreko kyata";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "کیات میانمار";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Myanmarin kyat";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Myanmar (Burma) kyat";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "kyat myanmarais";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Myanmarese kyat";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Kyat Mhaenmar";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Kyat Miànmarach";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Kyat birmano";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "મ્યાંમાર ક્યાત";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "קיאט מיאנמרי";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "म्यांमार क्याट";
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "mjanmarski kjat";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "mianmari kyat";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Մյանմայի կյատ";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "mjanmarskt kjat";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "kyat di Myanmar";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "მიანმარის კიატი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Мьянма кьяты";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "គីយ៉ាត​ភូមា";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಮ್ಯಾನ್ಮಾರ್ ಕ್ಯಾಟ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "مِیانما کیاٹ";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Мйанмар кйаты";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Myanmaresche Kyat";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ມຽນ​ມາ ຈ໊າດ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Mianmaro kijatas";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Mjanmas kjats";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Мјанмарски киат";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "മ്യാൻമാർ ക്യാട്";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "мьянмарын киат";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "म्यानमार क्याट";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Kyat Myanma";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "myanmarske kyat";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "म्यान्मा क्याट";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਮਿਆਂਮਾਰ ਕਿਆਤ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "kiat birmański";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Kyat mianmarense";
        ...
        test("has translation for 'pt_PT' locale", () {
          const expectedName = "Kyat de Mianmar";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "Kyat dal Myanmar";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "kyat din Myanmar";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Мьянманский кьят";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "බුරුම ක්යාට්";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "mjanmarský kyat";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Kiata e Mianmarit";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Мјанмарски кјат";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "myanmarisk kyat";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Kyat ya Myama";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "மியான்மர் கியாத்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "మయన్మార్ క్యాట్";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Myanmar Kyatı";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "مىيانمار كىياتى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "кʼят Мʼянми";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "میانما کیاٹ";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Myanma kyati";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Myanma Kyat";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "ম্যানমাৰ কিয়াট";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Мьянман кьятӗ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤑𞤭𞤴𞤢𞤼𞤵 𞤃𞤭𞤴𞤢𞤥𞤢𞤪𞤭𞤲𞤳𞤮";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Kuɗin Myanmar";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Kyat obodo Myanmar";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "kyatê myanmarî";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ମ୍ୟାନମାର୍ କ୍ୟାତ୍‌";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "ميانماري کيات";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "kyat de su Myanmar";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Kayatda Mayanmaar";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Mýanma kýaty";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "I-Kyat yaseMyanmar";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Kíyàtì Myanmar";
