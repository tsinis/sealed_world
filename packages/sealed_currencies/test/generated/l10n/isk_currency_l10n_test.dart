...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Icelandic Króna";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Yslandse kroon";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የአይስላንድ ክሮና";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "كرونه أيسلندي";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "İslandiya Kronu";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "ісландская крона";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Исландска крона";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "আইসল্যান্ড ক্রৌন";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "kurunenn Island";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Islandska kruna";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Исландска круна";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "corona islandesa";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Исландин крона";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "islandská koruna";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Króna Gwlad yr Iâ";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "islandsk krone";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Isländische Krone";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཨཱཡིས་ལེནཌ་གི་དངུལ་ ཀྲོ་ན";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "aiselandga króna";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Κορόνα Ισλανδίας";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Islandi kroon";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Islandiako koroa";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "کرونای ایسلند";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Islannin kruunu";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "íslendsk króna";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "couronne islandaise";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Yslânske kroon";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Króna na hÍoslainne";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Króna Innis Tìleach";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Coroa islandesa";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "આઇસલેન્ડિક ક્રોના";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "כתר איסלנדי";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "आइसलैंडिक क्रोना";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "izlandi korona";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Իսլանդական կրոն";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Krona Islandia";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "íslensk króna";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "corona islandese";
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "アイスランド クローナ";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ისლანდიური კრონა";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Исландия кронасы";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ក្រូណា​អ៊ីស្លង់";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಐಸ್‌ಲ್ಯಾಂಡಿಕ್ ಕ್ರೋನಾ";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "اَیسلینٛڑُک کرٛونا";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "исландия крону";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Islännesch Kroun";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ໄອ​ສ໌​ແລນ​ດິກ ໂຄຣ​ນາ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Islandijos krona";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Islandes krona";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ഐസ്‌ലാൻഡിക് ക്രോണ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "исландын крон";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "आइसलँडिक क्रोना";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Krona Iceland";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "အိုက်စလန် ခရိုဏာ";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "islandske kroner";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "आइसल्याण्डिक क्रोना";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "IJslandse kroon";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਆਈਸਲੈਂਡਿਕ ਕਰੌਨ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "korona islandzka";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "cruna islandaisa";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "coroană islandeză";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Исландская крона";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "අයිස්ලන්තික ක්‍රෝනා";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "islandska krona";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Korona islandeze";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "isländsk krona";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Krona ya Aisilandi";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "ஐஸ்லாண்டிக் க்ரோனா";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "ఐస్లాండిక్ క్రోనా";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "โครนาไอซ์แลนด์";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "İzlanda Kronu";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ئىسلاندىيە كروناسى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "ісландська крона";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "آئس لينڈی کرونا";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Islandiya kronasi";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Króna Iceland";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Icelandic Króna";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "আইচলেণ্ডিক ক্ৰোনা";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Исланди кронӗ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤑𞤮𞤪𞤮𞤲𞤢 𞤀𞤴𞤧𞤭𞤤𞤢𞤲𞤣𞤭𞤲𞤳𞤮";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Króna na ƙasar Iceland";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Króna obodo Iceland";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "kronê îslandayî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Kronur Tiorangi";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଆଇସଲ୍ୟାଣ୍ଡିକ୍‍ କ୍ରୋନା";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "آيسلېنډي کرونا";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Koronada Eysland";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Islandiýa kronasy";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "I-Króna yase-Iceland";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Kòrónà Icelandic";
