...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Liberian Dollar";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Liberiese dollar";
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Laeberia Dɔla";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "دولار ليبيري";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Liberiya Dolları";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "ліберыйскі долар";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Либерийски долар";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "liberiya Dolar";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "লিবেরিয়ান ডলার";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "dollar Liberia";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Liberijski dolar";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Либеријски долар";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "dòlar liberià";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Либерин доллар";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "liberijský dolar";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Doler Liberia";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "liberisk dollar";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Liberianischer Dollar";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ལཱའི་བེ་རི་ཡ་གི་དངུལ་ ཌོ་ལར";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "liberiaga dollar";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Δολάριο Λιβερίας";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "dólar liberiano";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Libeeria dollar";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Liberiako dolarra";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "دلار لیبریا";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Dolaar Liberiyaa";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Liberian dollari";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Liberia dollari";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "dollar libérien";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Liberiaanske dollar";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Dollar na Libéire";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Dolar Libèireach";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "લિબેરિયન ડોલર";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Dalar Laberiya";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "लाइबेरियाई डॉलर";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "libériai dollár";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Լիբերիական դոլար";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Dolar Liberia";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "líberískur dalur";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "dollaro liberiano";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ლიბერიული დოლარი";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Dola ya Liberia";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Либерия доллары";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ដុល្លារ​លីប៊ី";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಲಿಬೇರಿಯನ್ ಡಾಲರ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "لَیبیرِیَن ڑالَر";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Liberianeschen Dollar";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Doola ey’eLiberya";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Dolarɛ ya Liberya";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ລິ​ເບີ​ຣຽນ ໂດ​ລ່າ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Liberijos doleris";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Ndola wa Liberya";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Libērijas dolārs";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Dôlara Liberianina";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Либериски долар";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ലൈബീരിയൻ ഡോളർ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "либери доллар";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "लाइबेरियन डॉलर";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "လိုက်ဘေးရီးယား ဒေါ်လာ";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "liberiske dollar";
        ...
        test("has translation for 'nd' locale", () {
          const expectedName = "Dola yase Libheriya";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "लिबेरियाली डलर";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Liberiaanse dollar";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਲਾਈਬੀਰੀਆਈ ਡਾਲਰ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "dolar liberyjski";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "dollar liberian";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Idolari rya Liberiya";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "dolar liberian";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Либерийский доллар";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "dolära tî Liberïa";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ලයිබේරියානු ඩොලර්";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "libérijský dolár";
        ...
        test("has translation for 'sn' locale", () {
          const expectedName = "Dora re Liberia";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Dollari liberian";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "liberiansk dollar";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "லைபீரியன் டாலர்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "లిబేరియన్ డాలర్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ดอลลาร์ไลบีเรีย";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Dolyar ng Liberia";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Liberya Doları";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "لىبېرىيە دوللىرى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "ліберійський долар";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "لائبریائی ڈالر";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Liberiya dollari";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Đô la Liberia";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Dọla ti Orílẹ́ède Liberia";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Dɔla ti Orílɛ́ède Liberia";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Liberian Dollar";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "লাইবেৰিয়ান ডলাৰ";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Либери долларӗ";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Dollar obodo Liberia";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "dolarê lîberyayî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Tāra Raipiria";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଲିବେରୀୟ ଡଲାର୍";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "لايبيرين ډالر";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "dòllaru liberianu";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Doolarka Liberiya";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Liberiýa dollary";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "IDola yaseLiberia";
