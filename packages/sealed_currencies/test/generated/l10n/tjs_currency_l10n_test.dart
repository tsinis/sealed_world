...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Tajikistani Somoni";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Tadjikse roebel";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የታጂክስታን ሶሞኒ";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "سوموني طاجيكستاني";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Tacikistan Somonisi";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "таджыкскі самані";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Таджикистански сомони";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "তাজিকিস্তান সোমোনি";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "somoni Tadjikistan";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Tadžikistanski somoni";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Таљихистански сомони";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "somoni tadjik";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Таджикистанан сомони";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "tádžické somoni";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Somoni Tajikistan";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "tadsjikisk somoni";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Tadschikistan-Somoni";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཏ་ཇི་ཀིས་ཏཱན་གྱི་དངུལ་ སོ་མོ་ནི";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "tajikistanga somoni";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Σομόνι Τατζικιστάν";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "somoni tayiko";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Tadžikistani somoni";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Tajikistango somonia";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "سامانی تاجیکستان";
        ...
        test("has translation for 'fa_AF' locale", () {
          const expectedName = "سامانی تاجکستان";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Tadžikistanin somoni";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Tadsjikistan somoni";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Tadzjikistaanske somoni";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Somoni na Táidsíceastáine";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Somoni Taidigeach";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Somoni taxiquistano";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "તાજિકિસ્તાની સોમોની";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "סומוני טג׳קיסטני";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "ताजिकिस्तानी सोमोनी";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "tádzsikisztáni somoni";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Տաջիկական սոմոնի";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "tadsjikskur sómóni";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "somoni tagiko";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ტაჯიკური სომონი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Тәжікстан сомониі";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "សូមុនី​តាហ្ស៊ីគីស្ថាន";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ತಜಕಿಸ್ತಾನಿ ಸೊಮೋನಿ";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "تاجِکتانُک سَمونی";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Тажикстан сомониси";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ທາ​ຈິ​ກິ​​ຖາ​ນິ ໂຊ​ໂມ​ນິ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Tadžikistano somonis";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Tadžikistānas somons";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Таџикистански сомони";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "താജിക്കിസ്ഥാനി സോംനി";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "тажикийн сомон";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "ताजकीस्तानी सोमोनी";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "တာဂျစ်ကစ္စတန် ဆိုမိုနီ";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "tadsjikiske somoni";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "ताजिक्स्तानी सोमोनी";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Tadzjiekse somoni";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਤਾਜਿਕਿਸਤਾਨੀ ਸੋਮੋਨੀ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "somoni tadżyckie";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Somoni tadjique";
        ...
        test("has translation for 'pt_PT' locale", () {
          const expectedName = "Somoni do Tajaquistão";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "somoni dal Tadschikistan";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "somoni tadjic";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Таджикский сомони";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "තජිකිස්ථාන සමොනි";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "tadžické somoni";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Somona taxhike";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Таџикистански сомон";
        ...
        test("has translation for 'sr_Latn' locale", () {
          const expectedName = "Tadžikistanski somon";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "tadzjikisk somoni";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Somoni ya Tajikistani";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "தஜிகிஸ்தானி சோமோனி";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "తజికిస్థాన్ సమోని";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "โซโมนิทาจิกิสถาน";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "تاجىكىستان سومونىسى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "таджицький сомоні";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "تاجکستانی سومونی";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Tojikiston somoniysi";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Tajikistani Somoni";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "তাজিকিস্তানী ছোমনি";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Таджик сомонийӗ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤅𞤢𞤥𞤮𞥅𞤲𞤭 𞤚𞤢𞤶𞤭𞤳𞤭𞤧𞤼𞤢𞤲𞤳𞤮";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Somoni na ƙasar Tajikistan";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "somoni tajik";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Who Somoni obodo Tajikistan";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "somonê tacikistanî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Somoni Takiritānga";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ତାଜିକିସ୍ତାନୀ ସୋମୋନି";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "تاجکستاني سوموني";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "somoni tagiku";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Somoonida Tajikistan";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Täjik somonisi";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "I-Somoni yaseTajikistan";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Sómónì Tajikístàànì";
