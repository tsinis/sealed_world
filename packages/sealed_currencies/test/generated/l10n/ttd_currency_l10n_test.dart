...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Trinidad & Tobago Dollar";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Trinidad en Tobago dollar";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የትሪንዳድ እና ቶቤጎዶላር";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "دولار ترينداد وتوباجو";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Trinidad və Tobaqo Dolları";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "долар Трынідада і Табага";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Долар на Тринидад и Тобаго";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "ত্রিনিদাদ এবং টোবাগো ডলার";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "dollar Trinidad ha Tobago";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Trinidadtobaški dolar";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Тринидад тобагошки долар";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "dòlar de Trinitat i Tobago";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Тринидадан а, Тобагон а доллар";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "trinidadský dolar";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Doler Trinidad a Tobago";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "dollar fra Trinidad og Tobago";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Trinidad und Tobago-Dollar";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "trinidad kple tobagoga dollar";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Δολάριο Τρινιντάντ και Τομπάγκο";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "dólar de Trinidad y Tobago";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Trinidadi ja Tobago dollar";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Trinidad eta Tobagoko dolarra";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "دلار ترینیداد و توباگو";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Trinidadin ja Tobagon dollari";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Trinidad & Tobago dollari";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "dollar trinidadien";
        ...
        test("has translation for 'fr_CA' locale", () {
          const expectedName = "dollar de Trinité-et-Tobago";

          final translated = value.maybeTranslation(
            const BasicLocale(LangFra(), countryCode: "CA"),
            useLanguageFallback: false,
          );
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Dollar Oileán na Tríonóide agus Tobága";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Dolar Thrianaid agus Thobago";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Dólar de Trinidad e Tobago";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "ત્રિનિદાદ અને ટોબેગો ડોલર";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "דולר טרינידדי";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "त्रिनिदाद और टोबैगो डॉलर";
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "trininadtobaški dolar";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Trinidad és Tobago-i dollár";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Տրինիդադ և Տոբագոյի դոլար";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Dolar Trinidad dan Tobago";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Trínidad og Tóbagó-dalur";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "dollaro di Trinidad e Tobago";
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "トリニダードトバゴ ドル";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ტრინიდად და ტობაგოს დოლარი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Тринидад және Тобаго доллары";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ដុល្លារ​ទ្រីនីដាដ និងតូបាហ្គោ";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಟ್ರಿನಿಡಾಡ್ ಮತ್ತು ಟೊಬಾಗೊ ಡಾಲರ್";
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "트리니다드 토바고 달러";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "ٹرِنہِ ڈیڈ تہٕ ٹوبیگو ڈالَر";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "тринидад жана тобаго доллары";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Trinidad-an-Tobago-Dollar";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ທ​ຣິ​ນິ​ແດດ ແອນ ໂທ​ບາ​ໂກ ໂດ​ລ່າ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Trinidado ir Tobago doleris";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Trinidādas un Tobāgo dolārs";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ട്രിനിഡാഡ് അന്റ് ടുബാഗോ ഡോളർ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "тринидад ба тобаго доллар";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "त्रिनिदाद आणि टोबॅगो डॉलर";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ထရီနီဒတ်နှင့် တိုဘက်ဂို ဒေါ်လာ";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "trinidadiske dollar";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "त्रिनिडाड र टोबागो डलर";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "trinidadisk dollar";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਟ੍ਰਿਨੀਡਾਡ ਅਤੇ ਟੋਬਾਗੋ ਡਾਲਰ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "dolar Trynidadu i Tobago";
        ...
        test("has translation for 'pt_PT' locale", () {
          const expectedName = "Dólar de Trindade e Tobago";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "dollar da Trinidad e Tobago";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "dolar din Trinidad-Tobago";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Доллар Тринидада и Тобаго";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ට්‍රිනිඩෑඩ් සහ ටොබෑගෝ ඩොලර්";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "trinidadsko-tobažský dolár";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "dolar Trinidada in Tobaga";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Dollari i Trinidadit dhe Tobagos";
        ...
        test("has translation for 'sr_Latn' locale", () {
          const expectedName = "Trinidad-tobagoški dolar";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Trinidad och Tobago-dollar";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Dola ya Trinidad na Tobago";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "டிரினிடாட் மற்றும் டோபாகோ டாலர்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "ట్రినిడాడ్ మరియు టొబాగో డాలర్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ดอลลาร์ตรินิแดดและโตเบโก";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Dolyar ng Trinidad and Tobago";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Trinidad ve Tobago Doları";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "تىرىنىداد ۋە توباگو دوللىرى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "долар Тринідаду і Тобаго";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "ترینیداد اور ٹوباگو کا ڈالر";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Trinidad va Tobago dollari";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Тринидад ва Тобаго доллари";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Đô la Trinidad và Tobago";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Trinidad and Tobago Dollar";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "ট্ৰিনিডাড আৰু টোবাগো ডলাৰ";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Тринидад тата Тобаго долларӗ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤁𞤢𞤤𞤢 𞤚𞤭𞤪𞤲𞤭𞤣𞤢𞥄𞤣 & 𞤚𞤮𞤦𞤢𞤺𞤮";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Dalar ƙasar Trinidad da Tobago";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "dollar de Trinidad e Tobago";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Dollar Trinidad & Tobago";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Dolar Trinidad lan Tobago";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "dolarê trinidad û tobagoyî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Tāra Tirinaki Tōpako";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ତ୍ରିନିଦାଦ୍ ଏବଂ ଟୋବାଗୋ ଡଲାର୍";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "ټرينيډاډ او ټوباګو ډالر";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "dòllaru de Trinidad e Tobago";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Doolarka Tirinidad iyo Tobago";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Trininad we Tobago dollary";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Dọ́là Trinidad & Tobago";
