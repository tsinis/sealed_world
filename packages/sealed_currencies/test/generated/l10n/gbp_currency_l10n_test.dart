...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "British Pound";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Britse pond";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የእንግሊዝ ፓውንድ ስተርሊንግ";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "جنيه إسترليني";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Britaniya Funt";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "брытанскі фунт стэрлінгаў";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Британска лира";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "angilɛ Livri";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "ব্রিটিশ পাউন্ড";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "lur Breizh-Veur";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Britanska funta";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Британска фунта";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "lliura esterlina britànica";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Англин фунт";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "britská libra";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Punt Prydain";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "britisk pund";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Britisches Pfund";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "བྲི་ཊིཤ་ པ་འུནཌ་ ཨིས་ཊར་ལིང";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Britishga pound";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Λίρα Στερλίνα Βρετανίας";
        ...
        test("has translation for 'en_GG' locale", () {
          const expectedName = "UK Pound";

          final translated = value.maybeTranslation(
            const BasicLocale(LangEng(), countryCode: "GG"),
            useLanguageFallback: false,
          );
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "libra británica";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Suurbritannia naelsterling";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Libera esterlina";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "پوند بریتانیا";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Liibar Sterling";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Englannin punta";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "bretsk pund";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "livre sterling";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Punt Steirling";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Punnd Sasannach";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Libra esterlina";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "બ્રિટિશ પાઉન્ડ";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Fam kin Ingila";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "לירה שטרלינג";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "ब्रिटिश पाउंड स्टर्लिंग";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Բրիտանական ֆունտ ստերլինգ";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Pound Inggris";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "sterlingspund";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "sterlina britannica";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ბრიტანული გირვანქა სტერლინგი";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Mbauini cia Ngeretha";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Британдық фунт";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ផោនចក្រភពអង់គ្លេស";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಬ್ರಿಟೀಷ್ ಪೌಂಡ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "برطٲنوی پاونٛڑ سٹٔرلِنٛگ";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "британия фунт стерлинги";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Britescht Pond";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Pawundi ey’eBungereza";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Paunɛ ya Angɛlɛtɛ́lɛ";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ປອນ ສະ​ເຕີ​ຣິງ (ອັງ​ກິດ)";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Didžiosios Britanijos svaras";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Pauni wa Angeletele";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Lielbritānijas mārciņa";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ബ്രിട്ടീഷ് പൗണ്ട്";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "британийн фунт";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "ब्रिटिश पाऊंड";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Paun British";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဗြိတိသျှ ပေါင်";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "britiske pund";
        ...
        test("has translation for 'nd' locale", () {
          const expectedName = "Phawundi yase Ngilandi";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "बेलायती पाउण्ड स्टर्लिङ";
        ...
        test("has translation for 'os' locale", () {
          const expectedName = "Бритайнаг Фунт";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਬ੍ਰਿਟਿਸ਼ ਪੌਂਡ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "funt szterling";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Libra britânica";
        ...
        test("has translation for 'pt_PT' locale", () {
          const expectedName = "Libra esterlina britânica";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "glivra sterlina";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Ipawundi ryo mu Bwongereza";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "liră sterlină";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Британский фунт стерлингов";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "pôndo tî Anglëe";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "බ්‍රිතාන්‍ය ස්ටර්ලින් පවුම්";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "britanski funt";
        ...
        test("has translation for 'sn' locale", () {
          const expectedName = "Paundi ye Bhiriteni";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Sterlina britanike";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "brittiskt pund";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Pauni ya Uingereza";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "பிரிட்டிஷ் பவுண்டு";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "బ్రిటిష్ పౌండ్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ปอนด์สเตอร์ลิง (สหราชอาณาจักร)";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "İngiliz Sterlini";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ئەنگلىيە فوند سىتېرلىڭى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "англійський фунт";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "انگلستانی پاونڈ سٹرلنگ";
        ...
        test("has translation for 'ur_IN' locale", () {
          const expectedName = "برطانوی پاونڈ سٹرلنگ";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Angliya funt sterlingi";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Инглиз фунт";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "פֿונט שטערלינג";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Pọọn ti Orílẹ́ède Bírítísì";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Pɔɔn ti Orílɛ́ède Bírítísì";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-British Pound";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Britan funt sterlingi";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "ব্ৰিটিছ পাউণ্ড";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ବ୍ରିଟିସ ପାଉଣ୍ଡ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "برتانيوي پاونډ";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Pound ng Britanya";
