...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "North Korean Won";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Noord-Koreaanse won";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የሰሜን ኮሪያ ዎን";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "وون كوريا الشمالية";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Şimali Koreya Vonu";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "паўночнакарэйская вона";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Севернокорейски вон";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "উত্তর কোরিয়ার ওন";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "won Korea an Norzh";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Sjevernokorejski von";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Севернокорејски вон";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "won nord-coreà";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Къилбаседа Корейн вона";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "severokorejský won";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Won Gogledd Corea";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "nordkoreansk won";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Nordkoreanischer Won";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ནོརཐ་ ཀོ་རི་ཡ་གི་དངུལ་ ཝོན";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "dziehe koreaga won";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Γουόν Βόρειας Κορέας";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "won norcoreano";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Põhja-Korea vonn";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Ipar Koreako wona";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "وون کرهٔ شمالی";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Pohjois-Korean won";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Norðurkorea won";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "won nord-coréen";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Noard-Koreaanske won";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Won na Cóiré Thuaidh";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Won Choirèa a Tuath";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "ઉત્તર કોરિયન વન";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "וון צפון קוריאני";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "उत्तर कोरियाई वॉन";
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "sjevernokorejski won";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "észak-koreai won";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Հյուսիսկորեական վոն";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Won Korea Utara";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "norðurkóreskt vonn";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "won nordcoreano";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ჩრდილოეთ კორეული ვონი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Солтүстік Корея воны";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "វ៉ុនកូរ៉េខាងជើង";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಉತ್ತರ ಕೊರಿಯನ್ ವೋನ್";
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "조선 민주주의 인민 공화국 원";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "جنوٗبی کورِیَن وَن";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Түндүк Корея уону";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Nordkoreanesche Won";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ເກົາ​ຫລີ​ເໜືອ ວອນ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Šiaurės Korėjos vonas";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Ziemeļkorejas vona";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Северно корејски вон";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ഉത്തര കൊറിയൻ വോൺ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "хойд солонгос вон";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "उत्तर कोरियन वॉन";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "မြောက်ကိုရီးယား ဝမ်";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "nordkoreanske won";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "उत्तर कोरियाली वन";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਉੱਤਰੀ ਕੋਰੀਆਈ ਵੋਨ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "won północnokoreański";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Won norte-coreano";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "won da la Corea dal Nord";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "won nord-coreean";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Северокорейская вона";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "උතුරු කොරියානු වොන්";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "severokórejský won";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "severnokorejski von";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Uoni koreano-verior";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Won ya Korea Kaskazini";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "வட கொரிய வான்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "ఉత్తర కొరియా వోన్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "วอนเกาหลีเหนือ";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Won ng Hilagang Korea";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Kuzey Kore Wonu";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "شىمالىي كورېيە ۋونى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "північнокорейський вон";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "شمالی کوریائی وون";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Shimoliy Koreya voni";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Won Triều Tiên";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-North Korean Won";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "উত্তৰ কোৰিয়াৰ ওৱান";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤏𞤮𞤲 𞤁𞤮𞤱𞤣𞤮𞤱𞤪𞤭 𞤑𞤮𞥅𞤪𞤫𞤴𞤢𞤲𞤳𞤮";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Won na ƙasar Koriya ta Arewa";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "won nordkorean";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Won Obodo North Korea";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Won Korea Lor";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "wonê koreya bakurî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Won Kōrea ki te Raki";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଉତ୍ତର କୋରିଆଇ ୱୋନ୍";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "شمالي کوريايي وان";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "won nordcoreanu";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Wonka Waqooyiga Kuuriya";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Demirgazyk Koreý wony";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "I-Won yaseNorth Korea";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Wọ́ọ̀nù Àríwá Kòríà";
