...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Australian Dollar";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Australiese dollar";
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Ɔstrelia Dɔla";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የአውስትራሊያ ዶላር";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "دولار أسترالي";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Avstraliya Dolları";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "аўстралійскі долар";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Австралийски долар";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "ositirali Dolar";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "অস্ট্রেলিয়ান ডলার";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "dollar Aostralia";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Australijski dolar";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Аустралијски долар";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "dòlar australià";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Австралин доллар";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "australský dolar";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Doler Awstralia";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "australsk dollar";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Australischer Dollar";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཨཱོས་ཊྲེ་ལི་ཡ་གི་དངུལ་ ཌོ་ལར";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Australiaga dollar";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Δολάριο Αυστραλίας";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "dólar australiano";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Austraalia dollar";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Australiako dolarra";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "دلار استرالیا";
        ...
        test("has translation for 'fa_AF' locale", () {
          const expectedName = "دالر آسترالیا";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Dolaar Ostaraalii";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Australian dollari";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Avstralskur dollari";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "dollar australien";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Australyske dollar";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Dollar na hAstráile";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Dolar Astràilianach";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "ઑસ્ટ્રેલિયન ડૉલર";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Dalar Ostareliya";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "דולר אוסטרלי";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "ऑस्ट्रेलियाई डॉलर";
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "australski dolar";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "ausztrál dollár";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Ավստրալիական դոլար";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Dolar Australia";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "ástralskur dalur";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "dollaro australiano";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ავსტრალიური დოლარი";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Dola ya Australia";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Австралия доллары";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ដុល្លារ​អូស្ត្រាលី";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಆಸ್ಟ್ರೇಲಿಯನ್ ಡಾಲರ್‌";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "آسٹریلِیَن ڈالَر";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Australeschen Dollar";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Doola ey’Awusiturelya";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Dolarɛ ya Ositali";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ອອສ​ເຕຣ​ລຽນ ໂດ​ລ່າ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Australijos doleris";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Ndola wa Ositali";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Austrālijas dolārs";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Dolara aostralianina";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Австралиски долар";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ഓസ്ട്രേലിയൻ ഡോളർ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "австрали доллар";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "ऑस्ट्रेलियन डॉलर";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဩစတြေးလျ ဒေါ်လာ";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "australske dollar";
        ...
        test("has translation for 'nd' locale", () {
          const expectedName = "Dola yase Australia";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "अष्ट्रेलियन डलर";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Australische dollar";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਆਸਟ੍ਰੇਲੀਆਈ ਡਾਲਰ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "dolar australijski";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "dollar australian";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Idolari ryo muri Ositaraliya";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "dolar australian";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Австралийский доллар";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "dolära tî Ostralïi";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ඔස්ට්‍රේලියානු ඩොලර්";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "austrálsky dolár";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "avstralski dolar";
        ...
        test("has translation for 'sn' locale", () {
          const expectedName = "Dora re Australia";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Dollari australian";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "australisk dollar";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "ஆஸ்திரேலிய டாலர்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "ఆస్ట్రేలియన్ డాలర్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ดอลลาร์ออสเตรเลีย";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Dolyar ng Australya";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Avustralya Doları";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ئاۋسترالىيە دوللىرى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "австралійський долар";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "آسٹریلین ڈالر";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Avstraliya dollari";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Đô la Australia";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Dọla ti Orílẹ́ède Ástràlìá";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Dɔla ti Orílɛ́ède Ástràlìá";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Austrilian Dollar";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "অষ্ট্ৰেলিয়ান ডলাৰ";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଅଷ୍ଟ୍ରେଲିଆ ଡଲାର";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "اسټراليايي ډالر";
