...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Guatemalan Quetzal";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Guatemalaanse quetzal";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "كوتزال جواتيمالا";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Qvatemala Küetzalı";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "гватэмальскі кетсаль";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Гватемалски кетцал";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "গুয়াতেমালা কুয়েৎজাল";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "quetzal Guatemala";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Gvatemalski kecal";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Гватемалски квецал";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "quetzal guatemalenc";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Гватемалан кетсаль";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "guatemalský quetzal";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "guatemalansk quetzal";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Guatemaltekischer Quetzal";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "guatemalaga quetzal";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Κουετσάλ Γουατεμάλας";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "quetzal guatemalteco";
        ...
        test("has translation for 'es_GT' locale", () {
          const expectedName = "quetzal";

          final translated = value.maybeTranslation(
            const BasicLocale(LangSpa(), countryCode: "GT"),
            useLanguageFallback: false,
          );
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Guatemala ketsaal";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Guatemalako quetzala";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "کتزال گواتمالا";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Guatemala quetzal";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "quetzal guatémaltèque";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Guatemalteekse quetzal";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Quetzal Ghuatamala";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Quetzal Guatamalach";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "ગ્વાટેમાલા કુઇટ્ઝલ";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "קצל גואטמלי";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "ग्वाटेमाला क्वेटज़ल";
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "gvatemalski kvecal";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "guatemalai quetzal";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Գվատեմալական կետսալ";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "gvatemalskt kvesal";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "გვატემალური კეტსალი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Гватемала кетсалі";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ហ្គីស្សាល​ក្វាតេម៉ាឡា";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಗ್ವಾಟೆಮಾಲಾದ ಕುಯಿಟ್ಸಲ್‌‌";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "گواٹَمالَن قیوٗٹزَل";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "гватемала кетсалы";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Guatemaltekesche Quetzal";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ກົວເຕມາລານ ເຄັດຊອນ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Gvatemalos ketcalis";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Gvatemalas ketsals";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Гватемалски кветцал";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ഗ്വാട്ടിമാലൻ ക്വെറ്റ്‌സൽ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "гватемалын кецал";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "ग्वाटेमालाचे क्वेत्झाल";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဂွါတီမာလာ ခက်ဇော်လ်";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "guatemalanske quetzal";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "ग्वाटेमाला क्वेट्जाल";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਗੁਆਟੇਮਾਲਾ ਕੁਏਟਜ਼ਲ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "quetzal gwatemalski";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Quetzal guatemalense";
        ...
        test("has translation for 'pt_PT' locale", () {
          const expectedName = "Quetzal da Guatemala";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "quetzal da la Guatemala";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "quetzal guatemalez";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Гватемальский кетсаль";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ගෝතමාලානු ක්වෙට්සල්";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Kuecali i Guatemalës";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Гватемалски кецал";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Quetzal ya Guatemala";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "குவாதெமாலன் க்யுட்ஸல்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "గ్యుటెమాలన్ క్వెట్‌జల్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "เควตซัลกัวเตมาลา";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Quetzal ng Guatemala";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Guatemala Quetzalı";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "گىۋاتېمالا كۇۋېتزالى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "гватемальський кетсаль";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "گواٹے مالا کا کوئٹزل";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Gvatemala ketsali";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Гватемала кветзали";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Guatemalan Quetzal";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "গুৱাটেমালা কুৱেৎজাল";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Гватемала кетсалӗ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤑𞤫𞤼𞤵𞥁𞤢𞤤 𞤘𞤵𞤱𞤢𞤼𞤫𞤥𞤢𞤤𞤢𞤲𞤳𞤮";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Quetzal na ƙasar Guatemala";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "quetzal guatemaltec";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Quetzal obodo Guatemala";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "quertzalê guatemalayî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Quetzal Kuatamāra";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଗୁଏଟମାଲୀୟ କ୍ଵେତଜାଲ୍";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "ګويټيمالن کوټزل";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "quetzal guatemaltecu";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Kuwestalka Guwatemala";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Gwatemala ketsaly";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Kúẹ́tísààlì Guatimílà";
