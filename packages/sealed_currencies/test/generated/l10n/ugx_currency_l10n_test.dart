...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Ugandan Shilling";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Ugandese sjieling";
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Uganda Hyelen";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Uqanda Şillinqi";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "угандыйскі шылінг";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Угандски шилинг";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "uganda Siling";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "উগান্ডান শিলিং";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "shilling Ouganda";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Ugandski šiling";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "xíling ugandès";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Угандан шиллинг";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "ugandský šilink";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Swllt Uganda";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "ugandisk shilling";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Uganda-Schilling";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཡུ་གྷེན་ཌ་གི་དངུལ་ ཤི་ལིང";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "ugandaga shilling";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Σελίνι Ουγκάντας";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "chelín ugandés";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Uganda šilling";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Ugandako txelina";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "شیلینگ اوگاندا";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Siling Uganndaa";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Ugandan šillinki";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Uganda skillingur";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "shilling ougandais";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Oegandese shilling";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Scilling Uganda";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Shilling Ugandach";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Xilin ugandés";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "યુગાંડન શિલિંગ";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Sule Yuganda";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "שילינג אוגנדי";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "युगांडाई शिलिंग";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "ugandai shilling";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Ուգանդական շիլինգ";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Shilling Uganda";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "úgandskur skildingur";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "scellino ugandese";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "უგანდური შილინგი";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "ciringi cia Ũganda";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Уганда шиллингі";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ស៊ីលិញ​អ៊ូហ្គង់ដា";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಉಗಾಂಡನ್ ಶಿಲ್ಲಿಂಗ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "اُگاداہُک شِلِنٛگ";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Уганда шиллинги";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Silingi eya Yuganda";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Shilingɛ ya Uganda";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ອູ​ກັນ​ດັນ ຊິວ​ລິງ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Ugandos šilingas";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Nshili wa Uganda";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Ugandas šiliņš";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Shilling ogandianina";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Угандиски шилинг";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ഉഗാണ്ടൻ ഷില്ലിംഗ്";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "уганд шиллинг";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "युगांडा शिलिंग";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Syiling Uganda";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ယူဂန်းဒါး သျှီလင်";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "ugandiske shilling";
        ...
        test("has translation for 'nd' locale", () {
          const expectedName = "Shilingi yase Uganda";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "युगाण्डाली शिलिङ";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਯੂਗਾਂਡੀਆਈ ਸ਼ਿਲਿੰਗ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "szyling ugandyjski";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Xelim ugandense";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "schilling ugandais";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Ishilingi ry’Ubugande";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "șiling ugandez";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Угандийский шиллинг";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "shilîngi tî Ugandäa";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "උගන්ඩා ශිලිං";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "ugandský šiling";
        ...
        test("has translation for 'sn' locale", () {
          const expectedName = "Shiringi re Uganda";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Shilinga ugandeze";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Shilingi ya Uganda";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "உகாண்டன் ஷில்லிங்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "ఉగాండన్ షిల్లింగ్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ชิลลิงยูกันดา";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Uganda Şilini";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ئۇگاندا شىللىڭى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "угандійський шилінг";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "یوگانڈا شلنگ";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Uganda shillingi";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Siile ti Orílẹ́ède Uganda";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Siile ti Orílɛ́ède Uganda";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Ugandan Shilling";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "উগাণ্ডান শ্বিলিং";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Уганда шиллингӗ";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "shilling ugandese";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Shilling obodo Uganda";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "şîlîngê ûgandayî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "hereni Ukānga";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଉଗାଣ୍ଡିୟ ଶିଲିଂ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "يوګانډي شيلنګ";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "iscellinu ugandesu";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Shilingka Yugandha";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Uganda şillingi";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "I-Shilling yase-Uganda";
