...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Chilean Unit of Account (UF)";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Условна разчетна единица на Чили";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "চিলিয়ান উনিদাদেস দি ফোমেন্তো";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "unanenn jediñ Chile";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Čileanski unidades de fomento";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Чилеовски унидадес се фоменто";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "unidad de fomento xilena";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "chilská účetní jednotka (UF)";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Uned Cyfrifo Chile (UF)";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Chilenische Unidades de Fomento";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "tsilegakɔnta dzidzenu UF";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Ουνιδάδες ντε φομέντο Χιλής";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "unidad de fomento chilena";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Chilen unidades de fomento";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "unité d’investissement chilienne";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Sileenske unidades de fomento";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Unidades de Fomento na Sile";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Aonad cunntasachd Sileach (UF)";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Unidades de fomento chilenas";
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "čileanski unidades de fomentos";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Chilei unidades de fomento";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Satuan Hitung (UF) Cile";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Chilean Unidades de Fomento";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "unidades de fomento chilene";
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "チリ ウニダ・デ・フォメント (UF)";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "چِلِن یوٗنِڑیدیٖز ڑِ فومیٹو";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Chileneschen Unidad de Fomento";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ຫົວໜ່ວຍບັນຊີ (UF) ຊິລີ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Čiliečių unidades de fomentos";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ചിലിയൻ യൂണിഡാഡ്സ് ഡി ഫോമെൻറോ";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "chilenske unidades de fomento";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Chileense unidades de fomento";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "chilensk unidades de fomento";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Условная расчетная единица Чили";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Čílske Unidades de Fomento";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "čilski unidades de fomento";
        ...
        test("has translation for 'sr_Latn' locale", () {
          const expectedName = "Čileovski unidades se fomento";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "chilensk unidad de fomento";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ฟูเมนโตชิลี";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Şili Unidades de Fomento";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "چىلى ھېسابات بىرلىكى (UF)";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "чилійський юнідадес де фоменто";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Đơn vị Kế toán của Chile (UF)";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "Chilensk kontoenhed (UF)";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "Unitatea de cont chiliană (UF)";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Čīles konta vienība (UF)";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "Jednostka rozliczeniowa Chile (UF)";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "وحدة الحساب التشيلية";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Çili hesab vahidi";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Tšiili arvestusühik";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Chileense eenheid van rekening";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "ቺሌ መለያ መንገድ";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "Чылійскі адзінка рахунку";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "kontu-unitate txiletarra";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "واحد حساب شیلی";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "ચિલીયન યુનિટ ઑફ એકાઉન્ટ";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "יחידת חשבון צ'יליאנית";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "चिलीयन यूनिट ऑफ अकाउंट";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Չիլիայի հաշվապահության Միավոր";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ჩილის ანგარიშის ერთეული";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Чили төлем бірлігі";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "អង្គភាពគណនីរបស់ឈីលី";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಚಿಲಿಯನ್ ಘಟಕ ಖಾತೆ";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Чилинин эсеп бирдиги";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Чилеанска сметковна единица";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Чилийн нэгж ханш";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "चिलीयन युनिट ऑफ अकाउंट";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Unit Akaun Chile";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ချီလီယန်း ငွေကြေ";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "चिलीयन युनिट अफ अकाउंट";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਚਿਲੀ ਖਾਤੇ ਦੀ ਇਕਾਈ";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "චිලියාන් ගිණුමේ ඒකකය";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Njësia e Llogarisë Kiliane";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Kitengo cha Akaunti cha Chile";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "சிலியன் யூனிட் ஆஃப் அக்கவுண்ட்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "చిలీ యూనిట్ ఆఫ్ అకౌంట్";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "چلی اکاؤنٹ یونٹ";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Chili Hisoblash Birlik";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "Iyunithi ye-Akhawunti yaseChile";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "unidade de acontu tzilena";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "চিলিৰ একাউণ্টৰ একক (UF)";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଚିଲିକାର ଆକାଉଣ୍ଟ୍ ୟୁନିଟ୍";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "د چیلي د حساب واحد (UF)";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Unidades de Fomento ng Chile";
