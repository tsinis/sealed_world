...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "West African CFA Franc";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "CFA frank BCEAO";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የምዕራብ አፍሪካ ሴፋ ፍራንክ";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "فرنك غرب أفريقي";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Fil Dişi Sahili Frankı";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "заходнеафрыканскі франк КФА";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Западноафрикански франк";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "sefa Fraŋ (BCEAO)";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "পশ্চিম আফ্রিকান [CFA] ফ্র্যাঙ্ক";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "lur CFA Afrika ar Cʼhornôg";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Zapadnoafrički franak (CFA)";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "CFA франак BCEAO";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "franc CFA BCEAO";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Малхбузен Африкан КФА франк";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "CFA/BCEAO frank";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Ffranc CFA Gorllewin Affrica";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "CFA-franc BCEAO";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "ɣetoɖofe afrikaga CFA franc BCEAO";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Φράγκο CFA Δυτικής Αφρικής";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "franco CFA BCEAO";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Lääne-Aafrika CFA frank";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Afrika mendebaldeko CFA frankoa";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "فرانک CFA غرب افریقا";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Mbuuɗu Seefaa BCEAO";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "CFA-frangi BCEAO";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Vesturafrika CFA frankur";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Franc CFA Iarthar na hAfraice";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Franc CFA Afraga an Iar";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "પશ્ચિમી આફ્રિકન [CFA] ફ્રેંક";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Kuɗin Sefa na Afirka Ta Yamma";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "פרנק CFA BCEAO";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "पश्चिमी अफ़्रीकी CFA फ्रैंक";
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "CFA franak BCEAO";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Արևմտյան Աֆրիկայի ԿՖԱ ֆրանկ";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "vesturafrískur franki";
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "西アフリカ CFA フラン";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "(CFA) ფრანკი (BCEAO)";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Faranga CFA BCEAO";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "КФА ВСЕАО франкі";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ហ្វ្រង់ CFA អាហ្វ្រិកខាងលិច";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಪಶ್ಚಿಮ ಆಫ್ರಿಕಾದ [CFA] ಫ್ರಾಂಕ್";
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "서아프리카 CFA 프랑";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "سی ایٚف اے فرینک بی سی ایٖ اے او";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "CFA-Frang (BCEAO)";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Faranga ey’omu Afirika ey’ebugwanjuba";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Falánga CFA BCEAO";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ຟັງເຊຟານ ອາຟຣິກາຕາເວັນຕົກ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "CFA BCEAO frankas";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Nfalanga CFA BCEAO";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Rietumāfrikas CFA franks";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Farantsa CFA (BCEAO)";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "പശ്ചിമ ആഫ്രിക്കൻ [CFA] ഫ്രാങ്ക്";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "баруун африкийн франк";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "पश्चिम आफ्रिकन [CFA] फ्रँक";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "vestafrikanske CFA-franc";
        ...
        test("has translation for 'nd' locale", () {
          const expectedName = "Fulenki CFA BCEAO";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "सीएफ्‌ए फ्रान्क बीसीइएओ";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਪੱਛਮੀ ਅਫ਼ਰੀਕੀ (CFA) ਫ੍ਰੈਂਕ";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Franco CFA de BCEAO";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Франк КФА ВСЕАО";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "farânga CFA (BCEAO)";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "සිෆ්එ ෆ්රෑන්ක් බිසීඊඑඔ";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "západoafrický frank";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "zahodnoafriški frank CFA";
        ...
        test("has translation for 'sn' locale", () {
          const expectedName = "Furenki CFA BCEAO";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Franga e Bregut të Fildishtë";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "ЦФА франак БЦЕАО";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "västafrikansk franc";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Faranga ya Afrika Magharibi CFA";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "மேற்கு ஆப்பிரிக்க CFA ஃப்ராங்க்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "పశ్చిమ ఆఫ్రికన్ సిఏఫ్ఏ ఫ్రాంక్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ฟรังก์เซฟาธนาคารกลางรัฐแอฟริกาตะวันตก";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "CFA Franc ng Kanlurang Africa";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "CFA Frangı BCEAO";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "західноафриканський франк";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "مغربی افریقی [CFA] فرانک";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "G‘arbiy Afrika CFA franki";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Franc CFA Tây Phi";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Faransi ti Orílẹ́ède BIKEAO";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Faransi ti Orílɛ́ède BIKEAO";
        ...
        test("has translation for 'zh_Hant' locale", () {
          const expectedName = "法郎 (CFA–BCEAO)";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-West African CFA Franc";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "পশ্চিম আফ্ৰিকান CFA ফ্ৰেংক";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ପଶ୍ଚିମ ଆଫ୍ରିକା CFA ଫ୍ରାଙ୍କ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "لوېديځ افريقايي سي اف اې فرانک";
