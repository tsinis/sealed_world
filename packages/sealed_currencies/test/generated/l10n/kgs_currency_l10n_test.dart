...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Kyrgystani Som";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Kirgisiese som";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "سوم قيرغستاني";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Kırğızıstan Somu";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "кіргізскі сом";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Киргизстански сом";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "কিরগিজস্তান সোম";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "som Kyrgyzstan";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Kirgistanski som";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Киргистански сом";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "som kirguís";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Киргизин сом";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "kyrgyzský som";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "kirgisisk som";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Kirgisischer Som";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "kirgistanga som";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Σομ Κιργιζίας";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Kõrgõzstani somm";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Kirgizistango soma";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "سوم قرقیزستان";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Kirgisian som";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Kirgisia som";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "som kirghize";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Kirgizyske som";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Som na Cirgeastáine";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Som Cìorgasach";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Som quirguicistano";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "કિર્ગિસ્તાની સોમ";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "סום קירגיזי";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "किर्गिस्तानी सोम";
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "kirgiski som";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "kirgizisztáni szom";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Ղրղզական սոմ";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Som Kirgistan";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "kirgiskt som";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "som kirghiso";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ყირგიზული სომი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Қырғызстан сомы";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "សុម​កៀហ្ស៊ីស៊ីស្ថាន";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಕಿರ್ಗಿಸ್ತಾನಿ ಸೋಮ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "کِرگِستانُک سوم";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Кыргызстан сому";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Kirgisesche Som";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ຄ​ຣີ​ກິສ​​ຖາ​ນິ ໂຊມ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Kirgizijos somas";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Kirgizstānas soms";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "കിർഗിസ്ഥാനി സോം";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "किरगिस्तानी सॉम";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Som Kyrgystani";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ကာဂျစ္စတန် ဆော်မ်";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "kirgisiske som";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Kirgizische som";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਕਿਰਗਿਸਤਾਨੀ ਸੋਮ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "som kirgiski";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Som quirguiz";
        ...
        test("has translation for 'pt_PT' locale", () {
          const expectedName = "Som do Quirguistão";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "som kirghis";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Киргизский сом";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "කිරිගිස්ථාන සම්";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "kirgizský som";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "kirgiški som";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Soma kirgize";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "kirgizisk som";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Som ya Kyrgystani";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "கிர்கிஸ்தானி சோம்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "కిర్గిస్థాని సౌమ్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ซอมคีร์กีซสถาน";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Kırgızistan Somu";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "قىرغىزىستان سومى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "киргизький сом";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "کرغستانی سوم";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Qirg‘iziston somi";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Kyrgystani Som";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "কিৰ্গিস্তানী ছোম";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Киргиз сомӗ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤅𞤮𞤥𞤵 𞤑𞤭𞤪𞤺𞤭𞤧𞤼𞤢𞤲𞤭𞤲𞤳𞤮";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Som na ƙasar Kyrgystani";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "som kirghiz";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Som Obodo Kyrgyzstan";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "somê qirxizistanî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Som Kikitānga";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "କିର୍ଗିସ୍ତାନୀ ସୋମ୍";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "کرغزستاني سوم";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "som kirghisu";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Somta Kiyrgiystan";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Gyrgyz somy";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "I-Som yaseKyrgystan";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Sómú Kirijísítàànì";
