...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Singapore Dollar";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Singapoer dollar";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "دولار سنغافوري";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Sinqapur Dolları";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "сінгапурскі долар";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Сингапурски долар";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "সিঙ্গাপুর ডলার";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "dollar Singapour";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Singapurski dolar";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "dòlar de Singapur";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Сингапуран доллар";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "singapurský dolar";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Doler Singapore";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "singaporeansk dollar";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Singapur-Dollar";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "སིང་ག་པོར་གྱི་དངུལ་ ཌོ་ལར";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "singapɔga dollar";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Δολάριο Σιγκαπούρης";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "dólar singapurense";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Singapuri dollar";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Singapurreko dolarra";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "دلار سنگاپور";
        ...
        test("has translation for 'fa_AF' locale", () {
          const expectedName = "دالر سینگاپور";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Singaporen dollari";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Singapor dollari";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "dollar de Singapour";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Singaporese dollar";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Dollar Shingeapór";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Dolar Singeapòrach";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Dólar de Singapur";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "સિંગાપુર ડૉલર";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "דולר סינגפורי";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "सिंगापुर डॉलर";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "szingapúri dollár";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Սինգապուրի դոլար";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Dolar Singapura";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "singapúrskur dalur";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "dollaro di Singapore";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "სინგაპურის დოლარი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Сингапур доллары";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ដុល្លារ​​សិង្ហបូរី";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಸಿಂಗಾಪುರ್ ಡಾಲರ್‌";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "سِنگاپورُک ڈالَر";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ສິງ​ກະ​ໂປ ໂດ​ລ່າ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Singapūro doleris";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Singapūras dolārs";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "സിംഗപ്പൂർ ഡോളർ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "сингапур доллар";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "सिंगापूर डॉलर";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "စင်္ကာပူ ဒေါ်လာ";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "singaporske dollar";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "सिङ्गापुर डलर";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "singaporsk dollar";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਸਿੰਗਾਪੁਰ ਡਾਲਰ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "dolar singapurski";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Dólar singapuriano";
        ...
        test("has translation for 'pt_PT' locale", () {
          const expectedName = "Dólar de Singapura";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "dollar dal Singapur";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "dolar singaporez";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Сингапурский доллар";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "සිංගප්පූරු ඩොලර්";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "singapurský dolár";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Dollari i Singaporit";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "singaporiansk dollar";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Dola ya Singapore";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "சிங்கப்பூர் டாலர்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "సింగపూర్ డాలర్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ดอลลาร์สิงคโปร์";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Dolyar ng Singapore";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Singapur Doları";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "سىنگاپور دوللىرى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "сінгапурський долар";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "سنگا پور ڈالر";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Singapur dollari";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Đô la Singapore";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Singapore Dollar";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "ছিংগাপুৰ ডলাৰ";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Сингапур долларӗ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤁𞤢𞤤𞤢 𞤅𞤭𞤲𞤺𞤢𞤨𞤮𞤪𞤫𞤲𞤳𞤮";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Dalar Singapore";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "dollar singaporese";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Dollar obodo Singapore";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "dolarê sîngapurî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Tāra Hingapoa";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ସିଙ୍ଗାପୁର୍ ଡଲାର୍";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "سنګاپور ډالر";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "dòllaru de Singapore";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Doolarka Singabuur";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Singapur dollary";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "IDola yaseSingapore";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Dọ́là Síngápọ̀";
