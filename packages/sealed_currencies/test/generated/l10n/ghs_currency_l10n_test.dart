...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Ghanaian Cedi";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Ghanese cedi";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Qana Sedisi";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "ганскі седзі";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Ганайско седи";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Ganski cedi";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Гански цеди";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "cedi ghanès";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "ghanský cedi";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "ghanesisk cedi";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Ghanaischer Cedi";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Σέντι Γκάνας";
        ...
        test("has translation for 'es_MX' locale", () {
          const expectedName = "cedi ghanés";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Ghanako cedia";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Ghanan cedi";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "cédi ghanéen";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Cedi Gànach";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Cedi de Ghana";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "ઘાનાઇયન સેડી";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "घानियन सेडी";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "ghánai cedi";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Գանայական սեդի";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "ganverskur sedi";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "cedi ghanese";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "განური სედი";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ស៊ីឌី​ហ្គាណា";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "گَنیٚیَن سٮ۪ڑی";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Гана седиси";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Ghanaeschen Cedi";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ເຊ​ດິ ກາ​ນາ​ອຽນ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Ganos sedis";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Гански седи";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "घानीयन सेडी";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "ghanesiske cedi";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "घानाली सेडी";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "cedi ghański";
        ...
        test("has translation for 'pt_PT' locale", () {
          const expectedName = "Cedi de Gana";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "cedi ghanais";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "cedi ghanez";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Ганский седи";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "ghanské cedi";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Sejda ganeze";
        ...
        test("has translation for 'sr_Latn' locale", () {
          const expectedName = "Ganski sedi";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "ghanansk cedi";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Cedi ya Ghana";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "கானயன் சேடி";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "గానెయన్ సెడి";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Gana Sedisi";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "گانا سېدىسى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "ганський седі";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "گھانا کا سیڈی";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Ghanaian Cedi";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Гана седийӗ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤅𞤭𞤣𞤭 𞤘𞤢𞤲𞤢𞤲𞤳𞤮";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Sidi na Ghana";
        ...
        test("has translation for 'ha_GH' locale", () {
          const expectedName = "GHS";

          final translated = value.maybeTranslation(
            const BasicLocale(LangHau(), countryCode: "GH"),
            useLanguageFallback: false,
          );
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Cedi obodo Ghana";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "cediyê ganayî";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "cedi ganesu";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Sedida Gana";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Gano sedisi";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "I-Cedi yaseGhana";
