...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Surinamese Dollar";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Surinaamse dollar";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "دولار سورينامي";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Surinam Dolları";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "сурынамскі долар";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Суринамски долар";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "সুরিনাম ডলার";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "dollar Surinam";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Surinamski dolar";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "dòlar de Surinam";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Суринаман доллар";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "surinamský dolar";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Doler Surinam";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "surinamsk dollar";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Suriname-Dollar";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "surinamga dollar";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Δολάριο Σουρινάμ";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "dólar surinamés";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Surinameko dolarra";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "دلار سورینام";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Surinamen dollari";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Surinam dollari";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "dollar surinamais";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Surinaamske dollar";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Dollar Shuranam";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Dolar Suranamach";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "સૂરીનામિઝ ડોલર";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "דולר סורינאמי";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "सूरीनामी डॉलर";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "suriname-i dollár";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Սուրինամի դոլար";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Dolar Suriname";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Súrínamdalur";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "dollaro del Suriname";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "სურინამული დოლარი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Суринам доллары";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ដុល្លារ​សូរីណាម";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಸುರಿನಾಮೀಸ್ ಡಾಲರ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "سُریٖنامُک ڈالَر";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Surinameschen Dollar";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ຊູ​ຣິ​ນາ​ມີ​ສ ໂດ​ລ່າ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Surimano doleris";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Surinamas dolārs";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "സുരിനെയിമിസ് ഡോളർ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "суринам доллар";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "सुरिनामी डॉलर";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Dolar Surinam";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဆူရီနမ်း ဒေါ်လာ";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "surinamske dollar";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "सुरिनामिज डलर";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਸੂਰੀਨਾਮੀ ਡਾਲਰ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "dolar surinamski";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Dólar surinamês";
        ...
        test("has translation for 'pt_PT' locale", () {
          const expectedName = "Dólar do Suriname";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "dolar surinamez";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Суринамский доллар";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "සුරිනාම් ඩොලර්";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "surinamský dolár";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Dollari surinamez";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "surinamesisk dollar";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Dola ya Suriname";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "சுரினாமீஸ் டாலர்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "సురినామీయుల డాలర్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ดอลลาร์ซูรินาเม";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Dolyar ng Suriname";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Surinam Doları";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "سۇرىنام دوللىرى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "суринамський долар";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "سورینامی ڈالر";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Суринам доллари";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Đô la Suriname";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Surinamese Dollar";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "ছুৰিনামী ডলাৰ";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Суринам долларӗ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤁𞤢𞤤𞤢 𞤅𞤵𞤪𞤵𞤲𞤢𞤥𞤭𞤲𞤳𞤮";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Dalar ƙasar Suriname";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "dollar surinamese";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "dolarê surînamî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Tāra Huriname";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ସୁରିନାମିଜ୍ ଡଲାର୍";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "سورينيمي ډالر";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "dòllaru surinamesu";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Doolarka Surinamees";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Surinam dollary";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "IDola yaseSuriname";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Dọ́là Súrínámì";
