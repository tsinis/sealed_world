...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Kenyan Shilling";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Keniaanse sjieling";
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Kenya Hyelen";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Keniya Şillinqi";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "кенійскі шылінг";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Кенийски шилинг";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "keniya Siling";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "কেনিয়ান শিলিং";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "shilling Kenya";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Kenijski šiling";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Кенијски шилинг";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "xíling kenyà";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Кенин шиллинг";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "keňský šilink";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Swllt Kenya";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "kenyansk shilling";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Kenia-Schilling";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཀེན་ཡ་གི་དངུལ་ ཤི་ལིང";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "kenyaga shilling";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Σελίνι Κένυας";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "chelín keniano";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Keenia šilling";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Kenyako txelina";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "شیلینگ کنیا";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Siling Keñaa";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Kenian šillinki";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "kenjanskur skillingur";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "shilling kényan";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Keniaanske shilling";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Scilling na Céinia";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Shilling Ceineach";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Xilin kenyano";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "કેન્યેન શિલિંગ";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Sulen Kenya";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "שילינג קנייאתי";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "केन्याई शिलिंग";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "kenyai shilling";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Քենիական շիլինգ";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "kenískur skildingur";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "scellino keniota";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "კენიური შილინგი";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Ciringi ya Kenya";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Кения шиллингі";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ស៊ីលិញ​កេនយ៉ា";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಕೆನ್ಯನ್ ಶಿಲ್ಲಿಂಗ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "کٮ۪نیَن شِلِنٛگ";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Кения шиллинги";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Silingi ey’eKenya";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Shilingɛ ya Kenya";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ເຄນ​ຢັນ ຊິວ​ລິງ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Kenijos šilingas";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Nshili wa Kenya";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Kenijas šiliņš";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Shilling kenianina";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Кениски шилинг";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "കെനിയൻ ഷില്ലിംഗ്";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "кени шиллинг";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "केनियन शिलिंग";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Syiling Kenya";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ကင်ညာသျှီလင်";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "kenyanske shilling";
        ...
        test("has translation for 'nd' locale", () {
          const expectedName = "Shilingi yase Kenya";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "केन्याली शिलिङ";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Keniaanse shilling";
        ...
        test("has translation for 'om_KE' locale", () {
          const expectedName = "KES";

          final translated = value.maybeTranslation(
            const BasicLocale(LangOrm(), countryCode: "KE"),
            useLanguageFallback: false,
          );
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਕੀਨੀਆਈ ਸ਼ਿਲਿੰਗ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "szyling kenijski";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Xelim queniano";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "schilling kenian";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Ishilingi rya Kenya";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "șiling kenyan";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Кенийский шиллинг";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "shilîngi tî Kenyäa";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "කෙන්යානු ශිලිං";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "kenský šiling";
        ...
        test("has translation for 'sn' locale", () {
          const expectedName = "Shiringi ye Kenya";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Shilinga keniane";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Shilingi ya Kenya";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "கென்யன் ஷில்லிங்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "కెన్యాన్ షిల్లింగ్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ชิลลิงเคนยา";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Kenya Şilini";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "كېنىيە شىللىڭى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "кенійський шилінг";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "کینیائی شلنگ";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Keniya shillingi";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "ṣiili ti Orílẹ́ède Kenya";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "shiili ti Orílɛ́ède Kenya";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Kenyan Shilling";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "কেনিয়ান শ্বিলিং";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Кени шиллингӗ";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "shilling kenyan";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Shilling obodo Kenya";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "şîlîngê kenyayî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Hereni Kenia";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "କେନିୟ ଶିଲିଂ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "کينيايي شيلنګ";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "iscellinu kenianu";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Shilingka Kenya";
        ...
        test("has translation for 'so_KE' locale", () {
          const expectedName = "KES";

          final translated = value.maybeTranslation(
            const BasicLocale(LangSom(), countryCode: "KE"),
            useLanguageFallback: false,
          );
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Keniýa şillingi";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "I-Shilling yaseKenya";
