...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Hungarian Forint";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Hongaarse florint";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "فورينت مجري";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Macarıstan Forinti";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "венгерскі форынт";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Унгарски форинт";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "হাঙ্গেরিয়ান ফোরিন্ট";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "forint Hungaria";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Mađarska forinta";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Мађарска форинта";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "fòrint hongarès";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Венгрин форинт";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "maďarský forint";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Fforint Hwngari";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "ungarsk forint";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Ungarischer Forint";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "hungariaga forint";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Φιορίνι Ουγγαρίας";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "forinto húngaro";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Ungari forint";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Hungariako florina";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "فورینت مجارستان";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Unkarin forintti";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Ungarn forint";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "forint hongrois";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Hongaarse forint";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Forint na hUngáire";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Forint Ungaireach";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Florín húngaro";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "હંગેરીયન ફોરિન્ત";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "פורינט הונגרי";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "हंगेरियन फ़ोरिंट";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "magyar forint";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Հունգարական ֆորինտ";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "ungversk fórinta";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "fiorino ungherese";
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ハンガリー フォリント";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "უნგრული ფორინტი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Венгрия форинті";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ហ្វូរីន​ហុងគ្រី";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಹಂಗೇರಿಯನ್ ಫೋರಿಂಟ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "حَنگیرِیَن فورِنٛٹ";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "венгр форинти";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Ungaresche Forint";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ຮັງ​ກາ​ຣຽນ ຟໍ​ຣິນ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Vengrijos forintas";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Ungārijas forints";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Унгарска форинта";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ഹംഗേറിയൻ ഫോറിന്റ്";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "унгарын форинт";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "हंगेरियन फॉरिन्ट";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Forint Hungary";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဟန်ဂေရီယံဖော်ရင့်တ်";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "ungarske forinter";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "हङ्गेरियन फोरिन्ट";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਹੰਗਰੀ ਫੋਰਿੰਟ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "forint węgierski";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Forint húngaro";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "forint ungarais";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "forint maghiar";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Венгерский форинт";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "හංගේරියානු ෆරින්ට්";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "madžarski forint";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Forinta hungareze";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "ungersk forint";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Forint ya Hungaria";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "ஹங்கேரியன் ஃபோரின்ட்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "హంగేరియన్ ఫోరిన్ట్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ฟอรินต์ฮังการี";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Macar Forinti";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ۋېنگىرىيە فورېنتى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "угорський форинт";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "ہنگرین فورنٹ";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Vengriya forinti";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Hungarian Forint";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "হাংগেৰীয়ান ফ’ৰিণ্ট";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Венгри форинчӗ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤊𞤮𞤪𞤭𞤲𞤼𞤵 𞤖𞤵𞤲𞤺𞤢𞤪𞤭𞤴𞤢𞤲𞤳𞤮";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Kuɗin Hungary";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "forint hungare";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Forint obodo Hungary";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "forîntê macarî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Forint Hanekari";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ହଙ୍ଗେରିୟ ଫୋରିଣ୍ଟ୍";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "هنګري فورنټ";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "fiorinu ungheresu";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Forintiska Hangari";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Wenger forinti";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Forint ng Hungary";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "I-Forint yaseHungay";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Fọ́ríǹtì Họ̀ngérí";
