...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Dominican Peso";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Dominikaanse peso";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "بيزو الدومنيكان";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Dominika Pesosu";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "дамініканскае песа";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Доминиканско песо";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "ডোমিনিকান পেসো";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "peso Dominikan";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Dominikanski pezos";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Доминикански пезо";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "peso dominicà";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Доминикан песо";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "dominikánské peso";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Peso Gweriniaeth Dominica";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "dominikansk peso";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Dominikanischer Peso";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "dominicaga peso";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Πέσο Δομινικανής Δημοκρατίας";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "peso dominicano";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Dominikaani peeso";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Dominikar Errepublikako pesoa";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "پزوی جمهوری دومینیکن";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Dominikaanisen tasavallan peso";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Dominika peso";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "peso dominicain";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Dominikaanske peso";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Peso na Poblachta Doiminicí";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Peso Doiminiceach";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "ડોમિનિકન પેસો";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "פזו דומיניקני";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "डोमिनिकन पेसो";
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "dominikanski pezo";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "dominikai peso";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Դոմինիկյան պեսո";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Peso Dominika";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "dóminískur pesi";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "დომინიკური პესო";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Доминикан песосы";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ប៉េសូដូមីនីក";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಡೊಮಿನಿಕನ್ ಪೆಸೊ";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "ڈومِنِکَن پِسو";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "доминикан песосу";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Dominikanesche Peso";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ໂດ​ມິ​ນິ​ກັນ ເປ​ໂຊ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Dominikos pesas";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Dominikānas peso";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Доминикански Пезос";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ഡൊമിനിക്കൻ പെസോ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "доминиканы песо";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Peso Dominican";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဒိုမီနီကန် ပီဆို";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "dominikanske pesos";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Dominicaanse peso";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਡੌਮਿਨਿਕਨ ਪੇਸੋ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "peso dominikańskie";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Доминиканское песо";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ඩොමිනිකානු පෙසෝ";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "dominikánske peso";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "dominikanski peso";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Pesoja dominikane";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Peso ya Dominika";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "டொமினிக்கன் பெசோ";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "డోమినికన్ పెసో";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "เปโซโดมินิกัน";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Piso ng Dominican";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Dominik Pesosu";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "دومىنىكا پېسوسى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "домініканський песо";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "ڈومنیکن پیسو";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Dominikana pesosi";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Доминикан песоси";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Peso Dominica";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Dominican Peso";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "ড’মিনিকান পেছো";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Доминикан песийӗ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤆𞤫𞤧𞤮 𞤁𞤮𞤥𞤭𞤲𞤭𞤴𞤢𞤲𞤳𞤮";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Peso na jamhuriyar Dominica";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Peso Obodo Dominica";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "pesoyê domînîkî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Peso Tominika";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଡୋମିନିକୀୟ ପେସୋ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "دومينيکا پسو";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "peso dominicanu";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Beesada Dominiika";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Dominikan pesosy";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Pẹ́sò Dòníníkà";
