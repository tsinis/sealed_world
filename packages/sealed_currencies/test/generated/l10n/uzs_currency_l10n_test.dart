...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Uzbekistani Som";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Oezbekiese som";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የኡዝፔኪስታን ሶም";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "سوم أوزبكستاني";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Özbəkistan Somu";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "узбекскі сум";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Узбекски сум";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "উজবেকিস্তানি সোম";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "som Ouzbekistan";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Uzbekistanski som";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Узбекистански сом";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Узбекистанан сум";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "uzbecký sum";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Som Uzbekistan";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "usbekisk sum";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Usbekistan-Sum";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཨུས་བེ་ཀིས་ཏཱན་གྱི་དངུལ་ སོམ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "uzbekistanga som";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Σομ Ουζμπεκιστάν";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Usbekistani somm";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Uzbekistango soma";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "سوم ازبکستان";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Uzbekistanin som";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Usbekistan som";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Oezbekistaanske sum";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Sum na hÚisbéiceastáine";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Som Usbagach";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "ઉઝ્બેકિસ્તાન સોમ";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "उज़्बेकिस्तान सोम";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "üzbegisztáni szum";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Ուզբեկական սոմ";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "úsbekskt súm";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "უზბეკური სუმი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Өзбекстан сомы";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "សុមអ៊ូបេគីស្ថាន";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಉಜ್ಬೇಕಿಸ್ತಾನ್ ಸೊಮ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "اُبیکِستان سوم";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Өзбекстан суму";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ອຸສເບກິສຖານິ ໂຊມ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Uzbekistano sumas";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Uzbekistānas sums";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ഉസ്‌ബെക്കിസ്ഥാനി സോം";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "узбекийн сом";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "उझबेकिस्तानी सोम";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဥဇဘက်ကစ္စတန် ဆော်မ်";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "usbekiske som";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "उज्बेकिस्तान सोम";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Oezbeekse sum";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਉਜ਼ਬੇਕਿਸਤਾਨ ਸੋਮ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "som uzbecki";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Som uzbeque";
        ...
        test("has translation for 'pt_PT' locale", () {
          const expectedName = "Som do Uzbequistão";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "sum Uzbekistan";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Узбекский сум";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "උස්බෙකිස්ථාන සම්";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "uzbeški sum";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Soma uzbeke";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "uzbekisk sum";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Som ya Uzibekistani";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "உஸ்பெக்கிஸ்தானி சோம்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "ఉజ్‌బెకిస్తాన్ సౌమ్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ซอมอุซเบกิสถาน";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Uzbekistan Som";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Özbekistan Somu";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ئۆزبېكىستان سومى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "узбецький сум";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "ازبکستان سوم";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "O‘zbekiston so‘mi";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Ўзбекистон сўм";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Uzbekistan Som";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "উজবেকিস্তানী ছোম";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤅𞤮𞤥𞤵 𞤓𞥁𞤦𞤫𞤳𞤭𞤧𞤼𞤢𞤲𞤳𞤮";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Som na ƙasar Uzbekistan";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Som obodo Uzbekistan";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Som Usbekistan";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "somê ozbekî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Som Uhipeketāne";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଉଜବେକିସ୍ତାନୀ ସୋମ୍";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "ازبکستاني سوم";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Somta Usbekistan";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "I-Som yase-Uzbekistan";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Sómú Usibẹkísítàànì";
