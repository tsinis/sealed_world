...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "East Caribbean Dollar";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Oos-Karibbiese dollar";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የምዕራብ ካሪብያን ዶላር";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "دولار شرق الكاريبي";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Şərqi Karib Dolları";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "усходнекарыбскі долар";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Източнокарибски долар";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "পূর্ব ক্যারাবিয়ান ডলার";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "dollar Karib ar reter";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Istočnokaripski dolar";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Источно-карибски долар";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "dòlar del Carib Oriental";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Малхбален Карибийн доллар";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "východokaribský dolar";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Doler Dwyrain y Caribî";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "østkaribisk dollar";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Ostkaribischer Dollar";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "ɣedzeƒe caribbeaga dollar";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Δολάριο Ανατολικής Καραϊβικής";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "dólar del Caribe Oriental";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Ida-Kariibi dollar";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Karibe ekialdeko dolarra";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "دلار شرق کارائیب";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Itä-Karibian dollari";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Eystur Karibia dollari";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "dollar des Caraïbes orientales";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "East-Karibyske dollar";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Dollar na Cairibe Thoir";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Dolar Caraibeach earach";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Dólar do Caribe Oriental";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "ઇસ્ટ કેરિબિયન ડોલર";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "דולר מזרח קריבי";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "पूर्वी कैरिबियाई डॉलर";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "kelet-karibi dollár";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Արևելակարիբյան դոլար";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Dolar Karibia Timur";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "austurkarabískur dalur";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "dollaro dei Caraibi orientali";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "აღმოსავლეთ კარიბიული დოლარი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Шығыс Кариб доллары";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ដុល្លារ​ការ៉ាប៊ីន​ខាង​កើត";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಪೂರ್ವ ಕೆರೀಬಿಯನ್ ಡಾಲರ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "مَشرِقی کیرِبِیَن ڈالَر";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "чыгыш кариб доллары";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Ostkaribeschen Dollar";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ອີ​ສ ຄາ​ຣິ​ບຽນ ໂດ​ລ່າ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Rytų Karibų doleris";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Austrumkarību dolārs";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Источно карибиски долар";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "കിഴക്കൻ കരീബിയൻ ഡോളർ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "зүүн карибийн доллар";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "पूर्व कॅरीबियन डॉलर";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Dolar Caribbean Timur";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "အရှေ့ကာရစ်ဘီယံဒေါ်လာ";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "østkaribiske dollar";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "पूर्वी क्यारिबियन डलर";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Oost-Caribische dollar";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "austkaribisk dollar";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਪੂਰਬੀ ਕੈਰੇਬੀਅਨ ਡਾਲਰ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "dolar wschodniokaraibski";
        ...
        test("has translation for 'pt_PT' locale", () {
          const expectedName = "Dólar das Caraíbas Orientais";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "dollar da la Caribica Orientala";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "dolar din Caraibele de Est";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Восточно-карибский доллар";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "නැගෙනහිර කැරිබියානු ඩොලර්";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "východokaribský dolár";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "vzhodnokaribski dolar";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Dollari i Karaibeve Lindore";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Источнокарипски долар";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "östkaribisk dollar";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Dola ya Karibea ya Mashariki";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "கிழக்கு கரீபியன் டாலர்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "తూర్పు కరీబియన్ డాలర్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ดอลลาร์แคริบเบียนตะวันออก";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Dolyar ng Silangang Caribbean";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Doğu Karayip Doları";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "شەرقىي كارىب دوللىرى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "східнокарибський долар";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "مشرقی کریبیا کا ڈالر";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Sharqiy Karib dollari";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Шарқий Кариб доллари";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Đô la Đông Caribê";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-East Caribbean Dollar";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "ইষ্ট কেৰিবিয়ান ডলাৰ";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ପୂର୍ବ କାରିବିଆନ ଡଲାର";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "ختيځ کارېبين ډالر";
