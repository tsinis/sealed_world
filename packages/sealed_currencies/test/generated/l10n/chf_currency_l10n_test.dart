...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Swiss Franc";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Switserse frank";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "فرنك سويسري";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "İsveçrə Frankı";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "швейцарскі франк";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Швейцарски франк";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "suwisi Fraŋ";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Švicarski franak";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Швајцарски франак";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Швейцарин франк";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "švýcarský frank";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Ffranc y Swistir";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "schweizerfranc";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Schweizer Franken";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "སུ་ཡིས་ཀྱི་དངུལ་ ཕྲངཀ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Swissga franc";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Φράγκο Ελβετίας";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "franco suizo";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Šveitsi frank";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Suitzako frankoa";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "فرانک سوئیس";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Faraa Suwiis";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Sveitsin frangi";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "sveisiskur frankur";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "franc suisse";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Zwitserse frank";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Franc na hEilvéise";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Franc Eilbheiseach";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Franco suízo";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "સ્વિસ ફ્રેંક";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Kuɗin Suwizalan";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "פרנק שוויצרי";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "स्विस फ़्रैंक";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "svájci frank";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Շվեյցարական ֆրանկ";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Franc Swiss";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "svissneskur franki";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "franco svizzero";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "შვეიცარიული ფრანკი";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Faranga ya Uswisi";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Швейцария франкі";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ហ្វ្រង់ស្វីស";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಸ್ವಿಸ್ ಫ್ರಾಂಕ್";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "швейцария франкы";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Schwäizer Frang";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Faranga ey’eSwitizirandi";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Falánga ya Swisɛ";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ສະ​ວິ​ສ ຟ​ຣັງ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Šveicarijos frankas";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Nfalanga wa Swise";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Šveices franks";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Farantsa soisa";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Швајцарски Франк";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "സ്വിസ് ഫ്രാങ്ക്";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "швейцарь франк";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "स्विस फ्रँक";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Franc Switzerland";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "sveitsiske franc";
        ...
        test("has translation for 'nd' locale", () {
          const expectedName = "Fulenki yase Swisi";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "स्विस् फ्रैङ्क";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "sveitsisk franc";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਸਵਿਸ ਫ੍ਰੈਂਕ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "frank szwajcarski";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Franco suíço";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "franc svizzer";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Ifaranga ry’Ubusuwisi";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "franc elvețian";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Швейцарский франк";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "farânga tî Sûîsi";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ස්විස් ෆ්‍රෑන්ක්";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "švajčiarsky frank";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "švicarski frank";
        ...
        test("has translation for 'sn' locale", () {
          const expectedName = "Furenki re Swisi";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Franga zvicerane";
        ...
        test("has translation for 'sr_Latn' locale", () {
          const expectedName = "Švajcarski franak";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "schweizisk franc";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "சுவிஸ் ஃப்ராங்க்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "స్విస్ ఫ్రాంక్";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "İsviçre Frangı";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "شىۋېتسىيە فرانكى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "швейцарський франк";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "سوئس فرانکس";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Shveytsariya franki";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Franc Thụy sĩ";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "שווייצער פֿראַנק";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Faransi ti Orílẹ́ède Siwisi";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Faransi ti Orílɛ́ède Siwisi";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Swiss Franc";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "চুইছ ফ্ৰেংক";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Швейцари франкӗ";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "franco suisse";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Franc mba Switzerland";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "frankê swîsrî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Franc Huiterangi";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ସୁଇସ୍ ଫ୍ରାଙ୍କ୍";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "سويسي فرانک";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "francu isvìtzeru";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Faranka Iswiska";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Şweýsar franky";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "I-Franc yaseSwitzerland";
