...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Uruguayan Peso";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Uruguaanse peso";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "بيزو اوروغواي";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Uruqvay Pesosu";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "уругвайскае песа";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Уругвайско песо";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "উরুগুয়ে পেসো";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "peso Uruguay";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Urugvajski pezos";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Уругвајски пезо";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "peso uruguaià";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Уругвайн песо";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "uruguayské peso";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "uruguayansk peso";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Uruguayischer Peso";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཡུ་རུ་གུ་ཝའི་གི་དངུལ་ པེ་སོ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "uruguayga peso";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Πέσο Ουρουγουάης";
        ...
        test("has translation for 'en_AU' locale", () {
          const expectedName = "Peso Uruguayo";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Uruguay peeso";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Uruguaiko pesoa";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "پزوی اوروگوئه";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Uruguayn peso";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Uruguai peso";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "peso uruguayen";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Uruguayaanske peso";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Peso Uragua";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Peso Uruguaidheach";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Peso uruguaio";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "ઉરુગ્વેયન પેસો";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "פסו אורוגוואי";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "उरुग्वियन पेसो";
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "urugvajski pezo";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "uruguay-i peso";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Ուրուգվայական պեսո";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "úrúgvæskur pesi";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "peso uruguayano";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ურუგვაის პესო";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Уругвай песосы";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ប៉េសូអ៊ុយរូហ្គាយ";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಉರುಗ್ವೆಯ ಪೆಸೊ";
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "우루과이 페소 우루과요";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "اُروٗگایَن پیٚسو";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "уругвай песосу";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Uruguayesche Peso";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ອູ​ຣຸ​ກົວ​ຢານ ເປ​ໂຊ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Urugvajaus pesas";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Urugvajas peso";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Уругвајски пезос";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ഉറുഗ്വേയൻ പെസോ";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "उरुग्वेचा पेसो";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဥရုဂွေးပီဆို";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "uruguayanske pesos";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "उरूगुवायाली पेसो";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Uruguayaanse peso";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਉਰੂਗੁਵਾਇਨ ਪੇਸੋ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "peso urugwajskie";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "peso da l’Uruguay";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "peso uruguayan";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Уругвайское песо";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "උරුගුවේ පෙසෝ";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "uruguajské peso";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "urugvajski peso";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Pesoja uruguaiane";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Peso ya Urugwai";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "உருகுவேயன் பெசோ";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "ఉరుగ్వెయన్ పెసో";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "เปโซอุรุกวัย";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Piso ng Uruguay";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Uruguay Pesosu";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ئۇرۇگۋاي پېسوسى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "уругвайський песо";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "یوروگویان پیسو";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Urugvay pesosi";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Уругвай песоси";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Uruguayan Peso";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "উৰুগুৱেয়ান পেছো";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Уругвай песийӗ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤆𞤫𞥅𞤧𞤮𞥅 𞤒𞤵𞤪𞤺𞤮𞤴𞤢𞤲𞤳𞤮";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Peso na ƙasar Uruguay";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Peso obodo Uruguay";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "pesoyê ûrûgûayî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Peso Urukoi";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଉରୁଗୁଇୟାନ୍ ପେସୋ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "يوراګوي پسو";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "peso uruguayanu";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Beesada Urugway";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Urugwaý pesosy";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "I-Peso yase-Uruguay";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Pẹ́sò Úrúgúwè";
