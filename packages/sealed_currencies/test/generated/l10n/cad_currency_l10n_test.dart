...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Canadian Dollar";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Kanadese dollar";
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Kanada Dɔla";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Kanada Dolları";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "канадскі долар";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Канадски долар";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "kanada Dolar";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "কানাডিয়ান ডলার";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "dollar Kanada";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Kanadski dolar";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "dòlar canadenc";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Канадан доллар";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "kanadský dolar";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Doler Canada";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "canadisk dollar";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Kanadischer Dollar";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཀེ་ན་ཌ་གི་དངུལ་ ཌོ་ལར";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Canadaga dollar";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Δολάριο Καναδά";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "dólar canadiense";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Kanada dollar";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Kanadako dolarra";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "دلار کانادا";
        ...
        test("has translation for 'fa_AF' locale", () {
          const expectedName = "دالر کانادا";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Dolaar Kandaaa";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Kanadan dollari";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Kanada dollari";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "dollar canadien";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Canadese dollar";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Dollar Cheanada";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Dolar Canadach";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Dólar canadense";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "કેનેડિયન ડૉલર";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Dalar Kanada";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "कनाडाई डॉलर";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "kanadai dollár";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Կանադական դոլար";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Dolar Kanada";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Kanadadalur";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "dollaro canadese";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "კანადური დოლარი";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Ndora ya Kananda";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Канада доллары";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ដុល្លារ​កាណាដា";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಕೆನಡಾದ ಡಾಲರ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "کینَڑِیَن ڈالر";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Kanadeschen Dollar";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Doola ey’eKanada";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Dolarɛ ya Kanadá";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ໂດລ່າຄານາດາ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Kanados doleris";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Ndola wa Kanada";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Kanādas dolārs";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Dôlara Kanadianina";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "കനേഡിയൻ ഡോളർ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "канад доллар";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "कॅनडियन डॉलर";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ကနေဒါ ဒေါ်လာ";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "kanadiske dollar";
        ...
        test("has translation for 'nd' locale", () {
          const expectedName = "Dola yase Khanada";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "क्यानाडियाली डलर";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "kanadisk dollar";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਕੇਨੇਡਿਆਈ ਡਾਲਰ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "dolar kanadyjski";
        ...
        test("has translation for 'pt_PT' locale", () {
          const expectedName = "Dólar canadiano";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "dollar canadais";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Idolari rya Kanada";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "dolar canadian";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Канадский доллар";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "dolära tî kanadäa";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "කැනේඩියානු ඩොලර්";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "kanadský dolár";
        ...
        test("has translation for 'sn' locale", () {
          const expectedName = "Dora re Kanada";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Dollari kanadez";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "kanadensisk dollar";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Dola ya Kanada";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "கனடியன் டாலர்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "కెనడియన్ డాలర్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ดอลลาร์แคนาดา";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Dolyar ng Canada";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Kanada Doları";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "كانادا دوللىرى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "канадський долар";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "کنیڈین ڈالر";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Канада доллари";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Đô la Canada";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Dọla ti Orílẹ́ède Kánádà";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Dɔla ti Orílɛ́ède Kánádà";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Candian Dollar";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "কানাডিয়ান ডলাৰ";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "କାନାଡ଼ା ଡଲାର";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "کاناډايي ډالر";
