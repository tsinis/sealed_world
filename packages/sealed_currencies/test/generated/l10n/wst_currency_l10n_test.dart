...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Samoan Tala";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Samoaanse tala";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Samoa Talası";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "самаанская тала";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Самоанска тала";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "সামোয়ান টালা";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Samoanska tala";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Самоанан тала";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "samojská tala";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "samoansk tala";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Samoanischer Tala";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "samaoga tala";
        ...
        test("has translation for 'es_MX' locale", () {
          const expectedName = "tala samoano";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Samoa taala";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Samoko tala";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "تالای ساموا";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "tala samoan";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Samoaanske tala";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Tala Samothach";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "nyugat-szamoai tala";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Սամոական տալա";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "სამოური ტალა";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Самоа таласы";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Samoaneschen Tala";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ຊາ​ໂມນ ທາ​ລາ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "самоагийн тала";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "सामोअन टाला";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဆမိုအား ထားလာ";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "samoanske tala";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "सामोआन ताला";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "vestsamoisk tala";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਸਾਮੋਆਈ ਤਾਲਾ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "tala samoańskie";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "tala da la Samoa";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "tala samoană";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Самоанская тала";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "සැමෝවා ටාලා";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Tala samoane";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "västsamoansk tala";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Tala ya Samoa";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "சமோவான் தாலா";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "సమోయన్ తాలా";
        ...
        test("has translation for 'to' locale", () {
          const expectedName = "Tala fakahaʻamoa";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ساموئا تالاسى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "самоанська тала";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "ساموآ کا ٹالا";
        ...
        test("has translation for 'ur_IN' locale", () {
          const expectedName = "ساموآئی ٹالا";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Samoa talasi";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Samoan Tala";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "ছামোৱান টালা";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤚𞤢𞤤𞤢 𞤅𞤢𞤥𞤮𞤱𞤢𞤴𞤢𞤲𞤳𞤮";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Tala na ƙasar Samoa";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Tala obodo Samoa";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "talayê somonî";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ସାମୋୟିୟ ତାଲା";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "tala samoana";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Samoa talasy";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "I-Tala yaseSamoa";
