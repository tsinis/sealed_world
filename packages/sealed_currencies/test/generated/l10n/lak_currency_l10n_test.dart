...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Laotian Kip";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Laosiaanse kip";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "laotisk kip";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Laotischer Kip";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ལཱ་ཝོས་ཀྱི་དངུལ་ ཀིཔ";
        ...
        test("has translation for 'es_MX' locale", () {
          const expectedName = "kip laosiano";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Laoseko kipa";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "kip loatien";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Laotiaanske kip";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Kip Làthosach";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "લાઓશિયન કિપ";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "लाओशियन किप";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Լաոսական կիպ";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "kip laotiano";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ლაოსური კიპი";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಲೋಟಿಯನ್ ಕಿಪ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "لَوٹِیَن کِپ";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Laoteschen Kip";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Laoso kipas";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Laosas kips";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ലാവോഷിയൻ കിപ്";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "laotiske kip";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Laotiaanse kip";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਲਾਓਟਿਆਈ ਕਿਪ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "kip laotański";
        ...
        test("has translation for 'pt_PT' locale", () {
          const expectedName = "Kip de Laos";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "kip laoțian";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Лаосский кип";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Kipa e Laosit";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Kip ya Laosi";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "லவோஷியன் கிப்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "లాటియన్ కిప్";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "лаоський кіп";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "لاؤشیائی کِپ";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Laotian Kip";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "লাওচিয়ান কিপ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤑𞤭𞤨𞤵 𞤂𞤢𞤱𞤮𞥅𞤧𞤭𞤴𞤢𞤲𞤳𞤮";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "kip laotian";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Kip Obodo Laos";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଲାଓଟିୟ କିପ୍";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "kip laotianu";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "I-Kip yaseLaos";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Kíììpù Làótì";
