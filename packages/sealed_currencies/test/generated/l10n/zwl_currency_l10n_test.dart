...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Zimbabwean Dollar";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "دولار زمبابوي 2009";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Zimbabve Dolları";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Зимбабвийски долар";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "জিম্বাবুয়ে ডলার (২০০৯)";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "dollar Zimbabwe";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Zimbabvejski dolar";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Зимбабвеански долар";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "dòlar zimbabuès";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "zimbabwský dolar";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Doler Zimbabwe";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "Zimbabwisk dollar";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Simbabwe-Dollar";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "zimbabwega dollar";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Δολάριο Ζιμπάμπουε";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "dólar zimbabuense";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Zimbabwe dollar";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "دلار زیمبابوه (۲۰۰۹)";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Zimbabwen dollari";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "dollar zimbabwéen";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Simbabwaanske dollar";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Dolar Sìombabuthach";
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "zimbabveanski dolar";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Zimbabwei dollár";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Dolar Zimbabwe";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "dollaro zimbabwiano";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ດອນລາ ຊິມບັບເວ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Zimbabvės doleris";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Zimbabves dolārs";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Zimbabwaanse dollar";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Dólar do Zimbábue";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Доллар Зимбабве";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "Zimbabwiansky dolár";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ดอลลาร์ซิมบับเว";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Zimbabve Doları";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "زىمبابۋې دوللىرى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "зімбабвійський долар";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Đồng Đô la Zimbabwe";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "സിംബാബ്‌വേയൻ ഡോളർ";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Zimbabwiese dollar";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "даляр Зімбабвэ";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "dolar zimbabwetarra";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Dólar de Zimbabwe";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Dollar Siombábach";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "ઝિમ્બાબ્વે ડૉલર";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "דולר זימבבואי";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "जिम्बाब्वे डॉलर";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Զիմբաբվեյան դոլար";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Simbabveskur dalur";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ზიმბაბვე დოლარი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Зимбабведегі доллар";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ដុល្លារហ្ស៊ីមបាវ៉េ";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಜಿಂಬಾಬ್ವೆ ಡಾಲರ್";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Зимбабве доллары";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Зимбабвиски долар";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "Замбабив Доллар";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "झिम्बाब्वे डॉलर";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဇင်ဘာဘွေ ဒေါ်လာ";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "जिम्बाब्वे डलर";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਜਿੰਬਾਬਵੇ ਡਾਲਰ";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "සිම්බාබ්වේ ඩොලරය";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Dollar Zimbabve";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "ஜிம்பாப்வே டாலர்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "జింబాబ్వే డాలర్";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "زمبابوے ڈالر";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Zimbabve dollari";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "I-Zimbabwe Dollar";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "dollar dal Simbabwe";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "dòllaru zimbabweanu";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "জিম্বাবুৱেৰ ডলাৰ";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଜିମ୍ବାୱେ ଡଲାର";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "د زیمبابوې ډالر";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Dolyar ng Zimbabwe";
