...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "South African Rand";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Suid-Afrikaanse rand";
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Afrika Anaafo Rand";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የደቡብ አፍሪካ ራንድ";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "راند جنوب أفريقيا";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Cənubi Afrika Randı";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "паўднёваафрыканскі ранд";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Южноафрикански ранд";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "sudafriki Randi";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "দক্ষিণ আফ্রিকান রেন্ড";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "rand Suafrika";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Južnoafrički rand";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Јужно-афрички ранд";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "rand sud-africà";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Къилба-Африкин рэнд";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "jihoafrický rand";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Rand De Affrica";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "sydafrikansk rand";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Südafrikanischer Rand";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "སཱའུཐ་ ཨཕ་རི་ཀ་གི་དངུལ་ རཱནད";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "South Africaga rand";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Ραντ Νότιας Αφρικής";
        ...
        test("has translation for 'es_MX' locale", () {
          const expectedName = "rand sudafricano";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Lõuna-Aafrika rand";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Hegoafrikako randa";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "راند افریقای جنوبی";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Rannda Afrik Bŋ Worgo";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Etelä-Afrikan randi";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Suðurafrika rand";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "rand sud-africain";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Sûd-Afrikaanske rand";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Rand na hAfraice Theas";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Rand Afraga a Deas";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Rand surafricano";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "દક્ષિણ આફ્રિકી રેંડ";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Kuɗin Afirka Ta Kudu";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "ראנד דרום אפריקאי";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "दक्षिण अफ़्रीकी रैंड";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "dél-afrikai rand";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Հարավաֆրիկյան ռանդ";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Rand Afrika Selatan";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "suðurafrískt rand";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "სამხრეთ აფრიკული რანდი";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Randi ya Afrika Kusini";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Оңтүстік Африка рэнді";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "រ៉ង់អាហ្វ្រិកខាងត្បូង";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ದಕ್ಷಿಣ ಆಫ್ರಿಕನ್ ರಾಂಡ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "ساوُتھ افریٖکاہُک رینڈ";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Түштүк Африка ранды";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Südafrikanesche Rand";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Randi ey’eSawusafirika";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Randɛ ya Afríka Súdi";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ເຊົາທ໌ ອາ​ຟຣິ​ກັນ ແຣນດ໌";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Pietų Afrikos Respublikos randas";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Rande wa Afrika wa Mwinshi";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Dienvidāfrikas rends";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Rand afrikanina tatsimo";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Јужноафрикански ранд";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ദക്ഷിണാഫ്രിക്കൻ റാൻഡ്";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "өмнөд африкийн ранд";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "दक्षिण आफ्रिकी रँड";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "တောင်အဖရိက ရန်း";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "sørafrikanske rand";
        ...
        test("has translation for 'nd' locale", () {
          const expectedName = "Randi yase Afrika ye Zanzi";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "दक्षिण अफ्रिकी र्‍यान्ड";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Zuid-Afrikaanse rand";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "sørafrikansk rand";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਦੱਖਣੀ ਅਫਰੀਕੀ ਰੈਂਡ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "rand południowoafrykański";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Rand sul-africano";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "rand sidafrican";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Irandi ryo muri Afurika y’Epfo";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "rand sud-african";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Южноафриканский рэнд";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "rânde tî Mbongo-Afrîka";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "දකුණු අප්‍රිකානු රැන්ඩ්";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "juhoafrický rand";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "južnoafriški rand";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Randi afrikano-jugor";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Јужноафрички ранд";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "தென் ஆப்ரிக்க ராண்ட்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "దక్షిణ ఆఫ్రికా ర్యాండ్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "แรนด์แอฟริกาใต้";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Rand ng Timog Africa";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Güney Afrika Randı";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "جەنۇبىي ئافرىقا راندى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "південноафриканський ранд";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "جنوبی افریقی رانڈ";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Janubiy Afrika rendi";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Rand Nam Phi";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Randi ti Orílẹ́ède Ariwa Afirika";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Randi ti Orílɛ́ède Ariwa Afirika";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-South African Rand";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "দক্ষিণ আফ্ৰিকাৰ ৰাণ্ড";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Кӑнтӑр Африка рэндӗ";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "rand sudafrican";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Rand obodo South Africa";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Rand Afrika Kidul";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "randê afrîkaya başûrî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Rand Āwherika ki te Tonga";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଦକ୍ଷିଣ ଆଫ୍ରିକିୟ ରାଣ୍ଡ୍";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "جنوبي افريقاېي رنډ";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "rand sudafricanu";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Randka Koonfur Afrika";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Günorta Afrika rendi";
