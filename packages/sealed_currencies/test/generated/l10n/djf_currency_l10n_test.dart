...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Djiboutian Franc";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Djiboeti frank";
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Gyebuti Frank";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "فرنك جيبوتي";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Cibuti Frankı";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "джыбуційскі франк";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Джибутски франк";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "jibuti Fraŋ";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "জিবুতি ফ্রাঙ্ক";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "lur Djibouti";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Džibutski franak";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Џибутански франак";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "franc de Djibouti";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Джибутин франк";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "džibutský frank";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Ffranc Djibouti";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "djiboutisk franc";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Dschibuti-Franc";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "dziboutiga franc";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Φράγκο Τζιμπουτί";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "franco yibutiano";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Djibouti frank";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Djibutiko frankoa";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "فرانک جیبوتی";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Faraa Jibutii";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Djiboutin frangi";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Djibuti frankur";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "franc djiboutien";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Djiboutiaanske frank";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Franc Djibouti";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Franc Diobùtaidheach";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Franco xibutiano";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "જિબુટિયન ફ્રેંક";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Kuɗin Jibuti";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "פרנק ג׳יבוטי";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "जिबूती फ़्रैंक";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "dzsibuti frank";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Ջիբութիի ֆրանկ";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Franc Jibuti";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "djíbútískur franki";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "franco di Gibuti";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ჯიბუტის ფრანკი";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Faranga ya Jibuti";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Джибути франкі";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ហ្វ្រង់​ជីប៊ូទី";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಜಿಬೊಟಿಯನ್ ಫ್ರಾಂಕ್";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Жибути франкы";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Dschibuti-Frang";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Faranga ey’eJjibuti";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Falánga ya Dzibuti";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "​ດິ​ບູ​ຈຽນ ຟຣັງ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Džibučio frankas";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Nfalanga wa Dzibuti";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Džibutijas franks";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Farantsa Djibotianina";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Џибути франк";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ദിജിബൗട്ടിയൻ ഫ്രാങ്ക്";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "жибоути франк";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "जिबौटियन फ्रँक";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဂျီဘူတီ ဖရန့်";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "djiboutiske franc";
        ...
        test("has translation for 'nd' locale", () {
          const expectedName = "Fulenki yase Jibhuthi";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "जिबौंटियाली फ्रान्क";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Djiboutiaanse frank";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਜ਼ੀਬੂਤੀਅਨ ਫ੍ਰੈਂਕ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "frank dżibutyjski";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Franco djibutiense";
        ...
        test("has translation for 'pt_PT' locale", () {
          const expectedName = "Franco jibutiano";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "franc dal Dschibuti";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Ifaranga ryo muri Jibuti";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "franc djiboutian";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Франк Джибути";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "farânga tî Dibutïi";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ජිබූති ෆ්‍රෑන්ක්";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "džibutski frank";
        ...
        test("has translation for 'sn' locale", () {
          const expectedName = "Furenki re Jibhuti";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Faran Jabbuuti";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Franga xhibutiane";
        ...
        test("has translation for 'sr_Latn' locale", () {
          const expectedName = "Džibutanski franak";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "ஜிபவ்டியென் ஃப்ராங்க்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "జిబోటియన్ ఫ్రాంక్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ฟรังก์จิบูตี";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Cibuti Frangı";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "جىبۇتى فرانكى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "джибутійський франк";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "جبوتی فرانک";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Jibuti franki";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Faransi ti Orílẹ́ède Dibouti";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Faransi ti Orílɛ́ède Dibouti";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Djiboutian Franc";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "জিবুটি ফ্ৰেংক";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Джибути франкӗ";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "franco djibutian";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Franc obodo Djibouti";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "frankê cîbûtiyî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Franc Tepūti";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଜିବୌଟିୟ ଫ୍ରାଙ୍କ୍";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "جبوتي فرانک";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "francu gibutianu";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Jibuti franky";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "I-Franc yaseDjibouti";
