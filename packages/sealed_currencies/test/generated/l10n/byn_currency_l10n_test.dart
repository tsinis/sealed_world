...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Belarusian Ruble";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Belo-Russiese roebel";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "روبل بيلاروسي";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Belarus Rublu";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "беларускі рубель";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Беларуска рубла";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "বেলারুশিয়ান রুবেল";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "roubl Belarus";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Bjeloruska rublja";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Белоруска рубља";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "ruble bielorús";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Белоруссин сом";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "běloruský rubl";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Rwbl Belarws";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "hviderussisk rubel";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Weißrussischer Rubel";
        ...
        test("has translation for 'de_CH' locale", () {
          const expectedName = "Weissrussischer Rubel";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "belarusiaga ruble";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Ρούβλι Λευκορωσίας";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "rublo bielorruso";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Valgevene rubla";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Bielorrusiako errubloa";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "روبل بیلوروسی";
        ...
        test("has translation for 'fa_AF' locale", () {
          const expectedName = "روبل روسیهٔ سفید";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Valko-Venäjän rupla";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Hvítarussland ruble";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "rouble biélorusse";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Wit-Russyske roebel";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Rúbal na Bealarúise";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Rùbal Bealaruiseach";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "બેલારુશિયન રૂબલ";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "רובל בלרוסי";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "बेलारूसी रूबल";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "fehérorosz rubel";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Բելառուսական ռուբլի";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Rubel Belarusia";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "hvítrússnesk rúbla";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "rublo bielorusso";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ბელორუსული რუბლი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Беларусь рублі";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "រ៉ូបល​បេឡារុស";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಬೆಲಾರುಸಿಯನ್ ರೂಬಲ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "بِلیروشِیَن رِبٕل";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "беларусь рублу";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Wäissrussesche Rubel";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ເບ​ລາ​ຣຸ​ສ​ຊຽນ ຣູ​ເບິນ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Baltarusijos rublis";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Baltkrievijas rubelis";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ബെലാറുഷ്യൻ റൂബിൾ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "беларусь рубль";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "बेलारुशियन रुबल";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Rubel Belarus";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဘီလာရုဇ် ရူဘယ်";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "hviterussiske rubler";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Wit-Russische roebel";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "kviterussisk rubel";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਬੇਲਾਰੂਸੀ ਰੂਬਲ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "rubel białoruski";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Rublo bielorrusso";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "rubel bieloruss";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "rublă belarusă";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Белорусский рубль";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "බෙලරූස් රූබල්";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "bieloruský rubeľ";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "beloruski rubelj";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Rubla bjelloruse";
        ...
        test("has translation for 'sr_Latn' locale", () {
          const expectedName = "Beloruska rublja";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "vitrysk rubel";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Ruble ya Belarusi";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "பெலருசியன் ரூபிள்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "బెలరూసియన్ రూబల్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "รูเบิลเบลารุส";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Beyaz Rusya Rublesi";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "بېلارۇسىيە رۇبلىسى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "білоруський рубль";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "بیلاروسی روبل";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Belarus rubli";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Rúp Belarus";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Belarusian Ruble";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "বেলাৰুছীয় ৰুবেল";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Беларуҫ тенкӗ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤈𞤵𞥅𞤦𞤮𞤤 𞤄𞤫𞤤𞤢𞤪𞤭𞥅𞤧𞤭𞤴𞤢𞤲𞤳𞤮";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Kuɗin Belarus";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "rublo bielorusse";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Ruble mba Belarus";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Ruble Belarusia";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "rûbleyê belarûsî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Ruble Pērara";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ବେଲାରୁସି ରୁବଲ୍";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "بلاروسي روبل";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "rublu bielorussu";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Rubalka Belarus";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Belarus rubly";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Ruble ng Belarus";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "I-Ruble yaseBelarus";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Rọ́bù Bẹ̀lárùùsì";
