...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Eritrean Nakfa";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Eritrese nakfa";
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Ɛretereya Nakfa";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "ناكفا أريتري";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Eritreya Nakfası";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "эрытрэйская накфа";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Еритрейска накфа";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "eritere Nafika";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "এরিট্রিয়েন নাকফা";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "nakfa Eritrea";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Eritrejska nakfa";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Еритреанска накфа";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "nakfa eritreu";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Эритрейн накфа";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "eritrejská nakfa";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "eritreisk nakfa";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Eritreischer Nakfa";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "eritreaga nakfa";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Νάκφα Ερυθραίας";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Eritrea nakfa";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Eritreako nakfa";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "ناکفای اریتره";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Nafka Eriteree";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "nafka érythréen";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Nakfa na hEiritré";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Nakfa Eartrach";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Nakfa eritreo";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "એરિટ્રેયન નક્ફા";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Kuɗin Eritireya";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "נאקפה אריתראי";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "इरीट्रियन नाक्फ़ा";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "eritreai nakfa";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Էրիթրեական նակֆա";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "erítresk nakfa";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ერიტრეის ნაკფა";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Nakfa ya Eritrea";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Эритрея накфасы";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ណាក់ហ្វាអេរីទ្រា";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಎರಿತ್ರಿಯನ್ ನಕ್ಫಾ";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "رِٹریٖن نَفکا";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Эритреа накфасы";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Eritréieschen Nakfa";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Nakifa ey’Eritureya";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Nakfa ya Elitlɛ";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ອິ​ຣິ​ທຣຽນ ແນກ​ຟ​າ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Eritrėjos nakfa";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Nakfa wa Elitle";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Eritrejas nakfa";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Nakfà Eritreanina";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Еритрејска накфа";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "എറിത്രിയൻ നക്ഫ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "эритрей накфа";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "इरिट्रियन नाक्फा";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "အီရီထရီးယား နာ့ခ်ဖာ";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "eritreiske nakfa";
        ...
        test("has translation for 'nd' locale", () {
          const expectedName = "Nakfa yase Eritrea";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "एरिट्रियन नाक्फा";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਇਰੀਟ੍ਰਿਆਈ ਨਾਫ਼ਾ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "nakfa erytrejska";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Nakfa da Eritreia";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "nakfa eritreic";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Irinakufa ryo muri Eritereya";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "nakfa eritreeană";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "nakafa tî Eritrëe";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "එරිත්‍රියානු නැක්ෆා";
        ...
        test("has translation for 'sn' locale", () {
          const expectedName = "Nakfa re Eritrea";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Nakfa e Eritresë";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Eритрејска накфa";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "eritreansk nakfa";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "எரித்ரியன் நக்ஃபா";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "ఎరిట్రీన్ నక్ఫా";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "แนกฟาเอริเทรีย";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Eritre Nakfası";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ئېرىترېيە ناكفاسى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "еритрейська накфа";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "اریٹیریا کا نافکا";
        ...
        test("has translation for 'ur_IN' locale", () {
          const expectedName = "اریٹیریائی ناکفا";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Eritreya nakfasi";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Nakifa ti Orílẹ́ède Eriteriani";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Nakifa ti Orílɛ́ède Eriteriani";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Eritrean Nakfa";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "এৰিট্ৰিয়ন নাক্‌ফা";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Эритрей накфӗ";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "nakfa eritree";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Nakfa obodo Eritrea";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "nakfayê erîtreyî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Nakfa Eriterea";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଏରିଟ୍ରେୟ ନାକଫା";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "ايريټرين نکفا";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "nafka eritreu";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Nakfada Eritriya";
        ...
        test("has translation for 'ti_ER' locale", () {
          const expectedName = "ERN";

          final translated = value.maybeTranslation(
            const BasicLocale(LangTir(), countryCode: "ER"),
            useLanguageFallback: false,
          );
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Eritreýa nakfasy";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "I-Nakfa yase-Eritria";
