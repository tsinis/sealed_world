...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Vanuatu Vatu";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Vanuatuse vatu";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "فاتو فانواتو";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Vanuatu Vatusu";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Вануатско вату";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "ভানুয়াতু ভাতু";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "vatu Vanuatu";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Vanuatski vatu";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Вануатски вату";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "vatu de Vanuatu";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Вануатун вату";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "vanuatský vatu";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "vanuaisk vatu";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "vanuatuga vatu";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Βατού Βανουάτου";
        ...
        test("has translation for 'es_MX' locale", () {
          const expectedName = "vatu vanuatuense";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Vanuatuko vatua";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "واتوی وانوواتو";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Vanuatun vatu";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "vatu vanuatuan";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Vanuatuaanske vatu";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Vatu Vanuatú";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Vatu Vanuatuthach";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Vatu vanuatiano";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "ואטו של ונואטו";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "वनुआतू वातू";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "vanuatui vatu";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Վանուատուի վատու";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "vanúatúskt vatú";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "vatu di Vanuatu";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ვანუატუს ვატუ";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Вануату ватуы";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "វ៉ាទូវ៉ានូអាទូ";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "وَنوٗاَتوٗ وَتوٗ";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Вануату ватусу";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "​ວາ​ນົວ​ຕູ ວາ​ຕູ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Vanuatu vatas";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Ванатски вату";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "വന്വാതു വാതു";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "вануатугийн вату";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "वानुआतु वाटु";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဗနွားတူ ဗားထူ";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "vanuatiske vatu";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "भानुआतू भातु";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Vanuatuaanse vatu";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "vanuatuisk vatu";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਵਾਨੂਆਟੂ ਵਾਟੂ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "vatu wanuackie";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "vatu dal Vanuatu";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "vatu din Vanuatu";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Вату Вануату";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "වනුවාටු වාටු";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "vanuatské vatu";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "vanuatujski vatu";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Vatuja e Vanuatusë";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "vanuatisk vatu";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Vatu ya Vanuatu";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "வனுவாட்டு வாட்டு";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "วาตูวานูอาตู";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ۋانۇئاتۇ ۋاتۇسى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "вануатський вату";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "وینوواتو واتو";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Vanuatu vatusi";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Vanuatu Vatu";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "ভানাটুৰ ভাটু";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Вануату ватуйӗ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤜𞤢𞤼𞤵 𞤜𞤢𞤲𞤵𞤴𞤢𞤲𞤳𞤮";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Vatu da ƙasar Vanuatu";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Vatu obodo Vanuatu";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "vatûyê vanûatûyî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Vatu Whenuatū";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଭାନୁଆଟୁ ଭାଟୁ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "ونواتو واتو";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Fatu Fanuatu";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Wanuatu watusy";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "I-Vatu yaseVanuatu";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Fátù Vanuatu";
