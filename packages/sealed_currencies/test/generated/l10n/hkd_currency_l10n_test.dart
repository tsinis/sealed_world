...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Hong Kong Dollar";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የሆንግኮንግ ዶላር";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "دولار هونغ كونغ";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Honq Konq Dolları";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "ганконгскі долар";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Хонконгски долар";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "dollar Hong Kong";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Honkonški dolar";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Хонгконшки долар";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "dòlar de Hong Kong";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Гонконган доллар";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "hongkongský dolar";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Doler Hong Kong";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "Hongkong dollar";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཧོང་ཀོང་གི་དངུལ་ ཌོ་ལར";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Hong Kongga dollar";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Δολάριο Χονγκ Κονγκ";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "dólar hongkonés";
        ...
        test("has translation for 'es_MX' locale", () {
          const expectedName = "dólar de Hong Kong";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Hongkongi dollar";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Hong Kongeko dolarra";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "دلار هنگ‌کنگ";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Hongkongin dollari";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Hong Kong dollari";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "dollar de Hong Kong";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Hongkongske dollar";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Dollar Hong Cong";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Dolar Hong Kong";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "હોંગ કોંગ ડૉલર";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "דולר הונג קונגי";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "हाँगकाँग डॉलर";
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "hongkonški dolar";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "hongkongi dollár";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Հոնկոնգի դոլար";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Hong Kong-dalur";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "dollaro di Hong Kong";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ჰონკონგის დოლარი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Гонконг доллары";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ដុល្លារ​ហុងកុង";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಹಾಂಗ್ ಕಾಂಗ್ ಡಾಲರ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "حانٛگ کانٛگُک ڑالَر";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ຮອງ​ກົງ ໂດ​ລ່າ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Honkongo doleris";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Honkongas dolārs";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ഹോങ്കോങ്ങ് ഡോളർ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "хонгконг доллар";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဟောင်ကောင် ဒေါ်လာ";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Hongkongse dollar";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਹਾਂਗ ਕਾਂਗ ਡਾਲਰ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "dolar hongkoński";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "dollar da Hongkong";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "dolar din Hong Kong";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Гонконгский доллар";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "හොංකොං ඩොලර්";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "hongkonský dolár";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Dollari i Hong Kongut";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Hongkongdollar";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Dola ya Hong Kong";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "ஹாங்காங் டாலர்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "హాంకాంగ్ డాలర్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ดอลลาร์ฮ่องกง";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Dolyar ng Hong Kong";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Hong Kong Doları";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "شياڭگاڭ دوللىرى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "гонконгський долар";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "ھانگ کانگ ڈالر";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Gonkong dollari";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Đô la Hồng Kông";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Hong Kong Dollar";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "هانگ کانگي ډالر";
