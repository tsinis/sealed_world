...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Macedonian Denar";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Macedoniese denar";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "دينار مقدوني";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Makedoniya Dinarı";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "македонскі дэнар";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Македонски денар";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "ম্যাসেডোনিয়ান দিনার";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "denar Makedonia";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Makedonski denar";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "denar macedoni";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Македонин динар";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "makedonský denár";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Denar Macedonia";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "makedonsk denar";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Mazedonischer Denar";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "makedoniaga denar";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Δηνάριο ΠΓΔΜ";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "dinar macedonio";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Makedoonia dinaar";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Mazedoniako dinarra";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "دینار مقدونیه";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Makedonian denaari";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Makedónia denar";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "denar macédonien";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Macedonyske denar";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Denar na Macadóine";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Denar Masadonach";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "મેસેડોનિયન દિનાર";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "דינר מקדוני";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "मैसीडोनियन दिनार";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "macedon dínár";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Մակեդոնյան դենար";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "makedónskur denari";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "denar macedone";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "მაკედონიური დინარი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Македония динары";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ឌីណាម៉ាសេដូនី";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಮೆಸಡೋನಿಯನ್ ದಿನಾರ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "مٮ۪کَڑونِیَن دیٖنار";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "македон денары";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Mazedoneschen Denar";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ແມັກ​ເຊ​ໂດ​ນຽນ ເດ​ນາ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Makedonijos denaras";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Maķedonijas denārs";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "മാസിഡോണിയൻ ദിനാർ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "македони динар";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "मॅसेडोनियन देनार";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "မက်စီဒိုးနီးယား ဒီနာ";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "makedonske denarer";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "म्यासेडोनियाली डेनार";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Macedonische denar";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਮੈਕਡੋਨੀਆਈ ਡੇਨਾਰ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "denar macedoński";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Dinar macedônio";
        ...
        test("has translation for 'pt_PT' locale", () {
          const expectedName = "Dinar macedónio";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "dinar da la Macedonia";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "dinar macedonean";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Македонский денар";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "මැසඩෝනියානු ඩිනාර්";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "macedónsky denár";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Denari maqedonas";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "makedonisk denar";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Denar ya Masedonia";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "மாசிடோனியன் டேனார்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "మెసిడోనియన్ దినార్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ดีนาร์มาซิโดเนีย";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Makedonya Dinarı";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ماكېدونىيە دىنارى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "македонський денар";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "مقدونیائی دینار";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Makedoniya dinori";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Macedonian Denar";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "মেচিডোনীয় ডেনাৰ";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Македони денарӗ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤁𞤭𞤲𞤢𞥄𞤪 𞤃𞤢𞤧𞤫𞤣𞤮𞤲𞤭𞤲𞤳𞤮";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Dinarin Macedonia";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "denar macedonie";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Denar Obodo Macedonia";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Denar Masedonia";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "dînarê makedonî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Denar Makerōnia";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ମାସେଡୋନୀୟ ଡିନର୍";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "مسيډونايي دينار";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "denar matzèdone";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Denaarka Masedoniya";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Makedon dinary";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Denar ng Macedonia";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Dẹ́nà Masidóníà";
