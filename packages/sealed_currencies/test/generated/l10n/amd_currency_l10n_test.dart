...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Armenian Dram";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Armeense dram";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "درام أرميني";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Ermənistan Dramı";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "армянскі драм";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Арменски драм";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "আরমেনিয়ান দ্রাম";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "dram Armenia";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Armenski dram";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Јерменски драм";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "dram armeni";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Эрмалойчоьнан драм";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "arménský dram";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "armensk dram";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Armenischer Dram";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "armeniaga dram";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Ντραμ Αρμενίας";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Armeenia dramm";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Armeniako drama";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "درام ارمنستان";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Armenia dram";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "dram arménien";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Dram na hAirméine";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Dram Airmeineach";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Dram armenio";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "અર્મેનિયન ડ્રેમ";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "आर्मेनियाई द्राम";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "örmény dram";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Հայկական դրամ";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "armenskt dramm";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "dram armeno";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "სომხური დრამი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Армения драмы";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ដ្រាំ​អាមេនី";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಅರ್ಮೆನಿಯನ್ ಡ್ರಾಮ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "اَرمانٮ۪ن ڈرٛٮ۪م";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Armeneschen Dram";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ອາ​ເມ​ນຽນ ແດຣມ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Armėnijos dramas";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Armēnijas drams";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Ермениски Драм";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "അർമേനിയൻ ഡ്രാം";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "арменийн драм";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "आर्मेनियन द्रॅम";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "အာမေးနီးယားဒရမ်း";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "armenske dram";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "आर्मेनियाली ड्राम";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਅਰਮੀਨੀਆਈ ਦਰਮ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "dram armeński";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Dram armênio";
        ...
        test("has translation for 'pt_PT' locale", () {
          const expectedName = "Dram arménio";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "dram armenesc";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Армянский драм";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ආර්මේනියානු ඩ්‍රෑම්";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "arménsky dram";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Dramia armene";
        ...
        test("has translation for 'sr_Latn' locale", () {
          const expectedName = "Jermenski dram";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "armenisk dram";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Dram ya Armenia";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "ஆர்மேனியன் ட்ராம்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "అమెరికన్ డ్రామ్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "แดรมอาร์เมเนีย";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Ermenistan Dramı";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ئەرمېنىيە دىرامى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "вірменський драм";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "آرمینیائی ڈرم";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Armaniston drami";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Armenian Dram";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "আৰ্মেনিয়ান ড্ৰাম";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Армяни драмӗ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤁𞤢𞤪𞤢𞤥𞤵 𞤀𞤪𞤥𞤢𞤲𞤭𞤴𞤢𞤲𞤳𞤮";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Kuɗin Armenia";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "dram armenie";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Dram obodo Armenia";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "dramê ermenî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Dram Āmenia";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଅର୍ମେନୀୟ ଡ୍ରାମ୍";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "ارمينيايي ډرام";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "dram armenu";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Daraamka Armeniya";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Ermeni dramy";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "I-Dram yase Armenia";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Dírààmù Àmẹ́níà";
