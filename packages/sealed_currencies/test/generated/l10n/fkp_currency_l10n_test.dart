...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Falkland Islands Pound";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Falkland-eilande pond";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የፎክላንድ ደሴቶች ፓውንድ";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "جنيه جزر فوكلاند";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Folklend Adaları Funtu";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "фунт Фалклендскіх астравоў";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Фолклендска лира";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "ফকল্যান্ড দ্বীপপুঞ্জ পাউন্ড";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "lur Inizi Falkland";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Folklandska funta";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Фокландска острва фунта";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "lliura de les illes Malvines";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Фолклендан гӀайренийн фунт";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "falklandská libra";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Punt Ynysoedd Falkland/Malvinas";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "pund fra Falklandsøerne";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Falkland-Pfund";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "falklanɖ ƒudomekpo dukɔwo ƒe ga pound";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Λίρα Νησιών Φώκλαντ";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "libra malvinense";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Falklandi saarte nael";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Falkland uharteetako libera";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "پوند جزایر فالکلند";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Falklandinsaarten punta";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Falklandsoyggjar pund";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "livre des îles Malouines";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Falklâneilânske pûn";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Punt Oileáin Fháclainne";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Punnd Fàclannach";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Libra das Malvinas";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "ફૉકલેન્ડ આઇલેંડ્સ પાઉન્ડ";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "לירה של איי פוקלנד";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "फ़ॉकलैंड द्वीपसमूह पाउंड";
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "falklandska funta";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "falkland-szigeteki font";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Ֆոլքլենդյան կղզիների ֆունտ";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Pound Kepulauan Falkland";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "falklenskt pund";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "sterlina delle Falkland";
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "フォークランド（マルビナス）諸島 ポンド";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ფოლკლენდის კუნძულების ფუნტი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Фолкленд аралдарының фунты";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ផោន​កោះ​ហ្វក់ឡែន";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಫಾಲ್ಕ್‌ಲ್ಯಾಂಡ್ ದ್ವೀಪಗಳ ಪೌಂಡ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "فیکلینٛڑِس آیلینٛڑ پونٛڑ";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "фолкленд аралдарынын фунту";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Falkland-Pond";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ຟອ​ລ໌ກ​ແລນ ໄອ​ແລນ​ສ໌ ພາວ​ດ໌";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Falklando salų svaras";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Folklenda Salu mārciņa";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Фолкландска фунта";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ഫാക്ക്‌ലാന്റ് ദ്വീപുകളുടെ പൗണ്ട്";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "фолклэнд арлын паунд";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "फॉकलंड आयलंड पाउंड";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Paun Kepulauan Falkland";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဖော့ကလန်ကျွန်းစု ပေါင်";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "falklandspund";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "फक्‌ल्याण्ड टापुहरूका पाउन्ड";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Falklandeilands pond";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "Falkland-pund";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਫ਼ਾਕਲੈਂਡ ਆਈਲੈਂਡਸ ਪੌਂਡ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "funt falklandzki";
        ...
        test("has translation for 'pt_PT' locale", () {
          const expectedName = "Libra das Ilhas Falkland";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "glivra dal Falkland";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "liră din Insulele Falkland";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Фунт Фолклендских островов";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ෆෝක්ලන්ඩ් දූපත් පවුම්";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "falklandski funt";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Stërlina e Ishujve Falkland";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Фокландска фунта";
        ...
        test("has translation for 'sr_Latn' locale", () {
          const expectedName = "Foklandska funta";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Pauni ya Visiwa vya Falkland";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "ஃபாக்லாந்து தீவுகள் பவுண்டு";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "ఫాక్‌ల్యాండ్ దీవులు పౌండ్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ปอนด์หมู่เกาะฟอล์กแลนด์";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Pound ng Falkland Islands";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Falkland Adaları Lirası";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "فالكلاند ئاراللىرى فوند سىتېرلىڭى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "фунт Фолклендських островів";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "فاکلینڈ آئلینڈز پونڈ";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Folklend orollari funti";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Фолькленд ороли фунти";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Bảng Quần đảo Falkland";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Falkland Islands Pound";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "ফকলেণ্ড দ্বীপপুঞ্জৰ পাউণ্ড";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Факланд утравӗсен фунчӗ";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Fam na ƙasar Tsibirai na Falkland";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "libra falklandese";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Pound obodo Falkland Islands";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Pound Kepuloan Falkland";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "paundê giravên falklandê";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Pāuna Whākana";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଫକଲ୍ୟାଣ୍ଡ୍ ଦ୍ଵୀପପୁଞ୍ଜ ପାଉଣ୍ଡ୍";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "پاکلېنډ ټاپوګانو پونډ";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "isterlina de sas ìsulas Falklands";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Bowndka Faalklaan Aylaanis";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Folklend adalarynyň funty";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "Iponti yaseFalkland Islands";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Pọ́n-ùn Erékùsù Falkland";
