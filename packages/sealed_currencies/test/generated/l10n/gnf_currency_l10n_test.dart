...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Guinean Franc";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Guinese frank";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Qvineya Frankı";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "гвінейскі франк";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Гвинейски франк";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "গিনি ফ্রাঙ্ক";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Gvinejski franak";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Гвинејски франак";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "franc guineà";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Гвинейн франк";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "guinejský frank";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Ffranc Guinée";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "guineansk franc";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Guinea-Franc";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "giniga franc";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Φράγκο Γουινέας";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "franco guineano";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Guinea frank";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Gineako frankoa";
        ...
        test("has translation for 'ff_GN' locale", () {
          const expectedName = "GNF";

          final translated = value.maybeTranslation(
            const BasicLocale(LangFul(), countryCode: "GN"),
            useLanguageFallback: false,
          );
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Guinean frangi";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Guinea frankur";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "franc guinéen";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Guinese franc";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Franc na Guine";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Franc Ginitheach";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "ગિનીયન ફ્રેંક";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "गिनीयन फ़्रैंक";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "guineai frank";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Գվինեական ֆրանկ";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Franc Guinea";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Gíneufranki";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "franco della Guinea";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "გვინეური ფრანკი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Гвинея франкі";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ហ្វ្រង់​ហ្គីណេ";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಗಿನಿಯನ್ ಫ್ರಾಂಕ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "گِنِیَن فرٛینٛک";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Гине франкы";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Guinea-Frang";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ກິ​ນຽນ ຟຣັງ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Gvinėjos frankas";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Gvinejas franks";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Гвинејски франк";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ഗിനിയൻ ഫ്രാങ്ക്";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "гвиней франк";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဂီးနီ ဖရန့်";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "guineanske franc";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "गिनियाली फ्रान्क";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਗਿਨੀ ਫ੍ਰੈਂਕ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "frank gwinejski";
        ...
        test("has translation for 'pt_PT' locale", () {
          const expectedName = "Franco guineense";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "franc da la Guinea";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "franc guineean";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Гвинейский франк";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ගිනියානු ෆ්රෑන්ක්";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "gvinejski frank";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Franga guinease";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Faranga ya Guinea";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "கினியன் ஃப்ராங்க்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "గ్వినియన్ ఫ్రాంక్";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Gine Frangı";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "گىۋىنېيە فرانكى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "гвінейський франк";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Gvineya franki";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Gunean Franc";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "গিনি ফ্ৰেংক";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Гвиней франкӗ";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Kuɗin Guinea";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "franco guinean";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Franc obodo Guinea";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "frankê gîneyî";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଗୁଇନେୟ ଫ୍ରାଙ୍କ୍";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "francu guineanu";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Faranka Gini";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Gwineý franky";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "I-Franc yaseGuinea";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Fírànkì Gínì";
