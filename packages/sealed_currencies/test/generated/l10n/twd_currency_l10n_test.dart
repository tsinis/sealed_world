...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "New Taiwan Dollar";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Nuwe Taiwanese dollar";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የአዲሷ ታይዋን ዶላር";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "دولار تايواني";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Tayvan Yeni Dolları";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "новы тайваньскі долар";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Тайвански долар";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "নতুন তাইওয়ান ডলার";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "dollar nevez Taiwan";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Novi tajvanski dolar";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Нови тајвански долар";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "nou dòlar de Taiwan";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Тайванан керла доллар";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "tchajwanský dolar";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Doler Newydd Taiwan";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "ny taiwansk dollar";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Neuer Taiwan-Dollar";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཊཱའི་ཝཱན་གི་དངུལ ཌོ་ལར";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "Taiwanga dollar";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Νέο δολάριο Ταϊβάν";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "nuevo dólar taiwanés";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Taiwani dollar";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Taiwango dolar berria";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "دلار جدید تایوان";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Taiwanin uusi dollari";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Taivan new dollari";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "nouveau dollar taïwanais";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Nije Taiwanese dollar";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Dollar Nua na Téaváine";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Dolar ùr Taidh-Bhànach";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Novo dólar taiwanés";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "ન્યુ તાઇવાન ડૉલર";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "דולר טייוואני חדש";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "नया ताईवानी डॉलर";
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "novotajvanski dolar";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "tajvani új dollár";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Թայվանական նոր դոլար";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Dolar Baru Taiwan";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "taívanskur dalur";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "nuovo dollaro taiwanese";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ტაივანური ახალი დოლარი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Жаңа Тайван доллары";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ដុល្លារ​តៃវ៉ាន់";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ನ್ಯೂ ತೈವಾನ್ ಡಾಲರ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "نوٚو تیوانُک ڈالَر";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Тайвань жаӊы доллары";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Neien Taiwan-Dollar";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ນິວ ໄຕ້​ຫວັນ ໂດ​ລ່າ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Taivano naujasis doleris";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Taivānas jaunais dolārs";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Тајвански нов долар";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ന്യൂ തായ്‌വാൻ ഡോളർ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "шинэ тайвань доллар";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "न्यू तैवान डॉलर";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Dolar Taiwan Baru";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ထိုင်ဝမ် ဒေါ်လာအသစ်";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "nye taiwanske dollar";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "नयाँ ताइवान डलर";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Nieuwe Taiwanese dollar";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "taiwansk ny dollar";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਨਵਾਂ ਤਾਇਵਾਨ ਡਾਲਰ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "nowy dolar tajwański";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Novo dólar taiwanês";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "nov dollar taiwanais";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "dolar nou din Taiwan";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Новый тайваньский доллар";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "නව තායිවාන ඩොලර්";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "nový taiwanský dolár";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Dollari tajvanez";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Taiwandollar";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Dola ya Taiwan";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "புதிய தைவான் டாலர்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "క్రొత్త తైవాన్ డాలర్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ดอลลาร์ไต้หวันใหม่";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Dolyar ng New Taiwan";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Yeni Tayvan Doları";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "يېڭى تەيۋەن دوللىرى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "новий тайванський долар";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "نیو تائیوان ڈالر";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Yangi Tayvan dollari";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Đô la Đài Loan mới";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-New Taiwan Dollar";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "নিউ টাইৱান ডলাৰ";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ନୂଆ ତାଇୱାନ ଡଲାର";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "تايواني نوي ډالر";
