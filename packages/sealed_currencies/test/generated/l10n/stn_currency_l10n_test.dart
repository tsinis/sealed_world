...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "São Tomé & Príncipe Dobra";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "São Tomé en Príncipe dobra";
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Sao Tome ne Principe Dobra";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የሳኦ ቶመ እና ፕሪንሲፐ ዶብራ";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "دوبرا ساو تومي وبرينسيبي";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "San Tom və Prinsip Dobrası";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "добра Сан-Тамэ і Прынсіпі";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Добра на Сао Томе и Принсипи";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "sawotome Dobra";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "সাও টোমে এবং প্রিন্সিপে ডোবরা";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "dobra São Tomé ha Príncipe";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Dobra Sao Toma i Principa";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Сао Томе и Принципе добра";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "dobra de São Tomé i Príncipe";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Сан-Томен а, Принсипин а добра";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "svatotomášská dobra";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Dobra São Tomé a Príncipe";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "dobra fra Sao Tome og Principe";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "São-toméischer Dobra";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "são tomé kple príncipega dobra";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Ντόμπρα Σάο Τομέ και Πρίνσιπε";
        ...
        test("has translation for 'es_MX' locale", () {
          const expectedName = "dobra de Santo Tomé y Príncipe";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "São Tomé ja Príncipe dobra";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Sao Tomeko eta Principeko dobra";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "دوبرای سائوتومه و پرنسیپ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Dobra Sawo Tome e Prensipe";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "São Tomén ja Príncipen dobra";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Sao Tome & Prinsipi dobra";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "dobra santoméen";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Santomese dobra";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Dobra São Tomé agus Príncipe";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Dobra de São Tomé e Príncipe";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "સાઓ ટૉમ એન્ડ પ્રિંસાઇપ ડોબ્રા";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Kuɗin Sawo Tome da Paransip";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "דוברה של סן טומה ופרינסיפה";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "साओ तोम और प्रिंसिपे डोबरा";
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "dobra Svetog Tome i Principa";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "São Tomé és Príncipe-i dobra";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Սան Տոմե և Փրինսիպիի դոբրա";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Dobra Sao Tome dan Principe";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Saó Tóme og Prinsípe-dóbra";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "dobra di Sao Tomé e Principe";
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "サントメ・プリンシペ ドブラ";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "სან-ტომე და პრინსიპის დობრა";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Dobra ya Sao Tome na Principe";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Сант-Томе мен Принсипи добрасы";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ឌូប្រា​សៅតូម៉េ និងប្រាំងស៊ីប";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಸಾವೊ ಟೋಮ್ ಮತ್ತು ಪ್ರಿನ್ಸಿಪ್ ದೊಬ್ರಾ";
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "상투메 프린시페 도브라";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Сао Томе жана Принсипе добрасы";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "São-toméeschen Dobra";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Dobura ey’eSantome ne Purincipe";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Dobra ya Sao Tomé mpé Presipe";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ເຊົາ ໂທ​ເມ ແອນ ພ​ຣິນ​ຊິ​ປີ ໂດບຣາ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "San Tomės ir Principės dobra";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Dobra wa Sao Tome ne Presipe";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Santome un Prinsipi dobra";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Добра на Сао Томе и Принсипе";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "സാവോ ടോമി ആൻഡ് പ്രിൻസിപെ ഡോബ്ര";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "сан-томе ба принсипи добра";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "साओ टोम आणि प्रिन्सिपे डोबरा";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဆောင်တူမေးနှင့် ပရင်စီပီ ဒိုဘရာ";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "São Tomé og Príncipe-dobra";
        ...
        test("has translation for 'nd' locale", () {
          const expectedName = "Dobra yase Sao Tome lo Principe";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "साओ टोम र प्रिन्सिप डोब्रा";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "Sao Tome og Principe-dobra";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਸਾਉ ਟੋਮੀ ਐਂਡ ਪ੍ਰਿੰਸਪੀ ਡੋਬਰਾ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "dobra Wysp Świętego Tomasza i Książęcej";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "dobra da São Tomé e Principe";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Idobura ryo muri Sawotome na Perensipe";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "dobra Sao Tome și Principe";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Добра Сан-Томе и Принсипи";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "dôbra tî Sâô Tomë na Prinsîpe";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "සාඕ තෝම් සහ ප්‍රින්සිප් දොබ්‍රා";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "svätotomášska dobra";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "saotomejska dobra";
        ...
        test("has translation for 'sn' locale", () {
          const expectedName = "Dobra re Sao Tome ne Principe";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Dobra e Sao-Tomes dhe Prinsipes";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Саотомска добра";
        ...
        test("has translation for 'sr_Latn' locale", () {
          const expectedName = "Saotomska dobra";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "saotomeansk dobra";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "சாவ் டோமி மற்றும் பிரின்ஸ்பி டோப்ரா";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "సావో టోమ్ మరియు ప్రిన్సిపి డోబ్రా";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ดอบราเซาตูเมและปรินซิปี";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "São Tomé ve Príncipe Dobrası";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "سان-تومې ۋە پىرىنسىپى دوبراسى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "добра Сан-Томе і Принсіпі";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "ساؤ ٹوم اور پرنسپے ڈوبرا";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "San-Tome va Prinsipi dobrasi";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Dobra São Tomé và Príncipe";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Dobira ti Orílẹ́ède Sao tome Ati Pirisipe";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Dobira ti Orílɛ́ède Sao tome Ati Pirisipe";
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "圣多美和普林西比多布拉";
        ...
        test("has translation for 'zh_HK' locale", () {
          const expectedName = "聖多美和普林西比多布拉";
        ...
        test("has translation for 'zh_Hant' locale", () {
          const expectedName = "聖多美島和普林西比島多布拉";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-São Tomé kanye ne-Príncipe Dobra";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "চাও টোমে আৰু প্ৰিনচিপে ডোব্‌ৰা";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Сан-Томе тата Принсипи добрӗ";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Dobra nke obodo Sāo Tomé na Principe";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Dobra Sao Tome lan Principe";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "dobrayê sao tome û principeyî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Dobra Hao Tome me Pirinihipi";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ସାଓ ତୋମେ & ପ୍ରିସିପ୍ ଡୋବ୍ରା";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "ساو ټوم او پرينسپي ډوبرا";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Dobra Sao Tome & Birinsibi";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "San-Tome we Prinsipi dobrasy";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "I-Dobra yaseSão Tomé & Príncipe";
