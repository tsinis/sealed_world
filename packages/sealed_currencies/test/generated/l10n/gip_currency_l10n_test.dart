...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Gibraltar Pound";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Gibraltarese pond";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "ጂብራልተር ፓውንድ";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "جنيه جبل طارق";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Gibraltar Funtu";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "гібралтарскі фунт";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Гибралтарска лира";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "জিব্রাল্টার পাউন্ড";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "lur Jibraltar";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Gibraltarska funta";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Гибралташка фунта";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "lliura de Gibraltar";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Гибралтаран фунт";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "gibraltarská libra";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Punt Gibraltar";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "gibraltarisk pund";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Gibraltar-Pfund";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "gilbrataga pound";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Λίρα Γιβραλτάρ";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "libra gibraltareña";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Gibraltari nael";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Gibraltarreko libera";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "پوند جبل‌الطارق";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Gibraltarin punta";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Gibraltar pund";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "livre de Gibraltar";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Gibraltarees pûn";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Punt Ghiobráltar";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Punnd Diobraltarach";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "libra xibraltareña";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "જીબ્રાલ્ટર પાઉન્ડ";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "פאונד גיברלטר";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "जिब्राल्टर पाउंड";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "gibraltári font";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Ջիբրալթարի ֆունտ";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Pound Gibraltar";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Gíbraltarspund";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "sterlina di Gibilterra";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "გიბრალტარული ფუნტი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Гибралтар фунты";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ផោន​ហ្ស៊ីប្រាល់តា";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಗಿಬ್ರಾಲ್ಟರ್ ಪೌಂಡ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "گِبریلٹَر پَاونٛڑ";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "гибралтар фунту";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Gibraltar-Pond";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ກິບ​ຣາ​ທາ ພາ​ວດ໌";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Gibraltaro svaras";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Gibraltāra mārciņa";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Гибралтарска фунта";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ജിബ്രാൾട്ടർ പൗണ്ട്";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "гибралтар паунд";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Paun Gibraltar";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဂျီဘရော်လ်တာ ပေါင်";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "gibraltarske pund";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "जिब्राल्टर पाउण्ड";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Gibraltarees pond";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "gibraltarsk pund";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਜਿਬਰਾਲਟਰ ਪੌਂਡ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "funt gibraltarski";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Libra de Gibraltar";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "glivra da Gibraltar";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "liră din Gibraltar";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Гибралтарский фунт";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ජිබ්‍රෝල්ටා පවුම්";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "gibraltárska libra";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "gibraltarski funt";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Sterlina e Gjibraltarit";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "gibraltiskt pund";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Pauni ya Gibraltar";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "ஜிப்ரால்டர் பவுண்டு";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "జిబ్రల్‌టూర్ పౌండ్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ปอนด์ยิบรอลตาร์";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Cebelitarık Lirası";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "جەبىلتارىق فوند سىتېرلىڭى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "гібралтарський фунт";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "جبل الطارق پونڈ";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Gibraltar funti";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Bảng Gibraltar";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Gibraltar Pound";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "জিব্ৰাল্টৰ পাউণ্ড";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Гибралтар фунчӗ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤆𞤢𞤱𞤲𞥋𞤣𞤵 𞤔𞤭𞤤𞤦𞤪𞤢𞤤𞤼𞤢𞤪";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Kuɗin Gibraltal";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Pound obodo Gibraltar";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "poundê gîbraltarê";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Pāuna Kāmaka";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଗିବ୍ରାଲଟର୍ ପାଉଣ୍ଡ୍";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "جبل الطارقي پونډ";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "isterlina de Gibilterra";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Bowndka Gibraltar";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Gibraltar funty";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Pound ng Gibraltar";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "IPonti yaseGilbraltar";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Pọ́n-ùn Gibúrátà";
