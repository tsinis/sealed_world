...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Qatari Rial";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Katarrese rial";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Qatar Rialı";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "катарскі рыал";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Катарски риал";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "কাতার রিয়্যাল";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Katarski rijal";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Катаршки ријал";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "rial de Qatar";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Катаран риал";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "katarský rijál";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "qatarsk rial";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Katar-Riyal";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཀ་ཊར་གྱི་དངུལ་ རི་ཨཱལ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "katarga rial";
        ...
        test("has translation for 'en_AU' locale", () {
          const expectedName = "Qatari Riyal";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "rial catarí";
        ...
        test("has translation for 'es_MX' locale", () {
          const expectedName = "riyal de Qatar";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Katari riaal";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Qatarreko riala";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Qatarin rial";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "rial qatari";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Katarese rial";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Riyal Chatar";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Rial Catarach";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Rial qatarí";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "કતારી રિયાલ";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "क़तरी रियाल";
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "katarski rial";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "katari rial";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Կատարի ռիալ";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "katarskt ríal";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "rial qatariano";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "კატარის რიალი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Катар риалы";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಖತಾರಿ ರಿಯಲ್";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "قطاری رِیال";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ຄາ​ຕາ​ຣິ ຣຽວ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Kataro rialas";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Kataras riāls";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ഖത്തർ റിയാൽ";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "कतारी रियाल";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ကာတာရီအော်လ်";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "qatarske rialer";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Qatarese rial";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "rial katarski";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Rial catariano";
        ...
        test("has translation for 'pt_PT' locale", () {
          const expectedName = "Rial do Catar";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "riyal da Katar";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "rial qatarian";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Катарский риал";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "කටාර් රියාල්";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "katarský rial";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Riali i Katarit";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Катарски ријал";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "qatarisk rial";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Rial ya Qatari";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "கத்தாரி ரியால்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "క్వాటరి రీయల్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "เรียลกาตาร์";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Katar Riyali";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "قاتار رىيالى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "катарський ріал";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Qatar riyoli";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Qatari Rial";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "কাটাৰি ৰিয়েল";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Катар риалӗ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤈𞤭𞤴𞤢𞥄𞤤 𞤗𞤢𞤼𞤢𞤪𞤭𞤴𞤢𞤲𞤳𞤮";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Riyal ɗin Qatar";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Rial obodo Qatar";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "riyalê qeterî";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "କ୍ଵାତାରି ରିଆଲ୍";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "rial catarianu";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Riyaalka Qatar";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Katar rialy";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "I-Riyal yaseQatar";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Ráyò Kàtárì";
