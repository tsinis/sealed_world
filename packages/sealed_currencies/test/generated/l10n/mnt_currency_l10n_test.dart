...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Mongolian Tugrik";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Mongoolse toegrik";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የሞንጎሊያን ቱግሪክ";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "توغروغ منغولي";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Monqoliya Tuqriki";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "мангольскі тугрык";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Монголски тугрик";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "মঙ্গোলিয়ান তুগরিক";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "tugrik Mongolia";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Mongolski tugrik";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "tögrög mongol";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Монголин тугрик";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "mongolský tugrik";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "mongolsk tugrik";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Mongolischer Tögrög";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "སོག་པོའི་དངུལ་ ཏུ་གྲིཀ";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "mongoliaga tugrik";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Τουγκρίκ Μογγολίας";
        ...
        test("has translation for 'es_MX' locale", () {
          const expectedName = "tugrik mongol";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Mongoolia tugrik";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Mongoliako tugrika";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "توگریک مغولستان";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Mongolia tugrik";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Mongoalske tugrik";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Tugrik na Mongóile";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Tugrik Mongolach";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "મોંગોલિયન ટગરિક";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "טוגרוג מונגולי";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "मंगोलियाई टगरिक";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "mongóliai tugrik";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Մոնղոլական տուգրիկ";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "mongólskur túríkur";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "tugrik mongolo";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "მონღოლური ტუგრიკი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Моңғолия тугригі";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ទូរីក​ម៉ុងហ្គោលី";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಮಂಗೋಲಿಯಾದ ತುಗ್ರಿಕ್‌‌";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "مۄنگولِیَن ٹُگرِک";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Монгол тугриги";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Mongoleschen Tögrög";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ມອງ​ໂກ​ລຽນ ຕູກຣິກ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Mongolijos tugrikas";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Mongolijas tugriks";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Монголиски тугрик";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "മംഗോളിയൻ തുഗ്രിക്";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "मंगोलियन टुग्रिक";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "မွန်ဂိုးလီးယားထူးဂရခ်";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "mongolske tugrik";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "मङ्गोलियाली टुग्रिक";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Mongoolse tugrik";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਮੰਗੋਲੀਆਈ ਤੁਗਰਿਕ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "tugrik mongolski";
        ...
        test("has translation for 'pt_PT' locale", () {
          const expectedName = "Tugrik da Mongólia";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "tugrik mongolic";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Монгольский тугрик";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "මොන්ගෝලියානු ටග්‍රික්";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Tugrika mongole";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "mongolisk tögrög";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Tugrik ya Mongolia";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "மங்கோலியன் டுக்ரிக்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "మంగోలియన్ టుగ్రిక్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ทูกริกมองโกเลีย";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Moğolistan Tugriki";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "موڭغۇلىيە تۈگرىكى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "монгольський тугрик";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "منگولیائی ٹگرِ";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Mongoliya tugriki";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Tugrik Mông Cổ";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Mongolian Tugrik";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "মঙ্গোলিয়ান টুৰ্গিক";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Монголи тугрикӗ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤚𞤵𞤺𞤵𞤪𞤭𞤳𞤵 𞤃𞤮𞤲𞤺𞤮𞤤𞤭𞤴𞤢𞤲𞤳𞤮";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Tugrik na Mongolia";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Turgik Obodo Mongolia";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "togrokê moxolî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "tugrik Mongōria";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ମଙ୍ଗୋଲିୟ ତୁଗ୍ରିକ୍";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "منګوليايي توګريک";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "tugrik mòngolu";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Tugrikta Mongoliya";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Mongol tugrigi";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "I-Tugrik yaseMongolia";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Túgúrììkì Mòǹgólíà";
