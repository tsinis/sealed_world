...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Netherlands Antillean Guilder";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Nederlands-Antilliaanse gulde";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "ኔዘርላንድስ አንቲሊአን ጊልደር";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "غيلدر أنتيلي هولندي";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Niderland Antilyası Gilderi";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "нідэрландскі антыльскі гульдэн";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Антилски гулден";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "নেদারল্যান্ড এ্যান্টিলিয়ান গুল্ডের";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "florin Antilhez nederlandat";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Holandskoantilski gulden";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Холандски антили гилдер";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "florí de les Antilles Neerlandeses";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Нидерландин Антилин гульден";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "nizozemskoantilský gulden";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Guilder Antilles yr Iseldiroedd";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "Nederlandske Antiller-gylden";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Niederländische-Antillen-Gulden";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "nedalands antilleaga guilder";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Γκίλντα Ολλανδικών Αντιλλών";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "florín de las Antillas Neerlandesas";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Hollandi Antillide kulden";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Holandarren Antilletako guilderra";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "گیلدر آنتیل هلند";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Alankomaiden Antillien guldeni";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Niðurlonds Karibia gyllin";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "florin antillais";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Nederlânsk-Antilliaanske gûne";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Gildear Aintillí na hÍsiltíre";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Gulden Eileanan Aintilia nan Tìrean Ìsle";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Florín das Antillas Neerlandesas";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "નેધરલેંડ એંટિલિન ગિલ્ડર";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "גילדר של האנטילים ההולנדיים";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "नीदरलैंड एंटीलियन गिल्डर";
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "nizozemskoantilski gulden";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "holland antilláki forint";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Նիդեռլանդական անտիլյան գուլդեն";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Guilder Antilla Belanda";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "hollenskt Antillugyllini";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "fiorino delle Antille olandesi";
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "オランダ領アンティル ギルダー";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ნიდერლანდების ანტილების გულდენი";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Нидерланд антиль гульдені";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ហ្គីឌិន​ហុល្លង់​អង់ទីលៀន";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ನೆದರ್ಲೆಂಡ್ಸ್ ಆಂಟಿಲಿಯನ್ ಗಿಲ್ಡರ್";
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "네덜란드령 안틸레스 길더";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "نایدَرلینٛڑ اٮ۪نٹٕلیٖیَن گِلڑَر";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "нидерланд-антил гулдени";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Antillen-Gulden";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ເນ​ເທີ​ແລນ ແອນ​ຕິ​ລຽນ ກິວ​ເດີ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Olandijos Antilų guldenas";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Nīderlandes Antiļu guldenis";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Холандски антилски гилдер";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "നെതർലാൻഡ്‌സ് ആന്റിലൻ ഗിൽഡർ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "нидерландын антиллъя гулдер";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "नेदरलँडचा अँटिलीन गिल्डर";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Guilder Antillean Netherland";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "နယ်သာလန် အန်တီလန် ဂင်းဒါး";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "nederlandske antillegylden";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "नेदरल्याण्ड्स एन्टिलियन गिल्डर";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Nederlands-Antilliaanse gulden";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "nederlansk antillegylden";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਨੀਦਰਲੈਂਡਸ ਐਂਟੀਲੀਅਨ ਗਿਲਡਰ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "gulden antylski";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Florim das Antilhas Holandesas";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "flurin da las Antillas Olandaisas";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "gulden din Antilele Olandeze";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Нидерландский антильский гульден";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "නෙදර්ලන්ත ඇන්ටිලියන් ගිල්ඩර්";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "antilský gulden";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "nizozemsko-antilski gulden";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Gilderi antilian holandez";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Холандскоантилски гулден";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "Nederländska Antillernas gulden";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Guilder ya Antili za Kiholanzi";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "நெதர்லேண்ட்ஸ் அன்டிலியன் கில்டர்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "నెదర్లాండ్స్ యాంటిల్లియన్ గిల్‌డర్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "กิลเดอร์เนเธอร์แลนด์แอนทิลลิส";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Antillean Guilder ng Netherlands";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Hollanda Antilleri Guldeni";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "گوللاندىيەگە قاراشلىق ئانتىللېن گۇلدېنى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "нідерландський антильський гульден";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "نیدر لینڈز انٹیلیئن گلڈر";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Niderlandiya antil guldeni";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Голланд Антил гульдени";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Guilder Tây Ấn Hà Lan";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Netherlands Antillean Guilder";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "নেডাৰলেণ্ডছ এণ্টিলিয়েন গিল্ডাৰ";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Нидерланд Антиллиан гульденӗ";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "𞤊𞤵𞤤𞤮𞤪𞤭𞤲 𞤀𞤲𞤼𞤭𞤴𞤢𞤲𞤳𞤮";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Antillean Guilder na ƙasar Netherlands";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "florino antillan";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Antillean Guilder obodo Netherlands";
        ...
        test("has translation for 'jv' locale", () {
          const expectedName = "Guilder Antilla Walanda";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "guldenê antîlê yê holandî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Guilder Anatiri Hōrana";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ନେଦରଲ୍ୟାଣ୍ଡ୍ ଆଣ୍ଟିଲିୟ ଗିଲଡର୍";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "هالېنډي انټيليايي ګيلډر";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "fiorinu de sas Antillas Olandesas";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Galdarka Nadarlaan Antiliyaan";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Niderland antil guldeni";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Gílídà Netherlands Antillean";
