...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Cuban Convertible Peso";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Kubaanse omskakelbare peso";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የኩባ የሚመነዘር ፔሶ";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "بيزو كوبي قابل للتحويل";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Kuba Çevrilən Pesosu";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "кубінскае канверсоўнае песа";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Кубинско конвертируемо песо";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "কিউবান রূপান্তরযোগ্য পেসো";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "peso kemmadus Kuba";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Kubanski konvertibilni pezos";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "кубански конвертибилни песо";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "peso convertible cubà";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Кубан хийцалун песо";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "kubánské konvertibilní peso";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Peso Trosadwy Ciwba";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "cubansk konvertibel peso";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Kubanischer Peso (konvertibel)";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "kubaga convertible peso";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Μετατρέψιμο πέσο Κούβας";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "peso cubano convertible";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Kuuba konverteeritav peeso";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Kubako peso trukakorra";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "پزوی تبدیل‌پذیر کوبا";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Kuuban vaihdettava peso";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Kuba peso (sum kann vekslast)";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "peso cubain convertible";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Kubaanske convertibele peso";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Peso Inmhalartaithe Chúba";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Peso iompachail Cùbach";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "ક્યુબન રૂપાંતર યોગ્ય પેસો";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "פזו קובני להמרה";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "क्यूबाई परिवर्तनीय पेसो";
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "kubanski konvertibilni pezo";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "kubai konvertibilis peso";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Կուբայական փոխարկվող պեսո";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Peso Konvertibel Kuba";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "kúbverskur skiptanlegur pesi";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "peso cubano convertibile";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "კუბური კონვერტირებადი პესო";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Куба айырбасталмалы песосы";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ប៉េសូ​គុយបាអាច​បម្លែង​បាន";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಕ್ಯುಬಾದ ಪರಿವರ್ತನೀಯ ಪೆಸೊ";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "кубанын конвертациялануучу песосу";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Kubanesche Peso (konvertibel)";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ຄິວແບນ ຄອນເວີດຕິໂບ ເປໂຊ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Kubos konvertuojamasis pesas";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Kubas konvertējamais peso";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Кубански пезос (конвертибилен)";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ക്യൂബൻ കൺവേർട്ടബിൾ പെസോ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "кубын хөрвөгч песо";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "क्यूबन विनिमय पेसो";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Peso Boleh Tukar Cuba";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "နိုင်ငံခြားငွေလဲလှယ်နိုင်သော ကျူးဘားပီဆို";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "kubanske konvertible pesos";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "क्यूवाली रूपान्तरणयोग्य पेसो";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Cubaanse convertibele peso";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਕਿਊਬਨ ਬਦਲਣਯੋਗ ਪੇਸੋ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "peso kubańskie wymienialne";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Peso cubano conversível";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "peso cubanez convertibil";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Кубинское конвертируемое песо";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "මාරුකළ හැකි කියුබානු පැසෝ";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "kubánske konvertibilné peso";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "kubanski konvertibilni peso";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Pesoja kubaneze e shkëmbyeshme";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Кубански конвертибилни пезос";
        ...
        test("has translation for 'sv' locale", () {
          const expectedName = "kubansk peso (konvertibel)";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Peso ya Cuba Inayoweza Kubadilishwa";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "கியூபன் கன்வெர்டிபில் பெசோ";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "క్యూబన్ కన్వర్టబుల్ పెసో";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "เปโซคิวบา (แปลงสภาพ)";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Convertible na Piso ng Cuba";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Konvertibl Küba Pesosu";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "كۇبا ئالماشتۇرۇشچان پېسوسى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "кубинський конвертований песо";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "کیوبا کا قابل منتقلی پیسو";
        ...
        test("has translation for 'ur_IN' locale", () {
          const expectedName = "قابل منتقلی کیوبائی پیسو";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Kuba ayirboshlash pesosi";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "Куба Айирбошлаш песоси";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Peso Cuba có thể chuyển đổi";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Cuban Convertable Peso";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "কিউবান ৰূপান্তৰযোগ্য পেছো";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Куба конвертланакан песийӗ";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Peso mai fuska biyu na ƙasar Kuba";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "peso cuban convertibile";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Ego Peso e nwere ike ịgbanwe nke obodo Cuba";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "pesoyên konvertibl ê kubayî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Peso Kiupa takahuri";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "କ୍ୟୁବାନ୍ କନଭର୍ଟିବଲ୍ ପେସୋ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "کيوبايي بدلېدونکي پسو";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "peso cuban convertibel";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "peso cubanu cunvertìbile";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Beesada Konfatibal ee Kuuba";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Konwertirlenýän kuba pesosy";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Pẹ́sò Yíyípadà Kúbà";
