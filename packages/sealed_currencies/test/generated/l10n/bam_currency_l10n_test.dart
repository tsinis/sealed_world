...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Bosnia-Herzegovina Convertible Mark";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Bosnies-Herzegowiniese omskakelbare marka";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የቦስኒያ ሄርዞጎቪና የሚመነዘር ማርክ";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "مارك البوسنة والهرسك قابل للتحويل";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Bosniya-Herseqovina Markası";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "канверсоўная марка Босніі і Герцагавіны";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Босненска конвертируема марка";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "বসনিয়া এবং হার্জেগোভিনা মার্ক";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "mark kemmadus Bosnia ha Herzegovina";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Bosanskohercegovačka konvertibilna marka";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Конвертибилна марка";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "marc convertible de Bòsnia i Hercegovina";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Боснин а, Герцеговинан а хийцалун марка";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "bosenská konvertibilní marka";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Marc Trosadwy Bosnia a Hercegovina";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "bosnien-hercegovinsk konvertibel mark";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Bosnien und Herzegowina Konvertierbare Mark";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "bosnia-herzegovinaga convertible mark";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Μετατρέψιμο Μάρκο Βοσνίας-Ερζεγοβίνης";
        ...
        test("has translation for 'en_AU' locale", () {
          const expectedName = "Bosnia-Herzegovina Convertible Marka";

          final translated = value.maybeTranslation(
            const BasicLocale(LangEng(), countryCode: "AU"),
            useLanguageFallback: false,
          );
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "marco convertible de Bosnia-Herzegovina";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Bosnia ja Hertsegoviina konverteeritav mark";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Bosnia-Herzegovinako marko trukakorra";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "مارک تبدیل‌پذیر بوسنی و هرزگوین";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Bosnia-Hertsegovinan vaihdettava markka";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Bosnia-Hersegovina mark (kann vekslast)";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "mark convertible bosniaque";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Bosnyske convertibele mark";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Marg Inmhalartaithe na Boisnia-Heirseagaivéine";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Mark iompachail Bhosna agus Hearsagobhana";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Marco convertible de Bosnia e Hercegovina";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "બોસ્નિયા અને હર્ઝેગોવિના રૂપાંતર યોગ્ય માર્ક";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "מארק בר המרה של בוסניה־הרצגובינה";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "बोस्निया हर्ज़ेगोविना परिवर्तनीय मार्क";
        ...
        test("has translation for 'hr' locale", () {
          const expectedName = "konvertibilna marka";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "bosznia-hercegovinai konvertibilis márka";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Բոսնիա և Հերցեգովինայի փոխարկվող մարկ";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Mark Konvertibel Bosnia-Herzegovina";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "skiptanlegt Bosníu og Hersegóvínu-mark";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "marco convertibile della Bosnia-Herzegovina";
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "ボスニア マルク (BAM)";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "ბოსნია და ჰერცოგოვინას კონვერტირებადი მარკა";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Босния және Герцеговина айырбасталмалы маркасы";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ម៉ាក​អាច​បម្លែង​បាន​បូស្នី";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಬೋಸ್ನಿಯಾ-ಹರ್ಜ್‌ಗೋವಿನ ಪರಿವರ್ತನೀಯ ಗುರುತು";
        ...
        test("has translation for 'ko' locale", () {
          const expectedName = "보스니아-헤르체고비나 태환 마르크";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "بوزنِیاہَرزِگووِنا کَنوٲٹیبٕل مارٕک";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "босния-герцоговина конвертациялануучу маркасы";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Bosnien an Herzegowina Konvertéierbar Mark";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ບອ​ສ​ເນຍ-ເຮີ​ເຊ​ໂກວິ​ນາ ຄອນ​ເວີດ​ຕິ​ໂບ ມາກ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Bosnijos ir Hercegovinos konvertuojamoji markė";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Bosnijas un Hercogovinas konvertējamā marka";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Босанско-Херцеговска конвертибилна марка";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "ബോസ്‌നിയ-ഹെർസഗോവിന കൺവേർട്ടബിൾ മാർക്ക്";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "босни-герцеговин хөрвөгч марк";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "बोस्निया-हर्जेगोविना विनिमय मार्क";
        ...
        test("has translation for 'ms' locale", () {
          const expectedName = "Mark Boleh Tukar Bosnia-Herzegovina";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ဘော့စနီးယားနှင့် ဟာဇီဂိုဘီးနားမတ်က်";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "bosnisk-hercegovinske konvertible mark";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "बोस्निया-हर्जगोभिनिया रूपान्तरयोग्य मार्क";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Bosnische convertibele mark";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "bosnisk-hercegovinsk mark (konvertibel)";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਬੋਸਨੀਆ-ਹਰਜ਼ੇਗੋਵੀਨਾ ਬਦਲਣਯੋਗ ਮਾਰਕ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "marka zamienna Bośni i Hercegowiny";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Marco bósnio-herzegovino conversível";
        ...
        test("has translation for 'pt_PT' locale", () {
          const expectedName = "Marco bósnio-herzegóvino conversível";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "marc convertibel bosniac";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "marcă convertibilă din Bosnia și Herțegovina";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Конвертируемая марка Боснии и Герцеговины";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "බොස්නියා හර්සගොවීනා පරිවර්ත්‍ය මාර්ක්";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "konvertibilná marka";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "bosansko-hercegovska konvertibilna marka";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Marka e Bosnjë-Hercegovinës [e shkëmbyeshme]";
        ...
        test("has translation for 'sr' locale", () {
          const expectedName = "Босанско-херцеговачка конвертибилна марка";
        ...
        test("has translation for 'sr_Latn' locale", () {
          const expectedName = "Bosansko-hercegovačka konvertibilna marka";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName =
              "Mark Inayoweza Kubadilishwa ya Bosnia na Hezegovina";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "போஸ்னியா-ஹெர்ஸேகோவினா கன்வெர்டிபில் மார்க்";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "มาร์กบอสเนีย-เฮอร์เซโกวีนา";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Konvertibl Bosna Hersek Markı";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "بوسنىيە-خېرتسېگوۋىنا ئالماشتۇرۇشچان ماركى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "конвертована марка Боснії і Герцеговини";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "بوسنیا ہرزیگووینا کا قابل منتقلی نشان";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Bosniya va Gertsegovina ayirboshlash markasi";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Mark Bosnia-Herzegovina có thể chuyển đổi";
        ...
        test("has translation for 'zh' locale", () {
          const expectedName = "波斯尼亚-黑塞哥维那可兑换马克";
        ...
        test("has translation for 'zh_HK' locale", () {
          const expectedName = "波斯尼亞-赫塞哥維納可轉換馬克";

          final translated = value.maybeTranslation(
            const BasicLocale(LangZho(), countryCode: "HK"),
            useLanguageFallback: false,
          );
        ...
        test("has translation for 'zh_Hant' locale", () {
          const expectedName = "波士尼亞-赫塞哥維納可轉換馬克";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Bosnia-Herzegovina Convertible Mark";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "ব’ছনিয়া আৰু হাৰ্জেগ’ভিনা কনভাৰ্টিব্‌ল মাৰ্ক";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Боснипе Герцеговина конвертланакан марки";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Kuɗaɗen Bosnia da Herzegovina";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "marco convertibile de Bosnia-Herzegovina";
        ...
        test("has translation for 'ig' locale", () {
          const expectedName = "Akara mgbanwe ego obodo Bosnia-Herzegovina";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "markê konvertibl ê bosna hersekî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Mark Pōngia-Herekōwini takahuri";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ବୋସନିଆ-ହର୍ଜଗୋଭିନା କନଭର୍ଟିବଲ୍ ମାର୍କ୍";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "بوسنيا هرزګوينيايي بدلېدونکې مارک";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "marcu cunvertìbile de sa Bòsnia-Erzegòvina";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Konfatibal Maakta Bosnia-Hersogofina";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Konwertirlenýän Bosniýa we Gersegowina markasy";
        ...
        test("has translation for 'xh' locale", () {
          const expectedName = "I-Convertible Mark yaseBosnia-Herzegovina";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Àmi Yíyípadà Bosnia-Herzegovina";
