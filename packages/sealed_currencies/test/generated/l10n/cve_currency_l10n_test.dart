...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'en' locale", () {
          const expectedName = "Cape Verdean Escudo";
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Kaap Verdiese escudo";
        ...
        test("has translation for 'am' locale", () {
          const expectedName = "የኬፕ ቫርዲ ኤስኩዶ";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "اسكودو الرأس الخضراء";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "Kape Verde Eskudosu";
        ...
        test("has translation for 'be' locale", () {
          const expectedName = "эскуда Каба-Вердэ";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Ескудо на Кабо Верде";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "capivɛrdi Esekudo";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "কেপ ভার্দে এসকুডো";
        ...
        test("has translation for 'br' locale", () {
          const expectedName = "escudo Kab Glas";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Zelenortski eskudo";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Зеленортски ескудо";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "escut de Cap Verd";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "Кабо-Верден эскудо";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "kapverdské escudo";
        ...
        test("has translation for 'cy' locale", () {
          const expectedName = "Esgwdo Cabo Verde";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "kapverdisk escudo";
        ...
        test("has translation for 'de' locale", () {
          const expectedName = "Cabo-Verde-Escudo";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "kape verdega escudo";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Εσκούδο Πράσινου Ακρωτηρίου";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "escudo de Cabo Verde";
        ...
        test("has translation for 'et' locale", () {
          const expectedName = "Cabo Verde eskuudo";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "Cabo Verdeko ezkutua";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "اسکودوی کیپ‌ورد";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Eskudoo Kap Weer";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Kap Verden escudo";
        ...
        test("has translation for 'fo' locale", () {
          const expectedName = "Grønhøvdaoyggjar escudo";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "escudo capverdien";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Kaapverdyske escudo";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Escudo Rinn Verde";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Escudo a’ Chip Uaine";
        ...
        test("has translation for 'gl' locale", () {
          const expectedName = "Escudo caboverdiano";
        ...
        test("has translation for 'gu' locale", () {
          const expectedName = "કેપ વર્દિયન એસ્કુડો";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Kuɗin Tsibiran Kap Barde";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "אסקודו כף ורדה";
        ...
        test("has translation for 'hi' locale", () {
          const expectedName = "केप वर्ड एस्कूडो";
        ...
        test("has translation for 'hu' locale", () {
          const expectedName = "Cape Verde-i escudo";
        ...
        test("has translation for 'hy' locale", () {
          const expectedName = "Կաբո Վերդեի էսկուդո";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Escudo Tanjung Verde";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "grænhöfðeyskur skúti";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "escudo capoverdiano";
        ...
        test("has translation for 'ja' locale", () {
          const expectedName = "カーボベルデ エスクード";
        ...
        test("has translation for 'ka' locale", () {
          const expectedName = "კაბო-ვერდეს ესკუდო";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Eskudo ya Kepuvede";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "Кабо-Верде эскудосы";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "អ៊ីស្កូឌូ​កាប់វែរ";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಕೇಪ್ ವರ್ಡಿನ್ ಎಸ್‌ಕೂಡೊ";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "Кабо-Верде эскудосу";
        ...
        test("has translation for 'lb' locale", () {
          const expectedName = "Kap-Verde-Escudo";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Esikudo ey’Keepu Veredi";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Esikudo ya Kapevɛrɛ";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "ເຄບ ເວີດ​ດີນ ເອ​ສ​ຄູ​ໂດ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "Žaliojo Kyšulio eskudas";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Esikuludo wa Kapevere";
        ...
        test("has translation for 'lv' locale", () {
          const expectedName = "Kaboverdes eskudo";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Зелено’ртски ескудо";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "കേപ് വെർദിയൻ എസ്‌ക്യുഡോ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "кабо-верде эскудо";
        ...
        test("has translation for 'mr' locale", () {
          const expectedName = "केप व्हर्डेयन एस्कुडो";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "ကိတ်ပ်ဗာဒီ အက်စ်ခူဒို";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "kappverdiske escudos";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "केप भर्डियन एस्कुडो";
        ...
        test("has translation for 'nl' locale", () {
          const expectedName = "Kaapverdische escudo";
        ...
        test("has translation for 'nn' locale", () {
          const expectedName = "kappverdisk escudo";
        ...
        test("has translation for 'pa' locale", () {
          const expectedName = "ਕੇਪ ਵਰਡੀਅਨ ਸਕੂਡੋ";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "escudo zielonoprzylądkowe";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Escudo cabo-verdiano";
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "escudo dal Cap Verd";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Irikaboveridiyano ryo muri Esikudo";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "escudo din Capul Verde";
        ...
        test("has translation for 'ru' locale", () {
          const expectedName = "Эскудо Кабо-Верде";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = "eskûêdo tî Kâpo-Vêre";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "කේප් වර්ඩ් එස්කියුඩෝ";
        ...
        test("has translation for 'sn' locale", () {
          const expectedName = "Dhora re Escudo";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Eskudoja e Kepit të Gjelbër";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Eskudo ya Cape Verde";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "கேப் வெர்டியன் எஸ்குடோ";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "కేప్ వెర్డియన్ ఎస్కుడో";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "เอสคูโดเคปเวิร์ด";
        ...
        test("has translation for 'tr' locale", () {
          const expectedName = "Cape Verde Esküdosu";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "يېشىل تۇمشۇق ئېسكۇدوسى";
        ...
        test("has translation for 'uk' locale", () {
          const expectedName = "ескудо Кабо-Верде";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "کیپ ورڈی کا اسکیوڈو";
        ...
        test("has translation for 'ur_IN' locale", () {
          const expectedName = "کیپ ورڈی اسکیوڈو";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "Kabo-Verde eskudosi";
        ...
        test("has translation for 'vi' locale", () {
          const expectedName = "Escudo Cape Verde";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Kabofediano ti Orílẹ́ède Esuodo";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Kabofediano ti Orílɛ́ède Esuodo";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-Cape Verdean Escudo";
        ...
        test("has translation for 'as' locale", () {
          const expectedName = "কেপ ভাৰ্দে এছকুডো";
        ...
        test("has translation for 'cv' locale", () {
          const expectedName = "Кабо-Верде эскудӗ";
        ...
        test("has translation for 'ia' locale", () {
          const expectedName = "escudo capoverdian";
        ...
        test("has translation for 'ku' locale", () {
          const expectedName = "eskudoyê kape verdeyî";
        ...
        test("has translation for 'mi' locale", () {
          const expectedName = "Escudo Kūrae Matomato";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "କେପ୍ ଭେର୍ଦେୟ ଏସ୍କୁଡୋ";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "کيپ وردين اسکوډو";
        ...
        test("has translation for 'sc' locale", () {
          const expectedName = "iscudu cabubirdianu";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Eskudo Keyb Farde";
        ...
        test("has translation for 'tk' locale", () {
          const expectedName = "Kabo-Werde eskudosy";
