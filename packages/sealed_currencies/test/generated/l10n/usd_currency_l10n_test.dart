...
void main() => group(
      ...
      () {
        ...
        test("has translation for 'af' locale", () {
          const expectedName = "Amerikaanse dollar";
        ...
        test("has translation for 'ak' locale", () {
          const expectedName = "Amɛrika Dɔla";
        ...
        test("has translation for 'ar' locale", () {
          const expectedName = "دولار أمريكي";
        ...
        test("has translation for 'az' locale", () {
          const expectedName = "ABŞ Dolları";
        ...
        test("has translation for 'bg' locale", () {
          const expectedName = "Щатски долар";
        ...
        test("has translation for 'bm' locale", () {
          const expectedName = "ameriki Dolar";
        ...
        test("has translation for 'bn' locale", () {
          const expectedName = "মার্কিন ডলার";
        ...
        test("has translation for 'bo' locale", () {
          const expectedName = "ཨ་རིའི་སྒོར་";
        ...
        test("has translation for 'bs' locale", () {
          const expectedName = "Američki dolar";
        ...
        test("has translation for 'bs_Cyrl' locale", () {
          const expectedName = "Амерички долар";
        ...
        test("has translation for 'ca' locale", () {
          const expectedName = "dòlar dels Estats Units";
        ...
        test("has translation for 'ce' locale", () {
          const expectedName = "АЦШн доллар";
        ...
        test("has translation for 'cs' locale", () {
          const expectedName = "americký dolar";
        ...
        test("has translation for 'da' locale", () {
          const expectedName = "amerikansk dollar";
        ...
        test("has translation for 'dz' locale", () {
          const expectedName = "ཡུ་ཨེས་ ཌོ་ལར";
        ...
        test("has translation for 'ee' locale", () {
          const expectedName = "US ga dollar";
        ...
        test("has translation for 'el' locale", () {
          const expectedName = "Δολάριο ΗΠΑ";
        ...
        test("has translation for 'es' locale", () {
          const expectedName = "dólar estadounidense";
        ...
        test("has translation for 'eu' locale", () {
          const expectedName = "AEBko dolarra";
        ...
        test("has translation for 'fa' locale", () {
          const expectedName = "دلار امریکا";
        ...
        test("has translation for 'fa_AF' locale", () {
          const expectedName = "دالر امریکا";
        ...
        test("has translation for 'ff' locale", () {
          const expectedName = "Dolaar Dowlaaji Dentuɗi";
        ...
        test("has translation for 'fi' locale", () {
          const expectedName = "Yhdysvaltain dollari";
        ...
        test("has translation for 'fr' locale", () {
          const expectedName = "dollar des États-Unis";
        ...
        test("has translation for 'fy' locale", () {
          const expectedName = "Amerikaanske dollar";
        ...
        test("has translation for 'ga' locale", () {
          const expectedName = "Dollar S.A.M.";
        ...
        test("has translation for 'gd' locale", () {
          const expectedName = "Dolar nan Stàitean Aonaichte";
        ...
        test("has translation for 'ha' locale", () {
          const expectedName = "Dalar Amurka";
        ...
        test("has translation for 'he' locale", () {
          const expectedName = "דולר אמריקאי";
        ...
        test("has translation for 'id' locale", () {
          const expectedName = "Dolar Amerika Serikat";
        ...
        test("has translation for 'is' locale", () {
          const expectedName = "Bandaríkjadalur";
        ...
        test("has translation for 'it' locale", () {
          const expectedName = "dollaro statunitense";
        ...
        test("has translation for 'ki' locale", () {
          const expectedName = "Ndora cia Amerika";
        ...
        test("has translation for 'kk' locale", () {
          const expectedName = "АҚШ доллары";
        ...
        test("has translation for 'km' locale", () {
          const expectedName = "ដុល្លារ​អាមេរិក";
        ...
        test("has translation for 'kn' locale", () {
          const expectedName = "ಅಮೆರಿಕದ ಡಾಲರ್‌";
        ...
        test("has translation for 'ks' locale", () {
          const expectedName = "یوٗ ایٚس ڈالَر";
        ...
        test("has translation for 'ky' locale", () {
          const expectedName = "АКШ доллары";
        ...
        test("has translation for 'lg' locale", () {
          const expectedName = "Doola ey’Amerika";
        ...
        test("has translation for 'ln' locale", () {
          const expectedName = "Dolarɛ ya Ameriki";
        ...
        test("has translation for 'lo' locale", () {
          const expectedName = "​ໂດ​ລ່າ​ສະ​ຫະ​ລັດຯ";
        ...
        test("has translation for 'lt' locale", () {
          const expectedName = "JAV doleris";
        ...
        test("has translation for 'lu' locale", () {
          const expectedName = "Ndola wa Ameriki";
        ...
        test("has translation for 'mg' locale", () {
          const expectedName = "Dolara amerikanina";
        ...
        test("has translation for 'mk' locale", () {
          const expectedName = "Американски долар";
        ...
        test("has translation for 'ml' locale", () {
          const expectedName = "യു.എസ്. ഡോളർ";
        ...
        test("has translation for 'mn' locale", () {
          const expectedName = "америк доллар";
        ...
        test("has translation for 'my' locale", () {
          const expectedName = "အမေရိကန် ဒေါ်လာ";
        ...
        test("has translation for 'nb' locale", () {
          const expectedName = "amerikanske dollar";
        ...
        test("has translation for 'nd' locale", () {
          const expectedName = "Dola yase Amelika";
        ...
        test("has translation for 'ne' locale", () {
          const expectedName = "अमेरिकी डलर";
        ...
        test("has translation for 'os' locale", () {
          const expectedName = "АИШ-ы Доллар";
        ...
        test("has translation for 'pl' locale", () {
          const expectedName = "dolar amerykański";
        ...
        test("has translation for 'pt' locale", () {
          const expectedName = "Dólar americano";
        ...
        test("has translation for 'pt_PT' locale", () {
          const expectedName = "Dólar dos Estados Unidos";
        ...
        test("has translation for 'qu_EC' locale", () {
          const expectedName = "USD";

          final translated = value.maybeTranslation(
            const BasicLocale(LangQue(), countryCode: "EC"),
            useLanguageFallback: false,
          );
        ...
        test("has translation for 'rm' locale", () {
          const expectedName = "dollar dals Stadis Unids da l’America";
        ...
        test("has translation for 'rn' locale", () {
          const expectedName = "Idolari ry’abanyamerika";
        ...
        test("has translation for 'ro' locale", () {
          const expectedName = "dolar american";
        ...
        test("has translation for 'sg' locale", () {
          const expectedName = r"dol$ara ttî äLetäa-Ôko tî Amerîka";
        ...
        test("has translation for 'si' locale", () {
          const expectedName = "ඇමරිකානු ඩොලර්";
        ...
        test("has translation for 'sk' locale", () {
          const expectedName = "americký dolár";
        ...
        test("has translation for 'sl' locale", () {
          const expectedName = "ameriški dolar";
        ...
        test("has translation for 'sn' locale", () {
          const expectedName = "Dora re Amerika";
        ...
        test("has translation for 'so' locale", () {
          const expectedName = "Doollar maraykan";
        ...
        test("has translation for 'sq' locale", () {
          const expectedName = "Dollari amerikan";
        ...
        test("has translation for 'sw' locale", () {
          const expectedName = "Dola ya Marekani";
        ...
        test("has translation for 'ta' locale", () {
          const expectedName = "அமெரிக்க டாலர்";
        ...
        test("has translation for 'te' locale", () {
          const expectedName = "అమెరికా డాలర్";
        ...
        test("has translation for 'th' locale", () {
          const expectedName = "ดอลลาร์สหรัฐ";
        ...
        test("has translation for 'tl' locale", () {
          const expectedName = "Dolyar ng US";
        ...
        test("has translation for 'ug' locale", () {
          const expectedName = "ئامېرىكا دوللىرى";
        ...
        test("has translation for 'ur' locale", () {
          const expectedName = "امریکی ڈالر";
        ...
        test("has translation for 'uz' locale", () {
          const expectedName = "AQSH dollari";
        ...
        test("has translation for 'uz_Cyrl' locale", () {
          const expectedName = "АҚШ доллари";
        ...
        test("has translation for 'yi' locale", () {
          const expectedName = "אמעריקאנער דאלאר";
        ...
        test("has translation for 'yo' locale", () {
          const expectedName = "Dọla ti Orílẹ́ède Amerika";
        ...
        test("has translation for 'yo_BJ' locale", () {
          const expectedName = "Dɔla ti Orílɛ́ède Amerika";
        ...
        test("has translation for 'zu' locale", () {
          const expectedName = "i-US Dollar";
        ...
        test("has translation for 'or' locale", () {
          const expectedName = "ଆମେରିକା ଡଲାର";
        ...
        test("has translation for 'ps' locale", () {
          const expectedName = "امريکايي ډالر";
