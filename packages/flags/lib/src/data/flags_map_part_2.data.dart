...
const flagCxrProperties = FlagProperties(
  ...
  elementsProperties: [
    ...
    ElementsProperties([Color(0xff1c8a42), Color(0xffffc639)]),
  ],
  url:
...
const flagVutProperties = FlagProperties(
  ...
  elementsProperties: [
    ...
    ElementsProperties([Color(0xfffdce12)], x: -0.6, heightFactor: 8 / 36),
  ],
  url:
        ...
        ElementsProperties(
          ...
          children: [
            ElementsProperties(
              ...
              children: [
                ElementsProperties(
                  [Color(0xffffcc00), Color(0xff000000)],
                  heightFactor: 0.8,
                ),
              ],
            ),
...
const flagTklProperties = FlagProperties(
  ...
  elementsProperties: [
    ...
    ElementsProperties([Color(0xfffed100)], x: 0.6, heightFactor: 0.9),
  ],
...
const flagUnkProperties = FlagProperties(
  ...
  elementsProperties: [
    ...
    ElementsProperties([Color(0xffd0a650)], heightFactor: 1 / 2),
  ],
...
const flagCriProperties = FlagProperties(
  ...
  elementsProperties: [
    ElementsProperties(
      [Color(0xffffffff), Color(0xff002b7f)],
      x: -0.4,
      heightFactor: 0.29,
      widthFactor: 0.85,
    ),
...
const flagTkmProperties = FlagProperties(
  ...
  elementsProperties: [
    ElementsProperties(
      ...
      y: -0.55,
      heightFactor: 0.25,
      shape: Moon(radius: 1.02, x: -0.3, y: -0.2),
      children: [
        ElementsProperties(
          [Color(0xffffffff)],
          x: -0.86,
